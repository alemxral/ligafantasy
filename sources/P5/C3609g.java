...
public final class C3609g implements InterfaceC2777e {
    ...
    public C3609g(int i8, a cornerType) {
        ...
        this.f37040a = i8;
        this.f37041b = i8 * 2;
        this.f37043d = cornerType;
    }

    private final void b(Canvas canvas, Paint paint, float f8, float f9) {
        RectF rectF = new RectF(this.f37042c, f9 - this.f37041b, r1 + r3, f9);
        int i8 = this.f37040a;
        canvas.drawRoundRect(rectF, i8, i8, paint);
        int i9 = this.f37042c;
        canvas.drawRect(new RectF(i9, i9, i9 + this.f37041b, f9 - this.f37040a), paint);
        canvas.drawRect(new RectF(this.f37040a + r1, this.f37042c, f8, f9), paint);
    }
    ...
    private final void c(Canvas canvas, Paint paint, float f8, float f9) {
        ...
        int i10 = this.f37042c;
        canvas.drawRect(new RectF(i10, i10, f8 - this.f37040a, f9), paint);
        int i11 = this.f37040a;
        canvas.drawRect(new RectF(f8 - i11, this.f37042c, f8, f9 - i11), paint);
    }

    private final void d(Canvas canvas, Paint paint, float f8, float f9) {
        RectF rectF = new RectF(this.f37042c, f9 - this.f37041b, f8, f9);
        int i8 = this.f37040a;
        canvas.drawRoundRect(rectF, i8, i8, paint);
        int i9 = this.f37042c;
        canvas.drawRect(new RectF(i9, i9, f8, f9 - this.f37040a), paint);
    }
    ...
    private final void e(Canvas canvas, Paint paint, float f8, float f9) {
        ...
        int i11 = this.f37041b;
        RectF rectF2 = new RectF(f8 - i11, f9 - i11, f8, f9);
        int i12 = this.f37040a;
        canvas.drawRoundRect(rectF2, i12, i12, paint);
        canvas.drawRect(new RectF(this.f37042c, r1 + r3, f8 - this.f37040a, f9), paint);
        canvas.drawRect(new RectF(r1 + r2, this.f37042c, f8, f9 - this.f37040a), paint);
    }

    private final void f(Canvas canvas, Paint paint, float f8, float f9) {
        int i8 = this.f37041b;
        RectF rectF = new RectF(f8 - i8, this.f37042c, f8, r3 + i8);
        int i9 = this.f37040a;
        canvas.drawRoundRect(rectF, i9, i9, paint);
        RectF rectF2 = new RectF(this.f37042c, f9 - this.f37041b, r1 + r3, f9);
        int i10 = this.f37040a;
        canvas.drawRoundRect(rectF2, i10, i10, paint);
        int i11 = this.f37042c;
        int i12 = this.f37040a;
        canvas.drawRect(new RectF(i11, i11, f8 - i12, f9 - i12), paint);
        int i13 = this.f37042c;
        int i14 = this.f37040a;
        canvas.drawRect(new RectF(i13 + i14, i13 + i14, f8, f9), paint);
    }

    private final void g(Canvas canvas, Paint paint, float f8, float f9) {
        int i8 = this.f37042c;
        RectF rectF = new RectF(i8, i8, i8 + this.f37041b, f9);
        int i9 = this.f37040a;
        canvas.drawRoundRect(rectF, i9, i9, paint);
        canvas.drawRect(new RectF(this.f37040a + r1, this.f37042c, f8, f9), paint);
    }
    ...
    private final void h(Canvas canvas, Paint paint, float f8, float f9) {
        int i8 = this.f37042c;
        RectF rectF = new RectF(i8, i8, f8, i8 + this.f37041b);
        int i9 = this.f37040a;
        canvas.drawRoundRect(rectF, i9, i9, paint);
        RectF rectF2 = new RectF(f8 - this.f37041b, this.f37042c, f8, f9);
        int i10 = this.f37040a;
        canvas.drawRoundRect(rectF2, i10, i10, paint);
        canvas.drawRect(new RectF(this.f37042c, r1 + r3, f8 - this.f37040a, f9), paint);
    }
    ...
    private final void i(Canvas canvas, Paint paint, float f8, float f9) {
        ...
        canvas.drawRoundRect(rectF, i9, i9, paint);
        int i10 = this.f37042c;
        RectF rectF2 = new RectF(i10, i10, i10 + this.f37041b, f9);
        int i11 = this.f37040a;
        canvas.drawRoundRect(rectF2, i11, i11, paint);
        int i12 = this.f37042c;
        int i13 = this.f37040a;
    ...
    private final void k(Canvas canvas, Paint paint, float f8, float f9) {
        ...
        int i9 = this.f37040a;
        canvas.drawRoundRect(rectF, i9, i9, paint);
        RectF rectF2 = new RectF(this.f37042c, f9 - this.f37041b, f8, f9);
        int i10 = this.f37040a;
        canvas.drawRoundRect(rectF2, i10, i10, paint);
        canvas.drawRect(new RectF(r1 + r2, this.f37042c, f8, f9 - this.f37040a), paint);
    }
    ...
    private final void l(Canvas canvas, Paint paint, float f8, float f9) {
        RectF rectF = new RectF(f8 - this.f37041b, this.f37042c, f8, f9);
        int i8 = this.f37040a;
        canvas.drawRoundRect(rectF, i8, i8, paint);
        int i9 = this.f37042c;
        canvas.drawRect(new RectF(i9, i9, f8 - this.f37040a, f9), paint);
    }
    ...
    private final void m(Canvas canvas, Paint paint, float f8, float f9) {
        ...
        float f10 = f8 - i8;
        float f11 = f9 - i8;
        switch (b.f37060a[this.f37043d.ordinal()]) {
            case 1:
                int i9 = this.f37042c;
    ...
    private final void o(Canvas canvas, Paint paint, float f8, float f9) {
        ...
        int i10 = this.f37042c;
        canvas.drawRect(new RectF(i10, i10, f8 - this.f37040a, f9), paint);
        canvas.drawRect(new RectF(f8 - this.f37040a, this.f37042c + r1, f8, f9), paint);
    }
    ...
    private final void p(Canvas canvas, Paint paint, float f8, float f9) {
        ...
        int i9 = this.f37040a;
        canvas.drawRoundRect(rectF, i9, i9, paint);
        canvas.drawRect(new RectF(this.f37042c, r1 + this.f37040a, f8, f9), paint);
    }
    ...
    @Override // i2.InterfaceC2777e
    public String key() {
        return "RoundedTransformation(radius=" + this.f37040a + ", margin=" + this.f37042c + ", diameter=" + this.f37041b + ", cornerType=" + this.f37043d.name() + ')';
    }
