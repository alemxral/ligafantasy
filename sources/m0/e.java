...
public class e {
    ...
    private static final Charset f6837e = Charset.forName(C.UTF8_NAME);

    /* renamed from: f, reason: collision with root package name */
    private static final int f6838f = 15;

    /* renamed from: g, reason: collision with root package name */
    private static final h f6839g = new h();

    /* renamed from: h, reason: collision with root package name */
    private static final Comparator f6840h = new Comparator() { // from class: M0.a
    ...
    private static final FilenameFilter f6841i = new FilenameFilter() { // from class: M0.b
    ...
    private final AtomicInteger f6842a = new AtomicInteger(0);
        ...
        while (true) {
            try {
                ...
                if (read > 0) {
                    ...
                    String str = new String(byteArrayOutputStream.toByteArray(), f6837e);
    ...
    private void B(File file, B.d dVar, String str, B.a aVar) {
        try {
            h hVar = f6839g;
            G(this.f6843b.g(str), hVar.G(hVar.F(A(file)).r(dVar).o(aVar)));
    ...
    private void C(String str, long j8) {
        boolean z8;
        List<File> p8 = this.f6843b.p(str, f6841i);
        if (p8.isEmpty()) {
        ...
        D(this.f6843b.o(str, "report"), arrayList, j8, z8, I0.h.g(str, this.f6843b), F(this.f6843b.o(str, "app-quality-session-id")));
    }
    ...
    private void D(File file, List list, long j8, boolean z8, String str, String str2) {
        ...
        try {
            ...
            if (z8) {
                l8 = this.f6843b.j(l9.i());
            } else {
                l8 = this.f6843b.l(l9.i());
            }
            G(l8, hVar.G(p8));
        } catch (IOException e8) {
    ...
    private int E(String str, int i8) {
        List p8 = this.f6843b.p(str, new FilenameFilter() { // from class: M0.c
            @Override // java.io.FilenameFilter
    ...
    private static void G(File file, String str) {
        OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream(file), f6837e);
        try {
    ...
    private void g() {
        int i8 = this.f6844c.b().f7681a.f7693b;
        List n8 = n();
        int size = n8.size();
        if (size <= i8) {
            return;
    ...
    private List n() {
        ArrayList arrayList = new ArrayList();
        arrayList.addAll(this.f6843b.k());
        arrayList.addAll(this.f6843b.h());
        Comparator comparator = f6840h;
        Collections.sort(arrayList, comparator);
        List m8 = this.f6843b.m();
    ...
    public void l(String str, B.d dVar, B.a aVar) {
        File o8 = this.f6843b.o(str, "report");
        E0.f.f().b("Writing native session report for " + str + " to file: " + o8);
        B(o8, dVar, str, aVar);
    }

    public SortedSet p() {
        return new TreeSet(this.f6843b.d()).descendingSet();
    }

    public long q(String str) {
        return this.f6843b.o(str, "start-time").lastModified();
    }

    public boolean r() {
        if (this.f6843b.m().isEmpty() && this.f6843b.k().isEmpty() && this.f6843b.h().isEmpty()) {
            return false;
        }
        return true;
    }
    ...
    public List w() {
        ...
        for (File file : n8) {
            try {
                arrayList.add(AbstractC1184s.a(f6839g.F(A(file)), file.getName(), file));
            } catch (IOException e8) {
    ...
    public void y(B.e.d dVar, String str, boolean z8) {
        int i8 = this.f6844c.b().f7681a.f7692a;
        try {
            G(this.f6843b.o(str, m(this.f6842a.getAndIncrement(), z8)), f6839g.i(dVar));
            String d8 = this.f6845d.d();
            if (d8 == null) {
                E0.f.f().k("Missing AQS session id for Crashlytics session " + str);
            } else {
                G(this.f6843b.o(str, "app-quality-session-id"), d8);
            }
        } catch (IOException e8) {
    ...
    public void z(B b8) {
        ...
        String i8 = l8.i();
        try {
            G(this.f6843b.o(i8, "report"), f6839g.G(b8));
            H(this.f6843b.o(i8, "start-time"), "", l8.l());
        } catch (IOException e8) {
