...
public final class l extends ViewModel {
    ...
    public final String a(Set ids, a type) {
        ...
        if (ordinal != 0) {
            if (ordinal != 1) {
                if (ordinal != 2) {
                    if (ordinal != 3) {
                        ...
                        B6.e eVar2 = this.f1021b.f39913a;
                        if (eVar2 != null) {
                            map = eVar2.f1041g;
                        }
                        map = null;
                    ...
                    B6.e eVar3 = this.f1021b.f39913a;
                    if (eVar3 != null) {
                        map = eVar3.f1040f;
                    }
                    map = null;
                ...
                B6.e eVar4 = this.f1021b.f39913a;
                if (eVar4 != null) {
                    map = eVar4.f1039e;
                }
                map = null;
            ...
            B6.e eVar5 = this.f1021b.f39913a;
            if (eVar5 != null) {
                map = eVar5.f1038d;
            }
            map = null;
    ...
    public final List b() {
        ArrayList arrayList = new ArrayList();
        for (Map.Entry entry : this.f1023d.f39870a.entrySet()) {
            if (this.f1021b.f39907B.get(((y5.f) entry.getValue()).f39871a) != null) {
                arrayList.add(new R7.d(((y5.f) entry.getValue()).a(), this.f1021b.f39907B.get(((y5.f) entry.getValue()).f39871a), null, R7.e.GOOGLE_VENDOR, false, null, null, 116));
            }
        }
        return arrayList;
    }
    ...
    public final List c(String search) {
        ...
        if (ordinal != 0) {
            ...
            if (lVar == null) {
                ...
                Boolean bool = this.f1021b.f39932t.get(lVar.f1047a);
                if (bool == null) {
                    booleanValue = false;
                } else {
        ...
        f8.add(0, new R7.d(null, null, R7.f.LABEL, null, false, this.f1020a.a().f5670d, null, 91));
        ArrayList arrayList2 = new ArrayList();
        for (Object obj : f8) {
            if (n.F(((R7.d) obj).f8899a.f1048b, search, true)) {
                arrayList2.add(obj);
            }
        }
    ...
    public final List e() {
        ...
        if (eVar != null && (map = eVar.f1043i) != null) {
            for (Map.Entry entry : map.entrySet()) {
                if (this.f1021b.f39938z.get(((B6.l) entry.getValue()).f1047a) != null) {
                    Set set = ((B6.l) entry.getValue()).f1054d;
                    List list = this.f1022c.f2373b.f2338h;
                    if (!(set instanceof Collection) || !set.isEmpty()) {
                        Iterator it = set.iterator();
                        while (it.hasNext()) {
                            if (AbstractC1832c.a((Number) it.next(), list)) {
                                arrayList.add(new R7.d((B6.f) entry.getValue(), this.f1021b.f39938z.get(((B6.l) entry.getValue()).f1047a), null, null, false, null, null, 124));
                                break;
                            }
                        }
                    }
    ...
    public final List f() {
        ArrayList arrayList = new ArrayList();
        for (E6.d dVar : this.f1022c.f2374c.f2369a) {
            if (this.f1021b.f39906A.get(dVar.f2362a) != null) {
                arrayList.add(new R7.d(dVar.a(), this.f1021b.f39906A.get(dVar.f2362a), null, R7.e.NON_IAB_VENDOR, false, null, null, 116));
            }
        }
        return arrayList;
    }
