...
public final class h extends Q7.a implements a.b {
    ...
    public static final void m(PopupWindow mypopupWindow, h this$0, View view) {
        ...
        if (textView != null) {
            textView.setText(this$0.getString(I1.e.f3876a));
        }
    ...
    public static final void n(PopupWindow mypopupWindow, h this$0, View view) {
        ...
        TextView textView = this$0.f8361b;
        if (textView != null) {
            textView.setText(this$0.getString(I1.e.f3884i));
        }
        l lVar = this$0.f1010o;
        if (lVar == null) {
            AbstractC3159y.y("viewModel");
    ...
    public static final void o(PopupWindow mypopupWindow, h this$0, View view) {
        ...
        TextView textView = this$0.f8361b;
        if (textView != null) {
            textView.setText(this$0.getString(I1.e.f3888m));
        }
        l lVar = this$0.f1010o;
        if (lVar == null) {
            AbstractC3159y.y("viewModel");
    ...
    public static final void q(PopupWindow mypopupWindow, h this$0, View view) {
        ...
        TextView textView = this$0.f8361b;
        if (textView != null) {
            textView.setText(this$0.getString(I1.e.f3883h));
        }
        l lVar = this$0.f1010o;
        if (lVar == null) {
            AbstractC3159y.y("viewModel");
    ...
    public void b(R7.d item) {
        ...
        if (activity != null && (item.f8899a instanceof B6.l)) {
            ...
            if (supportFragmentManager.findFragmentByTag(str6) == null) {
                ...
                if (fVar2 instanceof B6.l) {
                    ...
                    String a8 = lVar2.a(((B6.l) item.f8899a).f1054d, B5.a.PURPOSE);
                    l lVar3 = this.f1010o;
                    if (lVar3 == null) {
                        AbstractC3159y.y("viewModel");
                        lVar3 = null;
                    }
                    String a9 = lVar3.a(((B6.l) item.f8899a).f1057g, B5.a.SPECIAL_PURPOSE);
                    l lVar4 = this.f1010o;
                    if (lVar4 == null) {
                        AbstractC3159y.y("viewModel");
                        lVar4 = null;
                    }
                    String a10 = lVar4.a(((B6.l) item.f8899a).f1058h, B5.a.FEATURE);
                    l lVar5 = this.f1010o;
                    if (lVar5 == null) {
                        AbstractC3159y.y("viewModel");
                        lVar5 = null;
                    }
                    String a11 = lVar5.a(((B6.l) item.f8899a).f1059i, B5.a.SPECIAL_FEATURE);
                    l lVar6 = this.f1010o;
                    if (lVar6 == null) {
                        AbstractC3159y.y("viewModel");
                        lVar6 = null;
                    }
                    String a12 = lVar6.a(((B6.l) item.f8899a).f1064n, B5.a.DATA_DECLARATION);
                    ...
                    if (i8 < 0) {
                        ...
                        fragmentActivity = activity;
                        if (f8 >= 1.0f) {
                            str2 = Z5.a.d(f8) + ' ' + lVar7.f1020a.g().f5660i;
                        } else {
                            str2 = i8 + ' ' + lVar7.f1020a.g().f5661j;
                        }
                    }
                    l lVar8 = this.f1010o;
                    if (lVar8 == null) {
                    ...
                    if (AbstractC3159y.d(bool, Boolean.TRUE)) {
                        ...
                        C4027a args = new C4027a(str7, str8, a8, null, a9, a10, a11, a12, str9, str2, str3, str5, fVar3.f1047a, item.f8902d, ((B6.l) fVar3).f1066p, "Error: cannot load vendor file", 8);
                        ...
                        str4 = lVar.f1020a.g().f5665n;
                    }
                    str3 = str4;
                    cVar = ((B6.l) item.f8899a).f1065o;
                    if (cVar == null) {
                        str5 = num;
                        B6.f fVar32 = item.f8899a;
                        C4027a args2 = new C4027a(str7, str8, a8, null, a9, a10, a11, a12, str9, str2, str3, str5, fVar32.f1047a, item.f8902d, ((B6.l) fVar32).f1066p, "Error: cannot load vendor file", 8);
                    ...
                    str5 = "";
                    B6.f fVar322 = item.f8899a;
                    C4027a args22 = new C4027a(str7, str8, a8, null, a9, a10, a11, a12, str9, str2, str3, str5, fVar322.f1047a, item.f8902d, ((B6.l) fVar322).f1066p, "Error: cannot load vendor file", 8);
    ...
    public void d(R7.d item) {
        ...
        if (eVar == eVar2) {
            ...
            if (AbstractC3159y.d(bool, bool2)) {
                lVar.f1021b.f39906A.set(item.f8899a.f1047a);
        ...
        if (item.f8902d == eVar2 && AbstractC3159y.d(item.f8900b, Boolean.FALSE)) {
            lVar.f1021b.f39906A.unset(item.f8899a.f1047a);
            H7.m mVar2 = H7.m.f3644a;
            StringBuilder a9 = AbstractC3505a.a("Non IAB", '_');
            a9.append(item.f8899a.f1047a);
            AbstractC3506b.a(item.f8900b, Boolean.TRUE, mVar2, a9.toString());
            return;
        }
        R7.e eVar3 = item.f8902d;
        R7.e eVar4 = R7.e.IAB_VENDOR;
        if (eVar3 == eVar4) {
            Boolean bool3 = item.f8900b;
            Boolean bool4 = Boolean.TRUE;
            if (AbstractC3159y.d(bool3, bool4)) {
                lVar.f1021b.f39938z.set(item.f8899a.f1047a);
                H7.m mVar3 = H7.m.f3644a;
                StringBuilder a10 = AbstractC3505a.a("Vendors", '_');
                a10.append(item.f8899a.f1047a);
                AbstractC3506b.a(item.f8900b, bool4, mVar3, a10.toString());
                return;
            }
        }
        if (item.f8902d == eVar4 && AbstractC3159y.d(item.f8900b, Boolean.FALSE)) {
            lVar.f1021b.f39938z.unset(item.f8899a.f1047a);
            H7.m mVar4 = H7.m.f3644a;
            StringBuilder a11 = AbstractC3505a.a("Vendors", '_');
            a11.append(item.f8899a.f1047a);
            AbstractC3506b.a(item.f8900b, Boolean.TRUE, mVar4, a11.toString());
            return;
        }
        R7.e eVar5 = item.f8902d;
        R7.e eVar6 = R7.e.GOOGLE_VENDOR;
        if (eVar5 == eVar6) {
            Boolean bool5 = item.f8900b;
            Boolean bool6 = Boolean.TRUE;
            if (AbstractC3159y.d(bool5, bool6)) {
                lVar.f1021b.f39907B.set(item.f8899a.f1047a);
                H7.m mVar5 = H7.m.f3644a;
                StringBuilder a12 = AbstractC3505a.a("Google", '_');
                a12.append(item.f8899a.f1047a);
                AbstractC3506b.a(item.f8900b, bool6, mVar5, a12.toString());
                return;
            }
        }
        if (item.f8902d == eVar6 && AbstractC3159y.d(item.f8900b, Boolean.FALSE)) {
            lVar.f1021b.f39907B.unset(item.f8899a.f1047a);
            H7.m mVar6 = H7.m.f3644a;
            StringBuilder a13 = AbstractC3505a.a("Google", '_');
            a13.append(item.f8899a.f1047a);
            AbstractC3506b.a(item.f8900b, Boolean.TRUE, mVar6, a13.toString());
            return;
        }
        R7.e eVar7 = item.f8902d;
        R7.e eVar8 = R7.e.PUBLISHER_VENDOR;
        if (eVar7 == eVar8) {
            Boolean bool7 = item.f8900b;
            Boolean bool8 = Boolean.TRUE;
            if (AbstractC3159y.d(bool7, bool8)) {
                lVar.f1021b.f39932t.set(item.f8899a.f1047a);
                lVar.f1021b.f39934v.setItems(AbstractC1246t.b1(((B6.l) item.f8899a).f1054d));
                H7.m mVar7 = H7.m.f3644a;
                StringBuilder a14 = AbstractC3505a.a("Vendors", '_');
                a14.append(item.f8899a.f1047a);
                AbstractC3506b.a(item.f8900b, bool8, mVar7, a14.toString());
                return;
            }
        }
        if (item.f8902d == eVar8 && AbstractC3159y.d(item.f8900b, Boolean.FALSE)) {
            lVar.f1021b.f39932t.unset(item.f8899a.f1047a);
            lVar.f1021b.f39934v.unset(AbstractC1246t.b1(((B6.l) item.f8899a).f1054d));
            H7.m mVar8 = H7.m.f3644a;
            StringBuilder a15 = AbstractC3505a.a("Vendors", '_');
            a15.append(item.f8899a.f1047a);
            AbstractC3506b.a(item.f8900b, Boolean.TRUE, mVar8, a15.toString());
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View inflate = inflater.inflate(I1.c.f3857h, viewGroup, false);
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.f1008m = (ConstraintLayout) view.findViewById(I1.b.f3750L);
        this.f1009n = (RecyclerView) view.findViewById(I1.b.f3764S);
        l lVar = this.f1010o;
        l lVar2 = null;
        if (lVar == null) {
            AbstractC3159y.y("viewModel");
        ...
        if (textView != null) {
            ...
            textView.setText(I7.b.a(lVar3.f1020a.a().f5667a));
        }
        ...
        if (imageView != null) {
            ...
            imageView.setContentDescription(lVar4.f1020a.a().f5673g);
        }
        r();
        ...
        if (searchView3 != null) {
            ...
            searchView3.setQueryHint(lVar5.f1020a.a().f5669c);
        }
        ...
        String str = lVar7.f1020a.a().f5668b;
        ...
        this.f1011p = new R7.a(c8, this, str, null, num, num2, num3, num4, this.f8370k, this.f8371l, 8);
        ...
        if (lVar2.f1030k && (searchView = this.f8364e) != null) {
    ...
    public final void r() {
        ...
        if (!((ArrayList) lVar.f()).isEmpty() || !((ArrayList) lVar.b()).isEmpty()) {
            ...
            View inflate = LayoutInflater.from(getContext()).inflate(I1.c.f3871v, (ViewGroup) null);
            ...
            final TextView textView4 = (TextView) inflate.findViewById(I1.b.f3763R0);
            l lVar3 = this.f1010o;
            if (lVar3 == null) {
                AbstractC3159y.y("viewModel");
                lVar3 = null;
