...
public final class C3045v extends AbstractC1310g {
    ...
    private final int f32701J;

    /* renamed from: K, reason: collision with root package name */
    private final String f32702K;

    /* renamed from: L, reason: collision with root package name */
    private final int f32703L;

    /* renamed from: M, reason: collision with root package name */
    private final boolean f32704M;
    ...
    private final Bundle o0() {
        String packageName = this.f32700I.getPackageName();
        Bundle bundle = new Bundle();
        bundle.putInt("com.google.android.gms.wallet.EXTRA_ENVIRONMENT", this.f32701J);
        bundle.putBoolean("com.google.android.gms.wallet.EXTRA_USING_ANDROID_PAY_BRAND", this.f32704M);
        bundle.putString("androidPackageName", packageName);
        String str = this.f32702K;
        if (!TextUtils.isEmpty(str)) {
            bundle.putParcelable("com.google.android.gms.wallet.EXTRA_BUYER_ACCOUNT", new Account(str, "com.google"));
        }
        bundle.putInt("com.google.android.gms.wallet.EXTRA_THEME", this.f32703L);
        return bundle;
    }
    ...
    public final void m0(C3715e c3715e, C3679j c3679j) {
        ...
        try {
            ...
            binderC3043t.w(Status.f15077h, false, Bundle.EMPTY);
        }
    }
    ...
    public final void n0(C3720j c3720j, C3679j c3679j) {
        ...
        try {
            ...
            binderC3044u.a0(Status.f15077h, null, Bundle.EMPTY);
        }
    }
