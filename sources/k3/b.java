...
public abstract class b {
    ...
    public static final class a extends AbstractC3160z implements n {
        ...
        public final void invoke(Composer composer, int i8) {
            b.a(composer, RecomposeScopeImplKt.updateChangedFlags(this.f5926a | 1));
        }
    }
    ...
    public static final void a(Composer composer, int i8) {
        ...
        if (i8 == 0 && startRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(SizeKt.m636requiredHeight3ABfNKs(Modifier.Companion, PrimitiveResources_androidKt.dimensionResource(s.f37367a, startRestartGroup, 0)), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
