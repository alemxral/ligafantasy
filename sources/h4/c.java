...
public final class c extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(g viewHolder, int i8) {
        ...
        CheckBox checkBox = viewHolder.f8746a;
        ArrayList arrayList = this.f3514b;
        AbstractC3159y.f(arrayList);
        checkBox.setText(((d) arrayList.get(i8)).c());
        CheckBox checkBox2 = viewHolder.f8746a;
        ArrayList arrayList2 = this.f3514b;
        AbstractC3159y.f(arrayList2);
        checkBox2.setChecked(((d) arrayList2.get(i8)).a());
        CheckBox checkBox3 = viewHolder.f8746a;
        ArrayList arrayList3 = this.f3514b;
    ...
    public g onCreateViewHolder(ViewGroup viewGroup, int i8) {
        ...
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(f.f2198v, viewGroup, false);
        AbstractC3159y.h(itemView, "itemView");
        return new g(itemView, this.f3513a);
    }
