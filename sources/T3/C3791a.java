...
public final class C3791a {
    ...
    public static final b f38215d = new b(null);

    /* renamed from: e, reason: collision with root package name */
    public static final int f38216e = 8;

    /* renamed from: a, reason: collision with root package name */
    private final SavedStateHandle f38217a;

    /* renamed from: b, reason: collision with root package name */
    private final EventReporter f38218b;

    /* renamed from: c, reason: collision with root package name */
    private final Function0 f38219c;
    ...
    static final class C0882a extends l implements n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ InterfaceC3358f f38221b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ C3791a f38222c;
        ...
        public static final class C0883a extends l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            /* synthetic */ Object f38224b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ C3791a f38225c;
            ...
            public final d create(Object obj, d dVar) {
                C0883a c0883a = new C0883a(this.f38225c, dVar);
                c0883a.f38224b = obj;
                return c0883a;
            }
            ...
            public final Object invoke(InterfaceC4021c interfaceC4021c, d dVar) {
                return ((C0883a) create(interfaceC4021c, dVar)).invokeSuspend(I.f6474a);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.f38223a == 0) {
                    t.b(obj);
                    this.f38225c.i((InterfaceC4021c) this.f38224b);
                    return I.f6474a;
                }
        ...
        C0882a(InterfaceC3358f interfaceC3358f, C3791a c3791a, d dVar) {
            super(2, dVar);
            this.f38221b = interfaceC3358f;
            this.f38222c = c3791a;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final d create(Object obj, d dVar) {
            return new C0882a(this.f38221b, this.f38222c, dVar);
        }

        @Override // X5.n
        public final Object invoke(M m8, d dVar) {
            return ((C0882a) create(m8, dVar)).invokeSuspend(I.f6474a);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                t.b(obj);
                InterfaceC3358f interfaceC3358f = this.f38221b;
                C0883a c0883a = new C0883a(this.f38222c, null);
                this.f38220a = 1;
    ...
    public C3791a(SavedStateHandle savedStateHandle, EventReporter eventReporter, InterfaceC3358f currentScreen, M coroutineScope, Function0 currentPaymentMethodTypeProvider) {
        ...
        this.f38217a = savedStateHandle;
        this.f38218b = eventReporter;
        this.f38219c = currentPaymentMethodTypeProvider;
        AbstractC2829k.d(coroutineScope, null, null, new C0882a(currentScreen, this, null), 3, null);
    }

    private final String c() {
        return (String) this.f38217a.get("previously_interacted_payment_form");
    }

    private final boolean d() {
        Boolean bool = (Boolean) this.f38217a.get("previously_sent_deep_link_event");
        if (bool != null) {
    ...
    private final String e() {
        return (String) this.f38217a.get("previously_shown_payment_form");
    }
    ...
    private final void j(String str) {
        this.f38217a.set("previously_interacted_payment_form", str);
    }

    private final void k(boolean z8) {
        this.f38217a.set("previously_sent_deep_link_event", Boolean.valueOf(z8));
    }

    private final void l(String str) {
        this.f38217a.set("previously_shown_payment_form", str);
    }
