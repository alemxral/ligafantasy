...
public final class C3825a implements Parcelable {
    ...
    public static final class C0892a implements C {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final C0892a f38757a;

        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f38758b;
        ...
        @Override // x6.C
        public t6.b[] d() {
            return new t6.b[]{C3826b.a.f38763a, r0.f39581a};
        }
        ...
        public C3825a c(w6.e decoder) {
            ...
            n0 n0Var = null;
            if (d8.z()) {
                c3826b = (C3826b) d8.r(a8, 0, C3826b.a.f38763a, null);
                str = d8.q(a8, 1);
                i8 = 3;
            } else {
                c3826b = null;
                ...
                while (z8) {
                    ...
                    if (p8 != -1) {
                        if (p8 != 0) {
                            ...
                            c3826b = (C3826b) d8.r(a8, 0, C3826b.a.f38763a, c3826b);
                            i9 |= 1;
                        }
                    } else {
                        z8 = false;
    ...
    public /* synthetic */ C3825a(int i8, C3826b c3826b, String str, n0 n0Var) {
        if (3 != (i8 & 3)) {
            AbstractC3942d0.a(i8, 3, C0892a.f38757a.a());
        }
        this.f38755a = c3826b;
        this.f38756b = str;
    }
    ...
    public static final /* synthetic */ void f(C3825a c3825a, w6.d dVar, v6.f fVar) {
        dVar.A(fVar, 0, C3826b.a.f38763a, c3825a.f38755a);
        dVar.y(fVar, 1, c3825a.f38756b);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3159y.d(this.f38755a, c3825a.f38755a) && AbstractC3159y.d(this.f38756b, c3825a.f38756b)) {
            return true;
        }
        return false;
    }
    ...
    public void writeToParcel(Parcel out, int i8) {
        ...
        this.f38755a.writeToParcel(out, i8);
