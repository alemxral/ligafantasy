...
public final class b {
    ...
    private final Map f11876a = new LinkedHashMap();
    ...
    public static final class a extends AbstractC3160z implements o {
        ...
        public final void a(String it, Composer composer, int i8) {
            ...
            this.f11877a.invoke(composer, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final b a(String id, long j8, long j9, int i8, n content) {
        ...
        this.f11876a.put(id, new InlineTextContent(new Placeholder(j8, j9, i8, null), ComposableLambdaKt.composableLambdaInstance(-254047745, true, new a(content))));
        return this;
    }

    public final b c(String id, long j8, int i8) {
        AbstractC3159y.i(id, "id");
        a(id, j8, TextUnitKt.getEm(0), i8, V2.a.f11873a.a());
        return this;
    }
