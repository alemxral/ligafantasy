...
public final class d {
    ...
    private final List g(Locale locale) {
        Object obj;
        if (AbstractC3159y.d(locale, f38768d)) {
            return f38769e;
        }
        f38768d = locale;
        List i8 = i(locale);
        ...
        f38769e = AbstractC1246t.G0(q8, AbstractC1246t.P0(arrayList, new a()));
        return f38769e;
    }

    private final List i(Locale locale) {
        Set<String> set = f38766b;
    ...
    public final /* synthetic */ boolean b(C3826b countryCode) {
        AbstractC3159y.i(countryCode, "countryCode");
        return f38767c.contains(countryCode.c());
    }
