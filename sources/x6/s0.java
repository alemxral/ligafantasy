...
public abstract class s0 implements w6.e, w6.c {
    ...
    private final ArrayList f39584a = new ArrayList();
    ...
    static final class a extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ InterfaceC3796a f39587b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Object f39588c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(InterfaceC3796a interfaceC3796a, Object obj) {
            super(0);
            this.f39587b = interfaceC3796a;
            this.f39588c = obj;
        }
        ...
        public final Object invoke() {
            s0 s0Var = s0.this;
            InterfaceC3796a interfaceC3796a = this.f39587b;
            Object obj = this.f39588c;
    ...
    static final class b extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ InterfaceC3796a f39590b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Object f39591c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(InterfaceC3796a interfaceC3796a, Object obj) {
            super(0);
            this.f39590b = interfaceC3796a;
            this.f39591c = obj;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return s0.this.I(this.f39590b, this.f39591c);
        }
    }
    ...
    public final Object U() {
        return AbstractC1246t.z0(this.f39584a);
    }

    protected abstract Object V(v6.f fVar, int i8);

    protected final Object W() {
        ArrayList arrayList = this.f39584a;
