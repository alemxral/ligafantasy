...
public final class C3963x implements t6.b {
    ...
    private final Enum[] f39614a;

    /* renamed from: b, reason: collision with root package name */
    private v6.f f39615b;

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC1227k f39616c;
    ...
    static final class a extends AbstractC3160z implements Function0 {
        ...
        public final v6.f invoke() {
            v6.f fVar = C3963x.this.f39615b;
            if (fVar == null) {
                return C3963x.this.h(this.f39618b);
            }
            return fVar;
        }
    }
    ...
    public C3963x(String serialName, Enum[] values) {
        ...
        this.f39614a = values;
        this.f39616c = L5.l.b(new a(serialName));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final v6.f h(String str) {
        C3962w c3962w = new C3962w(str, this.f39614a.length);
        for (Enum r02 : this.f39614a) {
    ...
    public v6.f a() {
        return (v6.f) this.f39616c.getValue();
    }
    ...
    public Enum c(w6.e decoder) {
        ...
        int l8 = decoder.l(a());
        if (l8 >= 0) {
            Enum[] enumArr = this.f39614a;
            if (l8 < enumArr.length) {
                return enumArr[l8];
            }
        }
        throw new t6.h(l8 + " is not among valid " + a().a() + " enum values, values size is " + this.f39614a.length);
    }
    ...
    public void e(w6.f encoder, Enum value) {
        ...
        int p02 = AbstractC1239l.p0(this.f39614a, value);
        if (p02 != -1) {
            encoder.e(a(), p02);
            return;
        }
        ...
        String arrays = Arrays.toString(this.f39614a);
