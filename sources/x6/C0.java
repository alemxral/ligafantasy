...
public final class C0 extends h0 {
    ...
    public short[] f() {
        short[] copyOf = Arrays.copyOf(this.f39487a, d());
        AbstractC3159y.h(copyOf, "copyOf(...)");
    ...
    private C0(short[] bufferWithData) {
        ...
        this.f39487a = bufferWithData;
        this.f39488b = L5.G.s(bufferWithData);
        b(10);
    }
}
