        ...
        if (d8.z()) {
            ...
            while (true) {
                ...
                if (p8 != -1) {
                    ...
                    throw new IllegalArgumentException(("Polymorphic value has not been read for class " + ((String) t8.f33747a)).toString());
                }
            }
        }
        d8.a(a8);
