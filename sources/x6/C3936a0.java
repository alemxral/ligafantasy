...
public final class C3936a0 implements t6.b {
    ...
    private final Object f39525a;

    /* renamed from: b, reason: collision with root package name */
    private List f39526b;

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC1227k f39527c;
    ...
    static final class a extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C3936a0 f39529b;
        ...
        a(String str, C3936a0 c3936a0) {
            super(0);
            this.f39528a = str;
            this.f39529b = c3936a0;
        }

        @Override // kotlin.jvm.functions.Function0
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final v6.f invoke() {
            return v6.i.b(this.f39528a, k.d.f38910a, new v6.f[0], new C0913a(this.f39529b));
        }
    }
    ...
    public C3936a0(String serialName, Object objectInstance) {
        ...
        this.f39525a = objectInstance;
        this.f39526b = AbstractC1246t.m();
        this.f39527c = L5.l.a(L5.o.f6492b, new a(serialName, this));
    }

    @Override // t6.b, t6.i, t6.InterfaceC3796a
    public v6.f a() {
        return (v6.f) this.f39527c.getValue();
    }
    ...
    public C3936a0(String serialName, Object objectInstance, Annotation[] classAnnotations) {
        ...
        this.f39526b = AbstractC1239l.c(classAnnotations);
    }
}
