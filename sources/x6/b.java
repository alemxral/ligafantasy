...
public class b extends AbstractC1346m {
    ...
    public b(AbstractC1353u abstractC1353u) {
        if (abstractC1353u.size() == 2) {
            ...
            this.f12737a = a.p(y8.nextElement());
            this.f12738b = Q.C(y8.nextElement());
        } else {
    ...
    public AbstractC1351s d() {
        ...
        c1337e.a(this.f12737a);
        c1337e.a(this.f12738b);
    ...
    public AbstractC1351s r() {
        return AbstractC1351s.s(this.f12738b.y());
    }

    public b(a aVar, InterfaceC1335d interfaceC1335d) {
        this.f12738b = new Q(interfaceC1335d);
        this.f12737a = aVar;
    }

    public b(a aVar, byte[] bArr) {
        this.f12738b = new Q(bArr);
        this.f12737a = aVar;
    }
}
