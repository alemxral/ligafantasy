...
public class C3944e0 implements v6.f, InterfaceC3952l {
    ...
    private final List[] f39538f;

    /* renamed from: g, reason: collision with root package name */
    private List f39539g;
    ...
    private final InterfaceC1227k f39542j;

    /* renamed from: k, reason: collision with root package name */
    private final InterfaceC1227k f39543k;

    /* renamed from: l, reason: collision with root package name */
    private final InterfaceC1227k f39544l;
    ...
    public C3944e0(String serialName, C c8, int i8) {
        ...
        this.f39538f = new List[i10];
        this.f39540h = new boolean[i10];
        this.f39541i = M5.Q.h();
        L5.o oVar = L5.o.f6492b;
        this.f39542j = L5.l.a(oVar, new b());
        this.f39543k = L5.l.a(oVar, new d());
        this.f39544l = L5.l.a(oVar, new a());
    }
    ...
    private final Map m() {
        ...
        int length = this.f39537e.length;
        for (int i8 = 0; i8 < length; i8++) {
            hashMap.put(this.f39537e[i8], Integer.valueOf(i8));
        }
        return hashMap;
    }

    private final t6.b[] n() {
        return (t6.b[]) this.f39542j.getValue();
    }

    private final int p() {
        return ((Number) this.f39544l.getValue()).intValue();
    }
    ...
    public int d(String name) {
        ...
        Integer num = (Integer) this.f39541i.get(name);
        if (num != null) {
            return num.intValue();
        }
        return -3;
    ...
    public String f(int i8) {
        return this.f39537e[i8];
    }

    @Override // v6.f
    public List g(int i8) {
        List list = this.f39538f[i8];
        if (list == null) {
    ...
    public final void k(String name, boolean z8) {
        AbstractC3159y.i(name, "name");
        String[] strArr = this.f39537e;
        int i8 = this.f39536d + 1;
        this.f39536d = i8;
        strArr[i8] = name;
        this.f39540h[i8] = z8;
        this.f39538f[i8] = null;
        if (i8 == this.f39535c - 1) {
            this.f39541i = m();
        }
    }

    public final v6.f[] o() {
        return (v6.f[]) this.f39543k.getValue();
    }

    public final void q(Annotation annotation) {
        AbstractC3159y.i(annotation, "annotation");
        List list = this.f39538f[this.f39536d];
        if (list == null) {
            list = new ArrayList(1);
            this.f39538f[this.f39536d] = list;
        }
        list.add(annotation);
    }
    ...
    public String toString() {
        return AbstractC1246t.w0(d6.m.s(0, this.f39535c), ", ", a() + '(', ")", 0, null, new c(), 24, null);
    }
