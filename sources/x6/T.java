...
public abstract class T extends AbstractC3935a {
    ...
    private final t6.b f39514a;

    /* renamed from: b, reason: collision with root package name */
    private final t6.b f39515b;
    ...
    public final void m(w6.c decoder, int i8, Map builder, boolean z8) {
        ...
        AbstractC3159y.i(decoder, "decoder");
        AbstractC3159y.i(builder, "builder");
        Object c9 = c.a.c(decoder, a(), i8, this.f39514a, null, 8, null);
        if (z8) {
            i9 = decoder.p(a());
            if (i9 != i8 + 1) {
        ...
        int i10 = i9;
        if (builder.containsKey(c9) && !(this.f39515b.a().getKind() instanceof v6.e)) {
            c8 = decoder.r(a(), i10, this.f39515b, M5.Q.i(builder, c9));
        } else {
            c8 = c.a.c(decoder, a(), i10, this.f39515b, null, 8, null);
        }
        builder.put(c9, c8);
    }
