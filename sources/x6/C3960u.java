...
public final class C3960u implements t6.b {
    ...
    public static final C3960u f39596a = new C3960u();

    /* renamed from: b, reason: collision with root package name */
    private static final v6.f f39597b = new k0("kotlin.time.Duration", e.i.f38883a);
    ...
    public long f(w6.e decoder) {
        ...
        return C2758a.f31395b.c(decoder.t());
    }
