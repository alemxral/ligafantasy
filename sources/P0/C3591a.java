...
public class C3591a extends AbstractC1310g implements InterfaceC3523e {
    ...
    private final boolean f36951I;

    /* renamed from: J, reason: collision with root package name */
    private final C1307d f36952J;

    /* renamed from: K, reason: collision with root package name */
    private final Bundle f36953K;
    ...
    protected final Bundle A() {
        if (!y().getPackageName().equals(this.f36952J.f())) {
            this.f36953K.putString("com.google.android.gms.signin.internal.realClientPackageName", this.f36952J.f());
        }
        return this.f36953K;
    }
    ...
    public final void a(f fVar) {
        ...
        try {
            Account c8 = this.f36952J.c();
            if ("<<default account>>".equals(c8.name)) {
                googleSignInAccount = L.c.b(y()).c();
            } else {
                googleSignInAccount = null;
            }
            ((g) D()).m0(new j(1, new M(c8, ((Integer) AbstractC1319p.l(this.f36954L)).intValue(), googleSignInAccount)), fVar);
