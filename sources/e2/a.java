...
public abstract class a {
    ...
    public static final class C0032a extends AbstractC3160z implements Function0 {
        ...
        final /* synthetic */ Function1 f1926a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C0032a(Function1 function1) {
            super(0);
            this.f1926a = function1;
        }
        ...
        public final void m5invoke() {
            this.f1926a.invoke(c.h.f23550a);
        }
    }
    ...
    public static final class b extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function1 f1927a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Function1 function1) {
            super(0);
            this.f1927a = function1;
        }
        ...
        public final void m6invoke() {
            this.f1927a.invoke(c.d.f23545a);
        }
    }
    ...
    public static final class c extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ e.a f1928a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1 f1929b;
        ...
        public static final class C0033a extends AbstractC3160z implements Function1 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ Function1 f1930a;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0033a(Function1 function1) {
                super(1);
                this.f1930a = function1;
            }

            public final void a(X2.g it) {
                AbstractC3159y.i(it, "it");
                this.f1930a.invoke(new c.b(it));
            }
        ...
        public static final class b extends AbstractC3160z implements Function1 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ Function1 f1931a;
            ...
            public final void a(w3.c cVar) {
                this.f1931a.invoke(new c.k(cVar));
            }
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            boolean p8 = this.f1928a.p();
            List z8 = this.f1928a.z();
            String v8 = this.f1928a.v();
            List s8 = this.f1928a.s();
            composer.startReplaceableGroup(936314931);
            boolean changed = composer.changed(this.f1929b);
            Function1 function1 = this.f1929b;
            ...
            A3.a r8 = this.f1928a.r();
            B3.d A8 = this.f1928a.A();
            composer.startReplaceableGroup(936324640);
            boolean changed2 = composer.changed(this.f1929b);
            Function1 function13 = this.f1929b;
    ...
    public static final class d extends AbstractC3160z implements Function0 {
        ...
        public final void m7invoke() {
            this.f1932a.invoke(c.o.f23559a);
        }
    }
    ...
    public static final class e extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ e.a f1933a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1 f1934b;
        ...
        public final void invoke(Composer composer, int i8) {
            a.a(this.f1933a, this.f1934b, this.f1935c, composer, RecomposeScopeImplKt.updateChangedFlags(this.f1936d | 1));
        }
    }
    ...
    public static final class g extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.customersheet.e f1938a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1 f1939b;
        ...
        public static final class C0034a extends AbstractC3160z implements Function0 {
            ...
            public final void m8invoke() {
                this.f1940a.invoke(c.i.f23551a);
            }
        }
        ...
        public static final class b extends AbstractC3160z implements Function0 {
            ...
            public final void m9invoke() {
                this.f1941a.invoke(c.C0462c.f23544a);
            }
        }
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            com.stripe.android.customersheet.e eVar = this.f1938a;
            composer.startReplaceableGroup(-1288185518);
            boolean changed = composer.changed(this.f1939b);
            Function1 function1 = this.f1939b;
            Object rememberedValue = composer.rememberedValue();
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            ...
            boolean z8 = !this.f1938a.g();
            composer.startReplaceableGroup(-1288179488);
            boolean changed2 = composer.changed(this.f1939b);
            Function1 function12 = this.f1939b;
            Object rememberedValue2 = composer.rememberedValue();
            if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
    ...
    public static final class h extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.customersheet.e f1942a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1 f1943b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function1 f1944c;
        ...
        h(com.stripe.android.customersheet.e eVar, Function1 function1, Function1 function12, boolean z8) {
            super(2);
            this.f1942a = eVar;
            this.f1943b = function1;
            this.f1944c = function12;
            this.f1945d = z8;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            com.stripe.android.customersheet.e eVar = this.f1942a;
            Function1 function1 = this.f1943b;
            Function1 function12 = this.f1944c;
            boolean z8 = this.f1945d;
    ...
    public static final class i extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.customersheet.e f1946a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ boolean f1947b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Modifier f1948c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function1 f1949d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Function1 f1950e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ int f1951f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f1952g;
        ...
        i(com.stripe.android.customersheet.e eVar, boolean z8, Modifier modifier, Function1 function1, Function1 function12, int i8, int i9) {
            ...
            this.f1946a = eVar;
            this.f1947b = z8;
            this.f1948c = modifier;
            this.f1949d = function1;
            this.f1950e = function12;
            this.f1951f = i8;
            this.f1952g = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            a.b(this.f1946a, this.f1947b, this.f1948c, this.f1949d, this.f1950e, composer, RecomposeScopeImplKt.updateChangedFlags(this.f1951f | 1), this.f1952g);
        }
    }
    ...
    public static final class j extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ e.b f1953a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Modifier f1954b;
        ...
        public final void invoke(Composer composer, int i8) {
            a.c(this.f1953a, this.f1954b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f1955c | 1), this.f1956d);
        }
    }
    ...
    public static final class k extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function1 f1957a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        k(Function1 function1) {
            super(0);
            this.f1957a = function1;
        }
        ...
        public final void m10invoke() {
            this.f1957a.invoke(c.a.f23542a);
        }
    }
    ...
    public static final class l extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function1 f1958a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        l(Function1 function1) {
            super(1);
            this.f1958a = function1;
        }

        public final void a(AbstractC3991f abstractC3991f) {
            this.f1958a.invoke(new c.m(abstractC3991f));
        }
    ...
    public static final class o extends AbstractC3160z implements Function0 {
        ...
        public final void m11invoke() {
            this.f1961a.invoke(c.o.f23559a);
        }
    }
    ...
    public static final class p extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ e.d f1962a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1 f1963b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function1 f1964c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Modifier f1965d;
        ...
        p(e.d dVar, Function1 function1, Function1 function12, Modifier modifier, int i8, int i9) {
            super(2);
            this.f1962a = dVar;
            this.f1963b = function1;
            this.f1964c = function12;
            this.f1965d = modifier;
            this.f1966e = i8;
            this.f1967f = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            a.d(this.f1962a, this.f1963b, this.f1964c, this.f1965d, composer, RecomposeScopeImplKt.updateChangedFlags(this.f1966e | 1), this.f1967f);
        }
    }
    ...
    public static final void a(e.a viewState, Function1 viewActionHandler, boolean z8, Composer composer, int i8) {
        ...
        float dimensionResource = PrimitiveResources_androidKt.dimensionResource(s.f37371e, startRestartGroup, 0);
        startRestartGroup.startReplaceableGroup(1183625317);
        if (viewState.n()) {
            String stringResource = StringResources_androidKt.stringResource(w.f37444g, startRestartGroup, 0);
            String stringResource2 = StringResources_androidKt.stringResource(w.f37442f, startRestartGroup, 0);
            String stringResource3 = StringResources_androidKt.stringResource(w.f37410E, startRestartGroup, 0);
            String stringResource4 = StringResources_androidKt.stringResource(AbstractC3053E.f32849V, startRestartGroup, 0);
        ...
        String stringResource5 = StringResources_androidKt.stringResource(w.f37435b0, composer3, 0);
    ...
    public static final void c(e.b bVar, Modifier modifier, Composer composer, int i8, int i9) {
        ...
        ColumnScopeInstance columnScopeInstance = ColumnScopeInstance.INSTANCE;
        AbstractC2612h0.a(StringResources_androidKt.stringResource(AbstractC3053E.f32837L0, startRestartGroup, 0), PaddingKt.m602paddingVpY3zN4$default(PaddingKt.m604paddingqDBjuR0$default(Modifier.Companion, 0.0f, 0.0f, 0.0f, Dp.m5178constructorimpl(20), 7, null), dimensionResource, 0.0f, 2, null), startRestartGroup, 0, 0);
    ...
    public static final void d(e.d viewState, Function1 viewActionHandler, Function1 paymentMethodNameProvider, Modifier modifier, Composer composer, int i8, int i9) {
        ...
        if (s8 == null) {
            s8 = StringResources_androidKt.stringResource(w.f37415J, startRestartGroup, 0);
        }
        startRestartGroup.endReplaceableGroup();
        ...
        q3.o a9 = r.f26334a.a(viewState.d(), viewState.t(), false, viewState.o(), paymentMethodNameProvider, viewState.l(), viewState.c() instanceof InterfaceC1925a.b);
        List a10 = a9.a();
