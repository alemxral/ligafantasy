...
public abstract class g {
    ...
    public static final class a extends AbstractC3160z implements n {
        ...
        final /* synthetic */ Modifier f37596a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ o f37597b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ int f37598c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ int f37599d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(Modifier modifier, o oVar, int i8, int i9) {
            super(2);
            this.f37596a = modifier;
            this.f37597b = oVar;
            this.f37598c = i8;
            this.f37599d = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            g.a(this.f37596a, this.f37597b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f37598c | 1), this.f37599d);
        }
    }
