...
public final class C3665a implements InterfaceC3667c {
    ...
    private final View f37475a;

    /* renamed from: b, reason: collision with root package name */
    private final Window f37476b;

    /* renamed from: c, reason: collision with root package name */
    private final WindowInsetsControllerCompat f37477c;
    ...
    public C3665a(View view, Window window) {
        ...
        this.f37477c = windowInsetsControllerCompat;
    }
    ...
    public void a(long j8, boolean z8, boolean z9, Function1 transformColorForLightContent) {
        ...
        d(z8);
        c(z9);
        Window window = this.f37476b;
        if (window != null) {
            if (z8 && ((windowInsetsControllerCompat = this.f37477c) == null || !windowInsetsControllerCompat.isAppearanceLightNavigationBars())) {
    ...
    public void b(long j8, boolean z8, Function1 transformColorForLightContent) {
        ...
        Window window = this.f37476b;
        if (window != null) {
            if (z8 && ((windowInsetsControllerCompat = this.f37477c) == null || !windowInsetsControllerCompat.isAppearanceLightStatusBars())) {
                j8 = ((Color) transformColorForLightContent.invoke(Color.m2961boximpl(j8))).m2981unboximpl();
            }
    ...
    public void c(boolean z8) {
        Window window;
        if (Build.VERSION.SDK_INT >= 29 && (window = this.f37476b) != null) {
            window.setNavigationBarContrastEnforced(z8);
        }
    }

    public void d(boolean z8) {
        WindowInsetsControllerCompat windowInsetsControllerCompat = this.f37477c;
