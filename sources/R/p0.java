...
public final class p0 implements Handler.Callback {
    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i8 == 1) {
            hashMap4 = this.f8587a.f8591f;
            synchronized (hashMap4) {
                try {
                    l0 l0Var2 = (l0) message.obj;
                    hashMap5 = this.f8587a.f8591f;
