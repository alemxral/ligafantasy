...
public final class C3149n implements InterfaceC2643c, InterfaceC3148m {
    ...
    private static final Map f33768c;

    /* renamed from: d, reason: collision with root package name */
    private static final HashMap f33769d;

    /* renamed from: e, reason: collision with root package name */
    private static final HashMap f33770e;

    /* renamed from: f, reason: collision with root package name */
    private static final HashMap f33771f;

    /* renamed from: g, reason: collision with root package name */
    private static final Map f33772g;

    /* renamed from: a, reason: collision with root package name */
    private final Class f33773a;
    ...
    public static final class a {
        ...
        public final String a(Class jClass) {
            ...
            if (jClass.isArray()) {
                ...
                if (componentType.isPrimitive() && (str = (String) C3149n.f33771f.get(componentType.getName())) != null) {
                    str2 = str + "Array";
                }
                if (str2 == null) {
                    return "kotlin.Array";
            ...
            String str3 = (String) C3149n.f33771f.get(jClass.getName());
            if (str3 == null) {
    ...
    static {
        ...
        for (Map.Entry entry : f33768c.entrySet()) {
