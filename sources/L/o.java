...
public abstract class o {
    ...
    private static final U.a f6018a = new U.a("GoogleSignInCommon", new String[0]);

    public static Intent a(Context context, GoogleSignInOptions googleSignInOptions) {
        f6018a.a("getFallbackSignInIntent()", new Object[0]);
    ...
    public static Intent b(Context context, GoogleSignInOptions googleSignInOptions) {
        f6018a.a("getNoImplementationSignInIntent()", new Object[0]);
        Intent c8 = c(context, googleSignInOptions);
    ...
    public static Intent c(Context context, GoogleSignInOptions googleSignInOptions) {
        f6018a.a("getSignInIntent()", new Object[0]);
    ...
    public static K.b d(Intent intent) {
        if (intent == null) {
            return new K.b(null, Status.f15077h);
        }
        Status status = (Status) intent.getParcelableExtra("googleSignInStatus");
        GoogleSignInAccount googleSignInAccount = (GoogleSignInAccount) intent.getParcelableExtra("googleSignInAccount");
        if (googleSignInAccount == null) {
            if (status == null) {
                status = Status.f15077h;
            }
            return new K.b(null, status);
        }
        return new K.b(googleSignInAccount, Status.f15075f);
    }

    public static P.g e(P.f fVar, Context context, boolean z8) {
        f6018a.a("Revoking access", new Object[0]);
    ...
    public static P.g f(P.f fVar, Context context, boolean z8) {
        f6018a.a("Signing out", new Object[0]);
        g(context);
        if (z8) {
            return P.h.b(Status.f15075f, fVar);
        }
