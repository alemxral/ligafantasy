...
public final class C3652e implements q {
    ...
    public static final a f37298e = new a(null);

    /* renamed from: f, reason: collision with root package name */
    public static final int f37299f = 8;
    ...
    private final P5.g f37302c;

    /* renamed from: d, reason: collision with root package name */
    private final InterfaceC1227k f37303d;
    ...
    static final class b extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            return new b(this.f37306c, this.f37307d, dVar);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r9) {
            ...
            L4a:
                ...
                goto L83
            L53:
                y3.i$b r9 = y3.i.b.f39814a
                boolean r0 = r8.f37307d
                if (r0 == 0) goto L83
            L59:
                r1 = r9
                goto L83
            ...
            L73:
                ...
                goto L83
            L7c:
                y3.i$a r9 = y3.i.a.f39813a
                boolean r0 = r8.f37306c
                if (r0 == 0) goto L83
                goto L59
            L83:
                if (r1 != 0) goto L87
                y3.i$c r1 = y3.i.c.f39815a
            L87:
                return r1
            L88:
    ...
    static final class c extends AbstractC3160z implements Function0 {
        ...
        public final SharedPreferences invoke() {
            return C3652e.this.f37300a.getSharedPreferences("DefaultPrefsRepository", 0);
        }
    }
    ...
    public C3652e(Context context, String str, P5.g workContext) {
        ...
        this.f37301b = str;
        this.f37302c = workContext;
        this.f37303d = L5.l.b(new c());
    }
    ...
    public final SharedPreferences h() {
        Object value = this.f37303d.getValue();
    ...
    public void a(AbstractC3991f abstractC3991f) {
        ...
        if (AbstractC3159y.d(iVar, i.a.f39813a)) {
            str = "google_pay";
        } else if (AbstractC3159y.d(iVar, i.b.f39814a)) {
            str = "link";
    ...
    public Object b(boolean z8, boolean z9, P5.d dVar) {
        return AbstractC2825i.g(this.f37302c, new b(z8, z9, null), dVar);
    }
}
