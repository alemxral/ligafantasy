...
public final class d implements ViewBinding {
    ...
    public static d d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z8) {
        View inflate = layoutInflater.inflate(P3.e.f7956d, viewGroup, false);
        if (z8) {
