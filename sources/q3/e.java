...
public final class e implements ViewBinding {
    ...
    private final LinearLayout f8215a;

    /* renamed from: b, reason: collision with root package name */
    public final ThreeDS2TextView f8216b;

    /* renamed from: c, reason: collision with root package name */
    public final LinearLayout f8217c;

    private e(LinearLayout linearLayout, ThreeDS2TextView threeDS2TextView, LinearLayout linearLayout2) {
        this.f8215a = linearLayout;
        this.f8216b = threeDS2TextView;
        this.f8217c = linearLayout2;
    }
    ...
    public static e c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z8) {
        View inflate = layoutInflater.inflate(P3.e.f7957e, viewGroup, false);
        if (z8) {
