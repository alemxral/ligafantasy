...
public final class C3658k {
    ...
    public final List b(String code) {
        ...
        Y2.d dVar = this.f37324b;
        InterfaceC3167b.a aVar = this.f37323a;
        K2.e eVar = this.f37327e;
        Function1 function1 = this.f37328f;
        if (jVar != null) {
            pVar = jVar.c();
        } else {
            pVar = null;
    ...
    public final void c(w3.c cVar, String selectedPaymentMethodCode) {
        ...
        if (cVar != null) {
            abstractC3991f = AbstractC1195c.g(cVar, e(selectedPaymentMethodCode), this.f37324b);
        } else {
            abstractC3991f = null;
        }
        this.f37326d.invoke(abstractC3991f);
    }
