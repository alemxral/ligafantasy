...
public class C4012b implements InterfaceC4011a {
    ...
    private static volatile InterfaceC4011a f40023c;

    /* renamed from: a, reason: collision with root package name */
    final C3162a f40024a;
    ...
    C4012b(C3162a c3162a) {
        ...
        this.f40024a = c3162a;
        this.f40025b = new ConcurrentHashMap();
    }
            ...
            synchronized (C4012b.class) {
                try {
                    if (f40023c == null) {
                        ...
                        f40023c = new C4012b(X0.r(context, null, null, null, bundle).o());
                    }
                } finally {
                }
            }
    ...
    private final boolean f(String str) {
        if (!str.isEmpty() && this.f40025b.containsKey(str) && this.f40025b.get(str) != null) {
            return true;
        }
        return false;
    }
    ...
    public void b(String str, String str2, Bundle bundle) {
        ...
        if (com.google.firebase.analytics.connector.internal.b.d(str) && com.google.firebase.analytics.connector.internal.b.b(str2, bundle) && com.google.firebase.analytics.connector.internal.b.a(str, str2, bundle)) {
            ...
            this.f40024a.a(str, str2, bundle);
        }
    }
