...
public final class C3744b {
    ...
    private static final a f37827b = new a(null);
    ...
    private final boolean b() {
        ...
        try {
            s.a aVar = s.f6498b;
            b8 = s.b(Boolean.valueOf(CustomTabsClient.bindCustomTabsService(this.f37828a, "com.android.chrome", new C0872b())));
        } catch (Throwable th) {
            s.a aVar2 = s.f6498b;
            b8 = s.b(t.a(th));
        }
    ...
    public final EnumC3743a a() {
        if (b()) {
            return EnumC3743a.f37823a;
        }
        return EnumC3743a.f37824b;
    }
}
