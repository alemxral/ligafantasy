...
public abstract class b implements Parcelable {
    ...
    public static final class a extends b {
        ...
        public String b(Resources resources) {
            ...
            String string = resources.getString(this.f8965a);
        ...
        public boolean equals(Object obj) {
            ...
            if ((obj instanceof a) && this.f8965a == ((a) obj).f8965a) {
                return true;
            }
            return false;
        }
        ...
        public String toString() {
            return "FromResources(stringResId=" + this.f8965a + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeInt(this.f8965a);
        }
    }
    ...
    public static final class C0185b extends b {
        ...
        public boolean equals(Object obj) {
            ...
            if ((obj instanceof C0185b) && AbstractC3159y.d(this.f8966a, ((C0185b) obj).f8966a)) {
                return true;
            }
            return false;
        }
        ...
        public String toString() {
            return "Raw(errorMessage=" + this.f8966a + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeString(this.f8966a);
        }
    }
