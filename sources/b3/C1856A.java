...
public final class C1856A implements v2.f {
    ...
    public static final class a implements Parcelable {
        ...
        public boolean equals(Object obj) {
            ...
            if ((obj instanceof a) && this.f14256a == ((a) obj).f14256a) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return androidx.compose.foundation.a.a(this.f14256a);
        }

        public String toString() {
            return "CardBrandChoice(eligible=" + this.f14256a + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeInt(this.f14256a ? 1 : 0);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof C1856A) && AbstractC3159y.d(this.f14255a, ((C1856A) obj).f14255a)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "MobileCardElementConfig(cardBrandChoice=" + this.f14255a + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        this.f14255a.writeToParcel(out, i8);
    }
}
