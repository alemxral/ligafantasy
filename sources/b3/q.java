...
public final class q implements v2.f {
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f14525b;
        ...
        @Override // x6.C
        public t6.b[] d() {
            return new t6.b[]{o.a.f14491a, AbstractC3808a.p(r0.f39581a)};
        }
        ...
        public q c(w6.e decoder) {
            ...
            n0 n0Var = null;
            if (d8.z()) {
                oVar = (o) d8.r(a8, 0, o.a.f14491a, null);
                str = (String) d8.y(a8, 1, r0.f39581a, null);
                i8 = 3;
            } else {
                oVar = null;
                String str2 = null;
                ...
                while (z8) {
                    ...
                    if (p8 != -1) {
                        if (p8 != 0) {
                            if (p8 == 1) {
                                str2 = (String) d8.y(a8, 1, r0.f39581a, str2);
                                i9 |= 2;
                            } else {
                                throw new t6.l(p8);
                            }
                        } else {
                            oVar = (o) d8.r(a8, 0, o.a.f14491a, oVar);
                            i9 |= 1;
                        }
                    } else {
                        z8 = false;
    ...
    public /* synthetic */ q(int i8, o oVar, String str, n0 n0Var) {
        if (1 != (i8 & 1)) {
            AbstractC3942d0.a(i8, 1, a.f14524a.a());
        }
        this.f14522a = oVar;
        if ((i8 & 2) == 0) {
            this.f14523b = null;
    ...
    public static final /* synthetic */ void e(q qVar, w6.d dVar, v6.f fVar) {
        dVar.A(fVar, 0, o.a.f14491a, qVar.f14522a);
        if (dVar.i(fVar, 1) || qVar.f14523b != null) {
            dVar.u(fVar, 1, r0.f39581a, qVar.f14523b);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        q qVar = (q) obj;
        if (AbstractC3159y.d(this.f14522a, qVar.f14522a) && AbstractC3159y.d(this.f14523b, qVar.f14523b)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f14522a.hashCode() * 31;
    ...
    public String toString() {
        return "ConsumerSessionSignup(consumerSession=" + this.f14522a + ", publishableKey=" + this.f14523b + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        this.f14522a.writeToParcel(out, i8);
        out.writeString(this.f14523b);
    }

    public q(o consumerSession, String str) {
        AbstractC3159y.i(consumerSession, "consumerSession");
        this.f14522a = consumerSession;
        this.f14523b = str;
    }
}
