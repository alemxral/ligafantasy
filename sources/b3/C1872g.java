...
public final class C1872g implements v2.f {
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3159y.d(this.f14456a, c1872g.f14456a) && AbstractC3159y.d(this.f14457b, c1872g.f14457b)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "CardMetadata(bin=" + this.f14456a + ", accountRanges=" + this.f14457b + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f14456a, i8);
        List list = this.f14457b;
