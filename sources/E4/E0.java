...
public abstract class E0 {
    ...
    public static final class a extends AbstractC3160z implements Function0 {
        ...
        final /* synthetic */ ManagedActivityResultLauncher f30329a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Context f30330b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(ManagedActivityResultLauncher managedActivityResultLauncher, Context context) {
            super(0);
            this.f30329a = managedActivityResultLauncher;
        ...
        public final void m5579invoke() {
            this.f30329a.launch(new Intent(this.f30330b, (Class<?>) CardScanActivity.class));
        }
    }
    ...
    public static final class b extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1 f30332b;
        ...
        public final void invoke(Composer composer, int i8) {
            E0.a(this.f30331a, this.f30332b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f30333c | 1));
        }
    }
    ...
    public static final class c extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function1 f30334a;
    ...
    public static final void a(boolean z8, Function1 onResult, Composer composer, int i8) {
        ...
        if ((i9 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            Painter painterResource = PainterResources_androidKt.painterResource(b4.k.f14642L, startRestartGroup, 0);
            int i12 = b4.n.f14672A0;
