...
public final class C2637x extends AbstractC2608f0 {
    ...
    private final m4.G f30861a;
    public static final b Companion = new b(null);

    /* renamed from: b, reason: collision with root package name */
    public static final int f30860b = m4.G.f35059d;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final a f30862a;

        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30863b;
    ...
    public /* synthetic */ C2637x(int i8, m4.G g8, x6.n0 n0Var) {
        super(null);
        if ((i8 & 1) == 0) {
            this.f30861a = m4.G.Companion.a("au_becs_debit[bsb_number]");
        } else {
            this.f30861a = g8;
        }
    }
    ...
    public static final /* synthetic */ void j(C2637x c2637x, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(c2637x.f(), m4.G.Companion.a("au_becs_debit[bsb_number]"))) {
            dVar.A(fVar, 0, G.a.f35085a, c2637x.f());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof C2637x) && AbstractC3159y.d(this.f30861a, ((C2637x) obj).f30861a)) {
            return true;
        }
        return false;
    }
    ...
    public final C2635v i(Map initialValues) {
        ...
        m4.G f8 = f();
        list = AbstractC2638y.f30866a;
        return new C2635v(f8, list, (String) initialValues.get(f()));
    }

    public String toString() {
        return "BsbSpec(apiPath=" + this.f30861a + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30861a, i8);
    }
