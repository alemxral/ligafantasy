...
public final class C2609g extends AbstractC2608f0 {
    ...
    private final m4.G f30666a;
    public static final b Companion = new b(null);

    /* renamed from: b, reason: collision with root package name */
    public static final int f30665b = m4.G.f35059d;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30668b;
    ...
    public /* synthetic */ C2609g(int i8, m4.G g8, x6.n0 n0Var) {
        super(null);
        if ((i8 & 1) == 0) {
            this.f30666a = m4.G.Companion.a("afterpay_text");
        } else {
            this.f30666a = g8;
        }
    }
    ...
    public static final /* synthetic */ void j(C2609g c2609g, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(c2609g.f(), m4.G.Companion.a("afterpay_text"))) {
            dVar.A(fVar, 0, G.a.f35085a, c2609g.f());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof C2609g) && AbstractC3159y.d(this.f30666a, ((C2609g) obj).f30666a)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "AfterpayClearpayTextSpec(apiPath=" + this.f30666a + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30666a, i8);
    }
