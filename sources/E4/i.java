...
public final class i {
    ...
    public final void b(Uri uri, String str, boolean z8, boolean z9) {
        ...
        Intent intent = new Intent(this.f2271a, (Class<?>) InstallerActivity.class);
        intent.setData(uri);
    ...
    public final void h(String packageName) {
        ...
        PendingIntent activity = PendingIntent.getActivity(this.f2271a, 0, intent, i8);
        PackageInstaller packageInstaller = this.f2271a.getPackageManager().getPackageInstaller();
