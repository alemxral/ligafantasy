...
public final class O0 extends AbstractC2608f0 {
    ...
    public static final int f30455c = m4.G.f35059d;
    ...
    public /* synthetic */ O0(int i8, m4.G g8, int i9, x6.n0 n0Var) {
        super(null);
        if (2 != (i8 & 2)) {
            AbstractC3942d0.a(i8, 2, a.f30458a.a());
        }
        if ((i8 & 1) == 0) {
            this.f30456a = m4.G.Companion.a("static_text");
        } else {
            this.f30456a = g8;
        }
        this.f30457b = i9;
    ...
    public static final /* synthetic */ void j(O0 o02, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(o02.f(), m4.G.Companion.a("static_text"))) {
            dVar.A(fVar, 0, G.a.f35085a, o02.f());
        }
        dVar.v(fVar, 1, o02.f30457b);
    }
    ...
    public boolean equals(Object obj) {
        ...
        O0 o02 = (O0) obj;
        if (AbstractC3159y.d(this.f30456a, o02.f30456a) && this.f30457b == o02.f30457b) {
            return true;
        }
        return false;
    }
    ...
    public final m4.D i() {
        return new M0(f(), this.f30457b, null, 4, null);
    }

    public String toString() {
        return "StaticTextSpec(apiPath=" + this.f30456a + ", stringResId=" + this.f30457b + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30456a, i8);
        out.writeInt(this.f30457b);
    }
