...
public final class C2622m0 extends AbstractC2608f0 {
    ...
    private final m4.G f30740a;
    public static final b Companion = new b(null);

    /* renamed from: b, reason: collision with root package name */
    public static final int f30739b = m4.G.f35059d;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30742b;
    ...
    public /* synthetic */ C2622m0(int i8, m4.G g8, x6.n0 n0Var) {
        super(null);
        if ((i8 & 1) == 0) {
            this.f30740a = m4.G.Companion.a("sepa_debit[iban]");
        } else {
            this.f30740a = g8;
        }
    }
    ...
    public static final /* synthetic */ void j(C2622m0 c2622m0, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(c2622m0.f(), m4.G.Companion.a("sepa_debit[iban]"))) {
            dVar.A(fVar, 0, G.a.f35085a, c2622m0.f());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof C2622m0) && AbstractC3159y.d(this.f30740a, ((C2622m0) obj).f30740a)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "IbanSpec(apiPath=" + this.f30740a + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30740a, i8);
    }
