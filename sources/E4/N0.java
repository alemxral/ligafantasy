...
public abstract class N0 {
    ...
    public static final class b extends AbstractC3160z implements X5.n {
        ...
        public final void invoke(Composer composer, int i8) {
            N0.a(this.f30447a, composer, RecomposeScopeImplKt.updateChangedFlags(this.f30448b | 1));
        }
    }
    ...
    public static final void a(M0 element, Composer composer, int i8) {
        ...
        m4.F.a(StringResources_androidKt.stringResource(element.f(), startRestartGroup, 0), SemanticsModifierKt.semantics(PaddingKt.m602paddingVpY3zN4$default(Modifier.Companion, 0.0f, Dp.m5178constructorimpl(8), 1, null), true, a.f30446a), startRestartGroup, 0, 0);
        if (ComposerKt.isTraceInProgress()) {
