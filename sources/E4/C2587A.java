...
public final class C2587A extends C3410b {
    ...
    private final b4.c f30253t;

    /* renamed from: u, reason: collision with root package name */
    private final InterfaceC3349K f30254u;
    ...
    static final class a extends AbstractC3160z implements Function1 {
        ...
        public /* synthetic */ class C0728a {
            ...
            public static final /* synthetic */ R5.a f30256a = R5.b.a(EnumC3126f.values());
        }
        ...
        public /* synthetic */ class b {
            ...
            static {
                ...
                try {
                    iArr[b4.c.f14597b.ordinal()] = 1;
                } catch (NoSuchFieldError unused) {
                }
                try {
                    iArr[b4.c.f14598c.ordinal()] = 2;
                } catch (NoSuchFieldError unused2) {
                }
                try {
                    iArr[b4.c.f14596a.ordinal()] = 3;
            ...
            if (i8 != 1) {
                if (i8 != 2) {
                    if (i8 == 3) {
                        ...
                        R5.a aVar2 = C0728a.f30256a;
                        ArrayList arrayList3 = new ArrayList();
                        for (Object obj2 : aVar2) {
                            if (((EnumC3126f) obj2) != EnumC3126f.f33464l) {
                                arrayList3.add(obj2);
                            }
                        }
    ...
    */
    ...
    public C2587A(m4.G identifier, Map rawValuesMap, Set countryCodes, C3434y countryDropdownFieldController, m4.e0 e0Var, Map map, b4.c collectionMode) {
        ...
        this.f30253t = collectionMode;
        this.f30254u = v4.g.m(countryDropdownFieldController.y(), new a());
    }
}
