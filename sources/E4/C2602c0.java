...
public final class C2602c0 {
    ...
    private final k3.i f30644a;

    public C2602c0(k3.i errorReporter) {
        AbstractC3159y.i(errorReporter, "errorReporter");
        this.f30644a = errorReporter;
    }

    public final List a(String str) {
        if (str != null && str.length() != 0) {
            Object a8 = C2606e0.f30655a.a(str);
            Throwable e8 = L5.s.e(a8);
            if (e8 != null) {
                i.b.a(this.f30644a, i.f.f33424n, AbstractC3790k.f38210e.b(e8), null, 4, null);
            }
            if (L5.s.e(a8) != null) {
                a8 = AbstractC1246t.m();
            }
