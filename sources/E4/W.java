...
public final class W extends AbstractC2608f0 {
    ...
    private final m4.G f30600a;

    /* renamed from: b, reason: collision with root package name */
    private final P0 f30601b;

    /* renamed from: c, reason: collision with root package name */
    private final List f30602c;
    ...
    private static final t6.b[] f30599e = {null, P0.Companion.serializer(), new C3943e(V.a.f30596a)};
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30604b;
        ...
        @Override // x6.C
        public t6.b[] d() {
            t6.b[] bVarArr = W.f30599e;
            return new t6.b[]{G.a.f35085a, bVarArr[1], bVarArr[2]};
        }
        ...
        public W c(w6.e decoder) {
            ...
            m4.G g9 = null;
            if (d8.z()) {
                m4.G g10 = (m4.G) d8.r(a8, 0, G.a.f35085a, null);
    ...
    public /* synthetic */ W(int i8, m4.G g8, P0 p02, List list, x6.n0 n0Var) {
        super(null);
        if (7 != (i8 & 7)) {
            AbstractC3942d0.a(i8, 7, a.f30603a.a());
        }
        this.f30600a = g8;
        this.f30601b = p02;
        this.f30602c = list;
    ...
    public static final /* synthetic */ void k(W w8, w6.d dVar, v6.f fVar) {
        t6.b[] bVarArr = f30599e;
        dVar.A(fVar, 0, G.a.f35085a, w8.i());
        dVar.A(fVar, 1, bVarArr[1], w8.f30601b);
        dVar.A(fVar, 2, bVarArr[2], w8.f30602c);
    }
    ...
    public boolean equals(Object obj) {
        ...
        W w8 = (W) obj;
        if (AbstractC3159y.d(this.f30600a, w8.f30600a) && this.f30601b == w8.f30601b && AbstractC3159y.d(this.f30602c, w8.f30602c)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((this.f30600a.hashCode() * 31) + this.f30601b.hashCode()) * 31) + this.f30602c.hashCode();
    }
    ...
    public final m4.h0 j(Map initialValues) {
        ...
        return AbstractC2608f0.e(this, new K0(i(), new C3434y(new J0(this.f30601b.c(), this.f30602c), (String) initialValues.get(i()))), null, 2, null);
    }

    public String toString() {
        return "DropdownSpec(apiPath=" + this.f30600a + ", labelTranslationId=" + this.f30601b + ", items=" + this.f30602c + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30600a, i8);
        out.writeString(this.f30601b.name());
        List list = this.f30602c;
    ...
    public W(m4.G apiPath, P0 labelTranslationId, List items) {
        ...
        this.f30600a = apiPath;
        this.f30601b = labelTranslationId;
        this.f30602c = items;
    }
}
