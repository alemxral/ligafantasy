...
public final class C2619l extends AbstractC2608f0 {
    ...
    private final m4.G f30723a;
    public static final b Companion = new b(null);

    /* renamed from: b, reason: collision with root package name */
    public static final int f30722b = m4.G.f35059d;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30725b;
    ...
    public /* synthetic */ C2619l(int i8, m4.G g8, x6.n0 n0Var) {
        super(null);
        if ((i8 & 1) == 0) {
            this.f30723a = m4.G.Companion.a("au_becs_mandate");
        } else {
            this.f30723a = g8;
        }
    }
    ...
    public static final /* synthetic */ void j(C2619l c2619l, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(c2619l.f(), m4.G.Companion.a("au_becs_mandate"))) {
            dVar.A(fVar, 0, G.a.f35085a, c2619l.f());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof C2619l) && AbstractC3159y.d(this.f30723a, ((C2619l) obj).f30723a)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "AuBecsDebitMandateTextSpec(apiPath=" + this.f30723a + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30723a, i8);
    }
