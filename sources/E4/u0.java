...
public final class u0 extends AbstractC2608f0 {
    ...
    public static final int f30829c = m4.G.f35059d;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30833b;
    ...
    public /* synthetic */ u0(int i8, m4.G g8, int i9, x6.n0 n0Var) {
        super(null);
        if (2 != (i8 & 2)) {
            AbstractC3942d0.a(i8, 2, a.f30832a.a());
        }
        if ((i8 & 1) == 0) {
            this.f30830a = m4.G.Companion.a("mandate");
        } else {
            this.f30830a = g8;
        }
        this.f30831b = i9;
    ...
    public static final /* synthetic */ void j(u0 u0Var, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(u0Var.f(), m4.G.Companion.a("mandate"))) {
            dVar.A(fVar, 0, G.a.f35085a, u0Var.f());
        }
        dVar.v(fVar, 1, u0Var.f30831b);
    }
    ...
    public boolean equals(Object obj) {
        ...
        u0 u0Var = (u0) obj;
        if (AbstractC3159y.d(this.f30830a, u0Var.f30830a) && this.f30831b == u0Var.f30831b) {
            return true;
        }
        return false;
    }
    ...
    public final m4.D i(String... args) {
        ...
        return new t0(f(), this.f30831b, AbstractC1239l.V0(args), 0.0f, null, 24, null);
    }

    public String toString() {
        return "MandateTextSpec(apiPath=" + this.f30830a + ", stringResId=" + this.f30831b + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30830a, i8);
        out.writeInt(this.f30831b);
    }
