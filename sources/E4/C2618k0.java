...
public final class C2618k0 implements m4.v0 {
    ...
    private static final a f30711h = new a(null);

    /* renamed from: i, reason: collision with root package name */
    public static final int f30712i = 8;

    /* renamed from: j, reason: collision with root package name */
    private static final List f30713j = AbstractC1246t.G0(AbstractC1246t.F0(new C2559c('0', '9'), new C2559c('a', 'z')), new C2559c('A', 'Z'));

    /* renamed from: a, reason: collision with root package name */
    private final int f30714a = KeyboardCapitalization.Companion.m4895getCharactersIUNYP9k();

    /* renamed from: b, reason: collision with root package name */
    private final String f30715b = "iban";

    /* renamed from: c, reason: collision with root package name */
    private final int f30716c = b4.n.f14735r;

    /* renamed from: d, reason: collision with root package name */
    private final int f30717d = KeyboardType.Companion.m4915getAsciiPjHm6EE();

    /* renamed from: e, reason: collision with root package name */
    private final l6.v f30718e = AbstractC3351M.a(new x0.c(j2.z.f33134o, null, true, null, 10, null));

    /* renamed from: f, reason: collision with root package name */
    private final InterfaceC3349K f30719f = AbstractC3351M.a(Boolean.FALSE);

    /* renamed from: g, reason: collision with root package name */
    private final VisualTransformation f30720g = new VisualTransformation() { // from class: e4.j0
    ...
    private final boolean o(String str) {
        ...
        return new BigInteger(new g6.j("[A-Z]").g(upperCase, b.f30721a)).mod(new BigInteger("97")).equals(BigInteger.ONE);
    }
    ...
    @Override // m4.v0
    public Integer b() {
        return Integer.valueOf(this.f30716c);
    }
    ...
    public String j(String userTyped) {
        ...
        for (int i8 = 0; i8 < length; i8++) {
            ...
            if (f30713j.contains(Character.valueOf(charAt))) {
                sb.append(charAt);
            }
        }
        String sb2 = sb.toString();
    ...
    public m4.y0 l(String input) {
        ...
        for (int i8 = 0; i8 < upperCase.length(); i8++) {
            if (Character.isDigit(upperCase.charAt(i8))) {
                return new z0.c(b4.n.f14741u, null, false, 6, null);
            }
        }
        if (upperCase.length() < 2) {
            return new z0.b(b4.n.f14737s);
        }
        String[] iSOCountries = Locale.getISOCountries();
        AbstractC3159y.h(iSOCountries, "getISOCountries(...)");
        if (!AbstractC1239l.W(iSOCountries, upperCase)) {
            return new z0.c(b4.n.f14739t, new String[]{upperCase}, false, 4, null);
        }
        if (input.length() < 8) {
            return new z0.b(b4.n.f14737s);
        }
        ...
        return new z0.b(AbstractC3053E.f32893t0);
    }
