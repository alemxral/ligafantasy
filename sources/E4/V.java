...
public final class V implements Parcelable {
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30597b;
        ...
        public V c(w6.e decoder) {
            ...
            x6.n0 n0Var = null;
            if (d8.z()) {
                str = (String) d8.y(a8, 0, x6.r0.f39581a, null);
                str2 = d8.q(a8, 1);
                i8 = 3;
            } else {
                str = null;
                ...
                while (z8) {
                    ...
                    if (p8 != -1) {
                        if (p8 != 0) {
                            ...
                            str = (String) d8.y(a8, 0, x6.r0.f39581a, str);
                            i9 |= 1;
                        }
                    } else {
                        z8 = false;
    ...
    public static final /* synthetic */ void e(V v8, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || v8.f30594a != null) {
            dVar.u(fVar, 0, x6.r0.f39581a, v8.f30594a);
        }
        if (dVar.i(fVar, 1) || !AbstractC3159y.d(v8.f30595b, "Other")) {
            dVar.y(fVar, 1, v8.f30595b);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        V v8 = (V) obj;
        if (AbstractC3159y.d(this.f30594a, v8.f30594a) && AbstractC3159y.d(this.f30595b, v8.f30595b)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (hashCode * 31) + this.f30595b.hashCode();
    }

    public String toString() {
        return "DropdownItemSpec(apiValue=" + this.f30594a + ", displayText=" + this.f30595b + ")";
    }
