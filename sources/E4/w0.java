...
public final class w0 extends AbstractC2608f0 {
    ...
    private final m4.G f30855a;

    /* renamed from: b, reason: collision with root package name */
    private final P0 f30856b;

    /* renamed from: c, reason: collision with root package name */
    private final L0 f30857c;
    public static final b Companion = new b(null);

    /* renamed from: d, reason: collision with root package name */
    public static final int f30853d = m4.G.f35059d;
    public static final Parcelable.Creator<w0> CREATOR = new c();

    /* renamed from: e, reason: collision with root package name */
    private static final t6.b[] f30854e = {null, P0.Companion.serializer()};
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30859b;
        ...
        @Override // x6.C
        public t6.b[] d() {
            return new t6.b[]{G.a.f35085a, w0.f30854e[1]};
        }
    ...
    public /* synthetic */ w0(int i8, m4.G g8, P0 p02, x6.n0 n0Var) {
        super(null);
        this.f30855a = (i8 & 1) == 0 ? m4.G.Companion.r() : g8;
        if ((i8 & 2) == 0) {
            this.f30856b = P0.f30470g;
        } else {
            this.f30856b = p02;
        }
        this.f30857c = new L0(i(), this.f30856b.c(), EnumC2639z.f30874d, EnumC2624n0.f30750b, false, 16, (AbstractC3151p) null);
    }

    public static final /* synthetic */ void k(w0 w0Var, w6.d dVar, v6.f fVar) {
        t6.b[] bVarArr = f30854e;
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(w0Var.i(), m4.G.Companion.r())) {
            dVar.A(fVar, 0, G.a.f35085a, w0Var.i());
        }
        if (dVar.i(fVar, 1) || w0Var.f30856b != P0.f30470g) {
            dVar.A(fVar, 1, bVarArr[1], w0Var.f30856b);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        w0 w0Var = (w0) obj;
        if (AbstractC3159y.d(this.f30855a, w0Var.f30855a) && this.f30856b == w0Var.f30856b) {
            return true;
        }
        return false;
    }
    ...
    public final m4.h0 j(Map initialValues) {
        ...
        return this.f30857c.j(initialValues);
    }

    public String toString() {
        return "NameSpec(apiPath=" + this.f30855a + ", labelTranslationId=" + this.f30856b + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30855a, i8);
        out.writeString(this.f30856b.name());
    }

    public /* synthetic */ w0(m4.G g8, P0 p02, int i8, AbstractC3151p abstractC3151p) {
        this((i8 & 1) != 0 ? m4.G.Companion.r() : g8, (i8 & 2) != 0 ? P0.f30470g : p02);
    }
    ...
    public w0(m4.G apiPath, P0 labelTranslationId) {
        ...
        this.f30855a = apiPath;
        this.f30856b = labelTranslationId;
        this.f30857c = new L0(i(), labelTranslationId.c(), EnumC2639z.f30874d, EnumC2624n0.f30750b, false, 16, (AbstractC3151p) null);
    }
}
