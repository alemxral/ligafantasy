...
public final class C2596J {
    ...
    public m4.y0 c(EnumC1870e brand, String number, int i8) {
        ...
        if (brand == EnumC1870e.f14433w) {
            return new z0.c(AbstractC3053E.f32895u0, null, true, 2, null);
        }
        if (z8 && number.length() < i8) {
            return new z0.b(AbstractC3053E.f32895u0);
        }
        if (!a8) {
            return new z0.c(AbstractC3053E.f32895u0, null, true, 2, null);
        }
        ...
        return new z0.c(AbstractC3053E.f32895u0, null, false, 6, null);
    }
