...
public final class C2607f implements m4.D {
    ...
    public static final int f30660f = 8;

    /* renamed from: a, reason: collision with root package name */
    private final m4.G f30661a;

    /* renamed from: b, reason: collision with root package name */
    private final m4.r f30662b;

    /* renamed from: c, reason: collision with root package name */
    private final boolean f30663c;

    /* renamed from: d, reason: collision with root package name */
    private final InterfaceC3983b f30664d;
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3159y.d(this.f30661a, c2607f.f30661a) && AbstractC3159y.d(this.f30662b, c2607f.f30662b)) {
            return true;
        }
        return false;
    }
    ...
    public final String g(Resources resources) {
        ...
        String string = resources.getString(b4.n.f14701a);
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f30661a.hashCode() * 31;
        m4.r rVar = this.f30662b;
        if (rVar == null) {
            hashCode = 0;
        } else {
    ...
    public String toString() {
        return "AfterpayClearpayHeaderElement(identifier=" + this.f30661a + ", controller=" + this.f30662b + ")";
    }
