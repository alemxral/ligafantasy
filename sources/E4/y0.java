...
public final class y0 extends AbstractC2608f0 {
    ...
    private final m4.G f30868a;
    public static final b Companion = new b(null);

    /* renamed from: b, reason: collision with root package name */
    public static final int f30867b = m4.G.f35059d;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final a f30869a;

        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30870b;
    ...
    public static final /* synthetic */ void j(y0 y0Var, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(y0Var.f(), m4.G.Companion.t())) {
            dVar.A(fVar, 0, G.a.f35085a, y0Var.f());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof y0) && AbstractC3159y.d(this.f30868a, ((y0) obj).f30868a)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "PhoneSpec(apiPath=" + this.f30868a + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30868a, i8);
    }
