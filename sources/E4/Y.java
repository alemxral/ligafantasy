...
public final class Y extends AbstractC2608f0 {
    ...
    private final m4.G f30611a;
    public static final b Companion = new b(null);

    /* renamed from: b, reason: collision with root package name */
    public static final int f30610b = m4.G.f35059d;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30613b;
    ...
    public static final /* synthetic */ void j(Y y8, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(y8.f(), m4.G.Companion.n())) {
            dVar.A(fVar, 0, G.a.f35085a, y8.f());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof Y) && AbstractC3159y.d(this.f30611a, ((Y) obj).f30611a)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "EmailSpec(apiPath=" + this.f30611a + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30611a, i8);
    }
