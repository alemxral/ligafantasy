...
public final class C2623n extends AbstractC2608f0 {
    ...
    private final m4.G f30744a;

    /* renamed from: b, reason: collision with root package name */
    private final m4.G f30745b;

    /* renamed from: c, reason: collision with root package name */
    private final m4.G f30746c;
    private static final b Companion = new b(null);

    /* renamed from: d, reason: collision with root package name */
    public static final int f30743d = m4.G.f35059d;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30748b;
                ...
                while (z8) {
                    ...
                    if (p8 != -1) {
                        if (p8 != 0) {
                            if (p8 != 1) {
                                if (p8 == 2) {
                                    g15 = (m4.G) d8.r(a8, 2, G.a.f35085a, g15);
                                    i9 |= 4;
                                } else {
                                    throw new t6.l(p8);
                                }
                            } else {
                                g14 = (m4.G) d8.r(a8, 1, G.a.f35085a, g14);
                                i9 |= 2;
                            }
                        } else {
                            g11 = (m4.G) d8.r(a8, 0, G.a.f35085a, g11);
                            i9 |= 1;
                        }
                    } else {
                        z8 = false;
    ...
    public /* synthetic */ C2623n(int i8, m4.G g8, m4.G g9, m4.G g10, x6.n0 n0Var) {
        super(null);
        this.f30744a = (i8 & 1) == 0 ? m4.G.Companion.a("bacs_debit[sort_code]") : g8;
        if ((i8 & 2) == 0) {
            this.f30745b = m4.G.Companion.a("bacs_debit[account_number]");
        } else {
            this.f30745b = g9;
        }
        if ((i8 & 4) == 0) {
            this.f30746c = new m4.G();
        } else {
            this.f30746c = g10;
        }
    }
    ...
    public static final /* synthetic */ void j(C2623n c2623n, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(c2623n.f30744a, m4.G.Companion.a("bacs_debit[sort_code]"))) {
            dVar.A(fVar, 0, G.a.f35085a, c2623n.f30744a);
        }
        if (dVar.i(fVar, 1) || !AbstractC3159y.d(c2623n.f30745b, m4.G.Companion.a("bacs_debit[account_number]"))) {
            dVar.A(fVar, 1, G.a.f35085a, c2623n.f30745b);
        }
        if (dVar.i(fVar, 2) || !AbstractC3159y.d(c2623n.f(), new m4.G())) {
            dVar.A(fVar, 2, G.a.f35085a, c2623n.f());
        }
    }
    ...
    public final m4.h0 i(Map initialValues) {
        ...
        return b(AbstractC1246t.p(new m4.q0(this.f30744a, new m4.s0(new C2627p(), false, (String) initialValues.get(this.f30744a), 2, null)), new m4.q0(this.f30745b, new m4.s0(new C2621m(), false, (String) initialValues.get(this.f30745b), 2, null))), Integer.valueOf(b4.n.f14711f));
    }
    ...
    public C2623n() {
        ...
        this.f30744a = bVar.a("bacs_debit[sort_code]");
        this.f30745b = bVar.a("bacs_debit[account_number]");
        this.f30746c = new m4.G();
    }
}
