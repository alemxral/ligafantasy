...
public final class F0 implements Parcelable {
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30343b;
            ...
            if (d8.z()) {
                ...
                while (z8) {
                    ...
                    if (p8 != -1) {
                        if (p8 != 0) {
                            if (p8 == 1) {
                                str = (String) d8.y(a8, 1, x6.r0.f39581a, str);
                                i9 |= 2;
                            } else {
                                throw new t6.l(p8);
                            }
                        } else {
                            str3 = (String) d8.y(a8, 0, x6.r0.f39581a, str3);
                            i9 |= 1;
                        }
                    } else {
                        z8 = false;
    ...
    public static final /* synthetic */ void e(F0 f02, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || f02.f30340a != null) {
            dVar.u(fVar, 0, x6.r0.f39581a, f02.f30340a);
        }
        if (dVar.i(fVar, 1) || f02.f30341b != null) {
            dVar.u(fVar, 1, x6.r0.f39581a, f02.f30341b);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        F0 f02 = (F0) obj;
        if (AbstractC3159y.d(this.f30340a, f02.f30340a) && AbstractC3159y.d(this.f30341b, f02.f30341b)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "SelectorIcon(lightThemePng=" + this.f30340a + ", darkThemePng=" + this.f30341b + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeString(this.f30340a);
        out.writeString(this.f30341b);
    }
