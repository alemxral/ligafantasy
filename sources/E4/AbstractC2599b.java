...
public abstract class AbstractC2599b {
    ...
    public static final class a extends AbstractC3160z implements X5.n {
        ...
        public final void invoke(Composer composer, int i8) {
            AbstractC2599b.a(composer, RecomposeScopeImplKt.updateChangedFlags(this.f30632a | 1));
        }
    }
    ...
    public static final void a(Composer composer, int i8) {
        ...
        if (i8 == 0 && startRestartGroup.getSkipping()) {
            ...
            String stringResource = StringResources_androidKt.stringResource(AbstractC3053E.f32830I, startRestartGroup, 0);
            Map e8 = M5.Q.e(L5.x.a("affirm", new AbstractC3805b.a(b4.k.f14643a, b4.n.f14686L, null, 4, null)));
            MaterialTheme materialTheme = MaterialTheme.INSTANCE;
            int i9 = MaterialTheme.$stable;
            AbstractC3806c.b(stringResource, PaddingKt.m602paddingVpY3zN4$default(Modifier.Companion, 0.0f, Dp.m5178constructorimpl(8), 1, null), e8, AbstractC3087m.n(materialTheme, startRestartGroup, i9).j(), materialTheme.getTypography(startRestartGroup, i9).getH6(), false, null, 0, null, startRestartGroup, (AbstractC3805b.a.f38476d << 6) | 48, 480);
            if (ComposerKt.isTraceInProgress()) {
