...
public final class C2600b0 implements Parcelable {
    ...
    public static final int f30633e = 0;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30639b;
        ...
        public C2600b0 c(w6.e decoder) {
            ...
            if (d8.z()) {
                ...
                str = q8;
                str4 = (String) d8.y(a8, 3, x6.r0.f39581a, null);
                str3 = q10;
                str2 = q9;
                i8 = 15;
            } else {
                    ...
                    if (p8 != -1) {
                        if (p8 != 0) {
                            if (p8 != 1) {
                                if (p8 != 2) {
                                    if (p8 == 3) {
                                        str8 = (String) d8.y(a8, 3, x6.r0.f39581a, str8);
                                        i9 |= 8;
                                    } else {
                                        throw new t6.l(p8);
                                    }
    ...
    public /* synthetic */ C2600b0(int i8, String str, String str2, String str3, String str4, x6.n0 n0Var) {
        if (7 != (i8 & 7)) {
            AbstractC3942d0.a(i8, 7, a.f30638a.a());
        }
        this.f30634a = str;
        this.f30635b = str2;
        this.f30636c = str3;
    ...
    public static final /* synthetic */ void f(C2600b0 c2600b0, w6.d dVar, v6.f fVar) {
        dVar.y(fVar, 0, c2600b0.f30634a);
        dVar.y(fVar, 1, c2600b0.f30635b);
        dVar.y(fVar, 2, c2600b0.f30636c);
        if (dVar.i(fVar, 3) || c2600b0.f30637d != null) {
            dVar.u(fVar, 3, x6.r0.f39581a, c2600b0.f30637d);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3159y.d(this.f30634a, c2600b0.f30634a) && AbstractC3159y.d(this.f30635b, c2600b0.f30635b) && AbstractC3159y.d(this.f30636c, c2600b0.f30636c) && AbstractC3159y.d(this.f30637d, c2600b0.f30637d)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = ((((this.f30634a.hashCode() * 31) + this.f30635b.hashCode()) * 31) + this.f30636c.hashCode()) * 31;
    ...
    public String toString() {
        return "ExternalPaymentMethodSpec(type=" + this.f30634a + ", label=" + this.f30635b + ", lightImageUrl=" + this.f30636c + ", darkImageUrl=" + this.f30637d + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeString(this.f30634a);
        out.writeString(this.f30635b);
        out.writeString(this.f30636c);
        out.writeString(this.f30637d);
    }
