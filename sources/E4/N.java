...
public final class N extends AbstractC2608f0 {
    ...
    private final m4.G f30441a;

    /* renamed from: b, reason: collision with root package name */
    private final int f30442b;

    /* renamed from: c, reason: collision with root package name */
    private final u0 f30443c;
    public static final b Companion = new b(null);

    /* renamed from: d, reason: collision with root package name */
    public static final int f30440d = m4.G.f35059d;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final a f30444a;

        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30445b;
    ...
    public /* synthetic */ N(int i8, m4.G g8, int i9, x6.n0 n0Var) {
        super(null);
        this.f30441a = (i8 & 1) == 0 ? m4.G.Companion.a("cashapp_mandate") : g8;
        if ((i8 & 2) == 0) {
            this.f30442b = b4.n.f14725m;
        } else {
            this.f30442b = i9;
        }
        this.f30443c = new u0(f(), this.f30442b);
    }
    ...
    public static final /* synthetic */ void j(N n8, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(n8.f(), m4.G.Companion.a("cashapp_mandate"))) {
            dVar.A(fVar, 0, G.a.f35085a, n8.f());
        }
        if (dVar.i(fVar, 1) || n8.f30442b != b4.n.f14725m) {
            dVar.v(fVar, 1, n8.f30442b);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        N n8 = (N) obj;
        if (AbstractC3159y.d(this.f30441a, n8.f30441a) && this.f30442b == n8.f30442b) {
            return true;
        }
        return false;
    }
    ...
    public final m4.D i(String merchantName) {
        ...
        return this.f30443c.i(merchantName, merchantName);
    }

    public String toString() {
        return "CashAppPayMandateTextSpec(apiPath=" + this.f30441a + ", stringResId=" + this.f30442b + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30441a, i8);
        out.writeInt(this.f30442b);
    }

    public /* synthetic */ N(m4.G g8, int i8, int i9, AbstractC3151p abstractC3151p) {
        this((i9 & 1) != 0 ? m4.G.Companion.a("cashapp_mandate") : g8, (i9 & 2) != 0 ? b4.n.f14725m : i8);
    }
    ...
    public N(m4.G apiPath, int i8) {
        ...
        this.f30441a = apiPath;
        this.f30442b = i8;
        this.f30443c = new u0(f(), i8);
    }
}
