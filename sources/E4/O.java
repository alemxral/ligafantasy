...
public final class O extends AbstractC2608f0 {
    ...
    private final m4.G f30451a;

    /* renamed from: b, reason: collision with root package name */
    private final Set f30452b;
    public static final b Companion = new b(null);

    /* renamed from: c, reason: collision with root package name */
    public static final int f30449c = 8;
    public static final Parcelable.Creator<O> CREATOR = new c();

    /* renamed from: d, reason: collision with root package name */
    private static final t6.b[] f30450d = {null, new x6.M(x6.r0.f39581a)};
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30454b;
        ...
        @Override // x6.C
        public t6.b[] d() {
            return new t6.b[]{G.a.f35085a, O.f30450d[1]};
        }
    ...
    public /* synthetic */ O(int i8, m4.G g8, Set set, x6.n0 n0Var) {
        super(null);
        this.f30451a = (i8 & 1) == 0 ? m4.G.Companion.l() : g8;
        if ((i8 & 2) == 0) {
            this.f30452b = v2.d.f38765a.h();
        } else {
            this.f30452b = set;
        }
    }
    ...
    public static final /* synthetic */ void k(O o8, w6.d dVar, v6.f fVar) {
        t6.b[] bVarArr = f30450d;
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(o8.i(), m4.G.Companion.l())) {
            dVar.A(fVar, 0, G.a.f35085a, o8.i());
        }
        if (dVar.i(fVar, 1) || !AbstractC3159y.d(o8.f30452b, v2.d.f38765a.h())) {
            dVar.A(fVar, 1, bVarArr[1], o8.f30452b);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        O o8 = (O) obj;
        if (AbstractC3159y.d(this.f30451a, o8.f30451a) && AbstractC3159y.d(this.f30452b, o8.f30452b)) {
            return true;
        }
        return false;
    }
    ...
    public final m4.h0 j(Map initialValues) {
        ...
        return AbstractC2608f0.e(this, new C3430u(i(), new C3434y(new C3429t(this.f30452b, null, false, false, null, null, 62, null), (String) initialValues.get(i()))), null, 2, null);
    }

    public String toString() {
        return "CountrySpec(apiPath=" + this.f30451a + ", allowedCountryCodes=" + this.f30452b + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30451a, i8);
        Set set = this.f30452b;
    ...
    public O(m4.G apiPath, Set allowedCountryCodes) {
        ...
        this.f30451a = apiPath;
        this.f30452b = allowedCountryCodes;
    }
}
