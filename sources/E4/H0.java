...
public final class H0 implements Parcelable {
    ...
    private final ArrayList f30363b;

    /* renamed from: c, reason: collision with root package name */
    private final F0 f30364c;
    ...
    private static final t6.b[] f30361e = {null, new C3943e(C2610g0.f30669c), null};

    /* loaded from: classes4.dex */
    public static final class a implements x6.C {

        /* renamed from: a, reason: collision with root package name */
        public static final a f30365a;

        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30366b;
        ...
        @Override // x6.C
        public t6.b[] d() {
            return new t6.b[]{x6.r0.f39581a, H0.f30361e[1], AbstractC3808a.p(F0.a.f30342a)};
        }
        ...
        public H0 c(w6.e decoder) {
            ...
            t6.b[] bVarArr = H0.f30361e;
            String str2 = null;
            if (d8.z()) {
                String q8 = d8.q(a8, 0);
                arrayList = (ArrayList) d8.r(a8, 1, bVarArr[1], null);
                str = q8;
                f02 = (F0) d8.y(a8, 2, F0.a.f30342a, null);
                i8 = 7;
            } else {
                ...
                while (z8) {
                    ...
                    if (p8 != -1) {
                        if (p8 != 0) {
                            if (p8 != 1) {
                                if (p8 == 2) {
                                    f03 = (F0) d8.y(a8, 2, F0.a.f30342a, f03);
                                    i9 |= 4;
                                } else {
                                    throw new t6.l(p8);
                                }
    ...
    public /* synthetic */ H0(int i8, String str, ArrayList arrayList, F0 f02, x6.n0 n0Var) {
        if (1 != (i8 & 1)) {
            AbstractC3942d0.a(i8, 1, a.f30365a.a());
        }
        this.f30362a = str;
        if ((i8 & 2) == 0) {
    ...
    public static final /* synthetic */ void f(H0 h02, w6.d dVar, v6.f fVar) {
        t6.b[] bVarArr = f30361e;
        dVar.y(fVar, 0, h02.f30362a);
        if (dVar.i(fVar, 1) || !AbstractC3159y.d(h02.f30363b, new ArrayList())) {
            dVar.A(fVar, 1, bVarArr[1], h02.f30363b);
        }
        if (dVar.i(fVar, 2) || h02.f30364c != null) {
            dVar.u(fVar, 2, F0.a.f30342a, h02.f30364c);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        H0 h02 = (H0) obj;
        if (AbstractC3159y.d(this.f30362a, h02.f30362a) && AbstractC3159y.d(this.f30363b, h02.f30363b) && AbstractC3159y.d(this.f30364c, h02.f30364c)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = ((this.f30362a.hashCode() * 31) + this.f30363b.hashCode()) * 31;
        F0 f02 = this.f30364c;
        if (f02 == null) {
            hashCode = 0;
        } else {
    ...
    public String toString() {
        return "SharedDataSpec(type=" + this.f30362a + ", fields=" + this.f30363b + ", selectorIcon=" + this.f30364c + ")";
    }
