...
public final class h implements o {
    ...
    public h(boolean z8, List rootCerts, U3.c errorReporter) {
        ...
        this.f12258a = z8;
        this.f12259b = rootCerts;
        this.f12260c = errorReporter;
    }
    ...
    private final boolean e(K1.r rVar, List list) {
        if (rVar.h().k() != null) {
            this.f12260c.i(new IllegalArgumentException("Encountered a JWK in " + rVar.h()));
        }
        a aVar = f12257d;
        K1.q h8 = rVar.h();
    ...
    */
    public final boolean d(java.util.List r3, java.util.List r4) {
        /*
            ...
            L5.s$a r0 = L5.s.f6498b     // Catch: java.lang.Throwable -> L16
            r0 = r3
        ...
        L19:
            ...
            r0 = r0 ^ r1
            if (r0 == 0) goto L32
            X3.h$a r0 = X3.h.f12257d     // Catch: java.lang.Throwable -> L16
            X3.h.a.a(r0, r3, r4)     // Catch: java.lang.Throwable -> L16
            L5.I r3 = L5.I.f6474a     // Catch: java.lang.Throwable -> L16
