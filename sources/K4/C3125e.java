...
public final class C3125e {
    ...
    private static final t6.b[] f33450e = {null, new C3943e(r0.f39581a), g.Companion.serializer()};

    /* renamed from: a, reason: collision with root package name */
    private final boolean f33451a;

    /* renamed from: b, reason: collision with root package name */
    private final ArrayList f33452b;

    /* renamed from: c, reason: collision with root package name */
    private final g f33453c;
    ...
    public static final class a implements C {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final a f33454a;

        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f33455b;
        ...
        @Override // x6.C
        public t6.b[] d() {
            t6.b[] bVarArr = C3125e.f33450e;
            return new t6.b[]{C3948h.f39553a, bVarArr[1], bVarArr[2]};
        }
    ...
    public /* synthetic */ C3125e(int i8, boolean z8, ArrayList arrayList, g gVar, n0 n0Var) {
        if (4 != (i8 & 4)) {
            AbstractC3942d0.a(i8, 4, a.f33454a.a());
        }
        this.f33451a = (i8 & 1) == 0 ? false : z8;
        if ((i8 & 2) == 0) {
            this.f33452b = new ArrayList();
        } else {
    ...
    public static final /* synthetic */ void d(C3125e c3125e, w6.d dVar, v6.f fVar) {
        t6.b[] bVarArr = f33450e;
        if (dVar.i(fVar, 0) || c3125e.f33451a) {
            dVar.o(fVar, 0, c3125e.f33451a);
        }
        if (dVar.i(fVar, 1) || !AbstractC3159y.d(c3125e.f33452b, new ArrayList())) {
            dVar.A(fVar, 1, bVarArr[1], c3125e.f33452b);
        }
        dVar.A(fVar, 2, bVarArr[2], c3125e.f33453c);
    }
    ...
    public C3125e(boolean z8, ArrayList examples, g nameType) {
        ...
        this.f33451a = z8;
        this.f33452b = examples;
        this.f33453c = nameType;
    }
