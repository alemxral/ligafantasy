...
public abstract class h {
    ...
    private static final AbstractC3999a f33501a = o.b(null, b.f33503a, 1, null);
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[EnumC3126f.f33463k.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[EnumC3126f.f33461i.ordinal()] = 2;
    ...
    private static final v0 e(EnumC3126f enumC3126f, int i8, int i9, int i10, String str) {
        if (a.f33502a[enumC3126f.ordinal()] == 2) {
    ...
    private static final o0 f(EnumC3126f enumC3126f, G g8, int i8, int i9, int i10, String str, boolean z8) {
        ...
        if (a.f33502a[enumC3126f.ordinal()] == 1 && AbstractC1246t.p("CA", "US").contains(str)) {
    ...
    public static final List g(List list, String countryCode) {
        ...
        for (Object obj : list) {
            ...
            if (c3124d.d() != EnumC3126f.f33462j && c3124d.d() != EnumC3126f.f33460h) {
                arrayList.add(obj);
            }
        }
