...
public final class C3124d {
    ...
    public static final int f33442d = 8;

    /* renamed from: e, reason: collision with root package name */
    private static final t6.b[] f33443e = {EnumC3126f.Companion.serializer(), null, null};

    /* renamed from: a, reason: collision with root package name */
    private final EnumC3126f f33444a;

    /* renamed from: b, reason: collision with root package name */
    private final boolean f33445b;

    /* renamed from: c, reason: collision with root package name */
    private final C3125e f33446c;
    ...
    public static final class a implements C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f33448b;
        ...
        @Override // x6.C
        public t6.b[] d() {
            return new t6.b[]{AbstractC3808a.p(C3124d.f33443e[0]), C3948h.f39553a, AbstractC3808a.p(C3125e.a.f33454a)};
        }
        ...
        public C3124d c(w6.e decoder) {
            ...
            t6.b[] bVarArr = C3124d.f33443e;
            if (d8.z()) {
                enumC3126f = (EnumC3126f) d8.y(a8, 0, bVarArr[0], null);
                z8 = d8.j(a8, 1);
                c3125e = (C3125e) d8.y(a8, 2, C3125e.a.f33454a, null);
                i8 = 7;
            } else {
                ...
                while (z10) {
                    ...
                    if (p8 != -1) {
                        if (p8 != 0) {
                            if (p8 != 1) {
                                if (p8 == 2) {
                                    c3125e2 = (C3125e) d8.y(a8, 2, C3125e.a.f33454a, c3125e2);
                                    i9 |= 4;
                                } else {
                                    throw new l(p8);
                                }
    ...
    public /* synthetic */ C3124d(int i8, EnumC3126f enumC3126f, boolean z8, C3125e c3125e, n0 n0Var) {
        if (3 != (i8 & 3)) {
            AbstractC3942d0.a(i8, 3, a.f33447a.a());
        }
        this.f33444a = enumC3126f;
        this.f33445b = z8;
        if ((i8 & 4) == 0) {
            this.f33446c = null;
        } else {
    ...
    public static final /* synthetic */ void e(C3124d c3124d, w6.d dVar, v6.f fVar) {
        dVar.u(fVar, 0, f33443e[0], c3124d.f33444a);
        dVar.o(fVar, 1, c3124d.f33445b);
        if (dVar.i(fVar, 2) || c3124d.f33446c != null) {
            dVar.u(fVar, 2, C3125e.a.f33454a, c3124d.f33446c);
        }
    }
