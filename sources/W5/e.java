...
public final class e extends Q7.a {
    ...
    public static final String f39037p = e.class.getSimpleName();

    /* renamed from: m, reason: collision with root package name */
    public C3852b f39038m;

    /* renamed from: n, reason: collision with root package name */
    public C3851a f39039n;
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (activity != null) {
            ...
            this.f39038m = (C3852b) new ViewModelProvider(viewModelStore, new c()).get(C3852b.class);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View inflate = inflater.inflate(I1.c.f3859j, viewGroup, false);
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(I1.b.f3760Q);
        C3852b c3852b = null;
        if (recyclerView != null) {
            C3851a c3851a = this.f39039n;
            if (c3851a == null) {
                AbstractC3159y.y("args");
                c3851a = null;
            }
            recyclerView.setAdapter(new Q7.d(c3851a.f39033a));
            recyclerView.setLayoutManager(new LinearLayoutManager(recyclerView.getContext()));
        }
        TextView textView = this.f8361b;
        if (textView != null) {
            C3852b c3852b2 = this.f39038m;
            if (c3852b2 == null) {
                AbstractC3159y.y("viewModel");
                c3852b2 = null;
            }
            textView.setText(c3852b2.f39034a.f5674a);
        }
        ...
        if (imageView != null) {
            ...
            C3852b c3852b3 = this.f39038m;
            if (c3852b3 == null) {
                AbstractC3159y.y("viewModel");
            } else {
                c3852b = c3852b3;
            }
            imageView.setContentDescription(c3852b.f39034a.f5675b);
        }
        J7.c cVar = this.f8369j;
        if (cVar != null && (num = cVar.f5536g) != null) {
