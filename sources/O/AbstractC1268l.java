...
public abstract class AbstractC1268l {
    ...
    public static final int f7658a = 12451000;

    /* renamed from: c, reason: collision with root package name */
    private static boolean f7660c = false;

    /* renamed from: d, reason: collision with root package name */
    static boolean f7661d = false;

    /* renamed from: b, reason: collision with root package name */
    static final AtomicBoolean f7659b = new AtomicBoolean();

    /* renamed from: e, reason: collision with root package name */
    private static final AtomicBoolean f7662e = new AtomicBoolean();
    ...
    public static int g(Context context, int i8) {
        ...
        try {
            context.getResources().getString(AbstractC1270n.f7666a);
        } catch (Throwable unused) {
            Log.e("GooglePlayServicesUtil", "The Google Play services resources were not found. Check your project configuration to ensure that the resources are included.");
        }
        if (!"com.google.android.gms".equals(context.getPackageName()) && !f7662e.get()) {
            int a8 = Y.a(context);
            if (a8 != 0) {
                if (a8 != f7658a) {
