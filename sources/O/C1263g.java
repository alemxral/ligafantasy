...
public class C1263g extends C1264h {
    ...
    private static final Object f7650e = new Object();

    /* renamed from: f, reason: collision with root package name */
    private static final C1263g f7651f = new C1263g();

    /* renamed from: d, reason: collision with root package name */
    public static final int f7649d = C1264h.f7653a;
    ...
    final void u(Context context, int i8, String str, PendingIntent pendingIntent) {
        ...
        if (W.h.c(context)) {
            ...
            if (W.h.d(context)) {
                style.addAction(M.a.f6821a, resources.getString(M.b.f6836o), pendingIntent);
            } else {
                style.setContentIntent(pendingIntent);
            }
        } else {
            style.setSmallIcon(R.drawable.stat_sys_warning).setTicker(resources.getString(M.b.f6829h)).setWhen(System.currentTimeMillis()).setContentIntent(pendingIntent).setContentText(d8);
        }
        if (W.k.h()) {
            ...
            if (str2 == null) {
                ...
                String string = context.getResources().getString(M.b.f6828g);
        ...
        if (i8 != 1 && i8 != 2 && i8 != 3) {
            ...
            AbstractC1268l.f7659b.set(false);
            i9 = 10436;
        }
    ...
    public final boolean x(Context context, C1258b c1258b, int i8) {
        ...
        u(context, c1258b.s(), null, PendingIntent.getActivity(context, 0, GoogleApiActivity.a(context, m8, i8, true), e0.h.f30208a | 134217728));
        return true;
    }
}
