...
public class ServiceConnectionC1257a implements ServiceConnection {
    ...
    boolean f7636a = false;

    /* renamed from: b, reason: collision with root package name */
    private final BlockingQueue f7637b = new LinkedBlockingQueue();
    ...
    public IBinder a(long j8, TimeUnit timeUnit) {
        ...
        if (!this.f7636a) {
            this.f7636a = true;
            IBinder iBinder = (IBinder) this.f7637b.poll(j8, timeUnit);
            if (iBinder != null) {
                return iBinder;
            }
