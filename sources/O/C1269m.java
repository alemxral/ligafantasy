...
public class C1269m {
    ...
    private static C1269m f7663c;

    /* renamed from: a, reason: collision with root package name */
    private final Context f7664a;

    /* renamed from: b, reason: collision with root package name */
    private volatile String f7665b;
    ...
    */
    ...
    private final N f(String str, boolean z8, boolean z9) {
        ...
        if (!str.equals(this.f7665b)) {
            if (D.e()) {
                c8 = D.b(str, AbstractC1268l.f(this.f7664a), false, false);
            } else {
                try {
                    PackageInfo packageInfo = this.f7664a.getPackageManager().getPackageInfo(str, 64);
                    boolean f8 = AbstractC1268l.f(this.f7664a);
                    if (packageInfo == null) {
                        c8 = N.c("null pkg");
                    } else {
                        Signature[] signatureArr = packageInfo.signatures;
                        if (signatureArr != null && signatureArr.length == 1) {
                            ...
                            if (a9.f7632a && (applicationInfo = packageInfo.applicationInfo) != null && (applicationInfo.flags & 2) != 0 && D.a(str2, a8, false, true).f7632a) {
    ...
    public boolean b(PackageInfo packageInfo) {
        ...
        if (e(packageInfo, true)) {
            if (AbstractC1268l.f(this.f7664a)) {
                return true;
            }
    ...
    public boolean c(int i8) {
        N c8;
        int length;
        String[] packagesForUid = this.f7664a.getPackageManager().getPackagesForUid(i8);
