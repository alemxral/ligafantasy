...
public class C1264h {
    ...
    public static final int f7653a = AbstractC1268l.f7658a;

    /* renamed from: b, reason: collision with root package name */
    private static final C1264h f7654b = new C1264h();
    ...
    public PendingIntent d(Context context, int i8, int i9, String str) {
        ...
        return PendingIntent.getActivity(context, i9, b8, g0.d.f31155a | 134217728);
    }
