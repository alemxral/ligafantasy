...
public abstract class y {
    public static Signature a(K1.p pVar, Provider provider) {
        ...
        Signature b12;
        Signature b13;
        if (pVar.equals(K1.p.f5814g) && (b13 = b("SHA256withRSA", provider)) != null) {
            return b13;
        }
        if (pVar.equals(K1.p.f5815h) && (b12 = b("SHA384withRSA", provider)) != null) {
            return b12;
        }
        if (pVar.equals(K1.p.f5816i) && (b11 = b("SHA512withRSA", provider)) != null) {
            return b11;
        }
        K1.p pVar2 = K1.p.f5821n;
        ...
        throw new K1.f(e.d(pVar, z.f7746c));
    }
