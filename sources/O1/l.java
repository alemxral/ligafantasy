...
public abstract class l {
    ...
    public static final Set f7731a;

    /* renamed from: b, reason: collision with root package name */
    public static final Map f7732b;

    static {
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        K1.d dVar = K1.d.f5716e;
        linkedHashSet.add(dVar);
        K1.d dVar2 = K1.d.f5717f;
        linkedHashSet.add(dVar2);
        K1.d dVar3 = K1.d.f5718g;
        linkedHashSet.add(dVar3);
        K1.d dVar4 = K1.d.f5721j;
        linkedHashSet.add(dVar4);
        K1.d dVar5 = K1.d.f5722k;
        linkedHashSet.add(dVar5);
        K1.d dVar6 = K1.d.f5723l;
        linkedHashSet.add(dVar6);
        K1.d dVar7 = K1.d.f5719h;
        linkedHashSet.add(dVar7);
        K1.d dVar8 = K1.d.f5720i;
        linkedHashSet.add(dVar8);
        K1.d dVar9 = K1.d.f5724m;
        linkedHashSet.add(dVar9);
        f7731a = DesugarCollections.unmodifiableSet(linkedHashSet);
        ...
        f7732b = DesugarCollections.unmodifiableMap(hashMap);
    }
    ...
    public static byte[] b(K1.m mVar, Z1.c cVar, Z1.c cVar2, Z1.c cVar3, Z1.c cVar4, SecretKey secretKey, Q1.c cVar5) {
        ...
        if (!mVar.v().equals(K1.d.f5716e) && !mVar.v().equals(K1.d.f5717f) && !mVar.v().equals(K1.d.f5718g)) {
            if (!mVar.v().equals(K1.d.f5721j) && !mVar.v().equals(K1.d.f5722k) && !mVar.v().equals(K1.d.f5723l)) {
                if (!mVar.v().equals(K1.d.f5719h) && !mVar.v().equals(K1.d.f5720i)) {
                    if (mVar.v().equals(K1.d.f5724m)) {
                        c8 = C.a(secretKey, cVar2.a(), cVar3.a(), a8, cVar4.a());
                    } else {
                        throw new K1.f(e.b(mVar.v(), f7731a));
                    }
                } else {
