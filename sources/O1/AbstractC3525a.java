...
public abstract class AbstractC3525a {
    ...
    private static final b f36348a;
    ...
    private static class d extends b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Method f36349a;

        /* renamed from: b, reason: collision with root package name */
        private final Method f36350b;

        /* renamed from: c, reason: collision with root package name */
        private final Method f36351c;

        /* renamed from: d, reason: collision with root package name */
        private final Method f36352d;
        ...
        public Constructor b(Class cls) {
            try {
                Object[] objArr = (Object[]) this.f36350b.invoke(cls, null);
                Class<?>[] clsArr = new Class[objArr.length];
                for (int i8 = 0; i8 < objArr.length; i8++) {
                    clsArr[i8] = (Class) this.f36352d.invoke(objArr[i8], null);
                }
        ...
        String[] c(Class cls) {
            try {
                ...
                for (int i8 = 0; i8 < objArr.length; i8++) {
                    strArr[i8] = (String) this.f36351c.invoke(objArr[i8], null);
                }
                return strArr;
            } catch (ReflectiveOperationException e8) {
                throw AbstractC3525a.d(e8);
        ...
        boolean d(Class cls) {
            try {
                return ((Boolean) this.f36349a.invoke(cls, null)).booleanValue();
            } catch (ReflectiveOperationException e8) {
                throw AbstractC3525a.d(e8);
            }
        }
        ...
        private d() {
            super();
            this.f36349a = Class.class.getMethod("isRecord", null);
            Method method = Class.class.getMethod("getRecordComponents", null);
            this.f36350b = method;
            Class<?> componentType = method.getReturnType().getComponentType();
            this.f36351c = componentType.getMethod("getName", null);
            this.f36352d = componentType.getMethod("getType", null);
        }
    }
    ...
    public static Method h(Class cls, Field field) {
        return f36348a.a(cls, field);
    }

    public static Constructor i(Class cls) {
        return f36348a.b(cls);
    }

    public static String[] j(Class cls) {
        return f36348a.c(cls);
    }

    public static boolean k(Class cls) {
        return f36348a.d(cls);
    }
