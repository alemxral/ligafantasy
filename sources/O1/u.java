...
public abstract class u {
    ...
    private static final byte[] f7738a = {0, 0, 0, 1};

    /* renamed from: b, reason: collision with root package name */
    private static final byte[] f7739b = {0, 0, 0, 0};

    /* renamed from: c, reason: collision with root package name */
    private static final byte[] f7740c = {69, 110, 99, 114, 121, 112, 116, 105, 111, 110};

    /* renamed from: d, reason: collision with root package name */
    private static final byte[] f7741d = {73, 110, 116, 101, 103, 114, 105, 116, 121};

    public static SecretKey a(SecretKey secretKey, K1.d dVar, byte[] bArr, byte[] bArr2) {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        try {
            byteArrayOutputStream.write(f7738a);
            byte[] encoded = secretKey.getEncoded();
            byteArrayOutputStream.write(encoded);
            int length = encoded.length * 8;
            byteArrayOutputStream.write(Z1.i.a(length / 2));
            byteArrayOutputStream.write(dVar.toString().getBytes(Z1.m.f13234a));
            if (bArr != null) {
                byteArrayOutputStream.write(Z1.i.a(bArr.length));
                byteArrayOutputStream.write(bArr);
            } else {
                byteArrayOutputStream.write(f7739b);
            }
            if (bArr2 != null) {
            ...
            byteArrayOutputStream.write(f7740c);
            try {
    ...
    public static SecretKey b(SecretKey secretKey, K1.d dVar, byte[] bArr, byte[] bArr2) {
        ...
        try {
            ...
            byteArrayOutputStream.write(f7741d);
            try {
