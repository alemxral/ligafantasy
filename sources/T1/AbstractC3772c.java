...
public abstract class AbstractC3772c {
    ...
    private static Pattern f38195c = Pattern.compile("^[0-1]*$", 2);

    /* renamed from: d, reason: collision with root package name */
    private static Pattern f38196d = Pattern.compile("^[A-Za-z0-9\\-_]*$", 2);
    ...
    public String c(String str) {
        if (f38196d.matcher(str).matches()) {
            String str2 = "";
            for (int i8 = 0; i8 < str.length(); i8++) {
                str2 = str2 + AbstractC3779j.b(((Integer) f38194b.get(Character.valueOf(str.charAt(i8)))).intValue(), 6);
            }
            return str2;
        }
    ...
    public String d(String str) {
        if (f38195c.matcher(str).matches()) {
            String g8 = g(str);
            String str2 = "";
            int i8 = 0;
            while (i8 <= g8.length() - 6) {
                int i9 = i8 + 6;
                try {
                    str2 = str2 + Character.valueOf(f38193a.charAt(AbstractC3779j.a(g8.substring(i8, i9))));
                    i8 = i9;
                } catch (C3800a unused) {
