...
public final class C4036G implements InterfaceC4061v {
    ...
    private char[] f40467a = C4045e.f40536c.d();
    ...
    private final void d(int i8, int i9, String str) {
        ...
        while (i8 < length) {
            ...
            if (charAt < S.a().length) {
                ...
                if (b8 == 0) {
                    i10 = f8 + 1;
                    this.f40467a[f8] = charAt;
                } else {
                    if (b8 == 1) {
                        String str2 = S.b()[charAt];
                        AbstractC3159y.f(str2);
                        int f9 = f(f8, str2.length());
                        str2.getChars(0, str2.length(), this.f40467a, f9);
                        i9 = f9 + str2.length();
                        this.f40468b = i9;
                    } else {
                        char[] cArr = this.f40467a;
                        cArr[f8] = '\\';
                        cArr[f8 + 1] = (char) b8;
                        i9 = f8 + 2;
                        this.f40468b = i9;
    ...
    public void c(String text) {
        ...
        e(length);
        text.getChars(0, text.length(), this.f40467a, this.f40468b);
        this.f40468b += length;
    }

    public void g() {
        C4045e.f40536c.c(this.f40467a);
    }

    public String toString() {
        return new String(this.f40467a, 0, this.f40468b);
    }
