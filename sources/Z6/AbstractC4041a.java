...
public abstract class AbstractC4041a {
    ...
    /* renamed from: b */
    public final C4033D f40529b = new C4033D();

    /* renamed from: d */
    private StringBuilder f40531d = new StringBuilder();
    ...
    private final int c(CharSequence charSequence, int i8) {
        ...
        if (i9 >= charSequence.length()) {
            this.f40528a = i8;
            u();
            if (this.f40528a + 4 < charSequence.length()) {
                return c(charSequence, this.f40528a);
            }
            x(this, "Unexpected EOF during unicode escape", 0, null, 6, null);
            throw new C1224h();
        }
        this.f40531d.append((char) ((B(charSequence, i8) << 12) + (B(charSequence, i8 + 1) << 8) + (B(charSequence, i8 + 2) << 4) + B(charSequence, i8 + 3)));
        return i9;
    }
    ...
    private final String s(int i8, int i9) {
        d(i8, i9);
        String sb = this.f40531d.toString();
        AbstractC3159y.h(sb, "toString(...)");
        this.f40531d.setLength(0);
        return sb;
    }
    ...
    public final void A(String key) {
        ...
        w("Encountered an unknown key '" + key + '\'', g6.n.X(K(0, this.f40528a), key, 0, false, 6, null), "Use 'ignoreUnknownKeys = true' in 'Json {}' builder to ignore unknown keys.");
        throw new C1224h();
    }
            ...
            if (F9 == 1) {
                ...
                if (F9 == 8 || F9 == 6) {
                    ...
                    if (((Number) AbstractC1246t.y0(arrayList)).byteValue() == 8) {
                        ...
                        throw AbstractC4031B.e(this.f40528a, "found ] instead of } at path: " + this.f40529b, C());
                    }
                } else if (F9 == 7) {
        ...
        if (i8 > 0 && c8 == '\"') {
            try {
                ...
                if (AbstractC3159y.d(q8, "null")) {
                    w("Expected string literal but 'null' literal was found", this.f40528a - 1, "Use 'coerceInputValues = true' in 'Json {}' builder to coerce nulls to default values.");
                    throw new C1224h();
                }
            } catch (Throwable th) {
                this.f40528a = i8;
    ...
    public final boolean g() {
        ...
        if (J8 != C().length()) {
            ...
            boolean f8 = f(J8);
            if (z8) {
                if (this.f40528a != C().length()) {
                    if (C().charAt(this.f40528a) == '\"') {
                        this.f40528a++;
                    } else {
    ...
    */
    ...
    public final String q() {
        ...
        if (J8 < C().length() && J8 != -1) {
            ...
            if (a8 == 0) {
                ...
                if (!z8) {
                    s8 = K(this.f40528a, J8);
                } else {
                    s8 = s(this.f40528a, J8);
                }
                this.f40528a = J8;
                return s8;
            }
    ...
    public String toString() {
        return "JsonReader(source='" + ((Object) C()) + "', currentPosition=" + this.f40528a + ')';
    }
    ...
    public final void v() {
        ...
        x(this, "Expected EOF after parsing, but had " + C().charAt(this.f40528a - 1) + " instead", 0, null, 6, null);
        throw new C1224h();
    }
    ...
    public final Void w(String message, int i8, String hint) {
        ...
        throw AbstractC4031B.e(i8, message + " at path: " + this.f40529b.a() + str, C());
    }
