...
public abstract class b implements Y6.e {
    ...
    private static long[] f13412g = {1, 32898, -9223372036854742902L, -9223372034707259392L, 32907, 2147483649L, -9223372034707259263L, -9223372036854743031L, 138, 136, 2147516425L, 2147483658L, 2147516555L, -9223372036854775669L, -9223372036854742903L, -9223372036854743037L, -9223372036854743038L, -9223372036854775680L, 32778, -9223372034707292150L, -9223372034707259263L, -9223372036854742912L, 2147483649L, -9223372034707259384L};

    /* renamed from: a, reason: collision with root package name */
    protected long[] f13413a = new long[25];

    /* renamed from: b, reason: collision with root package name */
    protected byte[] f13414b = new byte[PsExtractor.AUDIO_STREAM];
    ...
    private void g(byte[] bArr, int i8) {
        int i9 = this.f13415c >>> 6;
        for (int i10 = 0; i10 < i9; i10++) {
            long[] jArr = this.f13413a;
    ...
    private void h() {
        i();
        m();
        E7.f.l(this.f13413a, 0, this.f13415c >>> 6, this.f13414b, 0);
        ...
        if (i8 > 0 && i8 < 1600 && i8 % 64 == 0) {
            ...
            while (true) {
                ...
                if (i9 < jArr.length) {
                    ...
                    E7.a.i(this.f13414b, (byte) 0);
                    this.f13416d = 0;
                    this.f13418f = false;
                    this.f13417e = (1600 - i8) / 2;
                    return;
                }
            }
        } else {
    ...
    private void p() {
        ...
        if (i10 == this.f13415c) {
            ...
            for (int i14 = 0; i14 < i11; i14++) {
                long[] jArr = this.f13413a;
                jArr[i14] = jArr[i14] ^ E7.f.g(this.f13414b, i13);
                i13 += 8;
            }
            m();
            if (i12 > 0) {
                long[] jArr2 = this.f13413a;
                jArr2[i11] = (((1 << i12) - 1) & E7.f.g(this.f13414b, i13)) ^ jArr2[i11];
            }
        }
        long[] jArr3 = this.f13413a;
        int i15 = (this.f13415c - 1) >>> 6;
    ...
    protected void k(byte[] bArr, int i8, int i9) {
        ...
        if (i12 % 8 == 0) {
            if (!this.f13418f) {
                int i13 = i12 >>> 3;
                int i14 = this.f13415c >>> 3;
                int i15 = i14 - i13;
                if (i9 < i15) {
                    System.arraycopy(bArr, i8, this.f13414b, i13, i9);
                    i11 = this.f13416d + (i9 << 3);
                } else {
                    if (i13 > 0) {
                        System.arraycopy(bArr, i8, this.f13414b, i13, i15);
                        g(this.f13414b, 0);
                    } else {
                        i15 = 0;
                    }
                    ...
                    System.arraycopy(bArr, i8 + i15, this.f13414b, 0, i10);
                    i11 = i10 << 3;
                }
                this.f13416d = i11;
                return;
    ...
    public void l(int i8, int i9) {
        if (i9 >= 1 && i9 <= 7) {
            ...
            if (i10 % 8 == 0) {
                if (!this.f13418f) {
                    this.f13414b[i10 >>> 3] = (byte) (i8 & ((1 << i9) - 1));
                    this.f13416d = i10 + i9;
                    return;
                }
                throw new IllegalStateException("attempt to absorb while squeezing");
    ...
    protected byte[] m() {
        byte[] bArr = new byte[this.f13413a.length * 8];
        int i8 = 0;
        int i9 = 0;
        while (true) {
            long[] jArr = this.f13413a;
    ...
    public void r(byte[] bArr, int i8, long j8) {
        ...
        if (j8 % 8 == 0) {
            while (j9 < j8) {
                ...
                int min = (int) Math.min(this.f13416d, j8 - j9);
                System.arraycopy(this.f13414b, (this.f13415c - this.f13416d) / 8, bArr, ((int) (j9 / 8)) + i8, min / 8);
                this.f13416d -= min;
                j9 += min;
            }
            m();
