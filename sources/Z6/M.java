...
public final class M implements A6.d {
    ...
    private final void d(v6.f fVar, InterfaceC2643c interfaceC2643c) {
        ...
        for (int i8 = 0; i8 < e8; i8++) {
            String f8 = fVar.f(i8);
            if (AbstractC3159y.d(f8, this.f40496b)) {
    ...
    private final void e(v6.f fVar, InterfaceC2643c interfaceC2643c) {
        ...
        if (!(kind instanceof v6.d) && !AbstractC3159y.d(kind, j.a.f38905a)) {
            if (this.f40495a) {
                return;
            }
            if (!AbstractC3159y.d(kind, k.b.f38908a) && !AbstractC3159y.d(kind, k.c.f38909a) && !(kind instanceof v6.e) && !(kind instanceof j.b)) {
                return;
            }
