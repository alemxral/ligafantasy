...
public abstract class AbstractC4031B {
    ...
    public static final Void g(AbstractC4041a abstractC4041a, String entity) {
        ...
        abstractC4041a.w("Trailing comma before the end of JSON " + entity, abstractC4041a.f40528a - 1, "Trailing commas are non-complaint JSON and not allowed by default. Use 'allowTrailingCommas = true' in 'Json {}' builder to support them.");
        throw new C1224h();
    }
