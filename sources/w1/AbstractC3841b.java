...
public abstract class AbstractC3841b implements InterfaceC3842c {
    ...
    protected Map f38927a;

    /* renamed from: b, reason: collision with root package name */
    protected String[][] f38928b;

    @Override // w1.InterfaceC3842c
    public void a(String str, Object obj) {
        if (this.f38927a.containsKey(str)) {
            ((AbstractC3733a) this.f38927a.get(str)).d(obj);
            return;
        }
    ...
    public Object c(String str) {
        if (this.f38927a.containsKey(str)) {
            return ((AbstractC3733a) this.f38927a.get(str)).c();
        }
        return null;
    }
    ...
    */
    public void d(java.util.List r9) {
        /*
            ...
            r1 = 0
        L2:
            java.lang.String[][] r2 = r8.f38928b
            int r2 = r2.length
            if (r1 >= r2) goto L7c
            int r2 = r9.size()
            if (r1 >= r2) goto L7c
            ...
            r4 = 0
        L1d:
            java.lang.String[][] r5 = r8.f38928b
            r5 = r5[r1]
            int r6 = r5.length
            if (r3 >= r6) goto L79
            r5 = r5[r3]
            java.util.Map r6 = r8.f38927a
            boolean r6 = r6.containsKey(r5)
            if (r6 == 0) goto L5d
            java.util.Map r6 = r8.f38927a     // Catch: java.lang.Exception -> L45
    ...
    */
    public java.util.List e() {
        /*
            ...
            r2 = 0
        L7:
            java.lang.String[][] r3 = r8.f38928b
            int r3 = r3.length
            if (r2 >= r3) goto L78
            java.lang.String r3 = ""
            r4 = 0
        Lf:
            ...
            boolean r6 = r6.containsKey(r5)
            if (r6 == 0) goto L56
            java.util.Map r6 = r8.f38927a     // Catch: java.lang.Exception -> L3e
