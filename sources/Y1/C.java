...
public final class C {
    ...
    private C1515d f12767h;

    /* renamed from: i, reason: collision with root package name */
    private int f12768i;

    /* renamed from: j, reason: collision with root package name */
    private C1515d f12769j;
    ...
    public C(h hVar) {
        this.f12760a = hVar;
        this.f12761b = null;
        this.f12765f = new a[256];
        this.f12766g = 1;
        this.f12767h = new C1515d();
    }
    ...
    private B F(int i8, String str) {
        int W7 = W(i8, str);
        for (a N8 = N(W7); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == i8 && N8.f12772h == W7 && N8.f12757e.equals(str)) {
                return N8;
            }
        }
        this.f12767h.e(i8, D(str));
        int i9 = this.f12766g;
        this.f12766g = i9 + 1;
    ...
    private int J(a aVar) {
        if (this.f12771l == null) {
            this.f12771l = new a[16];
        }
        int i8 = this.f12770k;
        a[] aVarArr = this.f12771l;
        if (i8 == aVarArr.length) {
            a[] aVarArr2 = new a[aVarArr.length * 2];
            System.arraycopy(aVarArr, 0, aVarArr2, 0, aVarArr.length);
            this.f12771l = aVarArr2;
        }
        a[] aVarArr3 = this.f12771l;
        int i9 = this.f12770k;
        this.f12770k = i9 + 1;
        aVarArr3[i9] = aVar;
        return c0(aVar).f12753a;
    }

    private void M(C1516e c1516e, char[] cArr) {
        byte[] bArr = c1516e.f12807c;
        int e8 = c1516e.e();
        ...
        if (this.f12768i > 0) {
            ...
            c1515d.h(bArr, i8, t8);
            int i9 = i8;
            for (int i10 = 0; i10 < this.f12768i; i10++) {
                int i11 = i9 - i8;
                int I9 = c1516e.I(i9);
    ...
    private B b(int i8, int i9, int i10) {
        byte[] bArr = this.f12769j.f12803a;
        for (a N8 = N(i10); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == 64 && N8.f12772h == i10) {
                int i11 = (int) N8.f12758f;
                for (int i12 = 0; i12 < i9; i12++) {
                    if (bArr[i8 + i12] != bArr[i11 + i12]) {
                        break;
                    }
                }
                this.f12769j.f12804b = i8;
                return N8;
            }
        }
        int i13 = this.f12768i;
        this.f12768i = i13 + 1;
    ...
    private a c0(a aVar) {
        ...
        if (i8 > (aVarArr.length * 3) / 4) {
            ...
            for (int i10 = length - 1; i10 >= 0; i10--) {
                a aVar2 = this.f12765f[i10];
                while (aVar2 != null) {
                    int i11 = aVar2.f12772h % i9;
                    a aVar3 = aVar2.f12773i;
                    aVar2.f12773i = aVarArr2[i11];
                    aVarArr2[i11] = aVar2;
                    aVar2 = aVar3;
                }
            }
            this.f12765f = aVarArr2;
        }
        this.f12764e++;
        int i12 = aVar.f12772h;
        a[] aVarArr3 = this.f12765f;
        int length2 = i12 % aVarArr3.length;
        aVar.f12773i = aVarArr3[length2];
    ...
    private B h(int i8, String str, String str2, int i9) {
        ...
        for (a N8 = N(Z7); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == i8 && N8.f12772h == Z7 && N8.f12758f == i9 && N8.f12756d.equals(str) && N8.f12757e.equals(str2)) {
                return N8;
            }
        }
        this.f12767h.f(i8, i9, z(str, str2));
    ...
    private B m(int i8, int i9) {
        int U7 = U(i8, i9);
        for (a N8 = N(U7); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == i8 && N8.f12772h == U7 && N8.f12758f == i9) {
                return N8;
            }
        }
        this.f12767h.g(i8).i(i9);
        int i10 = this.f12766g;
        this.f12766g = i10 + 1;
    ...
    private B q(int i8, long j8) {
        int V7 = V(i8, j8);
        for (a N8 = N(V7); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == i8 && N8.f12772h == V7 && N8.f12758f == j8) {
                return N8;
            }
        }
        int i9 = this.f12766g;
        this.f12767h.g(i8).j(j8);
        this.f12766g += 2;
    ...
    private a s(int i8, String str, String str2, String str3) {
        ...
        for (a N8 = N(a02); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == i8 && N8.f12772h == a02 && N8.f12755c.equals(str) && N8.f12756d.equals(str2) && N8.f12757e.equals(str3)) {
                return N8;
            }
        }
        this.f12767h.f(i8, e(str).f12753a, z(str2, str3));
        int i9 = this.f12766g;
        this.f12766g = i9 + 1;
    ...
    public int D(String str) {
        int W7 = W(1, str);
        for (a N8 = N(W7); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == 1 && N8.f12772h == W7 && N8.f12757e.equals(str)) {
                return N8.f12753a;
            }
        }
        this.f12767h.g(1).l(str);
        int i8 = this.f12766g;
        this.f12766g = i8 + 1;
        return c0(new a(i8, 1, str, W7)).f12753a;
    }
    ...
    public int H(int i8, int i9) {
        ...
        for (a N8 = N(U7); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == 130 && N8.f12772h == U7 && N8.f12758f == j10) {
                return N8.f12759g;
            }
        }
        a[] aVarArr = this.f12771l;
        int I8 = I(this.f12760a.r(aVarArr[i8].f12757e, aVarArr[i9].f12757e));
        c0(new a(this.f12770k, TsExtractor.TS_STREAM_TYPE_HDMV_DTS, j10, U7)).f12759g = I8;
        return I8;
    }
    ...
    public int I(String str) {
        int W7 = W(128, str);
        for (a N8 = N(W7); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == 128 && N8.f12772h == W7 && N8.f12757e.equals(str)) {
                return N8.f12753a;
            }
        }
        return J(new a(this.f12770k, 128, str, W7));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int K(String str, int i8) {
        int X7 = X(TsExtractor.TS_STREAM_TYPE_AC3, str, i8);
        for (a N8 = N(X7); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == 129 && N8.f12772h == X7 && N8.f12758f == i8 && N8.f12757e.equals(str)) {
                return N8.f12753a;
            }
        }
        return J(new a(this.f12770k, TsExtractor.TS_STREAM_TYPE_AC3, str, i8, X7));
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public B T(int i8) {
        return this.f12771l[i8];
    }

    B c(q qVar, Object... objArr) {
        C1515d c1515d = this.f12769j;
        if (c1515d == null) {
            c1515d = new C1515d();
            this.f12769j = c1515d;
        }
        ...
        for (int i8 = 0; i8 < length; i8++) {
            iArr[i8] = d(objArr[i8]).f12753a;
        }
        int i9 = c1515d.f12804b;
        c1515d.k(u(qVar.d(), qVar.c(), qVar.b(), qVar.a(), qVar.e()).f12753a);
        c1515d.k(length);
        for (int i10 = 0; i10 < length; i10++) {
            c1515d.k(iArr[i10]);
        }
        int i11 = c1515d.f12804b - i9;
    ...
    public void d0(C1515d c1515d) {
        if (this.f12769j != null) {
            C1515d k8 = c1515d.k(D("BootstrapMethods")).i(this.f12769j.f12804b + 2).k(this.f12768i);
            C1515d c1515d2 = this.f12769j;
            k8.h(c1515d2.f12803a, 0, c1515d2.f12804b);
        }
    }
    ...
    public void e0(C1515d c1515d) {
        C1515d k8 = c1515d.k(this.f12766g);
        C1515d c1515d2 = this.f12767h;
        k8.h(c1515d2.f12803a, 0, c1515d2.f12804b);
    }
    ...
    public int f0(int i8, String str) {
        this.f12762c = i8;
        this.f12763d = str;
        return e(str).f12753a;
    }

    B g(String str, String str2, q qVar, Object... objArr) {
        return h(17, str, str2, c(qVar, objArr).f12753a);
    }
    ...
    public B o(String str, String str2, q qVar, Object... objArr) {
        return h(18, str, str2, c(qVar, objArr).f12753a);
    }
    ...
    B u(int i8, String str, String str2, String str3, boolean z8) {
        ...
        for (a N8 = N(b02); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == 15 && N8.f12772h == b02 && N8.f12758f == i8 && N8.f12755c.equals(str) && N8.f12756d.equals(str2) && N8.f12757e.equals(str3)) {
                return N8;
            }
        }
        if (i8 <= 4) {
            this.f12767h.d(15, i8, j(str, str2, str3).f12753a);
        } else {
            this.f12767h.d(15, i8, x(str, str2, str3, z8).f12753a);
        }
        int i9 = this.f12766g;
        this.f12766g = i9 + 1;
    ...
    public int z(String str, String str2) {
        ...
        for (a N8 = N(Y7); N8 != null; N8 = N8.f12773i) {
            if (N8.f12754b == 12 && N8.f12772h == Y7 && N8.f12756d.equals(str) && N8.f12757e.equals(str2)) {
                return N8.f12753a;
            }
        }
        this.f12767h.f(12, D(str), D(str2));
        int i8 = this.f12766g;
        this.f12766g = i8 + 1;
        return c0(new a(i8, 12, str, str2, Y7)).f12753a;
    }
    ...
    public C(h hVar, C1516e c1516e) {
        ...
        byte[] bArr = c1516e.f12807c;
        int f8 = c1516e.f(1) - 1;
        int i8 = c1516e.f12806b - f8;
        this.f12766g = c1516e.g();
        C1515d c1515d = new C1515d(i8);
        this.f12767h = c1515d;
        c1515d.h(bArr, f8, i8);
        this.f12765f = new a[this.f12766g * 2];
        char[] cArr = new char[c1516e.h()];
        boolean z8 = false;
        int i9 = 1;
        while (i9 < this.f12766g) {
            int f9 = c1516e.f(i9);
            byte b8 = bArr[f9 - 1];
            switch (b8) {
                case 1:
