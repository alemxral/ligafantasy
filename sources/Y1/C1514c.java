...
public class C1514c {
    ...
    static final class a {
        ...
        private boolean c(C1514c c1514c) {
            for (int i8 = 0; i8 < this.f12801a; i8++) {
                if (this.f12802b[i8].f12798a.equals(c1514c.f12798a)) {
                    return true;
                }
            }
            return false;
        ...
        public C1514c[] d() {
            ...
            System.arraycopy(this.f12802b, 0, c1514cArr, 0, i8);
            return c1514cArr;
        }
    }
    ...
    public final int c(C c8, byte[] bArr, int i8, int i9, int i10) {
        h hVar = c8.f12760a;
        int i11 = 0;
        for (C1514c c1514c = this; c1514c != null; c1514c = c1514c.f12800c) {
            c8.D(c1514c.f12798a);
            i11 += c1514c.j(hVar, bArr, i8, i9, i10).f12804b + 6;
        }
        return i11;
    }
    ...
    public final void h(C c8, byte[] bArr, int i8, int i9, int i10, C1515d c1515d) {
        ...
        for (C1514c c1514c = this; c1514c != null; c1514c = c1514c.f12800c) {
            ...
            c1515d.k(c8.D(c1514c.f12798a)).i(j8.f12804b);
            c1515d.h(j8.f12803a, 0, j8.f12804b);
        }
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public C1514c i(C1516e c1516e, int i8, int i9, char[] cArr, int i10, s[] sVarArr) {
        C1514c c1514c = new C1514c(this.f12798a);
        byte[] bArr = new byte[i9];
        c1514c.f12799b = bArr;
        System.arraycopy(c1516e.f12807c, i8, bArr, 0, i9);
        return c1514c;
    }

    protected C1515d j(h hVar, byte[] bArr, int i8, int i9, int i10) {
        return new C1515d(this.f12799b);
    }
}
