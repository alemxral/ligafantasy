...
public class C1515d {
    ...
    public C1515d() {
        this.f12803a = new byte[64];
    }

    private void b(int i8) {
        byte[] bArr = this.f12803a;
    ...
    public final C1515d a(String str, int i8, int i9) {
        ...
        if (i11 <= i9) {
            ...
            if ((i12 + i11) - i8 > this.f12803a.length) {
                b(i11 - i8);
            }
            int i15 = this.f12804b;
            while (i8 < length) {
                char charAt2 = str.charAt(i8);
                if (charAt2 >= 1 && charAt2 <= 127) {
                    this.f12803a[i15] = (byte) charAt2;
                    i15++;
                } else if (charAt2 <= 2047) {
                    byte[] bArr2 = this.f12803a;
                    int i16 = i15 + 1;
                    bArr2[i15] = (byte) (((charAt2 >> 6) & 31) | PsExtractor.AUDIO_STREAM);
                    i15 += 2;
                    bArr2[i16] = (byte) ((charAt2 & '?') | 128);
                } else {
                    byte[] bArr3 = this.f12803a;
    ...
    public C1515d g(int i8) {
        int i9 = this.f12804b;
        int i10 = i9 + 1;
        if (i10 > this.f12803a.length) {
            b(1);
        }
        this.f12803a[i9] = (byte) i8;
        this.f12804b = i10;
        return this;
    }

    public C1515d h(byte[] bArr, int i8, int i9) {
        if (this.f12804b + i9 > this.f12803a.length) {
            b(i9);
        }
        if (bArr != null) {
            System.arraycopy(bArr, i8, this.f12803a, this.f12804b, i9);
        }
        this.f12804b += i9;
        return this;
    }
    ...
    public C1515d l(String str) {
        ...
        if (length <= 65535) {
            int i8 = this.f12804b;
            if (i8 + 2 + length > this.f12803a.length) {
                b(length + 2);
            }
            byte[] bArr = this.f12803a;
            int i9 = i8 + 1;
    ...
    public C1515d(int i8) {
        this.f12803a = new byte[i8];
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public C1515d(byte[] bArr) {
        this.f12803a = bArr;
        this.f12804b = bArr.length;
    }
}
