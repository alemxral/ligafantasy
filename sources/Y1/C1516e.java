...
public class C1516e {
    ...
    public C1516e(byte[] bArr, int i8, boolean z8) {
        ...
        int I8 = I(i8 + 8);
        this.f12808d = new int[I8];
        this.f12809e = new String[I8];
        int i10 = i8 + 10;
        int i11 = 0;
        boolean z9 = false;
        boolean z10 = false;
        ...
        this.f12810f = iVarArr;
        this.f12811g = z10 ? k(i11) : null;
    }

    private void A(u uVar, k kVar, int i8, boolean z8) {
        int i9 = i8 + 1;
        int i10 = this.f12807c[i8] & 255;
        uVar.a(i10, z8);
        char[] cArr = kVar.f12855c;
    ...
    private int B(g gVar, k kVar, int i8) {
        ...
        while (true) {
            ...
            if ("Signature".equals(H10)) {
                ...
                c1514c = j(kVar2.f12853a, H10, i9, t8, cArr, -1, null);
                c1514c.f12800c = c1514c2;
                i14 = i14;
                i13 = i13;
                i12 = i12;
                i11 = i11;
        ...
        if (i18 != 0) {
            ...
            while (true) {
                ...
                int F8 = F(kVar, i25);
                i25 = r(m8.d(kVar.f12860h, kVar.f12861i, H(F8, cArr), true), F8 + 2, true, cArr);
                I11 = i26;
            }
        }
        if (i17 != 0) {
            ...
            while (true) {
                ...
                int F9 = F(kVar, i27);
                i27 = r(m8.d(kVar.f12860h, kVar.f12861i, H(F9, cArr), false), F9 + 2, true, cArr);
                I12 = i28;
            }
        }
        C1514c c1514c4 = c1514c3;
        while (c1514c4 != null) {
            C1514c c1514c5 = c1514c4.f12800c;
            c1514c4.f12800c = null;
            m8.b(c1514c4);
            c1514c4 = c1514c5;
        }
        m8.c();
    ...
    private int D(int i8, boolean z8, boolean z9, k kVar) {
        ...
        int i11;
        char[] cArr = kVar.f12855c;
        s[] sVarArr = kVar.f12859g;
        if (z8) {
            i9 = i8 + 1;
            i10 = this.f12807c[i8] & 255;
        } else {
            kVar.f12865m = -1;
            i9 = i8;
            i10 = 255;
        ...
        if (i10 < 64) {
            ...
            i10 -= 64;
            i9 = L(i9, kVar.f12871s, 0, cArr, sVarArr);
            kVar.f12866n = 4;
            kVar.f12870r = 1;
        } else if (i10 >= 247) {
            int I8 = I(i9);
            int i12 = i9 + 2;
            if (i10 == 247) {
                i9 = L(i12, kVar.f12871s, 0, cArr, sVarArr);
                kVar.f12866n = 4;
                kVar.f12870r = 1;
            } else {
                if (i10 >= 248 && i10 < 251) {
                    ...
                    int i16 = i14;
                    while (i16 > 0) {
                        i9 = L(i9, kVar.f12869q, i15, cArr, sVarArr);
                        i16--;
                        i15++;
                    }
                    kVar.f12866n = 1;
                    ...
                    for (int i18 = 0; i18 < I9; i18++) {
                        i17 = L(i17, kVar.f12869q, i18, cArr, sVarArr);
                    }
                    int I10 = I(i17);
                    i9 = i17 + 2;
                    kVar.f12870r = I10;
                    for (int i19 = 0; i19 < I10; i19++) {
                        i9 = L(i9, kVar.f12871s, i19, cArr, sVarArr);
                    }
                }
                i9 = i12;
            }
    ...
    private String E(int i8, char[] cArr) {
        return H(this.f12808d[I(i8)], cArr);
    }
    ...
    */
    private void b(Y1.k r11) {
        /*
            r10 = this;
            java.lang.String r0 = r11.f12858f
            java.lang.Object[] r1 = r11.f12869q
            int r2 = r11.f12856d
            r2 = r2 & 8
            r3 = 1
            r4 = 0
            ...
            java.lang.String r5 = r11.f12857e
            boolean r2 = r2.equals(r5)
            if (r2 == 0) goto L1c
            java.lang.Integer r2 = Y1.y.f13006g
            r1[r4] = r2
        L1a:
            r4 = 1
            goto L29
        ...
        L54:
            int r2 = r4 + 1
            java.lang.Integer r6 = Y1.y.f13003d
            r1[r4] = r6
        L5a:
            r4 = r2
            r2 = r5
        ...
        L81:
            int r2 = r4 + 1
            java.lang.Integer r6 = Y1.y.f13004e
            r1[r4] = r6
            goto L5a
        L88:
            int r2 = r4 + 1
            java.lang.Integer r6 = Y1.y.f13001b
            r1[r4] = r6
            goto L5a
        L8f:
            r2 = r5
        ...
        La6:
            int r2 = r4 + 1
            java.lang.Integer r6 = Y1.y.f13002c
            r1[r4] = r6
            goto L5a
        */
    ...
    private void c(int i8, s[] sVarArr) {
        if (sVarArr[i8] == null) {
            s u8 = u(i8, sVarArr);
            u8.f12909a = (short) (u8.f12909a | 1);
        }
    }

    private s d(int i8, s[] sVarArr) {
        s u8 = u(i8, sVarArr);
        u8.f12909a = (short) (u8.f12909a & (-2));
        return u8;
    }
        ...
        if (i12 != 64) {
            if (i12 != 70) {
                if (i12 != 83) {
                                ...
                                if (i12 != 73 && i12 != 74) {
                                    if (i12 != 90) {
                                        if (i12 != 91) {
                                            switch (i12) {
                                                case 66:
                                                    abstractC1512a.a(str, Byte.valueOf((byte) t(this.f12808d[I(i11)])));
                                                    break;
                                                case 67:
                                                    abstractC1512a.a(str, Character.valueOf((char) t(this.f12808d[I(i11)])));
                                                    break;
                                                case 68:
                                                    break;
                                                default:
                                            ...
                                            if (i14 != 70) {
                                                if (i14 != 83) {
                                                    if (i14 != 90) {
                                                        if (i14 != 73) {
                                                            if (i14 != 74) {
                                                                switch (i14) {
                                                                    case 66:
                                                                        ...
                                                                        while (i9 < I8) {
                                                                            bArr[i9] = (byte) t(this.f12808d[I(i13 + 1)]);
                                                                            i13 += 3;
                                                                            i9++;
                                                                        }
                                                                    ...
                                                                    case 67:
                                                                        ...
                                                                        while (i9 < I8) {
                                                                            cArr2[i9] = (char) t(this.f12808d[I(i13 + 1)]);
                                                                            i13 += 3;
                                                                            i9++;
                                                                        }
                                                                    ...
                                                                    case 68:
                                                                        ...
                                                                        while (i9 < I8) {
                                                                            dArr[i9] = Double.longBitsToDouble(v(this.f12808d[I(i13 + 1)]));
                                                                            i13 += 3;
                                                                            i9++;
                                                                        }
                                                                ...
                                                                while (i9 < I8) {
                                                                    jArr[i9] = v(this.f12808d[I(i13 + 1)]);
                                                                    i13 += 3;
                                                                    i9++;
                                                                }
                                                            ...
                                                            int[] iArr = new int[I8];
                                                            while (i9 < I8) {
                                                                iArr[i9] = t(this.f12808d[I(i13 + 1)]);
                                                                i13 += 3;
                                                                i9++;
                                                            }
                                                    ...
                                                    while (i9 < I8) {
                                                        sArr[i9] = (short) t(this.f12808d[I(i13 + 1)]);
                                                        i13 += 3;
                                                        i9++;
                                                    }
                                                ...
                                                while (i9 < I8) {
                                                    fArr[i9] = Float.intBitsToFloat(t(this.f12808d[I(i13 + 1)]));
                                                    i13 += 3;
                                                    i9++;
                                                }
                    ...
                    abstractC1512a.a(str, Short.valueOf((short) t(this.f12808d[I(i11)])));
                }
                return i8 + 3;
            }
    ...
    private int s(g gVar, k kVar, int i8) {
        ...
        if (i20 != 0) {
            ...
            while (true) {
                ...
                int F8 = F(kVar, i27);
                i27 = r(e8.d(kVar.f12860h, kVar.f12861i, H(F8, cArr), true), F8 + 2, true, cArr);
                I13 = i28;
            }
        }
        if (i19 != 0) {
            ...
            while (true) {
                ...
                int F9 = F(kVar, i29);
                i29 = r(e8.d(kVar.f12860h, kVar.f12861i, H(F9, cArr), false), F9 + 2, true, cArr);
                I14 = i30;
            }
        }
        while (true) {
    ...
    private int w(g gVar, k kVar, int i8) {
        ...
        char[] cArr = kVar.f12855c;
        kVar.f12856d = I(i8);
        kVar.f12857e = H(i8 + 2, cArr);
        int i11 = i8 + 4;
        kVar.f12858f = H(i11, cArr);
        int I8 = I(i8 + 6);
        int i12 = i8 + 8;
        int i13 = 0;
        int i14 = 0;
            ...
            if ("Code".equals(H8)) {
                ...
                if ("Exceptions".equals(H8)) {
                    ...
                    if ("Signature".equals(H8)) {
                        ...
                        i10 = i26;
                        C1514c j8 = j(kVar.f12853a, H8, i26, t8, cArr, -1, null);
                        j8.f12800c = c1514c;
                        c1514c = j8;
                        i18 = i25;
                        i13 = i27;
        ...
        int i35 = i17;
        int i36 = i18;
        int i37 = kVar.f12856d;
        String str = kVar.f12857e;
        String str2 = kVar.f12858f;
        if (i36 == 0) {
            K8 = null;
        } else {
            K8 = K(i36, cArr);
        ...
        if (i31 != 0) {
            ...
            while (true) {
                ...
                int F8 = F(kVar, i44);
                i44 = r(g8.C(kVar.f12860h, kVar.f12861i, H(F8, cArr), true), F8 + 2, true, cArr);
                I12 = i45;
            }
        }
        int i46 = i20;
        if (i46 != 0) {
            ...
            while (true) {
                ...
                int F9 = F(kVar, i47);
                i47 = r(g8.C(kVar.f12860h, kVar.f12861i, H(F9, cArr), false), F9 + 2, true, cArr);
                I13 = i48;
            }
        }
        int i49 = i21;
    ...
    public void a(g gVar, C1514c[] c1514cArr, int i8) {
        ...
        String[] strArr;
        k kVar = new k();
        kVar.f12853a = c1514cArr;
        kVar.f12854b = i8;
        char[] cArr = new char[this.f12812h];
        kVar.f12855c = cArr;
        int i12 = this.f12806b;
        int I8 = I(i12);
        ...
        C1514c c1514c2 = c1514c;
        gVar.a(t(this.f12808d[1] - 7), i15, m8, str3, m9, strArr3);
        ...
        if (i29 != 0) {
            ...
            if (I11 == 0) {
                ...
                H8 = H(this.f12808d[I11], cArr);
            }
            if (I11 == 0) {
                H9 = null;
            } else {
                H9 = H(this.f12808d[I11] + 2, cArr);
            }
            gVar.k(m10, H8, H9);
        }
        int i30 = i19;
        ...
        if (i36 != 0) {
            ...
            while (true) {
                ...
                int F8 = F(kVar, i37);
                i37 = r(gVar.o(kVar.f12860h, kVar.f12861i, H(F8, cArr), true), F8 + 2, true, cArr);
                I14 = i38;
            }
        }
        int i39 = i22;
        if (i39 != 0) {
            ...
            while (true) {
                ...
                int F9 = F(kVar, i40);
                i40 = r(gVar.o(kVar.f12860h, kVar.f12861i, H(F9, cArr), false), F9 + 2, true, cArr);
                I15 = i41;
            }
        }
        while (c1514c2 != null) {
            C1514c c1514c3 = c1514c2.f12800c;
            c1514c2.f12800c = null;
            gVar.c(c1514c2);
            c1514c2 = c1514c3;
        }
        int i42 = i23;
    ...
    public int f(int i8) {
        return this.f12808d[i8];
    }

    public int g() {
        return this.f12808d.length;
    }
        ...
        switch (b8) {
            ...
            default:
                switch (b8) {
                    case 15:
                        int l8 = l(i9);
                        int i10 = this.f12808d[I(i9 + 1)];
                        int i11 = this.f12808d[I(i10 + 2)];
                        String m8 = m(i10, cArr);
                        String H8 = H(i11, cArr);
                        String H9 = H(i11 + 2, cArr);
                        if (this.f12807c[i10 - 1] == 11) {
                            z8 = true;
                        } else {
                            z8 = false;
                        }
