...
public class l extends AbstractC1346m {
    ...
    private final byte[] f33721a;

    /* renamed from: b, reason: collision with root package name */
    private final byte[] f33722b;

    public l(byte[] bArr, byte[] bArr2) {
        this.f33721a = E7.a.d(bArr);
        this.f33722b = E7.a.d(bArr2);
    }
    ...
    public AbstractC1351s d() {
        ...
        c1337e.a(new C1330a0(this.f33721a));
        c1337e.a(new C1330a0(this.f33722b));
