...
public class n extends AbstractC1346m {
    ...
    private final byte[] f33731a;

    /* renamed from: b, reason: collision with root package name */
    private final byte[] f33732b;

    private n(AbstractC1353u abstractC1353u) {
        if (!C1344k.x(abstractC1353u.x(0)).z(0)) {
            throw new IllegalArgumentException("unknown version of sequence");
        }
        this.f33731a = E7.a.d(AbstractC1348o.x(abstractC1353u.x(1)).y());
        this.f33732b = E7.a.d(AbstractC1348o.x(abstractC1353u.x(2)).y());
    }
    ...
    public AbstractC1351s d() {
        ...
        c1337e.a(new C1330a0(this.f33731a));
        c1337e.a(new C1330a0(this.f33732b));
        return new C1338e0(c1337e);
    }

    public byte[] p() {
        return E7.a.d(this.f33731a);
    }

    public byte[] q() {
        return E7.a.d(this.f33732b);
    }

    public n(byte[] bArr, byte[] bArr2) {
        this.f33731a = E7.a.d(bArr);
        this.f33732b = E7.a.d(bArr2);
    }
}
