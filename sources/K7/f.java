...
public class f extends AbstractC1346m {
    ...
    private C1344k f33690a;

    /* renamed from: b, reason: collision with root package name */
    private C1347n f33691b;

    /* renamed from: c, reason: collision with root package name */
    private byte[][] f33692c;

    /* renamed from: d, reason: collision with root package name */
    private byte[] f33693d;

    /* renamed from: e, reason: collision with root package name */
    private byte[][] f33694e;

    /* renamed from: f, reason: collision with root package name */
    private byte[] f33695f;

    /* renamed from: g, reason: collision with root package name */
    private byte[] f33696g;

    /* renamed from: h, reason: collision with root package name */
    private C3626a[] f33697h;

    private f(AbstractC1353u abstractC1353u) {
        int i8 = 0;
        if (abstractC1353u.x(0) instanceof C1344k) {
            this.f33690a = C1344k.x(abstractC1353u.x(0));
        } else {
            this.f33691b = C1347n.B(abstractC1353u.x(0));
        }
        AbstractC1353u abstractC1353u2 = (AbstractC1353u) abstractC1353u.x(1);
        this.f33692c = new byte[abstractC1353u2.size()];
        for (int i9 = 0; i9 < abstractC1353u2.size(); i9++) {
            this.f33692c[i9] = ((AbstractC1348o) abstractC1353u2.x(i9)).y();
        }
        this.f33693d = ((AbstractC1348o) ((AbstractC1353u) abstractC1353u.x(2)).x(0)).y();
        AbstractC1353u abstractC1353u3 = (AbstractC1353u) abstractC1353u.x(3);
        this.f33694e = new byte[abstractC1353u3.size()];
        for (int i10 = 0; i10 < abstractC1353u3.size(); i10++) {
            this.f33694e[i10] = ((AbstractC1348o) abstractC1353u3.x(i10)).y();
        }
        this.f33695f = ((AbstractC1348o) ((AbstractC1353u) abstractC1353u.x(4)).x(0)).y();
        this.f33696g = ((AbstractC1348o) ((AbstractC1353u) abstractC1353u.x(5)).x(0)).y();
        ...
        int length = this.f33696g.length - 1;
        this.f33697h = new C3626a[length];
        int i17 = 0;
        while (i17 < length) {
            byte[] bArr5 = this.f33696g;
            int i18 = i17 + 1;
            this.f33697h[i17] = new C3626a(bArr5[i17], bArr5[i18], AbstractC3664a.f(bArr[i17]), AbstractC3664a.f(bArr2[i17]), AbstractC3664a.d(bArr3[i17]), AbstractC3664a.b(bArr4[i17]));
            i17 = i18;
        }
    }
    ...
    public AbstractC1351s d() {
        ...
        InterfaceC1335d interfaceC1335d = this.f33690a;
        if (interfaceC1335d == null) {
            interfaceC1335d = this.f33691b;
        }
        c1337e.a(interfaceC1335d);
        C1337e c1337e2 = new C1337e();
        int i8 = 0;
        while (true) {
            byte[][] bArr = this.f33692c;
            if (i8 >= bArr.length) {
                break;
            }
        ...
        c1337e3.a(new C1330a0(this.f33693d));
        c1337e.a(new C1338e0(c1337e3));
        C1337e c1337e4 = new C1337e();
        int i9 = 0;
        while (true) {
            byte[][] bArr2 = this.f33694e;
            if (i9 >= bArr2.length) {
                break;
            }
        ...
        c1337e5.a(new C1330a0(this.f33695f));
        c1337e.a(new C1338e0(c1337e5));
        C1337e c1337e6 = new C1337e();
        c1337e6.a(new C1330a0(this.f33696g));
        c1337e.a(new C1338e0(c1337e6));
        C1337e c1337e7 = new C1337e();
        for (int i10 = 0; i10 < this.f33697h.length; i10++) {
            C1337e c1337e8 = new C1337e();
            byte[][][] e8 = AbstractC3664a.e(this.f33697h[i10].a());
            ...
            byte[][][] e9 = AbstractC3664a.e(this.f33697h[i10].b());
            ...
            byte[][] c8 = AbstractC3664a.c(this.f33697h[i10].d());
            C1337e c1337e13 = new C1337e();
            for (byte[] bArr5 : c8) {
                c1337e13.a(new C1330a0(bArr5));
            }
            c1337e8.a(new C1338e0(c1337e13));
            c1337e8.a(new C1330a0(AbstractC3664a.a(this.f33697h[i10].c())));
    ...
    public short[] m() {
        return AbstractC3664a.b(this.f33693d);
    }

    public short[] p() {
        return AbstractC3664a.b(this.f33695f);
    }

    public short[][] r() {
        return AbstractC3664a.d(this.f33692c);
    }

    public short[][] s() {
        return AbstractC3664a.d(this.f33694e);
    }
    ...
    public int[] u() {
        return AbstractC3664a.g(this.f33696g);
    }

    public f(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, C3626a[] c3626aArr) {
        this.f33690a = new C1344k(1L);
        this.f33692c = AbstractC3664a.c(sArr);
        this.f33693d = AbstractC3664a.a(sArr2);
        this.f33694e = AbstractC3664a.c(sArr3);
        this.f33695f = AbstractC3664a.a(sArr4);
        this.f33696g = AbstractC3664a.h(iArr);
        this.f33697h = c3626aArr;
    }
}
