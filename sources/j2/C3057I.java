...
public final class C3057I {
    ...
    private static C3683c f32923i;

    /* renamed from: a, reason: collision with root package name */
    private final e3.m f32925a;

    /* renamed from: b, reason: collision with root package name */
    private final s f32926b;

    /* renamed from: c, reason: collision with root package name */
    private final String f32927c;

    /* renamed from: d, reason: collision with root package name */
    private final P5.g f32928d;

    /* renamed from: e, reason: collision with root package name */
    private final String f32929e;

    /* renamed from: f, reason: collision with root package name */
    public static final c f32920f = new c(null);

    /* renamed from: g, reason: collision with root package name */
    public static final int f32921g = 8;

    /* renamed from: h, reason: collision with root package name */
    public static final String f32922h = C3682b.f37542c.a().b();

    /* renamed from: j, reason: collision with root package name */
    private static boolean f32924j = true;
    ...
    public static final class c {
        ...
        public final boolean a() {
            return C3057I.f32924j;
        }

        public final C3683c b() {
            return C3057I.f32923i;
        }
    ...
    public static final class d extends kotlin.coroutines.jvm.internal.l implements Function1 {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.model.p f32934c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ String f32935d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ String f32936e;
        ...
        public final P5.d create(P5.d dVar) {
            return new d(this.f32934c, this.f32935d, this.f32936e, dVar);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(P5.d dVar) {
            return ((d) create(dVar)).invokeSuspend(L5.I.f6474a);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                com.stripe.android.model.p pVar = this.f32934c;
                j.c cVar = new j.c(C3057I.this.h(), this.f32935d, this.f32936e);
                this.f32932a = 1;
    ...
    public static final class e extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Object f32938b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ InterfaceC3061a f32939c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(Object obj, InterfaceC3061a interfaceC3061a, P5.d dVar) {
            super(2, dVar);
            this.f32938b = obj;
            this.f32939c = interfaceC3061a;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new e(this.f32938b, this.f32939c, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f32937a == 0) {
                ...
                InterfaceC3061a interfaceC3061a = this.f32939c;
                Throwable e8 = L5.s.e(obj2);
                if (e8 == null) {
                    interfaceC3061a.b((v2.f) obj2);
                } else {
                    interfaceC3061a.a(AbstractC3790k.f38210e.b(e8));
                }
                return L5.I.f6474a;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    public static final class f extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1 f32941b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ C3057I f32942c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ InterfaceC3061a f32943d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        f(Function1 function1, C3057I c3057i, InterfaceC3061a interfaceC3061a, P5.d dVar) {
            super(2, dVar);
            this.f32941b = function1;
            this.f32942c = c3057i;
            this.f32943d = interfaceC3061a;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new f(this.f32941b, this.f32942c, this.f32943d, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                L5.t.b(obj);
                Function1 function1 = this.f32941b;
                this.f32940a = 1;
            ...
            C3057I c3057i = this.f32942c;
            InterfaceC3061a interfaceC3061a = this.f32943d;
            this.f32940a = 2;
    ...
    public C3057I(e3.m stripeRepository, s paymentController, String publishableKey, String str, P5.g workContext) {
        ...
        this.f32925a = stripeRepository;
        this.f32926b = paymentController;
        this.f32927c = str;
        this.f32928d = workContext;
        this.f32929e = new C3681a().b(publishableKey);
    }
    ...
    private final void g(InterfaceC3061a interfaceC3061a, Function1 function1) {
        AbstractC2829k.d(N.a(this.f32928d), null, null, new f(function1, this, interfaceC3061a, null), 3, null);
    }
    ...
    */
    public C3057I(android.content.Context r22, java.lang.String r23, java.lang.String r24, boolean r25, java.util.Set r26) {
        /*
            ...
            r3 = r4
            r4.<init>(r0)
            r2.c r4 = j2.C3057I.f32923i
            r2.d$a r5 = r2.InterfaceC3684d.f37551a
            r13 = r25
            r2.d r5 = r5.a(r13)
