...
public final class C3067g implements InterfaceC3069i {
    ...
    private final InterfaceC3071k f32961a;

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC2585g f32962b;

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC3868F f32963c;

    /* renamed from: d, reason: collision with root package name */
    private final k3.i f32964d;

    /* renamed from: e, reason: collision with root package name */
    private final P5.g f32965e;

    /* renamed from: f, reason: collision with root package name */
    private C2582d f32966f;
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r9) {
            /*
                ...
                if (r1 == r3) goto L20
                if (r1 != r2) goto L18
                java.lang.Object r0 = r8.f32968b
            ...
            L18:
                ...
                throw r9
            L20:
                java.lang.Object r1 = r8.f32968b
                i6.M r1 = (i6.M) r1
                L5.t.b(r9)
                goto L40
            L28:
                L5.t.b(r9)
                java.lang.Object r9 = r8.f32968b
                i6.M r9 = (i6.M) r9
            ...
            L40:
                ...
                if (r3 == 0) goto Lac
            L5a:
                L5.s$a r3 = L5.s.f6498b     // Catch: java.lang.Throwable -> L7f
                ...
                r8.f32968b = r1     // Catch: java.lang.Throwable -> L7f
                r8.f32967a = r2     // Catch: java.lang.Throwable -> L7f
    ...
    public C3067g(InterfaceC3071k localStore, InterfaceC2585g fraudDetectionDataRequestFactory, InterfaceC3868F stripeNetworkClient, k3.i errorReporter, P5.g workContext) {
        ...
        this.f32961a = localStore;
        this.f32962b = fraudDetectionDataRequestFactory;
        this.f32963c = stripeNetworkClient;
        this.f32964d = errorReporter;
        this.f32965e = workContext;
    }

    @Override // j2.InterfaceC3069i
    public C2582d a() {
        C2582d c2582d = this.f32966f;
        if (!C3057I.f32920f.a()) {
            return null;
        }
        return c2582d;
    ...
    public void b() {
        if (C3057I.f32920f.a()) {
            AbstractC2825i.d(N.a(this.f32965e), null, null, new b(null), 3, null);
        }
    }

    public Object h(P5.d dVar) {
        return AbstractC2825i.g(this.f32965e, new a(null), dVar);
    }

    public void i(C2582d fraudDetectionData) {
        AbstractC3159y.i(fraudDetectionData, "fraudDetectionData");
        this.f32966f = fraudDetectionData;
        this.f32961a.b(fraudDetectionData);
    }
    ...
    public C3067g(Context context, P5.g workContext) {
        this(new C3068h(context, workContext), new C2581c(context), new x2.o(workContext, null, null, 0, null, 30, null), k3.i.f33380a.a(context, a0.f()), workContext);
