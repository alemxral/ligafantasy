...
public final class C3068h implements InterfaceC3071k {
    ...
    private static final a f32972c = new a(null);

    /* renamed from: d, reason: collision with root package name */
    public static final int f32973d = 8;

    /* renamed from: a, reason: collision with root package name */
    private final P5.g f32974a;

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC1227k f32975b;
    ...
    static final class b extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public static final class a extends AbstractC3160z implements Function0 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ JSONObject f32979a;
            ...
            public final Long invoke() {
                return Long.valueOf(this.f32979a.optLong(CampaignEx.JSON_KEY_TIMESTAMP, -1L));
            }
        }
    ...
    static final class c extends AbstractC3160z implements Function0 {
        ...
        public final SharedPreferences invoke() {
            return this.f32980a.getSharedPreferences("FraudDetectionDataStore", 0);
        }
    }
    ...
    public C3068h(Context context, P5.g workContext) {
        ...
        this.f32974a = workContext;
        this.f32975b = L5.l.b(new c(context));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final SharedPreferences d() {
        return (SharedPreferences) this.f32975b.getValue();
    }

    @Override // j2.InterfaceC3071k
    public Object a(P5.d dVar) {
        return AbstractC2825i.g(this.f32974a, new b(null), dVar);
    }
