...
public class r {
    ...
    private static final Map f3382f;

    /* renamed from: g, reason: collision with root package name */
    static final String f3383g;

    /* renamed from: a, reason: collision with root package name */
    private final Context f3384a;

    /* renamed from: b, reason: collision with root package name */
    private final z f3385b;

    /* renamed from: c, reason: collision with root package name */
    private final C1168b f3386c;

    /* renamed from: d, reason: collision with root package name */
    private final P0.d f3387d;

    /* renamed from: e, reason: collision with root package name */
    private final O0.i f3388e;
    ...
    static {
        ...
        f3383g = String.format(Locale.US, "Crashlytics Android SDK/%s", "18.4.1");
    }
    ...
    private B.a a(B.a aVar) {
        J0.C c8;
        if (this.f3388e.b().f7682b.f7691c && this.f3386c.f3268c.size() > 0) {
            ArrayList arrayList = new ArrayList();
            for (C1173g c1173g : this.f3386c.f3268c) {
    ...
    private B.b b() {
        return J0.B.b().j("18.4.1").f(this.f3386c.f3266a).g(this.f3385b.a().c()).e(this.f3385b.a().d()).c(this.f3386c.f3271f).d(this.f3386c.f3272g).i(4);
    }

    private static int f() {
        Integer num;
        String str = Build.CPU_ABI;
        if (TextUtils.isEmpty(str) || (num = (Integer) f3382f.get(str.toLowerCase(Locale.US))) == null) {
            return 7;
        }
        return num.intValue();
    }
    ...
    private B.e.d.a.b.AbstractC0076a g() {
        return B.e.d.a.b.AbstractC0076a.a().b(0L).d(0L).c(this.f3386c.f3270e).e(this.f3386c.f3267b).a();
    }
    ...
    private B.e.d.a j(int i8, P0.e eVar, Thread thread, int i9, int i10, boolean z8) {
        Boolean bool;
        boolean z9;
        ActivityManager.RunningAppProcessInfo j8 = AbstractC1176j.j(this.f3386c.f3270e, this.f3384a);
        if (j8 != null) {
    ...
    private B.e.d.c k(int i8) {
        Double d8;
        C1172f a8 = C1172f.a(this.f3384a);
        Float b8 = a8.b();
        if (b8 != null) {
        ...
        int c8 = a8.c();
        boolean p8 = AbstractC1176j.p(this.f3384a);
        long t8 = AbstractC1176j.t() - AbstractC1176j.a(this.f3384a);
    ...
    private B.e.d.a.b.c m(P0.e eVar, int i8, int i9, int i10) {
        String str = eVar.f7847b;
        String str2 = eVar.f7846a;
        StackTraceElement[] stackTraceElementArr = eVar.f7848c;
        int i11 = 0;
        if (stackTraceElementArr == null) {
            stackTraceElementArr = new StackTraceElement[0];
        }
        P0.e eVar2 = eVar.f7849d;
        if (i10 >= i9) {
            P0.e eVar3 = eVar2;
            while (eVar3 != null) {
                eVar3 = eVar3.f7849d;
    ...
    private B.e.a r() {
        return B.e.a.a().e(this.f3385b.f()).g(this.f3386c.f3271f).d(this.f3386c.f3272g).f(this.f3385b.a().c()).b(this.f3386c.f3273h.d()).c(this.f3386c.f3273h.e()).a();
    }

    private B.e s(String str, long j8) {
        return B.e.a().m(j8).j(str).h(f3383g).b(r()).l(u()).e(t()).i(3).a();
    }
    ...
    private J0.C y(P0.e eVar, Thread thread, int i8, boolean z8) {
        ArrayList arrayList = new ArrayList();
        arrayList.add(x(thread, eVar.f7848c, i8));
        if (z8) {
            for (Map.Entry<Thread, StackTraceElement[]> entry : Thread.getAllStackTraces().entrySet()) {
                Thread key = entry.getKey();
                if (!key.equals(thread)) {
                    arrayList.add(w(key, this.f3387d.a(entry.getValue())));
                }
            }
        }
        return J0.C.a(arrayList);
    ...
    public B.e.d c(B.a aVar) {
        int i8 = this.f3384a.getResources().getConfiguration().orientation;
    ...
    public B.e.d d(Throwable th, Thread thread, String str, long j8, int i8, int i9, boolean z8) {
        int i10 = this.f3384a.getResources().getConfiguration().orientation;
        return B.e.d.a().f(str).e(j8).b(j(i10, new P0.e(th, this.f3387d), thread, i8, i9, z8)).c(k(i10)).a();
    }
