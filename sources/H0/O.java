...
public class O {
    ...
    private final r f3252a;

    /* renamed from: b, reason: collision with root package name */
    private final M0.e f3253b;

    /* renamed from: c, reason: collision with root package name */
    private final N0.b f3254c;

    /* renamed from: d, reason: collision with root package name */
    private final I0.c f3255d;

    /* renamed from: e, reason: collision with root package name */
    private final I0.h f3256e;

    /* renamed from: f, reason: collision with root package name */
    private final z f3257f;
    ...
    private B.e.d c(B.e.d dVar) {
        return d(dVar, this.f3255d, this.f3256e);
    }
    ...
    private AbstractC1184s h(AbstractC1184s abstractC1184s) {
        if (abstractC1184s.b().f() == null) {
            return AbstractC1184s.a(abstractC1184s.b().q(this.f3257f.d()), abstractC1184s.d(), abstractC1184s.c());
        }
    ...
    private void r(Throwable th, Thread thread, String str, String str2, long j8, boolean z8) {
        this.f3253b.y(c(this.f3252a.d(th, thread, str2, j8, 4, 8, z8)), str, str2.equals("crash"));
    }
    ...
    public void i(String str, List list, B.a aVar) {
        ...
        this.f3253b.l(str, B.d.a().b(J0.C.a(arrayList)).a(), aVar);
    }

    public void j(long j8, String str) {
        this.f3253b.k(str, j8);
    }

    public boolean m() {
        return this.f3253b.r();
    }
    ...
    public void p(String str, long j8) {
        this.f3253b.z(this.f3252a.e(str, j8));
    }
    ...
    public void t(String str, List list, I0.c cVar, I0.h hVar) {
        ...
        B.e.d c8 = this.f3252a.c(e(k8));
        E0.f.f().b("Persisting anr for session " + str);
        this.f3253b.y(d(c8, cVar, hVar), str, true);
    }
