...
public final class C3682b {
    ...
    public static final a f37542c = new a(null);

    /* renamed from: d, reason: collision with root package name */
    private static final C3682b f37543d = new C3682b("2020-03-02", 0 == true ? 1 : 0, 2, 0 == true ? 1 : 0);

    /* renamed from: a, reason: collision with root package name */
    private final String f37544a;

    /* renamed from: b, reason: collision with root package name */
    private final Set f37545b;
    ...
    public C3682b(String version, Set betaCodes) {
        ...
        this.f37544a = version;
        this.f37545b = betaCodes;
    }

    public final String b() {
        List e8 = AbstractC1246t.e(this.f37544a);
        Set set = this.f37545b;
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3159y.d(this.f37544a, c3682b.f37544a) && AbstractC3159y.d(this.f37545b, c3682b.f37545b)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "ApiVersion(version=" + this.f37544a + ", betaCodes=" + this.f37545b + ")";
    }
