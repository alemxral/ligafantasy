...
public abstract class d {
    ...
    private static final ProvidableCompositionLocal f8722a = CompositionLocalKt.staticCompositionLocalOf(c.f8729a);
    ...
    public static final class a extends AbstractC3160z implements n {
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            MaterialThemeKt.MaterialTheme(this.f8723a.g(), e.a(), MaterialTheme.INSTANCE.getShapes(composer, MaterialTheme.$stable), this.f8724b, composer, 48, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class b extends AbstractC3160z implements n {
        ...
        public final void invoke(Composer composer, int i8) {
            d.a(this.f8725a, this.f8726b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f8727c | 1), this.f8728d);
        }
    }
    ...
    */
    public static final void a(boolean r6, X5.n r7, androidx.compose.runtime.Composer r8, int r9, int r10) {
        ...
        L7a:
            R2.c r1 = R2.c.f8719a
            R2.b r1 = r1.a(r6)
            androidx.compose.runtime.ProvidableCompositionLocal r3 = R2.d.f8722a
    ...
    public static final R2.b b(MaterialTheme materialTheme, Composer composer, int i8) {
        ...
        R2.b bVar = (R2.b) composer.consume(f8722a);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return bVar;
