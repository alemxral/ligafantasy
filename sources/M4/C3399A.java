...
public final class C3399A implements v0 {
    ...
    public static final a f34918h = new a(null);

    /* renamed from: i, reason: collision with root package name */
    public static final int f34919i = 8;

    /* renamed from: j, reason: collision with root package name */
    private static final Pattern f34920j;
    ...
    private final VisualTransformation f34925e;

    /* renamed from: f, reason: collision with root package name */
    private final l6.v f34926f;

    /* renamed from: g, reason: collision with root package name */
    private final InterfaceC3349K f34927g;
    ...
    public C3399A(int i8) {
        this.f34921a = i8;
        this.f34922b = KeyboardCapitalization.Companion.m4896getNoneIUNYP9k();
        this.f34923c = NotificationCompat.CATEGORY_EMAIL;
        this.f34924d = KeyboardType.Companion.m4917getEmailPjHm6EE();
        this.f34926f = AbstractC3351M.a(null);
        this.f34927g = AbstractC3351M.a(Boolean.FALSE);
    }
    ...
    @Override // m4.v0
    public Integer b() {
        return Integer.valueOf(this.f34921a);
    }
    ...
    public y0 l(String input) {
        ...
        if (f34920j.matcher(input).matches()) {
            return A0.b.f34929a;
        }
        if (!n(input) && !m(input)) {
            return new z0.b(AbstractC3081g.f33166B);
        }
        return new z0.c(AbstractC3081g.f33166B, null, false, 6, null);
    }
    ...
    public /* synthetic */ C3399A(int i8, int i9, AbstractC3151p abstractC3151p) {
        this((i9 & 1) != 0 ? AbstractC3081g.f33165A : i8);
    }
}
