...
public abstract class AbstractC3422l {
    ...
    public static final class a extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(SemanticsPropertyReceiver semantics) {
            ...
            SemanticsPropertiesKt.setTestTag(semantics, this.f35564a);
            SemanticsPropertiesKt.setStateDescription(semantics, this.f35565b);
        }
    }
    ...
    public static final class b extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Modifier f35566a;
        ...
        final /* synthetic */ boolean f35570e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1 f35571f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f35572g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f35573h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Modifier modifier, String str, boolean z8, String str2, boolean z9, Function1 function1, int i8, int i9) {
            super(2);
            this.f35566a = modifier;
            this.f35567b = str;
            this.f35568c = z8;
            this.f35569d = str2;
            this.f35570e = z9;
            this.f35571f = function1;
            this.f35572g = i8;
            this.f35573h = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            AbstractC3422l.a(this.f35566a, this.f35567b, this.f35568c, this.f35569d, this.f35570e, this.f35571f, composer, RecomposeScopeImplKt.updateChangedFlags(this.f35572g | 1), this.f35573h);
        }
    }
