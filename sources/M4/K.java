...
public final class K implements r {
    ...
    private static final a f35096f = new a(null);

    /* renamed from: g, reason: collision with root package name */
    public static final int f35097g = 8;

    /* renamed from: h, reason: collision with root package name */
    private static final C2559c f35098h = new C2559c('0', '9');
    ...
    private final List f35102d;

    /* renamed from: e, reason: collision with root package name */
    private final InterfaceC3349K f35103e;
    ...
    public static final class b implements InterfaceC3358f {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ InterfaceC3358f[] f35104a;

        /* loaded from: classes4.dex */
        static final class a extends AbstractC3160z implements Function0 {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ InterfaceC3358f[] f35105a;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public a(InterfaceC3358f[] interfaceC3358fArr) {
                super(0);
                this.f35105a = interfaceC3358fArr;
            }

            @Override // kotlin.jvm.functions.Function0
            public final Object[] invoke() {
                return new String[this.f35105a.length];
            }
        }
        ...
        public static final class C0795b extends kotlin.coroutines.jvm.internal.l implements X5.o {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i8 != 0) {
                    ...
                    L5.t.b(obj);
                    InterfaceC3359g interfaceC3359g = (InterfaceC3359g) this.f35107b;
                    String w02 = AbstractC1246t.w0(AbstractC1239l.V0((Object[]) this.f35108c), "", null, null, 0, null, null, 62, null);
                    this.f35106a = 1;
            ...
            public final Object invoke(InterfaceC3359g interfaceC3359g, Object[] objArr, P5.d dVar) {
                ...
                c0795b.f35107b = interfaceC3359g;
                c0795b.f35108c = objArr;
                return c0795b.invokeSuspend(L5.I.f6474a);
            }
        }

        public b(InterfaceC3358f[] interfaceC3358fArr) {
            this.f35104a = interfaceC3358fArr;
        }

        @Override // l6.InterfaceC3358f
        public Object collect(InterfaceC3359g interfaceC3359g, P5.d dVar) {
            InterfaceC3358f[] interfaceC3358fArr = this.f35104a;
    ...
    public K(int i8) {
        ...
        this.f35099a = i8;
        this.f35100b = "";
        this.f35101c = KeyboardType.Companion.m4919getNumberPasswordPjHm6EE();
        d6.i s8 = d6.m.s(0, i8);
        ...
        this.f35103e = new v4.e(bVar, new c(arrayList));
    }
    ...
    public final int A(int i8, String text) {
        ...
        if (AbstractC3159y.d(text, ((l6.v) this.f35102d.get(i8)).getValue())) {
            return 1;
        }
        if (text.length() == 0) {
            ((l6.v) this.f35102d.get(i8)).setValue("");
            return 0;
        }
        String v8 = v(text);
        ...
        while (it.hasNext()) {
            ...
            ((l6.v) this.f35102d.get(i8 + nextInt)).setValue(String.valueOf(v8.charAt(nextInt)));
        }
        return min;
    }
    ...
    public final void z(String digit) {
        ...
        String str = this.f35100b + digit;
        this.f35100b = str;
        if (str.length() == this.f35099a) {
            A(0, this.f35100b);
            this.f35100b = "";
        }
    }
