...
public final class C3420j implements InterfaceC3433x {
    ...
    private final List f35547a;

    /* renamed from: b, reason: collision with root package name */
    private final List f35548b;
    ...
    private final int f35551e;

    /* renamed from: f, reason: collision with root package name */
    private final List f35552f;

    /* renamed from: g, reason: collision with root package name */
    private final List f35553g;
    ...
    public static abstract class a {
        ...
        public static final class C0821a extends a {
            ...
            public /* synthetic */ C0821a(int r17, java.util.List r18, int r19, kotlin.jvm.internal.AbstractC3151p r20) {
                /*
                    ...
                    r2 = r19 & 1
                    if (r2 == 0) goto L9
                    int r2 = r2.AbstractC3685e.f37562h
                    goto Lb
                L9:
                    r2 = r17
                Lb:
            ...
            public boolean equals(Object obj) {
                ...
                if (this.f35556c == c0821a.f35556c && AbstractC3159y.d(this.f35557d, c0821a.f35557d)) {
                    return true;
                }
                return false;
            }
            ...
            public int hashCode() {
                return (this.f35556c * 31) + this.f35557d.hashCode();
            }

            public String toString() {
                return "Canada(label=" + this.f35556c + ", administrativeAreas=" + this.f35557d + ")";
            }
            ...
            public C0821a(int i8, List administrativeAreas) {
                ...
                this.f35556c = i8;
                this.f35557d = administrativeAreas;
            }
        }
        ...
        public static final class b extends a {
            ...
            public boolean equals(Object obj) {
                ...
                b bVar = (b) obj;
                if (this.f35558c == bVar.f35558c && AbstractC3159y.d(this.f35559d, bVar.f35559d)) {
                    return true;
                }
                return false;
            }
            ...
            public int hashCode() {
                return (this.f35558c * 31) + this.f35559d.hashCode();
            }

            public String toString() {
                return "US(label=" + this.f35558c + ", administrativeAreas=" + this.f35559d + ")";
            }
            ...
            public b(int i8, List administrativeAreas) {
                ...
                AbstractC3159y.i(administrativeAreas, "administrativeAreas");
                this.f35558c = i8;
                this.f35559d = administrativeAreas;
            }
        }
    }
    ...
    public C3420j(a country) {
        ...
        this.f35548b = arrayList2;
        this.f35550d = "administrativeArea";
        this.f35551e = country.b();
        this.f35552f = this.f35547a;
        this.f35553g = arrayList2;
    }
    ...
    public String f(String rawValue) {
        ...
        if (this.f35547a.contains(rawValue)) {
            return (String) this.f35548b.get(this.f35547a.indexOf(rawValue));
        }
        return (String) this.f35548b.get(0);
    }

    @Override // m4.InterfaceC3433x
    public String g(int i8) {
        return (String) this.f35548b.get(i8);
    }
