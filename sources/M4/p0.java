...
public abstract class p0 {
    ...
    public static final class a extends AbstractC3160z implements X5.n {
        ...
        final /* synthetic */ Integer f35632a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f35633b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Modifier f35634c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ boolean f35635d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ boolean f35636e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ X5.n f35637f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ X5.n f35638g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f35639h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f35640i;
        ...
        public final void invoke(Composer composer, int i8) {
            p0.a(this.f35632a, this.f35633b, this.f35634c, this.f35635d, this.f35636e, this.f35637f, this.f35638g, composer, RecomposeScopeImplKt.updateChangedFlags(this.f35639h | 1), this.f35640i);
        }
    }
    ...
    public static final class c extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Modifier f35642a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Shape f35643b;
        ...
        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ BorderStroke f35646e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ X5.n f35647f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f35648g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f35649h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(Modifier modifier, Shape shape, boolean z8, long j8, BorderStroke borderStroke, X5.n nVar, int i8, int i9) {
            super(2);
            this.f35642a = modifier;
            this.f35643b = shape;
            this.f35644c = z8;
            this.f35645d = j8;
            this.f35646e = borderStroke;
            this.f35647f = nVar;
            this.f35648g = i8;
            this.f35649h = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            p0.b(this.f35642a, this.f35643b, this.f35644c, this.f35645d, this.f35646e, this.f35647f, composer, RecomposeScopeImplKt.updateChangedFlags(this.f35648g | 1), this.f35649h);
        }
    }
    ...
    public static final class e extends AbstractC3160z implements X5.n {
        ...
        public final void invoke(Composer composer, int i8) {
            p0.c(this.f35651a, composer, RecomposeScopeImplKt.updateChangedFlags(this.f35652b | 1));
        }
    }
    ...
    public static final class g extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Integer f35654a;
        ...
        public final void invoke(Composer composer, int i8) {
            p0.d(this.f35654a, composer, RecomposeScopeImplKt.updateChangedFlags(this.f35655b | 1));
        }
    }
    ...
    */
    ...
    public static final void c(String error, Composer composer, int i8) {
        ...
        if ((i9 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            composer2 = startRestartGroup;
            TextKt.m1414Text4IGK_g(error, SemanticsModifierKt.semantics(Modifier.Companion, true, d.f35650a), materialTheme.getColors(startRestartGroup, i11).m1172getError0d7_KjU(), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1) null, materialTheme.getTypography(startRestartGroup, i11).getH6(), composer2, i9 & 14, 0, 65528);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void d(Integer num, Composer composer, int i8) {
        ...
        if ((i9 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            if (num != null) {
                F.a(StringResources_androidKt.stringResource(num.intValue(), startRestartGroup, i9 & 14), SemanticsModifierKt.semantics(PaddingKt.m604paddingqDBjuR0$default(Modifier.Companion, 0.0f, 0.0f, 0.0f, Dp.m5178constructorimpl(4), 7, null), true, f.f35653a), startRestartGroup, 0, 0);
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
