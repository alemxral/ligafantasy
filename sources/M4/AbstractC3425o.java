...
public abstract class AbstractC3425o {
    ...
    public static final class b extends AbstractC3160z implements X5.n {
        ...
        final /* synthetic */ C3423m f35607a;
    ...
    public static final class c extends AbstractC3160z implements X5.n {
        ...
        public final String a(Composer composer, int i8) {
            ...
            Object[] b8 = this.f35608a.b();
            composer.startReplaceableGroup(-956550707);
            if (b8 == null) {
                stringResource = null;
            } else {
                stringResource = StringResources_androidKt.stringResource(this.f35608a.a(), Arrays.copyOf(b8, b8.length), composer, 64);
            }
            composer.endReplaceableGroup();
            if (stringResource == null) {
                stringResource = StringResources_androidKt.stringResource(this.f35608a.a(), composer, 0);
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final class d extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Modifier f35609a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C3423m f35610b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ boolean f35611c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ int f35612d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ int f35613e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        d(Modifier modifier, C3423m c3423m, boolean z8, int i8, int i9) {
            super(2);
            this.f35609a = modifier;
            this.f35610b = c3423m;
            this.f35611c = z8;
            this.f35612d = i8;
            this.f35613e = i9;
        ...
        public final void invoke(Composer composer, int i8) {
            AbstractC3425o.a(this.f35609a, this.f35610b, this.f35611c, composer, RecomposeScopeImplKt.updateChangedFlags(this.f35612d | 1), this.f35613e);
        }
    }
    ...
    public static final class e extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(SemanticsPropertyReceiver semantics) {
            ...
            SemanticsPropertiesKt.setStateDescription(semantics, this.f35614a);
        }
    }
    ...
    public static final class f extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Modifier f35615a;
        ...
        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Function1 f35619e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ X5.n f35620f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ X5.n f35621g;
        ...
        public final void invoke(Composer composer, int i8) {
            AbstractC3425o.d(this.f35615a, this.f35616b, this.f35617c, this.f35618d, this.f35619e, this.f35620f, this.f35621g, composer, RecomposeScopeImplKt.updateChangedFlags(this.f35622h | 1), this.f35623i);
        }
    }
    ...
    public static final class g extends AbstractC3160z implements X5.n {
        ...
        public final void invoke(Composer composer, int i8) {
            AbstractC3425o.e(this.f35624a, this.f35625b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f35626c | 1));
        }
    }
