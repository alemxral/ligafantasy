...
public abstract class o {
    ...
    public static final a f36096a = new a(null);
    ...
    public static final class a {
        ...
        static final class C0831a extends AbstractC3160z implements Function1 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ InterfaceC3795a f36097a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ C2660a f36098b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0831a(InterfaceC3795a interfaceC3795a, C2660a c2660a) {
                super(1);
                this.f36097a = interfaceC3795a;
                this.f36098b = c2660a;
            }
            ...
            public final j2.q invoke(InterfaceC2464p host) {
                ...
                ActivityResultLauncher f8 = ((C3171a) this.f36097a.get()).f();
                if (f8 != null) {
                    return new q.b(f8);
                }
                return new q.a(host, this.f36098b);
            }
        }
        ...
        static final class b extends AbstractC3160z implements Function1 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ InterfaceC3795a f36099a;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            b(InterfaceC3795a interfaceC3795a) {
                super(1);
                this.f36099a = interfaceC3795a;
            }
            ...
            public final com.stripe.android.a invoke(InterfaceC2464p host) {
                AbstractC3159y.i(host, "host");
                ActivityResultLauncher g8 = ((C3171a) this.f36099a.get()).g();
                if (g8 != null) {
                    return new a.c(g8);
                }
                return new a.b(host);
        ...
        public final C2660a a(Context context) {
            ...
            return C2660a.f30995b.a(context);
        }
