...
public final class PublicSuffixDatabase {
    ...
    private static final byte[] f36937e = {42};

    /* renamed from: f, reason: collision with root package name */
    private static final String[] f36938f = new String[0];

    /* renamed from: g, reason: collision with root package name */
    private static final String[] f36939g = {"*"};

    /* renamed from: h, reason: collision with root package name */
    private static final PublicSuffixDatabase f36940h = new PublicSuffixDatabase();

    /* renamed from: a, reason: collision with root package name */
    private final AtomicBoolean f36941a = new AtomicBoolean(false);

    /* renamed from: b, reason: collision with root package name */
    private final CountDownLatch f36942b = new CountDownLatch(1);

    /* renamed from: c, reason: collision with root package name */
    private byte[] f36943c;

    /* renamed from: d, reason: collision with root package name */
    private byte[] f36944d;
        ...
        while (i12 < length) {
            ...
            if (i11 >= 0) {
                if (i11 <= 0) {
                    ...
                    if (length2 >= i20) {
                        if (length2 <= i20) {
                            return new String(bArr, i14, i16, c.f3216j);
                        }
                    }
                }
                i12 = i9 + 1;
    ...
    private String[] b(String[] strArr) {
        ...
        String[] strArr3;
        int i8 = 0;
        if (!this.f36941a.get() && this.f36941a.compareAndSet(false, true)) {
            f();
        } else {
            try {
                this.f36942b.await();
        ...
        for (int i9 = 0; i9 < strArr.length; i9++) {
            bArr[i9] = strArr[i9].getBytes(c.f3216j);
        }
        int i10 = 0;
        while (true) {
            str = null;
            if (i10 < length) {
                str2 = a(this.f36943c, bArr, i10);
                if (str2 != null) {
                    break;
                }
                i10++;
        ...
        if (str3 != null) {
            while (true) {
                ...
                String a8 = a(this.f36944d, bArr, i8);
                if (a8 != null) {
                    str = a8;
                    break;
                }
