...
public final class b implements j {
    ...
    public Object a(String jsonString) {
        ...
        try {
            if (jsonString.length() == 0) {
                BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(this.f7061a.getResources().openRawResource(I1.d.f3873a)));
                try {
    ...
    public final Map b() {
        ...
        JSONObject jSONObject = this.f7063c;
        if (jSONObject == null) {
