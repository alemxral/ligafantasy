...
public final class l implements j {
    ...
    public ChoiceCmpCallback f7068a;

    /* renamed from: b, reason: collision with root package name */
    public c f7069b;

    /* renamed from: c, reason: collision with root package name */
    public JSONObject f7070c;
    ...
    public l(ChoiceCmpCallback choiceCmpCallback, c coreUiLabelsResolver) {
        ...
        this.f7068a = choiceCmpCallback;
        this.f7069b = coreUiLabelsResolver;
    }
    ...
    public Object a(String jsonString) {
        ...
        try {
            this.f7070c = new JSONObject(jsonString);
            return new E6.f(c(), a(), b(), this.f7069b.a(jsonString), null, d(), 16);
        } catch (JSONException unused) {
            ChoiceCmpCallback choiceCmpCallback = this.f7068a;
    ...
    public final E6.e b() {
        JSONObject jSONObject = this.f7070c;
        if (jSONObject == null) {
