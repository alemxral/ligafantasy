...
public final class C3640n extends AbstractC3160z implements Function1 {
    ...
    public final /* synthetic */ C3639m f37169a;
    ...
    public Object invoke(Object obj) {
        ...
        if (uSRegulationData == null || (choiceCmpCallback2 = this.f37169a.f37166c) == null) {
            i8 = null;
        } else {
            choiceCmpCallback2.onReceiveUSRegulationsConsent(uSRegulationData);
            i8 = I.f6474a;
        }
        if (i8 == null && (choiceCmpCallback = this.f37169a.f37166c) != null) {
