...
public final class B extends Fragment implements e {
    ...
    private static final WeakHashMap f8124d = new WeakHashMap();

    /* renamed from: a, reason: collision with root package name */
    private final Map f8125a = DesugarCollections.synchronizedMap(new ArrayMap());
    ...
    public static B d(Activity activity) {
        B b8;
        WeakHashMap weakHashMap = f8124d;
    ...
    public final void a(String str, LifecycleCallback lifecycleCallback) {
        if (!this.f8125a.containsKey(str)) {
            this.f8125a.put(str, lifecycleCallback);
            if (this.f8126b > 0) {
    ...
    public final LifecycleCallback e(String str, Class cls) {
        return (LifecycleCallback) cls.cast(this.f8125a.get(str));
    }
