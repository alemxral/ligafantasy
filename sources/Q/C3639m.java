...
public final class C3639m extends ViewModel {
    ...
    public final C6.a f37164a;

    /* renamed from: b, reason: collision with root package name */
    public final L7.i f37165b;

    /* renamed from: c, reason: collision with root package name */
    public final ChoiceCmpCallback f37166c;
    ...
    public static final class a extends AbstractC3160z implements Function1 {
        ...
        public Object invoke(Object obj) {
            ...
            if (uSRegulationData == null || (choiceCmpCallback2 = C3639m.this.f37166c) == null) {
                i8 = null;
            } else {
                choiceCmpCallback2.onReceiveUSRegulationsConsent(uSRegulationData);
                i8 = I.f6474a;
            }
            if (i8 == null && (choiceCmpCallback = C3639m.this.f37166c) != null) {
    ...
    public C3639m(C6.a mspaConfig, L7.i gbcConsentRepository, ChoiceCmpCallback choiceCmpCallback) {
        ...
        this.f37164a = mspaConfig;
        this.f37165b = gbcConsentRepository;
        this.f37166c = choiceCmpCallback;
        this.f37167d = 2;
    }
    ...
    public final LiveData a() {
        ...
        if (eVar != null) {
            ...
            C3832b.b(C3832b.f38857a, ChoiceError.UNEXPECTED_ERROR_OCCURRED, null, null, EnumC3833c.CONSOLE, null, 22);
            completion.invoke(null);
        }
        return H7.m.f3644a.a(H7.n.ACCEPT_ALL, H7.a.ACCEPT_ALL);
    }
