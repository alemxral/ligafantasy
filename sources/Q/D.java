...
public final class D extends Fragment implements e {
    ...
    private static final WeakHashMap f8131d = new WeakHashMap();

    /* renamed from: a, reason: collision with root package name */
    private final Map f8132a = DesugarCollections.synchronizedMap(new ArrayMap());
    ...
    public static D j(FragmentActivity fragmentActivity) {
        D d8;
        WeakHashMap weakHashMap = f8131d;
    ...
    public final void a(String str, LifecycleCallback lifecycleCallback) {
        if (!this.f8132a.containsKey(str)) {
            this.f8132a.put(str, lifecycleCallback);
            if (this.f8133b > 0) {
    ...
    public final LifecycleCallback e(String str, Class cls) {
        return (LifecycleCallback) cls.cast(this.f8132a.get(str));
    }
