...
public final class C3638l extends Q7.a implements a.b {
    ...
    public static final String f37149B = C3638l.class.getName();

    /* renamed from: m, reason: collision with root package name */
    public TextView f37150m;

    /* renamed from: n, reason: collision with root package name */
    public TextView f37151n;

    /* renamed from: o, reason: collision with root package name */
    public TextView f37152o;

    /* renamed from: p, reason: collision with root package name */
    public Button f37153p;

    /* renamed from: q, reason: collision with root package name */
    public Button f37154q;

    /* renamed from: r, reason: collision with root package name */
    public RecyclerView f37155r;

    /* renamed from: s, reason: collision with root package name */
    public RecyclerView f37156s;

    /* renamed from: t, reason: collision with root package name */
    public RecyclerView f37157t;

    /* renamed from: u, reason: collision with root package name */
    public FrameLayout f37158u;

    /* renamed from: v, reason: collision with root package name */
    public ConstraintLayout f37159v;
    ...
    public static final void n(final C3638l this$0, View view) {
        ...
        C3639m c3639m = this$0.f37163z;
        if (c3639m == null) {
            AbstractC3159y.y("viewModel");
            c3639m = null;
        }
        RecyclerView recyclerView = this$0.f37155r;
        ...
        if (aVar == null || (list3 = aVar.f8861a) == null) {
            r32 = 0;
        } else {
            r32 = new ArrayList(AbstractC1246t.x(list3, 10));
            Iterator it = list3.iterator();
            while (it.hasNext()) {
                r32.add(((R7.d) it.next()).f8900b);
            }
        }
        RecyclerView recyclerView2 = this$0.f37156s;
        ...
        if (aVar2 == null || (list2 = aVar2.f8861a) == null) {
            r42 = 0;
        } else {
            r42 = new ArrayList(AbstractC1246t.x(list2, 10));
            Iterator it2 = list2.iterator();
            while (it2.hasNext()) {
                r42.add(((R7.d) it2.next()).f8900b);
            }
        }
        RecyclerView recyclerView3 = this$0.f37157t;
        ...
        if (aVar3 != null && (list = aVar3.f8861a) != null) {
            arrayList = new ArrayList(AbstractC1246t.x(list, 10));
            Iterator it3 = list.iterator();
            while (it3.hasNext()) {
                arrayList.add(((R7.d) it3.next()).f8900b);
            }
        }
        if (r32 == 0) {
        ...
        List list4 = c3639m.f37164a.f1301d;
        if (list4 != null) {
        ...
        if (!z8 || !purposeSwitchItemList.isEmpty()) {
            ...
            while (it4.hasNext()) {
                if (!AbstractC3159y.d((Boolean) it4.next(), Boolean.FALSE)) {
                    ...
                    aVar4 = H7.a.REJECT;
                    H7.m.f3644a.a(H7.n.SAVE_AND_EXIT, aVar4).observe(this$0, new Observer() { // from class: q.k
    ...
    public void d(R7.d itemData) {
        ...
        int ordinal = itemData.f8902d.ordinal();
        if (ordinal != 10) {
            if (ordinal == 11) {
                List list2 = c3639m.f37164a.f1301d;
                if (list2 != null) {
        ...
        List list3 = c3639m.f37164a.f1301d;
        if (list3 != null) {
    ...
    public final R7.a k(List list) {
        ...
        return new R7.a(list, this, null, null, num, num2, num3, num4, null, this.f8371l, 268);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View inflate = inflater.inflate(I1.c.f3854e, viewGroup, false);
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (textView != null) {
            textView.setText(getString(I1.e.f3878c));
        }
        this.f37150m = (TextView) view.findViewById(I1.b.f3791d1);
        this.f37155r = (RecyclerView) view.findViewById(I1.b.f3770V);
        this.f37151n = (TextView) view.findViewById(I1.b.f3794e1);
        this.f37152o = (TextView) view.findViewById(I1.b.f3832r0);
        this.f37153p = (Button) view.findViewById(I1.b.f3813l);
        this.f37154q = (Button) view.findViewById(I1.b.f3786c);
        this.f37156s = (RecyclerView) view.findViewById(I1.b.f3772W);
        this.f37157t = (RecyclerView) view.findViewById(I1.b.f3758P);
        this.f37158u = (FrameLayout) view.findViewById(I1.b.f3848z);
        this.f37159v = (ConstraintLayout) view.findViewById(I1.b.f3746J);
        this.f37160w = view.findViewById(I1.b.f3756O);
        this.f37161x = view.findViewById(I1.b.f3793e0);
        this.f37162y = view.findViewById(I1.b.f3816m);
        ...
        if (!((ArrayList) b8).isEmpty()) {
            RecyclerView recyclerView = this.f37155r;
            if (recyclerView != null) {
                recyclerView.setAdapter(k(b8));
            }
            TextView textView2 = this.f37150m;
            if (textView2 != null) {
                textView2.setVisibility(0);
            }
            RecyclerView recyclerView2 = this.f37155r;
            if (recyclerView2 != null) {
                recyclerView2.setVisibility(0);
            }
            View view2 = this.f37160w;
            if (view2 != null) {
                view2.setVisibility(0);
            }
        } else {
            TextView textView3 = this.f37150m;
            if (textView3 != null) {
                textView3.setVisibility(8);
            }
            RecyclerView recyclerView3 = this.f37155r;
            if (recyclerView3 != null) {
                recyclerView3.setVisibility(8);
            }
            View view3 = this.f37160w;
            if (view3 != null) {
                view3.setVisibility(8);
            }
        }
        C3639m c3639m2 = this.f37163z;
        if (c3639m2 == null) {
            AbstractC3159y.y("viewModel");
            c3639m2 = null;
        }
        ...
        List list = c3639m2.f37164a.f1301d;
        if (list == null) {
            arrayList = null;
        } else {
        ...
        if (!arrayList2.isEmpty()) {
            RecyclerView recyclerView4 = this.f37156s;
            if (recyclerView4 != null) {
                recyclerView4.setAdapter(k(arrayList2));
            }
            TextView textView4 = this.f37151n;
            if (textView4 != null) {
                textView4.setVisibility(0);
            }
            RecyclerView recyclerView5 = this.f37156s;
            if (recyclerView5 != null) {
                recyclerView5.setVisibility(0);
            }
            View view4 = this.f37161x;
            if (view4 != null) {
                view4.setVisibility(0);
            }
        } else {
            TextView textView5 = this.f37151n;
            if (textView5 != null) {
                textView5.setVisibility(8);
            }
            RecyclerView recyclerView6 = this.f37156s;
            if (recyclerView6 != null) {
                recyclerView6.setVisibility(8);
            }
            View view5 = this.f37161x;
            if (view5 != null) {
                view5.setVisibility(8);
            }
        }
        C3639m c3639m3 = this.f37163z;
        if (c3639m3 == null) {
            AbstractC3159y.y("viewModel");
            c3639m3 = null;
        }
        ...
        if (!((ArrayList) b9).isEmpty()) {
            RecyclerView recyclerView7 = this.f37157t;
            if (recyclerView7 != null) {
                recyclerView7.setAdapter(k(b9));
            }
            TextView textView6 = this.f37152o;
            if (textView6 != null) {
                textView6.setVisibility(0);
            }
            RecyclerView recyclerView8 = this.f37157t;
            if (recyclerView8 != null) {
                recyclerView8.setVisibility(0);
            }
            View view6 = this.f37162y;
            if (view6 != null) {
                view6.setVisibility(0);
            }
        } else {
            TextView textView7 = this.f37152o;
            if (textView7 != null) {
                textView7.setVisibility(8);
            }
            RecyclerView recyclerView9 = this.f37157t;
            if (recyclerView9 != null) {
                recyclerView9.setVisibility(8);
            }
            View view7 = this.f37162y;
            if (view7 != null) {
        ...
        if (C1895i.f14827b) {
            ...
            FrameLayout frameLayout = this.f37158u;
            if (frameLayout != null) {
                frameLayout.setVisibility(0);
            }
        } else {
            FrameLayout frameLayout2 = this.f37158u;
        ...
        if (cVar != null) {
            ...
            if (num3 != null) {
                ...
                ConstraintLayout constraintLayout = this.f37159v;
                if (constraintLayout != null) {
                    constraintLayout.setBackgroundColor(intValue2);
                }
            }
            Integer num4 = cVar.f5538i;
            if (num4 != null) {
                int intValue3 = num4.intValue();
                TextView textView8 = this.f37150m;
                if (textView8 != null) {
                    textView8.setTextColor(intValue3);
                }
                TextView textView9 = this.f37151n;
                if (textView9 != null) {
                    textView9.setTextColor(intValue3);
                }
                TextView textView10 = this.f37152o;
                if (textView10 != null) {
            ...
            if (num5 != null) {
                ...
                Button button2 = this.f37153p;
                if (button2 != null) {
                    button2.setTextColor(intValue4);
                }
            }
            Integer num6 = cVar.f5544o;
            if (num6 != null) {
                int intValue5 = num6.intValue();
                Button button3 = this.f37153p;
                if (button3 != null) {
        ...
        if (typeface != null) {
            TextView textView11 = this.f37150m;
            if (textView11 != null) {
                textView11.setTypeface(typeface);
            }
            TextView textView12 = this.f37151n;
            if (textView12 != null) {
                textView12.setTypeface(typeface);
            }
            TextView textView13 = this.f37152o;
            if (textView13 != null) {
                textView13.setTypeface(typeface);
            }
        }
        Typeface typeface2 = this.f8371l;
        if (typeface2 != null && (button = this.f37153p) != null) {
            button.setTypeface(typeface2);
        }
        C3639m c3639m4 = this.f37163z;
        if (c3639m4 == null) {
            AbstractC3159y.y("viewModel");
            c3639m4 = null;
        }
