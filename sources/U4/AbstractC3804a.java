...
public abstract class AbstractC3804a {
    ...
    public static final class C0888a extends AbstractC3160z implements Function1 {
        ...
        final /* synthetic */ AutofillNode f38473a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C0888a(AutofillNode autofillNode) {
            super(1);
            this.f38473a = autofillNode;
        }
        ...
        public final void invoke(LayoutCoordinates it) {
            ...
            this.f38473a.setBoundingBox(LayoutCoordinatesKt.boundsInWindow(it));
        }
    }
    ...
    public static final class b extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ AutofillNode f38474a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Autofill f38475b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(AutofillNode autofillNode, Autofill autofill) {
            super(1);
            this.f38474a = autofillNode;
            this.f38475b = autofill;
        }
        ...
        public final void invoke(FocusState focusState) {
            ...
            if (this.f38474a.getBoundingBox() == null || (autofill = this.f38475b) == null) {
                return;
            }
            AutofillNode autofillNode = this.f38474a;
