...
public final class F1 extends Fragment {
    ...
    public T4.y0 f11108a;

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC1227k f11109b;

    /* renamed from: c, reason: collision with root package name */
    private boolean f11110c;

    /* renamed from: d, reason: collision with root package name */
    private final ActivityResultLauncher f11111d;

    /* renamed from: e, reason: collision with root package name */
    private final ActivityResultLauncher f11112e;

    /* renamed from: f, reason: collision with root package name */
    private final ActivityResultLauncher f11113f;
    ...
    static final class a extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public static final class C0223a implements InterfaceC3359g {
            ...
            public final Object b(int i8, P5.d dVar) {
                if (i8 == 1) {
                    this.f11116a.b0().f11006x.setText(this.f11116a.getString(R.string.reviews_counter_single));
                } else {
                    this.f11116a.b0().f11006x.setText(this.f11116a.getString(R.string.reviews_counter_multiple, String.valueOf(i8)));
                }
                return L5.I.f6474a;
            }
            ...
            */
            public final java.lang.Object emit(l5.AbstractC3337y r5, P5.d r6) {
                ...
                L13:
                    ...
                    r0.<init>(r6)
                L18:
                    java.lang.Object r6 = r0.f11122c
                    java.lang.Object r1 = Q5.b.e()
                    int r2 = r0.f11124e
                    r3 = 1
                    if (r2 == 0) goto L39
                    if (r2 != r3) goto L31
                    java.lang.Object r5 = r0.f11121b
                    l5.y r5 = (l5.AbstractC3337y) r5
                    java.lang.Object r0 = r0.f11120a
                ...
                L39:
                    L5.t.b(r6)
                    l5.y$a r6 = l5.AbstractC3337y.a.f34533a
                ...
                L58:
                    ...
                    goto L79
                L74:
                    l5.y$b r6 = l5.AbstractC3337y.b.f34534a
            ...
            public final Object emit(AbstractC3337y abstractC3337y, P5.d dVar) {
                if (!AbstractC3159y.d(abstractC3337y, AbstractC3337y.a.f34533a)) {
                    if (abstractC3337y instanceof AbstractC3337y.c) {
                        if (this.f11127a.isAdded()) {
                            C3323k c3323k = new C3323k();
                            FragmentActivity requireActivity = this.f11127a.requireActivity();
                            AbstractC3159y.h(requireActivity, "requireActivity()");
                            c3323k.q(requireActivity, (String) ((AbstractC3337y.c) abstractC3337y).a(), this.f11127a.getString(R.string.uptodown_turbo));
                        }
                    } else {
    ...
    public static final class d extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Fragment f11128a;
    ...
    public static final class e extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f11129a;
        ...
        public final ViewModelStoreOwner invoke() {
            return (ViewModelStoreOwner) this.f11129a.invoke();
        }
    }
    ...
    public static final class f extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ InterfaceC1227k f11130a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public f(InterfaceC1227k interfaceC1227k) {
            super(0);
            this.f11130a = interfaceC1227k;
        }

        @Override // kotlin.jvm.functions.Function0
        public final ViewModelStore invoke() {
            ViewModelStoreOwner m5453viewModels$lambda1;
            m5453viewModels$lambda1 = FragmentViewModelLazyKt.m5453viewModels$lambda1(this.f11130a);
    ...
    public static final class g extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f11131a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ InterfaceC1227k f11132b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public g(Function0 function0, InterfaceC1227k interfaceC1227k) {
            super(0);
            this.f11131a = function0;
            this.f11132b = interfaceC1227k;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f11131a;
            if (function0 != null && (creationExtras = (CreationExtras) function0.invoke()) != null) {
                return creationExtras;
            }
            m5453viewModels$lambda1 = FragmentViewModelLazyKt.m5453viewModels$lambda1(this.f11132b);
    ...
    public static final class h extends AbstractC3160z implements Function0 {
        ...
        public final ViewModelProvider.Factory invoke() {
            ...
            m5453viewModels$lambda1 = FragmentViewModelLazyKt.m5453viewModels$lambda1(this.f11134b);
            HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = m5453viewModels$lambda1 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) m5453viewModels$lambda1 : null;
            if (hasDefaultViewModelProviderFactory != null && (defaultViewModelProviderFactory = hasDefaultViewModelProviderFactory.getDefaultViewModelProviderFactory()) != null) {
                return defaultViewModelProviderFactory;
            }
            ViewModelProvider.Factory defaultViewModelProviderFactory2 = this.f11133a.getDefaultViewModelProviderFactory();
    ...
    public static final class i extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new i(this.f11137c, dVar);
        }
    ...
    public F1() {
        InterfaceC1227k a8 = L5.l.a(L5.o.f6493c, new e(new d(this)));
        this.f11109b = FragmentViewModelLazyKt.createViewModelLazy(this, kotlin.jvm.internal.U.b(G1.class), new f(a8), new g(null, a8), new h(this, a8));
        ...
        this.f11111d = registerForActivityResult;
        ...
        this.f11112e = registerForActivityResult2;
        ...
        this.f11113f = registerForActivityResult3;
    }
    ...
    public static final void E0(F1 this$0, View view) {
        AbstractC3159y.i(this$0, "this$0");
        ActivityResultLauncher activityResultLauncher = this$0.f11113f;
    ...
    private final void H0() {
        ...
        UptodownApp.f27990B.q0(true);
    }

    private final void I0() {
        b0().f10988f.setOnClickListener(new View.OnClickListener() { // from class: U4.A1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.J0(F1.this, view);
            }
        });
        b0().f10988f.setImageResource(R.drawable.vector_user_login);
        ImageView imageView = b0().f10988f;
        ...
        b0().f10988f.setBackground(null);
        b0().f10978B.setText(getString(R.string.sign_in_sign_up));
        UsernameTextView.a aVar = UsernameTextView.f29975k;
        UsernameTextView usernameTextView = b0().f10978B;
        AbstractC3159y.h(usernameTextView, "binding.tvUsernameUserFragment");
        aVar.b(usernameTextView);
        b0().f10978B.setTextColor(ContextCompat.getColor(requireContext(), R.color.text_terciary));
        b0().f10998p.setOnClickListener(new View.OnClickListener() { // from class: U4.B1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.K0(F1.this, view);
            }
        });
        b0().f11006x.setVisibility(8);
        b0().f11005w.setVisibility(8);
        b0().f10989g.setVisibility(8);
        b0().f11001s.setVisibility(8);
        b0().f11002t.setVisibility(8);
    }
    ...
    private final void M0() {
        ...
        if (isAdded()) {
            ...
            TextView textView = c8.f10746f;
            j.a aVar = E4.j.f2272g;
            textView.setTypeface(aVar.t());
            c8.f10747g.setTypeface(aVar.u());
            c8.f10745e.setTypeface(aVar.u());
            c8.f10744d.setTypeface(aVar.u());
            c8.f10743c.setOnClickListener(new View.OnClickListener() { // from class: U4.o1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    F1.N0(F1.this, view);
                }
            });
            c8.f10742b.setOnClickListener(new View.OnClickListener() { // from class: U4.p1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    F1.O0(F1.this, view);
                }
            });
            c8.f10744d.setOnClickListener(new View.OnClickListener() { // from class: U4.q1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    F1.P0(F1.this, view);
                }
            ...
            if (isAdded()) {
                ...
                if (((AbstractActivityC2489a) activity3).s2() != null) {
                    ...
                    AlertDialog s24 = ((AbstractActivityC2489a) activity5).s2();
                    if (s24 != null) {
                        s24.show();
                    }
                }
    ...
    public final void Q0(int i8, int i9) {
        if (i8 > 0) {
            b0().f10981E.f11028d.setVisibility(0);
            b0().f10981E.f11030f.setText(String.valueOf(i8));
        } else {
            b0().f10981E.f11028d.setVisibility(4);
        }
        if (i9 > 0) {
            b0().f10984b.f11028d.setVisibility(0);
            b0().f10984b.f11030f.setText(String.valueOf(i9));
        } else {
            b0().f10984b.f11028d.setVisibility(4);
        }
    }
    ...
    private final void T(final Context context) {
        ...
        AbstractC3159y.h(c8, "inflate(layoutInflater)");
        TextView textView = c8.f10771f;
        j.a aVar = E4.j.f2272g;
        textView.setTypeface(aVar.u());
        c8.f10768c.setTypeface(aVar.u());
        c8.f10767b.setTypeface(aVar.u());
        c8.f10769d.setTypeface(aVar.u());
        String j8 = SettingsPreferences.f29309b.j(context);
        if (g6.n.s(j8, "yes", true)) {
            c8.f10768c.setChecked(true);
        } else if (g6.n.s(j8, "no", true)) {
            c8.f10767b.setChecked(true);
        } else {
            c8.f10769d.setChecked(true);
        }
        c8.f10768c.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: U4.u1
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z8) {
                F1.U(kotlin.jvm.internal.T.this, this, compoundButton, z8);
            }
        });
        c8.f10767b.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: U4.v1
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z8) {
                F1.V(kotlin.jvm.internal.T.this, this, compoundButton, z8);
            }
        });
        c8.f10769d.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: U4.w1
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z8) {
                F1.W(kotlin.jvm.internal.T.this, context, compoundButton, z8);
            }
        });
        c8.f10770e.setTypeface(aVar.t());
        c8.f10770e.setOnClickListener(new View.OnClickListener() { // from class: U4.x1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        if (getActivity() != null && !requireActivity().isFinishing() && (obj = t8.f33747a) != null) {
    ...
    public static final void U(kotlin.jvm.internal.T alertDialog, F1 this$0, CompoundButton compoundButton, boolean z8) {
        ...
        AbstractC3159y.i(this$0, "this$0");
        if (z8) {
            Object obj = alertDialog.f33747a;
    ...
    public static final void W(kotlin.jvm.internal.T alertDialog, Context context, CompoundButton compoundButton, boolean z8) {
        ...
        if (z8) {
            ...
            AbstractC3159y.f(obj);
            ((AlertDialog) obj).dismiss();
            SettingsPreferences.f29309b.B0(context, "system");
            AppCompatDelegate.setDefaultNightMode(-1);
            UptodownApp.f27990B.q0(true);
        }
    }
    ...
    private final void Y(final Context context) {
        ...
        j.a aVar = E4.j.f2272g;
        textView.setTypeface(aVar.u());
        c8.f10808d.setText(getString(R.string.log_out_confirmation_msg));
        c8.f10809e.setTypeface(aVar.t());
        c8.f10809e.setOnClickListener(new View.OnClickListener() { // from class: U4.r1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        c8.f10807c.setOnClickListener(new View.OnClickListener() { // from class: U4.s1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public final void e0(final X4.Q q8) {
        if (q8.e() != null) {
            com.squareup.picasso.w l8 = com.squareup.picasso.s.h().l(X4.Q.f12424k.c(q8.c()));
            UptodownApp.a aVar = UptodownApp.f27990B;
            Context requireContext = requireContext();
            AbstractC3159y.h(requireContext, "requireContext()");
            l8.n(aVar.f0(requireContext)).i(b0().f10988f);
            b0().f10988f.setBackground(ContextCompat.getDrawable(requireContext(), R.drawable.shadow_user_icon));
        } else {
            b0().f10988f.setImageResource(R.drawable.vector_user_profile);
        }
        b0().f10988f.setOnClickListener(new View.OnClickListener() { // from class: U4.X0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        b0().f11006x.setOnClickListener(new View.OnClickListener() { // from class: U4.i1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        if (q8.G()) {
            ...
            ImageView imageView2 = b0().f10988f;
            AbstractC3159y.h(imageView2, "binding.ivUserAvatarUserFragment");
            aVar4.a(imageView2);
            b0().f11001s.setBackground(ContextCompat.getDrawable(requireContext(), R.drawable.ripple_turbo_button));
            b0().f10989g.setVisibility(0);
        } else {
            b0().f11001s.setBackground(ContextCompat.getDrawable(requireContext(), R.drawable.ripple_blue_primary_button));
            b0().f10989g.setVisibility(8);
        }
        b0().f11006x.setVisibility(0);
        b0().f11005w.setVisibility(0);
        b0().f11001s.setVisibility(0);
        b0().f11002t.setVisibility(0);
        b0().f10998p.setOnClickListener(null);
    }
    ...
    private final void k0() {
        ...
        ActivityResultLauncher activityResultLauncher = this.f11111d;
        UptodownApp.a aVar = UptodownApp.f27990B;
        FragmentActivity requireActivity = requireActivity();
        AbstractC3159y.h(requireActivity, "requireActivity()");
        activityResultLauncher.launch(intent, aVar.b(requireActivity));
    ...
    private final void l0() {
        ...
        ActivityResultLauncher activityResultLauncher = this.f11112e;
        UptodownApp.a aVar = UptodownApp.f27990B;
        FragmentActivity requireActivity = requireActivity();
        AbstractC3159y.h(requireActivity, "requireActivity()");
        activityResultLauncher.launch(intent, aVar.b(requireActivity));
    ...
    private final void o0() {
        ...
        S0();
        b0().f10988f.setOnClickListener(new View.OnClickListener() { // from class: U4.C1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.p0(X4.Q.this, this, view);
            }
        });
        b0().f10998p.setOnClickListener(new View.OnClickListener() { // from class: U4.e1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.q0(F1.this, view);
            }
        });
        b0().f11001s.setOnClickListener(new View.OnClickListener() { // from class: U4.f1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.z0(F1.this, view);
            }
        });
        b0().f10981E.f11027c.setOnClickListener(new View.OnClickListener() { // from class: U4.g1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.A0(F1.this, view);
            }
        });
        b0().f10995m.f11027c.setOnClickListener(new View.OnClickListener() { // from class: U4.h1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.B0(F1.this, view);
            }
        });
        b0().f10984b.f11027c.setOnClickListener(new View.OnClickListener() { // from class: U4.j1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.C0(F1.this, view);
            }
        });
        b0().f10999q.f11027c.setOnClickListener(new View.OnClickListener() { // from class: U4.k1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.D0(F1.this, view);
            }
        });
        b0().f10982F.f11027c.setOnClickListener(new View.OnClickListener() { // from class: U4.l1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.E0(F1.this, view);
            }
        });
        b0().f10980D.f11027c.setOnClickListener(new View.OnClickListener() { // from class: U4.m1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.F0(F1.this, view);
            }
        });
        b0().f10989g.setOnClickListener(new View.OnClickListener() { // from class: U4.n1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.G0(F1.this, view);
            }
        });
        b0().f10991i.setOnClickListener(new View.OnClickListener() { // from class: U4.D1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.r0(F1.this, view);
            }
        });
        b0().f10990h.setOnClickListener(new View.OnClickListener() { // from class: U4.E1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.s0(F1.this, view);
            }
        });
        b0().f10992j.setOnClickListener(new View.OnClickListener() { // from class: U4.Y0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.t0(F1.this, view);
            }
        ...
        if (e8 != null && e8.G()) {
            b0().f10987e.setImageDrawable(ContextCompat.getDrawable(requireContext(), R.drawable.vector_support_turbo));
        } else {
            b0().f10987e.setImageDrawable(ContextCompat.getDrawable(requireContext(), R.drawable.vector_support));
        }
        b0().f10993k.setOnClickListener(new View.OnClickListener() { // from class: U4.Z0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.u0(F1.this, view);
            }
        });
        b0().f10979C.setOnClickListener(new View.OnClickListener() { // from class: U4.a1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.v0(F1.this, view);
            }
        });
        b0().f11002t.setOnClickListener(new View.OnClickListener() { // from class: U4.b1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.w0(F1.this, view);
            }
        });
        b0().f10986d.setOnClickListener(new View.OnClickListener() { // from class: U4.c1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                F1.x0(F1.this, view);
            }
        });
        b0().f10986d.setOnLongClickListener(new View.OnLongClickListener() { // from class: U4.d1
    ...
    public static final void x0(F1 this$0, View view) {
        AbstractC3159y.i(this$0, "this$0");
        if (this$0.getContext() != null && UptodownApp.f27990B.a0()) {
    ...
    public final G1 c0() {
        return (G1) this.f11109b.getValue();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        for (int i10 = 6; !z8 && i10 > 0; i10--) {
            ...
            if (i11 >= dimensionPixelSize2 * i10) {
                b0().f10985c.setColumnCount(i10);
                b0().f10985c.setRowCount(6 / i10);
                z8 = true;
                i9 = i11 / i10;
            }
        }
        if (i9 > 0) {
            b0().f10995m.f11027c.getLayoutParams().height = i9;
            b0().f10981E.f11027c.getLayoutParams().height = i9;
            b0().f10984b.f11027c.getLayoutParams().height = i9;
            b0().f10999q.f11027c.getLayoutParams().height = i9;
            b0().f10982F.f11027c.getLayoutParams().height = i9;
            b0().f10980D.f11027c.getLayoutParams().height = i9;
        }
    ...
    public void onResume() {
        ...
        if (new C3323k().o(getContext())) {
            b0().f10986d.setImageDrawable(ContextCompat.getDrawable(requireContext(), R.drawable.vector_dark_mode));
        } else {
            b0().f10986d.setImageDrawable(ContextCompat.getDrawable(requireContext(), R.drawable.vector_light_mode));
        }
        R();
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        b0().f11005w.setTypeface(aVar.u());
        b0().f11006x.setTypeface(aVar.t());
        b0().f11001s.setTypeface(aVar.t());
        b0().f10995m.f11029e.setTypeface(aVar.u());
        b0().f10995m.f11029e.setText(getString(R.string.my_apps_menu_left));
        b0().f10995m.f11026b.setImageResource(R.drawable.vector_user_panel_my_apps);
        b0().f10981E.f11029e.setTypeface(aVar.u());
        b0().f10981E.f11030f.setTypeface(aVar.u());
        b0().f10981E.f11029e.setText(getString(R.string.updates));
        b0().f10981E.f11026b.setImageResource(R.drawable.vector_user_panel_updates);
        b0().f10984b.f11029e.setTypeface(aVar.u());
        b0().f10984b.f11030f.setTypeface(aVar.u());
        b0().f10984b.f11029e.setText(getString(R.string.downloads_title));
        b0().f10984b.f11026b.setImageResource(R.drawable.vector_user_panel_download);
        b0().f10999q.f11029e.setTypeface(aVar.u());
        b0().f10999q.f11029e.setText(getString(R.string.rollback_title));
        b0().f10999q.f11026b.setImageResource(R.drawable.vector_user_panel_rollback);
        b0().f10982F.f11029e.setTypeface(aVar.u());
        b0().f10982F.f11029e.setText(getString(R.string.wishlist_title));
        b0().f10982F.f11026b.setImageResource(R.drawable.vector_user_panel_wishlist);
        b0().f10980D.f11029e.setTypeface(aVar.u());
        b0().f10980D.f11029e.setText(getString(R.string.upcoming_releases_title));
        b0().f10980D.f11026b.setImageResource(R.drawable.vector_user_panel_upcoming);
        b0().f11003u.setTypeface(aVar.u());
        b0().f11007y.setTypeface(aVar.u());
        b0().f11004v.setTypeface(aVar.u());
        b0().f11008z.setTypeface(aVar.u());
        b0().f10977A.setTypeface(aVar.u());
        b0().f10979C.setTypeface(aVar.u());
        b0().f11002t.setTypeface(aVar.u());
