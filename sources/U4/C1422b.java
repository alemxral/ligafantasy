...
public final class C1422b extends Fragment {
    ...
    public C1495e f11598b;

    /* renamed from: c, reason: collision with root package name */
    private D4.G f11599c;

    /* renamed from: a, reason: collision with root package name */
    private final InterfaceC1227k f11597a = L5.l.b(new C0230b());

    /* renamed from: d, reason: collision with root package name */
    private j f11600d = new j();

    /* renamed from: e, reason: collision with root package name */
    private i f11601e = new i();
    ...
    public static final class c implements W4.r {
        ...
        public void f(C1498h appInfo) {
            ...
            ((G.b) arrayList.get(this.f11604b)).e(appInfo);
            D4.G g9 = C1422b.this.f11599c;
            if (g9 != null) {
                g9.notifyItemChanged(this.f11604b);
            }
        }
    }
    ...
    public static final class d extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ C1498h f11605a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C1422b f11606b;
        ...
        public final void m89invoke() {
            if (this.f11605a.y0() != null) {
                C1422b c1422b = this.f11606b;
                String y02 = this.f11605a.y0();
    ...
    public static final class f extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ C1498h f11610a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C1422b f11611b;
        ...
        public final void m91invoke() {
            if (this.f11610a.y0() != null) {
                C1422b c1422b = this.f11611b;
                String y02 = this.f11610a.y0();
                AbstractC3159y.f(y02);
                c1422b.y(y02);
            }
        }
    ...
    public static final class i implements InterfaceC1482e {
        ...
        public void b(C1498h appInfo, int i8) {
            ...
            if (C1422b.this.getContext() != null) {
                ...
                a8.g();
                if (Z7 != null) {
                    DownloadApkWorker.f29987k.a(appInfo.i());
    ...
    public static final class k extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ C1422b f11620c;
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            return new k(this.f11619b, this.f11620c, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f11618a == 0) {
                ...
                if (str != null && str.length() != 0 && this.f11620c.f11599c != null) {
                    D4.G g8 = this.f11620c.f11599c;
                    AbstractC3159y.f(g8);
                    ...
                    while (it.hasNext()) {
                        ...
                        if (bVar.b() != null) {
                            ...
                            if (b8.y0() != null) {
                                C1498h b9 = bVar.b();
                                AbstractC3159y.f(b9);
                                if (AbstractC3159y.d(b9.y0(), this.f11619b)) {
                                    D4.G g9 = this.f11620c.f11599c;
                                    AbstractC3159y.f(g9);
    ...
    private final T4.n0 q() {
        return (T4.n0) this.f11597a.getValue();
    }

    private final void r() {
        q().f10763e.setVisibility(0);
        Drawable drawable = ContextCompat.getDrawable(requireContext(), R.drawable.vector_arrow_left);
        if (drawable != null) {
            q().f10763e.setNavigationIcon(drawable);
            q().f10763e.setNavigationContentDescription(getString(R.string.back));
        }
        q().f10763e.setNavigationOnClickListener(new View.OnClickListener() { // from class: U4.a
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                C1422b.s(C1422b.this, view);
            }
        });
        q().f10764f.setTypeface(E4.j.f2272g.u());
        q().f10764f.setVisibility(8);
        q().f10762d.setItemAnimator(null);
        q().f10762d.setLayoutManager(new LinearLayoutManager(getContext(), 1, false));
        RecyclerView recyclerView = q().f10762d;
        Context requireContext = requireContext();
        AbstractC3159y.h(requireContext, "requireContext()");
        recyclerView.addItemDecoration(new n5.t(requireContext, 11));
        RecyclerView recyclerView2 = q().f10762d;
    ...
    private final void u() {
        D4.G g8;
        if (E4.j.f2272g.h() == null && (g8 = this.f11599c) != null) {
    ...
    public final void w(C1498h c1498h) {
        if (getActivity() instanceof MainActivity) {
            FragmentActivity activity = getActivity();
            AbstractC3159y.g(activity, "null cannot be cast to non-null type com.uptodown.activities.MainActivity");
            ((MainActivity) activity).a7(c1498h, new d(c1498h, this));
            Context requireContext = requireContext();
            AbstractC3159y.h(requireContext, "requireContext()");
        ...
        if (getActivity() instanceof AppDetailActivity) {
            ...
            ((AppDetailActivity) activity2).r3(q().f10760b.getRoot());
            FragmentActivity activity3 = getActivity();
            AbstractC3159y.g(activity3, "null cannot be cast to non-null type com.uptodown.activities.AppDetailActivity");
            ((AppDetailActivity) activity3).s3(c1498h, new f(c1498h, this));
            Context requireContext2 = requireContext();
            AbstractC3159y.h(requireContext2, "requireContext()");
    ...
    private final void x(C1495e c1495e) {
        if (getActivity() != null && !requireActivity().isFinishing()) {
            ...
            D4.G g8 = new D4.G(this.f11600d, this.f11601e, new h(), c1495e.b(), c1495e.c());
            this.f11599c = g8;
            g8.b(n8, (int) dimension);
            q().f10762d.setAdapter(this.f11599c);
        }
    }
    ...
    public static final class e implements W4.r {
        ...
        static final class a extends AbstractC3160z implements Function0 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ C1422b f11608a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ C1498h f11609b;
            ...
            public final void m90invoke() {
                this.f11608a.y(this.f11609b.y0());
            }
        }
        ...
        public void f(C1498h appInfo) {
            ...
            FragmentActivity activity = C1422b.this.getActivity();
            AbstractC3159y.g(activity, "null cannot be cast to non-null type com.uptodown.activities.MainActivity");
            ((MainActivity) activity).a7(appInfo, new a(C1422b.this, appInfo));
        }
    ...
    public static final class g implements W4.r {
        ...
        static final class a extends AbstractC3160z implements Function0 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ C1422b f11613a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ C1498h f11614b;
            ...
            public final void m92invoke() {
                this.f11613a.y(this.f11614b.y0());
            }
        }
        ...
        public void f(C1498h appInfo) {
            ...
            ((AppDetailActivity) activity).s3(appInfo, new a(C1422b.this, appInfo));
        }
