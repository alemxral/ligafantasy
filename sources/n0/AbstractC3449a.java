...
public abstract class AbstractC3449a {
    ...
    private static final C1264h f35964a = C1264h.f();

    /* renamed from: b, reason: collision with root package name */
    private static final Object f35965b = new Object();

    /* renamed from: c, reason: collision with root package name */
    private static Method f35966c = null;

    /* renamed from: d, reason: collision with root package name */
    private static Method f35967d = null;

    public static void a(Context context) {
        Context context2;
        AbstractC1319p.m(context, "Context must not be null");
        f35964a.k(context, 11925000);
        synchronized (f35965b) {
            long elapsedRealtime = SystemClock.elapsedRealtime();
            try {
                context2 = DynamiteModule.e(context, DynamiteModule.f15200f, "com.google.android.gms.providerinstaller.dynamite").b();
            ...
            if (d8 != null) {
                try {
                    if (f35967d == null) {
                        Class cls = Long.TYPE;
                        f35967d = b(d8, "com.google.android.gms.common.security.ProviderInstallerImpl", "reportRequestStats", new Class[]{Context.class, cls, cls});
                    }
                    f35967d.invoke(null, context, Long.valueOf(elapsedRealtime), Long.valueOf(elapsedRealtime2));
                } catch (Exception e9) {
    ...
    private static void c(Context context, Context context2, String str) {
        ...
        try {
            if (f35966c == null) {
                f35966c = b(context, str, "insertProvider", new Class[]{Context.class});
            }
            f35966c.invoke(null, context);
        } catch (Exception e8) {
