...
public final class C2883j implements java.util.Map, Serializable, Map {
    ...
    private final java.util.Map f32214a;

    /* renamed from: b, reason: collision with root package name */
    final Object f32215b = this;

    /* renamed from: c, reason: collision with root package name */
    private transient java.util.Set f32216c;

    /* renamed from: d, reason: collision with root package name */
    private transient java.util.Set f32217d;

    /* renamed from: e, reason: collision with root package name */
    private transient java.util.Collection f32218e;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C2883j(java.util.Map map) {
        this.f32214a = (java.util.Map) Objects.requireNonNull(map);
    }

    private void writeObject(ObjectOutputStream objectOutputStream) {
        synchronized (this.f32215b) {
    ...
    */
    public final java.lang.Object compute(java.lang.Object r5, java.util.function.BiFunction r6) {
        /*
            r4 = this;
            java.lang.Object r0 = r4.f32215b
            monitor-enter(r0)
            java.util.Map r1 = r4.f32214a     // Catch: java.lang.Throwable -> L41
    ...
    public final Object computeIfAbsent(Object obj, Function function) {
        ...
        Object apply;
        synchronized (this.f32215b) {
            java.util.Map map = this.f32214a;
    ...
    */
    public final java.lang.Object computeIfPresent(java.lang.Object r5, java.util.function.BiFunction r6) {
        /*
            ...
            java.lang.Object r0 = r4.f32215b
            monitor-enter(r0)
            java.util.Map r1 = r4.f32214a     // Catch: java.lang.Throwable -> L3c
    ...
    public final boolean containsKey(Object obj) {
        boolean containsKey;
        synchronized (this.f32215b) {
            containsKey = this.f32214a.containsKey(obj);
        }
        return containsKey;
    }
    ...
    public final boolean containsValue(Object obj) {
        ...
        synchronized (this.f32215b) {
            containsValue = this.f32214a.containsValue(obj);
        }
        ...
        synchronized (this.f32215b) {
            try {
                if (this.f32217d == null) {
                    this.f32217d = new C2881h(this.f32214a.entrySet(), this.f32215b);
                }
                set = this.f32217d;
            } catch (Throwable th) {
                throw th;
    ...
    public final boolean equals(Object obj) {
        ...
        synchronized (this.f32215b) {
            equals = this.f32214a.equals(obj);
        }
        return equals;
    }
    ...
    public final void forEach(BiConsumer biConsumer) {
        synchronized (this.f32215b) {
            AbstractC2877d.q(this.f32214a, biConsumer);
        }
    }
    ...
    public final Object getOrDefault(Object obj, Object obj2) {
        Object s8;
        synchronized (this.f32215b) {
            s8 = AbstractC2877d.s(this.f32214a, obj, obj2);
        }
        return s8;
    }
    ...
    public final int hashCode() {
        int hashCode;
        synchronized (this.f32215b) {
            hashCode = this.f32214a.hashCode();
        }
        return hashCode;
    }
        ...
        synchronized (this.f32215b) {
            try {
                if (this.f32216c == null) {
                    this.f32216c = new C2881h(this.f32214a.keySet(), this.f32215b);
                }
                set = this.f32216c;
            } catch (Throwable th) {
                throw th;
    ...
    */
    public final java.lang.Object merge(java.lang.Object r5, java.lang.Object r6, java.util.function.BiFunction r7) {
        /*
            ...
            java.lang.Object r0 = r4.f32215b
            monitor-enter(r0)
            java.util.Map r1 = r4.f32214a     // Catch: java.lang.Throwable -> L46
    ...
    public final Object putIfAbsent(Object obj, Object obj2) {
        Object t8;
        synchronized (this.f32215b) {
            t8 = AbstractC2877d.t(this.f32214a, obj, obj2);
        }
        return t8;
    }
    ...
    public final Object remove(Object obj) {
        Object remove;
        synchronized (this.f32215b) {
            remove = this.f32214a.remove(obj);
        }
        return remove;
    }
        ...
        synchronized (this.f32215b) {
            try {
                if (this.f32218e == null) {
                    this.f32218e = new C2881h(this.f32214a.values(), this.f32215b);
                }
                collection = this.f32218e;
            } catch (Throwable th) {
                throw th;
            }
        }
