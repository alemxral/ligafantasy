...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable, v {
    ...
    static final int f32113g = Runtime.getRuntime().availableProcessors();

    /* renamed from: h, reason: collision with root package name */
    private static final j$.sun.misc.a f32114h;

    /* renamed from: i, reason: collision with root package name */
    private static final long f32115i;

    /* renamed from: j, reason: collision with root package name */
    private static final long f32116j;

    /* renamed from: k, reason: collision with root package name */
    private static final long f32117k;

    /* renamed from: l, reason: collision with root package name */
    private static final long f32118l;

    /* renamed from: m, reason: collision with root package name */
    private static final long f32119m;

    /* renamed from: n, reason: collision with root package name */
    private static final int f32120n;

    /* renamed from: o, reason: collision with root package name */
    private static final int f32121o;
    private static final ObjectStreamField[] serialPersistentFields;
    private static final long serialVersionUID = 7249069246763182397L;

    /* renamed from: a, reason: collision with root package name */
    volatile transient l[] f32122a;

    /* renamed from: b, reason: collision with root package name */
    private volatile transient l[] f32123b;
    private volatile transient long baseCount;

    /* renamed from: c, reason: collision with root package name */
    private volatile transient c[] f32124c;
    private volatile transient int cellsBusy;

    /* renamed from: d, reason: collision with root package name */
    private transient i f32125d;

    /* renamed from: e, reason: collision with root package name */
    private transient s f32126e;

    /* renamed from: f, reason: collision with root package name */
    private transient e f32127f;
    ...
    static {
        ...
        f32114h = h8;
        f32115i = h8.j(ConcurrentHashMap.class, "sizeCtl");
        f32116j = h8.j(ConcurrentHashMap.class, "transferIndex");
        f32117k = h8.j(ConcurrentHashMap.class, "baseCount");
        f32118l = h8.j(ConcurrentHashMap.class, "cellsBusy");
        f32119m = h8.j(c.class, "value");
        f32120n = h8.a(l[].class);
        int b8 = h8.b(l[].class);
        if (((b8 - 1) & b8) != 0) {
            throw new ExceptionInInitializerError("array index scale not a power of two");
        }
        f32121o = 31 - Integer.numberOfLeadingZeros(b8);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:155:0x013f, code lost:
        ...
        if (r25.f32124c != r7) goto L150;
     */
    /* JADX WARN: Code restructure failed: missing block: B:156:0x0141, code lost:
    
        r25.f32124c = (j$.util.concurrent.c[]) java.util.Arrays.copyOf(r7, r8 << 1);
     */
    ...
    */
    ...
    static final boolean b(l[] lVarArr, int i8, l lVar) {
        return f32114h.e(lVarArr, (i8 << f32121o) + f32120n, lVar);
    }
    ...
    private final l[] e() {
        while (true) {
            ...
            if (i8 < 0) {
                Thread.yield();
            } else if (f32114h.c(this, f32115i, i8, -1)) {
                try {
                    l[] lVarArr2 = this.f32122a;
                    if (lVarArr2 != null) {
    ...
    static final void h(l[] lVarArr, int i8, l lVar) {
        f32114h.l(lVarArr, (i8 << f32121o) + f32120n, lVar);
    }
    ...
    public static final l k(l[] lVarArr, int i8) {
        return (l) f32114h.g(lVarArr, (i8 << f32121o) + f32120n);
    }
    ...
    private final void m(l[] lVarArr, l[] lVarArr2) {
        ...
        if (lVarArr2 == null) {
            try {
                ...
                concurrentHashMap2.f32123b = lVarArr5;
        ...
        while (true) {
            if (z8) {
                ...
                if (i15 < 0 || i15 >= length || (i10 = i15 + length) >= length2) {
                    ...
                    if (z9) {
                        concurrentHashMap.f32123b = null;
                        concurrentHashMap.f32122a = lVarArr3;
                        concurrentHashMap.sizeCtl = (length << 1) - (length >>> 1);
                        return;
                    }
                    j$.sun.misc.a aVar2 = f32114h;
                    long j9 = f32115i;
                                ...
                                try {
                                    if (k(lVarArr4, i15) == k8) {
                                        if (i23 >= 0) {
                                            int i24 = i23 & length;
                                            r rVar3 = k8;
                                            for (r rVar4 = k8.f32150d; rVar4 != null; rVar4 = rVar4.f32150d) {
                                                int i25 = rVar4.f32147a & length;
                                                if (i25 != i24) {
                                                    rVar3 = rVar4;
                                                    i24 = i25;
                                                }
                                            ...
                                            if (k8 instanceof q) {
                                                ...
                                                r rVar5 = null;
                                                r rVar6 = null;
                                                l lVar2 = qVar.f32166f;
                                                int i29 = 0;
                                                int i30 = 0;
                                                r rVar7 = null;
                                                while (lVar2 != null) {
                                                    q qVar2 = qVar;
                                                    int i31 = lVar2.f32147a;
                                                    g gVar3 = gVar2;
                                                    r rVar8 = new r(i31, lVar2.f32148b, lVar2.f32149c, null, null);
                                                    if ((i31 & length) == 0) {
                                                        rVar8.f32171h = rVar6;
                                                        if (rVar6 == null) {
                                                            rVar2 = rVar8;
        ...
        synchronized (k8) {
            try {
                if (k(lVarArr, i8) == k8) {
                    ...
                    r rVar2 = null;
                    while (lVar != null) {
                        r rVar3 = new r(lVar.f32147a, lVar.f32148b, lVar.f32149c, null, null);
                        rVar3.f32171h = rVar2;
                        if (rVar2 == null) {
                            rVar = rVar3;
                        } else {
    ...
    private final void o(int i8) {
        ...
        while (true) {
            ...
            if (lVarArr == null || (length = lVarArr.length) == 0) {
                int i10 = i9 > l8 ? i9 : l8;
                if (f32114h.c(this, f32115i, i9, -1)) {
                    try {
                        if (this.f32122a == lVarArr) {
                            this.f32122a = new l[i10];
                            i9 = i10 - (i10 >>> 2);
                        }
                    } finally {
                        this.sizeCtl = i9;
                ...
                if (lVarArr == this.f32122a) {
                    if (f32114h.c(this, f32115i, i9, ((Integer.numberOfLeadingZeros(length) | 32768) << 16) + 2)) {
                        m(lVarArr, null);
                    }
                }
            }
    ...
    static l p(l lVar) {
        ...
        l lVar3 = null;
        while (lVar != null) {
            l lVar4 = new l(lVar.f32147a, lVar.f32148b, lVar.f32149c);
            if (lVar3 == null) {
                lVar2 = lVar4;
            } else {
                lVar3.f32150d = lVar4;
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        while (lVar != null) {
            ...
            if (k8 == null) {
                ...
                Object obj2 = lVar.f32148b;
                if (k8.f32147a >= 0) {
                    int i11 = 0;
                    for (l lVar3 = k8; lVar3 != null; lVar3 = lVar3.f32150d) {
                        if (lVar3.f32147a == i9 && ((obj = lVar3.f32148b) == obj2 || (obj != null && obj2.equals(obj)))) {
                            z8 = false;
                            break;
                        }
                        i11++;
                    ...
                    if (!z8 || i11 < 8) {
                        ...
                        while (lVar4 != null) {
                            long j13 = j12;
                            r rVar3 = new r(lVar4.f32147a, lVar4.f32148b, lVar4.f32149c, null, null);
                            rVar3.f32171h = rVar2;
                            if (rVar2 == null) {
                                rVar = rVar3;
                            } else {
                ...
                } else if (((q) k8).e(i9, obj2, lVar.f32149c) == null) {
                    j9 += j8;
                }
                z9 = false;
            }
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) {
        ...
        if (lVarArr != null) {
            ...
            while (true) {
                ...
                objectOutputStream.writeObject(a8.f32148b);
                objectOutputStream.writeObject(a8.f32149c);
            }
        }
            ...
            while (lVarArr != null && i8 < lVarArr.length) {
                ...
                if (k8 == null) {
                    ...
                    synchronized (k8) {
                        try {
                            if (k(lVarArr, i8) == k8) {
                                for (l lVar = i9 >= 0 ? k8 : k8 instanceof q ? ((q) k8).f32166f : null; lVar != null; lVar = lVar.f32150d) {
                                    j8--;
                                }
                                h(lVarArr, i8, null);
                                i8++;
    ...
    */
    public final java.lang.Object computeIfPresent(java.lang.Object r14, java.util.function.BiFunction r15) {
        /*
            ...
            int r1 = r14.hashCode()
            int r1 = i(r1)
            j$.util.concurrent.l[] r2 = r13.f32122a
            r3 = 0
            r5 = r0
            r4 = 0
        L12:
        ...
        L2e:
            ...
            r8 = r7
        L3a:
            int r11 = r8.f32147a     // Catch: java.lang.Throwable -> L4b
            if (r11 != r1) goto L65
            java.lang.Object r11 = r8.f32148b     // Catch: java.lang.Throwable -> L4b
            if (r11 == r14) goto L4e
            if (r11 == 0) goto L65
        ...
        L4b:
            ...
            goto Lb5
        L4e:
            java.lang.Object r5 = r8.f32149c     // Catch: java.lang.Throwable -> L4b
            java.lang.Object r5 = r15.apply(r14, r5)     // Catch: java.lang.Throwable -> L4b
            if (r5 == 0) goto L59
            r8.f32149c = r5     // Catch: java.lang.Throwable -> L4b
            goto Lab
        L59:
            j$.util.concurrent.l r3 = r8.f32150d     // Catch: java.lang.Throwable -> L4b
            if (r10 == 0) goto L60
            r10.f32150d = r3     // Catch: java.lang.Throwable -> L4b
            goto L63
        L60:
        ...
        L63:
            ...
            goto Lab
        L65:
            j$.util.concurrent.l r10 = r8.f32150d     // Catch: java.lang.Throwable -> L4b
            if (r10 != 0) goto L6a
            goto Lab
        L6a:
            int r4 = r4 + 1
        ...
        L70:
            ...
            j$.util.concurrent.r r8 = r4.f32165e     // Catch: java.lang.Throwable -> L4b
            if (r8 == 0) goto L9c
        ...
        L8c:
            ...
            if (r3 == 0) goto L9b
            j$.util.concurrent.r r3 = r4.f32166f     // Catch: java.lang.Throwable -> L4b
    ...
    final l[] d(l[] lVarArr, l lVar) {
        l[] lVarArr2;
        int i8;
        if (!(lVar instanceof g) || (lVarArr2 = ((g) lVar).f32140e) == null) {
            return this.f32122a;
        }
        int numberOfLeadingZeros = Integer.numberOfLeadingZeros(lVarArr.length) | 32768;
        while (true) {
            if (lVarArr2 != this.f32123b || this.f32122a != lVarArr || (i8 = this.sizeCtl) >= 0 || (i8 >>> 16) != numberOfLeadingZeros || i8 == numberOfLeadingZeros + 1 || i8 == 65535 + numberOfLeadingZeros || this.transferIndex <= 0) {
                break;
            }
            if (f32114h.c(this, f32115i, i8, i8 + 1)) {
                m(lVarArr, lVarArr2);
                break;
            }
        }
    ...
    public final boolean equals(Object obj) {
        ...
        while (true) {
            ...
            Object obj2 = a8.f32149c;
            Object obj3 = map.get(a8.f32148b);
    ...
    public final void forEach(BiConsumer biConsumer) {
        ...
        while (true) {
            ...
            if (a8 == null) {
                ...
                biConsumer.accept(a8.f32148b, a8.f32149c);
            }
        }
    }
    ...
    */
    public final java.lang.Object g(java.lang.Object r13, java.lang.Object r14, java.lang.Object r15) {
        /*
            ...
            int r0 = r13.hashCode()
            int r0 = i(r0)
            j$.util.concurrent.l[] r1 = r12.f32122a
        La:
            r2 = 0
            if (r1 == 0) goto Lbd
            int r3 = r1.length
        ...
        L25:
            ...
            r5 = r4
        L31:
            int r9 = r5.f32147a     // Catch: java.lang.Throwable -> L42
            if (r9 != r0) goto L65
            java.lang.Object r9 = r5.f32148b     // Catch: java.lang.Throwable -> L42
            if (r9 == r13) goto L45
            if (r9 == 0) goto L65
        ...
        L42:
            ...
            goto Lbb
        L45:
            java.lang.Object r9 = r5.f32149c     // Catch: java.lang.Throwable -> L42
            if (r15 == 0) goto L53
            if (r15 == r9) goto L53
            if (r9 == 0) goto Lad
        ...
        L53:
            if (r14 == 0) goto L58
            r5.f32149c = r14     // Catch: java.lang.Throwable -> L42
            goto Lae
        L58:
            if (r8 == 0) goto L5f
            j$.util.concurrent.l r3 = r5.f32150d     // Catch: java.lang.Throwable -> L42
            r8.f32150d = r3     // Catch: java.lang.Throwable -> L42
            goto Lae
        L5f:
            j$.util.concurrent.l r5 = r5.f32150d     // Catch: java.lang.Throwable -> L42
        L61:
            h(r1, r3, r5)     // Catch: java.lang.Throwable -> L42
            goto Lae
        L65:
            j$.util.concurrent.l r8 = r5.f32150d     // Catch: java.lang.Throwable -> L42
            if (r8 != 0) goto L6a
            goto Lad
        L6a:
            r11 = r8
        ...
        L6e:
            ...
            j$.util.concurrent.r r8 = r5.f32165e     // Catch: java.lang.Throwable -> L42
            if (r8 == 0) goto Lad
            j$.util.concurrent.r r8 = r8.b(r0, r13, r2)     // Catch: java.lang.Throwable -> L42
            if (r8 == 0) goto Lad
            java.lang.Object r9 = r8.f32149c     // Catch: java.lang.Throwable -> L42
            if (r15 == 0) goto L8d
            if (r15 == r9) goto L8d
            if (r9 == 0) goto Lad
            boolean r10 = r15.equals(r9)     // Catch: java.lang.Throwable -> L42
        ...
        L8d:
            if (r14 == 0) goto L92
            r8.f32149c = r14     // Catch: java.lang.Throwable -> L42
            goto Lae
        L92:
            boolean r8 = r5.f(r8)     // Catch: java.lang.Throwable -> L42
            if (r8 == 0) goto Lae
            j$.util.concurrent.r r5 = r5.f32166f     // Catch: java.lang.Throwable -> L42
    ...
    */
    public V get(java.lang.Object r5) {
        /*
            ...
            int r0 = r5.hashCode()
            int r0 = i(r0)
            j$.util.concurrent.l[] r1 = r4.f32122a
            r2 = 0
            if (r1 == 0) goto L4e
            int r3 = r1.length
            if (r3 <= 0) goto L4e
            ...
            int r3 = r1.f32147a
            if (r3 != r0) goto L2c
            java.lang.Object r3 = r1.f32148b
            if (r3 == r5) goto L29
            if (r3 == 0) goto L37
            boolean r3 = r5.equals(r3)
            if (r3 == 0) goto L37
        L29:
            java.lang.Object r5 = r1.f32149c
            return r5
        L2c:
            if (r3 >= 0) goto L37
            j$.util.concurrent.l r5 = r1.a(r0, r5)
            if (r5 == 0) goto L36
            java.lang.Object r2 = r5.f32149c
        L36:
            return r2
        L37:
            j$.util.concurrent.l r1 = r1.f32150d
            if (r1 == 0) goto L4e
            int r3 = r1.f32147a
            if (r3 != r0) goto L37
            java.lang.Object r3 = r1.f32148b
    ...
    public final int hashCode() {
        ...
        if (lVarArr != null) {
            ...
            while (true) {
                ...
                i8 += a8.f32149c.hashCode() ^ a8.f32148b.hashCode();
            }
        }
        return i8;
    }
    ...
    */
    ...
    public final void replaceAll(BiFunction biFunction) {
        ...
        while (true) {
            ...
            Object obj = a8.f32149c;
            Object obj2 = a8.f32148b;
            do {
