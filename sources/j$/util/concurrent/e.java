...
public final class e extends b implements Set, j$.util.Set {
    ...
    public final boolean add(Object obj) {
        ...
        return this.f32137a.f(entry.getKey(), entry.getValue(), false) == null;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        while (it.hasNext()) {
            ...
            if (this.f32137a.f(entry.getKey(), entry.getValue(), false) == null) {
                z8 = true;
            }
        }
        return z8;
    ...
    public final boolean contains(Object obj) {
        ...
        Object obj2;
        Object value;
        return (!(obj instanceof Map.Entry) || (key = (entry = (Map.Entry) obj).getKey()) == null || (obj2 = this.f32137a.get(key)) == null || (value = entry.getValue()) == null || (value != obj2 && !value.equals(obj2))) ? false : true;
    }
    ...
    public final void forEach(Consumer consumer) {
        ...
        while (true) {
            ...
            if (a8 == null) {
                ...
                consumer.o(new k(a8.f32148b, a8.f32149c, this.f32137a));
            }
        }
    }
    ...
    public final boolean remove(Object obj) {
        ...
        Object key;
        Object value;
        return (obj instanceof Map.Entry) && (key = (entry = (Map.Entry) obj).getKey()) != null && (value = entry.getValue()) != null && this.f32137a.remove(key, value);
    }
