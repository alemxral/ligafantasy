...
final class T1 implements V1, InterfaceC2970p2 {
    ...
    final /* synthetic */ LongBinaryOperator f32415c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public T1(long j8, LongBinaryOperator longBinaryOperator) {
        this.f32414b = j8;
        this.f32415c = longBinaryOperator;
    }
    ...
    public final void accept(long j8) {
        this.f32413a = this.f32415c.applyAsLong(this.f32413a, j8);
    }
    ...
    public final void f(V1 v12) {
        accept(((T1) v12).f32413a);
    }

    @Override // java.util.function.Supplier
    public final Object get() {
        return Long.valueOf(this.f32413a);
    }
