...
public final class C3010y1 extends C2896a3 implements L0, D0 {
    ...
    public final void h(Object[] objArr, int i8) {
        ...
        if (this.f32486c == 0) {
            System.arraycopy(this.f32464e, 0, objArr, i8, this.f32485b);
            return;
        }
        for (int i9 = 0; i9 < this.f32486c; i9++) {
            Object[] objArr2 = this.f32465f[i9];
            System.arraycopy(objArr2, 0, objArr, i8, objArr2.length);
            i8 += this.f32465f[i9].length;
        }
        int i10 = this.f32485b;
        if (i10 > 0) {
            System.arraycopy(this.f32464e, 0, objArr, i8, i10);
        }
    }
