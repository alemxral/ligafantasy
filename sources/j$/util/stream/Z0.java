...
public final class Z0 extends Y0 implements A0 {
    ...
    public final F0 a() {
        ...
        throw new IllegalStateException(String.format("Current size %d is less than fixed size %d", Integer.valueOf(this.f32449b), Integer.valueOf(dArr.length)));
    }
    ...
    public final void j() {
        ...
        double[] dArr = this.f32448a;
        if (i8 < dArr.length) {
            throw new IllegalStateException(String.format("End size %d is less than fixed size %d", Integer.valueOf(this.f32449b), Integer.valueOf(dArr.length)));
        }
    }
    ...
    public final String toString() {
        double[] dArr = this.f32448a;
        return String.format("DoubleFixedNodeBuilder[%d][%s]", Integer.valueOf(dArr.length - this.f32449b), Arrays.toString(dArr));
    }
}
