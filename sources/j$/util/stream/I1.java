...
final class I1 extends W1 implements V1, InterfaceC2960n2 {
    ...
    final /* synthetic */ Supplier f32313b;

    /* renamed from: c, reason: collision with root package name */
    final /* synthetic */ ObjDoubleConsumer f32314c;

    /* renamed from: d, reason: collision with root package name */
    final /* synthetic */ BinaryOperator f32315d;

    /* JADX INFO: Access modifiers changed from: package-private */
    public I1(Supplier supplier, ObjDoubleConsumer objDoubleConsumer, BinaryOperator binaryOperator) {
        this.f32313b = supplier;
        this.f32314c = objDoubleConsumer;
        this.f32315d = binaryOperator;
    }

    @Override // j$.util.stream.InterfaceC2975q2
    public final void accept(double d8) {
        this.f32314c.accept(this.f32442a, d8);
    }
    ...
    public final void f(V1 v12) {
        this.f32442a = this.f32315d.apply(this.f32442a, ((I1) v12).f32442a);
    }
