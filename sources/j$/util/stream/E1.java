...
final class E1 implements V1, InterfaceC2960n2 {
    ...
    private double f32279a;

    /* renamed from: b, reason: collision with root package name */
    final /* synthetic */ double f32280b;

    /* renamed from: c, reason: collision with root package name */
    final /* synthetic */ DoubleBinaryOperator f32281c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public E1(double d8, DoubleBinaryOperator doubleBinaryOperator) {
        this.f32280b = d8;
        this.f32281c = doubleBinaryOperator;
    }

    @Override // j$.util.stream.InterfaceC2975q2
    public final void accept(double d8) {
        this.f32279a = this.f32281c.applyAsDouble(this.f32279a, d8);
    }
    ...
    public final void f(V1 v12) {
        accept(((E1) v12).f32279a);
    }

    @Override // java.util.function.Supplier
    public final Object get() {
        return Double.valueOf(this.f32279a);
    }
