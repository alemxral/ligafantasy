...
public final class Collectors {
    ...
    static final Set f32272a;

    /* renamed from: b, reason: collision with root package name */
    static final Set f32273b;
    ...
    static {
        ...
        f32272a = Collections.unmodifiableSet(EnumSet.of(enumC2932i3));
        Collections.unmodifiableSet(EnumSet.of(enumC2932i2, enumC2932i3));
        f32273b = Collections.emptySet();
    ...
    public static Collector<CharSequence, ?, String> joining(CharSequence charSequence) {
        return new C2957n(new C2892a(1, charSequence), new C2947l(24), new C2947l(25), new C2947l(26), f32273b);
    }
