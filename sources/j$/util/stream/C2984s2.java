...
public final class C2984s2 extends AbstractC2930h2 {
    ...
    final /* synthetic */ long f32602m;

    /* renamed from: n, reason: collision with root package name */
    final /* synthetic */ long f32603n;
    ...
    final L0 K(AbstractC2897b abstractC2897b, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (C8 > 0 && spliterator.hasCharacteristics(16384)) {
            return AbstractC3013z0.E(abstractC2897b, AbstractC3013z0.C(abstractC2897b.F(), spliterator, this.f32602m, this.f32603n), true, intFunction);
        }
        if (EnumC2916e3.ORDERED.r(abstractC2897b.G())) {
            return (L0) new A2(this, abstractC2897b, spliterator, intFunction, this.f32602m, this.f32603n).invoke();
        }
        Spliterator T7 = abstractC2897b.T(spliterator);
        long j10 = this.f32602m;
        long j11 = this.f32603n;
        if (j10 <= C8) {
    ...
    final Spliterator L(AbstractC2897b abstractC2897b, Spliterator spliterator) {
        ...
        if (EnumC2916e3.ORDERED.r(abstractC2897b.G())) {
            return ((L0) new A2(this, abstractC2897b, spliterator, new C2918f0(8), this.f32602m, this.f32603n).invoke()).spliterator();
        }
        Spliterator T8 = abstractC2897b.T(spliterator);
        long j12 = this.f32602m;
        if (j12 <= C8) {
            long j13 = C8 - j12;
            if (j10 >= 0) {
