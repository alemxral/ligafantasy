...
public final /* synthetic */ class C2892a implements Supplier, Consumer, BooleanSupplier, DoubleFunction, Function, LongFunction {
    ...
    public void accept(Object obj) {
        switch (this.f32459a) {
            case 2:
                ((InterfaceC2975q2) this.f32460b).accept((InterfaceC2975q2) obj);
                return;
            default:
                ((List) this.f32460b).add(obj);
                return;
        }
    }
    ...
    public Object apply(double d8) {
        Object apply = ((DoubleFunction) this.f32460b).apply(d8);
        if (apply == null) {
            return null;
        }
    ...
    public Object apply(long j8) {
        Object apply = ((LongFunction) this.f32460b).apply(j8);
        if (apply == null) {
            return null;
        }
    ...
    public Object apply(Object obj) {
        Object apply = ((Function) this.f32460b).apply(obj);
        if (apply == null) {
            return null;
        }
    ...
    public Object get() {
        switch (this.f32459a) {
            case 0:
                return ((AbstractC2897b) this.f32460b).I();
            case 1:
                Set set = Collectors.f32272a;
                return new j$.util.v0((CharSequence) this.f32460b);
            default:
                return (Spliterator) this.f32460b;
        }
    }
    ...
    public boolean getAsBoolean() {
        switch (this.f32459a) {
            case 3:
                C2971p3 c2971p3 = (C2971p3) this.f32460b;
                return c2971p3.f32534d.tryAdvance(c2971p3.f32535e);
            case 4:
                C2980r3 c2980r3 = (C2980r3) this.f32460b;
                return c2980r3.f32534d.tryAdvance(c2980r3.f32535e);
            case 5:
                C2990t3 c2990t3 = (C2990t3) this.f32460b;
                return c2990t3.f32534d.tryAdvance(c2990t3.f32535e);
            default:
                I3 i32 = (I3) this.f32460b;
                return i32.f32534d.tryAdvance(i32.f32535e);
        }
    }
}
