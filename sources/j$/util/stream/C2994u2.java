...
public final class C2994u2 extends AbstractC2903c0 {
    ...
    final /* synthetic */ long f32615m;

    /* renamed from: n, reason: collision with root package name */
    final /* synthetic */ long f32616n;
    ...
    final L0 K(AbstractC2897b abstractC2897b, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (C8 > 0 && spliterator.hasCharacteristics(16384)) {
            return AbstractC3013z0.G(abstractC2897b, AbstractC3013z0.C(abstractC2897b.F(), spliterator, this.f32615m, this.f32616n), true);
        }
        if (EnumC2916e3.ORDERED.r(abstractC2897b.G())) {
            return (L0) new A2(this, abstractC2897b, spliterator, intFunction, this.f32615m, this.f32616n).invoke();
        }
        j$.util.Z z8 = (j$.util.Z) abstractC2897b.T(spliterator);
        long j10 = this.f32615m;
        long j11 = this.f32616n;
        if (j10 <= C8) {
    ...
    final Spliterator L(AbstractC2897b abstractC2897b, Spliterator spliterator) {
        ...
        long j9;
        long C8 = abstractC2897b.C(spliterator);
        long j10 = this.f32616n;
        if (C8 > 0 && spliterator.hasCharacteristics(16384)) {
            j$.util.Z z8 = (j$.util.Z) abstractC2897b.T(spliterator);
            long j11 = this.f32615m;
            return new x3(z8, j11, AbstractC3013z0.B(j11, j10));
        }
        if (EnumC2916e3.ORDERED.r(abstractC2897b.G())) {
            return ((L0) new A2(this, abstractC2897b, spliterator, new C2918f0(10), this.f32615m, this.f32616n).invoke()).spliterator();
        }
        j$.util.Z z9 = (j$.util.Z) abstractC2897b.T(spliterator);
        long j12 = this.f32615m;
        if (j12 <= C8) {
            long j13 = C8 - j12;
            if (j10 >= 0) {
