...
final class P1 implements V1, InterfaceC2965o2 {
    ...
    final /* synthetic */ IntBinaryOperator f32368c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public P1(int i8, IntBinaryOperator intBinaryOperator) {
        this.f32367b = i8;
        this.f32368c = intBinaryOperator;
    }
    ...
    public final void accept(int i8) {
        this.f32366a = this.f32368c.applyAsInt(this.f32366a, i8);
    }
    ...
    public final void f(V1 v12) {
        accept(((P1) v12).f32366a);
    }

    @Override // java.util.function.Supplier
    public final Object get() {
        return Integer.valueOf(this.f32366a);
    }
