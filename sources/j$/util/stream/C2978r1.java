...
public final class C2978r1 extends C2974q1 implements C0 {
    ...
    public final J0 a() {
        ...
        throw new IllegalStateException(String.format("Current size %d is less than fixed size %d", Integer.valueOf(this.f32593b), Integer.valueOf(jArr.length)));
    }
    ...
    public final void j() {
        ...
        long[] jArr = this.f32592a;
        if (i8 < jArr.length) {
            throw new IllegalStateException(String.format("End size %d is less than fixed size %d", Integer.valueOf(this.f32593b), Integer.valueOf(jArr.length)));
        }
    }
    ...
    public final String toString() {
        long[] jArr = this.f32592a;
        return String.format("LongFixedNodeBuilder[%d][%s]", Integer.valueOf(jArr.length - this.f32593b), Arrays.toString(jArr));
    }
}
