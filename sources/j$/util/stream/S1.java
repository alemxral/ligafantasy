...
final class S1 extends W1 implements V1, InterfaceC2965o2 {
    ...
    final /* synthetic */ Supplier f32401b;

    /* renamed from: c, reason: collision with root package name */
    final /* synthetic */ ObjIntConsumer f32402c;

    /* renamed from: d, reason: collision with root package name */
    final /* synthetic */ BinaryOperator f32403d;

    /* JADX INFO: Access modifiers changed from: package-private */
    public S1(Supplier supplier, ObjIntConsumer objIntConsumer, BinaryOperator binaryOperator) {
        this.f32401b = supplier;
        this.f32402c = objIntConsumer;
        this.f32403d = binaryOperator;
    }
    ...
    public final void accept(int i8) {
        this.f32402c.accept(this.f32442a, i8);
    }
    ...
    public final void f(V1 v12) {
        this.f32442a = this.f32403d.apply(this.f32442a, ((S1) v12).f32442a);
    }
