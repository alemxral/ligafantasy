...
public final class P0 implements L0 {
    ...
    private final Collection f32365a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public P0(Collection collection) {
        this.f32365a = collection;
    }
    ...
    public final long count() {
        return this.f32365a.size();
    }

    @Override // j$.util.stream.L0
    public final void forEach(Consumer consumer) {
        Collection.EL.a(this.f32365a, consumer);
    }
    ...
    public final Object[] n(IntFunction intFunction) {
        java.util.Collection collection = this.f32365a;
    ...
    public final Spliterator spliterator() {
        return Collection.EL.stream(this.f32365a).spliterator();
    }
