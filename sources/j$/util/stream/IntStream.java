...
public interface IntStream extends InterfaceC2927h {
    ...
    public final /* synthetic */ class VivifiedWrapper implements IntStream {
        ...
        /* renamed from: a */
        public final /* synthetic */ java.util.stream.IntStream f32316a;

        private /* synthetic */ VivifiedWrapper(java.util.stream.IntStream intStream) {
            this.f32316a = intStream;
        }
        ...
        public final /* synthetic */ IntStream a() {
            return convert(this.f32316a.filter(null));
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ G asDoubleStream() {
            return E.w(this.f32316a.asDoubleStream());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ InterfaceC2968p0 asLongStream() {
            return C2958n0.w(this.f32316a.asLongStream());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ j$.util.C average() {
            return AbstractC2877d.j(this.f32316a.average());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ Stream boxed() {
            return C2901b3.w(this.f32316a.boxed());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ IntStream c() {
            return convert(this.f32316a.map(null));
        }
        ...
        public final /* synthetic */ Object collect(Supplier supplier, ObjIntConsumer objIntConsumer, BiConsumer biConsumer) {
            return this.f32316a.collect(supplier, objIntConsumer, biConsumer);
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ long count() {
            return this.f32316a.count();
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ G d() {
            return E.w(this.f32316a.mapToDouble(null));
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ IntStream distinct() {
            return convert(this.f32316a.distinct());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ boolean e() {
            return this.f32316a.noneMatch(null);
        }

        public final /* synthetic */ boolean equals(Object obj) {
            java.util.stream.IntStream intStream = this.f32316a;
            if (obj instanceof VivifiedWrapper) {
                obj = ((VivifiedWrapper) obj).f32316a;
            }
        ...
        public final /* synthetic */ j$.util.D findAny() {
            return AbstractC2877d.k(this.f32316a.findAny());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ j$.util.D findFirst() {
            return AbstractC2877d.k(this.f32316a.findFirst());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ void forEach(IntConsumer intConsumer) {
            this.f32316a.forEach(intConsumer);
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ void forEachOrdered(IntConsumer intConsumer) {
            this.f32316a.forEachOrdered(intConsumer);
        }
        ...
        public final /* synthetic */ InterfaceC2968p0 i() {
            return C2958n0.w(this.f32316a.mapToLong(null));
        }

        @Override // j$.util.stream.InterfaceC2927h
        public final /* synthetic */ boolean isParallel() {
            return this.f32316a.isParallel();
        }
        ...
        public final /* synthetic */ Stream mapToObj(IntFunction intFunction) {
            return C2901b3.w(this.f32316a.mapToObj(intFunction));
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ j$.util.D max() {
            return AbstractC2877d.k(this.f32316a.max());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ j$.util.D min() {
            return AbstractC2877d.k(this.f32316a.min());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ boolean o() {
            return this.f32316a.anyMatch(null);
        }

        @Override // j$.util.stream.InterfaceC2927h
        public final /* synthetic */ InterfaceC2927h onClose(Runnable runnable) {
            return C2917f.w(this.f32316a.onClose(runnable));
        }

        @Override // j$.util.stream.IntStream, j$.util.stream.InterfaceC2927h, j$.util.stream.G
        public final /* synthetic */ IntStream parallel() {
            return convert(this.f32316a.parallel());
        }

        @Override // j$.util.stream.InterfaceC2927h, j$.util.stream.G
        public final /* synthetic */ InterfaceC2927h parallel() {
            return C2917f.w(this.f32316a.parallel());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ IntStream peek(IntConsumer intConsumer) {
            return convert(this.f32316a.peek(intConsumer));
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ boolean r() {
            return this.f32316a.allMatch(null);
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ int reduce(int i8, IntBinaryOperator intBinaryOperator) {
            return this.f32316a.reduce(i8, intBinaryOperator);
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ j$.util.D reduce(IntBinaryOperator intBinaryOperator) {
            return AbstractC2877d.k(this.f32316a.reduce(intBinaryOperator));
        }

        @Override // j$.util.stream.IntStream, j$.util.stream.InterfaceC2927h, j$.util.stream.G
        public final /* synthetic */ IntStream sequential() {
            return convert(this.f32316a.sequential());
        }

        @Override // j$.util.stream.InterfaceC2927h, j$.util.stream.G
        public final /* synthetic */ InterfaceC2927h sequential() {
            return C2917f.w(this.f32316a.sequential());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ IntStream skip(long j8) {
            return convert(this.f32316a.skip(j8));
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ IntStream sorted() {
            return convert(this.f32316a.sorted());
        }

        @Override // j$.util.stream.InterfaceC2927h
        public final /* synthetic */ Spliterator spliterator() {
            return j$.util.g0.a(this.f32316a.spliterator());
        }

        /* JADX WARN: Type inference failed for: r0v1, types: [java.util.Spliterator$OfInt] */
        @Override // j$.util.stream.IntStream, j$.util.stream.InterfaceC2927h
        public final /* synthetic */ j$.util.Z spliterator() {
            return j$.util.X.a(this.f32316a.spliterator());
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ int sum() {
            return this.f32316a.sum();
        }

        @Override // j$.util.stream.IntStream
        public final C3021y summaryStatistics() {
            this.f32316a.summaryStatistics();
            throw new Error("Java 8+ API desugaring (library desugaring) cannot convert from java.util.IntSummaryStatistics");
        }

        @Override // j$.util.stream.IntStream
        public final /* synthetic */ int[] toArray() {
            return this.f32316a.toArray();
        }

        @Override // j$.util.stream.InterfaceC2927h
        public final /* synthetic */ InterfaceC2927h unordered() {
            return C2917f.w(this.f32316a.unordered());
        }
    }
    ...
    public final /* synthetic */ class Wrapper implements java.util.stream.IntStream {
        ...
        public static /* synthetic */ java.util.stream.IntStream convert(IntStream intStream) {
            ...
            return intStream instanceof VivifiedWrapper ? ((VivifiedWrapper) intStream).f32316a : new Wrapper();
        }
