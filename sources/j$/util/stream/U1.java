...
final class U1 implements V1, InterfaceC2970p2 {
    ...
    final /* synthetic */ LongBinaryOperator f32433c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public U1(LongBinaryOperator longBinaryOperator) {
        this.f32433c = longBinaryOperator;
    }
    ...
    public final void accept(long j8) {
        if (this.f32431a) {
            ...
            j8 = this.f32433c.applyAsLong(this.f32432b, j8);
        }
        this.f32432b = j8;
    }
    ...
    public final Object get() {
        return this.f32431a ? j$.util.E.a() : j$.util.E.d(this.f32432b);
    }
