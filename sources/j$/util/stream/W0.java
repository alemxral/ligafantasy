...
abstract class W0 extends N0 implements K0 {
    ...
    public final void e(Object obj) {
        ((K0) this.f32346a).e(obj);
        ((K0) this.f32347b).e(obj);
    }
    ...
    public final void q(int i8, Object obj) {
        L0 l02 = this.f32346a;
        ((K0) l02).q(i8, obj);
        ((K0) this.f32347b).q(i8 + ((int) ((K0) l02).count()), obj);
    }

    public final String toString() {
        long count = count();
        String name = getClass().getName();
        return count < 32 ? String.format("%s[%s.%s]", name, this.f32346a, this.f32347b) : String.format("%s[size=%d]", name, Long.valueOf(count()));
    }
}
