...
final class C2923g0 extends AbstractC2950l2 {
    ...
    final /* synthetic */ AbstractC2897b f32530c;
    ...
    public final void accept(long j8) {
        switch (this.f32529b) {
            case 0:
                this.f32559a.accept((InterfaceC2975q2) ((LongFunction) ((C2996v) this.f32530c).f32618n).apply(j8));
                return;
            case 1:
                ((C3008y) this.f32530c).getClass();
                LongUnaryOperator longUnaryOperator = null;
                longUnaryOperator.applyAsLong(j8);
                throw null;
            case 2:
                ((C3004x) this.f32530c).getClass();
                LongToIntFunction longToIntFunction = null;
                longToIntFunction.applyAsInt(j8);
                throw null;
            case 3:
                ((A) this.f32530c).getClass();
            ...
            case 4:
                ...
                throw null;
            default:
                ((LongConsumer) ((C2938j0) this.f32530c).f32551n).accept(j8);
