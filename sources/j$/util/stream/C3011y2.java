...
public final class C3011y2 extends C {
    ...
    final /* synthetic */ long f32648m;

    /* renamed from: n, reason: collision with root package name */
    final /* synthetic */ long f32649n;
    ...
    final L0 K(AbstractC2897b abstractC2897b, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (C8 > 0 && spliterator.hasCharacteristics(16384)) {
            return AbstractC3013z0.F(abstractC2897b, AbstractC3013z0.C(abstractC2897b.F(), spliterator, this.f32648m, this.f32649n), true);
        }
        if (EnumC2916e3.ORDERED.r(abstractC2897b.G())) {
            return (L0) new A2(this, abstractC2897b, spliterator, intFunction, this.f32648m, this.f32649n).invoke();
        }
        j$.util.W w8 = (j$.util.W) abstractC2897b.T(spliterator);
        long j10 = this.f32648m;
        long j11 = this.f32649n;
        if (j10 <= C8) {
    ...
    final Spliterator L(AbstractC2897b abstractC2897b, Spliterator spliterator) {
        ...
        long j9;
        long C8 = abstractC2897b.C(spliterator);
        long j10 = this.f32649n;
        if (C8 > 0 && spliterator.hasCharacteristics(16384)) {
            j$.util.W w8 = (j$.util.W) abstractC2897b.T(spliterator);
            long j11 = this.f32648m;
            return new x3(w8, j11, AbstractC3013z0.B(j11, j10));
        }
        if (EnumC2916e3.ORDERED.r(abstractC2897b.G())) {
            return ((L0) new A2(this, abstractC2897b, spliterator, new C2918f0(12), this.f32648m, this.f32649n).invoke()).spliterator();
        }
        j$.util.W w9 = (j$.util.W) abstractC2897b.T(spliterator);
        long j12 = this.f32648m;
        if (j12 <= C8) {
            long j13 = C8 - j12;
            if (j10 >= 0) {
