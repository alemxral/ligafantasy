...
public final class C3003w2 extends AbstractC2948l0 {
    ...
    final /* synthetic */ long f32631m;

    /* renamed from: n, reason: collision with root package name */
    final /* synthetic */ long f32632n;
    ...
    final L0 K(AbstractC2897b abstractC2897b, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (C8 > 0 && spliterator.hasCharacteristics(16384)) {
            return AbstractC3013z0.H(abstractC2897b, AbstractC3013z0.C(abstractC2897b.F(), spliterator, this.f32631m, this.f32632n), true);
        }
        if (EnumC2916e3.ORDERED.r(abstractC2897b.G())) {
            return (L0) new A2(this, abstractC2897b, spliterator, intFunction, this.f32631m, this.f32632n).invoke();
        }
        j$.util.c0 c0Var = (j$.util.c0) abstractC2897b.T(spliterator);
        long j10 = this.f32631m;
        long j11 = this.f32632n;
        if (j10 <= C8) {
    ...
    final Spliterator L(AbstractC2897b abstractC2897b, Spliterator spliterator) {
        ...
        if (C8 > 0 && spliterator.hasCharacteristics(16384)) {
            j$.util.c0 c0Var = (j$.util.c0) abstractC2897b.T(spliterator);
            long j11 = this.f32631m;
            return new x3(c0Var, j11, AbstractC3013z0.B(j11, j10));
        }
        if (EnumC2916e3.ORDERED.r(abstractC2897b.G())) {
            return ((L0) new A2(this, abstractC2897b, spliterator, new C2918f0(11), this.f32631m, this.f32632n).invoke()).spliterator();
        }
        j$.util.c0 c0Var2 = (j$.util.c0) abstractC2897b.T(spliterator);
        long j12 = this.f32631m;
        if (j12 <= C8) {
            long j13 = C8 - j12;
            if (j10 >= 0) {
