...
abstract class AbstractC2935i2 extends AbstractC2897b implements Stream {
    ...
    public final Stream b(C2892a c2892a) {
        ...
        return new C2920f2(this, EnumC2916e3.f32511p | EnumC2916e3.f32509n | EnumC2916e3.f32515t, c2892a, 1);
    }
    ...
    public final Stream distinct() {
        return new AbstractC2930h2(this, EnumC2916e3.f32508m | EnumC2916e3.f32515t, 0);
    }
    ...
    public final Stream dropWhile(Predicate predicate) {
        ...
        return new Q3(this, U3.f32436b, predicate);
    }

    @Override // j$.util.stream.Stream
    public final Stream filter(Predicate predicate) {
        Objects.requireNonNull(predicate);
        return new C2996v(this, EnumC2916e3.f32515t, predicate, 4);
    }

    @Override // j$.util.stream.Stream
    public final j$.util.B findAny() {
        return (j$.util.B) z(L.f32330d);
    }

    @Override // j$.util.stream.Stream
    public final j$.util.B findFirst() {
        return (j$.util.B) z(L.f32329c);
    }
    ...
    public final InterfaceC2968p0 k(C2892a c2892a) {
        Objects.requireNonNull(c2892a);
        return new C2938j0(this, EnumC2916e3.f32511p | EnumC2916e3.f32509n | EnumC2916e3.f32515t, c2892a, 2);
    }
    ...
    public final Stream map(Function function) {
        ...
        return new C2920f2(this, EnumC2916e3.f32511p | EnumC2916e3.f32509n, function, 0);
    }

    @Override // j$.util.stream.Stream
    public final G mapToDouble(ToDoubleFunction toDoubleFunction) {
        Objects.requireNonNull(toDoubleFunction);
        return new C3000w(this, EnumC2916e3.f32511p | EnumC2916e3.f32509n, toDoubleFunction, 3);
    }

    @Override // j$.util.stream.Stream
    public final IntStream mapToInt(ToIntFunction toIntFunction) {
        Objects.requireNonNull(toIntFunction);
        return new Y(this, EnumC2916e3.f32511p | EnumC2916e3.f32509n, toIntFunction, 2);
    }

    @Override // j$.util.stream.Stream
    public final InterfaceC2968p0 mapToLong(ToLongFunction toLongFunction) {
        Objects.requireNonNull(toLongFunction);
        return new C2938j0(this, EnumC2916e3.f32511p | EnumC2916e3.f32509n, toLongFunction, 3);
    }
    ...
    public final IntStream p(C2892a c2892a) {
        Objects.requireNonNull(c2892a);
        return new Y(this, EnumC2916e3.f32511p | EnumC2916e3.f32509n | EnumC2916e3.f32515t, c2892a, 3);
    }
    ...
    public final Stream takeWhile(Predicate predicate) {
        int i8 = U3.f32435a;
        Objects.requireNonNull(predicate);
        return new O3(this, U3.f32435a, predicate);
    }
    ...
    public final G v(C2892a c2892a) {
        Objects.requireNonNull(c2892a);
        return new C3000w(this, EnumC2916e3.f32511p | EnumC2916e3.f32509n | EnumC2916e3.f32515t, c2892a, 4);
    }
}
