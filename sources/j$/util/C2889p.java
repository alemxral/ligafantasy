...
public class C2889p extends C2887n implements java.util.List, List {
    ...
    private Object readResolve() {
        java.util.List list = this.f32237b;
    ...
    public final boolean equals(Object obj) {
        return obj == this || this.f32237b.equals(obj);
    }

    @Override // java.util.List
    public final Object get(int i8) {
        return this.f32237b.get(i8);
    }
    ...
    public final int indexOf(Object obj) {
        return this.f32237b.indexOf(obj);
    }

    @Override // java.util.List
    public final int lastIndexOf(Object obj) {
        return this.f32237b.lastIndexOf(obj);
    }
    ...
    public java.util.List subList(int i8, int i9) {
        return new C2889p(this.f32237b.subList(i8, i9));
    }
}
