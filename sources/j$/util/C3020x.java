...
public final class C3020x implements DoubleConsumer {
    ...
    private double f32684a;

    /* renamed from: b, reason: collision with root package name */
    private double f32685b;
    private long count;
    private double sum;
    ...
    private void c(double d8) {
        double d9 = d8 - this.f32684a;
        double d10 = this.sum;
        double d11 = d10 + d9;
        this.f32684a = (d11 - d10) - d9;
        this.sum = d11;
    }
    ...
    public final String toString() {
        ...
        double d9 = this.sum + this.f32684a;
        if (Double.isNaN(d9) && Double.isInfinite(this.f32685b)) {
            d9 = this.f32685b;
        }
        Double valueOf2 = Double.valueOf(d9);
        Double valueOf3 = Double.valueOf(this.min);
        if (this.count > 0) {
            double d10 = this.sum + this.f32684a;
            if (Double.isNaN(d10) && Double.isInfinite(this.f32685b)) {
                d10 = this.f32685b;
            }
            d8 = d10 / this.count;
        } else {
