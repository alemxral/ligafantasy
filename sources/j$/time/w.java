...
public final class w implements j$.time.temporal.m, j$.time.temporal.p, Comparable, Serializable {
    ...
    private long D() {
        return ((this.f32034a * 12) + this.f32035b) - 1;
    }
    ...
    private w I(int i8, int i9) {
        return (this.f32034a == i8 && this.f32035b == i9) ? this : new w(i8, i9);
    }
    ...
    public final w e(long j8, j$.time.temporal.u uVar) {
        ...
        switch (v.f32033b[((j$.time.temporal.b) uVar).ordinal()]) {
            case 1:
                return F(j8);
            case 2:
                return G(j8);
    ...
    public final w F(long j8) {
        ...
        long j9 = (this.f32034a * 12) + (this.f32035b - 1) + j8;
        long j10 = 12;
    ...
    public final w G(long j8) {
        return j8 == 0 ? this : I(j$.time.temporal.a.YEAR.z(this.f32034a + j8), this.f32035b);
    }
    ...
    public final void K(DataOutput dataOutput) {
        dataOutput.writeInt(this.f32034a);
        dataOutput.writeByte(this.f32035b);
    }

    @Override // java.lang.Comparable
    public final int compareTo(Object obj) {
        w wVar = (w) obj;
        int i8 = this.f32034a - wVar.f32034a;
        return i8 == 0 ? this.f32035b - wVar.f32035b : i8;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        w wVar = (w) obj;
        return this.f32034a == wVar.f32034a && this.f32035b == wVar.f32035b;
    }
    ...
    public final int hashCode() {
        return (this.f32035b << 27) ^ this.f32034a;
    }
    ...
    public final j$.time.temporal.w m(j$.time.temporal.r rVar) {
        if (rVar == j$.time.temporal.a.YEAR_OF_ERA) {
            return j$.time.temporal.w.j(1L, this.f32034a <= 0 ? C.NANOS_PER_SECOND : 999999999L);
        }
    ...
    public final long r(j$.time.temporal.r rVar) {
        ...
        int i8 = v.f32032a[((j$.time.temporal.a) rVar).ordinal()];
        if (i8 == 1) {
            return this.f32035b;
        }
        if (i8 == 2) {
    ...
    public final Object u(j$.time.temporal.t tVar) {
        return tVar == j$.time.temporal.n.e() ? j$.time.chrono.t.f31895d : tVar == j$.time.temporal.n.i() ? j$.time.temporal.b.MONTHS : j$.time.temporal.n.c(this, tVar);
    }
