...
public final class u implements j$.time.temporal.m, j$.time.temporal.p, Comparable, Serializable {
    ...
    public static final /* synthetic */ int f32030b = 0;
    ...
    public final u e(long j8, j$.time.temporal.u uVar) {
        ...
        int i8 = t.f31997b[((j$.time.temporal.b) uVar).ordinal()];
        if (i8 == 1) {
            return F(j8);
        }
        if (i8 == 2) {
    ...
    public final u F(long j8) {
        return j8 == 0 ? this : D(j$.time.temporal.a.YEAR.z(this.f32031a + j8));
    }
    ...
    public final void H(DataOutput dataOutput) {
        dataOutput.writeInt(this.f32031a);
    }

    @Override // java.lang.Comparable
    public final int compareTo(Object obj) {
        return this.f32031a - ((u) obj).f32031a;
    }
    ...
    public final j$.time.temporal.w m(j$.time.temporal.r rVar) {
        if (rVar == j$.time.temporal.a.YEAR_OF_ERA) {
            return j$.time.temporal.w.j(1L, this.f32031a <= 0 ? C.NANOS_PER_SECOND : 999999999L);
        }
    ...
    public final long r(j$.time.temporal.r rVar) {
        ...
        int i8 = t.f31996a[((j$.time.temporal.a) rVar).ordinal()];
        int i9 = this.f32031a;
        if (i8 == 1) {
            if (i9 < 1) {
                i9 = 1 - i9;
    ...
    public final String toString() {
        return Integer.toString(this.f32031a);
    }

    @Override // j$.time.temporal.o
    public final Object u(j$.time.temporal.t tVar) {
        return tVar == j$.time.temporal.n.e() ? j$.time.chrono.t.f31895d : tVar == j$.time.temporal.n.i() ? j$.time.temporal.b.YEARS : j$.time.temporal.n.c(this, tVar);
    }
    ...
    public final j$.time.temporal.m v(j$.time.temporal.m mVar) {
        ...
        return mVar.d(this.f32031a, j$.time.temporal.a.YEAR);
    }
