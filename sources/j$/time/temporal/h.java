...
abstract class h implements r {
    ...
    private static final int[] f32004a;

    /* renamed from: b, reason: collision with root package name */
    private static final /* synthetic */ h[] f32005b;
    ...
    static {
        h hVar = new h() { // from class: j$.time.temporal.d
            ...
            public final boolean m(o oVar) {
                if (oVar.f(a.DAY_OF_YEAR) && oVar.f(a.MONTH_OF_YEAR) && oVar.f(a.YEAR)) {
                    r rVar = j.f32008a;
                    if (((AbstractC2862a) AbstractC2870i.p(oVar)).equals(j$.time.chrono.t.f31895d)) {
                        return true;
                    }
                }
                return false;
        ...
        f32005b = new h[]{hVar, hVar2, hVar3, hVar4};
        f32004a = new int[]{0, 90, 181, 273, 0, 91, 182, 274};
    }
