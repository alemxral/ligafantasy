...
public final class LocalDateTime implements j$.time.temporal.m, j$.time.temporal.p, InterfaceC2866e, Serializable {
    ...
    public static final LocalDateTime f31829c = O(h.f31965d, k.f31973e);

    /* renamed from: d, reason: collision with root package name */
    public static final LocalDateTime f31830d = O(h.f31966e, k.f31974f);
    ...
    private int D(LocalDateTime localDateTime) {
        int D8 = this.f31831a.D(localDateTime.f31831a);
        return D8 == 0 ? this.f31832b.compareTo(localDateTime.f31832b) : D8;
    }
    ...
    private LocalDateTime W(h hVar, k kVar) {
        return (this.f31831a == hVar && this.f31832b == kVar) ? this : new LocalDateTime(hVar, kVar);
    }
    ...
    public final int F() {
        return this.f31831a.H();
    }

    public final int G() {
        return this.f31831a.K();
    }

    public final int H() {
        return this.f31832b.I();
    }

    public final int I() {
        return this.f31832b.J();
    }

    public final int J() {
        return this.f31831a.L();
    }
    ...
    public final boolean K(LocalDateTime localDateTime) {
        ...
        long s8 = this.f31831a.s();
        long s9 = localDateTime.f31831a.s();
        return s8 > s9 || (s8 == s9 && this.f31832b.U() > localDateTime.f31832b.U());
    }
    ...
    public final LocalDateTime e(long j8, j$.time.temporal.u uVar) {
        ...
        int i8 = i.f31970a[((j$.time.temporal.b) uVar).ordinal()];
        k kVar = this.f31832b;
        h hVar = this.f31831a;
        switch (i8) {
            case 1:
                return S(this.f31831a, 0L, 0L, 0L, j8);
            case 2:
                LocalDateTime W7 = W(hVar.T(j8 / 86400000000L), kVar);
                return W7.S(W7.f31831a, 0L, 0L, 0L, (j8 % 86400000000L) * 1000);
            case 3:
                LocalDateTime W8 = W(hVar.T(j8 / 86400000), kVar);
                return W8.S(W8.f31831a, 0L, 0L, 0L, (j8 % 86400000) * 1000000);
            case 4:
                return R(j8);
            case 5:
                return S(this.f31831a, 0L, j8, 0L, 0L);
            case 6:
                return S(this.f31831a, j8, 0L, 0L, 0L);
            case 7:
                LocalDateTime W9 = W(hVar.T(j8 / 256), kVar);
                return W9.S(W9.f31831a, (j8 % 256) * 12, 0L, 0L, 0L);
            default:
    ...
    public final LocalDateTime R(long j8) {
        return S(this.f31831a, 0L, 0L, j8, 0L);
    }
    ...
    public final LocalDateTime V(h hVar) {
        return W(hVar, this.f31832b);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void X(DataOutput dataOutput) {
        this.f31831a.b0(dataOutput);
        this.f31832b.Y(dataOutput);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f31831a.equals(localDateTime.f31831a) && this.f31832b.equals(localDateTime.f31832b);
    }
    ...
    public final int hashCode() {
        return this.f31831a.hashCode() ^ this.f31832b.hashCode();
    }

    @Override // j$.time.temporal.o
    public final int j(j$.time.temporal.r rVar) {
        return rVar instanceof j$.time.temporal.a ? ((j$.time.temporal.a) rVar).E() ? this.f31832b.j(rVar) : this.f31831a.j(rVar) : j$.time.temporal.n.a(this, rVar);
    }
    ...
    public final long r(j$.time.temporal.r rVar) {
        return rVar instanceof j$.time.temporal.a ? ((j$.time.temporal.a) rVar).E() ? this.f31832b.r(rVar) : this.f31831a.r(rVar) : rVar.l(this);
    }

    public final String toString() {
        return this.f31831a.toString() + ExifInterface.GPS_DIRECTION_TRUE + this.f31832b.toString();
    }

    @Override // j$.time.temporal.o
    public final Object u(j$.time.temporal.t tVar) {
        return tVar == j$.time.temporal.n.f() ? this.f31831a : AbstractC2870i.k(this, tVar);
    }
