...
public final class h implements j$.time.temporal.m, j$.time.temporal.p, InterfaceC2863b, Serializable {
    ...
    public static final h f31965d = P(-999999999, 1, 1);

    /* renamed from: e, reason: collision with root package name */
    public static final h f31966e = P(999999999, 12, 31);
    ...
    private final short f31968b;

    /* renamed from: c, reason: collision with root package name */
    private final short f31969c;
    ...
    private h(int i8, int i9, int i10) {
        this.f31967a = i8;
        this.f31968b = (short) i9;
        this.f31969c = (short) i10;
    }
    ...
    private static h E(int i8, int i9, int i10) {
        ...
        if (i10 > 28) {
            if (i9 != 2) {
                ...
                j$.time.chrono.t.f31895d.getClass();
    ...
    private int G(j$.time.temporal.r rVar) {
        int i8;
        int i9 = g.f31963a[((j$.time.temporal.a) rVar).ordinal()];
        short s8 = this.f31969c;
    ...
    public final int D(h hVar) {
        int i8 = this.f31967a - hVar.f31967a;
        if (i8 != 0) {
            return i8;
        }
        int i9 = this.f31968b - hVar.f31968b;
        return i9 == 0 ? this.f31969c - hVar.f31969c : i9;
    }
    ...
    public final int J() {
        return (m.G(this.f31968b).D(N()) + this.f31969c) - 1;
    }
    ...
    public final boolean N() {
        j$.time.chrono.t tVar = j$.time.chrono.t.f31895d;
        long j8 = this.f31967a;
        tVar.getClass();
        return j$.time.chrono.t.m(j8);
    }

    public final int O() {
        short s8 = this.f31968b;
    ...
    public final h e(long j8, j$.time.temporal.u uVar) {
        ...
        switch (g.f31964b[((j$.time.temporal.b) uVar).ordinal()]) {
            case 1:
                return T(j8);
            case 2:
    ...
    public final h U(long j8) {
        ...
        long j9 = (this.f31967a * 12) + (this.f31968b - 1) + j8;
        long j10 = 12;
        return W(j$.time.temporal.a.YEAR.z(j$.com.android.tools.r8.a.k(j9, j10)), ((int) j$.com.android.tools.r8.a.j(j9, j10)) + 1, this.f31969c);
    }

    public final h V(long j8) {
        return j8 == 0 ? this : W(j$.time.temporal.a.YEAR.z(this.f31967a + j8), this.f31968b, this.f31969c);
    }
    ...
    public final h d(long j8, j$.time.temporal.r rVar) {
        ...
        aVar.D(j8);
        int i8 = g.f31963a[aVar.ordinal()];
        short s8 = this.f31969c;
        short s9 = this.f31968b;
        int i9 = this.f31967a;
        switch (i8) {
            case 1:
                int i10 = (int) j8;
    ...
    public final j$.time.chrono.m a() {
        return j$.time.chrono.t.f31895d;
    }
    ...
    public final h a0(int i8) {
        ...
        j$.time.temporal.a.YEAR.D(i8);
        return W(i8, this.f31968b, this.f31969c);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void b0(DataOutput dataOutput) {
        dataOutput.writeInt(this.f31967a);
        dataOutput.writeByte(this.f31968b);
        dataOutput.writeByte(this.f31969c);
    }
    ...
    public final int hashCode() {
        int i8 = this.f31967a;
        return (((i8 << 11) + (this.f31968b << 6)) + this.f31969c) ^ (i8 & (-2048));
    }
    ...
    public final j$.time.temporal.w m(j$.time.temporal.r rVar) {
        ...
        if (i8 == 3) {
            return j$.time.temporal.w.j(1L, (m.G(this.f31968b) != m.FEBRUARY || N()) ? 5L : 4L);
        }
        if (i8 != 4) {
            return ((j$.time.temporal.a) rVar).j();
        }
        return j$.time.temporal.w.j(1L, this.f31967a <= 0 ? C.NANOS_PER_SECOND : 999999999L);
    }

    @Override // j$.time.temporal.o
    public final long r(j$.time.temporal.r rVar) {
        return rVar instanceof j$.time.temporal.a ? rVar == j$.time.temporal.a.EPOCH_DAY ? s() : rVar == j$.time.temporal.a.PROLEPTIC_MONTH ? ((this.f31967a * 12) + this.f31968b) - 1 : G(rVar) : rVar.l(this);
    }

    @Override // j$.time.chrono.InterfaceC2863b
    public final long s() {
        long j8 = this.f31967a;
        long j9 = this.f31968b;
        long j10 = 365 * j8;
        long j11 = (((367 * j9) - 362) / 12) + (j8 >= 0 ? ((j8 + 399) / 400) + (((3 + j8) / 4) - ((99 + j8) / 100)) + j10 : j10 - ((j8 / (-400)) + ((j8 / (-4)) - (j8 / (-100))))) + (this.f31969c - 1);
        if (j9 > 2) {
            j11 = !N() ? j11 - 2 : j11 - 1;
        }
        return j11 - 719528;
