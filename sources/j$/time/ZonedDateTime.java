...
public final class ZonedDateTime implements j$.time.temporal.m, ChronoZonedDateTime<h>, Serializable {
    ...
    private final LocalDateTime f31842a;

    /* renamed from: b, reason: collision with root package name */
    private final ZoneOffset f31843b;

    /* renamed from: c, reason: collision with root package name */
    private final ZoneId f31844c;

    private ZonedDateTime(LocalDateTime localDateTime, ZoneId zoneId, ZoneOffset zoneOffset) {
        this.f31842a = localDateTime;
        this.f31843b = zoneOffset;
        this.f31844c = zoneId;
    }
    ...
    public static ZonedDateTime now(ZoneId zoneId) {
        Objects.requireNonNull(zoneId, "zone");
        a aVar = zoneId == ZoneOffset.UTC ? a.f31845b : new a(zoneId);
        Objects.requireNonNull(aVar, "clock");
        aVar.getClass();
        return ofInstant(Instant.ofEpochMilli(System.currentTimeMillis()), aVar.c());
    }
    ...
    public final ZonedDateTime e(long j8, j$.time.temporal.u uVar) {
        ...
        ZoneOffset zoneOffset = this.f31843b;
        ZoneId zoneId = this.f31844c;
        LocalDateTime localDateTime = this.f31842a;
    ...
    public final ZonedDateTime l(h hVar) {
        return E(LocalDateTime.O(hVar, this.f31842a.b()), this.f31844c, this.f31843b);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void J(DataOutput dataOutput) {
        this.f31842a.X(dataOutput);
        this.f31843b.P(dataOutput);
        this.f31844c.H(dataOutput);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f31842a.equals(zonedDateTime.f31842a) && this.f31843b.equals(zonedDateTime.f31843b) && this.f31844c.equals(zonedDateTime.f31844c);
    }
    ...
    public final ChronoZonedDateTime h(ZoneId zoneId) {
        Objects.requireNonNull(zoneId, "zone");
        return this.f31844c.equals(zoneId) ? this : E(this.f31842a, zoneId, this.f31843b);
    }

    public final int hashCode() {
        return (this.f31842a.hashCode() ^ this.f31843b.hashCode()) ^ Integer.rotateLeft(this.f31844c.hashCode(), 3);
    }
    ...
    public final int j(j$.time.temporal.r rVar) {
        ...
        int i8 = y.f32039a[((j$.time.temporal.a) rVar).ordinal()];
        if (i8 != 1) {
            return i8 != 2 ? this.f31842a.j(rVar) : this.f31843b.J();
        }
    ...
    public final j$.time.temporal.w m(j$.time.temporal.r rVar) {
        return rVar instanceof j$.time.temporal.a ? (rVar == j$.time.temporal.a.INSTANT_SECONDS || rVar == j$.time.temporal.a.OFFSET_SECONDS) ? ((j$.time.temporal.a) rVar).j() : this.f31842a.m(rVar) : rVar.u(this);
    }
    ...
    public final long r(j$.time.temporal.r rVar) {
        ...
        int i8 = y.f32039a[((j$.time.temporal.a) rVar).ordinal()];
        return i8 != 1 ? i8 != 2 ? this.f31842a.r(rVar) : this.f31843b.J() : AbstractC2870i.o(this);
    }
    ...
    public final String toString() {
        String localDateTime = this.f31842a.toString();
        ZoneOffset zoneOffset = this.f31843b;
    ...
    public final Object u(j$.time.temporal.t tVar) {
        return tVar == j$.time.temporal.n.f() ? this.f31842a.T() : AbstractC2870i.l(this, tVar);
    }
