...
public final class DateTimeFormatter {
    ...
    public static final DateTimeFormatter f31913f;

    /* renamed from: a, reason: collision with root package name */
    private final e f31914a;

    /* renamed from: b, reason: collision with root package name */
    private final Locale f31915b;

    /* renamed from: c, reason: collision with root package name */
    private final s f31916c;

    /* renamed from: d, reason: collision with root package name */
    private final j$.time.chrono.m f31917d;

    /* renamed from: e, reason: collision with root package name */
    private final ZoneId f31918e;
    ...
    static {
        ...
        nVar.k(aVar3, 2);
        t tVar = t.STRICT;
        j$.time.chrono.t tVar2 = j$.time.chrono.t.f31895d;
        ...
        n nVar12 = new n();
        nVar12.p();
        nVar12.l(j$.time.temporal.j.f32010c, 4, 10, uVar);
        nVar12.f("-W");
        nVar12.k(j$.time.temporal.j.f32009b, 2);
        nVar12.e('-');
    ...
    public DateTimeFormatter(e eVar, Locale locale, t tVar, j$.time.chrono.m mVar) {
        s sVar = s.f31959a;
        this.f31914a = (e) Objects.requireNonNull(eVar, "printerParser");
        this.f31915b = (Locale) Objects.requireNonNull(locale, "locale");
        this.f31916c = (s) Objects.requireNonNull(sVar, "decimalStyle");
        this.f31917d = mVar;
        this.f31918e = null;
    }
    ...
    public final String a(j$.time.temporal.o oVar) {
        ...
        try {
            this.f31914a.j(new p(oVar, this), sb);
            return sb.toString();
    ...
    public final String toString() {
        String eVar = this.f31914a.toString();
