...
public final class g extends i {
    ...
    public final i b() {
        ...
        return new g(this.f31928a, this.f31929b, this.f31930c, this.f31926g, -1);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // j$.time.format.i
    public final i c(int i8) {
        return new g(this.f31928a, this.f31929b, this.f31930c, this.f31926g, this.f31932e + i8);
    }
    ...
    public final boolean j(p pVar, StringBuilder sb) {
        ...
        boolean z8 = this.f31926g;
        int i8 = this.f31929b;
        if (scale != 0) {
            String substring = bigDecimal.setScale(Math.min(Math.max(bigDecimal.scale(), i8), this.f31930c), roundingMode).toPlainString().substring(2);
            b8.getClass();
            if (z8) {
                sb.append('.');
            }
    ...
    public final String toString() {
        return "Fraction(" + this.f31928a + "," + this.f31929b + "," + this.f31930c + (this.f31926g ? ",DecimalPoint" : "") + ")";
    }
}
