...
public final class j implements f {
    ...
    static final String[] f31933d = {"+HH", "+HHmm", "+HH:mm", "+HHMM", "+HH:MM", "+HHMMss", "+HH:MM:ss", "+HHMMSS", "+HH:MM:SS", "+HHmmss", "+HH:mm:ss", "+H", "+Hmm", "+H:mm", "+HMM", "+H:MM", "+HMMss", "+H:MM:ss", "+HMMSS", "+H:MM:SS", "+Hmmss", "+H:mm:ss"};

    /* renamed from: e, reason: collision with root package name */
    static final j f31934e = new j("+HH:MM:ss", "Z");
    ...
    public final String toString() {
        String replace = this.f31935a.replace("'", "''");
        return "Offset(" + f31933d[this.f31936b] + ",'" + replace + "')";
    }
}
