...
public final class k implements j$.time.temporal.m, j$.time.temporal.p, Comparable, Serializable {
    ...
    public static final k f31973e;

    /* renamed from: f, reason: collision with root package name */
    public static final k f31974f;

    /* renamed from: g, reason: collision with root package name */
    public static final k f31975g;

    /* renamed from: h, reason: collision with root package name */
    private static final k[] f31976h = new k[24];
    private static final long serialVersionUID = 6414437269572265201L;

    /* renamed from: a, reason: collision with root package name */
    private final byte f31977a;
    ...
    static {
        ...
        while (true) {
            ...
            if (i8 >= kVarArr.length) {
                ...
                k kVar2 = kVarArr[12];
                f31973e = kVar;
                f31974f = new k(23, 59, 59, 999999999);
                return;
            }
    ...
    private k(int i8, int i9, int i10, int i11) {
        this.f31977a = (byte) i8;
        this.f31978b = (byte) i9;
        this.f31979c = (byte) i10;
        this.f31980d = i11;
    }

    private static k E(int i8, int i9, int i10, int i11) {
        return ((i9 | i10) | i11) == 0 ? f31976h[i8] : new k(i8, i9, i10, i11);
    }
    ...
    private int G(j$.time.temporal.r rVar) {
        int i8 = j.f31971a[((j$.time.temporal.a) rVar).ordinal()];
        byte b8 = this.f31978b;
        int i9 = this.f31980d;
        byte b9 = this.f31977a;
        switch (i8) {
            case 1:
                return i9;
            case 2:
    ...
    public final int compareTo(k kVar) {
        int compare = Integer.compare(this.f31977a, kVar.f31977a);
        if (compare != 0) {
            return compare;
        }
        int compare2 = Integer.compare(this.f31978b, kVar.f31978b);
        if (compare2 != 0) {
            return compare2;
        }
        int compare3 = Integer.compare(this.f31979c, kVar.f31979c);
        return compare3 == 0 ? Integer.compare(this.f31980d, kVar.f31980d) : compare3;
    }
    ...
    public final k e(long j8, j$.time.temporal.u uVar) {
        ...
        switch (j.f31972b[((j$.time.temporal.b) uVar).ordinal()]) {
            case 1:
                return R(j8);
            case 2:
    ...
    public final k P(long j8) {
        ...
        return E(((((int) (j8 % 24)) + this.f31977a) + 24) % 24, this.f31978b, this.f31979c, this.f31980d);
    }
    ...
    public final k Q(long j8) {
        ...
        int i8 = (this.f31977a * 60) + this.f31978b;
        int i9 = ((((int) (j8 % 1440)) + i8) + 1440) % 1440;
        return i8 == i9 ? this : E(i9 / 60, i9 % 60, this.f31979c, this.f31980d);
    }
    ...
    public final k S(long j8) {
        ...
        int i8 = (this.f31978b * 60) + (this.f31977a * 3600) + this.f31979c;
        int i9 = ((((int) (j8 % 86400)) + i8) + 86400) % 86400;
        return i8 == i9 ? this : E(i9 / 3600, (i9 / 60) % 60, i9 % 60, this.f31980d);
    }

    public final long U() {
        return (this.f31979c * C.NANOS_PER_SECOND) + (this.f31978b * 60000000000L) + (this.f31977a * 3600000000000L) + this.f31980d;
    }

    public final int V() {
        return (this.f31978b * 60) + (this.f31977a * 3600) + this.f31979c;
    }
    ...
    public final k d(long j8, j$.time.temporal.r rVar) {
        ...
        aVar.D(j8);
        int i8 = j.f31971a[aVar.ordinal()];
        byte b8 = this.f31978b;
        byte b9 = this.f31979c;
        int i9 = this.f31980d;
        byte b10 = this.f31977a;
        switch (i8) {
            case 1:
                return X((int) j8);
            case 2:
    ...
    public final k X(int i8) {
        ...
        return E(this.f31977a, this.f31978b, this.f31979c, i8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void Y(DataOutput dataOutput) {
        int i8;
        byte b8 = this.f31979c;
        byte b9 = this.f31977a;
        byte b10 = this.f31978b;
        int i9 = this.f31980d;
        if (i9 != 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        k kVar = (k) obj;
        return this.f31977a == kVar.f31977a && this.f31978b == kVar.f31978b && this.f31979c == kVar.f31979c && this.f31980d == kVar.f31980d;
    }
    ...
    public final String toString() {
        ...
        byte b8 = this.f31977a;
        sb.append(b8 < 10 ? MBridgeConstans.ENDCARD_URL_TYPE_PL : "");
        sb.append((int) b8);
        byte b9 = this.f31978b;
        sb.append(b9 < 10 ? ":0" : ":");
        sb.append((int) b9);
        byte b10 = this.f31979c;
        int i9 = this.f31980d;
        if (b10 > 0 || i9 > 0) {
            sb.append(b10 < 10 ? ":0" : ":");
            sb.append((int) b10);
