...
public final class f implements Serializable {
    ...
    private static final long[] f32057i = new long[0];

    /* renamed from: j, reason: collision with root package name */
    private static final e[] f32058j = new e[0];

    /* renamed from: k, reason: collision with root package name */
    private static final LocalDateTime[] f32059k = new LocalDateTime[0];

    /* renamed from: l, reason: collision with root package name */
    private static final b[] f32060l = new b[0];
    ...
    private final ZoneOffset[] f32062b;

    /* renamed from: c, reason: collision with root package name */
    private final long[] f32063c;

    /* renamed from: d, reason: collision with root package name */
    private final LocalDateTime[] f32064d;

    /* renamed from: e, reason: collision with root package name */
    private final ZoneOffset[] f32065e;

    /* renamed from: f, reason: collision with root package name */
    private final e[] f32066f;

    /* renamed from: g, reason: collision with root package name */
    private final TimeZone f32067g;

    /* renamed from: h, reason: collision with root package name */
    private final transient ConcurrentHashMap f32068h = new ConcurrentHashMap();
    ...
    private f(ZoneOffset zoneOffset) {
        ...
        this.f32061a = jArr;
        this.f32063c = jArr;
        this.f32064d = f32059k;
        this.f32065e = zoneOffsetArr;
        this.f32066f = f32058j;
        this.f32067g = null;
    }
    ...
    public f(TimeZone timeZone) {
        ...
        this.f32065e = zoneOffsetArr;
        this.f32066f = f32058j;
        this.f32067g = timeZone;
    }

    private f(long[] jArr, ZoneOffset[] zoneOffsetArr, long[] jArr2, ZoneOffset[] zoneOffsetArr2, e[] eVarArr) {
        LocalDateTime l8;
        this.f32061a = jArr;
        this.f32062b = zoneOffsetArr;
        this.f32063c = jArr2;
        this.f32065e = zoneOffsetArr2;
        this.f32066f = eVarArr;
        if (jArr2.length == 0) {
            this.f32064d = f32059k;
        } else {
            ...
            this.f32064d = (LocalDateTime[]) arrayList.toArray(new LocalDateTime[arrayList.size()]);
        }
        this.f32067g = null;
    }
    ...
    private b[] b(int i8) {
        ...
        ConcurrentHashMap concurrentHashMap = this.f32068h;
        b[] bVarArr = (b[]) concurrentHashMap.get(valueOf);
        if (bVarArr != null) {
            return bVarArr;
        }
        TimeZone timeZone = this.f32067g;
        if (timeZone == null) {
            e[] eVarArr = this.f32066f;
        ...
        long n8 = AbstractC2870i.n(LocalDateTime.M(i8 - 1), this.f32062b[0]);
    ...
    private Object e(LocalDateTime localDateTime) {
        Object obj = null;
        ZoneOffset[] zoneOffsetArr = this.f32062b;
        int i8 = 0;
        TimeZone timeZone = this.f32067g;
        if (timeZone != null) {
        ...
        if (this.f32063c.length == 0) {
            return zoneOffsetArr[0];
        }
        int length2 = this.f32066f.length;
        LocalDateTime[] localDateTimeArr = this.f32064d;
        ...
        ZoneOffset[] zoneOffsetArr2 = this.f32065e;
        if (binarySearch == -1) {
    ...
    public static f k(DataInput dataInput) {
        ...
        e[] eVarArr = readByte == 0 ? f32058j : new e[readByte];
    ...
    private Object writeReplace() {
        return new a(this.f32067g != null ? (byte) 100 : (byte) 1, this);
    }
    ...
    public final ZoneOffset d(Instant instant) {
        ...
        long[] jArr = this.f32063c;
        if (jArr.length == 0) {
            return this.f32062b[0];
        }
        long E8 = instant.E();
        int length = this.f32066f.length;
        ZoneOffset[] zoneOffsetArr = this.f32065e;
    ...
    public final boolean equals(Object obj) {
        ...
        f fVar = (f) obj;
        return Objects.equals(this.f32067g, fVar.f32067g) && Arrays.equals(this.f32061a, fVar.f32061a) && Arrays.equals(this.f32062b, fVar.f32062b) && Arrays.equals(this.f32063c, fVar.f32063c) && Arrays.equals(this.f32065e, fVar.f32065e) && Arrays.equals(this.f32066f, fVar.f32066f);
    }
    ...
    public final int hashCode() {
        TimeZone timeZone = this.f32067g;
        return (((((timeZone != null ? timeZone.hashCode() : 0) ^ Arrays.hashCode(this.f32061a)) ^ Arrays.hashCode(this.f32062b)) ^ Arrays.hashCode(this.f32063c)) ^ Arrays.hashCode(this.f32065e)) ^ Arrays.hashCode(this.f32066f);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void l(DataOutput dataOutput) {
        long[] jArr = this.f32061a;
        dataOutput.writeInt(jArr.length);
        for (long j8 : jArr) {
            a.c(j8, dataOutput);
        }
        for (ZoneOffset zoneOffset : this.f32062b) {
            a.d(zoneOffset, dataOutput);
        }
        long[] jArr2 = this.f32063c;
        dataOutput.writeInt(jArr2.length);
        for (long j9 : jArr2) {
            a.c(j9, dataOutput);
        }
        for (ZoneOffset zoneOffset2 : this.f32065e) {
    ...
    public final void m(DataOutput dataOutput) {
        dataOutput.writeUTF(this.f32067g.getID());
    }
    ...
    public final String toString() {
        ...
        if (timeZone != null) {
            ...
            ZoneOffset zoneOffset = this.f32062b[r1.length - 1];
