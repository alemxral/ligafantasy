...
public final class ZoneOffset extends ZoneId implements j$.time.temporal.o, j$.time.temporal.p, Comparable<ZoneOffset>, Serializable {
    ...
    private final transient String f31841c;

    /* renamed from: d, reason: collision with root package name */
    private static final ConcurrentHashMap f31836d = new ConcurrentHashMap(16, 0.75f, 4);

    /* renamed from: e, reason: collision with root package name */
    private static final ConcurrentHashMap f31837e = new ConcurrentHashMap(16, 0.75f, 4);
    public static final ZoneOffset UTC = M(0);

    /* renamed from: f, reason: collision with root package name */
    public static final ZoneOffset f31838f = M(-64800);

    /* renamed from: g, reason: collision with root package name */
    public static final ZoneOffset f31839g = M(64800);
    ...
    */
    public static j$.time.ZoneOffset K(java.lang.String r7) {
        /*
            ...
            j$.util.concurrent.ConcurrentHashMap r0 = j$.time.ZoneOffset.f31837e
    ...
    public static ZoneOffset M(int i8) {
        ...
        ConcurrentHashMap concurrentHashMap = f31836d;
        ...
        f31837e.putIfAbsent(zoneOffset2.f31841c, zoneOffset2);
        return zoneOffset2;
    }
    ...
    public final int compareTo(ZoneOffset zoneOffset) {
        return zoneOffset.f31840b - this.f31840b;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ZoneOffset) {
            return this.f31840b == ((ZoneOffset) obj).f31840b;
        }
        return false;
    }
    ...
    public final j$.time.temporal.m v(j$.time.temporal.m mVar) {
        return mVar.d(this.f31840b, j$.time.temporal.a.OFFSET_SECONDS);
    }
}
