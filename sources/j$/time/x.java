...
public final class x extends ZoneId {
    ...
    public static final /* synthetic */ int f32036d = 0;
    ...
    private final transient j$.time.zone.f f32038c;
    ...
    public final j$.time.zone.f D() {
        j$.time.zone.f fVar = this.f32038c;
        return fVar != null ? fVar : j$.time.zone.j.a(this.f32037b, false);
    }
    ...
    public final void H(DataOutput dataOutput) {
        ...
        dataOutput.writeUTF(this.f32037b);
    }
