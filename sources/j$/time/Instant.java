...
public final class Instant implements j$.time.temporal.m, j$.time.temporal.p, Comparable<Instant>, Serializable {
    ...
    public static final Instant f31826c = new Instant(0, 0);
    ...
    private Instant I(long j8, long j9) {
        ...
        return H(j$.com.android.tools.r8.a.f(j$.com.android.tools.r8.a.f(this.f31827a, j8), j9 / C.NANOS_PER_SECOND), this.f31828b + (j9 % C.NANOS_PER_SECOND));
    }
    ...
    public final Instant e(long j8, j$.time.temporal.u uVar) {
        ...
        switch (f.f31912b[((j$.time.temporal.b) uVar).ordinal()]) {
            case 1:
                return I(0L, j8);
            case 2:
    ...
    public final void K(DataOutput dataOutput) {
        dataOutput.writeLong(this.f31827a);
        dataOutput.writeInt(this.f31828b);
    }
    ...
    public final int compareTo(Instant instant) {
        ...
        int compare = Long.compare(this.f31827a, instant2.f31827a);
        return compare != 0 ? compare : this.f31828b - instant2.f31828b;
    }
    ...
    */
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f31827a == instant.f31827a && this.f31828b == instant.f31828b;
    }
    ...
    public final int hashCode() {
        long j8 = this.f31827a;
        return (this.f31828b * 51) + ((int) (j8 ^ (j8 >>> 32)));
    }
    ...
    public final int j(j$.time.temporal.r rVar) {
        ...
        int i8 = f.f31911a[((j$.time.temporal.a) rVar).ordinal()];
        int i9 = this.f31828b;
        if (i8 == 1) {
            return i9;
        }
        ...
        if (i8 == 4) {
            j$.time.temporal.a.INSTANT_SECONDS.z(this.f31827a);
        }
    ...
    public final long r(j$.time.temporal.r rVar) {
        ...
        int i9 = f.f31911a[((j$.time.temporal.a) rVar).ordinal()];
    ...
    public final String toString() {
        return DateTimeFormatter.f31913f.a(this);
    }
    ...
    public final j$.time.temporal.m v(j$.time.temporal.m mVar) {
        return mVar.d(this.f31827a, j$.time.temporal.a.INSTANT_SECONDS).d(this.f31828b, j$.time.temporal.a.NANO_OF_SECOND);
    }
