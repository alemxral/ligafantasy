...
public final class J extends AbstractC2865d {
    ...
    private final transient j$.time.h f31857a;
    ...
    private int K() {
        return this.f31857a.L() + 543;
    }

    private J M(j$.time.h hVar) {
        return hVar.equals(this.f31857a) ? this : new J(hVar);
    }
    ...
    final InterfaceC2863b G(long j8) {
        return M(this.f31857a.T(j8));
    }

    @Override // j$.time.chrono.AbstractC2865d
    final InterfaceC2863b H(long j8) {
        return M(this.f31857a.U(j8));
    }

    @Override // j$.time.chrono.AbstractC2865d
    final InterfaceC2863b I(long j8) {
        return M(this.f31857a.V(j8));
    }
    ...
    */
    public final j$.time.chrono.J d(long r9, j$.time.temporal.r r11) {
        /*
            ...
            return r8
        L10:
            int[] r1 = j$.time.chrono.I.f31856a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            j$.time.h r3 = r8.f31857a
            r4 = 7
            r5 = 6
            r6 = 4
            if (r2 == r6) goto L4c
            ...
            goto L62
        L27:
            j$.time.chrono.H r11 = j$.time.chrono.H.f31855d
            ...
            return r9
        L4c:
            j$.time.chrono.H r2 = j$.time.chrono.H.f31855d
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof J) {
            return this.f31857a.equals(((J) obj).f31857a);
        }
        return false;
    }
    ...
    public final int hashCode() {
        H.f31855d.getClass();
        return this.f31857a.hashCode() ^ 146118545;
    }
    ...
    public final j$.time.temporal.w m(j$.time.temporal.r rVar) {
        ...
        int i8 = I.f31856a[aVar.ordinal()];
        if (i8 == 1 || i8 == 2 || i8 == 3) {
            return this.f31857a.m(rVar);
        }
        if (i8 != 4) {
            return H.f31855d.m(aVar);
        }
    ...
    public final long r(j$.time.temporal.r rVar) {
        ...
        int i8 = I.f31856a[((j$.time.temporal.a) rVar).ordinal()];
        if (i8 == 4) {
            int K8 = K();
            if (K8 < 1) {
                K8 = 1 - K8;
