...
final class l implements ChronoZonedDateTime, Serializable {
    ...
    private final transient C2868g f31873a;

    /* renamed from: b, reason: collision with root package name */
    private final transient ZoneOffset f31874b;

    /* renamed from: c, reason: collision with root package name */
    private final transient ZoneId f31875c;

    private l(ZoneId zoneId, ZoneOffset zoneOffset, C2868g c2868g) {
        this.f31873a = (C2868g) Objects.requireNonNull(c2868g, "dateTime");
        this.f31874b = (ZoneOffset) Objects.requireNonNull(zoneOffset, TypedValues.CycleType.S_WAVE_OFFSET);
        this.f31875c = (ZoneId) Objects.requireNonNull(zoneId, "zone");
    }
    ...
    */
    ...
    public final ChronoZonedDateTime e(long j8, j$.time.temporal.u uVar) {
        ...
        return D(a(), this.f31873a.e(j8, uVar).v(this));
    }
    ...
    public final j$.time.temporal.m d(long j8, j$.time.temporal.r rVar) {
        ...
        int i8 = AbstractC2872k.f31872a[aVar.ordinal()];
        if (i8 == 1) {
            return e(j8 - AbstractC2870i.o(this), j$.time.temporal.b.SECONDS);
        }
        ZoneId zoneId = this.f31875c;
        C2868g c2868g = this.f31873a;
        if (i8 != 2) {
            return F(zoneId, this.f31874b, c2868g.d(j8, rVar));
        }
    ...
    public final ChronoZonedDateTime h(ZoneId zoneId) {
        return F(zoneId, this.f31874b, this.f31873a);
    }

    public final int hashCode() {
        return (this.f31873a.hashCode() ^ this.f31874b.hashCode()) ^ Integer.rotateLeft(this.f31875c.hashCode(), 3);
    }
    ...
    public final long r(j$.time.temporal.r rVar) {
        ...
        int i8 = AbstractC2871j.f31871a[((j$.time.temporal.a) rVar).ordinal()];
    ...
    public final String toString() {
        String c2868g = this.f31873a.toString();
        ZoneOffset zoneOffset = this.f31874b;
    ...
    public final void writeExternal(ObjectOutput objectOutput) {
        objectOutput.writeObject(this.f31873a);
        objectOutput.writeObject(this.f31874b);
        objectOutput.writeObject(this.f31875c);
    }
