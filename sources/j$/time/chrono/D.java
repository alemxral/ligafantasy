...
public final class D extends AbstractC2865d {
    ...
    private final transient j$.time.h f31850a;
    ...
    private int K() {
        return this.f31850a.L() - 1911;
    }

    private D M(j$.time.h hVar) {
        return hVar.equals(this.f31850a) ? this : new D(hVar);
    }
    ...
    final InterfaceC2863b G(long j8) {
        return M(this.f31850a.T(j8));
    }

    @Override // j$.time.chrono.AbstractC2865d
    final InterfaceC2863b H(long j8) {
        return M(this.f31850a.U(j8));
    }

    @Override // j$.time.chrono.AbstractC2865d
    final InterfaceC2863b I(long j8) {
        return M(this.f31850a.V(j8));
    }
    ...
    */
    public final j$.time.chrono.D d(long r9, j$.time.temporal.r r11) {
        /*
            ...
            return r8
        L10:
            int[] r1 = j$.time.chrono.C.f31849a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            j$.time.h r3 = r8.f31850a
            r4 = 7
            r5 = 6
            r6 = 4
            if (r2 == r6) goto L4c
            ...
            goto L62
        L27:
            j$.time.chrono.B r11 = j$.time.chrono.B.f31848d
            ...
            return r9
        L4c:
            j$.time.chrono.B r2 = j$.time.chrono.B.f31848d
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof D) {
            return this.f31850a.equals(((D) obj).f31850a);
        }
        return false;
    }
    ...
    public final int hashCode() {
        B.f31848d.getClass();
        return this.f31850a.hashCode() ^ (-1990173233);
    }
    ...
    public final j$.time.temporal.w m(j$.time.temporal.r rVar) {
        ...
        int i8 = C.f31849a[aVar.ordinal()];
        if (i8 == 1 || i8 == 2 || i8 == 3) {
            return this.f31850a.m(rVar);
        }
        if (i8 != 4) {
            return B.f31848d.m(aVar);
        }
    ...
    public final long r(j$.time.temporal.r rVar) {
        ...
        int i8 = C.f31849a[((j$.time.temporal.a) rVar).ordinal()];
        if (i8 == 4) {
            int K8 = K();
            if (K8 < 1) {
                K8 = 1 - K8;
