...
public final class z implements n, Serializable {
    ...
    public static final z f31904d;

    /* renamed from: e, reason: collision with root package name */
    private static final z[] f31905e;
    private static final long serialVersionUID = 1466499369062886794L;

    /* renamed from: a, reason: collision with root package name */
    private final transient int f31906a;

    /* renamed from: b, reason: collision with root package name */
    private final transient j$.time.h f31907b;

    /* renamed from: c, reason: collision with root package name */
    private final transient String f31908c;
    ...
    public static long B() {
        ...
        for (z zVar : f31905e) {
            f8 = Math.min(f8, ((zVar.f31907b.N() ? 366 : 365) - zVar.f31907b.J()) + 1);
            if (zVar.q() != null) {
                f8 = Math.min(f8, zVar.q().f31907b.J() - 1);
            }
        }
        return f8;
    }
    ...
    public static long D() {
        int L8 = 1000000000 - k().f31907b.L();
        z[] zVarArr = f31905e;
        int L9 = zVarArr[0].f31907b.L();
        for (int i8 = 1; i8 < zVarArr.length; i8++) {
            z zVar = zVarArr[i8];
            L8 = Math.min(L8, (zVar.f31907b.L() - L9) + 1);
            L9 = zVar.f31907b.L();
        }
        return L8;
    }
    ...
    public static z i(j$.time.h hVar) {
        ...
        for (int length = zVarArr.length - 1; length >= 0; length--) {
            ...
            if (hVar.compareTo(zVar.f31907b) >= 0) {
                return zVar;
            }
        }
        return null;
    ...
    public final void E(DataOutput dataOutput) {
        dataOutput.writeByte(this.f31906a);
    }
    ...
    public final j$.time.temporal.w m(j$.time.temporal.r rVar) {
        ...
        return rVar == aVar ? w.f31898d.m(aVar) : j$.time.temporal.n.d(this, rVar);
    }
