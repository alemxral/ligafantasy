...
public final class y extends AbstractC2865d {
    ...
    static final j$.time.h f31900d = j$.time.h.P(1873, 1, 1);
    private static final long serialVersionUID = -305327627230580483L;

    /* renamed from: a, reason: collision with root package name */
    private final transient j$.time.h f31901a;

    /* renamed from: b, reason: collision with root package name */
    private transient z f31902b;

    /* renamed from: c, reason: collision with root package name */
    private transient int f31903c;
    ...
    public y(j$.time.h hVar) {
        ...
        z i8 = z.i(hVar);
        this.f31902b = i8;
        this.f31903c = (hVar.L() - i8.n().L()) + 1;
        this.f31901a = hVar;
    }

    private y L(j$.time.h hVar) {
        return hVar.equals(this.f31901a) ? this : new y(hVar);
    }
    ...
    final InterfaceC2863b G(long j8) {
        return L(this.f31901a.T(j8));
    }

    @Override // j$.time.chrono.AbstractC2865d
    final InterfaceC2863b H(long j8) {
        return L(this.f31901a.U(j8));
    }

    @Override // j$.time.chrono.AbstractC2865d
    final InterfaceC2863b I(long j8) {
        return L(this.f31901a.V(j8));
    }
    ...
    public final y d(long j8, j$.time.temporal.r rVar) {
        ...
        j$.time.h hVar = this.f31901a;
        if (i8 == 3 || i8 == 8 || i8 == 9) {
            int a8 = w.f31898d.m(aVar).a(j8, aVar);
            int i9 = iArr[aVar.ordinal()];
            if (i9 == 3) {
                return M(this.f31902b, a8);
            }
            if (i9 == 8) {
                return M(z.y(a8), this.f31903c);
            }
            if (i9 == 9) {
                return L(hVar.a0(a8));
            }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof y) {
            return this.f31901a.equals(((y) obj).f31901a);
        }
        return false;
    }
    ...
    public final int hashCode() {
        w.f31898d.getClass();
        return this.f31901a.hashCode() ^ (-688086063);
    }
    ...
    public final j$.time.temporal.w m(j$.time.temporal.r rVar) {
        ...
        j$.time.temporal.a aVar = (j$.time.temporal.a) rVar;
        int i8 = x.f31899a[aVar.ordinal()];
        j$.time.h hVar = this.f31901a;
        if (i8 != 1) {
            z zVar = this.f31902b;
            if (i8 != 2) {
                if (i8 != 3) {
                    return w.f31898d.m(aVar);
                }
                int L8 = zVar.n().L();
                z q8 = zVar.q();
    ...
    public final long r(j$.time.temporal.r rVar) {
        ...
        int i8 = x.f31899a[((j$.time.temporal.a) rVar).ordinal()];
        int i9 = this.f31903c;
        z zVar = this.f31902b;
        j$.time.h hVar = this.f31901a;
        switch (i8) {
