...
public final class C2868g implements InterfaceC2866e, j$.time.temporal.m, j$.time.temporal.p, Serializable {
    ...
    static C2868g D(m mVar, j$.time.temporal.m mVar2) {
        ...
        if (abstractC2862a.equals(c2868g.f31864a.a())) {
            return c2868g;
        }
        throw new ClassCastException("Chronology mismatch, required: " + abstractC2862a.i() + ", actual: " + c2868g.f31864a.a().i());
    }
    ...
    private C2868g K(j$.time.temporal.m mVar, j$.time.k kVar) {
        InterfaceC2863b interfaceC2863b = this.f31864a;
        return (interfaceC2863b == mVar && this.f31865b == kVar) ? this : new C2868g(AbstractC2865d.D(interfaceC2863b.a(), mVar), kVar);
    }
    ...
    public final C2868g e(long j8, j$.time.temporal.u uVar) {
        ...
        int i8 = AbstractC2867f.f31863a[((j$.time.temporal.b) uVar).ordinal()];
        j$.time.k kVar = this.f31865b;
        switch (i8) {
            case 1:
                return I(this.f31864a, 0L, 0L, 0L, j8);
            case 2:
                C2868g K8 = K(interfaceC2863b.e(j8 / 86400000000L, (j$.time.temporal.u) j$.time.temporal.b.DAYS), kVar);
                return K8.I(K8.f31864a, 0L, 0L, 0L, (j8 % 86400000000L) * 1000);
            case 3:
                C2868g K9 = K(interfaceC2863b.e(j8 / 86400000, (j$.time.temporal.u) j$.time.temporal.b.DAYS), kVar);
                return K9.I(K9.f31864a, 0L, 0L, 0L, (j8 % 86400000) * 1000000);
            case 4:
                return H(j8);
            case 5:
                return I(this.f31864a, 0L, j8, 0L, 0L);
            case 6:
                return I(this.f31864a, j8, 0L, 0L, 0L);
            case 7:
                C2868g K10 = K(interfaceC2863b.e(j8 / 256, (j$.time.temporal.u) j$.time.temporal.b.DAYS), kVar);
                return K10.I(K10.f31864a, (j8 % 256) * 12, 0L, 0L, 0L);
            default:
    ...
    public final C2868g H(long j8) {
        return I(this.f31864a, 0L, 0L, j8, 0L);
    }
    ...
    public final int hashCode() {
        return this.f31864a.hashCode() ^ this.f31865b.hashCode();
    }

    @Override // j$.time.temporal.o
    public final int j(j$.time.temporal.r rVar) {
        return rVar instanceof j$.time.temporal.a ? ((j$.time.temporal.a) rVar).E() ? this.f31865b.j(rVar) : this.f31864a.j(rVar) : m(rVar).a(r(rVar), rVar);
    }

    @Override // j$.time.temporal.m
    public final j$.time.temporal.m l(j$.time.h hVar) {
        return K(hVar, this.f31865b);
    }
    ...
    public final long r(j$.time.temporal.r rVar) {
        return rVar instanceof j$.time.temporal.a ? ((j$.time.temporal.a) rVar).E() ? this.f31865b.r(rVar) : this.f31864a.r(rVar) : rVar.l(this);
    }

    public final String toString() {
        return this.f31864a.toString() + ExifInterface.GPS_DIRECTION_TRUE + this.f31865b.toString();
    }
    ...
    public final void writeExternal(ObjectOutput objectOutput) {
        objectOutput.writeObject(this.f31864a);
        objectOutput.writeObject(this.f31865b);
    }
}
