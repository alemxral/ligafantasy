...
public abstract class AbstractC2862a implements m {
    ...
    private static final ConcurrentHashMap f31859a = new ConcurrentHashMap();

    /* renamed from: b, reason: collision with root package name */
    private static final ConcurrentHashMap f31860b = new ConcurrentHashMap();

    /* renamed from: c, reason: collision with root package name */
    public static final /* synthetic */ int f31861c = 0;
    ...
    public static m j(String str) {
        ...
        while (true) {
            ConcurrentHashMap concurrentHashMap = f31859a;
            m mVar = (m) concurrentHashMap.get(str);
            if (mVar == null) {
                mVar = (m) f31860b.get(str);
            }
            if (mVar != null) {
                return mVar;
            }
    ...
    public static m l(m mVar, String str) {
        String q8;
        m mVar2 = (m) f31859a.putIfAbsent(str, mVar);
        if (mVar2 == null && (q8 = mVar.q()) != null) {
            f31860b.putIfAbsent(q8, mVar);
        }
        return mVar2;
    }
