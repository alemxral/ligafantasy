...
public abstract class d {
    ...
    private static final short[] f3058a = new short[128];

    /* renamed from: b, reason: collision with root package name */
    private static final byte[] f3059b;
    ...
    static {
        ...
        for (int i8 = 0; i8 < 128; i8++) {
            byte b8 = bArr2[i8];
            f3058a[i8] = (short) (bArr4[b8] | ((bArr3[b8] & i8) << 8));
        }
    }
    ...
    public static int b(byte[] bArr, char[] cArr) {
        ...
        while (i8 < bArr.length) {
            ...
            if (b8 >= 0) {
                ...
                short s8 = f3058a[b8 & Byte.MAX_VALUE];
                int i11 = s8 >>> 8;
                byte b9 = (byte) s8;
                while (b9 >= 0) {
                    if (i10 >= bArr.length) {
