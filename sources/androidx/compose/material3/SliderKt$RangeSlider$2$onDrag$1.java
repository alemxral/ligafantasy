...
public final class SliderKt$RangeSlider$2$onDrag$1 extends AbstractC3160z implements n {
    ...
    public final void invoke(boolean z8, float f8) {
        ...
        if (z8) {
            ...
            snapValueToTick2 = SliderKt.snapValueToTick(m.j(this.$rawOffsetStart.getValue().floatValue(), this.$minPx.f33744a, floatValue), this.$tickFractions, this.$minPx.f33744a, this.$maxPx.f33744a);
            ...
            snapValueToTick = SliderKt.snapValueToTick(m.j(this.$rawOffsetEnd.getValue().floatValue(), floatValue2, this.$maxPx.f33744a), this.$tickFractions, this.$minPx.f33744a, this.$maxPx.f33744a);
