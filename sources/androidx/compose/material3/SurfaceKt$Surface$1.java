...
public final class SurfaceKt$Surface$1 extends AbstractC3160z implements n {
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SemanticsModifierKt.semantics(m1809surface8ww4TTg, false, AnonymousClass1.INSTANCE), I.f6474a, new AnonymousClass2(null));
        n nVar = this.$content;
        int i9 = this.$$changed;
