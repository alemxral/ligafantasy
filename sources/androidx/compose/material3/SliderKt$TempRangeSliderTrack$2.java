...
final class SliderKt$TempRangeSliderTrack$2 extends AbstractC3160z implements Function1 {
    ...
    public final void invoke(DrawScope Canvas) {
        ...
        long Offset = OffsetKt.Offset(this.$thumbRadiusPx.f33744a, Offset.m2736getYimpl(Canvas.mo3413getCenterF1C5BW0()));
        long Offset2 = OffsetKt.Offset(Size.m2804getWidthimpl(Canvas.mo3414getSizeNHjbRc()) - this.$thumbRadiusPx.f33744a, Offset.m2736getYimpl(Canvas.mo3413getCenterF1C5BW0()));
        ...
        for (Map.Entry entry : linkedHashMap.entrySet()) {
            ...
            long j12 = j11;
            long j13 = j10;
            c.H(Canvas, arrayList, PointMode.Companion.m3254getPointsr_lszbg(), (booleanValue ? state : state2).getValue().m2981unboximpl(), p8.f33744a, StrokeCap.Companion.m3302getRoundKaPHkGw(), null, 0.0f, null, 0, 480, null);
            p8 = p8;
            j11 = j12;
            j10 = j13;
        }
