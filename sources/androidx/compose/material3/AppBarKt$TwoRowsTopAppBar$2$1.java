...
public final class AppBarKt$TwoRowsTopAppBar$2$1 extends AbstractC3160z implements Function0 {
    ...
    public final void m1464invoke() {
        ...
        if (AbstractC3159y.b((topAppBarScrollBehavior == null || (state = topAppBarScrollBehavior.getState()) == null) ? null : Float.valueOf(state.getHeightOffsetLimit()), this.$pinnedHeightPx.f33744a - this.$maxHeightPx.f33744a)) {
            return;
        }
        ...
        state2.setHeightOffsetLimit(this.$pinnedHeightPx.f33744a - this.$maxHeightPx.f33744a);
    }
}
