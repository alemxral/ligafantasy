        ...
        Object collect = this.latestNonEmptyAnchorsFlow.collect(new InterfaceC3359g(this) { // from class: androidx.compose.material3.SwipeableState$performFling$2
            ...
            public final Object emit(Map<Float, ? extends T> map, P5.d dVar2) {
                ...
                if (obj != null && ((Boolean) this.this$0.getConfirmStateChange$material3_release().invoke(obj)).booleanValue()) {
                    ...
                    return animateTo$material3_release$default == b.e() ? animateTo$material3_release$default : I.f6474a;
                }
                ...
                return animateInternalToOffset == b.e() ? animateInternalToOffset : I.f6474a;
            }
        }, dVar);
        if (collect == b.e()) {
            return collect;
