...
public final class SwipeableState$animateInternalToOffset$2 extends l implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(Animatable<Float, AnimationVector1D> animateTo) {
            ...
            this.$$this$drag.dragBy(animateTo.getValue().floatValue() - this.$prevValue.f33744a);
            this.$prevValue.f33744a = animateTo.getValue().floatValue();
        }
    }
    ...
    public final Object invoke(DragScope dragScope, d dVar) {
        return ((SwipeableState$animateInternalToOffset$2) create(dragScope, dVar)).invokeSuspend(I.f6474a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i8 != 0) {
                ...
                p8.f33744a = ((Number) mutableState2.getValue()).floatValue();
                ...
                Animatable Animatable$default = AnimatableKt.Animatable$default(p8.f33744a, 0.0f, 2, null);
