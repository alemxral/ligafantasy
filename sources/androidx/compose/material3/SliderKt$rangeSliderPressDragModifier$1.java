...
public final class SliderKt$rangeSliderPressDragModifier$1 extends l implements n {
        ...
        public static final class C03321 extends l implements n {
            ...
            public static final class C03331 extends k implements n {
                ...
                public static final class AnonymousClass2 extends l implements n {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i8 != 0) {
                            ...
                            t.b(obj);
                            MutableInteractionSource activeInteraction = this.$rangeSliderLogic.activeInteraction(this.$draggingStart.f33743a);
                ...
                public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, d dVar) {
                    return ((C03331) create(awaitPointerEventScope, dVar)).invokeSuspend(I.f6474a);
                }
            ...
            public final Object invoke(PointerInputScope pointerInputScope, d dVar) {
                return ((C03321) create(pointerInputScope, dVar)).invokeSuspend(I.f6474a);
            }
    ...
    @Override // X5.n
    public final Object invoke(PointerInputScope pointerInputScope, d dVar) {
        return ((SliderKt$rangeSliderPressDragModifier$1) create(pointerInputScope, dVar)).invokeSuspend(I.f6474a);
    }
