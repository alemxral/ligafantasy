...
public final class AppBarKt$TwoRowsTopAppBar$3 extends AbstractC3160z implements n {
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        int i10 = i9 << 3;
        AppBarKt.m1458TopAppBarLayoutkXwM9vE(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(companion, windowInsets)), p8.f33744a, topAppBarColors.m1947getNavigationIconContentColor0d7_KjU$material3_release(), topAppBarColors.m1948getTitleContentColor0d7_KjU$material3_release(), topAppBarColors.m1946getActionIconContentColor0d7_KjU$material3_release(), nVar, textStyle, f8, arrangement.getCenter(), arrangement.getStart(), 0, z8, nVar2, nVar3, composer, (i10 & 458752) | 905969664 | (i10 & 3670016), ((i9 >> 12) & 896) | 3078);
        Modifier clipToBounds = ClipKt.clipToBounds(companion);
        float heightOffset = ((topAppBarScrollBehavior == null || (state = topAppBarScrollBehavior.getState()) == null) ? 0.0f : state.getHeightOffset()) + (p9.f33744a - p8.f33744a);
