        ...
        if ((i9 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1
                private static final boolean measure_3p2s80s$canAddToCurrentSequence(List<Placeable> list, Q q8, MeasureScope measureScope, float f10, long j8, Placeable placeable) {
                    if (!list.isEmpty() && q8.f33745a + measureScope.mo442roundToPx0680j_4(f10) + placeable.getWidth() > Constraints.m5146getMaxWidthimpl(j8)) {
                        return false;
                    }
                    return true;
                }
                ...
                private static final void measure_3p2s80s$startNewSequence(List<List<Placeable>> list, Q q8, MeasureScope measureScope, float f10, List<Placeable> list2, List<Integer> list3, Q q9, List<Integer> list4, Q q10, Q q11) {
                    ...
                    if (!list5.isEmpty()) {
                        q8.f33745a += measureScope.mo442roundToPx0680j_4(f10);
                    }
                    list5.add(AbstractC1246t.W0(list2));
                    list3.add(Integer.valueOf(q9.f33745a));
                    list4.add(Integer.valueOf(q8.f33745a));
                    q8.f33745a += q9.f33745a;
                    q10.f33745a = Math.max(q10.f33745a, q11.f33745a);
                    list2.clear();
                    q11.f33745a = 0;
                    q9.f33745a = 0;
                }
                ...
                public final MeasureResult mo132measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j8) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (!arrayList.isEmpty()) {
                            q15.f33745a += Layout.mo442roundToPx0680j_4(f8);
                        }
                        ArrayList arrayList6 = arrayList;
                        arrayList6.add(mo4131measureBRTryo0);
                        q15.f33745a += mo4131measureBRTryo0.getWidth();
                        q13 = q14;
                        q13.f33745a = Math.max(q13.f33745a, mo4131measureBRTryo0.getHeight());
                    ...
                    int max = Math.max(q10.f33745a, Constraints.m5148getMinWidthimpl(j8));
                    return MeasureScope.CC.q(Layout, max, Math.max(q16.f33745a, Constraints.m5147getMinHeightimpl(j8)), null, new AlertDialogKt$AlertDialogFlowRow$1$measure$1(arrayList2, Layout, f8, max, arrayList4), 4, null);
                }
