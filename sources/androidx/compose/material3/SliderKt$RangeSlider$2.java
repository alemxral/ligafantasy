...
public final class SliderKt$RangeSlider$2 extends AbstractC3160z implements o {
    ...
    public final void invoke(BoxWithConstraintsScope BoxWithConstraints, Composer composer, int i8) {
        ...
        float f8 = 2;
        p8.f33744a = m5146getMaxWidthimpl - (density.mo448toPx0680j_4(SliderKt.getThumbWidth()) / f8);
        p9.f33744a = density.mo448toPx0680j_4(SliderKt.getThumbWidth()) / f8;
        I i10 = I.f6474a;
        ...
        float f9 = p8.f33744a - p9.f33744a;
