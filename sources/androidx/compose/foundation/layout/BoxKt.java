    ...
    public static final MeasurePolicy boxMeasurePolicy(final Alignment alignment, final boolean z8) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1
            ...
            public final MeasureResult mo132measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> measurables, long j8) {
                ...
                Q q8 = new Q();
                q8.f33745a = Constraints.m5148getMinWidthimpl(j8);
                Q q9 = new Q();
                q9.f33745a = Constraints.m5147getMinHeightimpl(j8);
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    ...
                    if (!matchesParentSize2) {
                        ...
                        q8.f33745a = Math.max(q8.f33745a, mo4131measureBRTryo03.getWidth());
                        q9.f33745a = Math.max(q9.f33745a, mo4131measureBRTryo03.getHeight());
                    } else {
                        z9 = true;
                    }
                }
                ...
                return MeasureScope.CC.q(MeasurePolicy, q8.f33745a, q9.f33745a, null, new BoxKt$boxMeasurePolicy$1$measure$5(placeableArr, measurables, MeasurePolicy, q8, q9, alignment), 4, null);
            }
