    ...
    public static final LazyStaggeredGridMeasureResult m782measureStaggeredGriddSVRQoE(LazyLayoutMeasureScope measureStaggeredGrid, LazyStaggeredGridState state, List<Integer> pinnedItems, LazyStaggeredGridItemProvider itemProvider, LazyStaggeredGridSlots resolvedSlots, long j8, boolean z8, boolean z9, long j9, int i8, int i9, int i10, int i11) {
        ...
        try {
            ...
            try {
                ...
                t8.f33747a = updateScrollPositionIfTheFirstItemWasMoved$foundation_release;
                ...
                return measure(lazyStaggeredGridMeasureContext, Z5.a.d(state.getScrollToBeConsumed$foundation_release()), (int[]) t8.f33747a, (int[]) t9.f33747a, r12);
            } catch (Throwable th) {
                createNonObservableSnapshot.restoreCurrent(makeCurrent);
                throw th;
            }
