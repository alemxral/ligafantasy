...
final class TransformableStateKt$animateZoomBy$3 extends l implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(AnimationScope<Float, AnimationVector1D> animateTo) {
            ...
            d.a(this.$$this$transform, this.$previous.f33744a == 0.0f ? 1.0f : animateTo.getValue().floatValue() / this.$previous.f33744a, 0L, 0.0f, 6, null);
            this.$previous.f33744a = animateTo.getValue().floatValue();
        }
    }
    ...
    public final Object invoke(TransformScope transformScope, P5.d dVar) {
        return ((TransformableStateKt$animateZoomBy$3) create(transformScope, dVar)).invokeSuspend(I.f6474a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            AnimationState AnimationState$default = AnimationStateKt.AnimationState$default(this.$previous.f33744a, 0.0f, 0L, 0L, false, 30, null);
