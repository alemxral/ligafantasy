...
final class TransformableStateKt$animatePanBy$2 extends l implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(AnimationScope<Offset, AnimationVector2D> animateTo) {
            ...
            d.a(this.$$this$transform, 0.0f, Offset.m2739minusMKHz9U(animateTo.getValue().m2745unboximpl(), this.$previous.f33746a), 0.0f, 5, null);
            this.$previous.f33746a = animateTo.getValue().m2745unboximpl();
        }
    }
    ...
    public final Object invoke(TransformScope transformScope, P5.d dVar) {
        return ((TransformableStateKt$animatePanBy$2) create(transformScope, dVar)).invokeSuspend(I.f6474a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.Companion), Offset.m2724boximpl(this.$previous.f33746a), null, 0L, 0L, false, 60, null);
