...
public final class ScrollExtensionsKt$animateScrollBy$2 extends l implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements n {
        ...
        public final void invoke(float f8, float f9) {
            ...
            float f10 = p8.f33744a;
            p8.f33744a = f10 + this.$$this$scroll.scrollBy(f8 - f10);
        }
    }
    ...
    public final Object invoke(ScrollScope scrollScope, P5.d dVar) {
        return ((ScrollExtensionsKt$animateScrollBy$2) create(scrollScope, dVar)).invokeSuspend(I.f6474a);
    }
