...
public final class ContentInViewModifier$launchAnimation$1 extends l implements n {
    ...
    public static final class AnonymousClass1 extends l implements n {
            ...
            public final void m377invoke() {
                ...
                while (true) {
                    ...
                    if (!(rect == null ? true : ContentInViewModifier.m374isMaxVisibleO0kMr_c$default(contentInViewModifier, rect, 0L, 1, null))) {
                        ...
                        ((ContentInViewModifier.Request) bringIntoViewRequestPriorityQueue.requests.removeAt(bringIntoViewRequestPriorityQueue.requests.getSize() - 1)).getContinuation().resumeWith(s.b(I.f6474a));
                    }
                }
        ...
        public final Object invoke(ScrollScope scrollScope, P5.d dVar) {
            return ((AnonymousClass1) create(scrollScope, dVar)).invokeSuspend(I.f6474a);
        }
    ...
    public final Object invoke(M m8, P5.d dVar) {
        return ((ContentInViewModifier$launchAnimation$1) create(m8, dVar)).invokeSuspend(I.f6474a);
    }
