...
public final class SnapFlingBehaviorKt$animateDecay$2 extends AbstractC3160z implements Function1 {
    ...
    public final void invoke(AnimationScope<Float, AnimationVector1D> animateDecay) {
        ...
        if (Math.abs(animateDecay.getValue().floatValue()) >= Math.abs(this.$targetOffset)) {
            ...
            SnapFlingBehaviorKt.animateDecay$consumeDelta(animateDecay, this.$this_animateDecay, this.$onAnimationStep, coerceToTarget - this.$previousValue.f33744a);
            animateDecay.cancelAnimation();
            this.$previousValue.f33744a = coerceToTarget;
            return;
        }
        SnapFlingBehaviorKt.animateDecay$consumeDelta(animateDecay, this.$this_animateDecay, this.$onAnimationStep, animateDecay.getValue().floatValue() - this.$previousValue.f33744a);
        this.$previousValue.f33744a = animateDecay.getValue().floatValue();
    }
}
