...
final class DefaultFlingBehavior$performFling$2 extends l implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(AnimationScope<Float, AnimationVector1D> animateDecay) {
            ...
            float floatValue = animateDecay.getValue().floatValue() - this.$lastValue.f33744a;
            float scrollBy = this.$this_performFling.scrollBy(floatValue);
            this.$lastValue.f33744a = animateDecay.getValue().floatValue();
            this.$velocityLeft.f33744a = animateDecay.getVelocity().floatValue();
    ...
    public final Object invoke(M m8, P5.d dVar) {
        return ((DefaultFlingBehavior$performFling$2) create(m8, dVar)).invokeSuspend(I.f6474a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            if (Math.abs(this.$initialVelocity) > 1.0f) {
                P p9 = new P();
                p9.f33744a = this.$initialVelocity;
                P p10 = new P();
