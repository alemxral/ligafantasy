...
public final class AnimationVector2D extends AnimationVector {
    ...
    private float f13728v1;

    /* renamed from: v2, reason: collision with root package name */
    private float f13729v2;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof AnimationVector2D) {
            ...
            if (animationVector2D.f13728v1 == this.f13728v1 && animationVector2D.f13729v2 == this.f13729v2) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (Float.floatToIntBits(this.f13728v1) * 31) + Float.floatToIntBits(this.f13729v2);
    }
    ...
    public String toString() {
        return "AnimationVector2D: v1 = " + this.f13728v1 + ", v2 = " + this.f13729v2;
    }
