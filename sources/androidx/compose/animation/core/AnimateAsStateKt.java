...
public final class AnimateAsStateKt {
    ...
    private static final SpringSpec<Integer> intDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Integer.valueOf(VisibilityThresholdsKt.getVisibilityThreshold(C3158x.f33777a)), 3, null);
    ...
    public static final State<Float> animateFloatAsState(float f8, AnimationSpec<Float> animationSpec, float f9, String str, Function1 function1, Composer composer, int i8, int i9) {
        ...
        composer.endReplaceableGroup();
        int i10 = i8 << 3;
        State<Float> animateValueAsState = animateValueAsState(Float.valueOf(f8), VectorConvertersKt.getVectorConverter(r.f33776a), animationSpec2, Float.valueOf(f10), str2, function12, composer, (i10 & 7168) | (i8 & 14) | (57344 & i10) | (i10 & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Integer> animateIntAsState(int i8, AnimationSpec<Integer> animationSpec, String str, Function1 function1, Composer composer, int i9, int i10) {
        ...
        int i11 = i9 << 6;
        State<Integer> animateValueAsState = animateValueAsState(Integer.valueOf(i8), VectorConvertersKt.getVectorConverter(C3158x.f33777a), animationSpec2, null, str2, function12, composer, (i9 & 14) | ((i9 << 3) & 896) | (57344 & i11) | (i11 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State animateIntAsState(int i8, AnimationSpec animationSpec, Function1 function1, Composer composer, int i9, int i10) {
        ...
        State animateValueAsState = animateValueAsState(Integer.valueOf(i8), VectorConvertersKt.getVectorConverter(C3158x.f33777a), animationSpec2, null, null, function12, composer, (i9 & 14) | ((i9 << 3) & 896) | ((i9 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
