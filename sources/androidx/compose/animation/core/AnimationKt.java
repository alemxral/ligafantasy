...
public final class AnimationKt {
    ...
    public static final DecayAnimation<Float, AnimationVector1D> DecayAnimation(FloatDecayAnimationSpec animationSpec, float f8, float f9) {
        ...
        return new DecayAnimation<>((DecayAnimationSpec<Float>) DecayAnimationSpecKt.generateDecayAnimationSpec(animationSpec), VectorConvertersKt.getVectorConverter(r.f33776a), Float.valueOf(f8), AnimationVectorsKt.AnimationVector(f9));
    }
