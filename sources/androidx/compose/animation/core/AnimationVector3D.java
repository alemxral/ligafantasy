...
public final class AnimationVector3D extends AnimationVector {
    ...
    private float f13730v1;

    /* renamed from: v2, reason: collision with root package name */
    private float f13731v2;

    /* renamed from: v3, reason: collision with root package name */
    private float f13732v3;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof AnimationVector3D) {
            ...
            if (animationVector3D.f13730v1 == this.f13730v1 && animationVector3D.f13731v2 == this.f13731v2 && animationVector3D.f13732v3 == this.f13732v3) {
                return true;
            }
        }
        return false;
    ...
    public float get$animation_core_release(int i8) {
        if (i8 != 0) {
            if (i8 != 1) {
                ...
                return this.f13732v3;
            }
            return this.f13731v2;
        }
        return this.f13730v1;
    }
    ...
    public int hashCode() {
        return (((Float.floatToIntBits(this.f13730v1) * 31) + Float.floatToIntBits(this.f13731v2)) * 31) + Float.floatToIntBits(this.f13732v3);
    }
    ...
    public String toString() {
        return "AnimationVector3D: v1 = " + this.f13730v1 + ", v2 = " + this.f13731v2 + ", v3 = " + this.f13732v3;
    }
