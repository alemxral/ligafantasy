...
public final class DecayAnimationSpecKt {
    ...
    public static final float calculateTargetValue(DecayAnimationSpec<Float> decayAnimationSpec, float f8, float f9) {
        AbstractC3159y.i(decayAnimationSpec, "<this>");
        return ((AnimationVector1D) decayAnimationSpec.vectorize(VectorConvertersKt.getVectorConverter(r.f33776a)).getTargetValue(AnimationVectorsKt.AnimationVector(f8), AnimationVectorsKt.AnimationVector(f9))).getValue();
    }
}
