...
public final class InfiniteTransition$run$1 extends l implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(long j8) {
            ...
            int i8 = 0;
            if (j9 == Long.MIN_VALUE || this.$durationScale.f33744a != SuspendAnimationKt.getDurationScale(this.$$this$LaunchedEffect.getCoroutineContext())) {
                ...
                this.$durationScale.f33744a = SuspendAnimationKt.getDurationScale(this.$$this$LaunchedEffect.getCoroutineContext());
            }
            if (this.$durationScale.f33744a == 0.0f) {
            ...
            this.this$0.onFrame(((float) (longValue - j10)) / this.$durationScale.f33744a);
        }
    }
    ...
    public static final class AnonymousClass3 extends l implements n {
        ...
        public final Object invoke(float f8, P5.d dVar) {
            return ((AnonymousClass3) create(Float.valueOf(f8), dVar)).invokeSuspend(I.f6474a);
        }
    ...
    public final Object invoke(M m8, P5.d dVar) {
        return ((InfiniteTransition$run$1) create(m8, dVar)).invokeSuspend(I.f6474a);
    }
