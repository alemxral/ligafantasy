...
public final class InfiniteTransitionKt {
    ...
    public static final State<Float> animateFloat(InfiniteTransition infiniteTransition, float f8, float f9, InfiniteRepeatableSpec<Float> animationSpec, String str, Composer composer, int i8, int i9) {
        ...
        int i10 = i8 << 3;
        State<Float> animateValue = animateValue(infiniteTransition, Float.valueOf(f8), Float.valueOf(f9), VectorConvertersKt.getVectorConverter(r.f33776a), animationSpec, str2, composer, (i8 & 112) | 8 | (i8 & 896) | (57344 & i10) | (i10 & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
