...
public final class SplineBasedDecayKt {
    ...
    private static final float f13726P1 = 0.175f;

    /* renamed from: P2, reason: collision with root package name */
    private static final float f13727P2 = 0.35000002f;
    ...
    public static final void computeSplineInfo(float[] fArr, float[] fArr2, int i8) {
        ...
        for (int i9 = 0; i9 < i8; i9++) {
            ...
            while (true) {
                ...
                f10 = f8 * 3.0f * f9;
                f11 = f8 * f8 * f8;
                float f20 = (((f9 * f13726P1) + (f8 * f13727P2)) * f10) + f11;
            ...
            fArr2[i9] = (f14 * ((f13 * f13726P1) + (f12 * f13727P2))) + f15;
        }
        fArr2[i8] = 1.0f;
        fArr[i8] = 1.0f;
    }
