...
public final class MultiParagraph$fillBoundingBoxes$1 extends AbstractC3160z implements Function1 {
    ...
    public final void invoke(ParagraphInfo paragraphInfo) {
        ...
        paragraphInfo.getParagraph().mo4541fillBoundingBoxes8ffj60Q(TextRange, fArr, q8.f33745a);
        int m4688getLengthimpl = q8.f33745a + (TextRange.m4688getLengthimpl(TextRange) * 4);
        for (int i8 = q8.f33745a; i8 < m4688getLengthimpl; i8 += 4) {
            int i9 = i8 + 1;
            float f8 = fArr[i9];
            float f9 = p8.f33744a;
            fArr[i9] = f8 + f9;
        ...
        q8.f33745a = m4688getLengthimpl;
        p8.f33744a += paragraphInfo.getParagraph().getHeight();
    }
}
