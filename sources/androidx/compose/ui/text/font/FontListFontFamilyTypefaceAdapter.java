...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    private static final J DropExceptionHandler = new FontListFontFamilyTypefaceAdapter$special$$inlined$CoroutineExceptionHandler$1(J.f31700m0);
    ...
    public FontListFontFamilyTypefaceAdapter(AsyncTypefaceCache asyncTypefaceCache, P5.g gVar) {
        ...
        this.asyncLoadScope = N.a(DropExceptionHandler.plus(DispatcherKt.getFontCacheManagementDispatcher()).plus(gVar).plus(U0.a((InterfaceC2855x0) gVar.get(InterfaceC2855x0.f31795n0))));
    }
    ...
    public /* synthetic */ FontListFontFamilyTypefaceAdapter(AsyncTypefaceCache asyncTypefaceCache, P5.g gVar, int i8, AbstractC3151p abstractC3151p) {
        this((i8 & 1) != 0 ? new AsyncTypefaceCache() : asyncTypefaceCache, (i8 & 2) != 0 ? P5.h.f7981a : gVar);
    }
}
