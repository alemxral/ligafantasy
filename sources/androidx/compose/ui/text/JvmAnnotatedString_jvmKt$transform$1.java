...
public final class JvmAnnotatedString_jvmKt$transform$1 extends AbstractC3160z implements Function1 {
    ...
    public final Integer invoke(List<Integer> list) {
        ...
        this.$resultStr.f33747a = ((String) this.$resultStr.f33747a) + ((String) this.$transform.invoke(this.$this_transform.getText(), Integer.valueOf(intValue), Integer.valueOf(intValue2)));
        return this.$offsetMap.put(Integer.valueOf(intValue2), Integer.valueOf(((String) this.$resultStr.f33747a).length()));
    }
}
