...
public final class PointerHoverIconModifierNode$displayIconFromAncestorNodeWithCursorInBoundsOrDefaultIcon$1 extends AbstractC3160z implements Function1 {
    ...
    public final Boolean invoke(PointerHoverIconModifierNode pointerHoverIconModifierNode) {
        boolean z8;
        boolean z9;
        if (this.$pointerHoverIconModifierNode.f33747a == null) {
            z9 = pointerHoverIconModifierNode.cursorInBoundsOfNode;
            if (z9) {
                this.$pointerHoverIconModifierNode.f33747a = pointerHoverIconModifierNode;
                return Boolean.TRUE;
            }
        }
        if (this.$pointerHoverIconModifierNode.f33747a != null && pointerHoverIconModifierNode.getOverrideDescendants()) {
