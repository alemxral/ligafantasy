...
public interface Modifier {
    ...
    public static abstract class Node implements DelegatableNode {
        ...
        public final M getCoroutineScope() {
            M m8 = this.scope;
            if (m8 == null) {
                M a8 = N.a(DelegatableNodeKt.requireOwner(this).getCoroutineContext().plus(B0.a((InterfaceC2855x0) DelegatableNodeKt.requireOwner(this).getCoroutineContext().get(InterfaceC2855x0.f31795n0))));
                this.scope = a8;
                return a8;
            }
            return m8;
