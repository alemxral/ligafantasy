...
public final class PopupLayout$updatePosition$1 extends AbstractC3160z implements Function0 {
    ...
    public final void m5439invoke() {
        this.$popupPosition.f33746a = this.this$0.getPositionProvider().mo1010calculatePositionllwVHH4(this.$parentBounds, this.$windowSize, this.this$0.getParentLayoutDirection(), this.$popupContentSize);
    }
}
