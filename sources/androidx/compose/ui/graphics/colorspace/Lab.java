...
public final class Lab extends ColorSpace {
    ...
    private static final float f13773A = 0.008856452f;

    /* renamed from: B, reason: collision with root package name */
    private static final float f13774B = 7.787037f;

    /* renamed from: C, reason: collision with root package name */
    private static final float f13775C = 0.13793103f;
    public static final Companion Companion = new Companion(null);

    /* renamed from: D, reason: collision with root package name */
    private static final float f13776D = 0.20689656f;
    ...
    public float[] fromXyz(float[] fArr) {
        ...
        if (f12 > f13773A) {
            ...
            f8 = (f12 * f13774B) + f13775C;
        }
        if (f13 > f13773A) {
            f9 = (float) Math.pow(f13, 0.33333334f);
        } else {
            f9 = (f13 * f13774B) + f13775C;
        }
        if (f14 > f13773A) {
            f10 = (float) Math.pow(f14, 0.33333334f);
        } else {
            f10 = f13775C + (f14 * f13774B);
        }
    ...
    public long toXy$ui_graphics_release(float f8, float f9, float f10) {
        ...
        if (j9 > f13776D) {
            ...
            f11 = (j9 - f13775C) * 0.12841855f;
        }
        if (j8 > f13776D) {
            f12 = j8 * j8 * j8;
        } else {
            f12 = (j8 - f13775C) * 0.12841855f;
        }
        Illuminant illuminant = Illuminant.INSTANCE;
    ...
    public float[] toXyz(float[] fArr) {
        ...
        if (f12 > f13776D) {
            ...
            f8 = (f12 - f13775C) * 0.12841855f;
        }
        if (f11 > f13776D) {
            f9 = f11 * f11 * f11;
        } else {
            f9 = (f11 - f13775C) * 0.12841855f;
        }
        if (f13 > f13776D) {
            f10 = f13 * f13 * f13;
        } else {
            f10 = (f13 - f13775C) * 0.12841855f;
        }
        Illuminant illuminant = Illuminant.INSTANCE;
    ...
    public long mo3365xyzaToColorJlNiLsg$ui_graphics_release(float f8, float f9, float f10, float f11, ColorSpace colorSpace) {
        ...
        if (f15 > f13773A) {
            ...
            f12 = (f15 * f13774B) + f13775C;
        }
        if (f16 > f13773A) {
            f13 = (float) Math.pow(f16, 0.33333334f);
        } else {
            f13 = (f16 * f13774B) + f13775C;
        }
        if (f17 > f13773A) {
            f14 = (float) Math.pow(f17, 0.33333334f);
        } else {
            f14 = (f17 * f13774B) + f13775C;
        }
