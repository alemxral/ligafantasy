...
public final class SliderKt$Slider$3 extends AbstractC3160z implements o {
    ...
    public static final float invoke$scaleToUserValue(P p8, P p9, InterfaceC2561e interfaceC2561e, float f8) {
        float scale;
        scale = SliderKt.scale(p8.f33744a, p9.f33744a, f8, ((Number) interfaceC2561e.getStart()).floatValue(), ((Number) interfaceC2561e.getEndInclusive()).floatValue());
        return scale;
    }
    ...
    public final void invoke(BoxWithConstraintsScope BoxWithConstraints, Composer composer, int i8) {
        ...
        p8.f33744a = Math.max(m5146getMaxWidthimpl - density.mo448toPx0680j_4(SliderKt.getThumbRadius()), 0.0f);
        p9.f33744a = Math.min(density.mo448toPx0680j_4(SliderKt.getThumbRadius()), p8.f33744a);
        ...
        InterfaceC2561e b8 = m.b(p9.f33744a, p8.f33744a);
        float f9 = this.$value;
        int i10 = this.$$dirty;
        ...
        float f10 = p8.f33744a - p9.f33744a;
