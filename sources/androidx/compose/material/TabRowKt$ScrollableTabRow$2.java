...
public final class TabRowKt$ScrollableTabRow$2 extends AbstractC3160z implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements n {
        ...
        public static final class AnonymousClass2 extends AbstractC3160z implements Function1 {
            ...
            public final void invoke(Placeable.PlacementScope layout) {
                ...
                for (Measurable measurable : subcompose) {
                    ...
                    Placeable.PlacementScope.placeRelative$default(layout, mo4131measureBRTryo0, 0, q9.f33745a - mo4131measureBRTryo0.getHeight(), 0.0f, 4, null);
                    q8 = q8;
                    q9 = q9;
                    j8 = j8;
                }
                ...
                while (it.hasNext()) {
                    Placeable.PlacementScope.placeRelative$default(layout, ((Measurable) it.next()).mo4131measureBRTryo0(Constraints.Companion.m5154fixedJhjzzOo(q10.f33745a, q11.f33745a)), 0, 0, 0.0f, 4, null);
                }
        ...
        public final MeasureResult m1385invoke0kLqBqw(SubcomposeMeasureScope SubcomposeLayout, long j8) {
            ...
            Q q8 = new Q();
            q8.f33745a = mo442roundToPx0680j_42 * 2;
            Q q9 = new Q();
            for (Placeable placeable : arrayList) {
                q8.f33745a += placeable.getWidth();
                q9.f33745a = Math.max(q9.f33745a, placeable.getHeight());
            }
            return MeasureScope.CC.q(SubcomposeLayout, q8.f33745a, q9.f33745a, null, new AnonymousClass2(mo442roundToPx0680j_42, arrayList, SubcomposeLayout, this.$divider, this.$scrollableTabData, this.$selectedTabIndex, j8, q8, q9, this.$indicator, this.$$dirty), 4, null);
        }
    }
