...
public final class Typography {
    ...
    private final TextStyle f13755h1;

    /* renamed from: h2, reason: collision with root package name */
    private final TextStyle f13756h2;

    /* renamed from: h3, reason: collision with root package name */
    private final TextStyle f13757h3;

    /* renamed from: h4, reason: collision with root package name */
    private final TextStyle f13758h4;

    /* renamed from: h5, reason: collision with root package name */
    private final TextStyle f13759h5;

    /* renamed from: h6, reason: collision with root package name */
    private final TextStyle f13760h6;
    ...
    public static /* synthetic */ Typography copy$default(Typography typography, TextStyle textStyle, TextStyle textStyle2, TextStyle textStyle3, TextStyle textStyle4, TextStyle textStyle5, TextStyle textStyle6, TextStyle textStyle7, TextStyle textStyle8, TextStyle textStyle9, TextStyle textStyle10, TextStyle textStyle11, TextStyle textStyle12, TextStyle textStyle13, int i8, Object obj) {
        ...
        if ((i8 & 1) != 0) {
            textStyle14 = typography.f13755h1;
        } else {
            textStyle14 = textStyle;
        }
        if ((i8 & 2) != 0) {
            textStyle15 = typography.f13756h2;
        } else {
            textStyle15 = textStyle2;
        }
        if ((i8 & 4) != 0) {
            textStyle16 = typography.f13757h3;
        } else {
            textStyle16 = textStyle3;
        }
        if ((i8 & 8) != 0) {
            textStyle17 = typography.f13758h4;
        } else {
            textStyle17 = textStyle4;
        }
        if ((i8 & 16) != 0) {
            textStyle18 = typography.f13759h5;
        } else {
            textStyle18 = textStyle5;
        }
        if ((i8 & 32) != 0) {
            textStyle19 = typography.f13760h6;
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3159y.d(this.f13755h1, typography.f13755h1) && AbstractC3159y.d(this.f13756h2, typography.f13756h2) && AbstractC3159y.d(this.f13757h3, typography.f13757h3) && AbstractC3159y.d(this.f13758h4, typography.f13758h4) && AbstractC3159y.d(this.f13759h5, typography.f13759h5) && AbstractC3159y.d(this.f13760h6, typography.f13760h6) && AbstractC3159y.d(this.subtitle1, typography.subtitle1) && AbstractC3159y.d(this.subtitle2, typography.subtitle2) && AbstractC3159y.d(this.body1, typography.body1) && AbstractC3159y.d(this.body2, typography.body2) && AbstractC3159y.d(this.button, typography.button) && AbstractC3159y.d(this.caption, typography.caption) && AbstractC3159y.d(this.overline, typography.overline)) {
            return true;
        }
        return false;
    }
    ...
    public final TextStyle getH1() {
        return this.f13755h1;
    }

    public final TextStyle getH2() {
        return this.f13756h2;
    }

    public final TextStyle getH3() {
        return this.f13757h3;
    }

    public final TextStyle getH4() {
        return this.f13758h4;
    }

    public final TextStyle getH5() {
        return this.f13759h5;
    }

    public final TextStyle getH6() {
        return this.f13760h6;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((((this.f13755h1.hashCode() * 31) + this.f13756h2.hashCode()) * 31) + this.f13757h3.hashCode()) * 31) + this.f13758h4.hashCode()) * 31) + this.f13759h5.hashCode()) * 31) + this.f13760h6.hashCode()) * 31) + this.subtitle1.hashCode()) * 31) + this.subtitle2.hashCode()) * 31) + this.body1.hashCode()) * 31) + this.body2.hashCode()) * 31) + this.button.hashCode()) * 31) + this.caption.hashCode()) * 31) + this.overline.hashCode();
    }

    public String toString() {
        return "Typography(h1=" + this.f13755h1 + ", h2=" + this.f13756h2 + ", h3=" + this.f13757h3 + ", h4=" + this.f13758h4 + ", h5=" + this.f13759h5 + ", h6=" + this.f13760h6 + ", subtitle1=" + this.subtitle1 + ", subtitle2=" + this.subtitle2 + ", body1=" + this.body1 + ", body2=" + this.body2 + ", button=" + this.button + ", caption=" + this.caption + ", overline=" + this.overline + ')';
    }
