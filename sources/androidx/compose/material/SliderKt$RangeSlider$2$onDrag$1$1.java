...
public final class SliderKt$RangeSlider$2$onDrag$1$1 extends AbstractC3160z implements n {
    ...
    public final void invoke(boolean z8, float f8) {
        ...
        if (z8) {
            ...
            b8 = m.b(m.j(this.$rawOffsetStart.getFloatValue(), this.$minPx.f33744a, floatValue), floatValue);
        } else {
            ...
            b8 = m.b(floatValue2, m.j(this.$rawOffsetEnd.getFloatValue(), floatValue2, this.$maxPx.f33744a));
        }
