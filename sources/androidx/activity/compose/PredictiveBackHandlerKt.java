...
public final class PredictiveBackHandlerKt {
    ...
    public static final void PredictiveBackHandler(final boolean z8, n nVar, Composer composer, int i8, int i9) {
        ...
        if (rememberedValue == companion.getEmpty()) {
            CompositionScopedCoroutineScopeCanceller compositionScopedCoroutineScopeCanceller = new CompositionScopedCoroutineScopeCanceller(EffectsKt.createCompositionCoroutineScope(h.f7981a, startRestartGroup));
