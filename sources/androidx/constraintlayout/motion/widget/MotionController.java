...
public class MotionController {
    ...
    public void getDpDt(float f8, float f9, float f10, float[] fArr) {
        ...
        float f12 = motionPaths.f13888x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f13 = f12 - motionPaths2.f13888x;
        float f14 = motionPaths.f13889y - motionPaths2.f13889y;
    ...
    public float getFinalX() {
        return this.mEndMotionPath.f13888x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f13889y;
    }
    ...
    public float getKeyFrameParameter(int i8, float f8, float f9) {
        MotionPaths motionPaths = this.mEndMotionPath;
        float f10 = motionPaths.f13888x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f11 = motionPaths2.f13888x;
        float f12 = f10 - f11;
        float f13 = motionPaths.f13889y;
        float f14 = motionPaths2.f13889y;
        float f15 = f13 - f14;
    ...
    public KeyPositionBase getPositionKeyframe(int i8, int i9, float f8, float f9) {
        ...
        float f10 = motionPaths.f13888x;
        rectF.left = f10;
        float f11 = motionPaths.f13889y;
        rectF.top = f11;
        rectF.right = f10 + motionPaths.width;
        rectF.bottom = f11 + motionPaths.height;
        RectF rectF2 = new RectF();
        MotionPaths motionPaths2 = this.mEndMotionPath;
        float f12 = motionPaths2.f13888x;
        rectF2.left = f12;
        float f13 = motionPaths2.f13889y;
        rectF2.top = f13;
    ...
    public float getStartX() {
        return this.mStartMotionPath.f13888x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f13889y;
    }
    ...
    public boolean interpolate(View view, float f8, long j8, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            c8 = 1;
            MotionPaths motionPaths = this.mStartMotionPath;
            float f13 = motionPaths.f13888x;
            MotionPaths motionPaths2 = this.mEndMotionPath;
            float f14 = f13 + ((motionPaths2.f13888x - f13) * f12);
            float f15 = motionPaths.f13889y;
            float f16 = f15 + ((motionPaths2.f13889y - f15) * f12);
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f13888x + " y: " + this.mStartMotionPath.f13889y + " end: x: " + this.mEndMotionPath.f13888x + " y: " + this.mEndMotionPath.f13889y;
    }
