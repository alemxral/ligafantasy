...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z8) {
        boolean diff = diff(this.f13888x, motionPaths.f13888x);
        boolean diff2 = diff(this.f13889y, motionPaths.f13889y);
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f13888x, this.f13889y, this.width, this.height, this.mPathRotate};
        int i8 = 0;
        for (int i9 : iArr) {
            if (i9 < 6) {
                dArr[i8] = fArr[r2];
    ...
    public void getCenter(double d8, int[] iArr, double[] dArr, float[] fArr, int i8) {
        float f8 = this.f13888x;
        float f9 = this.f13889y;
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f17 = motionPaths.f13888x;
        float f18 = motionPaths.f13889y;
        float f19 = (motionPaths2.f13888x + (f13 / 2.0f)) - ((f14 / 2.0f) + f17);
        float f20 = (motionPaths2.f13889y + (f15 / 2.0f)) - (f18 + (f16 / 2.0f));
        float f21 = ((f13 - f14) * f8) / 2.0f;
        this.f13888x = (int) ((f17 + (f19 * f12)) - f21);
        float f22 = ((f15 - f16) * f9) / 2.0f;
        this.f13889y = (int) ((f18 + (f20 * f12)) - f22);
        ...
        this.mMode = 0;
        this.f13888x = (int) (((motionPaths.f13888x + (f10 * f19)) + (f23 * f20)) - f21);
        this.f13889y = (int) (((motionPaths.f13889y + (f19 * f11)) + (f20 * f12)) - f22);
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f14 = motionPaths.f13888x;
        float f15 = motionPaths.width;
        float f16 = motionPaths.f13889y;
        float f17 = motionPaths.height;
        float f18 = (motionPaths2.f13888x + (motionPaths2.width / 2.0f)) - ((f15 / 2.0f) + f14);
        float f19 = (motionPaths2.f13889y + (motionPaths2.height / 2.0f)) - ((f17 / 2.0f) + f16);
        float f20 = f18 * f11;
        float f21 = (f12 * f8) / 2.0f;
        this.f13888x = (int) ((f14 + f20) - f21);
        float f22 = f11 * f19;
        float f23 = (f13 * f9) / 2.0f;
        this.f13889y = (int) ((f16 + f22) - f23);
        ...
        this.mMode = 1;
        float f24 = (int) ((motionPaths.f13888x + f20) - f21);
        float f25 = (int) ((motionPaths.f13889y + f22) - f23);
        this.f13888x = f24 + ((-f19) * f10);
        this.f13889y = f25 + (f18 * f10);
    ...
    void initPolar(int i8, int i9, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                float f18 = motionPaths2.f13888x;
                float f19 = motionPaths.f13888x;
                this.f13888x = (f12 * (f18 - f19)) + f19;
                if (!Float.isNaN(keyPosition.mPercentY)) {
                    f13 = keyPosition.mPercentY;
                }
                float f20 = motionPaths2.f13889y;
                float f21 = motionPaths.f13889y;
                this.f13889y = (f13 * (f20 - f21)) + f21;
            } else {
                if (Float.isNaN(keyPosition.mPercentX)) {
                    float f22 = motionPaths2.f13888x;
                    float f23 = motionPaths.f13888x;
                    min = ((f22 - f23) * f13) + f23;
                } else {
                ...
                this.f13888x = min;
                if (Float.isNaN(keyPosition.mPercentY)) {
                    float f24 = motionPaths2.f13889y;
                    float f25 = motionPaths.f13889y;
                    f11 = (f13 * (f24 - f25)) + f25;
                } else {
            ...
            float f26 = motionPaths2.f13888x;
            float f27 = motionPaths.f13888x;
            this.f13888x = (f10 * (f26 - f27)) + f27;
            if (!Float.isNaN(keyPosition.mPercentY)) {
                f13 = keyPosition.mPercentY;
            }
            float f28 = motionPaths2.f13889y;
            float f29 = motionPaths.f13889y;
            this.f13889y = (f13 * (f28 - f29)) + f29;
        }
    ...
    void initScreen(int i8, int i9, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        this.position = this.time;
        float f15 = motionPaths.f13888x;
        float f16 = motionPaths.f13889y;
        float f17 = motionPaths2.f13888x + (f11 / 2.0f);
        float f18 = motionPaths2.f13889y + (f13 / 2.0f);
        float f19 = (f11 - f12) * f8;
        this.f13888x = (int) ((f15 + ((f17 - ((f12 / 2.0f) + f15)) * f10)) - (f19 / 2.0f));
        float f20 = (f13 - f14) * f9;
        this.f13889y = (int) ((f16 + ((f18 - (f16 + (f14 / 2.0f))) * f10)) - (f20 / 2.0f));
        this.width = (int) (f12 + f19);
        this.height = (int) (f14 + f20);
        this.mMode = 2;
        if (!Float.isNaN(keyPosition.mPercentX)) {
            this.f13888x = (int) (keyPosition.mPercentX * ((int) (i8 - this.width)));
        }
        if (!Float.isNaN(keyPosition.mPercentY)) {
            this.f13889y = (int) (keyPosition.mPercentY * ((int) (i9 - this.height)));
        }
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    ...
    public void setView(float f8, View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3, boolean z8) {
        float f9;
        float f10;
        float f11 = this.f13888x;
        float f12 = this.f13889y;
    ...
    public void setupRelative(MotionController motionController, MotionPaths motionPaths) {
        double d8 = ((this.f13888x + (this.width / 2.0f)) - motionPaths.f13888x) - (motionPaths.width / 2.0f);
        double d9 = ((this.f13889y + (this.height / 2.0f)) - motionPaths.f13889y) - (motionPaths.height / 2.0f);
        this.mRelativeToController = motionController;
        this.f13888x = (float) Math.hypot(d9, d8);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f13889y = (float) (Math.atan2(d9, d8) + 1.5707963267948966d);
        } else {
            this.f13889y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    public void getCenter(double d8, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        float f8;
        float f9 = this.f13888x;
        float f10 = this.f13889y;
