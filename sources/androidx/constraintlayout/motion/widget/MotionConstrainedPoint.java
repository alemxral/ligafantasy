...
public class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        int i8 = 0;
        float[] fArr = {this.position, this.f13886x, this.f13887y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        for (int i9 : iArr) {
            if (i9 < 18) {
                dArr[i8] = fArr[r5];
                i8++;
    ...
    void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f13886x, motionConstrainedPoint.f13886x);
        zArr[2] = zArr[2] | diff(this.f13887y, motionConstrainedPoint.f13887y);
