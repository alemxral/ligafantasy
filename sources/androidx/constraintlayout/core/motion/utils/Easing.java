...
public class Easing {
    ...
    static class CubicEasing extends Easing {
        ...
        CubicEasing(String str) {
            ...
            this.f13876x1 = Double.parseDouble(str.substring(indexOf + 1, indexOf2).trim());
            int i8 = indexOf2 + 1;
            int indexOf3 = str.indexOf(44, i8);
            this.f13878y1 = Double.parseDouble(str.substring(i8, indexOf3).trim());
            int i9 = indexOf3 + 1;
            int indexOf4 = str.indexOf(44, i9);
            this.f13877x2 = Double.parseDouble(str.substring(i9, indexOf4).trim());
            int i10 = indexOf4 + 1;
            this.f13879y2 = Double.parseDouble(str.substring(i10, str.indexOf(41, i10)).trim());
        }

        private double getDiffX(double d8) {
            double d9 = 1.0d - d8;
            double d10 = this.f13876x1;
            double d11 = this.f13877x2;
            return (d9 * 3.0d * d9 * d10) + (d9 * 6.0d * d8 * (d11 - d10)) + (3.0d * d8 * d8 * (1.0d - d11));
        }

        private double getDiffY(double d8) {
            double d9 = 1.0d - d8;
            double d10 = this.f13878y1;
            double d11 = this.f13879y2;
            return (d9 * 3.0d * d9 * d10) + (d9 * 6.0d * d8 * (d11 - d10)) + (3.0d * d8 * d8 * (1.0d - d11));
        }
        ...
        private double getX(double d8) {
            double d9 = 1.0d - d8;
            double d10 = 3.0d * d9;
            return (this.f13876x1 * d9 * d10 * d8) + (this.f13877x2 * d10 * d8 * d8) + (d8 * d8 * d8);
        }

        private double getY(double d8) {
            double d9 = 1.0d - d8;
            double d10 = 3.0d * d9;
            return (this.f13878y1 * d9 * d10 * d8) + (this.f13879y2 * d10 * d8 * d8) + (d8 * d8 * d8);
        }
