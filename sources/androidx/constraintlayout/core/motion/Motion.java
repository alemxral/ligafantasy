...
public class Motion implements TypedValues {
    ...
    void getDpDt(float f8, float f9, float f10, float[] fArr) {
        ...
        float f12 = motionPaths.f13874x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f13 = f12 - motionPaths2.f13874x;
        float f14 = motionPaths.f13875y - motionPaths2.f13875y;
    ...
    public float getFinalX() {
        return this.mEndMotionPath.f13874x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f13875y;
    }
    ...
    float getKeyFrameParameter(int i8, float f8, float f9) {
        MotionPaths motionPaths = this.mEndMotionPath;
        float f10 = motionPaths.f13874x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f11 = motionPaths2.f13874x;
        float f12 = f10 - f11;
        float f13 = motionPaths.f13875y;
        float f14 = motionPaths2.f13875y;
        float f15 = f13 - f14;
    ...
    public float getStartX() {
        return this.mStartMotionPath.f13874x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f13875y;
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f8, long j8, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            MotionPaths motionPaths = this.mStartMotionPath;
            float f13 = motionPaths.f13874x;
            MotionPaths motionPaths2 = this.mEndMotionPath;
            float f14 = f13 + ((motionPaths2.f13874x - f13) * f12);
            float f15 = motionPaths.f13875y;
            float f16 = f15 + ((motionPaths2.f13875y - f15) * f12);
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f13874x + " y: " + this.mStartMotionPath.f13875y + " end: x: " + this.mEndMotionPath.f13874x + " y: " + this.mEndMotionPath.f13875y;
    }
