...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z8) {
        boolean diff = diff(this.f13874x, motionPaths.f13874x);
        boolean diff2 = diff(this.f13875y, motionPaths.f13875y);
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f13874x, this.f13875y, this.width, this.height, this.mPathRotate};
        int i8 = 0;
        for (int i9 : iArr) {
            if (i9 < 6) {
                dArr[i8] = fArr[r2];
    ...
    public void getCenter(double d8, int[] iArr, double[] dArr, float[] fArr, int i8) {
        float f8 = this.f13874x;
        float f9 = this.f13875y;
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f17 = motionPaths.f13874x;
        float f18 = motionPaths.f13875y;
        float f19 = (motionPaths2.f13874x + (f13 / 2.0f)) - ((f14 / 2.0f) + f17);
        float f20 = (motionPaths2.f13875y + (f15 / 2.0f)) - (f18 + (f16 / 2.0f));
        float f21 = ((f13 - f14) * f8) / 2.0f;
        this.f13874x = (int) ((f17 + (f19 * f12)) - f21);
        float f22 = ((f15 - f16) * f9) / 2.0f;
        this.f13875y = (int) ((f18 + (f20 * f12)) - f22);
        ...
        this.mMode = 0;
        this.f13874x = (int) (((motionPaths.f13874x + (f10 * f19)) + (f23 * f20)) - f21);
        this.f13875y = (int) (((motionPaths.f13875y + (f19 * f11)) + (f20 * f12)) - f22);
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f14 = motionPaths.f13874x;
        float f15 = motionPaths.width;
        float f16 = motionPaths.f13875y;
        float f17 = motionPaths.height;
        float f18 = (motionPaths2.f13874x + (motionPaths2.width / 2.0f)) - ((f15 / 2.0f) + f14);
        float f19 = (motionPaths2.f13875y + (motionPaths2.height / 2.0f)) - ((f17 / 2.0f) + f16);
        float f20 = f18 * f11;
        float f21 = (f12 * f8) / 2.0f;
        this.f13874x = (int) ((f14 + f20) - f21);
        float f22 = f11 * f19;
        float f23 = (f13 * f9) / 2.0f;
        this.f13875y = (int) ((f16 + f22) - f23);
        ...
        this.mMode = 1;
        float f24 = (int) ((motionPaths.f13874x + f20) - f21);
        float f25 = (int) ((motionPaths.f13875y + f22) - f23);
        this.f13874x = f24 + ((-f19) * f10);
        this.f13875y = f25 + (f18 * f10);
    ...
    void initPolar(int i8, int i9, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                float f18 = motionPaths2.f13874x;
                float f19 = motionPaths.f13874x;
                this.f13874x = (f12 * (f18 - f19)) + f19;
                if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                    f13 = motionKeyPosition.mPercentY;
                }
                float f20 = motionPaths2.f13875y;
                float f21 = motionPaths.f13875y;
                this.f13875y = (f13 * (f20 - f21)) + f21;
            } else {
                if (Float.isNaN(motionKeyPosition.mPercentX)) {
                    float f22 = motionPaths2.f13874x;
                    float f23 = motionPaths.f13874x;
                    min = ((f22 - f23) * f13) + f23;
                } else {
                ...
                this.f13874x = min;
                if (Float.isNaN(motionKeyPosition.mPercentY)) {
                    float f24 = motionPaths2.f13875y;
                    float f25 = motionPaths.f13875y;
                    f11 = (f13 * (f24 - f25)) + f25;
                } else {
            ...
            float f26 = motionPaths2.f13874x;
            float f27 = motionPaths.f13874x;
            this.f13874x = (f10 * (f26 - f27)) + f27;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f13 = motionKeyPosition.mPercentY;
            }
            float f28 = motionPaths2.f13875y;
            float f29 = motionPaths.f13875y;
            this.f13875y = (f13 * (f28 - f29)) + f29;
        }
    ...
    void initScreen(int i8, int i9, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        this.position = this.time;
        float f15 = motionPaths.f13874x;
        float f16 = motionPaths.f13875y;
        float f17 = motionPaths2.f13874x + (f11 / 2.0f);
        float f18 = motionPaths2.f13875y + (f13 / 2.0f);
        float f19 = (f11 - f12) * f8;
        this.f13874x = (int) ((f15 + ((f17 - ((f12 / 2.0f) + f15)) * f10)) - (f19 / 2.0f));
        float f20 = (f13 - f14) * f9;
        this.f13875y = (int) ((f16 + ((f18 - (f16 + (f14 / 2.0f))) * f10)) - (f20 / 2.0f));
        this.width = (int) (f12 + f19);
        this.height = (int) (f14 + f20);
        this.mMode = 2;
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            this.f13874x = (int) (motionKeyPosition.mPercentX * ((int) (i8 - this.width)));
        }
        if (!Float.isNaN(motionKeyPosition.mPercentY)) {
            this.f13875y = (int) (motionKeyPosition.mPercentY * ((int) (i9 - this.height)));
        }
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    ...
    public void setupRelative(Motion motion, MotionPaths motionPaths) {
        double d8 = ((this.f13874x + (this.width / 2.0f)) - motionPaths.f13874x) - (motionPaths.width / 2.0f);
        double d9 = ((this.f13875y + (this.height / 2.0f)) - motionPaths.f13875y) - (motionPaths.height / 2.0f);
        this.mRelativeToController = motion;
        this.f13874x = (float) Math.hypot(d9, d8);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f13875y = (float) (Math.atan2(d9, d8) + 1.5707963267948966d);
        } else {
            this.f13875y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
