        ...
        synchronized (this.lock) {
            try {
                if (this.INSTANCE == null) {
                    ...
                    OkioStorage okioStorage = new OkioStorage(AbstractC1285k.f8077b, this.serializer, null, new DataStoreSingletonDelegate$getValue$1$1(applicationContext, this), 4, null);
