...
public final class FlowLiveDataConversions {
    ...
    public static final <T> LiveData<T> asLiveData(InterfaceC3358f interfaceC3358f, P5.g context, long j8) {
        AbstractC3159y.i(interfaceC3358f, "<this>");
        AbstractC3159y.i(context, "context");
        ComputableLiveData$_liveData$1 computableLiveData$_liveData$1 = (LiveData<T>) CoroutineLiveDataKt.liveData(context, j8, new FlowLiveDataConversions$asLiveData$1(interfaceC3358f, null));
        if (interfaceC3358f instanceof InterfaceC3349K) {
            if (ArchTaskExecutor.getInstance().isMainThread()) {
                computableLiveData$_liveData$1.setValue(((InterfaceC3349K) interfaceC3358f).getValue());
            } else {
                computableLiveData$_liveData$1.postValue(((InterfaceC3349K) interfaceC3358f).getValue());
            }
        }
