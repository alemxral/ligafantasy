...
public final class C3396a implements m3.d {
    ...
    private static final C0794a f34880g = new C0794a(null);

    /* renamed from: h, reason: collision with root package name */
    public static final int f34881h = 8;

    /* renamed from: a, reason: collision with root package name */
    private final m f34882a;

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC3873c f34883b;

    /* renamed from: c, reason: collision with root package name */
    private final PaymentAnalyticsRequestFactory f34884c;

    /* renamed from: d, reason: collision with root package name */
    private final InterfaceC3864B f34885d;

    /* renamed from: e, reason: collision with root package name */
    private final InterfaceC3684d f34886e;

    /* renamed from: f, reason: collision with root package name */
    private final g f34887f;
    ...
    public static final class b extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f34892e = obj;
            this.f34894g |= Integer.MIN_VALUE;
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f34899e = obj;
            this.f34901g |= Integer.MIN_VALUE;
    ...
    static final class d extends l implements n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ h f34904c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ C3396a f34905d;
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            return new d(this.f34904c, this.f34905d, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                if (hVar instanceof h.f) {
                    this.f34905d.f34883b.a(this.f34905d.f34884c.p(PaymentAnalyticsEvent.f24823Y, ((h.f) this.f34904c).f()));
                } else if (hVar instanceof h.c) {
                    this.f34905d.f34883b.a(this.f34905d.f34884c.p(PaymentAnalyticsEvent.f24823Y, ((h.c) this.f34904c).f()));
                } else if (hVar instanceof h.a) {
                    this.f34905d.f34883b.a(this.f34905d.f34884c.p(PaymentAnalyticsEvent.f24822X, ((h.a) this.f34904c).f()));
                } else if (hVar instanceof h.d) {
                    this.f34905d.f34883b.a(PaymentAnalyticsRequestFactory.v(this.f34905d.f34884c, PaymentAnalyticsEvent.f24824Z, null, null, null, null, null, 62, null));
                } else if (hVar instanceof h.e) {
                    this.f34905d.f34883b.a(PaymentAnalyticsRequestFactory.v(this.f34905d.f34884c, PaymentAnalyticsEvent.f24824Z, null, null, null, null, null, 62, null));
                } else if (hVar instanceof h.g) {
                    this.f34905d.f34883b.a(this.f34905d.f34884c.p(PaymentAnalyticsEvent.f24840p0, ((h.g) this.f34904c).f()));
                }
                InterfaceC3873c interfaceC3873c = this.f34905d.f34883b;
                PaymentAnalyticsRequestFactory paymentAnalyticsRequestFactory = this.f34905d.f34884c;
                PaymentAnalyticsEvent paymentAnalyticsEvent = PaymentAnalyticsEvent.f24821W;
                Y3.g b8 = this.f34904c.b();
                if (b8 != null) {
                    str = b8.b();
                } else {
                    str = null;
                ...
                j.c cVar2 = new j.c(this.f34904c.c().e(), this.f34904c.c().c(), null, 4, null);
                C3396a c3396a = this.f34905d;
                h hVar2 = this.f34904c;
                this.f34902a = cVar2;
                this.f34903b = 1;
            ...
            if (((Boolean) obj).booleanValue()) {
                ...
                return new C2662c(this.f34904c.c().d(), i9, null, false, null, null, cVar.j(), 60, null);
            }
            i9 = 2;
            return new C2662c(this.f34904c.c().d(), i9, null, false, null, null, cVar.j(), 60, null);
        }
    ...
    public C3396a(m stripeRepository, InterfaceC3873c analyticsRequestExecutor, PaymentAnalyticsRequestFactory paymentAnalyticsRequestFactory, InterfaceC3864B retryDelaySupplier, InterfaceC3684d logger, g workContext) {
        ...
        this.f34882a = stripeRepository;
        this.f34883b = analyticsRequestExecutor;
        this.f34884c = paymentAnalyticsRequestFactory;
        this.f34885d = retryDelaySupplier;
        this.f34886e = logger;
        this.f34887f = workContext;
    }
    ...
    */
    public final java.lang.Object f(com.stripe.android.stripe3ds2.transaction.h r8, x2.j.c r9, int r10, P5.d r11) {
        ...
        L14:
            ...
            goto L12
        L1a:
            java.lang.Object r11 = r6.f34892e
    ...
    */
    public final java.lang.Object h(com.stripe.android.stripe3ds2.transaction.h r7, x2.j.c r8, int r9, java.lang.Throwable r10, P5.d r11) {
        ...
        L13:
            ...
            r0.<init>(r11)
        L18:
            java.lang.Object r11 = r0.f34899e
    ...
    public Object a(h hVar, P5.d dVar) {
        return AbstractC2825i.g(this.f34887f, new d(hVar, this, null), dVar);
    }
}
