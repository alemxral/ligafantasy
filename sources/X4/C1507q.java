...
public final class C1507q implements Parcelable {
    ...
    public static final b f12689c = new b(null);
    ...
    public final void e(JSONObject jsonObject) {
        ...
        try {
            if (!jsonObject.isNull("question")) {
                this.f12690a = jsonObject.getString("question");
            }
            if (!jsonObject.isNull("answer")) {
                this.f12691b = jsonObject.getString("answer");
            }
        } catch (Exception e8) {
            e8.printStackTrace();
        }
    ...
    public C1507q(Parcel source) {
        AbstractC3159y.i(source, "source");
        this.f12690a = source.readString();
        this.f12691b = source.readString();
    }
}
