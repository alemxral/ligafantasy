...
public final class C1503m {
    ...
    public static final class a {
        ...
        public static final class C0241a extends AbstractC3160z implements Function1 {
            ...
            /* renamed from: a, reason: collision with root package name */
            public static final C0241a f12637a = new C0241a();
        ...
        public final List a(String inputText, String tag) {
            ...
            return AbstractC2683j.D(AbstractC2683j.y(g6.j.d(new g6.j(tag), inputText, 0, 2, null), C0241a.f12637a));
        }
        ...
        public final String c(SpannableStringBuilder spannableStringBuilder) {
            ...
            return g6.n.A(new g6.j("<(\\w+)>(.*?)</(\\w+)>").g(new g6.j("\\[(\\w+)=([\\w\\d]*)](.*?)\\[/(\\w+)]").g(spannableStringBuilder, c.f12638a), d.f12639a), "<br />", "", false, 4, null);
        }
