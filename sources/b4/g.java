...
public abstract class g {
    ...
    public static final class a {
        ...
        public static final class C0361a extends AbstractC3160z implements Function1 {
            ...
            /* renamed from: a, reason: collision with root package name */
            public static final C0361a f14610a = new C0361a();
        ...
        public final List e(String string) {
            ...
            return AbstractC2683j.D(AbstractC2683j.p(AbstractC2683j.g(AbstractC2683j.y(g6.j.d(new g6.j("[*([A-Za-z_0-9]+)]*"), string, 0, 2, null), C0361a.f14610a)), b.f14611a));
        }
        ...
        public final com.stripe.android.model.p g(Map fieldValuePairs, String code, boolean z8, o.b bVar) {
            ...
            for (Map.Entry entry : fieldValuePairs.entrySet()) {
                if (((G) entry.getKey()).h0() == P.a.f35173a) {
            ...
            return com.stripe.android.model.p.f24568u.o(code, g.f14609a.c(linkedHashMap2), z8, Q.y(b8), a0.d("PaymentSheet"), bVar);
        }
        ...
        public final q h(Map fieldValuePairs, String code) {
            ...
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            for (Map.Entry entry : fieldValuePairs.entrySet()) {
                if (((G) entry.getKey()).h0() == P.b.f35177a) {
                    linkedHashMap.put(entry.getKey(), entry.getValue());
                }
            }
            boolean d8 = AbstractC3159y.d(code, o.p.f24525o.f24537a);
            Boolean bool = null;
            if (!d8) {
                return null;
            }
        ...
        public final r i(Map fieldValuePairs, String code) {
            ...
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            for (Map.Entry entry : fieldValuePairs.entrySet()) {
                if (((G) entry.getKey()).h0() == P.a.f35174b) {
                    linkedHashMap.put(entry.getKey(), entry.getValue());
                }
            }
            if (AbstractC3159y.d(code, o.p.f24496B.f24537a)) {
            ...
            if (AbstractC3159y.d(code, o.p.f24512R.f24537a)) {
            ...
            if (!AbstractC3159y.d(code, o.p.f24497C.f24537a)) {
                return null;
            }
            return r.f.f24662c;
        }
