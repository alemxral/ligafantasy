...
public final class C1880b implements Parcelable {
    ...
    public C1880b(long j8, String currencyCode) {
        ...
        this.f14594a = j8;
        this.f14595b = currencyCode;
    }

    public final InterfaceC3983b b() {
        int i8 = n.f14680F;
        C3659a c3659a = C3659a.f37472a;
        long j8 = this.f14594a;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f14594a == c1880b.f14594a && AbstractC3159y.d(this.f14595b, c1880b.f14595b)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (androidx.collection.a.a(this.f14594a) * 31) + this.f14595b.hashCode();
    }

    public String toString() {
        return "Amount(value=" + this.f14594a + ", currencyCode=" + this.f14595b + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeLong(this.f14594a);
