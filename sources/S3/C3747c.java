...
public final class C3747c implements InterfaceC3746b {
    ...
    private final InterfaceC3873c f37836a;

    /* renamed from: b, reason: collision with root package name */
    private final C3875e f37837b;

    /* renamed from: c, reason: collision with root package name */
    private final g f37838c;
    ...
    public static final class a extends l implements n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ AbstractC3745a f37841c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(AbstractC3745a abstractC3745a, P5.d dVar) {
            super(2, dVar);
            this.f37841c = abstractC3745a;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new a(this.f37841c, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f37839a == 0) {
                t.b(obj);
                InterfaceC3873c interfaceC3873c = C3747c.this.f37836a;
                C3875e c3875e = C3747c.this.f37837b;
                AbstractC3745a abstractC3745a = this.f37841c;
    ...
    public C3747c(InterfaceC3873c analyticsRequestExecutor, C3875e analyticsRequestFactory, g workContext) {
        ...
        this.f37836a = analyticsRequestExecutor;
        this.f37837b = analyticsRequestFactory;
        this.f37838c = workContext;
    }

    private final void e(AbstractC3745a abstractC3745a) {
        AbstractC2829k.d(N.a(this.f37838c), null, null, new a(abstractC3745a, null), 3, null);
    }
