...
public final class C2586h {
    ...
    public static final int f30235h = 8;

    /* renamed from: a, reason: collision with root package name */
    private final DisplayMetrics f30236a;
    ...
    public C2586h(DisplayMetrics displayMetrics, String packageName, String str, String timeZone) {
        ...
        this.f30236a = displayMetrics;
        this.f30237b = packageName;
        this.f30238c = str;
        this.f30239d = timeZone;
        this.f30240e = displayMetrics.widthPixels + "w_" + displayMetrics.heightPixels + "h_" + displayMetrics.densityDpi + "dpi";
        this.f30241f = "Android " + Build.VERSION.RELEASE + " " + Build.VERSION.CODENAME + " " + Build.VERSION.SDK_INT;
    }

    private final Map a() {
        String locale = Locale.getDefault().toString();
        AbstractC3159y.h(locale, "toString(...)");
        return Q.k(x.a("c", d(locale)), x.a("d", d(this.f30241f)), x.a("f", d(this.f30240e)), x.a("g", d(this.f30239d)));
    }
    ...
    private final Map c(C2582d c2582d) {
        ...
        Map k8 = Q.k(a8, x.a("e", str3), x.a("k", this.f30237b), x.a("o", Build.VERSION.RELEASE), x.a(TtmlNode.TAG_P, Integer.valueOf(Build.VERSION.SDK_INT)), x.a(CampaignEx.JSON_KEY_AD_Q, Build.MANUFACTURER), x.a(CampaignEx.JSON_KEY_AD_R, Build.BRAND), x.a("s", Build.MODEL), x.a("t", Build.TAGS));
        String str4 = this.f30238c;
        if (str4 != null) {
            map = Q.e(x.a("l", str4));
        }
        if (map == null) {
