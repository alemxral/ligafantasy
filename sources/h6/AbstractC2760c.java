...
public abstract class AbstractC2760c {
    ...
    public static final long r(double d8, EnumC2761d unit) {
        ...
        double a8 = AbstractC2762e.a(d8, unit, EnumC2761d.f31402b);
        if (!Double.isNaN(a8)) {
            long e8 = Z5.a.e(a8);
            if (new l(-4611686018426999999L, 4611686018426999999L).l(e8)) {
                return l(e8);
            }
            return k(Z5.a.e(AbstractC2762e.a(d8, unit, EnumC2761d.f31404d)));
        }
    ...
    public static final long s(int i8, EnumC2761d unit) {
        AbstractC3159y.i(unit, "unit");
        if (unit.compareTo(EnumC2761d.f31405e) <= 0) {
            return l(AbstractC2762e.c(i8, unit, EnumC2761d.f31402b));
        }
        return t(i8, unit);
    }
    ...
    public static final long t(long j8, EnumC2761d unit) {
        AbstractC3159y.i(unit, "unit");
        EnumC2761d enumC2761d = EnumC2761d.f31402b;
        long c8 = AbstractC2762e.c(4611686018426999999L, enumC2761d, unit);
        if (new l(-c8, c8).l(j8)) {
            return l(AbstractC2762e.c(j8, unit, enumC2761d));
        }
        return j(m.m(AbstractC2762e.b(j8, unit, EnumC2761d.f31404d), -4611686018427387903L, 4611686018427387903L));
    }
}
