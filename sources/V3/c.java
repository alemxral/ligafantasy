...
public final class c implements k {
    ...
    public static final a f11886d = new a(null);

    /* renamed from: e, reason: collision with root package name */
    private static final K1.d f11887e = K1.d.f5716e;

    /* renamed from: a, reason: collision with root package name */
    private final boolean f11888a;

    /* renamed from: b, reason: collision with root package name */
    private byte f11889b;
    ...
    public String V(JSONObject challengeRequest, SecretKey secretKey) {
        ...
        K1.m a8 = a(string);
        Y y8 = Y.f33752a;
        String format = String.format(Locale.ROOT, "%03d", Arrays.copyOf(new Object[]{Byte.valueOf(this.f11889b)}, 1));
        ...
        nVar.g(new o(d(secretKey, v8), this.f11889b));
        byte b8 = (byte) (this.f11889b + 1);
        this.f11889b = b8;
        if (b8 != 0) {
            String t8 = nVar.t();
    ...
    public final K1.m a(String keyId) {
        ...
        K1.m d8 = new m.a(K1.i.f5747l, f11887e).m(keyId).d();
    ...
    public final void e(JSONObject cres) {
        ...
        if (cres.has("acsCounterAtoS")) {
            ...
            if (s.e(b8) == null) {
                ...
                if (this.f11890c == byteValue) {
                    return;
                }
                throw new Y3.c(Y3.f.f13154i, "Counters are not equal. SDK counter: " + ((int) this.f11890c) + ", ACS counter: " + ((int) byteValue));
            }
            throw Y3.c.f13119d.a("acsCounterAtoS");
        }
        throw Y3.c.f13119d.b("acsCounterAtoS");
    }
    ...
    public boolean equals(Object obj) {
        ...
        c cVar = (c) obj;
        if (this.f11888a == cVar.f11888a && this.f11889b == cVar.f11889b && this.f11890c == cVar.f11890c) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        boolean z8 = this.f11888a;
        ?? r02 = z8;
        if (z8) {
            r02 = 1;
        }
        return (((r02 * 31) + this.f11889b) * 31) + this.f11890c;
    }

    public String toString() {
        return "DefaultMessageTransformer(isLiveMode=" + this.f11888a + ", counterSdkToAcs=" + ((int) this.f11889b) + ", counterAcsToSdk=" + ((int) this.f11890c) + ")";
    }
