...
public final class b implements i {
    ...
    public String a(String payload, PublicKey acsPublicKey, String directoryServerId, String str) {
        ...
        if (acsPublicKey instanceof RSAPublicKey) {
            s.a aVar = s.f6498b;
            b8 = s.b(this.f11883a.b(payload, (RSAPublicKey) acsPublicKey, str));
        } else if (acsPublicKey instanceof ECPublicKey) {
            s.a aVar2 = s.f6498b;
            b8 = s.b(this.f11884b.a(payload, (ECPublicKey) acsPublicKey, directoryServerId));
        } else {
            s.a aVar3 = s.f6498b;
