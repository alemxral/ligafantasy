...
public final class f {
    ...
    private final U3.c f11906a;

    /* renamed from: b, reason: collision with root package name */
    private final KeyFactory f11907b;

    public f(U3.c errorReporter) {
        Object b8;
        AbstractC3159y.i(errorReporter, "errorReporter");
        this.f11906a = errorReporter;
        try {
            s.a aVar = s.f6498b;
    ...
    public final ECPrivateKey a(byte[] privateKeyEncoded) {
        ...
        try {
            s.a aVar = s.f6498b;
            PrivateKey generatePrivate = this.f11907b.generatePrivate(new PKCS8EncodedKeySpec(privateKeyEncoded));
    ...
    public final ECPublicKey b(byte[] publicKeyEncoded) {
        ...
        try {
            s.a aVar = s.f6498b;
            PublicKey generatePublic = this.f11907b.generatePublic(new X509EncodedKeySpec(publicKeyEncoded));
