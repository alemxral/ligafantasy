...
public final class h {
    ...
    public final String a(String payload, ECPublicKey acsPublicKey, String directoryServerId) {
        ...
        K1.n nVar = new K1.n(new m.a(K1.i.f5747l, K1.d.f5716e).i(R1.b.x(new b.a(aVar, (ECPublicKey) publicKey).a().o())).d(), new w(payload));
        nVar.g(new L1.b(z8));
        String t8 = nVar.t();
