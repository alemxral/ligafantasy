...
public class C1853c {
    ...
    private File a() {
        if (this.f14246a == null) {
            synchronized (this) {
                try {
                    if (this.f14246a == null) {
                        this.f14246a = new File(this.f14247b.k().getFilesDir(), "PersistedInstallation." + this.f14247b.o() + ".json");
                    }
                } finally {
                }
            }
    ...
    public AbstractC1854d b(AbstractC1854d abstractC1854d) {
        ...
        try {
            ...
            createTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f14247b.k().getFilesDir());
