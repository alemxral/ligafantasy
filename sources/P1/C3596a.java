...
public class C3596a implements Closeable {
    ...
    private final char[] f36967c = new char[1024];
    ...
    public C3596a(Reader reader) {
        ...
        this.f36976l = iArr;
        iArr[0] = 6;
        this.f36978n = new String[32];
        this.f36979o = new int[32];
        Objects.requireNonNull(reader, "in == null");
        this.f36965a = reader;
    }

    private int I(boolean z8) {
        char[] cArr = this.f36967c;
        int i8 = this.f36968d;
        int i9 = this.f36969e;
        while (true) {
            if (i8 == i9) {
    ...
    */
    ...
    private int O() {
        ...
        String str2;
        int i8;
        char c8 = this.f36967c[this.f36968d];
        if (c8 != 't' && c8 != 'T') {
            if (c8 != 'f' && c8 != 'F') {
                if (c8 != 'n' && c8 != 'N') {
                    return 0;
        ...
        for (int i9 = 1; i9 < length; i9++) {
            if (this.f36968d + i9 >= this.f36969e && !m(i9 + 1)) {
                return 0;
            }
            char c9 = this.f36967c[this.f36968d + i9];
            if (c9 != str.charAt(i9) && c9 != str2.charAt(i9)) {
                return 0;
            }
        }
        if ((this.f36968d + length < this.f36969e || m(length + 1)) && w(this.f36967c[this.f36968d + length])) {
            return 0;
        }
        this.f36968d += length;
        this.f36972h = i8;
    ...
    */
    ...
    private void Q(int i8) {
        int i9 = this.f36977m;
        int[] iArr = this.f36976l;
        if (i9 == iArr.length) {
            int i10 = i9 * 2;
            this.f36976l = Arrays.copyOf(iArr, i10);
            this.f36979o = Arrays.copyOf(this.f36979o, i10);
            this.f36978n = (String[]) Arrays.copyOf(this.f36978n, i10);
        }
        int[] iArr2 = this.f36976l;
        int i11 = this.f36977m;
        this.f36977m = i11 + 1;
        iArr2[i11] = i8;
    }
    ...
    private char R() {
        int i8;
        if (this.f36968d == this.f36969e && !m(1)) {
                                ...
                                if (c8 == 'u') {
                                    ...
                                    while (i11 < i12) {
                                        ...
                                        if (c10 >= '0' && c10 <= '9') {
                                            ...
                                            throw new NumberFormatException("\\u" + new String(this.f36967c, this.f36968d, 4));
                                        }
                                        c9 = (char) (c11 + i8);
                                        i11++;
                                    }
    ...
    private boolean U(String str) {
        int length = str.length();
        while (true) {
            if (this.f36968d + length > this.f36969e && !m(length)) {
                return false;
            }
            char[] cArr = this.f36967c;
            int i8 = this.f36968d;
            if (cArr[i8] == '\n') {
                ...
                for (int i9 = 0; i9 < length; i9++) {
                    if (this.f36967c[this.f36968d + i9] != str.charAt(i9)) {
                        break;
                    }
                }
                return true;
    ...
    private boolean m(int i8) {
        ...
        int i10;
        char[] cArr = this.f36967c;
        int i11 = this.f36971g;
        int i12 = this.f36968d;
        this.f36971g = i11 - i12;
        int i13 = this.f36969e;
        if (i13 != i12) {
            int i14 = i13 - i12;
            this.f36969e = i14;
        ...
        this.f36968d = 0;
        do {
            Reader reader = this.f36965a;
            int i15 = this.f36969e;
            int read = reader.read(cArr, i15, cArr.length - i15);
            if (read == -1) {
                return false;
            }
            i9 = this.f36969e + read;
            this.f36969e = i9;
            if (this.f36970f == 0 && (i10 = this.f36971g) == 0 && i9 > 0 && cArr[0] == 65279) {
                this.f36968d++;
                this.f36971g = i10 + 1;
                i8++;
            }
    ...
    private String o(boolean z8) {
        ...
        while (true) {
            int i9 = this.f36977m;
            if (i8 < i9) {
                int i10 = this.f36976l[i8];
                if (i10 != 1 && i10 != 2) {
                    if (i10 == 3 || i10 == 4 || i10 == 5) {
                        sb.append('.');
                        String str = this.f36978n[i8];
                        if (str != null) {
                            sb.append(str);
                        }
                    }
                } else {
                    int i11 = this.f36979o[i8];
                    if (z8 && i11 > 0 && i8 == i9 - 1) {
                        i11--;
                    }
                    sb.append('[');
    ...
    public boolean A() {
        ...
        if (i8 == 5) {
            this.f36972h = 0;
            int[] iArr = this.f36979o;
            int i9 = this.f36977m - 1;
            iArr[i9] = iArr[i9] + 1;
            return true;
        }
        if (i8 == 6) {
            this.f36972h = 0;
            int[] iArr2 = this.f36979o;
            int i10 = this.f36977m - 1;
    ...
    public double E() {
        ...
        if (i8 == 16) {
            this.f36975k = new String(this.f36967c, this.f36968d, this.f36974j);
            this.f36968d += this.f36974j;
        } else if (i8 != 8 && i8 != 9) {
            if (i8 == 10) {
                this.f36975k = M();
            } else if (i8 != 11) {
        ...
        this.f36972h = 11;
        double parseDouble = Double.parseDouble(this.f36975k);
        if (!this.f36966b && (Double.isNaN(parseDouble) || Double.isInfinite(parseDouble))) {
    ...
    public int F() {
        ...
        if (i8 == 15) {
            ...
            throw new NumberFormatException("Expected an int but was " + this.f36973i + x());
        }
        if (i8 == 16) {
            this.f36975k = new String(this.f36967c, this.f36968d, this.f36974j);
            this.f36968d += this.f36974j;
            ...
            try {
                int parseInt = Integer.parseInt(this.f36975k);
                this.f36972h = 0;
                int[] iArr2 = this.f36979o;
                int i11 = this.f36977m - 1;
        ...
        if (i12 == parseDouble) {
            this.f36975k = null;
            this.f36972h = 0;
            int[] iArr3 = this.f36979o;
            int i13 = this.f36977m - 1;
            iArr3[i13] = iArr3[i13] + 1;
            return i12;
        }
        throw new NumberFormatException("Expected an int but was " + this.f36975k + x());
    }
    ...
    public long G() {
        ...
        if (i8 == 16) {
            ...
            try {
                long parseLong = Long.parseLong(this.f36975k);
                this.f36972h = 0;
                int[] iArr2 = this.f36979o;
                int i10 = this.f36977m - 1;
                iArr2[i10] = iArr2[i10] + 1;
        ...
        throw new NumberFormatException("Expected a long but was " + this.f36975k + x());
    }
    ...
    public String H() {
        ...
        this.f36972h = 0;
        this.f36978n[this.f36977m - 1] = K8;
        return K8;
    }
    ...
    public String L() {
        ...
        if (i8 == 10) {
            ...
            str = Long.toString(this.f36973i);
        } else if (i8 == 16) {
            str = new String(this.f36967c, this.f36968d, this.f36974j);
            this.f36968d += this.f36974j;
        } else {
    ...
    public void X() {
        ...
        do {
            ...
            switch (i9) {
                ...
                case 2:
                    if (i8 == 0) {
                        this.f36978n[this.f36977m - 1] = null;
                    }
                    this.f36977m--;
                    i8--;
                    this.f36972h = 0;
                ...
                case 12:
                    T('\'');
                    if (i8 == 0) {
                        this.f36978n[this.f36977m - 1] = "<skipped>";
                    }
                    this.f36972h = 0;
                    break;
                case 13:
                    ...
                    if (I12 != 91) {
                        if (I12 != 93) {
                            if (I12 != 123) {
                                ...
                                if (w(this.f36967c[this.f36968d])) {
                                    e();
                                    this.f36972h = 10;
                                    return 10;
                                }
    ...
    String x() {
        return " at line " + (this.f36970f + 1) + " column " + ((this.f36968d - this.f36971g) + 1) + " path " + getPath();
    }
}
