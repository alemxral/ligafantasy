...
public abstract class j {
    ...
    public static final class b extends AbstractC3160z implements n {
        ...
        final /* synthetic */ O f8350a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ long f8351b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ S f8352c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ InterfaceC1281g f8353d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ S f8354e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ S f8355f;
            ...
            if (i8 == 1) {
                ...
                if (!o8.f33743a) {
                    ...
                    if (j8 >= this.f8351b) {
                        ...
                        long j10 = s8.f33746a;
                        if (j10 == 4294967295L) {
                            j10 = this.f8353d.readLongLe();
                        }
                        s8.f33746a = j10;
                        S s9 = this.f8354e;
                        long j11 = 0;
                        if (s9.f33746a == 4294967295L) {
                            j9 = this.f8353d.readLongLe();
                        } else {
                            j9 = 0;
                        }
                        s9.f33746a = j9;
                        S s10 = this.f8355f;
                        if (s10.f33746a == 4294967295L) {
                            j11 = this.f8353d.readLongLe();
                        }
                        s10.f33746a = j11;
                        return;
                    }
    ...
    public static final class c extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ InterfaceC1281g f8356a;
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ T f8359d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(InterfaceC1281g interfaceC1281g, T t8, T t9, T t10) {
            super(2);
            this.f8356a = interfaceC1281g;
            this.f8357b = t8;
            this.f8358c = t9;
            this.f8359d = t10;
        }
        ...
        public final void a(int i8, long j8) {
            ...
            if (i8 == 21589) {
                long j9 = 1;
                if (j8 >= 1) {
                    byte readByte = this.f8356a.readByte();
                    boolean z10 = false;
                    if ((readByte & 1) == 1) {
                        z8 = true;
                    } else {
                    ...
                    InterfaceC1281g interfaceC1281g = this.f8356a;
                    if (z8) {
                        j9 = 5;
                    }
                    if (z9) {
                    ...
                    if (j8 >= j9) {
                        if (z8) {
                            this.f8357b.f33747a = Long.valueOf(interfaceC1281g.readIntLe() * 1000);
                        }
                        if (z9) {
                            this.f8358c.f33747a = Long.valueOf(this.f8356a.readIntLe() * 1000);
                        }
                        if (z10) {
                            this.f8359d.f33747a = Long.valueOf(this.f8356a.readIntLe() * 1000);
                            return;
                        }
                        return;
                    }
    ...
    private static final Map a(List list) {
        Q e8 = Q.a.e(Q.f7988b, "/", false, 1, null);
    ...
    public static final i e(InterfaceC1281g interfaceC1281g) {
        ...
        if (readIntLe == 33639248) {
            ...
            if ((readShortLe & 1) == 0) {
                ...
                S s8 = new S();
                s8.f33746a = interfaceC1281g.readIntLe() & 4294967295L;
                S s9 = new S();
                s9.f33746a = interfaceC1281g.readIntLe() & 4294967295L;
                ...
                S s10 = new S();
                s10.f33746a = interfaceC1281g.readIntLe() & 4294967295L;
                ...
                if (!g6.n.G(readUtf8, (char) 0, false, 2, null)) {
                    ...
                    return new i(Q.a.e(Q.f7988b, "/", false, 1, null).l(readUtf8), g6.n.r(readUtf8, "/", false, 2, null), interfaceC1281g.readUtf8(readShortLe5), readIntLe2, s8.f33746a, s9.f33746a, readShortLe2, b8, s10.f33746a);
                }
    ...
    private static final C1284j i(InterfaceC1281g interfaceC1281g, C1284j c1284j) {
        ...
        if (readIntLe == 67324752) {
            ...
            if ((readShortLe & 1) == 0) {
                ...
                return new C1284j(c1284j.d(), c1284j.c(), null, c1284j.b(), (Long) t10.f33747a, (Long) t8.f33747a, (Long) t9.f33747a, null, 128, null);
            }
            throw new IOException("unsupported zip: general purpose bit flag=" + c(i8));
        }
