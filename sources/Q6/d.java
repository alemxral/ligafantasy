...
public abstract class d {
    ...
    private static final C1282h f8324a;

    /* renamed from: b, reason: collision with root package name */
    private static final C1282h f8325b;

    /* renamed from: c, reason: collision with root package name */
    private static final C1282h f8326c;

    /* renamed from: d, reason: collision with root package name */
    private static final C1282h f8327d;

    /* renamed from: e, reason: collision with root package name */
    private static final C1282h f8328e;

    static {
        C1282h.a aVar = C1282h.f8053d;
        f8324a = aVar.c("/");
        f8325b = aVar.c("\\");
        f8326c = aVar.c("/\\");
        f8327d = aVar.c(".");
    ...
    public static final int l(Q q8) {
        int w8 = C1282h.w(q8.b(), f8324a, 0, 2, null);
        if (w8 != -1) {
            return w8;
        }
        return C1282h.w(q8.b(), f8325b, 0, 2, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final C1282h m(Q q8) {
        C1282h b8 = q8.b();
        C1282h c1282h = f8324a;
        if (C1282h.q(b8, c1282h, 0, 2, null) == -1) {
            C1282h b9 = q8.b();
            C1282h c1282h2 = f8325b;
    ...
    public static final boolean n(Q q8) {
        if (!q8.b().g(f8328e) || (q8.b().F() != 2 && !q8.b().A(q8.b().F() - 3, f8324a, 0, 1) && !q8.b().A(q8.b().F() - 3, f8325b, 0, 1))) {
            return false;
        }
        return true;
    }
    ...
    private static final boolean p(C1279e c1279e, C1282h c1282h) {
        if (!AbstractC3159y.d(c1282h, f8325b) || c1279e.x() < 2 || c1279e.l(1L) != 58) {
            return false;
        }
    ...
    public static final Q q(C1279e c1279e, boolean z8) {
        ...
        while (!c1279e.exhausted()) {
            ...
            } else if (!AbstractC3159y.d(readByteString, f8327d) && !AbstractC3159y.d(readByteString, C1282h.f8054e)) {
                arrayList.add(readByteString);
            }
        }
