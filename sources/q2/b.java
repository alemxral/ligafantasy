...
public abstract class b {
    ...
    public static final class a extends AbstractC3160z implements n {
        ...
        final /* synthetic */ Modifier f37239a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ int f37240b;
        ...
        public final void invoke(Composer composer, int i8) {
            b.a(this.f37239a, composer, RecomposeScopeImplKt.updateChangedFlags(this.f37240b | 1), this.f37241c);
        }
    }
    ...
    public static final class C0851b extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Modifier f37242a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ long f37243b;
        ...
        public final void invoke(Composer composer, int i8) {
            b.b(this.f37242a, this.f37243b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f37244c | 1), this.f37245d);
        }
    }
    ...
    public static final void a(Modifier modifier, Composer composer, int i8, int i9) {
        ...
        if ((i10 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            b(SizeKt.m633height3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), PrimitiveResources_androidKt.dimensionResource(s.f37368b, startRestartGroup, 0)), 0L, startRestartGroup, 0, 2);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void b(Modifier modifier, long j8, Composer composer, int i8, int i9) {
        ...
        if ((i10 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            float dimensionResource = PrimitiveResources_androidKt.dimensionResource(s.f37369c, startRestartGroup, 0);
            float dimensionResource2 = PrimitiveResources_androidKt.dimensionResource(s.f37370d, startRestartGroup, 0);
