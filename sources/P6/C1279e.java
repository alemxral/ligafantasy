...
public final class C1279e implements InterfaceC1281g, InterfaceC1280f, Cloneable, ByteChannel {
    ...
    public void C(C1279e source, long j8) {
        ...
        if (source != this) {
            ...
            while (j8 > 0) {
                ...
                AbstractC3159y.f(u9);
                int i9 = u9.f8002c;
                AbstractC3159y.f(source.f8043a);
                if (j8 < i9 - r1.f8001b) {
                    U u10 = this.f8043a;
                    if (u10 != null) {
                    ...
                    if (u8 != null && u8.f8004e) {
                        long j9 = u8.f8002c + j8;
                        if (u8.f8003d) {
                            i8 = 0;
                        } else {
                            i8 = u8.f8001b;
                    ...
                    source.f8043a = u12.e((int) j8);
                }
                U u13 = source.f8043a;
                AbstractC3159y.f(u13);
                long j10 = u13.f8002c - u13.f8001b;
                source.f8043a = u13.b();
                U u14 = this.f8043a;
                if (u14 == null) {
                    this.f8043a = u13;
    ...
    public final C1282h E(int i8) {
        ...
        while (i9 < i8) {
            AbstractC3159y.f(u9);
            bArr[i14] = u9.f8000a;
            i9 += u9.f8002c - u9.f8001b;
            iArr[i14] = Math.min(i9, i8);
            iArr[i14 + i11] = u9.f8001b;
            u9.f8003d = true;
            i14++;
            u9 = u9.f8005f;
        }
    ...
    public final U F(int i8) {
        if (i8 >= 1 && i8 <= 8192) {
            ...
            U u9 = u8.f8006g;
            AbstractC3159y.f(u9);
            if (u9.f8002c + i8 <= 8192 && u9.f8004e) {
                return u9;
            }
            return u9.c(V.c());
        }
    ...
    public C1279e write(byte[] source, int i8, int i9) {
        ...
        while (i8 < i10) {
            U F8 = F(1);
            int min = Math.min(i10 - i8, 8192 - F8.f8002c);
            int i11 = i8 + min;
            AbstractC1239l.d(source, F8.f8000a, F8.f8002c, i8, i11);
            F8.f8002c += min;
            i8 = i11;
        }
        w(x() + j8);
    ...
    public C1279e R(String string, int i8, int i9, Charset charset) {
        ...
        if (i8 >= 0) {
            if (i9 >= i8) {
                if (i9 <= string.length()) {
                    if (AbstractC3159y.d(charset, C2728d.f31279b)) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof C1279e) {
            ...
            if (x() == c1279e.x()) {
                ...
                long j8 = 0;
                while (j8 < x()) {
                    long min = Math.min(u8.f8002c - i8, u9.f8002c - i9);
                    long j9 = 0;
                    while (j9 < min) {
                        int i10 = i8 + 1;
                        int i11 = i9 + 1;
                        if (u8.f8000a[i8] == u9.f8000a[i9]) {
                            j9++;
                            i8 = i10;
                            i9 = i11;
                        }
    ...
    public final C1279e f() {
        ...
        if (x() != 0) {
            ...
            d8.f8006g = d8;
            d8.f8005f = d8;
            for (U u9 = u8.f8005f; u9 != u8; u9 = u9.f8005f) {
                U u10 = d8.f8006g;
                AbstractC3159y.f(u10);
                AbstractC3159y.f(u9);
                u10.c(u9.d());
    ...
    public final C1279e g(C1279e out, long j8, long j9) {
        ...
        if (j9 != 0) {
            ...
            while (j9 > 0) {
                AbstractC3159y.f(u8);
                U d8 = u8.d();
                int i10 = d8.f8001b + ((int) j8);
                d8.f8001b = i10;
                d8.f8002c = Math.min(i10 + ((int) j9), d8.f8002c);
                U u9 = out.f8043a;
                if (u9 == null) {
                    d8.f8006g = d8;
                    d8.f8005f = d8;
    ...
    public int hashCode() {
        ...
        do {
            int i9 = u8.f8002c;
            for (int i10 = u8.f8001b; i10 < i9; i10++) {
                i8 = (i8 * 31) + u8.f8000a[i10];
            }
            u8 = u8.f8005f;
            AbstractC3159y.f(u8);
        } while (u8 != this.f8043a);
        return i8;
    }
        ...
        if (0 <= j8 && j8 <= j9) {
            ...
            if (x() - j8 < j8) {
                ...
                while (j10 > j8) {
                    u8 = u8.f8006g;
                    AbstractC3159y.f(u8);
                    j10 -= u8.f8002c - u8.f8001b;
                }
                while (j10 < j9) {
                    byte[] bArr = u8.f8000a;
                    int min = (int) Math.min(u8.f8002c, (u8.f8001b + j9) - j10);
                    i8 = (int) ((u8.f8001b + j8) - j10);
                    while (i8 < min) {
                        if (bArr[i8] != b8) {
                            i8++;
                        }
            ...
            while (true) {
                long j11 = (u8.f8002c - u8.f8001b) + j10;
                if (j11 > j8) {
                    break;
                }
                u8 = u8.f8005f;
            ...
            while (j10 < j9) {
                byte[] bArr2 = u8.f8000a;
                int min2 = (int) Math.min(u8.f8002c, (u8.f8001b + j9) - j10);
                i8 = (int) ((u8.f8001b + j8) - j10);
                while (i8 < min2) {
                    if (bArr2[i8] != b8) {
                        i8++;
        ...
        if (u8 != null) {
            if (x() - j8 < j8) {
                ...
                while (x8 > j8) {
                    u8 = u8.f8006g;
                    AbstractC3159y.f(u8);
                    x8 -= u8.f8002c - u8.f8001b;
                }
                AbstractC3159y.f(u8);
                return u8.f8000a[(int) ((u8.f8001b + j8) - x8)];
            }
            long j9 = 0;
            while (true) {
                long j10 = (u8.f8002c - u8.f8001b) + j9;
                if (j10 <= j8) {
                    u8 = u8.f8005f;
                    AbstractC3159y.f(u8);
                    j9 = j10;
                    ...
                    AbstractC3159y.f(u8);
                    return u8.f8000a[(int) ((u8.f8001b + j8) - j9)];
                }
            }
        } else {
    ...
    public int read(ByteBuffer sink) {
        ...
        int min = Math.min(sink.remaining(), u8.f8002c - u8.f8001b);
        sink.put(u8.f8000a, u8.f8001b, min);
        int i8 = u8.f8001b + min;
        u8.f8001b = i8;
        this.f8044b -= min;
        if (i8 == u8.f8002c) {
            this.f8043a = u8.b();
    ...
    */
    ...
    public String readString(long j8, Charset charset) {
        ...
        if (j8 >= 0 && j8 <= 2147483647L) {
            if (this.f8044b >= j8) {
                ...
                int i9 = (int) j8;
                String str = new String(u8.f8000a, i8, i9, charset);
                int i10 = u8.f8001b + i9;
                u8.f8001b = i10;
                this.f8044b -= j8;
                if (i10 == u8.f8002c) {
                    this.f8043a = u8.b();
    ...
    public String readUtf8() {
        return readString(this.f8044b, C2728d.f31279b);
    }
    ...
    public String readUtf8(long j8) {
        return readString(j8, C2728d.f31279b);
    }
    ...
    public int write(ByteBuffer source) {
        ...
        while (i8 > 0) {
            U F8 = F(1);
            int min = Math.min(i8, 8192 - F8.f8002c);
            source.get(F8.f8000a, F8.f8002c, min);
            i8 -= min;
            F8.f8002c += min;
        }
        this.f8044b += remaining;
        return remaining;
    }
    ...
    public int read(byte[] sink, int i8, int i9) {
        ...
        int min = Math.min(i9, u8.f8002c - u8.f8001b);
        byte[] bArr = u8.f8000a;
        int i10 = u8.f8001b;
