...
public final class r extends AbstractC1283i {
    ...
    protected synchronized int o(long j8, byte[] array, int i8, int i9) {
        ...
        while (true) {
            ...
            int read = this.f8094e.read(array, i8, i9 - i10);
            if (read == -1) {
                if (i10 == 0) {
                    return -1;
                }
