...
public final class j implements InterfaceC3167b.a {
    ...
    private final InterfaceC3873c f33830a;

    /* renamed from: b, reason: collision with root package name */
    private final Context f33831b;

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC1227k f33832c;
    ...
    public static final class a implements InterfaceC3169d {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final InterfaceC3349K f33833a = v4.g.n(Boolean.FALSE);
    ...
    public j(Context context, InterfaceC3873c analyticsRequestExecutor) {
        ...
        this.f33830a = analyticsRequestExecutor;
        this.f33831b = context.getApplicationContext();
        this.f33832c = L5.l.b(new b());
    }
    ...
    public final InterfaceC3169d c(InterfaceC3170e interfaceC3170e) {
        ...
        try {
            s.a aVar = s.f6498b;
            r.a aVar2 = r.f33047c;
            Context appContext = this.f33831b;
        ...
        if (s.h(obj)) {
            d((String) obj, PaymentAnalyticsEvent.f24860z0);
        }
        if (s.e(obj) != null) {
            d("pk_undefined", PaymentAnalyticsEvent.f24794A0);
        }
        if (s.e(obj) == null) {
            String str = (String) obj;
            Context appContext2 = this.f33831b;
            ...
            x2.m mVar = new x2.m();
            Context appContext3 = this.f33831b;
    ...
    private final void d(String str, PaymentAnalyticsEvent paymentAnalyticsEvent) {
        InterfaceC3873c interfaceC3873c = this.f33830a;
        Context appContext = this.f33831b;
        AbstractC3159y.h(appContext, "appContext");
    ...
    public InterfaceC3167b a() {
        return (InterfaceC3167b) this.f33832c.getValue();
    }
