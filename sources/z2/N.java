...
final class N implements h.d {
    ...
    public static final N f13262a = new N();
    ...
    @Override // Y2.h.d
    public X2.g j() {
        return new X2.g(M.f13259a.getType().f24537a, b4.n.f14710e0, b4.k.f14653k, true, (String) null, (String) null, (InterfaceC3983b) null, 64, (AbstractC3151p) null);
    }
}
