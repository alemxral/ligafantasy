...
final class C1531n implements h.c {
    ...
    public static final C1531n f13338a = new C1531n();
    ...
    public List c(Y2.d metadata, H0 sharedDataSpec, X2.h transformSpecToElements) {
        ...
        return transformSpecToElements.a(AbstractC1246t.G0(sharedDataSpec.c(), AbstractC1246t.r(new z0(bVar.r(), z0.d.f30886b), new z0(bVar.n(), z0.d.f30887c), new z0(bVar.t(), z0.d.f30888d), new C2623n(), new z0(bVar.d(), z0.d.f30889e), new C2625o())), AbstractC1246t.p(bVar.r(), bVar.n(), bVar.d()));
    }

    @Override // Y2.h.c
    public X2.g d(H0 sharedDataSpec) {
        AbstractC3159y.i(sharedDataSpec, "sharedDataSpec");
        return new X2.g(C1530m.f13334a, sharedDataSpec, b4.n.f14692R, b4.k.f14653k, true, null, 32, null);
    }
