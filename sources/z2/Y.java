...
final class Y implements h.c {
    ...
    public static final Y f13282a = new Y();
    ...
    public X2.g d(H0 sharedDataSpec) {
        ...
        return new X2.g(X.f13279a.getType().f24537a, b4.n.f14720j0, b4.k.f14668z, false, (String) null, (String) null, (InterfaceC3983b) null, 64, (AbstractC3151p) null);
    }
