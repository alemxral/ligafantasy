...
final class C1521d implements h.c {
    ...
    public static final C1521d f13298a = new C1521d();
    ...
    public X2.g d(H0 sharedDataSpec) {
        ...
        int i9 = i8;
        int i10 = b4.k.f14648f;
        if (aVar.a()) {
            a8 = AbstractC3984c.a(q3.w.f37440e);
        } else {
            a8 = AbstractC3984c.a(q3.w.f37434b);
        }
