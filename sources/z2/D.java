...
public final class D implements h.d {
    ...
    @Override // Y2.h.d
    public X2.g j() {
        return new X2.g(this.f13242a.getType(), AbstractC3984c.b(this.f13242a.c()), 0, this.f13242a.e(), this.f13242a.b(), false, (InterfaceC3983b) null, 64, (AbstractC3151p) null);
    }
}
