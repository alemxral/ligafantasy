...
final class c0 implements h.c {
    ...
    public static final c0 f13297a = new c0();
    ...
    public List c(Y2.d metadata, H0 sharedDataSpec, X2.h transformSpecToElements) {
        ...
        byte b8 = 0;
        if (metadata.Y()) {
            m8 = AbstractC1246t.e(new e4.u0(g8, b4.n.f14748x0, 1, (AbstractC3151p) (b8 == true ? 1 : 0)));
        } else {
            m8 = AbstractC1246t.m();
        }
    ...
    public X2.g d(H0 sharedDataSpec) {
        AbstractC3159y.i(sharedDataSpec, "sharedDataSpec");
        return new X2.g(b0.f13291a, sharedDataSpec, b4.n.f14724l0, b4.k.f14632B, false, null, 48, null);
    }
