...
final class C1527j implements h.c {
    ...
    public static final C1527j f13322a = new C1527j();
    ...
    public List c(Y2.d metadata, H0 sharedDataSpec, X2.h transformSpecToElements) {
        ...
        m4.G g8 = null;
        byte b8 = 0;
        if (C1526i.f13318a.c(metadata)) {
            m8 = AbstractC1246t.e(new e4.u0(g8, b4.n.f14703b, 1, (AbstractC3151p) (b8 == true ? 1 : 0)));
        } else {
            m8 = AbstractC1246t.m();
        }
    ...
    public X2.g d(H0 sharedDataSpec) {
        AbstractC3159y.i(sharedDataSpec, "sharedDataSpec");
        return new X2.g(C1526i.f13318a, sharedDataSpec, b4.n.f14690P, b4.k.f14651i, false, null, 48, null);
    }
