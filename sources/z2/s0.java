...
final class s0 implements h.d {
    ...
    public static final s0 f13361a = new s0();
    ...
    public List g(Y2.d metadata, h.a arguments) {
        ...
        return new X2.b(arguments).b(m4.h0.f35499f.b(new R0(null, 1, null), Integer.valueOf(b4.n.f14685K))).a();
    }
    ...
    @Override // Y2.h.d
    public X2.g j() {
        return new X2.g(r0.f13355a, null, b4.n.f14740t0, b4.k.f14639I, false, null, 50, null);
    }
}
