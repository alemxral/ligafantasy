...
final class A implements h.c {
    ...
    public List c(Y2.d metadata, H0 sharedDataSpec, X2.h transformSpecToElements) {
        ...
        m4.G g8 = null;
        byte b8 = 0;
        if (C1542z.f13384a.c(metadata)) {
            m8 = AbstractC1246t.e(new e4.N(g8, 0, 3, (AbstractC3151p) (b8 == true ? 1 : 0)));
        } else {
            m8 = AbstractC1246t.m();
        }
    ...
    public X2.g d(H0 sharedDataSpec) {
        AbstractC3159y.i(sharedDataSpec, "sharedDataSpec");
        return new X2.g(C1542z.f13384a, sharedDataSpec, b4.n.f14698X, b4.k.f14658p, false, null, 48, null);
    }
