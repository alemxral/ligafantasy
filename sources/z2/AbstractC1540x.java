...
public abstract class AbstractC1540x {
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[u.d.a.f26378a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[u.d.a.f26379b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[u.d.a.f26380c.ordinal()] = 3;
    ...
    public static final m4.D c(b4.c cVar, Map map, Map map2) {
        ...
        if (map2 != null) {
            ...
            if (str != null && (L02 = g6.n.L0(str)) != null) {
                ...
                return m4.h0.f35499f.a(AbstractC1246t.r(new C2587A(m4.G.Companion.a("credit_billing"), map, v2.d.f38765a.h(), null, e0Var, map2, cVar, 8, null), e0Var), Integer.valueOf(b4.n.f14719j));
            }
        }
        e0Var = null;
        return m4.h0.f35499f.a(AbstractC1246t.r(new C2587A(m4.G.Companion.a("credit_billing"), map, v2.d.f38765a.h(), null, e0Var, map2, cVar, 8, null), e0Var), Integer.valueOf(b4.n.f14719j));
    ...
    public static final m4.D d(Map map, boolean z8, boolean z9) {
        ...
        return m4.h0.f35499f.a(r8, Integer.valueOf(b4.n.f14727n));
    }

    public static final b4.c e(u.d.a aVar) {
        AbstractC3159y.i(aVar, "<this>");
        int i8 = a.f13378a[aVar.ordinal()];
        if (i8 != 1) {
            if (i8 != 2) {
                if (i8 == 3) {
                    return b4.c.f14598c;
