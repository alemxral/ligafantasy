...
final class C1538v implements h.d {
    ...
    public static final C1538v f13370a = new C1538v();
    ...
    public List g(Y2.d metadata, h.a arguments) {
        ...
        return new X2.b(arguments).e(X2.a.f12197a).e(X2.a.f12199c).b(h0.a.c(m4.h0.f35499f, new m4.q0(a8, new m4.s0(new m4.r0(Integer.valueOf(b4.n.f14723l), KeyboardCapitalization.Companion.m4896getNoneIUNYP9k(), KeyboardType.Companion.m4915getAsciiPjHm6EE(), null, 8, null), false, (String) arguments.d().get(a8), 2, null)), null, 2, null)).c(M5.a0.d("BR")).a();
    }
    ...
    @Override // Y2.h.d
    public X2.g j() {
        return new X2.g(C1537u.f13366a, null, b4.n.f14696V, b4.k.f14656n, false, null, 50, null);
    }
}
