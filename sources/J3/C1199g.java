...
public final class C1199g {
    ...
    public static final C1199g f5166a = new C1199g();

    /* renamed from: b, reason: collision with root package name */
    public static X5.p f5167b = ComposableLambdaKt.composableLambdaInstance(2125430138, false, a.f5168a);
    ...
    static final class a extends AbstractC3160z implements X5.p {
        ...
        public static final class C0100a extends kotlin.coroutines.jvm.internal.l implements X5.n {
            ...
            public final P5.d create(Object obj, P5.d dVar) {
                return new C0100a(this.f5170b, dVar);
            }

            @Override // X5.n
            public final Object invoke(i6.M m8, P5.d dVar) {
                return ((C0100a) create(m8, dVar)).invokeSuspend(L5.I.f6474a);
            }
        ...
        public final void a(AnimatedContentScope AnimatedContent, I3.m mVar, Composer composer, int i8) {
            ...
            if (mVar instanceof m.c) {
                ...
                b4.d.a(SizeKt.m639requiredSize3ABfNKs(Modifier.Companion, Dp.m5178constructorimpl(48)), MaterialTheme.INSTANCE.getColors(composer, MaterialTheme.$stable).m1177getOnSurface0d7_KjU(), PrimitiveResources_androidKt.dimensionResource(q3.s.f37370d, composer, 0), 0L, 0, composer, 6, 24);
                ...
                IconKt.m1266Iconww6aTOc(PainterResources_androidKt.painterResource(q3.t.f37393s, composer, 0), (String) null, SizeKt.m639requiredSize3ABfNKs(Modifier.Companion, Dp.m5178constructorimpl(48)), MaterialTheme.INSTANCE.getColors(composer, MaterialTheme.$stable).m1177getOnSurface0d7_KjU(), composer, 440, 0);
                composer.endReplaceableGroup();
            } else {
                if (mVar == null) {
                    z8 = true;
