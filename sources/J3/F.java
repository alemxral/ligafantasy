...
public abstract class F {
    ...
    public static final class a extends AbstractC3160z implements X5.n {
        ...
        final /* synthetic */ Typeface f4779d;
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            String upperCase = StringResources_androidKt.stringResource(this.f4776a, composer, 0).toUpperCase(Locale.ROOT);
            AbstractC3159y.h(upperCase, "toUpperCase(...)");
            long j8 = this.f4777b;
            long j9 = this.f4778c;
            Typeface editButtonTypeface = this.f4779d;
    ...
    public static final class b extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ long f4782c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function0 f4783d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ int f4784e;
        ...
        public final void invoke(Composer composer, int i8) {
            F.a(this.f4780a, this.f4781b, this.f4782c, this.f4783d, composer, RecomposeScopeImplKt.updateChangedFlags(this.f4784e | 1));
        }
    }
    ...
    public static final class c extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ G f4785a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ boolean f4786b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function0 f4787c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ float f4788d;
        ...
        public final void invoke(Composer composer, int i8) {
            F.b(this.f4785a, this.f4786b, this.f4787c, this.f4788d, composer, RecomposeScopeImplKt.updateChangedFlags(this.f4789e | 1), this.f4790f);
        }
    }
    ...
    public static final class e extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ TextInputService f4793b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function0 f4794c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ G f4795d;
        ...
        public static final class a extends AbstractC3160z implements Function0 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ TextInputService f4797a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ Function0 f4798b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(TextInputService textInputService, Function0 function0) {
                super(0);
                this.f4797a = textInputService;
                this.f4798b = function0;
            }
            ...
            public final void m16invoke() {
                TextInputService textInputService = this.f4797a;
        ...
        public static final class b extends AbstractC3160z implements X5.n {
            ...
            public final void invoke(Composer composer, int i8) {
                ...
                IconKt.m1266Iconww6aTOc(PainterResources_androidKt.painterResource(this.f4799a.c(), composer, 0), StringResources_androidKt.stringResource(this.f4799a.a(), composer, 0), (Modifier) null, this.f4800b, composer, 8, 4);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
        ...
        e(boolean z8, TextInputService textInputService, Function0 function0, G g8, long j8) {
            super(2);
            this.f4792a = z8;
            this.f4793b = textInputService;
            this.f4794c = function0;
            this.f4795d = g8;
            this.f4796e = j8;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            IconButtonKt.IconButton(new a(this.f4793b, this.f4794c), TestTagKt.testTag(Modifier.Companion, "SHEET_NAVIGATION_BUTTON_TAG"), this.f4792a, null, ComposableLambdaKt.composableLambda(composer, -430730, true, new b(this.f4795d, this.f4796e)), composer, 24624, 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final class f extends AbstractC3160z implements X5.o {
        ...
        public final void invoke(RowScope TopAppBar, Composer composer, int i8) {
            ...
            if (this.f4801a.e()) {
                F.a(this.f4801a.b(), this.f4802b, this.f4803c, this.f4801a.d(), composer, 0);
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final class g extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ float f4806c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function0 f4807d;
        ...
        public final void invoke(Composer composer, int i8) {
            F.c(this.f4804a, this.f4805b, this.f4806c, this.f4807d, composer, RecomposeScopeImplKt.updateChangedFlags(this.f4808e | 1));
        }
    }
    ...
    public static final class h extends AbstractC3160z implements X5.n {
        ...
        public final void invoke(Composer composer, int i8) {
            F.d(composer, RecomposeScopeImplKt.updateChangedFlags(this.f4809a | 1));
        }
    }
    ...
    public static final void a(int i8, boolean z8, long j8, Function0 function0, Composer composer, int i9) {
        ...
        if ((i10 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
                rememberedValue2 = TextUnit.m5355boximpl(density.mo450toSp0xMU5do(Dp.m5178constructorimpl(Dp.m5178constructorimpl(TextUnit.m5365getValueimpl(C3086l.f33222a.f().p())) * p8.g())));
    ...
    public static final void d(Composer composer, int i8) {
        ...
        if (i8 == 0 && startRestartGroup.getSkipping()) {
            ...
            long colorResource = ColorResources_androidKt.colorResource(q3.r.f37365d, startRestartGroup, 0);
            long colorResource2 = ColorResources_androidKt.colorResource(q3.r.f37366e, startRestartGroup, 0);
