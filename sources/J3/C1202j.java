...
public final class C1202j implements InterfaceC1211t {
    ...
    private final Function1 f5209a;

    /* renamed from: b, reason: collision with root package name */
    private final X5.n f5210b;

    /* renamed from: c, reason: collision with root package name */
    private final X5.o f5211c;
    ...
    private final l6.v f5214f;

    /* renamed from: g, reason: collision with root package name */
    private final l6.v f5215g;

    /* renamed from: h, reason: collision with root package name */
    private final l6.v f5216h;

    /* renamed from: i, reason: collision with root package name */
    private final l6.v f5217i;

    /* renamed from: j, reason: collision with root package name */
    private final l6.v f5218j;

    /* renamed from: k, reason: collision with root package name */
    private final i6.M f5219k;

    /* renamed from: l, reason: collision with root package name */
    private final InterfaceC3349K f5220l;
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ C1207o.a f5227d;
    ...
    static final class d extends AbstractC3160z implements X5.q {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ InterfaceC3983b f5229b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        d(InterfaceC3983b interfaceC3983b) {
            super(5);
            this.f5229b = interfaceC3983b;
        }
        ...
        public final C1207o a(com.stripe.android.model.o paymentMethod, C1207o.a choice, C1207o.b status, boolean z8, InterfaceC3983b interfaceC3983b) {
            ...
            return new C1207o(status, C1202j.this.o(paymentMethod), this.f5229b, !AbstractC3159y.d(p8, choice), choice, C1202j.this.m(paymentMethod), C1202j.this.f5212d, z8, interfaceC3983b);
        }
    ...
    public C1202j(com.stripe.android.model.o initialPaymentMethod, InterfaceC3983b displayName, Function1 eventHandler, X5.n removeExecutor, X5.o updateExecutor, boolean z8, boolean z9, P5.g workContext) {
        ...
        this.f5209a = eventHandler;
        this.f5210b = removeExecutor;
        this.f5211c = updateExecutor;
        this.f5212d = z8;
        this.f5213e = z9;
        l6.v a8 = AbstractC3351M.a(p(initialPaymentMethod));
        this.f5214f = a8;
        l6.v a9 = AbstractC3351M.a(C1207o.b.f5340a);
        this.f5215g = a9;
        ...
        this.f5218j = a12;
        this.f5219k = i6.N.a(workContext.plus(U0.b(null, 1, null)));
        this.f5220l = v4.g.g(a10, a8, a9, a11, a12, new d(displayName));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final List m(com.stripe.android.model.o oVar) {
        Set b8;
        o.g.c cVar = n(oVar).f24472k;
        if (cVar != null && (b8 = cVar.b()) != null) {
            Set set = b8;
            ArrayList arrayList = new ArrayList(AbstractC1246t.x(set, 10));
            Iterator it = set.iterator();
            while (it.hasNext()) {
                arrayList.add(x(EnumC1870e.f14423m.b((String) it.next())));
            }
            return arrayList;
        }
    ...
    public final C1207o.a p(com.stripe.android.model.o oVar) {
        return x(EnumC1870e.f14423m.b(n(oVar).f24473l));
    }

    private final void q(C1207o.a aVar) {
        this.f5214f.setValue(aVar);
        this.f5209a.invoke(new InterfaceC1206n.a.C0106a(aVar.a()));
    }

    private final void r() {
        this.f5209a.invoke(new InterfaceC1206n.a.C0106a(null));
    }

    private final void s() {
        this.f5209a.invoke(new InterfaceC1206n.a.b(((C1207o.a) this.f5214f.getValue()).a()));
    }

    private final void t() {
        this.f5217i.setValue(Boolean.FALSE);
    }

    private final void u() {
        this.f5217i.setValue(Boolean.FALSE);
        AbstractC2829k.d(this.f5219k, null, null, new b(null), 3, null);
    }

    private final void v() {
        this.f5217i.setValue(Boolean.TRUE);
    }

    private final void w() {
        com.stripe.android.model.o oVar = (com.stripe.android.model.o) this.f5216h.getValue();
        C1207o.a aVar = (C1207o.a) this.f5214f.getValue();
        if (!AbstractC3159y.d(p(oVar), aVar)) {
            AbstractC2829k.d(this.f5219k, null, null, new c(aVar, null), 3, null);
        }
    }
    ...
    @Override // J3.InterfaceC1211t
    public void close() {
        i6.N.d(this.f5219k, null, 1, null);
    }
