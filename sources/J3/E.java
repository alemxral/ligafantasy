...
public abstract class E {
    ...
    public static final class b extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ X5.n f4770a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ X5.n f4771b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Modifier f4772c;
        ...
        public final void invoke(Composer composer, int i8) {
            E.a(this.f4770a, this.f4771b, this.f4772c, composer, RecomposeScopeImplKt.updateChangedFlags(this.f4773d | 1), this.f4774e);
        }
    }
    ...
    public static final class c extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ScrollState f4775a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(ScrollState scrollState) {
            super(0);
            this.f4775a = scrollState;
        }
