...
public abstract class AbstractC1196d {
    ...
    public static final class a extends AbstractC3160z implements X5.o {
        ...
        final /* synthetic */ Function0 f5152a;
        ...
        public final void invoke(RowScope TopAppBar, Composer composer, int i8) {
            ...
            IconButtonKt.IconButton(this.f5152a, null, false, null, ComposableLambdaKt.composableLambda(composer, 782248533, true, new C0099a(this.f5153b)), composer, 24576, 14);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final class b extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function0 f5156b;
        ...
        public final void invoke(Composer composer, int i8) {
            AbstractC1196d.a(this.f5155a, this.f5156b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f5157c | 1));
        }
    }
