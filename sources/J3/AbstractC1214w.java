...
public abstract class AbstractC1214w {
    ...
    public static final class a extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        final /* synthetic */ Function0 f5417c;
        ...
        public static final class C0109a extends kotlin.coroutines.jvm.internal.k implements X5.n {
            ...
            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ Function0 f5420c;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0109a(Function0 function0, P5.d dVar) {
                super(2, dVar);
                this.f5420c = function0;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                C0109a c0109a = new C0109a(this.f5420c, dVar);
                c0109a.f5419b = obj;
                return c0109a;
            }
            ...
            public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, P5.d dVar) {
                return ((C0109a) create(awaitPointerEventScope, dVar)).invokeSuspend(L5.I.f6474a);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i8 != 0) {
                    ...
                    L5.t.b(obj);
                    AwaitPointerEventScope awaitPointerEventScope = (AwaitPointerEventScope) this.f5419b;
                    this.f5418a = 1;
        ...
        a(Function0 function0, P5.d dVar) {
            super(2, dVar);
            this.f5417c = function0;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            a aVar = new a(this.f5417c, dVar);
            aVar.f5416b = obj;
            return aVar;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                L5.t.b(obj);
                PointerInputScope pointerInputScope = (PointerInputScope) this.f5416b;
                C0109a c0109a = new C0109a(this.f5417c, null);
                this.f5415a = 1;
    ...
    public static final class b extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f5421a;
    ...
    public static final class c extends AbstractC3160z implements X5.n {
        ...
        final /* synthetic */ A3.a f5425d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ B3.d f5426e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ float f5427f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function1 f5428g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function0 f5429h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f5430i;
        ...
        c(boolean z8, String str, List list, A3.a aVar, B3.d dVar, float f8, Function1 function1, Function0 function0, int i8) {
            ...
            this.f5426e = dVar;
            this.f5427f = f8;
            this.f5428g = function1;
            this.f5429h = function0;
            this.f5430i = i8;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            AbstractC1214w.a(this.f5422a, this.f5423b, this.f5424c, this.f5425d, this.f5426e, this.f5427f, this.f5428g, this.f5429h, composer, RecomposeScopeImplKt.updateChangedFlags(this.f5430i | 1));
        }
    }
    ...
    public static final class f extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ List f5436d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Function1 f5437e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ A3.a f5438f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ B3.d f5439g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function1 f5440h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Modifier f5441i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Function0 f5442j;
        ...
        f(boolean z8, List list, String str, List list2, Function1 function1, A3.a aVar, B3.d dVar, Function1 function12, Modifier modifier, Function0 function0, int i8, int i9) {
            ...
            this.f5435c = str;
            this.f5436d = list2;
            this.f5437e = function1;
            this.f5438f = aVar;
            this.f5439g = dVar;
            this.f5440h = function12;
            this.f5441i = modifier;
            this.f5442j = function0;
            this.f5443k = i8;
            this.f5444l = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            AbstractC1214w.b(this.f5433a, this.f5434b, this.f5435c, this.f5436d, this.f5437e, this.f5438f, this.f5439g, this.f5440h, this.f5441i, this.f5442j, composer, RecomposeScopeImplKt.updateChangedFlags(this.f5443k | 1), this.f5444l);
        }
    }
    ...
    public static final void a(boolean z8, String selectedPaymentMethodCode, List formElements, A3.a formArguments, B3.d usBankAccountFormArguments, float f8, Function1 onFormFieldValuesChanged, Function0 onInteractionEvent, Composer composer, int i8) {
        ...
        Object m2583rememberSaveable = RememberSaveableKt.m2583rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) null, (String) null, (Function0) d.f5431a, startRestartGroup, 3080, 6);
        ...
        if (!AbstractC3159y.d(selectedPaymentMethodCode, o.p.f24509O.f24537a) && !AbstractC3159y.d(selectedPaymentMethodCode, o.p.f24518h.f24537a)) {
    ...
    public static final void b(boolean z8, List supportedPaymentMethods, String selectedItemCode, List formElements, Function1 onItemSelectedListener, A3.a formArguments, B3.d usBankAccountFormArguments, Function1 onFormFieldValuesChanged, Modifier modifier, Function0 function0, Composer composer, int i8, int i9) {
        ...
        if (supportedPaymentMethods.size() > 1) {
            ...
            AbstractC1213v.a(supportedPaymentMethods, intValue, z8, onItemSelectedListener, c3755g, PaddingKt.m604paddingqDBjuR0$default(Modifier.Companion, 0.0f, 0.0f, 0.0f, Dp.m5178constructorimpl(12), 7, null), null, composer2, ((i8 << 6) & 896) | 196616 | ((i8 >> 3) & 7168) | (C3755g.f37920g << 12), 64);
        } else {
            composer2 = startRestartGroup;
            modifier3 = modifier4;
        }
