...
public final class a implements U3.c {
    ...
    private static final C0222a f11062i = new C0222a(null);

    /* renamed from: j, reason: collision with root package name */
    private static final String f11063j = StandardCharsets.UTF_8.name();

    /* renamed from: a, reason: collision with root package name */
    private final Context f11064a;

    /* renamed from: b, reason: collision with root package name */
    private final b f11065b;

    /* renamed from: c, reason: collision with root package name */
    private final g f11066c;

    /* renamed from: d, reason: collision with root package name */
    private final o f11067d;

    /* renamed from: e, reason: collision with root package name */
    private final U3.d f11068e;
    ...
    public static final class c implements b {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final Map f11073b = Q.h();
    ...
    static final class e extends l implements n {
        ...
        /* renamed from: b, reason: collision with root package name */
        private /* synthetic */ Object f11076b;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Throwable f11078d;
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            e eVar = new e(this.f11078d, dVar);
            eVar.f11076b = obj;
            return eVar;
        }
    ...
    public a(Context context, b config, g workContext, o logger, U3.d sentryConfig, String environment, String localeCountry, int i8) {
        ...
        this.f11065b = config;
        this.f11066c = workContext;
        this.f11067d = logger;
        this.f11068e = sentryConfig;
        this.f11069f = environment;
        this.f11070g = localeCountry;
        this.f11071h = i8;
    }
    ...
    public final void j(Throwable th) {
        this.f11067d.a("Failed to send error report.", th);
    }

    private final HttpsURLConnection k() {
        URLConnection openConnection = new URL("https://errors.stripe.com/api/" + this.f11068e.a() + "/store/").openConnection();
    ...
    public final /* synthetic */ JSONObject d(Throwable t8) {
        ...
        JSONObject put4 = new JSONObject().put("locale", this.f11070g).put("environment", this.f11069f).put("android_os_version", this.f11071h);
        for (Map.Entry entry : this.f11065b.b().entrySet()) {
    ...
    public final /* synthetic */ JSONObject e() {
        ...
        try {
            s.a aVar = s.f6498b;
            b8 = s.b(this.f11064a.getPackageManager().getPackageInfo(this.f11064a.getPackageName(), 0));
        } catch (Throwable th) {
            s.a aVar2 = s.f6498b;
            b8 = s.b(t.a(th));
        }
        ...
        if (packageInfo != null && (applicationInfo = packageInfo.applicationInfo) != null) {
            charSequence = applicationInfo.loadLabel(this.f11064a.getPackageManager());
        } else {
            charSequence = null;
        }
        JSONObject jSONObject = new JSONObject();
        JSONObject put = new JSONObject().put("app_identifier", this.f11064a.getPackageName()).put("app_name", charSequence);
        if (packageInfo != null) {
    ...
    public final /* synthetic */ String g() {
        return AbstractC1246t.w0(AbstractC1246t.p("Sentry", AbstractC1246t.w0(AbstractC1246t.p(x.a("sentry_key", this.f11068e.getKey()), x.a("sentry_version", this.f11068e.getVersion()), x.a("sentry_timestamp", this.f11068e.c()), x.a("sentry_client", "Android3ds2Sdk 6.1.8"), x.a("sentry_secret", this.f11068e.b())), ", ", null, null, 0, null, d.f11074a, 30, null)), " ", null, null, 0, null, null, 62, null);
    }

    @Override // U3.c
    public void i(Throwable t8) {
        AbstractC3159y.i(t8, "t");
        AbstractC2829k.d(N.a(this.f11066c), null, null, new e(t8, null), 3, null);
    }
    ...
    */
    public /* synthetic */ a(android.content.Context r9, U3.a.b r10, P5.g r11, com.stripe.android.stripe3ds2.transaction.o r12, U3.d r13, java.lang.String r14, java.lang.String r15, int r16, int r17, kotlin.jvm.internal.AbstractC3151p r18) {
        ...
        L14:
            r3 = r0 & 8
            if (r3 == 0) goto L1b
            com.stripe.android.stripe3ds2.transaction.o$b r3 = com.stripe.android.stripe3ds2.transaction.o.b.f26880b
            goto L1c
        L1b:
            r3 = r12
        L1c:
