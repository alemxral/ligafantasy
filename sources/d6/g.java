    ...
    public String b(C6.b field) {
        ...
        switch (field) {
            ...
            case TargetedAdvertisingOptOutNotice:
                String TARGETED_ADVERTISING_OPT_OUT_NOTICE = i.f38743d;
            ...
            case SaleOptOut:
                String SALE_OPT_OUT = i.f38744e;
                AbstractC3159y.h(SALE_OPT_OUT, "SALE_OPT_OUT");
                return SALE_OPT_OUT;
            case TargetedAdvertisingOptOut:
                String TARGETED_ADVERTISING_OPT_OUT = i.f38745f;
            ...
            case SensitiveDataProcessing:
                String SENSITIVE_DATA_PROCESSING = i.f38746g;
            ...
            case KnownChildSensitiveDataConsents:
                String KNOWN_CHILD_SENSITIVE_DATA_CONSENTS = i.f38747h;
            ...
            case MspaCoveredTransaction:
                String MSPA_COVERED_TRANSACTION = i.f38748i;
            ...
            case MspaOptOutOptionMode:
                String MSPA_OPT_OUT_OPTION_MODE = i.f38749j;
            ...
            case MspaServiceProviderMode:
                String MSPA_SERVICE_PROVIDER_MODE = i.f38750k;
