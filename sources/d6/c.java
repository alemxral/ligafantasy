    ...
    public String b(C6.b field) {
        ...
        switch (field) {
            ...
            case TargetedAdvertisingOptOutNotice:
                String TARGETED_ADVERTISING_OPT_OUT_NOTICE = v1.f.f38698d;
            ...
            case SaleOptOut:
                String SALE_OPT_OUT = v1.f.f38699e;
                AbstractC3159y.h(SALE_OPT_OUT, "SALE_OPT_OUT");
                return SALE_OPT_OUT;
            case TargetedAdvertisingOptOut:
                String TARGETED_ADVERTISING_OPT_OUT = v1.f.f38700f;
            ...
            case SensitiveDataProcessing:
                String SENSITIVE_DATA_PROCESSING = v1.f.f38701g;
            ...
            case KnownChildSensitiveDataConsents:
                String KNOWN_CHILD_SENSITIVE_DATA_CONSENTS = v1.f.f38702h;
            ...
            case MspaCoveredTransaction:
                String MSPA_COVERED_TRANSACTION = v1.f.f38703i;
            ...
            case MspaOptOutOptionMode:
                String MSPA_OPT_OUT_OPTION_MODE = v1.f.f38704j;
            ...
            case MspaServiceProviderMode:
                String MSPA_SERVICE_PROVIDER_MODE = v1.f.f38705k;
