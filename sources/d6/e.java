...
public class e {
    ...
    public C3680a f1875a;

    /* renamed from: b, reason: collision with root package name */
    public final E6.f f1876b;

    /* renamed from: c, reason: collision with root package name */
    public final SharedStorage f1877c;

    /* renamed from: d, reason: collision with root package name */
    public final USRegulationData f1878d;
    ...
    public e() {
        ...
        this.f1876b = dVar.j();
        this.f1877c = dVar.m();
        this.f1878d = new USRegulationData(0, null, 0, 0, 0, 0, 0, 0, 0, 0, 0, null, null, 0, 0, 0, 0, 131071, null);
    }

    public final String a() {
        try {
            String d8 = this.f1875a.d();
            AbstractC3159y.h(d8, "{ gppModel.encode() }");
            return d8;
        } catch (Exception unused) {
            C3832b.b(C3832b.f38857a, ChoiceError.ERROR_WHILE_SAVING_CONSENT, null, null, EnumC3833c.CONSOLE, null, 22);
            return "";
        }
    }
    ...
    public String b(C6.b field) {
        ...
        switch (field.ordinal()) {
            ...
            case 4:
                String SENSITIVE_DATA_PROCESSING_OPT_OUT_NOTICE = v1.g.f38714f;
    ...
    public void d(C6.b field, boolean z8) {
        ...
        c(field, p8);
        this.f1878d.setKnownChildSensitiveDataConsents(p8);
    }
    ...
    public final void e(List purposes, boolean z8, Function1 function1) {
        ...
        int i17 = this.f1877c.i(N7.a.SAVED_MSPA_SECTION_ID);
        String str = "";
        this.f1877c.g(n.A("IABGPP_[SectionID]_String", "[SectionID]", String.valueOf(i17), false, 4, null), "");
        try {
            JSONArray jSONArray = new JSONArray(this.f1877c.j(N7.a.HDR_SECTION_LIST));
        ...
        this.f1877c.e(N7.a.HDR_SECTION_LIST, arrayList.toString());
        this.f1877c.e(N7.a.HDR_SECTION_ID, AbstractC1246t.w0(arrayList, "_", null, null, 0, null, null, 62, null));
        this.f1875a.b(i17);
        this.f1877c.e(N7.a.GPP_STRING, a());
        ...
        while (true) {
            ...
            if (it2.hasNext()) {
                ...
                if (num != null) {
                    ...
                    switch (bVar.ordinal()) {
                        case 6:
                            ...
                            this.f1878d.setSaleOptOutNotice(i11);
                            if (z8) {
                            ...
                            USRegulationData uSRegulationData = this.f1878d;
                            if (AbstractC3159y.d(eVar.f1332d, Boolean.TRUE)) {
                                i18 = 1;
                            }
                        ...
                        case 7:
                            ...
                            if (b(bVar).length() <= 0) {
                                ...
                                USRegulationData uSRegulationData2 = this.f1878d;
                                if (z8) {
                                    if (AbstractC3159y.d(eVar.f1332d, Boolean.TRUE)) {
                                        i18 = 1;
                                    }
                        ...
                        case 8:
                            if (b(bVar).length() > 0) {
                                ...
                                USRegulationData uSRegulationData3 = this.f1878d;
                                if (z8) {
                                    if (AbstractC3159y.d(eVar.f1332d, Boolean.TRUE)) {
                                        i18 = 1;
                                    }
                        ...
                        case 9:
                            ...
                            if (list2 != null) {
                                ...
                                this.f1878d.setSensitiveDataProcessing(AbstractC1239l.U0(iArr));
                            }
                            c(bVar, obj2);
                            break;
                        case 10:
                        ...
                        case 11:
                            if (b(bVar).length() <= 0) {
                                ...
                                USRegulationData uSRegulationData4 = this.f1878d;
                                if (z8) {
                                    if (AbstractC3159y.d(eVar.f1332d, Boolean.TRUE)) {
                                        i18 = 1;
                                    }
                ...
                if (this.f1876b.f2373b.f2322K) {
                    i8 = 1;
                } else {
                    i8 = 2;
                }
                c(C6.b.MspaCoveredTransaction, Integer.valueOf(i8));
                this.f1878d.setMspaCoveredTransaction(i8);
                String str2 = this.f1876b.f2373b.f2323L;
                C6.e eVar2 = null;
                if (str2 == null) {
                    i10 = null;
                } else {
                    ...
                    this.f1878d.setMspaOptOutOptionMode(i9);
                    this.f1878d.setMspaServiceProviderMode(i18);
                    i10 = I.f6474a;
                }
                if (i10 == null) {
                    c(C6.b.MspaOptOutOptionMode, 0);
                    c(C6.b.MspaServiceProviderMode, 0);
                    this.f1878d.setMspaOptOutOptionMode(0);
                    this.f1878d.setMspaServiceProviderMode(0);
                }
                ...
                this.f1877c.d(N7.a.MSPA_PURPOSE_CONSENT, vector);
                ...
                this.f1877c.d(N7.a.MSPA_SENSITIVE_PURPOSE_CONSENT, vector2);
                O7.d dVar = O7.d.f7793a;
                C3680a gppModel = this.f1875a;
                AbstractC3159y.i(gppModel, "gppModel");
                O7.d.f7807o = gppModel;
                this.f1878d.setGppString(a());
                this.f1878d.setVersion(1);
                this.f1877c.c(N7.a.SAVED_MSPA_SECTION_ID, i());
                this.f1877c.e(N7.a.HDR_GPP_VERSION, String.valueOf(this.f1875a.e().g()));
                this.f1877c.e(N7.a.HDR_SECTION_LIST, this.f1875a.h().toString());
                SharedStorage sharedStorage = this.f1877c;
                N7.a aVar = N7.a.HDR_SECTION_ID;
                List h8 = this.f1875a.h();
                ...
                SharedStorage sharedStorage2 = this.f1877c;
                try {
                    String b8 = this.f1875a.g(g()).b();
                    AbstractC3159y.h(b8, "{\n            gppModel.g…ction).encode()\n        }");
                    str = b8;
                } catch (Exception unused2) {
                }
                sharedStorage2.g(A8, str);
                this.f1877c.e(N7.a.HDR_GPP_STRING, this.f1878d.getGppString());
                this.f1877c.e(N7.a.SAVED_MSPA_JURISDICTION, C6.d.f1327h.f39879a);
                this.f1877c.e(N7.a.SAVED_REGION, O7.d.f7806n);
                this.f1877c.e(N7.a.GPP_STRING, this.f1878d.getGppString());
                function1.invoke(this.f1878d);
                return;
            }
        }
    }
    ...
    public void f(boolean z8) {
        ...
        this.f1878d.setSensitiveDataLimitUseNotice(i8);
    }

    public String g() {
        String NAME = l.f38961f;
    ...
    public void h(boolean z8) {
        ...
        this.f1878d.setSensitiveDataProcessingOptOutNotice(i8);
    }
    ...
    public void j(boolean z8) {
        ...
        this.f1878d.setSharingNotice(i8);
    }
    ...
    public void k(boolean z8) {
        ...
        this.f1878d.setSharingOptOutNotice(i8);
    }
    ...
    public void l(boolean z8) {
        ...
        this.f1878d.setTargetedAdvertisingOptOutNotice(i8);
    }
}
