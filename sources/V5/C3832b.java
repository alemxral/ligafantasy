...
public final class C3832b {
    ...
    public static final C3832b f38857a = new C3832b();

    /* renamed from: b, reason: collision with root package name */
    public static final ChoiceCmpCallback f38858b = ChoiceCmp.INSTANCE.getCallback();
        ...
        if (ordinal != 0) {
            if (ordinal != 1) {
                if (ordinal == 2) {
                    ...
                    ChoiceCmpCallback choiceCmpCallback = f38858b;
            ...
            ChoiceCmpCallback choiceCmpCallback2 = f38858b;
