...
public final class C3563o0 extends RecyclerView.ViewHolder {
    ...
    private final W4.t f36832a;

    /* renamed from: b, reason: collision with root package name */
    private final TextView f36833b;

    /* renamed from: c, reason: collision with root package name */
    private final ImageView f36834c;
    ...
    public C3563o0(View itemView, String text, W4.t tVar) {
        ...
        this.f36834c = (ImageView) itemView.findViewById(R.id.iv_title_info);
    ...
    public final void b(boolean z8) {
        ...
        ImageView imageView3 = this.f36834c;
        if (imageView3 != null) {
