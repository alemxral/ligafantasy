...
public final class C3553j0 extends RecyclerView.ViewHolder {
    ...
    private final W4.B f36796a;

    /* renamed from: b, reason: collision with root package name */
    private final TextView f36797b;

    /* renamed from: c, reason: collision with root package name */
    private final TextView f36798c;

    /* renamed from: d, reason: collision with root package name */
    private final TextView f36799d;

    /* renamed from: e, reason: collision with root package name */
    private final ImageView f36800e;
    ...
    public C3553j0(View itemView, W4.B b8) {
        ...
        this.f36800e = (ImageView) findViewById4;
    ...
    public static final void b(C3553j0 this$0, View view) {
        ...
        if (this$0.f36796a != null && (bindingAdapterPosition = this$0.getBindingAdapterPosition()) != -1) {
            this$0.f36796a.a(bindingAdapterPosition);
        }
    }
    ...
    public final void c(C1496f item, Context context) {
        ...
        try {
            ...
            String Q8 = item.Q();
            AbstractC3159y.f(Q8);
            this.f36800e.setImageDrawable(N4.q.d(packageManager, Q8, 0).applicationInfo.loadIcon(context.getPackageManager()));
        } catch (Exception e8) {
            this.f36800e.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.vector_uptodown_logo_bag_disabled));
            e8.printStackTrace();
        }
        this.f36797b.setText(item.I());
        this.f36798c.setText(item.h0());
        this.f36799d.setText(item.a0());
    }
}
