...
public final class H extends RecyclerView.ViewHolder {
    ...
    private W4.u f36568a;

    /* renamed from: b, reason: collision with root package name */
    private TextView f36569b;

    /* renamed from: c, reason: collision with root package name */
    private TextView f36570c;
    ...
    public H(View itemView, W4.u listener) {
        ...
        this.f36570c = (TextView) findViewById2;
        TextView textView = this.f36569b;
        j.a aVar = E4.j.f2272g;
        textView.setTypeface(aVar.u());
        this.f36570c.setTypeface(aVar.u());
    }
    ...
    public final void b(final C1511v lang, String currentLanguageCode) {
        ...
        if (g6.n.s(lang.a(), "ar", false)) {
            if (!AbstractC3159y.d(currentLanguageCode, "ar")) {
                ...
                this.f36569b.setText(spannableString);
                return;
            }
            return;
        }
        if (AbstractC3159y.d(currentLanguageCode, "ar")) {
            ...
            this.f36569b.setText(spannableString2);
        }
    }
}
