...
public abstract class AbstractC3554k extends RecyclerView.ViewHolder {
    ...
    public final void c(ProgressBar pb, final ImageView ivIcon) {
        ...
        if (pb.getVisibility() == 0) {
            ValueAnimator endDownloadAnimation$lambda$4 = ValueAnimator.ofFloat(this.f36803c, this.f36802b);
    ...
    public final void e(ProgressBar pb, final ImageView ivIcon) {
        ...
        if (pb.getVisibility() == 8) {
            pb.setVisibility(0);
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f36802b, this.f36803c);
    ...
    public static final class a implements Animator.AnimatorListener {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ProgressBar f36804a;

        public a(ProgressBar progressBar) {
            this.f36804a = progressBar;
        }

        @Override // android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            this.f36804a.setVisibility(8);
        }
