...
public final class Y extends RecyclerView.ViewHolder {
    ...
    private final InterfaceC1479b f36696a;

    /* renamed from: b, reason: collision with root package name */
    private final Context f36697b;

    /* renamed from: c, reason: collision with root package name */
    private final ImageView f36698c;

    /* renamed from: d, reason: collision with root package name */
    private final TextView f36699d;

    /* renamed from: e, reason: collision with root package name */
    private final TextView f36700e;

    /* renamed from: f, reason: collision with root package name */
    private final TextView f36701f;
    ...
    public Y(View itemView, InterfaceC1479b interfaceC1479b, Context context) {
        ...
        this.f36698c = (ImageView) findViewById;
    ...
    public static final void b(Y this$0, View view) {
        ...
        if (this$0.f36696a != null && (bindingAdapterPosition = this$0.getBindingAdapterPosition()) != -1) {
            this$0.f36696a.a(bindingAdapterPosition);
        }
    }

    public final void c(C1496f c1496f) {
        if (c1496f != null) {
            this.f36698c.setImageDrawable(C3307A.f34459a.k(this.f36697b, c1496f.Q(), R.drawable.vector_uptodown_logo_bag_disabled));
            this.f36699d.setText(c1496f.I());
            this.f36700e.setText(c1496f.h0());
            if (c1496f.T() != null) {
                kotlin.jvm.internal.Y y8 = kotlin.jvm.internal.Y.f33752a;
                String string = this.f36697b.getString(R.string.x_positives);
