...
public abstract class AbstractC3548h extends RecyclerView.ViewHolder {
    ...
    private final void f(C1496f c1496f, X4.O o8, TextView textView) {
        if (o8 != null && o8.f() == 0) {
            textView.setText(this.f36774a.getString(R.string.status_download_update));
            textView.setTextColor(ContextCompat.getColor(this.f36774a, R.color.white));
            textView.setBackground(ContextCompat.getDrawable(this.f36774a, R.drawable.ripple_install_button));
        } else if (c1496f.f()) {
            textView.setText(this.f36774a.getString(R.string.dark_mode_disabled));
            textView.setTextColor(ContextCompat.getColor(this.f36774a, R.color.main_light_grey));
            textView.setBackground(ContextCompat.getDrawable(this.f36774a, R.drawable.bg_status_download_installed));
        } else {
            textView.setText(this.f36774a.getString(R.string.status_download_installed));
            textView.setTextColor(ContextCompat.getColor(this.f36774a, R.color.main_blue));
            textView.setBackground(ContextCompat.getDrawable(this.f36774a, R.drawable.shape_stroke_blue_primary));
        }
    ...
    private final void j(String str, ProgressBar progressBar, ImageView imageView, TextView textView, TextView textView2, LinearLayout linearLayout) {
        C3475c.f36184a.c(progressBar, imageView);
    ...
    private final void k(int i8, long j8, ProgressBar progressBar, ImageView imageView, TextView textView, TextView textView2, TextView textView3, LinearLayout linearLayout) {
        C3475c.f36184a.e(progressBar, imageView);
        ...
        if (i8 == 0) {
            ...
            textView2.setText(this.f36774a.getString(R.string.status_download_update_pending));
        } else {
            progressBar.setIndeterminate(false);
            progressBar.setProgress(i8);
            textView2.setText(this.f36774a.getString(R.string.percent_of_total_size, Integer.valueOf(i8), new N4.g().c(j8)));
        }
    }
    ...
    public final RelativeLayout.LayoutParams b(RelativeLayout.LayoutParams layoutParams, Context context, int i8, int i9) {
        ...
        if (AbstractC3159y.d(SettingsPreferences.f29309b.q(context), "ar")) {
            if (i8 == i9) {
    ...
    public final void e(C1498h app, ProgressBar pb, ImageView ivIcon, TextView tvDesc, TextView tvProgress, TextView textView, LinearLayout llProgress) {
        ...
        C3326n a8 = C3326n.f34490t.a(this.f36774a);
        a8.a();
        ...
        boolean z9 = false;
        if (UptodownApp.f27990B.V("downloadApkWorker", this.f36774a) && DownloadApkWorker.f29987k.c(app.i())) {
            z8 = true;
        } else {
            z8 = false;
        }
    ...
    public final void g(String str, TextView tvStatus, TextView tvDesc) {
        ...
        AbstractC3159y.i(tvDesc, "tvDesc");
        if (new C3319g().r(str, this.f36774a)) {
            C3326n a8 = C3326n.f34490t.a(this.f36774a);
            a8.a();
        ...
        tvStatus.setText(this.f36774a.getString(R.string.status_download_installed));
        tvStatus.setTextColor(ContextCompat.getColor(this.f36774a, R.color.main_blue));
        tvStatus.setBackground(ContextCompat.getDrawable(this.f36774a, R.drawable.shape_stroke_blue_primary));
        tvStatus.setTypeface(E4.j.f2272g.t());
        tvStatus.setVisibility(8);
        tvDesc.setVisibility(0);
    }
    ...
    public final void h(ImageView iv, String str) {
        ...
        if (str != null) {
            com.squareup.picasso.s.h().l(str).l(R.drawable.shape_bg_placeholder).n(UptodownApp.f27990B.f0(this.f36774a)).i(iv);
        } else {
            iv.setImageDrawable(ContextCompat.getDrawable(this.f36774a, R.drawable.vector_app_icon_placeholder));
        }
    }
