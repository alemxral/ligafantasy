...
public final class X0 extends RecyclerView.ViewHolder {
    ...
    private W4.s f36689a;

    /* renamed from: b, reason: collision with root package name */
    private RelativeLayout f36690b;

    /* renamed from: c, reason: collision with root package name */
    private TextView f36691c;

    /* renamed from: d, reason: collision with root package name */
    private RecyclerView f36692d;

    /* renamed from: e, reason: collision with root package name */
    private LinearLayoutManager f36693e;

    /* renamed from: f, reason: collision with root package name */
    private final D4.U f36694f;
    ...
    public static final class a extends RecyclerView.OnScrollListener {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int i8) {
            ...
            if (i8 == 0) {
                int findFirstCompletelyVisibleItemPosition = X0.this.f36693e.findFirstCompletelyVisibleItemPosition();
                int findLastCompletelyVisibleItemPosition = X0.this.f36693e.findLastCompletelyVisibleItemPosition();
                int m8 = X0.this.e().m();
                if (findLastCompletelyVisibleItemPosition == X0.this.f36693e.getItemCount() - 1 && findLastCompletelyVisibleItemPosition != X0.this.e().m()) {
    ...
    public X0(View itemView, W4.s listener, InterfaceC1478a actionsClickListener, Context context, String fragmentName) {
        ...
        this.f36690b = (RelativeLayout) findViewById;
        ...
        this.f36692d = (RecyclerView) findViewById3;
        this.f36693e = new LinearLayoutManager(itemView.getContext(), 0, false);
        D4.U u8 = new D4.U(this.f36689a, actionsClickListener, context, fragmentName);
        this.f36694f = u8;
        new C3478f().attachToRecyclerView(this.f36692d);
        this.f36691c.setTypeface(E4.j.f2272g.t());
        this.f36692d.setLayoutManager(this.f36693e);
        this.f36692d.setItemAnimator(null);
        this.f36692d.setAdapter(u8);
        if (!SettingsPreferences.f29309b.L(context)) {
            this.f36692d.addOnScrollListener(new a());
        }
    }
    ...
    public static final void d(X0 this$0, X4.N topByCategory, View view) {
        ...
        this$0.f36689a.c(topByCategory);
    }

    public final void c(final X4.N topByCategory) {
        AbstractC3159y.i(topByCategory, "topByCategory");
        this.f36690b.setOnClickListener(new View.OnClickListener() { // from class: o5.W0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                X0.d(X0.this, topByCategory, view);
            }
        });
        this.f36691c.setText(topByCategory.b().f());
        this.f36694f.u(topByCategory.a());
    }
