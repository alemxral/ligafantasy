...
public final class C3544f extends RecyclerView.ViewHolder {
    ...
    private final InterfaceC1479b f36762a;

    /* renamed from: b, reason: collision with root package name */
    private final Context f36763b;

    /* renamed from: c, reason: collision with root package name */
    private final ImageView f36764c;

    /* renamed from: d, reason: collision with root package name */
    private final TextView f36765d;

    /* renamed from: e, reason: collision with root package name */
    private final TextView f36766e;

    /* renamed from: f, reason: collision with root package name */
    private final TextView f36767f;

    /* renamed from: g, reason: collision with root package name */
    private final RelativeLayout f36768g;
    ...
    public C3544f(View itemView, InterfaceC1479b interfaceC1479b, Context context) {
        ...
        this.f36764c = (ImageView) findViewById;
    ...
    public static final void b(C3544f this$0, View view) {
        ...
        if (this$0.f36762a != null && (bindingAdapterPosition = this$0.getBindingAdapterPosition()) != -1) {
            this$0.f36762a.a(bindingAdapterPosition);
        }
    }
    ...
    public final void c(C1496f c1496f) {
        ...
        if (c1496f != null) {
            d(c1496f);
            C3326n a8 = C3326n.f34490t.a(this.f36763b);
            a8.a();
            String Q8 = c1496f.Q();
            AbstractC3159y.f(Q8);
            X4.O u02 = a8.u0(Q8);
            a8.g();
            this.f36764c.setImageDrawable(C3307A.f34459a.k(this.f36763b, c1496f.Q(), R.drawable.vector_uptodown_logo_bag_disabled));
            this.f36765d.setText(c1496f.I());
            this.f36766e.setText(c1496f.h0());
            ...
            if (g6.n.s(str, c1496f.Q(), true)) {
                this.f36766e.setText(R.string.installing);
            }
            if (c1496f.i() == 1) {
                this.f36767f.setText(this.f36763b.getString(R.string.disabled_updates));
                this.f36767f.setVisibility(0);
            } else if (u02 != null && u02.f() == 1) {
                this.f36767f.setText(this.f36763b.getString(R.string.skipped_update));
                this.f36767f.setVisibility(0);
            } else {
