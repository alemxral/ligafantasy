...
public final class C3131e extends Presenter.ViewHolder {
    ...
    public static final a f33507l = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private final TextView f33508a;

    /* renamed from: b, reason: collision with root package name */
    private final TextView f33509b;

    /* renamed from: c, reason: collision with root package name */
    private final TextView f33510c;

    /* renamed from: d, reason: collision with root package name */
    private final TextView f33511d;

    /* renamed from: e, reason: collision with root package name */
    private final TextView f33512e;

    /* renamed from: f, reason: collision with root package name */
    private final TextView f33513f;

    /* renamed from: g, reason: collision with root package name */
    private final ProgressBar f33514g;

    /* renamed from: h, reason: collision with root package name */
    private final LinearLayout f33515h;

    /* renamed from: i, reason: collision with root package name */
    private final LinearLayout f33516i;

    /* renamed from: j, reason: collision with root package name */
    private final RelativeLayout f33517j;

    /* renamed from: k, reason: collision with root package name */
    private final TextView f33518k;
    ...
    public C3131e(View view) {
        ...
        this.f33508a = (TextView) findViewById;
        ...
        this.f33516i = (LinearLayout) findViewById8;
        ...
        this.f33517j = (RelativeLayout) findViewById9;
        ...
        this.f33518k = (TextView) findViewById10;
    }
    ...
    private final void l(Context context, C1498h c1498h) {
        if (c1498h.F0() == 0) {
            this.f33517j.setVisibility(8);
            return;
        }
        TextView textView = (TextView) this.f33517j.findViewById(R.id.tv_valoration_value_tv_app_detail);
        j.a aVar = E4.j.f2272g;
        textView.setTypeface(aVar.u());
        textView.setText(String.valueOf(c1498h.F0() / 10.0d));
        TextView textView2 = (TextView) this.f33517j.findViewById(R.id.tv_num_ratings);
        textView2.setTypeface(aVar.u());
        textView2.setText(String.valueOf(c1498h.G0()));
        View findViewById = this.f33517j.findViewById(R.id.iv_star1);
        AbstractC3159y.h(findViewById, "rlValoration.findViewById(R.id.iv_star1)");
        ImageView imageView = (ImageView) findViewById;
        View findViewById2 = this.f33517j.findViewById(R.id.iv_star2);
        AbstractC3159y.h(findViewById2, "rlValoration.findViewById(R.id.iv_star2)");
        ImageView imageView2 = (ImageView) findViewById2;
        View findViewById3 = this.f33517j.findViewById(R.id.iv_star3);
        AbstractC3159y.h(findViewById3, "rlValoration.findViewById(R.id.iv_star3)");
        ImageView imageView3 = (ImageView) findViewById3;
        View findViewById4 = this.f33517j.findViewById(R.id.iv_star4);
        AbstractC3159y.h(findViewById4, "rlValoration.findViewById(R.id.iv_star4)");
        ImageView imageView4 = (ImageView) findViewById4;
        View findViewById5 = this.f33517j.findViewById(R.id.iv_star5);
    ...
    public final void e(Context context, C1498h appInfo, int i8) {
        ...
        this.f33508a.setText(appInfo.s0());
        this.f33509b.setText(appInfo.T0());
        this.f33510c.setText(appInfo.s());
        m(i8);
        this.f33512e.setText(appInfo.g1());
        this.f33513f.setText(appInfo.k());
        l(context, appInfo);
    }
    ...
    public final void f(final Context context, C1498h c1498h) {
        ...
        if (arrayList != null) {
            ...
            if (N02.size() > 0) {
                ...
                while (it.hasNext()) {
                    F f8 = (F) it.next();
                    View inflate = LayoutInflater.from(context).inflate(R.layout.tv_article, (ViewGroup) this.f33516i, false);
                    ...
                    this.f33516i.addView(relativeLayout);
                }
                return;
            }
        }
        this.f33518k.setVisibility(8);
        this.f33516i.setVisibility(8);
    }
    ...
    public final void i(Context context, final C1498h c1498h) {
        ...
        if (arrayList != null && (linearLayout = this.f33515h) != null) {
            if (linearLayout.getChildCount() > 0) {
                this.f33515h.removeAllViews();
            }
    ...
    public final void m(int i8) {
        if (i8 > 0) {
            this.f33514g.setVisibility(0);
            this.f33514g.setProgress(i8);
        ...
        this.f33514g.setVisibility(8);
        this.f33511d.setVisibility(8);
    }

    public final void n(boolean z8) {
        this.f33514g.setIndeterminate(z8);
    }
}
