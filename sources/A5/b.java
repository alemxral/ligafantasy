...
public final class b {
    ...
    public static final class a extends AbstractC3160z implements n {
        ...
        public Object invoke(Object obj, Object obj2) {
            ...
            if (intValue > 0 && intValue <= g6.n.M((CharSequence) this.f487a.f33747a) + 1) {
                T t8 = this.f487a;
                StringBuilder sb = new StringBuilder((String) t8.f33747a);
                int i8 = intValue - 1;
                if (booleanValue) {
                    c8 = '1';
                } else {
    ...
    public final String a(Vector vector) {
        ...
        T t8 = new T();
        t8.f33747a = g6.n.w(MBridgeConstans.ENDCARD_URL_TYPE_PL, vector.getMaxId());
        vector.forEach(new a(t8));
        return (String) t8.f33747a;
    }
}
