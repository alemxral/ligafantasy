...
public interface a extends IInterface {
    ...
    public static final String f13569g = "android$support$customtabs$trusted$ITrustedWebActivityCallback".replace('$', '.');
    ...
    public static abstract class AbstractBinderC0270a extends Binder implements a {
        ...
        private static class C0271a implements a {
            ...
            private IBinder f13570a;

            C0271a(IBinder iBinder) {
                this.f13570a = iBinder;
            }
            ...
            public void onExtraCallback(String str, Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(a.f13569g);
                    obtain.writeString(str);
                    b.d(obtain, bundle, 0);
                    this.f13570a.transact(2, obtain, obtain2, 0);
        ...
        public AbstractBinderC0270a() {
            attachInterface(this, a.f13569g);
        }
        ...
        public static a asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(a.f13569g);
