...
public interface b extends IInterface {
    ...
    public static final String f13571h = "android$support$customtabs$trusted$ITrustedWebActivityService".replace('$', '.');
    ...
    public static abstract class a extends Binder implements b {
        ...
        private static class C0272a implements b {
            ...
            private IBinder f13572a;

            C0272a(IBinder iBinder) {
                this.f13572a = iBinder;
            }
            ...
            public Bundle areNotificationsEnabled(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(b.f13571h);
                    C0273b.d(obtain, bundle, 0);
                    this.f13572a.transact(6, obtain, obtain2, 0);
            ...
            public void cancelNotification(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(b.f13571h);
                    C0273b.d(obtain, bundle, 0);
                    this.f13572a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public Bundle extraCommand(String str, Bundle bundle, IBinder iBinder) {
                ...
                try {
                    ...
                    this.f13572a.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) C0273b.c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
            ...
            public Bundle getActiveNotifications() {
                ...
                try {
                    obtain.writeInterfaceToken(b.f13571h);
                    this.f13572a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) C0273b.c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
            ...
            public Bundle getSmallIconBitmap() {
                ...
                try {
                    obtain.writeInterfaceToken(b.f13571h);
                    this.f13572a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) C0273b.c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
            ...
            public int getSmallIconId() {
                ...
                try {
                    obtain.writeInterfaceToken(b.f13571h);
                    this.f13572a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public Bundle notifyNotificationWithChannel(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(b.f13571h);
                    C0273b.d(obtain, bundle, 0);
                    this.f13572a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) C0273b.c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
        ...
        public a() {
            attachInterface(this, b.f13571h);
        }
        ...
        public static b asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(b.f13571h);
