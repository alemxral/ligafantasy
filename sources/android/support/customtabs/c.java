...
public interface c extends IInterface {
    ...
    public static final String f13565e = "android$support$customtabs$IEngagementSignalsCallback".replace('$', '.');
    ...
    public static abstract class a extends Binder implements c {
        ...
        private static class C0268a implements c {
            ...
            private IBinder f13566a;

            C0268a(IBinder iBinder) {
                this.f13566a = iBinder;
            }
            ...
            public void onGreatestScrollPercentageIncreased(int i8, Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(c.f13565e);
                    obtain.writeInt(i8);
                    b.d(obtain, bundle, 0);
                    this.f13566a.transact(3, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onSessionEnded(boolean z8, Bundle bundle) {
                ...
                try {
                    ...
                    b.d(obtain, bundle, 0);
                    this.f13566a.transact(4, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onVerticalScrollEvent(boolean z8, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeInt(z8 ? 1 : 0);
                    b.d(obtain, bundle, 0);
                    this.f13566a.transact(2, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public a() {
            attachInterface(this, c.f13565e);
        }
        ...
        public static c asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(c.f13565e);
