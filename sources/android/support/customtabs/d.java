...
public interface d extends IInterface {
    ...
    public static final String f13567f = "android$support$customtabs$IPostMessageService".replace('$', '.');
    ...
    public static abstract class a extends Binder implements d {
        ...
        private static class C0269a implements d {
            ...
            private IBinder f13568a;

            C0269a(IBinder iBinder) {
                this.f13568a = iBinder;
            }
            ...
            public void onMessageChannelReady(android.support.customtabs.a aVar, Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(d.f13567f);
                    obtain.writeStrongInterface(aVar);
                    b.d(obtain, bundle, 0);
                    this.f13568a.transact(2, obtain, obtain2, 0);
            ...
            public void onPostMessage(android.support.customtabs.a aVar, String str, Bundle bundle) {
                ...
                try {
                    ...
                    b.d(obtain, bundle, 0);
                    this.f13568a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public a() {
            attachInterface(this, d.f13567f);
        }
        ...
        public static d asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(d.f13567f);
