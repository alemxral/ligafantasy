...
public interface a extends IInterface {
    ...
    public static final String f13561c = "android$support$customtabs$ICustomTabsCallback".replace('$', '.');
    ...
    public static abstract class AbstractBinderC0264a extends Binder implements a {
        ...
        private static class C0265a implements a {
            ...
            private IBinder f13562a;

            C0265a(IBinder iBinder) {
                this.f13562a = iBinder;
            }
            ...
            public void extraCallback(String str, Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(a.f13561c);
                    obtain.writeString(str);
                    b.d(obtain, bundle, 0);
                    this.f13562a.transact(3, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public Bundle extraCallbackWithResult(String str, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    b.d(obtain, bundle, 0);
                    this.f13562a.transact(7, obtain, obtain2, 0);
            ...
            public void onActivityLayout(int i8, int i9, int i10, int i11, int i12, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeInt(i12);
                    b.d(obtain, bundle, 0);
                    this.f13562a.transact(10, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onActivityResized(int i8, int i9, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeInt(i9);
                    b.d(obtain, bundle, 0);
                    this.f13562a.transact(8, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onMessageChannelReady(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(a.f13561c);
                    b.d(obtain, bundle, 0);
                    this.f13562a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onMinimized(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(a.f13561c);
                    b.d(obtain, bundle, 0);
                    this.f13562a.transact(11, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onNavigationEvent(int i8, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeInt(i8);
                    b.d(obtain, bundle, 0);
                    this.f13562a.transact(2, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onPostMessage(String str, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    b.d(obtain, bundle, 0);
                    this.f13562a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onRelationshipValidationResult(int i8, Uri uri, boolean z8, Bundle bundle) {
                ...
                try {
                    ...
                    b.d(obtain, bundle, 0);
                    this.f13562a.transact(6, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onUnminimized(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(a.f13561c);
                    b.d(obtain, bundle, 0);
                    this.f13562a.transact(12, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onWarmupCompleted(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(a.f13561c);
                    b.d(obtain, bundle, 0);
                    this.f13562a.transact(9, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public AbstractBinderC0264a() {
            attachInterface(this, a.f13561c);
        }
        ...
        public static a asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(a.f13561c);
