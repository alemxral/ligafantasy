...
public interface a extends IInterface {
    ...
    public static final String f13573i = "android$support$v4$app$INotificationSideChannel".replace('$', '.');
    ...
    public static abstract class AbstractBinderC0274a extends Binder implements a {
        ...
        private static class C0275a implements a {
            ...
            private IBinder f13574a;

            C0275a(IBinder iBinder) {
                this.f13574a = iBinder;
            }
            ...
            public void cancel(String str, int i8, String str2) {
                ...
                try {
                    obtain.writeInterfaceToken(a.f13573i);
                    obtain.writeString(str);
                    obtain.writeInt(i8);
                    obtain.writeString(str2);
                    this.f13574a.transact(2, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void cancelAll(String str) {
                ...
                try {
                    obtain.writeInterfaceToken(a.f13573i);
                    obtain.writeString(str);
                    this.f13574a.transact(3, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void notify(String str, int i8, String str2, Notification notification) {
                ...
                try {
                    ...
                    this.f13574a.transact(1, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public AbstractBinderC0274a() {
            attachInterface(this, a.f13573i);
        }
        ...
        public static a asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(a.f13573i);
