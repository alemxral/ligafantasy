...
abstract class c {
    ...
    static class b extends MediaController.Callback {
        ...
        public void onAudioInfoChanged(MediaController.PlaybackInfo playbackInfo) {
            this.f13669a.c(playbackInfo.getPlaybackType(), C0281c.b(playbackInfo), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume());
        }

        @Override // android.media.session.MediaController.Callback
        public void onExtrasChanged(Bundle bundle) {
            MediaSessionCompat.a(bundle);
            this.f13669a.a(bundle);
        }

        @Override // android.media.session.MediaController.Callback
        public void onMetadataChanged(MediaMetadata mediaMetadata) {
            this.f13669a.b(mediaMetadata);
        }

        @Override // android.media.session.MediaController.Callback
        public void onPlaybackStateChanged(PlaybackState playbackState) {
            this.f13669a.d(playbackState);
        }
