...
public final class MediaControllerCompat {
    ...
    private final MediaSessionCompat.Token f13621b;

    /* renamed from: c, reason: collision with root package name */
    private final HashSet f13622c = new HashSet();

    /* loaded from: classes.dex */
    static class MediaControllerImplApi21 implements b {

        /* renamed from: a, reason: collision with root package name */
        protected final Object f13623a;

        /* renamed from: b, reason: collision with root package name */
        final Object f13624b = new Object();

        /* renamed from: c, reason: collision with root package name */
        private final List f13625c = new ArrayList();

        /* renamed from: d, reason: collision with root package name */
        private HashMap f13626d = new HashMap();

        /* renamed from: e, reason: collision with root package name */
        final MediaSessionCompat.Token f13627e;
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            /* renamed from: a, reason: collision with root package name */
            private WeakReference f13628a;

            ExtraBinderRequestResultReceiver(MediaControllerImplApi21 mediaControllerImplApi21) {
                super(null);
                this.f13628a = new WeakReference(mediaControllerImplApi21);
            }

            @Override // android.os.ResultReceiver
            protected void onReceiveResult(int i8, Bundle bundle) {
                MediaControllerImplApi21 mediaControllerImplApi21 = (MediaControllerImplApi21) this.f13628a.get();
                if (mediaControllerImplApi21 != null && bundle != null) {
                    synchronized (mediaControllerImplApi21.f13624b) {
                        mediaControllerImplApi21.f13627e.i(b.a.i(BundleCompat.getBinder(bundle, "android.support.v4.media.session.EXTRA_BINDER")));
                        mediaControllerImplApi21.f13627e.j(bundle.getBundle("android.support.v4.media.session.SESSION_TOKEN2_BUNDLE"));
        ...
        public MediaMetadataCompat a() {
            Object d8 = android.support.v4.media.session.c.d(this.f13623a);
            if (d8 != null) {
        ...
        public final void b(a aVar) {
            android.support.v4.media.session.c.i(this.f13623a, aVar.mCallbackObj);
            synchronized (this.f13624b) {
                if (this.f13627e.e() != null) {
                    try {
                        a aVar2 = (a) this.f13626d.remove(aVar);
                        if (aVar2 != null) {
                            aVar.mIControllerCallback = null;
                            this.f13627e.e().F(aVar2);
                        }
                    } catch (RemoteException e8) {
                        Log.e("MediaControllerCompat", "Dead object in unregisterCallback.", e8);
                    }
                } else {
                    this.f13625c.remove(aVar);
                }
            }
        }
        ...
        public boolean c(KeyEvent keyEvent) {
            return android.support.v4.media.session.c.b(this.f13623a, keyEvent);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.b
        public f d() {
            Object f8 = android.support.v4.media.session.c.f(this.f13623a);
            if (f8 != null) {
                return new g(f8);
            }
            return null;
        ...
        public final void e(a aVar, Handler handler) {
            android.support.v4.media.session.c.g(this.f13623a, aVar.mCallbackObj, handler);
            synchronized (this.f13624b) {
                if (this.f13627e.e() != null) {
                    a aVar2 = new a(aVar);
                    this.f13626d.put(aVar, aVar2);
                    aVar.mIControllerCallback = aVar2;
                    try {
                        this.f13627e.e().n(aVar2);
        ...
        public PlaybackStateCompat getPlaybackState() {
            if (this.f13627e.e() != null) {
                try {
                    return this.f13627e.e().getPlaybackState();
                } catch (RemoteException e8) {
                    Log.e("MediaControllerCompat", "Dead object in getPlaybackState.", e8);
                }
            }
            Object e9 = android.support.v4.media.session.c.e(this.f13623a);
            if (e9 != null) {
        ...
        public void h(String str, Bundle bundle, ResultReceiver resultReceiver) {
            android.support.v4.media.session.c.h(this.f13623a, str, bundle, resultReceiver);
        }
    }
    ...
    public static abstract class a implements IBinder.DeathRecipient {
        ...
        private static class b implements c.a {
            ...
            /* renamed from: a, reason: collision with root package name */
            private final WeakReference f13631a;
        ...
        private static class c extends a.AbstractBinderC0279a {
            ...
            /* renamed from: a, reason: collision with root package name */
            private final WeakReference f13632a;
    ...
    public MediaControllerCompat(Context context, MediaSessionCompat.Token token) {
        if (token != null) {
            ...
            if (i8 >= 24) {
                this.f13620a = new d(context, token);
                return;
            } else if (i8 >= 23) {
                this.f13620a = new c(context, token);
                return;
            } else {
                this.f13620a = new MediaControllerImplApi21(context, token);
                return;
            }
        }
    ...
    public boolean a(KeyEvent keyEvent) {
        if (keyEvent != null) {
            return this.f13620a.c(keyEvent);
        }
    ...
    public PlaybackStateCompat c() {
        return this.f13620a.getPlaybackState();
    }
