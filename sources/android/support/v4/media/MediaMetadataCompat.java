...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final ArrayMap f13610d;

    /* renamed from: e, reason: collision with root package name */
    private static final String[] f13611e;

    /* renamed from: f, reason: collision with root package name */
    private static final String[] f13612f;

    /* renamed from: g, reason: collision with root package name */
    private static final String[] f13613g;

    /* renamed from: a, reason: collision with root package name */
    final Bundle f13614a;

    /* renamed from: b, reason: collision with root package name */
    private Object f13615b;

    /* renamed from: c, reason: collision with root package name */
    private MediaDescriptionCompat f13616c;
    ...
    static {
        ...
        f13611e = new String[]{"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};
        f13612f = new String[]{"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};
        f13613g = new String[]{"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};
        CREATOR = new a();
    }

    MediaMetadataCompat(Parcel parcel) {
        this.f13614a = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
    ...
    public Bitmap c(String str) {
        try {
            return (Bitmap) this.f13614a.getParcelable(str);
        } catch (Exception e8) {
    ...
    public MediaDescriptionCompat e() {
        ...
        Bitmap bitmap;
        Uri uri2;
        MediaDescriptionCompat mediaDescriptionCompat = this.f13616c;
        ...
        if (this.f13614a.containsKey("android.media.metadata.BT_FOLDER_TYPE")) {
            bundle.putLong("android.media.extra.BT_FOLDER_TYPE", f("android.media.metadata.BT_FOLDER_TYPE"));
        }
        if (this.f13614a.containsKey("android.media.metadata.DOWNLOAD_STATUS")) {
    ...
    public long f(String str) {
        return this.f13614a.getLong(str, 0L);
    }

    public String i(String str) {
        CharSequence charSequence = this.f13614a.getCharSequence(str);
    ...
    public CharSequence j(String str) {
        return this.f13614a.getCharSequence(str);
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i8) {
        parcel.writeBundle(this.f13614a);
    }
}
