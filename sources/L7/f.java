...
public final class f implements e {
    ...
    public final SharedStorage f6706a;

    /* renamed from: b, reason: collision with root package name */
    public final y5.s f6707b;

    /* renamed from: c, reason: collision with root package name */
    public final ChoiceCmpCallback f6708c;

    /* renamed from: d, reason: collision with root package name */
    public final A5.f f6709d;
    ...
    public f(SharedStorage sharedStorage, y5.s tcModel, ChoiceCmpCallback choiceCmpCallback) {
        ...
        this.f6706a = sharedStorage;
        this.f6707b = tcModel;
        this.f6708c = choiceCmpCallback;
        this.f6709d = new A5.f(Boolean.TRUE, 2, AbstractC1246t.s(y5.l.CORE));
    }
    ...
    public void a(PrivacyEncodingMode encodingMode, boolean z8) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            sVar.f39914b = epochMilli;
            sVar.f39915c = epochMilli;
        } else {
            ...
            sVar.f39914b = timeInMillis;
            sVar.f39915c = timeInMillis;
        }
        int i9 = a.f6710a[encodingMode.ordinal()];
        int i10 = 1;
        if (i9 != 1) {
            if (i9 != 2) {
                b();
        ...
        SharedStorage sharedStorage = this.f6706a;
        N7.a aVar = N7.a.NON_IAB_CONSENT_ENCODED;
        y5.s sVar2 = this.f6707b;
        long j8 = sVar2.f39914b;
        long j9 = sVar2.f39915c;
        int i11 = sVar2.f39925m;
        int i12 = sVar2.f39926n;
        int maxId = sVar2.f39906A.getMaxId();
        Set<Integer> vendorConsents = sVar2.f39906A.getAcceptedItems();
        ...
        if (z8) {
            ChoiceCmpCallback choiceCmpCallback2 = this.f6708c;
            ...
            ChoiceCmpCallback choiceCmpCallback3 = this.f6708c;
            if (choiceCmpCallback3 != null) {
                if (this.f6706a.i(N7.a.TCF_GDPR_APPLIES) == 1) {
                    z9 = true;
                } else {
                    z9 = false;
                }
                choiceCmpCallback3.onNonIABVendorConsentGiven(new NonIABData(z9, false, false, this.f6706a.j(N7.a.NON_IAB_CONSENT_ENCODED), this.f6707b.f39906A.getMap()));
            }
            if (this.f6706a.h(N7.a.GOOGLE_ENABLED) && (choiceCmpCallback = this.f6708c) != null) {
                Set<Integer> vendorsID = this.f6707b.f39907B.getAcceptedItems();
    ...
    public final void b() {
        ...
        y5.s sVar = this.f6707b;
        SharedStorage sharedStorage = this.f6706a;
        String gppString = AbstractC3997d.f39869a.a(sVar);
        A5.b bVar = A5.b.f486a;
        String nonIabVendorConsents = bVar.a(sVar.f39906A);
        String nonIabVendorConsentsEncoded = I7.b.b(sVar.f39906A.toString());
        String nonIabVendorLegitimateInterests = bVar.a(sVar.f39909D);
        Set<Integer> vendorsID = sVar.f39907B.getAcceptedItems();
        AbstractC3159y.i(vendorsID, "vendorsID");
        ...
        String iabVendorConsents = bVar.a(sVar.f39938z);
        String vendorLegitimateInterests = bVar.a(sVar.f39908C);
        String purposeConsents = bVar.a(sVar.f39930r);
        String purposeLegitimateInterests = bVar.a(sVar.f39931s);
        String specialFeatureOptions = bVar.a(sVar.f39929q);
        String publisherRestrictions = sVar.f39912G.f39885c.toString();
        String publisherConsents = bVar.a(sVar.f39934v);
        String publisherLegitimateInterests = bVar.a(sVar.f39935w);
        String publisherCustomConsents = bVar.a(sVar.f39936x);
        String publisherCustomLegitimateInterests = bVar.a(sVar.f39937y);
    ...
    public final void c() {
        ...
        y5.s sVar = this.f6707b;
        SharedStorage sharedStorage = this.f6706a;
        String tcString = y5.v.f39942a.a(sVar, this.f6709d);
        A5.b bVar = A5.b.f486a;
        String nonIabVendorConsents = bVar.a(sVar.f39906A);
        String nonIabVendorConsentsEncoded = I7.b.b(sVar.f39906A.toString());
        String nonIabVendorLegitimateInterests = bVar.a(sVar.f39909D);
