...
public final class c extends AbstractC1230c implements a, Serializable {
    ...
    public boolean a(Enum element) {
        ...
        if (((Enum) AbstractC1239l.k0(this.f8747a, element.ordinal())) == element) {
            return true;
        }
        return false;
    }
    ...
    public Enum get(int i8) {
        AbstractC1230c.Companion.b(i8, this.f8747a.length);
        return this.f8747a[i8];
    }
    ...
    public int h(Enum element) {
        ...
        if (((Enum) AbstractC1239l.k0(this.f8747a, ordinal)) != element) {
            return -1;
        }
        return ordinal;
    }
