...
public class C1350q {
    ...
    private OutputStream f8832a;

    public C1350q(OutputStream outputStream) {
        this.f8832a = outputStream;
    }
    ...
    public C1334c0 d() {
        return new C1334c0(this.f8832a);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public C1350q e() {
        return new q0(this.f8832a);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void f(int i8) {
        this.f8832a.write(i8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void g(byte[] bArr, int i8, int i9) {
        this.f8832a.write(bArr, i8, i9);
    }
