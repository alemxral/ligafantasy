...
public class C1357y {
    ...
    private void e(boolean z8) {
        InputStream inputStream = this.f8851a;
    ...
    public InterfaceC1335d b() {
        boolean z8;
        int read = this.f8851a.read();
        if (read == -1) {
            return null;
        }
        boolean z9 = false;
        e(false);
        int o8 = C1343j.o(this.f8851a, read);
        if ((read & 32) != 0) {
            z8 = true;
        } else {
            z8 = false;
        ...
        if (l8 < 0) {
            if (z8) {
                C1357y c1357y = new C1357y(new z0(this.f8851a, this.f8852b), this.f8852b);
        ...
        x0 x0Var = new x0(this.f8851a, l8, this.f8852b);
        if ((read & PsExtractor.AUDIO_STREAM) == 192) {
        ...
        if (o8 != 4) {
            try {
                return C1343j.b(o8, x0Var, this.f8853c);
    ...
    public AbstractC1351s c(boolean z8, int i8) {
        if (!z8) {
            return new w0(false, i8, new C1330a0(((x0) this.f8851a).g()));
        }
        C1337e d8 = d();
        if (this.f8851a instanceof z0) {
            if (d8.f() == 1) {
    ...
    public C1357y(InputStream inputStream, int i8) {
        this.f8851a = inputStream;
        this.f8852b = i8;
        this.f8853c = new byte[11];
    }
}
