...
public class C1344k extends AbstractC1351s {
    ...
    public C1344k(long j8) {
        this.f8820a = BigInteger.valueOf(j8).toByteArray();
        this.f8821b = 0;
    }
    ...
    public boolean m(AbstractC1351s abstractC1351s) {
        ...
        return E7.a.a(this.f8820a, ((C1344k) abstractC1351s).f8820a);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // R6.AbstractC1351s
    public void p(C1350q c1350q, boolean z8) {
        c1350q.n(z8, 2, this.f8820a);
    }
    ...
    public BigInteger y() {
        return new BigInteger(this.f8820a);
    }
    ...
    public C1344k(BigInteger bigInteger) {
        this.f8820a = bigInteger.toByteArray();
        this.f8821b = 0;
    }
    ...
    public C1344k(byte[] bArr, boolean z8) {
        ...
        this.f8820a = z8 ? E7.a.d(bArr) : bArr;
        this.f8821b = F(bArr);
    }
}
