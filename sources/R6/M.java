...
public class M extends AbstractC1358z {
    ...
    public void p(C1350q c1350q, boolean z8) {
        Enumeration z9;
        c1350q.v(z8, 160, this.f8854a);
        c1350q.f(128);
        if (!this.f8855b) {
            InterfaceC1335d interfaceC1335d = this.f8856c;
            if (interfaceC1335d instanceof AbstractC1348o) {
                ...
                throw new C1340g("not implemented: " + this.f8856c.getClass().getName());
            }
            c1350q.h(z9);
        } else {
            c1350q.u(this.f8856c.d(), true);
        }
        c1350q.f(0);
        c1350q.f(0);
    }
    ...
    @Override // R6.AbstractC1351s
    public boolean t() {
        if (!this.f8855b && !this.f8856c.d().t()) {
            return false;
        }
        return true;
    }
