...
public class E extends AbstractC1348o {
    ...
    private final AbstractC1348o[] f8761c;
    ...
    public class a implements Enumeration {
        ...
        public boolean hasMoreElements() {
            if (this.f8762a < E.this.f8829a.length) {
                return true;
            }
            return false;
        }
        ...
        public Object nextElement() {
            ...
            byte[] bArr = e8.f8829a;
            if (i8 < bArr.length) {
                int min = Math.min(bArr.length - i8, e8.f8760b);
                byte[] bArr2 = new byte[min];
                System.arraycopy(E.this.f8829a, this.f8762a, bArr2, 0, min);
                this.f8762a += min;
    ...
    public class b implements Enumeration {
        ...
        @Override // java.util.Enumeration
        public boolean hasMoreElements() {
            if (this.f8764a < E.this.f8761c.length) {
                return true;
            }
            return false;
        }
        ...
        public Object nextElement() {
            if (this.f8764a < E.this.f8761c.length) {
                AbstractC1348o[] abstractC1348oArr = E.this.f8761c;
                int i8 = this.f8764a;
                this.f8764a = i8 + 1;
