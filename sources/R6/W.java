...
public class W extends AbstractC1351s {
    ...
    public W(byte[] bArr) {
        this.f8781a = E7.a.d(bArr);
    }

    @Override // R6.AbstractC1351s, R6.AbstractC1346m
    public int hashCode() {
        return E7.a.k(this.f8781a);
    }
    ...
    public boolean m(AbstractC1351s abstractC1351s) {
        ...
        return E7.a.a(this.f8781a, ((W) abstractC1351s).f8781a);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // R6.AbstractC1351s
    public void p(C1350q c1350q, boolean z8) {
        c1350q.n(z8, 25, this.f8781a);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // R6.AbstractC1351s
    public int q() {
        return E0.a(this.f8781a.length) + 1 + this.f8781a.length;
    }
