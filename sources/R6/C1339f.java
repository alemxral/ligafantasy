...
public class C1339f extends AbstractC1351s {
    ...
    private static C1339f[] f8802c = new C1339f[12];
    ...
    public boolean m(AbstractC1351s abstractC1351s) {
        ...
        return E7.a.a(this.f8803a, ((C1339f) abstractC1351s).f8803a);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // R6.AbstractC1351s
    public void p(C1350q c1350q, boolean z8) {
        c1350q.n(z8, 10, this.f8803a);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // R6.AbstractC1351s
    public int q() {
        return E0.a(this.f8803a.length) + 1 + this.f8803a.length;
    }
