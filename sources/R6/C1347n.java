...
public class C1347n extends AbstractC1351s {
    ...
    private static final ConcurrentMap f8824c = new ConcurrentHashMap();
    ...
    public static class a {
        ...
        a(byte[] bArr) {
            this.f8827a = E7.a.k(bArr);
            this.f8828b = bArr;
        }

        public boolean equals(Object obj) {
            if (obj instanceof a) {
                return E7.a.a(this.f8828b, ((a) obj).f8828b);
            }
            return false;
        }
    ...
    */
    ...
    public static C1347n y(byte[] bArr) {
        C1347n c1347n = (C1347n) f8824c.get(new a(bArr));
        if (c1347n == null) {
    ...
    private synchronized byte[] z() {
        try {
            if (this.f8826b == null) {
                ...
                this.f8826b = byteArrayOutputStream.toByteArray();
            }
        } catch (Throwable th) {
            throw th;
        }
    ...
    public C1347n C() {
        a aVar = new a(z());
        ConcurrentMap concurrentMap = f8824c;
    ...
    public boolean m(AbstractC1351s abstractC1351s) {
        ...
        return this.f8825a.equals(((C1347n) abstractC1351s).f8825a);
    }
    ...
    C1347n(byte[] bArr) {
        ...
        this.f8825a = stringBuffer.toString();
        this.f8826b = E7.a.d(bArr);
    }
}
