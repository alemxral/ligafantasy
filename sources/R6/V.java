...
public class V extends C1342i {
    ...
    private byte[] A() {
        byte[] bArr = this.f8813a;
        if (bArr[bArr.length - 1] == 90) {
            if (!x()) {
                byte[] bArr2 = this.f8813a;
                byte[] bArr3 = new byte[bArr2.length + 4];
                System.arraycopy(bArr2, 0, bArr3, 0, bArr2.length - 1);
                System.arraycopy(E7.h.d("0000Z"), 0, bArr3, this.f8813a.length - 1, 5);
                return bArr3;
            }
            if (!y()) {
                byte[] bArr4 = this.f8813a;
                byte[] bArr5 = new byte[bArr4.length + 2];
                System.arraycopy(bArr4, 0, bArr5, 0, bArr4.length - 1);
                System.arraycopy(E7.h.d("00Z"), 0, bArr5, this.f8813a.length - 1, 3);
                return bArr5;
            }
            if (w()) {
                int length = this.f8813a.length - 2;
                while (length > 0 && this.f8813a[length] == 48) {
                    length--;
                }
                byte[] bArr6 = this.f8813a;
                if (bArr6[length] == 46) {
