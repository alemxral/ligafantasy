...
public abstract class AbstractC1341h extends AbstractC1351s {
    ...
    public AbstractC1341h(C1337e c1337e) {
        ...
        z(abstractC1358z.y());
        this.f8812e = abstractC1358z.x();
    }

    private void A(AbstractC1351s abstractC1351s) {
        this.f8812e = abstractC1351s;
    }
    ...
    public int hashCode() {
        int i8;
        C1347n c1347n = this.f8808a;
        if (c1347n != null) {
            i8 = c1347n.hashCode();
        } else {
            i8 = 0;
        }
        C1344k c1344k = this.f8809b;
        if (c1344k != null) {
            i8 ^= c1344k.hashCode();
        }
        AbstractC1351s abstractC1351s = this.f8810c;
        if (abstractC1351s != null) {
            i8 ^= abstractC1351s.hashCode();
        }
        return i8 ^ this.f8812e.hashCode();
    }
    ...
    public boolean m(AbstractC1351s abstractC1351s) {
        ...
        C1347n c1347n2 = this.f8808a;
        if (c1347n2 != null && ((c1347n = abstractC1341h.f8808a) == null || !c1347n.r(c1347n2))) {
            return false;
        }
        C1344k c1344k2 = this.f8809b;
        if (c1344k2 != null && ((c1344k = abstractC1341h.f8809b) == null || !c1344k.r(c1344k2))) {
            return false;
        }
        AbstractC1351s abstractC1351s3 = this.f8810c;
        if (abstractC1351s3 != null && ((abstractC1351s2 = abstractC1341h.f8810c) == null || !abstractC1351s2.r(abstractC1351s3))) {
            return false;
        }
        return this.f8812e.r(abstractC1341h.f8812e);
    }
    ...
    public AbstractC1351s u() {
        return new S(this.f8808a, this.f8809b, this.f8810c, this.f8811d, this.f8812e);
    }
