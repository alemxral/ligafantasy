...
public abstract class AbstractC1353u extends AbstractC1351s implements Iterable {
    ...
    class a implements Enumeration {
        ...
        public boolean hasMoreElements() {
            if (this.f8840a < AbstractC1353u.this.f8839a.length) {
                return true;
            }
            return false;
        }
        ...
        public Object nextElement() {
            int i8 = this.f8840a;
            InterfaceC1335d[] interfaceC1335dArr = AbstractC1353u.this.f8839a;
    ...
    public int hashCode() {
        int length = this.f8839a.length;
        int i8 = length + 1;
        while (true) {
            length--;
            if (length >= 0) {
                i8 = (i8 * 257) ^ this.f8839a[length].d().hashCode();
            } else {
                return i8;
            }
        }
    ...
    public Iterator iterator() {
        return new a.C0037a(this.f8839a);
    }
    ...
    public boolean m(AbstractC1351s abstractC1351s) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            AbstractC1351s d8 = this.f8839a[i8].d();
            AbstractC1351s d9 = abstractC1353u.f8839a[i8].d();
            if (d8 != d9 && !d8.m(d9)) {
                return false;
            }
        }
    ...
    public String toString() {
        ...
        int i8 = 0;
        while (true) {
            stringBuffer.append(this.f8839a[i8]);
            i8++;
            if (i8 >= size) {
                stringBuffer.append(']');
    ...
    public AbstractC1351s u() {
        return new C1338e0(this.f8839a, false);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // R6.AbstractC1351s
    public AbstractC1351s v() {
        return new s0(this.f8839a, false);
    }

    public InterfaceC1335d x(int i8) {
        return this.f8839a[i8];
    }
    ...
    public AbstractC1353u(C1337e c1337e) {
        ...
        this.f8839a = c1337e.g();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public AbstractC1353u(InterfaceC1335d[] interfaceC1335dArr, boolean z8) {
        this.f8839a = z8 ? C1337e.b(interfaceC1335dArr) : interfaceC1335dArr;
    }
}
