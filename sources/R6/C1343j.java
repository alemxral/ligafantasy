...
public class C1343j extends FilterInputStream {
    ...
    protected AbstractC1351s a(int i8, int i9, int i10) {
        ...
        x0 x0Var = new x0(this, i10, this.f8815a);
    ...
    protected int h() {
        return l(this, this.f8815a, false);
    }
    ...
    public AbstractC1351s m() {
        ...
        if (h8 < 0) {
            if (z8) {
                C1357y c1357y = new C1357y(new z0(this, this.f8815a), this.f8815a);
