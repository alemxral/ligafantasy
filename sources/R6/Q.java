...
public class Q extends AbstractC1331b {
    ...
    public static Q C(Object obj) {
        if (obj != null && !(obj instanceof Q)) {
            if (obj instanceof n0) {
                n0 n0Var = (n0) obj;
                return new Q(n0Var.f8790a, n0Var.f8791b);
            }
    ...
    public void p(C1350q c1350q, boolean z8) {
        ...
        c1350q.k(z8, 3, (byte) this.f8791b, bArr);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // R6.AbstractC1351s
    public int q() {
        return E0.a(this.f8790a.length + 1) + 1 + this.f8790a.length + 1;
    }
