...
public abstract class AbstractC1355w extends AbstractC1351s implements Iterable {
    ...
    protected final InterfaceC1335d[] f8844a;
    ...
    class a implements Enumeration {
        ...
        public boolean hasMoreElements() {
            if (this.f8846a < AbstractC1355w.this.f8844a.length) {
                return true;
            }
            return false;
        }
        ...
        public Object nextElement() {
            int i8 = this.f8846a;
            InterfaceC1335d[] interfaceC1335dArr = AbstractC1355w.this.f8844a;
    ...
    public int hashCode() {
        ...
        while (true) {
            length--;
            if (length >= 0) {
                i8 += this.f8844a[length].d().hashCode();
            } else {
                return i8;
            }
        }
    ...
    public boolean m(AbstractC1351s abstractC1351s) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            AbstractC1351s d8 = f0Var.f8844a[i8].d();
            AbstractC1351s d9 = f0Var2.f8844a[i8].d();
            if (d8 != d9 && !d8.m(d9)) {
                return false;
            }
        }
    ...
    public String toString() {
        ...
        int i8 = 0;
        while (true) {
            stringBuffer.append(this.f8844a[i8]);
            i8++;
            if (i8 >= size) {
                stringBuffer.append(']');
    ...
    public AbstractC1351s u() {
        ...
        if (this.f8845b) {
            interfaceC1335dArr = this.f8844a;
        } else {
            interfaceC1335dArr = (InterfaceC1335d[]) this.f8844a.clone();
    ...
    public AbstractC1351s v() {
        return new u0(this.f8845b, this.f8844a);
    }
    ...
    public AbstractC1355w(InterfaceC1335d interfaceC1335d) {
        ...
        this.f8844a = new InterfaceC1335d[]{interfaceC1335d};
        this.f8845b = true;
    }
    ...
    public AbstractC1355w(C1337e c1337e, boolean z8) {
        ...
        this.f8844a = g8;
        this.f8845b = z8 || g8.length < 2;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public AbstractC1355w(boolean z8, InterfaceC1335d[] interfaceC1335dArr) {
        this.f8844a = interfaceC1335dArr;
        this.f8845b = z8 || interfaceC1335dArr.length < 2;
    }
}
