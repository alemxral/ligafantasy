...
public final class C3695f extends AbstractC3483C {
    ...
    private final AtomicReferenceArray f37672e;

    public C3695f(long j8, C3695f c3695f, int i8) {
        super(j8, c3695f, i8);
        int i9;
        i9 = AbstractC3694e.f37671f;
        this.f37672e = new AtomicReferenceArray(i9);
    }
    ...
    public String toString() {
        return "SemaphoreSegment[id=" + this.f36219c + ", hashCode=" + hashCode() + ']';
    }
}
