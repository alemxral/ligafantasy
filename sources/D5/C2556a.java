...
public final class C2556a {
    ...
    public static final C0726a f30163b = new C0726a(null);
    ...
    public final C1929d b(String token) {
        ...
        String str = "/eapi/sdk-installation/" + Settings.Secure.getString(this.f30164a.getContentResolver(), "android_id");
        HashMap hashMap = new HashMap();
        String jSONObject = new C1881a(this.f30164a, token).a(this.f30164a).toString();
        AbstractC3159y.h(jSONObject, "jsonObjectContext.toString()");
        hashMap.put("context", jSONObject);
        String jSONObject2 = new C1882b(this.f30164a).a().toString();
        AbstractC3159y.h(jSONObject2, "jsonObjectFile.toString()");
        hashMap.put("file", jSONObject2);
        StringBuilder sb = new StringBuilder();
        C1926a c1926a = C1926a.f14971a;
        sb.append(c1926a.b());
        sb.append(str);
        String sb2 = sb.toString();
