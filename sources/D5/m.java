...
public final class m implements ViewModelProvider.Factory {
    ...
    public ViewModel create(Class modelClass) {
        ...
        return new l(dVar.n(), dVar.j(), ChoiceCmp.INSTANCE.getGoogleVendorList$app_release(), dVar.j().f2373b.b(), dVar.k(), dVar.c(), dVar.j().f2373b.f2347q, dVar.p().c(), dVar.e(), dVar.f());
    }
}
