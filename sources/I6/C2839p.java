...
public class C2839p extends Z implements InterfaceC2837o, kotlin.coroutines.jvm.internal.e, e1 {
    ...
    private static final AtomicIntegerFieldUpdater f31779f = AtomicIntegerFieldUpdater.newUpdater(C2839p.class, "_decisionAndIndex");

    /* renamed from: g, reason: collision with root package name */
    private static final AtomicReferenceFieldUpdater f31780g = AtomicReferenceFieldUpdater.newUpdater(C2839p.class, Object.class, "_state");

    /* renamed from: h, reason: collision with root package name */
    private static final AtomicReferenceFieldUpdater f31781h = AtomicReferenceFieldUpdater.newUpdater(C2839p.class, Object.class, "_parentHandle");
    private volatile int _decisionAndIndex;
    private volatile Object _parentHandle;
    private volatile Object _state;

    /* renamed from: d, reason: collision with root package name */
    private final P5.d f31782d;

    /* renamed from: e, reason: collision with root package name */
    private final P5.g f31783e;

    public C2839p(P5.d dVar, int i8) {
        super(i8);
        this.f31782d = dVar;
        this.f31783e = dVar.getContext();
        this._decisionAndIndex = 536870911;
        this._state = C2815d.f31740a;
    }
    ...
    private final InterfaceC2816d0 D() {
        InterfaceC2855x0 interfaceC2855x0 = (InterfaceC2855x0) getContext().get(InterfaceC2855x0.f31795n0);
        if (interfaceC2855x0 == null) {
            return null;
        }
        InterfaceC2816d0 d8 = InterfaceC2855x0.a.d(interfaceC2855x0, true, false, new C2846t(this), 2, null);
        androidx.concurrent.futures.a.a(f31781h, this, null, d8);
        return d8;
    }

    private final void E(Object obj) {
        boolean z8;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f31780g;
        while (true) {
            Object obj2 = atomicReferenceFieldUpdater.get(this);
            if (obj2 instanceof C2815d) {
                if (androidx.concurrent.futures.a.a(f31780g, this, obj2, obj)) {
                    return;
                }
            } else {
                ...
                if (z8) {
                    ...
                    if (obj2 instanceof C2803B) {
                        ...
                        if (c2803b.c()) {
                            l(abstractC2833m, c2803b.f31662e);
                            return;
                        } else {
                            if (androidx.concurrent.futures.a.a(f31780g, this, obj2, C2803B.b(c2803b, null, abstractC2833m, null, null, null, 29, null))) {
                                return;
                            }
                        }
                    } else {
                        ...
                        AbstractC3159y.g(obj, "null cannot be cast to non-null type kotlinx.coroutines.CancelHandler");
                        if (androidx.concurrent.futures.a.a(f31780g, this, obj2, new C2803B(obj2, (AbstractC2833m) obj, null, null, null, 28, null))) {
                            return;
                        }
                    }
                }
    ...
    private final boolean F() {
        if (AbstractC2810a0.c(this.f31725c)) {
            P5.d dVar = this.f31782d;
    ...
    private final void M(Object obj, int i8, Function1 function1) {
        ...
        } while (!androidx.concurrent.futures.a.a(f31780g, this, obj2, O((N0) obj2, obj, i8, function1, null)));
        s();
        t(i8);
    }
    ...
    private final boolean P() {
        int i8;
        AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = f31779f;
        do {
        ...
        } while (!f31779f.compareAndSet(this, i8, 1073741824 + (536870911 & i8)));
        return true;
    }
    ...
    private final C3486F Q(Object obj, Object obj2, Function1 function1) {
        ...
        do {
            ...
            if (obj3 instanceof N0) {
                ...
                if (!(obj3 instanceof C2803B) || obj2 == null || ((C2803B) obj3).f31661d != obj2) {
                    return null;
                }
                return AbstractC2841q.f31784a;
            }
        } while (!androidx.concurrent.futures.a.a(f31780g, this, obj3, O((N0) obj3, obj, this.f31725c, function1, obj2)));
        s();
        return AbstractC2841q.f31784a;
    }
    ...
    private final boolean R() {
        ...
        } while (!f31779f.compareAndSet(this, i8, 536870912 + (536870911 & i8)));
        return true;
    }
    ...
    private final void o(AbstractC3483C abstractC3483C, Throwable th) {
        int i8 = f31779f.get(this) & 536870911;
        if (i8 != 536870911) {
            try {
    ...
    private final InterfaceC2816d0 x() {
        return (InterfaceC2816d0) f31781h.get(this);
    }
    ...
    public final boolean L() {
        ...
        if ((obj instanceof C2803B) && ((C2803B) obj).f31661d != null) {
            r();
            return false;
        }
        f31779f.set(this, 536870911);
        atomicReferenceFieldUpdater.set(this, C2815d.f31740a);
        return true;
    }
        ...
        while (true) {
            ...
            if (!(obj2 instanceof N0)) {
                ...
                if (obj2 instanceof C2803B) {
                    C2803B c2803b = (C2803B) obj2;
                    if (!c2803b.c()) {
                        if (androidx.concurrent.futures.a.a(f31780g, this, obj2, C2803B.b(c2803b, null, null, null, null, th, 15, null))) {
                            c2803b.d(this, th);
                            return;
                        }
                    } else {
                ...
                } else if (androidx.concurrent.futures.a.a(f31780g, this, obj2, new C2803B(obj2, null, null, null, th, 14, null))) {
                    return;
                }
            } else {
    ...
    public void resumeWith(Object obj) {
        N(this, AbstractC2808G.b(obj, this), this.f31725c, null, 4, null);
    }

    public String toString() {
        return I() + '(' + Q.c(this.f31782d) + "){" + A() + "}@" + Q.b(this);
    }
    ...
    public boolean v(Throwable th) {
        ...
        } while (!androidx.concurrent.futures.a.a(f31780g, this, obj, new C2844s(this, th, z8)));
        N0 n02 = (N0) obj;
        if (n02 instanceof AbstractC2833m) {
            l((AbstractC2833m) obj, th);
    ...
    public final Object y() {
        ...
        if (!(z8 instanceof C2804C)) {
            if (AbstractC2810a0.b(this.f31725c) && (interfaceC2855x0 = (InterfaceC2855x0) getContext().get(InterfaceC2855x0.f31795n0)) != null && !interfaceC2855x0.isActive()) {
        ...
        throw ((C2804C) z8).f31664a;
    }

    public final Object z() {
        return f31780g.get(this);
    }
}
