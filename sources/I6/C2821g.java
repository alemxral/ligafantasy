...
public final class C2821g extends AbstractC2809a {
    ...
    private final Thread f31757d;

    /* renamed from: e, reason: collision with root package name */
    private final AbstractC2824h0 f31758e;

    public C2821g(P5.g gVar, Thread thread, AbstractC2824h0 abstractC2824h0) {
        super(gVar, true, true);
        this.f31757d = thread;
        this.f31758e = abstractC2824h0;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // i6.F0
    public void H(Object obj) {
        if (!AbstractC3159y.d(Thread.currentThread(), this.f31757d)) {
            Thread thread = this.f31757d;
            AbstractC2813c.a();
    ...
    public final Object O0() {
        ...
        AbstractC2813c.a();
        try {
            AbstractC2824h0 abstractC2824h0 = this.f31758e;
            C2804C c2804c = null;
            ...
            while (!Thread.interrupted()) {
                try {
                    AbstractC2824h0 abstractC2824h02 = this.f31758e;
                    ...
                    if (!b()) {
                        ...
                        AbstractC2824h0 abstractC2824h03 = this.f31758e;
                        ...
                        throw c2804c.f31664a;
                    }
                } catch (Throwable th) {
                    AbstractC2824h0 abstractC2824h04 = this.f31758e;
