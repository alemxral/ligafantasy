...
public abstract class AbstractC2826i0 extends AbstractC2828j0 implements W {
    ...
    private static final AtomicReferenceFieldUpdater f31764d = AtomicReferenceFieldUpdater.newUpdater(AbstractC2826i0.class, Object.class, "_queue");

    /* renamed from: e, reason: collision with root package name */
    private static final AtomicReferenceFieldUpdater f31765e = AtomicReferenceFieldUpdater.newUpdater(AbstractC2826i0.class, Object.class, "_delayed");

    /* renamed from: f, reason: collision with root package name */
    private static final AtomicIntegerFieldUpdater f31766f = AtomicIntegerFieldUpdater.newUpdater(AbstractC2826i0.class, "_isCompleted");
    ...
    private final class a extends c {
        ...
        private final InterfaceC2837o f31767c;

        public a(long j8, InterfaceC2837o interfaceC2837o) {
            super(j8);
            this.f31767c = interfaceC2837o;
        }

        @Override // java.lang.Runnable
        public void run() {
            this.f31767c.w(AbstractC2826i0.this, L5.I.f6474a);
        }

        @Override // i6.AbstractC2826i0.c
        public String toString() {
            return super.toString() + this.f31767c;
        }
    }
    ...
    private static final class b extends c {
        ...
        /* renamed from: c, reason: collision with root package name */
        private final Runnable f31769c;
        ...
        @Override // i6.AbstractC2826i0.c
        public String toString() {
            return super.toString() + this.f31769c;
        }
    }
    ...
    public static abstract class c implements Runnable, Comparable, InterfaceC2816d0, n6.O {
        ...
        public void a(n6.N n8) {
            ...
            c3486f = AbstractC2832l0.f31774a;
            if (obj != c3486f) {
                this._heap = n8;
                return;
            }
        ...
        public int compareTo(c cVar) {
            long j8 = this.f31770a - cVar.f31770a;
            if (j8 > 0) {
                return 1;
            }
            if (j8 < 0) {
        ...
        public final void dispose() {
            ...
            synchronized (this) {
                try {
                    ...
                    c3486f2 = AbstractC2832l0.f31774a;
                    this._heap = c3486f2;
                    L5.I i8 = L5.I.f6474a;
                } catch (Throwable th) {
                    throw th;
                ...
                synchronized (dVar) {
                    try {
                        ...
                        if (cVar == null) {
                            ...
                            long j9 = cVar.f31770a;
                            if (j9 - j8 < 0) {
                                j8 = j9;
                            }
                            if (j8 - dVar.f31772c > 0) {
                                dVar.f31772c = j8;
                            }
                        }
                        long j10 = this.f31770a;
                        long j11 = dVar.f31772c;
                        if (j10 - j11 < 0) {
                            this.f31770a = j11;
                        }
                        dVar.a(this);
        ...
        public String toString() {
            return "Delayed[nanos=" + this.f31770a + ']';
        }
    }
    ...
    private final void U() {
        C3486F c3486f;
        C3486F c3486f2;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f31764d;
        while (true) {
            Object obj = atomicReferenceFieldUpdater.get(this);
            if (obj == null) {
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = f31764d;
                c3486f = AbstractC2832l0.f31775b;
                if (androidx.concurrent.futures.a.a(atomicReferenceFieldUpdater2, this, null, c3486f)) {
                    return;
                }
            } else if (!(obj instanceof n6.s)) {
                c3486f2 = AbstractC2832l0.f31775b;
                if (obj == c3486f2) {
                    return;
                }
                ...
                sVar.a((Runnable) obj);
                if (androidx.concurrent.futures.a.a(f31764d, this, obj, sVar)) {
                    return;
                }
            } else {
                ((n6.s) obj).d();
    ...
    private final Runnable V() {
        ...
        while (true) {
            ...
            if (!(obj instanceof n6.s)) {
                ...
                if (androidx.concurrent.futures.a.a(f31764d, this, obj, null)) {
                    AbstractC3159y.g(obj, "null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");
                    return (Runnable) obj;
                }
            } else {
                ...
                androidx.concurrent.futures.a.a(f31764d, this, obj, sVar.i());
            }
        }
    }
    ...
    private final boolean X(Runnable runnable) {
        ...
        while (true) {
            ...
            if (obj == null) {
                if (androidx.concurrent.futures.a.a(f31764d, this, null, runnable)) {
                    return true;
                }
            } else if (!(obj instanceof n6.s)) {
                c3486f = AbstractC2832l0.f31775b;
                ...
                if (a8 != 1) {
                    ...
                    androidx.concurrent.futures.a.a(f31764d, this, obj, sVar2.i());
                }
            }
        }
    }
    ...
    private final int c0(long j8, c cVar) {
        ...
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f31765e;
    ...
    public final void a0() {
        f31764d.set(this, null);
        f31765e.set(this, null);
    }
