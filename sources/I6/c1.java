...
public final class c1 extends C3482B {
    ...
    private final ThreadLocal f31739e;
    ...
    */
    ...
    protected void K0(Object obj) {
        if (this.threadLocalIsSet) {
            L5.r rVar = (L5.r) this.f31739e.get();
            if (rVar != null) {
                n6.J.a((P5.g) rVar.a(), rVar.b());
            }
            this.f31739e.remove();
        }
        Object a8 = AbstractC2808G.a(obj, this.f36217d);
        P5.d dVar = this.f36217d;
    ...
    public final boolean O0() {
        boolean z8;
        if (this.threadLocalIsSet && this.f31739e.get() == null) {
            z8 = true;
        } else {
            z8 = false;
        }
    ...
    public final void P0(P5.g gVar, Object obj) {
        ...
        this.f31739e.set(L5.x.a(gVar, obj));
    }
}
