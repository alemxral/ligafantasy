...
public final class C1841l {
    ...
    public SharedStorage f14209a;

    /* renamed from: b, reason: collision with root package name */
    public final s f14210b;

    /* renamed from: c, reason: collision with root package name */
    public final E6.f f14211c;

    /* renamed from: d, reason: collision with root package name */
    public final q f14212d;

    /* renamed from: e, reason: collision with root package name */
    public final L7.c f14213e;

    /* renamed from: f, reason: collision with root package name */
    public final u f14214f;

    /* renamed from: g, reason: collision with root package name */
    public w f14215g;

    /* renamed from: h, reason: collision with root package name */
    public final m f14216h;

    /* renamed from: i, reason: collision with root package name */
    public final o f14217i;

    /* renamed from: j, reason: collision with root package name */
    public final L7.k f14218j;

    /* renamed from: k, reason: collision with root package name */
    public final L7.e f14219k;

    /* renamed from: l, reason: collision with root package name */
    public boolean f14220l;

    /* renamed from: m, reason: collision with root package name */
    public C3998e f14221m;
    ...
    public C1841l(SharedStorage storage, s tcModel, E6.f portalConfig, q gvlRepository, L7.c cmpRepository, u portalConfigRepository, w translationsTextRepository, m geoIPRepository, o googleVendorsRepository, L7.k gbcRepository, L7.e consentRepository) {
        ...
        this.f14209a = storage;
        this.f14210b = tcModel;
        this.f14211c = portalConfig;
        this.f14212d = gvlRepository;
        this.f14213e = cmpRepository;
        this.f14214f = portalConfigRepository;
        this.f14215g = translationsTextRepository;
        this.f14216h = geoIPRepository;
        this.f14217i = googleVendorsRepository;
        this.f14218j = gbcRepository;
        this.f14219k = consentRepository;
        this.f14221m = new C3998e(null, 1);
        this.f14223o = -1;
        this.f14224p = new y5.g(null, null, 3);
        this.f14223o = g();
    }
    ...
    public final boolean b() {
        String str;
        String upperCase;
        if (this.f14211c.f2373b.f2328Q.contains("EEA")) {
            J5.b bVar = this.f14222n;
            if (bVar == null) {
                str = null;
            } else {
                str = bVar.f5489a;
        ...
        if (!this.f14211c.f2373b.f2328Q.contains("WORLDWIDE")) {
            return false;
        }
        return true;
    }
    ...
    public final boolean c(Set set) {
        List list = this.f14211c.f2373b.f2338h;
    ...
    public final String e() {
        ...
        sb.append(this.f14211c.f2373b.f2330S.f2361c);
        sb.append(this.f14211c.f2373b.f2330S.f2359a);
        return I7.b.b(sb.toString());
    }

    public final String f() {
        return I7.b.b(this.f14211c.f2374c.f2371c + this.f14211c.f2373b.f2356z + this.f14211c.f2373b.f2352v + this.f14211c.f2373b.f2353w + this.f14211c.f2373b.f2351u + this.f14211c.f2373b.f2349s + this.f14211c.f2373b.f2350t);
    }

    public final int g() {
        int i8 = this.f14209a.i(N7.a.TCF_POLICY_VERSION);
        if (i8 == 0) {
            return this.f14209a.i(N7.a.GPP_POLICY_VERSION);
        }
        return i8;
    }
    ...
    public final int h() {
        Integer num;
        B6.e eVar = this.f14210b.f39913a;
        if (eVar == null) {
            num = null;
        } else {
            num = eVar.f1037c;
    ...
    public final int i() {
        ...
        if (num == null) {
            return this.f14209a.i(N7.a.VENDOR_LIST_VERSION);
        }
        return num.intValue();
    }
    ...
    public final boolean j() {
        if (m()) {
            return !AbstractC3159y.d(this.f14209a.j(N7.a.GBC_PURPOSE_HASH), e());
        }
        return false;
    }

    public final boolean k() {
        if (this.f14211c.f2373b.f2324M) {
    ...
    public final boolean m() {
        ...
        String str4;
        String upperCase;
        E6.c cVar = this.f14211c.f2373b.f2330S;
        if (!cVar.f2359a) {
            return false;
        }
        if (!cVar.f2360b.contains("WORLDWIDE")) {
            String str5 = null;
            if (this.f14211c.f2373b.f2330S.f2360b.contains("EEA")) {
                J5.b bVar = this.f14222n;
                if (bVar == null) {
                    str4 = null;
                } else {
            ...
            List list = this.f14211c.f2373b.f2330S.f2360b;
            J5.b bVar2 = this.f14222n;
            if (bVar2 == null || (str3 = bVar2.f5489a) == null) {
                str = null;
            } else {
            ...
            if (!AbstractC1246t.d0(list, str)) {
                List list2 = this.f14211c.f2373b.f2330S.f2360b;
                J5.b bVar3 = this.f14222n;
                if (bVar3 != null && (str2 = bVar3.f5489a) != null) {
    ...
    public final boolean n() {
        SharedStorage sharedStorage = this.f14209a;
        N7.a preferenceKey = N7.a.VENDOR_LIST_LAST_UPDATED;
        sharedStorage.getClass();
        AbstractC3159y.i(preferenceKey, "preferenceKey");
        if (TimeUnit.MILLISECONDS.toDays(System.currentTimeMillis() - sharedStorage.f17832a.getLong("gvl_last_updated", 0L)) >= this.f14211c.f2373b.f2312A && i() > this.f14209a.i(N7.a.VENDOR_LIST_VERSION)) {
            return false;
        }
        return true;
    }
    ...
    public final boolean o() {
        if (this.f14211c.f2373b.f2332b.contains("USP") && (this.f14211c.f2373b.f2328Q.contains("WORLDWIDE") || this.f14211c.f2373b.f2328Q.contains("USA"))) {
            return true;
        }
        return false;
    }
            ...
            if (encodedTCString != null) {
                ...
                while (i17 < size) {
                    ...
                    if (segment == lVar) {
                        ...
                        tcModel.f39921i = aVar.a(substring2, num2 == null ? 0 : num2.intValue());
                    } else {
                        list = s02;
                    }
                    int intValue8 = (segment == lVar || (b8 = cVar.b("segmentType")) == null) ? 0 : b8.intValue();
                    if (tcModel.f39921i == 1) {
                        strArr = (String[]) E5.a.f2310b.get(segment.f39897a);
                    } else {
                        strArr = (String[]) E5.a.f2311c.get(segment.f39897a);
                    }
                    if (strArr != null) {
                        ...
                        while (i19 < length) {
                            ...
                            if (b9 == null && A5.g.f508a.a(str8)) {
                                b9 = Integer.valueOf(tcModel.f39928p);
                            }
                            if ((b9 != null && b9.intValue() == 0) || b9 == null) {
                                ...
                                if (AbstractC3159y.d(str8, "version")) {
                                    tcModel.f39921i = C5.d.f1293a.a(value, b9.intValue());
                                    i11 = intValue8;
                                    i8 = size;
                                    strArr2 = strArr;
                                } else {
                                    if (AbstractC3159y.d(str8, "created")) {
                                        i8 = size;
                                        strArr2 = strArr;
                                        tcModel.f39914b = C5.a.f1289a.a(value, b9.intValue());
                                    } else {
                                        i8 = size;
                                        strArr2 = strArr;
                                        if (AbstractC3159y.d(str8, "lastUpdated")) {
                                            tcModel.f39915c = C5.a.f1289a.a(value, b9.intValue());
                                        } else {
                                            i9 = i18;
                                            if (AbstractC3159y.d(str8, "cmpId")) {
                                                ...
                                                if (AbstractC3159y.d(str8, "isServiceSpecific")) {
                                                    ...
                                                    tcModel.f39917e = AbstractC3159y.d(value, "1");
                                                } else if (AbstractC3159y.d(str8, "useNonStandardStacks")) {
                                                    AbstractC3159y.i(value, "value");
                                                    tcModel.f39918f = AbstractC3159y.d(value, "1");
                                                } else if (AbstractC3159y.d(str8, "specialFeatureOptions")) {
                                                    tcModel.f39929q = AbstractC1831b.a(b9, C5.c.f1292a, value, "<set-?>");
                                                } else if (AbstractC3159y.d(str8, "purposeConsents")) {
                                                    tcModel.f39930r = AbstractC1831b.a(b9, C5.c.f1292a, value, "<set-?>");
                                                } else if (AbstractC3159y.d(str8, "purposeLegitimateInterests")) {
                                                    tcModel.f39931s = AbstractC1831b.a(b9, C5.c.f1292a, value, "<set-?>");
                                                } else if (AbstractC3159y.d(str8, "purposeOneTreatment")) {
                                                    AbstractC3159y.i(value, "value");
                                                    tcModel.f39919g = AbstractC3159y.d(value, "1");
                                                    ...
                                                    if (AbstractC3159y.d(str8, "vendorConsents")) {
                                                        ...
                                                        if (AbstractC3159y.d(str8, "publisherRestrictions")) {
                                                            ...
                                                            if (AbstractC3159y.d(str8, "publisherConsents")) {
                                                                tcModel.f39934v = AbstractC1831b.a(b9, C5.c.f1292a, value, "<set-?>");
                                                            } else if (AbstractC3159y.d(str8, "publisherLegitimateInterests")) {
                                                                tcModel.f39935w = AbstractC1831b.a(b9, C5.c.f1292a, value, "<set-?>");
                                                            } else if (AbstractC3159y.d(str8, "numCustomPurposes")) {
                                                                tcModel.f39928p = C5.d.f1293a.a(value, b9.intValue());
                                                            } else if (AbstractC3159y.d(str8, "publisherCustomConsents")) {
                                                                tcModel.f39936x = AbstractC1831b.a(b9, C5.c.f1292a, value, "<set-?>");
                                                            } else if (AbstractC3159y.d(str8, "publisherCustomLegitimateInterests")) {
                                                                tcModel.f39937y = AbstractC1831b.a(b9, C5.c.f1292a, value, "<set-?>");
                ...
                c1841l.f14210b.f39930r.set(tcModel.f39930r);
                Vector vector6 = c1841l.f14210b.f39931s;
                vector6.unsetAllOwnedItems();
                vector6.set(tcModel.f39931s);
                c1841l.f14210b.f39929q.set(tcModel.f39929q);
                Vector vector7 = c1841l.f14210b.f39938z;
                vector7.unsetAllOwnedItems();
                vector7.setOwnedItems(tcModel.f39938z);
                Vector vector8 = c1841l.f14210b.f39908C;
                vector8.unsetAllOwnedItems();
                vector8.setOwnedItems(tcModel.f39908C);
            }
        }
        O7.d dVar9 = O7.d.f7793a;
        if (dVar9.g().j(w1.h.f38943f) || c1841l.f14209a.j(N7.a.TC_STRING).length() > 0) {
            String str12 = c1841l.f14211c.f2373b.f2320I;
            if (str12 != null) {
                PrivacyEncodingMode privacyEncodingMode = PrivacyEncodingMode.GPP;
                if (str12.equals(privacyEncodingMode.getValue())) {
                    if (!dVar9.g().i(w1.h.f38941d)) {
                        c1841l.f14219k.a(privacyEncodingMode, false);
                    }
                    c1841l.f14209a.b(N7.a.TCF_CMP_SDK_ID);
                    c1841l.f14209a.b(N7.a.TCF_CMP_SDK_VERSION);
                    c1841l.f14209a.b(N7.a.TCF_POLICY_VERSION);
                    c1841l.f14209a.b(N7.a.TCF_GDPR_APPLIES);
                    c1841l.f14209a.b(N7.a.TCF_PUBLISHER_CC);
                    c1841l.f14209a.b(N7.a.TCF_PURPOSE_ONE_TREATMENT);
                    c1841l.f14209a.b(N7.a.TCF_USE_NON_STANDARD_STACKS);
                    c1841l.f14209a.b(N7.a.TC_STRING);
                    c1841l.f14209a.b(N7.a.TCF_VENDOR_CONSENTS);
                    c1841l.f14209a.b(N7.a.TCF_VENDOR_LEGITIMATE_INTERESTS);
                    c1841l.f14209a.b(N7.a.TCF_PURPOSE_CONSENTS);
                    c1841l.f14209a.b(N7.a.TCF_PURPOSE_LEGITIMATE_INTERESTS);
                    c1841l.f14209a.b(N7.a.TCF_SPECIAL_FEATURES_OPT_INS);
                    c1841l.f14209a.b(N7.a.TCF_PUBLISHER_RESTRICTIONS);
                    c1841l.f14209a.b(N7.a.TCF_PUBLISHER_CONSENT);
                    c1841l.f14209a.b(N7.a.TCF_PUBLISHER_LEGITIMATE_INTERESTS);
                    c1841l.f14209a.b(N7.a.TCF_PUBLISHER_CUSTOM_PURPOSES_CONSENTS);
                    c1841l.f14209a.b(N7.a.TCF_PUBLISHER_CUSTOM_PURPOSES_LEGITIMATE_INTERESTS);
                    return;
                }
            }
            String str13 = c1841l.f14211c.f2373b.f2320I;
            if (str13 != null) {
                PrivacyEncodingMode privacyEncodingMode2 = PrivacyEncodingMode.TCF;
                if (str13.equals(privacyEncodingMode2.getValue())) {
                    dVar9.g().b(w1.h.f38941d);
                    c1841l.f14209a.b(N7.a.GPP_CMP_SDK_ID);
                    c1841l.f14209a.b(N7.a.GPP_CMP_SDK_VERSION);
                    c1841l.f14209a.b(N7.a.GPP_POLICY_VERSION);
                    c1841l.f14209a.b(N7.a.GPP_GDPR_APPLIES);
                    c1841l.f14209a.b(N7.a.GPP_PUBLISHER_CC);
                    c1841l.f14209a.b(N7.a.GPP_PURPOSE_ONE_TREATMENT);
                    c1841l.f14209a.b(N7.a.GPP_USE_NON_STANDARD_STACKS);
                    c1841l.f14209a.b(N7.a.GPP_STRING);
                    c1841l.f14209a.b(N7.a.GPP_VENDOR_CONSENTS);
                    c1841l.f14209a.b(N7.a.GPP_VENDOR_LEGITIMATE_INTERESTS);
                    c1841l.f14209a.b(N7.a.GPP_PURPOSE_CONSENTS);
                    c1841l.f14209a.b(N7.a.GPP_PURPOSE_LEGITIMATE_INTERESTS);
                    c1841l.f14209a.b(N7.a.GPP_SPECIAL_FEATURES_OPT_INS);
                    c1841l.f14209a.b(N7.a.GPP_PUBLISHER_RESTRICTIONS);
                    c1841l.f14209a.b(N7.a.GPP_PUBLISHER_CONSENT);
                    c1841l.f14209a.b(N7.a.GPP_PUBLISHER_LEGITIMATE_INTERESTS);
                    c1841l.f14209a.b(N7.a.GPP_PUBLISHER_CUSTOM_PURPOSES_CONSENTS);
                    c1841l.f14209a.b(N7.a.GPP_PUBLISHER_CUSTOM_PURPOSES_LEGITIMATE_INTERESTS);
                    if (c1841l.f14209a.j(N7.a.TC_STRING).length() == 0) {
                        c1841l.f14219k.a(privacyEncodingMode2, false);
                        return;
                    }
                    return;
                }
            ...
            if (!dVar9.g().i(w1.h.f38941d)) {
                c1841l.f14219k.a(PrivacyEncodingMode.GPP, false);
            }
            if (c1841l.f14209a.j(N7.a.TC_STRING).length() == 0) {
                c1841l.f14219k.a(PrivacyEncodingMode.TCF, false);
            }
        }
    }

    public final void q() {
        this.f14209a.c(N7.a.GPP_CMP_SDK_ID, this.f14210b.f39925m);
        this.f14209a.c(N7.a.GPP_CMP_SDK_VERSION, this.f14210b.f39926n);
        this.f14209a.c(N7.a.GPP_POLICY_VERSION, this.f14210b.f());
        this.f14209a.c(N7.a.GPP_GDPR_APPLIES, b() ? 1 : 0);
        this.f14209a.e(N7.a.GPP_PUBLISHER_CC, this.f14211c.f2373b.f2336f);
        this.f14209a.c(N7.a.GPP_PURPOSE_ONE_TREATMENT, this.f14210b.f39919g ? 1 : 0);
        this.f14209a.c(N7.a.GPP_USE_NON_STANDARD_STACKS, this.f14210b.f39918f ? 1 : 0);
    }

    public final void r() {
        this.f14209a.c(N7.a.TCF_CMP_SDK_ID, this.f14210b.f39925m);
        this.f14209a.c(N7.a.TCF_CMP_SDK_VERSION, this.f14210b.f39926n);
        this.f14209a.c(N7.a.TCF_POLICY_VERSION, this.f14210b.f());
        this.f14209a.c(N7.a.TCF_GDPR_APPLIES, b() ? 1 : 0);
        this.f14209a.e(N7.a.TCF_PUBLISHER_CC, this.f14211c.f2373b.f2336f);
        this.f14209a.c(N7.a.TCF_PURPOSE_ONE_TREATMENT, this.f14210b.f39919g ? 1 : 0);
        this.f14209a.c(N7.a.TCF_USE_NON_STANDARD_STACKS, this.f14210b.f39918f ? 1 : 0);
    }

    public final boolean s() {
        boolean z8;
        if (this.f14209a.j(N7.a.TRANSLATIONS_TEXT).length() > 0 && this.f14209a.j(N7.a.PORTAL_CONFIG).length() > 0 && (!this.f14224p.f39875b.containsKey(String.valueOf(this.f14210b.f39925m)) || !n() || !AbstractC3159y.d(AbstractC3159y.q(this.f14209a.j(N7.a.NON_IAB_VENDOR_CONSENT_HASH), f()), this.f14209a.j(N7.a.OPTION_HASH)) || this.f14223o != h() || ((this.f14209a.j(N7.a.TC_STRING).length() == 0 && !O7.d.f7793a.g().j(w1.h.f38943f)) || j()))) {
            z8 = true;
        } else {
            z8 = false;
        }
        if (m()) {
            this.f14209a.e(N7.a.GBC_PURPOSE_HASH, e());
        }
        return z8;
    }
}
