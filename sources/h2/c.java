...
public final class c extends WebView implements C2553q.b {
    ...
    private final InterfaceC2578b f31358a;

    /* renamed from: b, reason: collision with root package name */
    private final f f31359b;

    /* renamed from: c, reason: collision with root package name */
    private Function1 f31360c;
    ...
    public static final class a extends WebChromeClient {
        ...
        static final class C0754a extends AbstractC3160z implements Function0 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ WebChromeClient.CustomViewCallback f31363a;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0754a(WebChromeClient.CustomViewCallback customViewCallback) {
                super(0);
                this.f31363a = customViewCallback;
            }
            ...
            public final void m5590invoke() {
                this.f31363a.onCustomViewHidden();
            }
        }
        ...
        public void onHideCustomView() {
            ...
            c.this.f31358a.onExitFullscreen();
        }
        ...
        public void onShowCustomView(View view, WebChromeClient.CustomViewCallback callback) {
            ...
            c.this.f31358a.a(view, new C0754a(callback));
        }
    }
    ...
    private final void d(C2659a c2659a) {
        ...
        InputStream openRawResource = getResources().openRawResource(AbstractC1906a.f14868a);
    ...
    public void a() {
        Function1 function1 = this.f31360c;
        if (function1 == null) {
            AbstractC3159y.y("youTubePlayerInitListener");
            function1 = null;
        }
        function1.invoke(this.f31359b);
    }

    public final boolean c(e2.c listener) {
        AbstractC3159y.i(listener, "listener");
        return this.f31359b.h().add(listener);
    }
    ...
    public final void e(Function1 initListener, C2659a c2659a) {
        ...
        this.f31360c = initListener;
        if (c2659a == null) {
            c2659a = C2659a.f30990b.a();
        }
        d(c2659a);
    }
    ...
    public Collection<e2.c> getListeners() {
        return AbstractC1246t.b1(this.f31359b.h());
    }
    ...
    public c(Context context, InterfaceC2578b listener, AttributeSet attributeSet, int i8) {
        ...
        AbstractC3159y.i(listener, "listener");
        this.f31358a = listener;
        this.f31359b = new f(this);
    }
}
