...
public final class C2745a extends h2.b {
    ...
    private final h2.c f31343a;

    /* renamed from: b, reason: collision with root package name */
    private final C2705b f31344b;

    /* renamed from: c, reason: collision with root package name */
    private final C2709f f31345c;

    /* renamed from: d, reason: collision with root package name */
    private boolean f31346d;

    /* renamed from: e, reason: collision with root package name */
    private Function0 f31347e;

    /* renamed from: f, reason: collision with root package name */
    private final Set f31348f;
    ...
    public static final class b extends AbstractC2577a {
        ...
        public void g(InterfaceC2541e youTubePlayer) {
            ...
            Iterator it = C2745a.this.f31348f.iterator();
            if (!it.hasNext()) {
                C2745a.this.f31348f.clear();
    ...
    static final class e extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C2659a f31355b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ e2.c f31356c;
        ...
        public final void m5589invoke() {
            C2745a.this.getWebViewYouTubePlayer$core_release().e(new C0753a(this.f31356c), this.f31355b);
        }
    }
    ...
    public final boolean f() {
        if (!this.f31349g && !this.f31343a.f()) {
            return false;
        }
        return true;
    }
    ...
    public final void i() {
        this.f31343a.getYoutubePlayer$core_release().pause();
        this.f31345c.l();
        this.f31349g = false;
    }
    ...
    public final void j() {
        this.f31344b.a();
        removeView(this.f31343a);
        this.f31343a.removeAllViews();
        this.f31343a.destroy();
    }
    ...
    public C2745a(Context context, InterfaceC2578b listener, AttributeSet attributeSet, int i8) {
        ...
        this.f31345c = c2709f;
        this.f31347e = d.f31353a;
        this.f31348f = new LinkedHashSet();
        this.f31349g = true;
    ...
    public static final class c implements C2705b.a {
        ...
        public void a() {
            if (!C2745a.this.g()) {
                C2745a.this.f31347e.invoke();
            } else {
                C2745a.this.f31345c.m(C2745a.this.getWebViewYouTubePlayer$core_release().getYoutubePlayer$core_release());
            }
        }
