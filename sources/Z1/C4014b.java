...
public final class C4014b {
    ...
    public void a(EnumC4013a enumC4013a) {
        ...
        this.f40034a.w().f("adUserInteraction", jSONObject);
    }

    public void b() {
        g.f(this.f40034a);
        this.f40034a.w().d("bufferFinish");
    }

    public void c() {
        g.f(this.f40034a);
        this.f40034a.w().d("bufferStart");
    }

    public void d() {
        g.f(this.f40034a);
        this.f40034a.w().d(CampaignEx.JSON_NATIVE_VIDEO_COMPLETE);
    }

    public void h() {
        g.f(this.f40034a);
        this.f40034a.w().d("firstQuartile");
    }

    public void i() {
        g.f(this.f40034a);
        this.f40034a.w().d(CampaignEx.JSON_NATIVE_VIDEO_MIDPOINT);
    }

    public void j() {
        g.f(this.f40034a);
        this.f40034a.w().d(CampaignEx.JSON_NATIVE_VIDEO_PAUSE);
    }

    public void k() {
        g.f(this.f40034a);
        this.f40034a.w().d(CampaignEx.JSON_NATIVE_VIDEO_RESUME);
    }

    public void l() {
        g.f(this.f40034a);
        this.f40034a.w().d("skipped");
    }
    ...
    public void m(float f8, float f9) {
        ...
        this.f40034a.w().f("start", jSONObject);
    }

    public void n() {
        g.f(this.f40034a);
        this.f40034a.w().d("thirdQuartile");
    }
    ...
    public void o(float f8) {
        ...
        E1.c.h(jSONObject, "deviceVolume", Float.valueOf(h.d().c()));
        this.f40034a.w().f("volumeChange", jSONObject);
    }
}
