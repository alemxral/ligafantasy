...
public final class C implements ViewBinding {
    ...
    private final RelativeLayout f10035a;

    /* renamed from: b, reason: collision with root package name */
    public final SubsamplingScaleImageView f10036b;

    /* renamed from: c, reason: collision with root package name */
    public final ProgressBar f10037c;

    private C(RelativeLayout relativeLayout, SubsamplingScaleImageView subsamplingScaleImageView, ProgressBar progressBar) {
        this.f10035a = relativeLayout;
        this.f10036b = subsamplingScaleImageView;
        this.f10037c = progressBar;
    }
