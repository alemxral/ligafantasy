...
public final class f {
    ...
    public static final f f2753c = new a().a();

    /* renamed from: a, reason: collision with root package name */
    private final Set f2754a;

    /* renamed from: b, reason: collision with root package name */
    private final O6.c f2755b;

    /* loaded from: classes5.dex */
    public static final class a {

        /* renamed from: a, reason: collision with root package name */
        private final List f2756a = new ArrayList();

        public f a() {
            return new f(new LinkedHashSet(this.f2756a), null);
        }
    }
    ...
    public f e(O6.c cVar) {
        if (G6.c.n(this.f2755b, cVar)) {
            return this;
        }
        return new f(this.f2754a, cVar);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof f) {
            f fVar = (f) obj;
            if (G6.c.n(this.f2755b, fVar.f2755b) && this.f2754a.equals(fVar.f2754a)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        ...
        return (i8 * 31) + this.f2754a.hashCode();
    }
}
