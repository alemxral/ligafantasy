...
public final class C2679f implements InterfaceC2680g {
    ...
    private final Function0 f31119a;

    /* renamed from: b, reason: collision with root package name */
    private final Function1 f31120b;
    ...
    public static final class a implements Iterator, Y5.a {
        ...
        /* renamed from: a, reason: collision with root package name */
        private Object f31121a;

        /* renamed from: b, reason: collision with root package name */
        private int f31122b = -2;
        ...
        private final void b() {
            ...
            int i8;
            if (this.f31122b != -2) {
                Function1 function1 = C2679f.this.f31120b;
                Object obj = this.f31121a;
                AbstractC3159y.f(obj);
                invoke = function1.invoke(obj);
            } else {
                invoke = C2679f.this.f31119a.invoke();
            }
            this.f31121a = invoke;
            if (invoke == null) {
                i8 = 0;
    ...
    public C2679f(Function0 getInitialValue, Function1 getNextValue) {
        ...
        this.f31119a = getInitialValue;
        this.f31120b = getNextValue;
    }
