...
public abstract class h {
    ...
    public static final class a extends AbstractC3160z implements Function0 {
        ...
        final /* synthetic */ Function0 f9831a;
    ...
    public static final class b extends AbstractC3160z implements n {
        ...
        final /* synthetic */ float f9835d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Function0 f9836e;
        ...
        public final void invoke(Composer composer, int i8) {
            h.a(this.f9832a, this.f9833b, this.f9834c, this.f9835d, this.f9836e, composer, RecomposeScopeImplKt.updateChangedFlags(this.f9837f | 1));
        }
    }
    ...
    public static final class c extends AbstractC3160z implements o {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Q f9839b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ w0 f9840c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ U2.a f9841d;
        ...
        final /* synthetic */ S2.b f9844g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ MutableState f9845h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ FocusRequester f9846i;
        ...
        c(w0 w0Var, Q q8, w0 w0Var2, U2.a aVar, boolean z8, boolean z9, S2.b bVar, MutableState mutableState, FocusRequester focusRequester, State state) {
            ...
            this.f9843f = z9;
            this.f9844g = bVar;
            this.f9845h = mutableState;
            this.f9846i = focusRequester;
            this.f9847j = state;
        }
        ...
        public final void invoke(AnimatedVisibilityScope AnimatedVisibility, Composer composer, int i8) {
            ...
            w0 w0Var = this.f9838a;
            Q q8 = this.f9839b;
            w0 w0Var2 = this.f9840c;
            U2.a aVar = this.f9841d;
            boolean z8 = this.f9842e;
            boolean z9 = this.f9843f;
            S2.b bVar = this.f9844g;
            MutableState mutableState = this.f9845h;
            FocusRequester focusRequester = this.f9846i;
            State state = this.f9847j;
            ...
            T2.g.a(valueOf, w0Var, q8, w0Var2, aVar, z8, false, z9, bVar, c8, (Function0) rememberedValue, null, focusRequester, null, null, composer, (Q.f35181s << 6) | 1577024, 0, 26624);
            AnimatedVisibilityKt.AnimatedVisibility(columnScopeInstance, aVar == U2.a.f11059c, (Modifier) null, (EnterTransition) null, (ExitTransition) null, (String) null, T2.b.f9702a.a(), composer, 1572870, 30);
            composer.endReplaceableGroup();
            composer.endNode();
            composer.endReplaceableGroup();
            composer.endReplaceableGroup();
    ...
    public static final class d extends AbstractC3160z implements n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ U2.a f9851c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ boolean f9852d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ S2.b f9853e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ g0 f9854f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ w0 f9855g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Q f9856h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ w0 f9857i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ FocusRequester f9858j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ int f9859k;
        ...
        public final void invoke(Composer composer, int i8) {
            h.b(this.f9849a, this.f9850b, this.f9851c, this.f9852d, this.f9853e, this.f9854f, this.f9855g, this.f9856h, this.f9857i, this.f9858j, composer, RecomposeScopeImplKt.updateChangedFlags(this.f9859k | 1));
        }
    }
    ...
    public static final class f extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            return new f(this.f9862b, this.f9863c, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f9861a == 0) {
                t.b(obj);
                this.f9862b.invoke(h.h(this.f9863c));
                return I.f6474a;
            }
    ...
    public static final class g extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ FocusManager f9865b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ TextInputService f9866c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ State f9867d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        g(FocusManager focusManager, TextInputService textInputService, State state, P5.d dVar) {
            super(2, dVar);
            this.f9865b = focusManager;
            this.f9866c = textInputService;
            this.f9867d = state;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new g(this.f9865b, this.f9866c, this.f9867d, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f9864a == 0) {
                t.b(obj);
                if (h.h(this.f9867d).f() == U2.a.f11057a && h.h(this.f9867d).i() != null) {
                    this.f9865b.clearFocus(true);
                    TextInputService textInputService = this.f9866c;
    ...
    public static final class i extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ T2.c f9868a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ boolean f9869b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function1 f9870c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Modifier f9871d;
        ...
        i(T2.c cVar, boolean z8, Function1 function1, Modifier modifier, int i8, int i9) {
            ...
            this.f9868a = cVar;
            this.f9869b = z8;
            this.f9870c = function1;
            this.f9871d = modifier;
            this.f9872e = i8;
            this.f9873f = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            h.f(this.f9868a, this.f9869b, this.f9870c, this.f9871d, composer, RecomposeScopeImplKt.updateChangedFlags(this.f9872e | 1), this.f9873f);
        }
    }
    ...
    public static final class j extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ FocusRequester f9876c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        j(boolean z8, FocusRequester focusRequester, P5.d dVar) {
            super(2, dVar);
            this.f9875b = z8;
            this.f9876c = focusRequester;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new j(this.f9875b, this.f9876c, dVar);
        }
    ...
    public static final class k extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ M f9878b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ BringIntoViewRequester f9879c;
        ...
        public static final class a extends kotlin.coroutines.jvm.internal.l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ BringIntoViewRequester f9881b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(BringIntoViewRequester bringIntoViewRequester, P5.d dVar) {
                super(2, dVar);
                this.f9881b = bringIntoViewRequester;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new a(this.f9881b, dVar);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i8 != 0) {
                    ...
                    t.b(obj);
                    BringIntoViewRequester bringIntoViewRequester = this.f9881b;
                    this.f9880a = 1;
        ...
        k(boolean z8, M m8, BringIntoViewRequester bringIntoViewRequester) {
            ...
            this.f9877a = z8;
            this.f9878b = m8;
            this.f9879c = bringIntoViewRequester;
        }
        ...
        public final void invoke(FocusState state) {
            ...
            if (state.getHasFocus() && this.f9877a) {
                AbstractC2829k.d(this.f9878b, null, null, new a(this.f9879c, null), 3, null);
            }
        }
    }
    ...
    public static final class l extends AbstractC3160z implements n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ g0 f9883b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ w0 f9884c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Q f9885d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ w0 f9886e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ U2.a f9887f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ boolean f9888g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ boolean f9889h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ boolean f9890i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ S2.b f9891j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ Function0 f9892k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ Modifier f9893l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ int f9894m;

        /* renamed from: n, reason: collision with root package name */
        final /* synthetic */ int f9895n;

        /* renamed from: o, reason: collision with root package name */
        final /* synthetic */ int f9896o;
        ...
        l(String str, g0 g0Var, w0 w0Var, Q q8, w0 w0Var2, U2.a aVar, boolean z8, boolean z9, boolean z10, S2.b bVar, Function0 function0, Modifier modifier, int i8, int i9, int i10) {
            ...
            this.f9890i = z10;
            this.f9891j = bVar;
            this.f9892k = function0;
            this.f9893l = modifier;
            this.f9894m = i8;
            this.f9895n = i9;
            this.f9896o = i10;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            h.g(this.f9882a, this.f9883b, this.f9884c, this.f9885d, this.f9886e, this.f9887f, this.f9888g, this.f9889h, this.f9890i, this.f9891j, this.f9892k, this.f9893l, composer, RecomposeScopeImplKt.updateChangedFlags(this.f9894m | 1), RecomposeScopeImplKt.updateChangedFlags(this.f9895n), this.f9896o);
        }
    }
    ...
    public static final void a(String str, boolean z8, boolean z9, float f8, Function0 function0, Composer composer, int i8) {
        ...
        if ((46811 & i9) == 9362 && startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.startReplaceableGroup(2058660585);
            ColumnScopeInstance columnScopeInstance = ColumnScopeInstance.INSTANCE;
            String stringResource = StringResources_androidKt.stringResource(K2.j.f5904a, startRestartGroup, 0);
    ...
    public static final void f(T2.c viewModel, boolean z8, Function1 onStateChanged, Modifier modifier, Composer composer, int i8, int i9) {
        ...
        int i11 = g0.f35484c << 3;
        int i12 = s0.f35671x;
        g(d8, q8, l8, o8, n8, f8, z8, j8, p8, i10, c0219h, modifier2, startRestartGroup, i11 | (i12 << 6) | (Q.f35181s << 9) | (i12 << 12) | ((i8 << 15) & 3670016), (i8 >> 6) & 112, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
    ...
    public static final void g(String merchantName, g0 sectionController, w0 emailController, Q phoneNumberController, w0 nameController, U2.a signUpState, boolean z8, boolean z9, boolean z10, S2.b bVar, Function0 toggleExpanded, Modifier modifier, Composer composer, int i8, int i9, int i10) {
        ...
        int i13 = i8 >> 15;
        int i14 = 941621248 | i11 | (i13 & 112) | ((i8 >> 9) & 896) | (i13 & 7168) | (i13 & 57344) | (g0.f35484c << 15);
        int i15 = i8 << 12;
        b(z9, z8, signUpState, z10, bVar, sectionController, emailController, phoneNumberController, nameController, focusRequester, startRestartGroup, i14 | (458752 & i15) | (Q.f35181s << 21) | (i15 & 29360128));
        startRestartGroup.endReplaceableGroup();
        startRestartGroup.endNode();
        startRestartGroup.endReplaceableGroup();
        startRestartGroup.endReplaceableGroup();
