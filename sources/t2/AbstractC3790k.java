...
public abstract class AbstractC3790k extends Exception {
    ...
    public static final a f38210e = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private final r2.f f38211a;
        ...
        public final AbstractC3790k b(Throwable throwable) {
            ...
            if (throwable instanceof JSONException) {
                ...
                if (throwable instanceof IOException) {
                    return C3780a.C0881a.b(C3780a.f38206f, (IOException) throwable, null, 2, null);
                }
    ...
    */
    ...
    private final boolean f(AbstractC3790k abstractC3790k) {
        if (AbstractC3159y.d(this.f38211a, abstractC3790k.f38211a) && AbstractC3159y.d(this.f38212b, abstractC3790k.f38212b) && this.f38213c == abstractC3790k.f38213c && AbstractC3159y.d(getMessage(), abstractC3790k.getMessage())) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Objects.hash(this.f38211a, this.f38212b, Integer.valueOf(this.f38213c), getMessage());
    }
