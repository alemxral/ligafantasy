...
public final class h {
    ...
    private final NsdManager f6449b;

    /* renamed from: c, reason: collision with root package name */
    private NsdManager.ResolveListener f6450c;

    /* renamed from: d, reason: collision with root package name */
    private NsdManager.ServiceInfoCallback f6451d;

    /* renamed from: e, reason: collision with root package name */
    private NsdManager.DiscoveryListener f6452e;

    /* renamed from: f, reason: collision with root package name */
    private NsdServiceInfo f6453f;

    /* renamed from: g, reason: collision with root package name */
    private ArrayList f6454g;
    ...
    private final void i() {
        if (Build.VERSION.SDK_INT >= 34) {
            if (this.f6451d == null) {
                this.f6451d = g.a(new c());
            }
        } else if (this.f6450c == null) {
            this.f6450c = new d();
        }
    }
    ...
    public final boolean m(NsdServiceInfo nsdServiceInfo) {
        ...
        if (AbstractC3159y.d(nsdServiceInfo.getServiceType(), "_nsduptodown._tcp.") && serviceName != null && serviceName.length() != 0 && !n.s(serviceName, j.f2272g.m(), true)) {
            return true;
        }
        return false;
    }
    ...
    private final void o() {
        ...
        if (Build.VERSION.SDK_INT >= 34 && (serviceInfoCallback = this.f6451d) != null) {
            try {
                NsdManager nsdManager = this.f6449b;
    ...
    public final void p(NsdServiceInfo nsdServiceInfo) {
        if (AbstractC3159y.d(nsdServiceInfo.getServiceName(), j.f2272g.m())) {
            return;
        }
        this.f6453f = nsdServiceInfo;
        this.f6448a.a();
    }
    ...
    public final void d() {
        h();
        try {
            this.f6449b.discoverServices("_nsduptodown._tcp.", 1, this.f6452e);
    ...
    public final void j(int i8, NsdManager.RegistrationListener mRegistrationListener) {
        ...
        nsdServiceInfo.setServiceName(j.f2272g.m());
        nsdServiceInfo.setServiceType("_nsduptodown._tcp.");
        try {
            this.f6449b.registerService(nsdServiceInfo, 1, mRegistrationListener);
    ...
    public final void l(NsdServiceInfo service) {
        ...
        if (Build.VERSION.SDK_INT >= 34) {
            ...
            if (newSingleThreadScheduledExecutor != null && (serviceInfoCallback = this.f6451d) != null) {
                NsdManager nsdManager = this.f6449b;
                AbstractC3159y.f(serviceInfoCallback);
        ...
        this.f6449b.resolveService(service, this.f6450c);
    }

    public final void n() {
        NsdManager.DiscoveryListener discoveryListener = this.f6452e;
        if (discoveryListener != null) {
            try {
                this.f6449b.stopServiceDiscovery(discoveryListener);
            } catch (Exception e8) {
                e8.printStackTrace();
            }
            this.f6452e = null;
