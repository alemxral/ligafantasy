...
public final class C1569m {
    ...
    private final FragmentActivity f13530a;
    ...
    public static final class a {
        ...
        public final void a(AppCompatActivity activity, T3.p toolbarCustomization) {
            ...
            if (toolbarCustomization.b() != null) {
                Z3.a.f13387a.e(activity, Color.parseColor(toolbarCustomization.b()));
    ...
    public final ThreeDS2Button a(T3.p pVar, T3.b bVar) {
        ...
        String string;
        FragmentActivity fragmentActivity = this.f13530a;
        ...
        if (appCompatActivity != null && (supportActionBar = appCompatActivity.getSupportActionBar()) != null) {
            threeDS2Button = new ThreeDS2Button(new ContextThemeWrapper(this.f13530a, P3.g.f7972a), null, 0, 6, null);
            ...
            if (pVar != null) {
                ...
                if (f8 != null && !g6.n.u(f8)) {
                    ...
                    string = this.f13530a.getString(P3.f.f7971h);
                    AbstractC3159y.f(string);
                }
                supportActionBar.setTitle(Z3.a.f13387a.b(this.f13530a, string, pVar));
            } else {
                supportActionBar.setTitle(P3.f.f7971h);
                threeDS2Button.setText(P3.f.f7970g);
            }
        }
