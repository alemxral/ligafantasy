...
public final class C1566j extends FrameLayout {
    ...
    private static final a f13517h = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private final boolean f13518a;

    /* renamed from: b, reason: collision with root package name */
    private final ThreeDS2TextView f13519b;

    /* renamed from: c, reason: collision with root package name */
    private final LinearLayout f13520c;
    ...
    public final CompoundButton a(b.a option, T3.b bVar, boolean z8) {
        ...
        materialCheckBox.setPadding(this.f13522e, materialCheckBox.getPaddingTop(), materialCheckBox.getPaddingRight(), materialCheckBox.getPaddingBottom());
        materialCheckBox.setMinimumHeight(this.f13524g);
        RadioGroup.LayoutParams layoutParams = new RadioGroup.LayoutParams(-1, -2);
        if (!z8) {
            layoutParams.bottomMargin = this.f13521d;
        }
        layoutParams.leftMargin = this.f13523f;
        materialCheckBox.setLayoutParams(layoutParams);
        return materialCheckBox;
    }

    public final void b(int i8) {
        View childAt = this.f13520c.getChildAt(i8);
    ...
    public final void c(List list, T3.b bVar) {
        if (list != null) {
            ...
            while (it.hasNext()) {
                ...
                this.f13520c.addView(a(aVar, bVar, z8));
            }
        }
    }
    ...
    public final List<CheckBox> getCheckBoxes() {
        ...
        d6.i s8 = d6.m.s(0, this.f13520c.getChildCount());
        ArrayList arrayList = new ArrayList(AbstractC1246t.x(s8, 10));
        Iterator it = s8.iterator();
        while (it.hasNext()) {
            View childAt = this.f13520c.getChildAt(((N) it).nextInt());
    ...
    public final List<Integer> getSelectedIndexes$3ds2sdk_release() {
        ...
        while (it.hasNext()) {
            int nextInt = ((N) it).nextInt();
            View childAt = this.f13520c.getChildAt(nextInt);
            AbstractC3159y.g(childAt, "null cannot be cast to non-null type android.widget.CompoundButton");
    ...
    public final List<b.a> getSelectedOptions() {
        ...
        while (it.hasNext()) {
            Object tag = this.f13520c.getChildAt(((Number) it.next()).intValue()).getTag();
    ...
    public String getUserEntry() {
        return AbstractC1246t.w0(getSelectedOptions(), ",", null, null, 0, null, b.f13525a, 30, null);
    }
    ...
    public C1566j(Context context, AttributeSet attributeSet, int i8, boolean z8) {
        ...
        this.f13521d = context.getResources().getDimensionPixelSize(P3.b.f7914d);
        this.f13522e = context.getResources().getDimensionPixelSize(P3.b.f7911a);
        this.f13523f = context.getResources().getDimensionPixelSize(P3.b.f7913c);
        this.f13524g = context.getResources().getDimensionPixelSize(P3.b.f7912b);
        if (z8) {
            Q3.f c8 = Q3.f.c(LayoutInflater.from(context), this, true);
            AbstractC3159y.h(c8, "inflate(...)");
            ThreeDS2TextView label = c8.f8219b;
            AbstractC3159y.h(label, "label");
            this.f13519b = label;
            RadioGroup selectGroup = c8.f8220c;
            AbstractC3159y.h(selectGroup, "selectGroup");
            this.f13520c = selectGroup;
            return;
        }
        Q3.e c9 = Q3.e.c(LayoutInflater.from(context), this, true);
        AbstractC3159y.h(c9, "inflate(...)");
        ThreeDS2TextView label2 = c9.f8216b;
        AbstractC3159y.h(label2, "label");
        this.f13519b = label2;
        LinearLayout selectGroup2 = c9.f8217c;
        AbstractC3159y.h(selectGroup2, "selectGroup");
        this.f13520c = selectGroup2;
    }
}
