...
public class f implements i, j {
    ...
    private final Z0.b f12163a;

    /* renamed from: b, reason: collision with root package name */
    private final Context f12164b;

    /* renamed from: c, reason: collision with root package name */
    private final Z0.b f12165c;

    /* renamed from: d, reason: collision with root package name */
    private final Set f12166d;
    ...
    public /* synthetic */ Void k() {
        synchronized (this) {
            ((k) this.f12163a.get()).k(System.currentTimeMillis(), ((h1.i) this.f12165c.get()).a());
        }
        return null;
    }
    ...
    @Override // X0.i
    public Task a() {
        if (!UserManagerCompat.isUserUnlocked(this.f12164b)) {
            return r0.l.e("");
        }
        return r0.l.c(this.f12167e, new Callable() { // from class: X0.d
    ...
    public Task l() {
        if (this.f12166d.size() <= 0) {
            return r0.l.e(null);
        }
        if (!UserManagerCompat.isUserUnlocked(this.f12164b)) {
            return r0.l.e(null);
        }
        return r0.l.c(this.f12167e, new Callable() { // from class: X0.e
            @Override // java.util.concurrent.Callable
            public final Object call() {
                Void k8;
                k8 = f.this.k();
