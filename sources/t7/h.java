...
public final class h {
    ...
    private byte[] d(int i8, byte[] bArr, byte[] bArr2) {
        byte[] q8 = A.q(i8, this.f38276b);
        this.f38275a.b(q8, 0, q8.length);
        this.f38275a.b(bArr, 0, bArr.length);
        this.f38275a.b(bArr2, 0, bArr2.length);
        int i9 = this.f38276b;
        byte[] bArr3 = new byte[i9];
        Y6.e eVar = this.f38275a;
