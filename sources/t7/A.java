...
public abstract class A {
    ...
    private static class a extends ObjectInputStream {
        ...
        private static final Set f38239c;

        /* renamed from: a, reason: collision with root package name */
        private final Class f38240a;
        ...
        protected Class resolveClass(ObjectStreamClass objectStreamClass) {
            if (!this.f38241b) {
                if (objectStreamClass.getName().equals(this.f38240a.getName())) {
                    this.f38241b = true;
                } else {
                    throw new InvalidClassException("unexpected class: ", objectStreamClass.getName());
                }
            } else if (!f38239c.contains(objectStreamClass.getName())) {
                throw new InvalidClassException("unexpected class: ", objectStreamClass.getName());
            }
