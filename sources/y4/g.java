...
public final class g extends ResultReceiver {
                    ...
                    if (c3307a.d().size() > 0) {
                        ...
                        if (activity instanceof Updates) {
                            ...
                            if (appDetailActivity.r2()) {
                                this.f13227a = 2;
                                if (appDetailActivity.x3(this) == e8) {
                                    return e8;
                                }
                            }
                        }
    ...
    protected void onReceiveResult(int i8, Bundle bundle) {
        ...
        if (i8 != 222) {
                ...
                if (i8 == 227) {
                    ...
                    if (str != null) {
                        ...
                        if (context2 != null) {
                            ...
                            Context context3 = this.f13226a;
                            AbstractC3159y.f(context3);
                            b(context3, str, bundle2);
                        }
                    }
                    if (j8 > 0) {
                        bundle2.putString("size", C3331s.f34515a.d(j8));
                    }
                    new C3330r(this.f13226a).b("install", bundle2);
                    Context context4 = this.f13226a;
                    if (context4 != null) {
                        UptodownApp.a aVar = UptodownApp.f27990B;
                        AbstractC3159y.f(context4);
                        UptodownApp.a.N0(aVar, context4, false, false, 6, null);
                    }
            ...
            C3335w c3335w2 = C3335w.f34532a;
            Context context5 = this.f13226a;
        ...
        C3335w c3335w3 = C3335w.f34532a;
        Context context6 = this.f13226a;
