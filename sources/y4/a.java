...
public final class a extends BroadcastReceiver {
    ...
    public static final C0252a f13170a = new C0252a(null);

    /* renamed from: b, reason: collision with root package name */
    private static String f13171b;
    ...
    public static final class b extends l implements n {
        ...
        final /* synthetic */ BroadcastReceiver.PendingResult f13177e;
        ...
        public static final class C0253a extends l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ BroadcastReceiver.PendingResult f13179b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0253a(BroadcastReceiver.PendingResult pendingResult, P5.d dVar) {
                super(2, dVar);
                this.f13179b = pendingResult;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new C0253a(this.f13179b, dVar);
            }

            @Override // X5.n
            public final Object invoke(M m8, P5.d dVar) {
                return ((C0253a) create(m8, dVar)).invokeSuspend(I.f6474a);
            }
        ...
        b(Context context, String str, a aVar, BroadcastReceiver.PendingResult pendingResult, P5.d dVar) {
            ...
            this.f13175c = str;
            this.f13176d = aVar;
            this.f13177e = pendingResult;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new b(this.f13174b, this.f13175c, this.f13176d, this.f13177e, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                t.b(obj);
                String h8 = new C3319g().h(this.f13174b, this.f13175c);
                boolean s8 = g6.n.s(this.f13174b.getPackageName(), h8, true);
                if (!s8 && h8 == null) {
                    K4.a h9 = j.f2272g.h();
                    if (h9 != null) {
                        str = h9.b();
                    ...
                    s8 = g6.n.s(str, this.f13175c, true);
                }
                this.f13176d.e(s8, new C3319g().z(this.f13174b, this.f13175c), this.f13175c, this.f13174b);
            ...
            UptodownApp.a.N0(UptodownApp.f27990B, this.f13174b, false, false, 6, null);
            J0 c8 = C2812b0.c();
            C0253a c0253a = new C0253a(this.f13177e, null);
            this.f13173a = 2;
    ...
    static final class c extends l implements n {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ BroadcastReceiver.PendingResult f13183d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Context f13184e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(String str, BroadcastReceiver.PendingResult pendingResult, Context context, P5.d dVar) {
            super(2, dVar);
            this.f13182c = str;
            this.f13183d = pendingResult;
            this.f13184e = context;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new c(this.f13182c, this.f13183d, this.f13184e, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                t.b(obj);
                a aVar = a.this;
                String packagename = this.f13182c;
                AbstractC3159y.h(packagename, "packagename");
                BroadcastReceiver.PendingResult pendingResult = this.f13183d;
                AbstractC3159y.h(pendingResult, "pendingResult");
                Context context = this.f13184e;
                this.f13180a = 1;
        ...
        if (z8) {
            ...
            if (l8 != null) {
                ...
                if (b02 != null) {
                    ...
                    if (SettingsPreferences.f29309b.R(context)) {
    ...
    private final void g(Context context, C1496f c1496f) {
        ...
        String d8;
        if (c1496f != null && (d8 = (aVar = SettingsPreferences.f29309b).d(context)) != null) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action != null) {
            ...
            if (g6.n.s(action, "android.intent.action.PACKAGE_ADDED", true) && (data = intent.getData()) != null) {
                ...
                if (schemeSpecificPart != null && !booleanExtra && UptodownApp.f27990B.Q()) {
                    ...
                    if (c3307a.d().size() > 0) {
                        ...
                        if (g6.n.s(str, f13171b, true) && currentTimeMillis - f13172c <= AdaptiveTrackSelection.DEFAULT_MIN_TIME_BETWEEN_BUFFER_REEVALUTATION_MS) {
                            z8 = false;
                        }
                        f13172c = currentTimeMillis;
                        f13171b = str;
                        if (z8) {
