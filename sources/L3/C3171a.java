...
public final class C3171a implements InterfaceC3178h {
    ...
    public static final C0780a f33867h = new C0780a(null);

    /* renamed from: i, reason: collision with root package name */
    public static final int f33868i = 8;

    /* renamed from: a, reason: collision with root package name */
    private final C3174d f33869a;

    /* renamed from: b, reason: collision with root package name */
    private final C3182l f33870b;
    ...
    private final InterfaceC1227k f33873e;

    /* renamed from: f, reason: collision with root package name */
    private ActivityResultLauncher f33874f;

    /* renamed from: g, reason: collision with root package name */
    private ActivityResultLauncher f33875g;
    ...
    static final class b extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Context f33877b;
        ...
        public final Map invoke() {
            return AbstractC3172b.a(C3171a.this.f33872d, this.f33877b);
        }
    }
    ...
    public C3171a(C3174d noOpIntentNextActionHandler, C3182l sourceNextActionHandler, Map paymentNextActionHandlers, boolean z8, Context applicationContext) {
        ...
        this.f33869a = noOpIntentNextActionHandler;
        this.f33870b = sourceNextActionHandler;
        this.f33871c = paymentNextActionHandlers;
        this.f33872d = z8;
        this.f33873e = L5.l.b(new b(applicationContext));
    }

    private final Map h() {
        return (Map) this.f33873e.getValue();
    }
    ...
    public void b(ActivityResultCaller activityResultCaller, ActivityResultCallback activityResultCallback) {
        ...
        this.f33874f = activityResultCaller.registerForActivityResult(new PaymentRelayContract(), activityResultCallback);
        this.f33875g = activityResultCaller.registerForActivityResult(new PaymentBrowserAuthContract(), activityResultCallback);
    }
    ...
    public void c() {
        ...
        ActivityResultLauncher activityResultLauncher = this.f33874f;
        if (activityResultLauncher != null) {
            activityResultLauncher.unregister();
        }
        ActivityResultLauncher activityResultLauncher2 = this.f33875g;
