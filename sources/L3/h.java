...
public abstract class h {
    ...
    public static final class a extends AbstractC3160z implements Function0 {
        ...
        final /* synthetic */ MutableState f6223a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(MutableState mutableState) {
            super(0);
            this.f6223a = mutableState;
        }
        ...
        public final void m46invoke() {
            this.f6223a.setValue(Boolean.TRUE);
        }
    }
    ...
    public static final class b extends AbstractC3160z implements Function0 {
        ...
        final /* synthetic */ Function1 f6225b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ C3654g f6226c;
        ...
        public final void m47invoke() {
            this.f6224a.setValue(Boolean.FALSE);
            this.f6225b.invoke(this.f6226c);
        }
    }
    ...
    public static final class c extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ MutableState f6227a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(MutableState mutableState) {
            super(0);
            this.f6227a = mutableState;
        }
        ...
        public final void m48invoke() {
            this.f6227a.setValue(Boolean.FALSE);
        }
    }
    ...
    public static final class d extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ C3654g f6228a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1 f6229b;
        ...
        public final void invoke(Composer composer, int i8) {
            h.a(this.f6228a, this.f6229b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f6230c | 1));
        }
    }
    ...
    public static final class f extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function1 f6232a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C3654g f6233b;
        ...
        public final void m49invoke() {
            this.f6232a.invoke(this.f6233b);
        }
    }
    ...
    public static final class g extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ C3654g f6234a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1 f6235b;
        ...
        public final void invoke(Composer composer, int i8) {
            h.b(this.f6234a, this.f6235b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f6236c | 1));
        }
    }
    ...
    public static final class C0132h extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(SemanticsPropertyReceiver semantics) {
            ...
            SemanticsPropertiesKt.setContentDescription(semantics, this.f6237a);
        }
    }
    ...
    public static final class i extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ImageVector f6239b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function0 f6240c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ String f6241d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Modifier f6242e;
        ...
        i(long j8, ImageVector imageVector, Function0 function0, String str, Modifier modifier, int i8) {
            super(2);
            this.f6238a = j8;
            this.f6239b = imageVector;
            this.f6240c = function0;
            this.f6241d = str;
            this.f6242e = modifier;
            this.f6243f = i8;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            h.c(this.f6238a, this.f6239b, this.f6240c, this.f6241d, this.f6242e, composer, RecomposeScopeImplKt.updateChangedFlags(this.f6243f | 1));
        }
    }
    ...
    public static final void a(C3654g paymentMethod, Function1 deletePaymentMethod, Composer composer, int i8) {
        ...
        MutableState mutableState = (MutableState) RememberSaveableKt.m2583rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) e.f6231a, startRestartGroup, 3080, 6);
        String str = paymentMethod.d().f24395a;
