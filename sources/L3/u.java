...
public final class u {
    ...
    public final List a(M3.a viewModel, Y2.d paymentMethodMetadata, C3649b customerStateHolder) {
        ...
        if (h02.size() == 1 && ((List) customerStateHolder.c().getValue()).isEmpty()) {
            return AbstractC1246t.e(new InterfaceC4021c.l(d.f6192l.a((String) AbstractC1246t.m0(h02), viewModel, paymentMethodMetadata, customerStateHolder), true));
        }
        List c8 = AbstractC1246t.c();
        c8.add(new InterfaceC4021c.k(c.f6137A.a(viewModel, paymentMethodMetadata, customerStateHolder)));
        ...
        if (eVar != null) {
            String o8 = eVar.f().o();
            if (C3658k.f37321g.a(viewModel, q3.m.f37331h.a(viewModel, ViewModelKt.getViewModelScope(viewModel)), paymentMethodMetadata).d(o8)) {
                c8.add(new InterfaceC4021c.l(d.f6192l.a(o8, viewModel, paymentMethodMetadata, customerStateHolder), false, 2, null));
            }
        }
