...
public final class C3186p extends AbstractC3176f {
    ...
    private final C3189s f33929a;

    /* renamed from: b, reason: collision with root package name */
    private final C3174d f33930b;

    /* renamed from: c, reason: collision with root package name */
    private final Context f33931c;
    ...
    public C3186p(C3189s webIntentAuthenticator, C3174d noOpIntentAuthenticator, Context context) {
        ...
        this.f33929a = webIntentAuthenticator;
        this.f33930b = noOpIntentAuthenticator;
    ...
    public Object e(InterfaceC2464p interfaceC2464p, StripeIntent stripeIntent, j.c cVar, P5.d dVar) {
        ...
        if (((StripeIntent.a.h) l8).b() == null) {
            k3.i b8 = i.a.b(k3.i.f33380a, this.f33931c, null, 2, null);
            i.f fVar = i.f.f33414d;
            ...
            Object d8 = this.f33930b.d(interfaceC2464p, stripeIntent, cVar, dVar);
            if (d8 == Q5.b.e()) {
                return d8;
            }
            return I.f6474a;
        }
        Object d9 = this.f33929a.d(interfaceC2464p, stripeIntent, cVar, dVar);
        if (d9 == Q5.b.e()) {
            return d9;
        }
        return I.f6474a;
