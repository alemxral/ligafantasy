...
public final class b implements i {
    ...
    public static final c f6107q = new c(null);

    /* renamed from: r, reason: collision with root package name */
    public static final int f6108r = 8;

    /* renamed from: a, reason: collision with root package name */
    private final InterfaceC3349K f6109a;

    /* renamed from: b, reason: collision with root package name */
    private final Y2.d f6110b;

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC3349K f6111c;

    /* renamed from: d, reason: collision with root package name */
    private final InterfaceC3349K f6112d;

    /* renamed from: e, reason: collision with root package name */
    private final InterfaceC3349K f6113e;

    /* renamed from: f, reason: collision with root package name */
    private final Function0 f6114f;

    /* renamed from: g, reason: collision with root package name */
    private final Function1 f6115g;

    /* renamed from: h, reason: collision with root package name */
    private final Function1 f6116h;

    /* renamed from: i, reason: collision with root package name */
    private final Function1 f6117i;

    /* renamed from: j, reason: collision with root package name */
    private final Function1 f6118j;

    /* renamed from: k, reason: collision with root package name */
    private final Function1 f6119k;

    /* renamed from: l, reason: collision with root package name */
    private final boolean f6120l;

    /* renamed from: m, reason: collision with root package name */
    private final M f6121m;

    /* renamed from: n, reason: collision with root package name */
    private final AtomicBoolean f6122n;

    /* renamed from: o, reason: collision with root package name */
    private final InterfaceC3349K f6123o;

    /* renamed from: p, reason: collision with root package name */
    private final InterfaceC3349K f6124p;
        ...
        public static final class C0122a implements InterfaceC3359g {
            ...
            public final Object emit(i.a aVar, P5.d dVar) {
                if (!aVar.e() && !aVar.a() && aVar.d().size() == 1) {
                    this.f6127a.h((C3654g) AbstractC1246t.m0(aVar.d()));
                }
                return I.f6474a;
            }
        }
    ...
    static final class C0123b extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        @Override // X5.n
        public final Object invoke(M m8, P5.d dVar) {
            return ((C0123b) create(m8, dVar)).invokeSuspend(I.f6474a);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                L5.t.b(obj);
                InterfaceC3349K interfaceC3349K = b.this.f6109a;
                a aVar = new a(b.this);
                this.f6128a = 1;
    ...
    public static final class c {
        ...
        static final class C0124b extends AbstractC3160z implements Function1 {
            ...
            public final void a(C3654g it) {
                ...
                this.f6131a.E(c0916f);
                this.f6131a.n().k(c0916f);
            }
        ...
        public final C3654g c(AbstractC3991f abstractC3991f, List list) {
            ...
            if (z8) {
                ...
                d8 = AbstractC3159y.d(abstractC3991f, AbstractC3991f.c.f39757a);
            }
            if (d8) {
                d9 = true;
            } else {
                d9 = AbstractC3159y.d(abstractC3991f, AbstractC3991f.d.f39758a);
            }
            if (!d9) {
            ...
            if (abstractC3991f instanceof AbstractC3991f.C0916f) {
                String str = ((AbstractC3991f.C0916f) abstractC3991f).v().f24395a;
                ...
                while (true) {
                    ...
                    Object next = it.next();
                    if (AbstractC3159y.d(((C3654g) next).d().f24395a, str)) {
                        obj = next;
                        break;
                    }
                }
    ...
    static final class d extends AbstractC3160z implements Function1 {
        ...
        public final List invoke(List paymentMethods) {
            ...
            Iterator it = list.iterator();
            while (it.hasNext()) {
                arrayList.add(q.a((com.stripe.android.model.o) it.next(), bVar.f6115g, bVar.f6110b));
            }
            return arrayList;
        }
    }
    ...
    static final class e extends AbstractC3160z implements X5.q {
        ...
        public final i.a a(List displayablePaymentMethods, AbstractC3991f abstractC3991f, boolean z8, boolean z9, boolean z10) {
            ...
            if (!z8) {
                c8 = b.f6107q.c(abstractC3991f, displayablePaymentMethods);
            } else {
                c8 = null;
            }
    ...
    public b(InterfaceC3349K paymentMethods, Y2.d paymentMethodMetadata, InterfaceC3349K selection, InterfaceC3349K editing, InterfaceC3349K canRemove, InterfaceC3349K canEdit, Function0 toggleEdit, Function1 providePaymentMethodName, Function1 onSelectPaymentMethod, Function1 onDeletePaymentMethod, Function1 onEditPaymentMethod, Function1 navigateBack, boolean z8, P5.g dispatcher) {
        ...
        this.f6109a = paymentMethods;
        this.f6110b = paymentMethodMetadata;
        this.f6111c = selection;
        this.f6112d = editing;
        this.f6113e = canEdit;
        this.f6114f = toggleEdit;
        this.f6115g = providePaymentMethodName;
        this.f6116h = onSelectPaymentMethod;
        this.f6117i = onDeletePaymentMethod;
        this.f6118j = onEditPaymentMethod;
        this.f6119k = navigateBack;
        this.f6120l = z8;
        M a8 = N.a(dispatcher.plus(U0.b(null, 1, null)));
        this.f6121m = a8;
        this.f6122n = new AtomicBoolean(false);
        InterfaceC3349K m8 = v4.g.m(paymentMethods, new d());
        this.f6123o = m8;
        this.f6124p = v4.g.g(m8, selection, editing, canRemove, canEdit, e.f6136a);
    ...
    public final void h(C3654g c3654g) {
        this.f6116h.invoke(c3654g);
        i(true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void i(boolean z8) {
        if (!this.f6122n.getAndSet(true)) {
            this.f6119k.invoke(Boolean.valueOf(z8));
        }
    }
    ...
    public void b(i.b viewAction) {
        ...
        if (viewAction instanceof i.b.a) {
            this.f6117i.invoke(((i.b.a) viewAction).a());
        } else if (viewAction instanceof i.b.C0133b) {
            this.f6118j.invoke(((i.b.C0133b) viewAction).a());
        } else if (AbstractC3159y.d(viewAction, i.b.d.f6252a)) {
            this.f6114f.invoke();
        }
    }
