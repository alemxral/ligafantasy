...
public final class d implements s {
    ...
    public static final a f6192l = new a(null);

    /* renamed from: m, reason: collision with root package name */
    public static final int f6193m = 8;

    /* renamed from: a, reason: collision with root package name */
    private final String f6194a;

    /* renamed from: b, reason: collision with root package name */
    private final A3.a f6195b;

    /* renamed from: c, reason: collision with root package name */
    private final List f6196c;

    /* renamed from: d, reason: collision with root package name */
    private final X5.n f6197d;

    /* renamed from: e, reason: collision with root package name */
    private final B3.d f6198e;

    /* renamed from: f, reason: collision with root package name */
    private final Function1 f6199f;

    /* renamed from: g, reason: collision with root package name */
    private final W2.a f6200g;

    /* renamed from: h, reason: collision with root package name */
    private final Function0 f6201h;

    /* renamed from: i, reason: collision with root package name */
    private final boolean f6202i;

    /* renamed from: j, reason: collision with root package name */
    private final M f6203j;

    /* renamed from: k, reason: collision with root package name */
    private final InterfaceC3349K f6204k;
    ...
    public static final class a {
        ...
        public static final class c extends AbstractC3160z implements Function0 {
            ...
            public final Boolean invoke() {
                return Boolean.valueOf(this.f6205a.r().e());
            }
        }
        ...
        public final s a(String selectedPaymentMethodCode, M3.a viewModel, Y2.d paymentMethodMetadata, C3649b customerStateHolder) {
            ...
            if (!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) {
                ...
                while (it.hasNext()) {
                    o.p pVar = ((com.stripe.android.model.o) it.next()).f24399e;
                    if (pVar != null) {
                        str = pVar.f24537a;
                    } else {
                        str = null;
    ...
    static final class b extends AbstractC3160z implements Function1 {
        ...
        public final s.a a(boolean z8) {
            return new s.a(d.this.f6194a, z8, d.this.f6198e, d.this.f6195b, d.this.f6196c, d.this.f6200g);
        }
    ...
    public d(String selectedPaymentMethodCode, A3.a formArguments, List formElements, X5.n onFormFieldValuesChanged, B3.d usBankAccountArguments, Function1 reportFieldInteraction, W2.a aVar, Function0 canGoBackDelegate, boolean z8, InterfaceC3349K processing, M coroutineScope) {
        ...
        this.f6194a = selectedPaymentMethodCode;
        this.f6195b = formArguments;
        this.f6196c = formElements;
        this.f6197d = onFormFieldValuesChanged;
        this.f6198e = usBankAccountArguments;
        this.f6199f = reportFieldInteraction;
        this.f6200g = aVar;
        this.f6201h = canGoBackDelegate;
        this.f6202i = z8;
        this.f6203j = coroutineScope;
        this.f6204k = v4.g.m(processing, new b());
    }
    ...
    @Override // L3.s
    public boolean b() {
        return ((Boolean) this.f6201h.invoke()).booleanValue();
    }

    @Override // L3.s
    public void c(s.b viewAction) {
        AbstractC3159y.i(viewAction, "viewAction");
        if (AbstractC3159y.d(viewAction, s.b.a.f6406a)) {
            this.f6199f.invoke(this.f6194a);
        } else if (viewAction instanceof s.b.C0136b) {
            this.f6197d.invoke(((s.b.C0136b) viewAction).a(), this.f6194a);
        }
    }

    @Override // L3.s
    public void close() {
        N.d(this.f6203j, null, 1, null);
    }
