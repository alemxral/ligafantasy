...
public final class a implements f {
    ...
    public static final C0120a f6102d = new C0120a(null);

    /* renamed from: e, reason: collision with root package name */
    public static final int f6103e = 8;

    /* renamed from: a, reason: collision with root package name */
    private final Function1 f6104a;

    /* renamed from: b, reason: collision with root package name */
    private final Function0 f6105b;
    ...
    public a(com.stripe.android.model.o paymentMethod, Y2.d paymentMethodMetadata, Function1 providePaymentMethodName, Function1 onDeletePaymentMethod, Function0 navigateBack) {
        ...
        this.f6104a = onDeletePaymentMethod;
        this.f6105b = navigateBack;
        this.f6106c = new f.a(q.a(paymentMethod, providePaymentMethodName, paymentMethodMetadata), paymentMethodMetadata.V().a());
    }
    ...
    public void a(f.b viewAction) {
        ...
        if (viewAction instanceof f.b.a) {
            this.f6104a.invoke(getState().a().d());
            this.f6105b.invoke();
        }
    }
