...
public class k extends AbstractC3733a {
    ...
    public void a(String str) {
        if (str.charAt(16) == '1') {
            this.f37816a = l.a(str.substring(17));
            return;
        }
    ...
    public String b() {
        int i8;
        if (((List) this.f37816a).size() > 0) {
            i8 = ((Integer) ((List) this.f37816a).get(((List) r0).size() - 1)).intValue();
        } else {
            i8 = 0;
        }
        String b8 = l.b((List) this.f37816a);
        if (b8.length() <= i8) {
        ...
        for (int i10 = 0; i10 < i8; i10++) {
            if (i10 == ((Integer) ((List) this.f37816a).get(i9)).intValue() - 1) {
