...
public abstract class x extends w {
    ...
    public static final class a extends AbstractC3160z implements X5.n {
        ...
        final /* synthetic */ char[] f31325a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ boolean f31326b;
        ...
        public final L5.r a(CharSequence $receiver, int i8) {
            ...
            int T7 = x.T($receiver, this.f31325a, i8, this.f31326b);
            if (T7 < 0) {
                return null;
            }
    ...
    public static final class b extends AbstractC3160z implements X5.n {
        ...
        public final L5.r a(CharSequence $receiver, int i8) {
            AbstractC3159y.i($receiver, "$this$$receiver");
            L5.r K8 = x.K($receiver, this.f31327a, i8, this.f31328b, false);
            if (K8 != null) {
    ...
    public static final class c extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ CharSequence f31329a;
