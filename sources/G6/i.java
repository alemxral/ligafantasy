...
public final class i implements h {
    ...
    private final Matcher f31297a;

    /* renamed from: b, reason: collision with root package name */
    private final CharSequence f31298b;

    /* renamed from: c, reason: collision with root package name */
    private final g f31299c;

    /* renamed from: d, reason: collision with root package name */
    private List f31300d;
    ...
    public h next() {
        ...
        int i9 = end + i8;
        if (i9 <= this.f31298b.length()) {
            Matcher matcher = this.f31297a.pattern().matcher(this.f31298b);
            AbstractC3159y.h(matcher, "matcher(...)");
            d8 = k.d(matcher, i9, this.f31298b);
            return d8;
        }
        return null;
    }
