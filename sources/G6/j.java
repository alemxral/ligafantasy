...
public final class j implements Serializable {
    ...
    public static final a f31304b = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private final Pattern f31305a;
    ...
    public static final class b extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ CharSequence f31307b;
        ...
        public final h invoke() {
            return j.this.a(this.f31307b, this.f31308c);
        }
    }
    ...
    public final h a(CharSequence input, int i8) {
        ...
        Matcher matcher = this.f31305a.matcher(input);
    ...
    public final InterfaceC2680g c(CharSequence input, int i8) {
        ...
        if (i8 >= 0 && i8 <= input.length()) {
            return AbstractC2683j.j(new b(input, i8), c.f31309a);
        }
    ...
    public final boolean e(CharSequence input) {
        AbstractC3159y.i(input, "input");
        return this.f31305a.matcher(input).matches();
    }

    public final String f(CharSequence input, String replacement) {
        AbstractC3159y.i(input, "input");
        AbstractC3159y.i(replacement, "replacement");
        String replaceAll = this.f31305a.matcher(input).replaceAll(replacement);
    ...
    public final String h(CharSequence input, String replacement) {
        AbstractC3159y.i(input, "input");
        AbstractC3159y.i(replacement, "replacement");
        String replaceFirst = this.f31305a.matcher(input).replaceFirst(replacement);
    ...
    public String toString() {
        String pattern = this.f31305a.toString();
