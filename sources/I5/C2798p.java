...
public final class C2798p extends RowsSupportFragment {
    ...
    private C1498h f31628a;

    /* renamed from: b, reason: collision with root package name */
    private C1498h f31629b;

    /* renamed from: c, reason: collision with root package name */
    private ArrayList f31630c = new ArrayList();

    /* renamed from: d, reason: collision with root package name */
    private ArrayList f31631d = new ArrayList();

    /* renamed from: e, reason: collision with root package name */
    private ArrayList f31632e = new ArrayList();

    /* renamed from: f, reason: collision with root package name */
    private ArrayObjectAdapter f31633f;
    ...
    public C2798p() {
        ...
        this.f31633f = arrayObjectAdapter;
    ...
    private final void r(C1498h c1498h) {
        if (getContext() != null) {
            ...
            this.f31633f.add(new ListRow(arrayObjectAdapter));
        }
    }
    ...
    private final void s(X4.N n8) {
        if (getContext() != null) {
            ...
            this.f31633f.add(new ListRow(headerItem, arrayObjectAdapter));
        }
    }
    ...
    private final void w() {
        ...
        C1498h c1498h = this.f31629b;
        if (c1498h != null) {
            AbstractC3159y.f(c1498h);
            r(c1498h);
        }
        if ((!this.f31632e.isEmpty()) && this.f31632e.size() > 1) {
            Object obj2 = this.f31632e.get(1);
        ...
        if ((!this.f31632e.isEmpty()) && this.f31632e.size() > 2) {
            Object obj3 = this.f31632e.get(2);
        ...
        if (!this.f31631d.isEmpty()) {
            Iterator it = this.f31631d.iterator();
            while (it.hasNext()) {
    ...
    public void onResume() {
        super.onResume();
        if (this.f31628a == null || this.f31630c.isEmpty()) {
            y();
        }
    }
    ...
    public static final class a implements W4.n {
        ...
        public void a(X4.N topHorizontalTopReceived) {
            ...
            C2798p.this.f31631d.add(topHorizontalTopReceived);
            C2798p.this.x();
        }
        ...
        public void b(ArrayList miniTopsReceived) {
            ...
            C2798p.this.f31631d.addAll(miniTopsReceived);
            C2798p.this.x();
        }
        ...
        public void c(X4.N topHorizontalNewReleasesReceived) {
            ...
            C2798p.this.f31631d.add(topHorizontalNewReleasesReceived);
        }
        ...
        public void d(ArrayList homeFeaturesReceived) {
            ...
            if (homeFeaturesReceived.size() > 0) {
                C2798p.this.f31628a = (C1498h) AbstractC1246t.m0(homeFeaturesReceived);
                C2798p c2798p = C2798p.this;
                C1498h c1498h = c2798p.f31628a;
                AbstractC3159y.f(c1498h);
                c2798p.t(c1498h);
            }
        ...
        public void f(X4.N topHorizontalLatestReceived) {
            ...
            C2798p.this.f31631d.add(topHorizontalLatestReceived);
            C2798p.this.x();
        }
        ...
        public void g(ArrayList recentFeaturedReceived) {
            ...
            C2798p.this.f31629b = (C1498h) AbstractC1246t.m0(recentFeaturedReceived);
            C2798p.this.x();
        }
        ...
        public void l(ArrayList categoriesReceived) {
            ...
            C2798p.this.f31630c = categoriesReceived;
        }
    ...
    public static final class b implements W4.r {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Presenter.ViewHolder f31637b;

        b(Presenter.ViewHolder viewHolder) {
            this.f31637b = viewHolder;
        }
        ...
        public void f(C1498h appInfo) {
            ...
            if (C2798p.this.getActivity() != null && (C2798p.this.getActivity() instanceof h5.b)) {
                try {
                    ...
                    Presenter.ViewHolder itemViewHolder = this.f31637b;
