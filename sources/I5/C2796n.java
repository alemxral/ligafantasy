...
public final class C2796n extends RowsSupportFragment {
    ...
    private ArrayObjectAdapter f31623b;
    ...
    public C2796n() {
        ...
        this.f31623b = arrayObjectAdapter;
    ...
    public final void l(ArrayList arrayList) {
        ...
        this.f31623b.add(new ListRow(arrayObjectAdapter));
    }
    ...
    private final void p(X4.N n8) {
        if (getContext() != null) {
            ...
            this.f31623b.add(new ListRow(headerItem, arrayObjectAdapter));
            return;
        }
        this.f31622a = false;
    }
    ...
    public static final class b implements W4.r {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Presenter.ViewHolder f31626b;
        ...
        public void f(C1498h appInfo) {
            ...
            if (C2796n.this.getActivity() != null && (C2796n.this.getActivity() instanceof h5.b)) {
                try {
                    ...
                    Presenter.ViewHolder itemViewHolder = this.f31626b;
