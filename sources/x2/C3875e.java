...
public class C3875e {
    ...
    private static volatile UUID f39132h;

    /* renamed from: i, reason: collision with root package name */
    private static final String f39133i;

    /* renamed from: j, reason: collision with root package name */
    private static final I5.a f39134j;

    /* renamed from: a, reason: collision with root package name */
    private final PackageManager f39135a;

    /* renamed from: b, reason: collision with root package name */
    private final PackageInfo f39136b;

    /* renamed from: c, reason: collision with root package name */
    private final String f39137c;

    /* renamed from: d, reason: collision with root package name */
    private final I5.a f39138d;

    /* renamed from: e, reason: collision with root package name */
    private final I5.a f39139e;

    /* renamed from: f, reason: collision with root package name */
    private final I5.a f39140f;
    ...
    static {
        ...
        f39132h = randomUUID;
        f39133i = Build.MANUFACTURER + "_" + Build.BRAND + "_" + Build.MODEL;
        f39134j = new I5.a() { // from class: x2.d
            @Override // I5.a
    ...
    public C3875e(PackageManager packageManager, PackageInfo packageInfo, String packageName, I5.a publishableKeyProvider, I5.a networkTypeProvider, I5.a pluginTypeProvider) {
        ...
        this.f39135a = packageManager;
        this.f39136b = packageInfo;
        this.f39137c = packageName;
        this.f39138d = publishableKeyProvider;
        this.f39139e = networkTypeProvider;
        this.f39140f = pluginTypeProvider;
    }
    ...
    private final Map i() {
        String str = (String) this.f39139e.get();
        if (str == null) {
            return Q.h();
        }
    ...
    private final Map k() {
        Map e8;
        String str = (String) this.f39140f.get();
    ...
    private final Map l() {
        ...
        try {
            ...
            b8 = L5.s.b((String) this.f39138d.get());
        } catch (Throwable th) {
        ...
        return Q.q(Q.q(Q.k(a8, L5.x.a("publishable_key", b8), L5.x.a("os_name", Build.VERSION.CODENAME), L5.x.a("os_release", Build.VERSION.RELEASE), L5.x.a("os_version", Integer.valueOf(Build.VERSION.SDK_INT)), L5.x.a("device_type", f39133i), L5.x.a("bindings_version", "20.49.0"), L5.x.a("is_development", Boolean.FALSE), L5.x.a("session_id", f39132h), L5.x.a("locale", Locale.getDefault().toString())), i()), k());
    }

    public final Map e() {
        PackageInfo packageInfo;
        PackageManager packageManager = this.f39135a;
        if (packageManager != null && (packageInfo = this.f39136b) != null) {
            return Q.k(L5.x.a("app_name", h(packageInfo, packageManager)), L5.x.a("app_version", Integer.valueOf(this.f39136b.versionCode)));
        }
        return Q.h();
    }
    ...
    public final C3872b g(InterfaceC3871a event, Map additionalParams) {
        ...
        return new C3872b(Q.q(f(event), additionalParams), y.a.f39250d.b());
    }
    ...
    public /* synthetic */ C3875e(PackageManager packageManager, PackageInfo packageInfo, String str, I5.a aVar, I5.a aVar2, I5.a aVar3, int i8, AbstractC3151p abstractC3151p) {
        this(packageManager, packageInfo, str, aVar, aVar2, (i8 & 32) != 0 ? f39134j : aVar3);
    }
}
