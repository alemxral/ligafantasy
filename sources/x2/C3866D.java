...
public final class C3866D {
    ...
    public static final b f39094b = new b(null);

    /* renamed from: c, reason: collision with root package name */
    private static final Function1 f39095c = a.f39097a;

    /* renamed from: a, reason: collision with root package name */
    private final Function1 f39096a;
    ...
    public C3866D(Function1 systemPropertySupplier) {
        ...
        this.f39096a = systemPropertySupplier;
    }
    ...
    public final JSONObject b(C3683c c3683c) {
        Map map;
        Map k8 = Q.k(L5.x.a("os.name", "android"), L5.x.a("os.version", String.valueOf(Build.VERSION.SDK_INT)), L5.x.a("bindings.version", "20.49.0"), L5.x.a("lang", "Java"), L5.x.a("publisher", "Stripe"), L5.x.a("http.agent", this.f39096a.invoke("http.agent")));
        if (c3683c != null) {
            map = c3683c.b();
        } else {
            map = null;
