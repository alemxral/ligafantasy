...
public interface l {
    ...
    public static final class a {
        ...
        static final /* synthetic */ a f39182a = new a();

        /* renamed from: b, reason: collision with root package name */
        private static final int f39183b;

        /* renamed from: c, reason: collision with root package name */
        private static final int f39184c;

        static {
            TimeUnit timeUnit = TimeUnit.SECONDS;
            f39183b = (int) timeUnit.toMillis(30L);
            f39184c = (int) timeUnit.toMillis(80L);
        }
    ...
    public static final class c implements l {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static volatile b f39187b = b.a.f39185a;
        ...
        public static final class a extends AbstractC3160z implements X5.n {
            ...
            public final void a(HttpURLConnection open, AbstractC3869G request) {
                ...
                AbstractC3159y.i(request, "request");
                open.setConnectTimeout(a.f39183b);
                open.setReadTimeout(a.f39184c);
                ...
                if (AbstractC3869G.a.f39104c == request.b()) {
        ...
        private final HttpsURLConnection b(AbstractC3869G abstractC3869G) {
            return f39187b.a(abstractC3869G, a.f39188a);
        }
