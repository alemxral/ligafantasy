...
public final class w implements i {
    ...
    private final SharedPreferences f39232a;

    /* renamed from: b, reason: collision with root package name */
    private final I f39233b;
    ...
    static final class a extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            return new a(this.f39236c, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f39234a == 0) {
                L5.t.b(obj);
                String string = w.this.f39232a.getString(this.f39236c, null);
                if (string == null) {
                    return null;
                }
                w.this.f39232a.edit().remove(this.f39236c).apply();
                try {
                    s.a aVar = L5.s.f6498b;
                    AbstractC3999a.C0918a c0918a = AbstractC3999a.f39943d;
                    c0918a.e();
    ...
    private w(SharedPreferences sharedPreferences, I i8) {
        this.f39232a = sharedPreferences;
        this.f39233b = i8;
    }

    @Override // x2.i
    public Object a(String str, P5.d dVar) {
        return AbstractC2825i.g(this.f39233b, new a(str, null), dVar);
    }
