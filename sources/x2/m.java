...
public final class m implements InterfaceC3873c {
    ...
    private final InterfaceC3868F f39190a;

    /* renamed from: b, reason: collision with root package name */
    private final P5.g f39191b;

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC3684d f39192c;
    ...
    static final class b extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        /* renamed from: b, reason: collision with root package name */
        private /* synthetic */ Object f39194b;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ C3872b f39196d;
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            b bVar = new b(this.f39196d, dVar);
            bVar.f39194b = obj;
            return bVar;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i8 != 0) {
                    ...
                    L5.t.b(obj);
                    m mVar = m.this;
                    C3872b c3872b = this.f39196d;
                    s.a aVar = L5.s.f6498b;
                    InterfaceC3868F interfaceC3868F = mVar.f39190a;
                    this.f39193a = 1;
            ...
            if (e9 != null) {
                mVar2.f39192c.a("Exception while making analytics request", e9);
            }
            return I.f6474a;
        }
    }
    ...
    public m(InterfaceC3868F stripeNetworkClient, P5.g workContext, InterfaceC3684d logger) {
        ...
        this.f39190a = stripeNetworkClient;
        this.f39191b = workContext;
        this.f39192c = logger;
    }
    ...
    public void a(C3872b request) {
        ...
        this.f39192c.d("Event: " + request.h().get(NotificationCompat.CATEGORY_EVENT));
        AbstractC2829k.d(N.a(this.f39191b), null, null, new b(request, null), 3, null);
    }

    public m() {
        this(InterfaceC3684d.f37551a.b(), C2812b0.b());
    }
