...
public interface InterfaceC3867E extends Closeable {
    ...
    public static abstract class a implements InterfaceC3867E {
        ...
        public static final C0908a f39098b = new C0908a(null);

        /* renamed from: c, reason: collision with root package name */
        private static final String f39099c = StandardCharsets.UTF_8.name();

        /* renamed from: a, reason: collision with root package name */
        private final HttpsURLConnection f39100a;
        ...
        private final InputStream e() {
            int b8 = b();
            if (200 <= b8 && b8 < 300) {
                return this.f39100a.getInputStream();
            }
            return this.f39100a.getErrorStream();
        }

        public /* synthetic */ int b() {
            return this.f39100a.getResponseCode();
        }
        ...
        public /* synthetic */ C3870H z() {
            int b8 = b();
            Object B8 = B(e());
            Map<String, List<String>> headerFields = this.f39100a.getHeaderFields();
    ...
    public static final class b extends a {
        ...
        public String B(InputStream inputStream) {
            ...
            try {
                Scanner useDelimiter = new Scanner(inputStream, a.f39098b.a()).useDelimiter("\\A");
