...
public final class v {
    ...
    public static final v f39228a = new v();
    ...
    public static final class a {
        ...
        public boolean equals(Object obj) {
            ...
            a aVar = (a) obj;
            if (AbstractC3159y.d(this.f39229a, aVar.f39229a) && AbstractC3159y.d(this.f39230b, aVar.f39230b)) {
                return true;
            }
            return false;
        }
        ...
        public String toString() {
            return a(this.f39229a) + "=" + a(this.f39230b);
        }
    }
    ...
    private final List e(List list, String str) {
        ...
        if (j(list)) {
            ...
            while (it.hasNext()) {
                AbstractC1246t.D(arrayList, f39228a.h(it.next(), str2));
            }
        } else {
            arrayList = new ArrayList();
            int i8 = 0;
            for (Object obj : list) {
                ...
                AbstractC1246t.D(arrayList, f39228a.h(obj, str + "[" + i8 + "]"));
                i8 = i9;
            }
        }
        return arrayList;
    ...
    private final List f(Map map, String str) {
        if (map != null) {
            ...
            for (Map.Entry entry : map.entrySet()) {
                ...
                AbstractC1246t.D(arrayList, f39228a.h(value, str2));
            }
            return arrayList;
        }
    ...
    public final String b(Map map) {
        return AbstractC1246t.w0(d(map), "&", null, null, 0, null, b.f39231a, 30, null);
    }
    ...
    public final String c(Map map) {
        ...
        Map a8;
        String b8;
        if (map == null || (a8 = (vVar = f39228a).a(map)) == null || (b8 = vVar.b(a8)) == null) {
            return "";
        }
        return b8;
    }
