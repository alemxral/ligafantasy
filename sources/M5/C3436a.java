...
public final class C3436a extends SSLSocketFactory {
    ...
    public static final C0824a f35848b = new C0824a(null);

    /* renamed from: a, reason: collision with root package name */
    private final SSLSocketFactory f35849a;
    ...
    public Socket createSocket() {
        Socket createSocket = this.f35849a.createSocket();
    ...
    public String[] getDefaultCipherSuites() {
        String[] defaultCipherSuites = this.f35849a.getDefaultCipherSuites();
    ...
    public String[] getSupportedCipherSuites() {
        String[] supportedCipherSuites = this.f35849a.getSupportedCipherSuites();
    ...
    public Socket createSocket(Socket s8, String host, int i8, boolean z8) {
        ...
        Socket createSocket = this.f35849a.createSocket(s8, host, i8, z8);
    ...
    public Socket createSocket(String host, int i8) {
        AbstractC3159y.i(host, "host");
        Socket createSocket = this.f35849a.createSocket(host, i8);
    ...
    public Socket createSocket(String host, int i8, InetAddress localHost, int i9) {
        ...
        Socket createSocket = this.f35849a.createSocket(host, i8, localHost, i9);
    ...
    public Socket createSocket(InetAddress address, int i8, InetAddress localAddress, int i9) {
        ...
        Socket createSocket = this.f35849a.createSocket(address, i8, localAddress, i9);
