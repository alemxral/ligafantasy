...
public final class C1238k extends AbstractC1233f {
    ...
    private static final Object[] f7049e = new Object[0];
    ...
    private final void h(int i8, Collection collection) {
        ...
        int length = this.f7051b.length;
        while (i8 < length && it.hasNext()) {
            this.f7051b[i8] = it.next();
            i8++;
        }
        int i9 = this.f7050a;
        for (int i10 = 0; i10 < i9 && it.hasNext(); i10++) {
            this.f7051b[i10] = it.next();
        }
        this.f7052c = size() + collection.size();
    }

    private final void l(int i8) {
        Object[] objArr = new Object[i8];
        Object[] objArr2 = this.f7051b;
        AbstractC1239l.i(objArr2, objArr, 0, this.f7050a, objArr2.length);
        Object[] objArr3 = this.f7051b;
    ...
    private final int m(int i8) {
        if (i8 == 0) {
            return AbstractC1239l.i0(this.f7051b);
        }
        return i8 - 1;
    }
    ...
    private final void p(int i8) {
        if (i8 >= 0) {
            ...
            if (objArr == f7049e) {
                this.f7051b = new Object[d6.m.d(i8, 10)];
                return;
            } else {
    ...
    private final int r(int i8) {
        if (i8 == AbstractC1239l.i0(this.f7051b)) {
            return 0;
        }
        return i8 + 1;
    }
    ...
    public boolean addAll(Collection elements) {
        ...
        h(v(this.f7050a + size()), elements);
        return true;
    }

    @Override // java.util.AbstractList, java.util.AbstractCollection, java.util.Collection, java.util.List
    public void clear() {
        int v8 = v(this.f7050a + size());
        int i8 = this.f7050a;
        if (i8 < v8) {
            AbstractC1239l.t(this.f7051b, null, i8, v8);
        } else if (!isEmpty()) {
            Object[] objArr = this.f7051b;
            AbstractC1239l.t(objArr, null, this.f7050a, objArr.length);
            AbstractC1239l.t(this.f7051b, null, 0, v8);
        }
        this.f7050a = 0;
        this.f7052c = 0;
    }
    ...
    public final Object first() {
        if (!isEmpty()) {
            return this.f7051b[this.f7050a];
        }
    ...
    public final void g(Object obj) {
        p(size() + 1);
        this.f7051b[v(this.f7050a + size())] = obj;
        this.f7052c = size() + 1;
    }
    ...
    public Object get(int i8) {
        ...
        return this.f7051b[v(this.f7050a + i8)];
    }
    ...
    public int indexOf(Object obj) {
        ...
        if (i9 < v8) {
            while (i9 < v8) {
                if (AbstractC3159y.d(obj, this.f7051b[i9])) {
                    i8 = this.f7050a;
                } else {
                    i9++;
                }
            ...
            while (true) {
                if (i9 < length) {
                    ...
                    for (int i10 = 0; i10 < v8; i10++) {
                        if (AbstractC3159y.d(obj, this.f7051b[i10])) {
                            i9 = i10 + this.f7051b.length;
                            i8 = this.f7050a;
                        }
                    }
                    return -1;
    ...
    public final Object last() {
        if (!isEmpty()) {
            return this.f7051b[v(this.f7050a + AbstractC1246t.o(this))];
        }
        throw new NoSuchElementException("ArrayDeque is empty.");
    }
    ...
    public int lastIndexOf(Object obj) {
        ...
        if (i9 < v8) {
            i02 = v8 - 1;
            if (i9 <= i02) {
                while (!AbstractC3159y.d(obj, this.f7051b[i02])) {
                    if (i02 != i9) {
                        i02--;
                    }
                }
        ...
        if (i9 > v8) {
            ...
            while (true) {
                if (-1 < i10) {
                    if (AbstractC3159y.d(obj, this.f7051b[i10])) {
                        i02 = i10 + this.f7051b.length;
                        i8 = this.f7050a;
                        break;
                    }
                    i10--;
                } else {
                    i02 = AbstractC1239l.i0(this.f7051b);
                    int i11 = this.f7050a;
                    if (i11 <= i02) {
                        while (!AbstractC3159y.d(obj, this.f7051b[i02])) {
                            if (i02 != i11) {
    ...
    public boolean removeAll(Collection elements) {
        ...
        z8 = false;
        z8 = false;
        if (!isEmpty() && this.f7051b.length != 0) {
            int v9 = v(this.f7050a + size());
            int i8 = this.f7050a;
            if (i8 < v9) {
                v8 = i8;
                while (i8 < v9) {
                    Object obj = this.f7051b[i8];
                ...
                AbstractC1239l.t(this.f7051b, null, v8, v9);
            } else {
                int length = this.f7051b.length;
                int i9 = i8;
                boolean z9 = false;
    ...
    public Object removeAt(int i8) {
        ...
        int v8 = v(this.f7050a + i8);
        Object obj = this.f7051b[v8];
        if (i8 < (size() >> 1)) {
            int i9 = this.f7050a;
            if (v8 >= i9) {
                Object[] objArr = this.f7051b;
            ...
            Object[] objArr4 = this.f7051b;
            int i11 = this.f7050a;
            objArr4[i11] = null;
            this.f7050a = r(i11);
        } else {
            int v9 = v(this.f7050a + AbstractC1246t.o(this));
            if (v8 <= v9) {
                Object[] objArr5 = this.f7051b;
                AbstractC1239l.i(objArr5, objArr5, v8, v8 + 1, v9 + 1);
            } else {
                Object[] objArr6 = this.f7051b;
                AbstractC1239l.i(objArr6, objArr6, v8, v8 + 1, objArr6.length);
                Object[] objArr7 = this.f7051b;
    ...
    public Object[] toArray(Object[] array) {
        ...
        int i8 = this.f7050a;
        if (i8 < v8) {
            AbstractC1239l.n(this.f7051b, array, 0, i8, v8, 2, null);
        } else if (!isEmpty()) {
            Object[] objArr = this.f7051b;
            AbstractC1239l.i(objArr, array, 0, this.f7050a, objArr.length);
            Object[] objArr2 = this.f7051b;
            AbstractC1239l.i(objArr2, array, objArr2.length - this.f7050a, 0, v8);
        }
    ...
    public final Object y() {
        if (!isEmpty()) {
            int v8 = v(this.f7050a + AbstractC1246t.o(this));
            Object[] objArr = this.f7051b;
        ...
        if (i8 < ((size() + 1) >> 1)) {
            ...
            if (v9 < i9) {
                ...
                if (length >= i11) {
                    ...
                    Object[] objArr7 = this.f7051b;
                    AbstractC1239l.i(objArr7, objArr7, 0, this.f7050a + length, v9);
                }
            }
            this.f7050a = i10;
