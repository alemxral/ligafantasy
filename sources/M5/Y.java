...
public class Y extends AbstractC1230c {
    ...
    public static final class a implements ListIterator, Y5.a {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final ListIterator f7010a;

        a(int i8) {
            int Z7;
            List list = Y.this.f7009a;
            Z7 = B.Z(Y.this, i8);
            this.f7010a = list.listIterator(Z7);
        }
        ...
        public boolean hasNext() {
            return this.f7010a.hasPrevious();
        }

        @Override // java.util.ListIterator
        public boolean hasPrevious() {
            return this.f7010a.hasNext();
        }

        @Override // java.util.ListIterator, java.util.Iterator
        public Object next() {
            return this.f7010a.previous();
        }

        @Override // java.util.ListIterator
        public int nextIndex() {
            int Y7;
            Y7 = B.Y(Y.this, this.f7010a.previousIndex());
            return Y7;
        }

        @Override // java.util.ListIterator
        public Object previous() {
            return this.f7010a.next();
        }

        @Override // java.util.ListIterator
        public int previousIndex() {
            int Y7;
            Y7 = B.Y(Y.this, this.f7010a.nextIndex());
            return Y7;
        }
