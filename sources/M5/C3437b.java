...
public final class C3437b {
    ...
    private final Y4.d f35850a;

    /* renamed from: b, reason: collision with root package name */
    private HttpsURLConnection f35851b;

    /* renamed from: c, reason: collision with root package name */
    private OutputStream f35852c;

    /* renamed from: d, reason: collision with root package name */
    private final String f35853d = "--";

    /* renamed from: e, reason: collision with root package name */
    private final String f35854e = "SwA" + System.currentTimeMillis() + "SwA";

    /* renamed from: f, reason: collision with root package name */
    private long f35855f;
    ...
    public final void a(String paramName, String fileName, byte[] bytes, JSONObject jSONObject) {
        ...
        try {
            ...
            OutputStream outputStream = this.f35852c;
            AbstractC3159y.f(outputStream);
            String str3 = this.f35853d + this.f35854e + "\r\n";
            Charset charset = C2728d.f31279b;
            ...
            if (this.f35850a != null) {
                ...
                this.f35850a.send(137, bundle2);
            }
            OutputStream outputStream9 = this.f35852c;
            ...
            if (this.f35850a != null) {
                ...
                this.f35850a.send(137, bundle3);
            }
            OutputStream outputStream10 = this.f35852c;
    ...
    public final long b(String paramName, String fileName, String str, long j8) {
        ...
        try {
            ...
            OutputStream outputStream = this.f35852c;
            AbstractC3159y.f(outputStream);
            String str5 = this.f35853d + this.f35854e + "\r\n";
            Charset charset = C2728d.f31279b;
    ...
    public final void d(URL url, String str) {
        ...
        this.f35851b = httpsURLConnection;
        AbstractC3159y.f(httpsURLConnection);
        httpsURLConnection.setRequestMethod(ShareTarget.METHOD_POST);
        HttpsURLConnection httpsURLConnection2 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection2);
        httpsURLConnection2.setDoInput(true);
        HttpsURLConnection httpsURLConnection3 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection3);
        httpsURLConnection3.setDoOutput(true);
        HttpsURLConnection httpsURLConnection4 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection4);
        httpsURLConnection4.setRequestProperty("Connection", "Keep-Alive");
        HttpsURLConnection httpsURLConnection5 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection5);
        httpsURLConnection5.setRequestProperty("Content-Type", "multipart/form-data; boundary=" + this.f35854e);
        HttpsURLConnection httpsURLConnection6 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection6);
        httpsURLConnection6.setRequestProperty("Accept-Charset", "utf-8");
        HttpsURLConnection httpsURLConnection7 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection7);
        httpsURLConnection7.setRequestProperty("Accept", "application/json");
        HttpsURLConnection httpsURLConnection8 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection8);
        httpsURLConnection8.setRequestProperty("Identificador", "Uptodown_Android");
        HttpsURLConnection httpsURLConnection9 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection9);
        httpsURLConnection9.setRequestProperty("apk_file", str);
        HttpsURLConnection httpsURLConnection10 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection10);
        httpsURLConnection10.setRequestProperty("Identificador-Version", "625");
        HttpsURLConnection httpsURLConnection11 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection11);
        httpsURLConnection11.setRequestProperty("APIKEY", C3307A.f34459a.e());
        C3436a c3436a = new C3436a();
        HttpsURLConnection httpsURLConnection12 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection12);
        httpsURLConnection12.setSSLSocketFactory(c3436a);
        C3327o c3327o = C3327o.f34511a;
        HttpsURLConnection httpsURLConnection13 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection13);
        c3327o.a(httpsURLConnection13);
        HttpsURLConnection httpsURLConnection14 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection14);
        httpsURLConnection14.setFixedLengthStreamingMode((int) this.f35855f);
        HttpsURLConnection httpsURLConnection15 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection15);
        httpsURLConnection15.connect();
        HttpsURLConnection httpsURLConnection16 = this.f35851b;
        AbstractC3159y.f(httpsURLConnection16);
        this.f35852c = httpsURLConnection16.getOutputStream();
    }

    public final void e() {
        if (this.f35850a != null) {
            String str = '\n' + this.f35853d + this.f35854e + this.f35853d;
            Bundle bundle = new Bundle();
        ...
        OutputStream outputStream = this.f35852c;
        AbstractC3159y.f(outputStream);
        byte[] bytes = (this.f35853d + this.f35854e + this.f35853d + "\r\n").getBytes(C2728d.f31279b);
        AbstractC3159y.h(bytes, "getBytes(...)");
        outputStream.write(bytes);
        OutputStream outputStream2 = this.f35852c;
        AbstractC3159y.f(outputStream2);
    ...
    public final I f(boolean z8) {
        ...
        I i8 = new I();
        try {
            HttpsURLConnection httpsURLConnection = this.f35851b;
            AbstractC3159y.f(httpsURLConnection);
            ...
            if (z9 && z8) {
                ...
                while (true) {
                    ...
                    sb.append(new String(bArr, 0, read, C2728d.f31279b));
                }
                i8.i(sb.toString());
                ...
                while (true) {
                    ...
                    sb.append(new String(bArr, 0, read2, C2728d.f31279b));
                }
                i8.i(sb.toString());
            }
            errorStream.close();
    ...
    public final void g(String paramName, String fileName, byte[] bytes) {
        ...
        AbstractC3159y.i(fileName, "fileName");
        AbstractC3159y.i(bytes, "bytes");
        long length = this.f35855f + (this.f35853d + this.f35854e + "\r\n").length();
        this.f35855f = length;
        long j8 = 2;
        long length2 = length + ("Content-Disposition: form-data; name=\"" + paramName + "\"; filename=\"" + fileName + "\"\r\n").length() + 40 + 35 + j8;
        this.f35855f = length2;
        this.f35855f = length2 + ((long) bytes.length) + j8;
    }
    ...
    public final void h(String paramName, String fileName, long j8) {
        ...
        this.f35855f = length;
        long j9 = 2;
        this.f35855f = length + ("Content-Disposition: form-data; name=\"" + paramName + "\"; filename=\"" + fileName + "\"\r\n").length() + 40 + 35 + j9 + j8 + j9;
    }

    public final void i() {
        this.f35855f = this.f35855f + (this.f35853d + this.f35854e + this.f35853d + "\r\n").length();
    }
