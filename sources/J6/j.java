...
public final class j implements s {
    ...
    private volatile I6.g f5516c;

    /* renamed from: d, reason: collision with root package name */
    private Object f5517d;

    /* renamed from: e, reason: collision with root package name */
    private volatile boolean f5518e;
    ...
    private C1164a b(r rVar) {
        ...
        F6.f fVar;
        if (rVar.l()) {
            sSLSocketFactory = this.f5514a.A();
            hostnameVerifier = this.f5514a.n();
            fVar = this.f5514a.d();
        } else {
        ...
        return new C1164a(rVar.k(), rVar.w(), this.f5514a.j(), this.f5514a.z(), sSLSocketFactory, hostnameVerifier, fVar, this.f5514a.v(), this.f5514a.t(), this.f5514a.s(), this.f5514a.g(), this.f5514a.w());
    }
        ...
        if (zVar != null) {
            ...
            if (f8 != 307 && f8 != 308) {
                if (f8 != 401) {
                    if (f8 != 503) {
                        if (f8 != 407) {
                            ...
                            if (t8.type() == Proxy.Type.HTTP) {
                                return this.f5514a.v().a(b8, zVar);
                            }
                    ...
                    return this.f5514a.b().a(b8, zVar);
                }
            } else if (!g8.equals(ShareTarget.METHOD_GET) && !g8.equals("HEAD")) {
                return null;
            }
            if (!this.f5514a.l() || (h8 = zVar.h("Location")) == null || (z8 = zVar.E().i().z(h8)) == null) {
                return null;
            }
            if (!z8.A().equals(zVar.E().i().A()) && !this.f5514a.m()) {
                return null;
            }
            x.a h9 = zVar.E().h();
            if (f.b(g8)) {
    ...
    public z a(s.a aVar) {
        ...
        F6.e b8 = gVar.b();
        o d8 = gVar.d();
        I6.g gVar2 = new I6.g(this.f5514a.f(), b(request.i()), b8, d8, this.f5517d);
        this.f5516c = gVar2;
        z zVar = null;
        int i8 = 0;
        while (!this.f5518e) {
            try {
                ...
                if (i9 <= 20) {
                    ...
                    if (!g(f8, c8.i())) {
                        gVar2.j();
                        gVar2 = new I6.g(this.f5514a.f(), b(c8.i()), b8, d8, this.f5517d);
                        this.f5516c = gVar2;
