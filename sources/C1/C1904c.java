...
public class C1904c {
    ...
    private static final Pattern f14851d = Pattern.compile("[0-9]+s");

    /* renamed from: e, reason: collision with root package name */
    private static final Charset f14852e = Charset.forName(C.UTF8_NAME);

    /* renamed from: a, reason: collision with root package name */
    private final Context f14853a;

    /* renamed from: b, reason: collision with root package name */
    private final Z0.b f14854b;

    /* renamed from: c, reason: collision with root package name */
    private final e f14855c = new e();
    ...
    private String f() {
        try {
            ...
            if (a8 == null) {
                Log.e("ContentValues", "Could not get fingerprint hash for package: " + this.f14853a.getPackageName());
                return null;
            }
            return i.b(a8, false);
        } catch (PackageManager.NameNotFoundException e8) {
            Log.e("ContentValues", "No such package: " + this.f14853a.getPackageName(), e8);
            return null;
        }
    }
    ...
    private HttpURLConnection l(URL url, String str) {
        try {
            ...
            httpURLConnection.addRequestProperty("X-Android-Package", this.f14853a.getPackageName());
            X0.i iVar = (X0.i) this.f14854b.get();
            if (iVar != null) {
                try {
    ...
    static long m(String str) {
        AbstractC1319p.b(f14851d.matcher(str).matches(), "Invalid Expiration Timestamp.");
    ...
    private AbstractC1905d n(HttpURLConnection httpURLConnection) {
        ...
        JsonReader jsonReader = new JsonReader(new InputStreamReader(inputStream, f14852e));
        f.a a8 = f.a();
    ...
    private static String o(HttpURLConnection httpURLConnection) {
        ...
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(errorStream, f14852e));
        try {
            try {
