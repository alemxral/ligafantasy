...
public final class C1913F implements InterfaceC3845a {
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[AbstractC2554a.g.f30146c.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[AbstractC2554a.g.f30147d.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[AbstractC2554a.g.f30150g.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[AbstractC2554a.g.f30148e.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[AbstractC2554a.g.f30149f.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[AbstractC2554a.g.f30151h.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                iArr[AbstractC2554a.g.f30152i.ordinal()] = 7;
    ...
    public AbstractC2554a a(JSONObject json) {
        ...
        AbstractC2554a.g a8 = AbstractC2554a.g.f30145b.a(v2.e.l(json, "type"));
        if (a8 == null || (optJSONObject = json.optJSONObject(a8.b())) == null) {
            return null;
        }
        String l8 = v2.e.l(json, "dynamic_last4");
        switch (b.f14893a[a8.ordinal()]) {
            case 1:
