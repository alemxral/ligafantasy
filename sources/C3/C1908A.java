...
public final class C1908A implements InterfaceC3845a {
    ...
    private static final b f14874b = new b(null);

    /* renamed from: c, reason: collision with root package name */
    private static final Set f14875c = a0.i("card", "sepa_debit");
    ...
    public static final class a implements InterfaceC3845a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final C0366a f14876b = new C0366a(null);
        ...
        public Source.CodeVerification a(JSONObject json) {
            ...
            return new Source.CodeVerification(json.optInt("attempts_remaining", -1), Source.CodeVerification.Status.f24019b.a(v2.e.l(json, NotificationCompat.CATEGORY_STATUS)));
        }
    }
    ...
    public static final class c implements InterfaceC3845a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final a f14877b = new a(null);
    ...
    public static final class d implements InterfaceC3845a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final a f14878b = new a(null);
    ...
    public static final class e implements InterfaceC3845a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final a f14879b = new a(null);
    ...
    public static final class f implements InterfaceC3845a {
        ...
        public Source.Redirect a(JSONObject json) {
            AbstractC3159y.i(json, "json");
            return new Source.Redirect(v2.e.l(json, "return_url"), Source.Redirect.Status.f24037b.a(v2.e.l(json, NotificationCompat.CATEGORY_STATUS)), v2.e.l(json, "url"));
        }
    }
    ...
    public Source a(JSONObject json) {
        ...
        if (AbstractC3159y.d(optString, "card")) {
            return f14874b.d(json);
        }
        if (AbstractC3159y.d(optString, "source")) {
            return f14874b.e(json);
        }
        return null;
    }
}
