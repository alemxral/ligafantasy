...
public final class o implements InterfaceC3845a {
    ...
    public static final b f14919e = new b(null);

    /* renamed from: f, reason: collision with root package name */
    public static final int f14920f = 8;

    /* renamed from: g, reason: collision with root package name */
    private static final v f14921g = new v();

    /* renamed from: b, reason: collision with root package name */
    private final b3.v f14922b;
    ...
    private final j.c.a.InterfaceC0508c i(JSONObject jSONObject) {
        ...
        return j.c.a.InterfaceC0508c.C0509a.f24276a;
    }
    ...
    private final StripeIntent j(String str, JSONObject jSONObject, JSONArray jSONArray, List list, JSONArray jSONArray2, String str2) {
        ...
        if (jSONObject != null) {
            jSONObject2 = jSONObject.optJSONObject(this.f14922b.getType());
        } else {
            jSONObject2 = null;
        }
        if (jSONObject2 == null) {
        ...
        if (vVar instanceof v.a) {
            ...
            if (b8 instanceof i.b.a) {
                return new m(str, (i.b.a) ((v.a) this.f14922b).b().b(), this.f14923c, this.f14924d).a(jSONObject2);
            }
            if (b8 instanceof i.b.C0502b) {
                return new n(str, (i.b.C0502b) ((v.a) this.f14922b).b().b(), this.f14923c, this.f14924d).a(jSONObject2);
            }
            throw new L5.p();
        }
        throw new L5.p();
    ...
    public com.stripe.android.model.j a(JSONObject json) {
        ...
        List a8 = InterfaceC3845a.f38975a.a(json.optJSONArray("unactivated_payment_method_types"));
        ...
        return new com.stripe.android.model.j(new j.d(InterfaceC3845a.f38975a.a(jSONArray), z8, map, z9), str, str2, j8, e8, optString3, c8, !AbstractC3159y.d(optString4, "disabled"), null, 256, null);
    }

    public /* synthetic */ o(b3.v vVar, String str, Function0 function0, int i8, AbstractC3151p abstractC3151p) {
        this(vVar, str, (i8 & 4) != 0 ? a.f14925a : function0);
    }
}
