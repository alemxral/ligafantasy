...
public final class C1912E implements InterfaceC3845a {
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[C1864I.c.f14346c.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[C1864I.c.f14347d.ordinal()] = 2;
    ...
    public C1864I a(JSONObject json) {
        ...
        C1864I.c a8 = C1864I.c.f14345b.a(v2.e.l(json, "type"));
        ...
        int i8 = b.f14891a[a8.ordinal()];
        if (i8 != 1) {
            if (i8 != 2) {
                c1864i = new C1864I(l8, a8, date, f9, f8, null, null, 96, null);
            } else {
                C1864I.c cVar = C1864I.c.f14347d;
            ...
            C1864I.c cVar2 = C1864I.c.f14346c;
