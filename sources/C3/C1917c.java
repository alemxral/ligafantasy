...
public final class C1917c implements InterfaceC3845a {
    ...
    public BankAccount a(JSONObject json) {
        ...
        return new BankAccount(v2.e.l(json, "id"), v2.e.l(json, "account_holder_name"), BankAccount.Type.f23988b.a(v2.e.l(json, "account_holder_type")), v2.e.l(json, "bank_name"), v2.e.f38770a.g(json, "country"), v2.e.h(json, "currency"), v2.e.l(json, "fingerprint"), v2.e.l(json, "last4"), v2.e.l(json, "routing_number"), BankAccount.Status.f23979b.a(v2.e.l(json, NotificationCompat.CATEGORY_STATUS)));
    }
}
