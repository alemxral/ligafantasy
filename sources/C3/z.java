...
public final class z implements InterfaceC3845a {
    ...
    public SourceTypeModel.Card a(JSONObject json) {
        ...
        EnumC1870e a8 = C1869d.f14401v.a(v2.e.l(json, "brand"));
        String l10 = v2.e.l(json, "country");
        String l11 = v2.e.l(json, "cvc_check");
        String l12 = v2.e.l(json, "dynamic_last4");
        v2.e eVar = v2.e.f38770a;
        return new SourceTypeModel.Card(l8, l9, a8, l10, l11, l12, eVar.i(json, "exp_month"), eVar.i(json, "exp_year"), EnumC1871f.f14448b.a(v2.e.l(json, "funding")), v2.e.l(json, "last4"), SourceTypeModel.Card.ThreeDSecureStatus.f24102b.a(v2.e.l(json, "three_d_secure")), K.f14357b.a(v2.e.l(json, "tokenization_method")));
    }
}
