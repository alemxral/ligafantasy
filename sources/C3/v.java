...
public final class v implements InterfaceC3845a {
    ...
    private static final e f14945b = new e(null);

    /* loaded from: classes4.dex */
    public static final class a implements InterfaceC3845a {

        /* renamed from: b, reason: collision with root package name */
        private static final C0370a f14946b = new C0370a(null);
    ...
    public static final class d implements InterfaceC3845a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final b f14949b = new b(null);

        /* loaded from: classes4.dex */
        public static final class a implements InterfaceC3845a {

            /* renamed from: b, reason: collision with root package name */
            private static final C0371a f14950b = new C0371a(null);
        ...
        public static final class c implements InterfaceC3845a {
            ...
            public o.g.c a(JSONObject json) {
                AbstractC3159y.i(json, "json");
                List a8 = v2.e.f38770a.a(json.optJSONArray("available"));
                if (a8 == null) {
                    a8 = AbstractC1246t.m();
                }
                List list = a8;
                ...
                return new o.g.c(AbstractC1246t.b1(arrayList), v2.e.f38770a.f(json, "selection_mandatory"), v2.e.l(json, "preferred"));
            }
        }
        ...
        public static final class C0372d implements InterfaceC3845a {
            ...
            public o.g.d a(JSONObject json) {
                AbstractC3159y.i(json, "json");
                return new o.g.d(v2.e.f38770a.f(json, "supported"));
            }
        }
        ...
        public o.g a(JSONObject json) {
            ...
            o.g.c cVar;
            AbstractC3159y.i(json, "json");
            EnumC1870e b8 = EnumC1870e.f14423m.b(v2.e.l(json, "brand"));
    ...
    public static final class g implements InterfaceC3845a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final a f14954b = new a(null);
    ...
    public static final class k implements InterfaceC3845a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final a f14958b = new a(null);
    ...
    public static final class l implements InterfaceC3845a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final a f14959b = new a(null);
    ...
    public /* synthetic */ class m {
        ...
        static {
            ...
            try {
                iArr[o.p.f24520j.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[o.p.f24522l.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[o.p.f24521k.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[o.p.f24523m.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[o.p.f24524n.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                iArr[o.p.f24525o.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                iArr[o.p.f24526p.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                iArr[o.p.f24527q.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                iArr[o.p.f24495A.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                iArr[o.p.f24509O.ordinal()] = 11;
    ...
    public com.stripe.android.model.o a(JSONObject json) {
        ...
        o.p a8 = o.p.f24517g.a(l8);
        o.f i9 = new o.f().l(v2.e.l(json, "id")).r(a8).h(l8).i(v2.e.f38770a.j(json, "created"));
        ...
        if (a8 == null) {
            ...
            i8 = m.f14960a[a8.ordinal()];
        }
        switch (i8) {
            case 1:
                JSONObject optJSONObject2 = json.optJSONObject(a8.f24537a);
                if (optJSONObject2 != null) {
            ...
            case 2:
                ...
                break;
            case 3:
                JSONObject optJSONObject3 = json.optJSONObject(a8.f24537a);
                if (optJSONObject3 != null) {
                ...
                break;
            case 4:
                JSONObject optJSONObject4 = json.optJSONObject(a8.f24537a);
                if (optJSONObject4 != null) {
                ...
                break;
            case 5:
                JSONObject optJSONObject5 = json.optJSONObject(a8.f24537a);
                ...
                break;
            case 6:
                JSONObject optJSONObject6 = json.optJSONObject(a8.f24537a);
                ...
                break;
            case 7:
                JSONObject optJSONObject7 = json.optJSONObject(a8.f24537a);
                ...
                break;
            case 8:
                JSONObject optJSONObject8 = json.optJSONObject(a8.f24537a);
                ...
                break;
            case 9:
                JSONObject optJSONObject9 = json.optJSONObject(a8.f24537a);
                ...
                break;
            case 10:
                JSONObject optJSONObject10 = json.optJSONObject(a8.f24537a);
                ...
                break;
            case 11:
                JSONObject optJSONObject11 = json.optJSONObject(a8.f24537a);
