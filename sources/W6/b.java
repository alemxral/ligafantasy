...
public class b extends AbstractC1346m {
    ...
    private C1344k f12148a;

    /* renamed from: b, reason: collision with root package name */
    private X6.a f12149b;

    /* renamed from: c, reason: collision with root package name */
    private AbstractC1348o f12150c;

    /* renamed from: d, reason: collision with root package name */
    private AbstractC1355w f12151d;

    /* renamed from: e, reason: collision with root package name */
    private AbstractC1331b f12152e;
    ...
    private b(AbstractC1353u abstractC1353u) {
        ...
        this.f12148a = x8;
        int s8 = s(x8);
        this.f12149b = X6.a.p(y8.nextElement());
        this.f12150c = AbstractC1348o.x(y8.nextElement());
        int i8 = -1;
        while (y8.hasMoreElements()) {
            ...
            if (y9 == 0) {
                this.f12151d = AbstractC1355w.x(abstractC1358z, false);
            } else {
                if (y9 != 1) {
                ...
                this.f12152e = Q.B(abstractC1358z, false);
            }
            i8 = y9;
        }
    }
    ...
    public AbstractC1351s d() {
        ...
        c1337e.a(this.f12148a);
        c1337e.a(this.f12149b);
        c1337e.a(this.f12150c);
        AbstractC1355w abstractC1355w = this.f12151d;
        if (abstractC1355w != null) {
            c1337e.a(new h0(false, 0, abstractC1355w));
        }
        AbstractC1331b abstractC1331b = this.f12152e;
    ...
    public InterfaceC1335d t() {
        return AbstractC1351s.s(this.f12150c.y());
    }
    ...
    public b(X6.a aVar, InterfaceC1335d interfaceC1335d, AbstractC1355w abstractC1355w, byte[] bArr) {
        this.f12148a = new C1344k(bArr != null ? E7.b.f2388b : E7.b.f2387a);
        this.f12149b = aVar;
        this.f12150c = new C1330a0(interfaceC1335d);
        this.f12151d = abstractC1355w;
        this.f12152e = bArr == null ? null : new Q(bArr);
    }
}
