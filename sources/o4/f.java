...
public final class f {
    ...
    public static final class a extends AbstractC3160z implements n {
        ...
        final /* synthetic */ o4.c f36505b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ long f36506c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ long f36507d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ o f36508e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ boolean f36509f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ r f36510g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f36511h;
        ...
        public final void invoke(Composer composer, int i8) {
            f.this.a(this.f36505b, this.f36506c, this.f36507d, this.f36508e, this.f36509f, this.f36510g, composer, RecomposeScopeImplKt.updateChangedFlags(this.f36511h | 1));
        }
    }
    ...
    public static final class d extends AbstractC3160z implements o {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final d f36514a = new d();
    ...
    public static final class e extends AbstractC3160z implements o {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final e f36515a = new e();
        ...
        public final FiniteAnimationSpec invoke(Transition.Segment animateFloat, Composer composer, int i8) {
            ...
            o4.c cVar = o4.c.f36467a;
            o4.c cVar2 = o4.c.f36468b;
            if (animateFloat.isTransitioningTo(cVar, cVar2)) {
                tween = AnimationSpecKt.tween$default(67, 0, EasingKt.getLinearEasing(), 2, null);
            } else if (!animateFloat.isTransitioningTo(cVar2, cVar) && !animateFloat.isTransitioningTo(o4.c.f36469c, cVar2)) {
    ...
    public /* synthetic */ class C0843f {
        ...
        static {
            ...
            try {
                iArr[o4.c.f36467a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[o4.c.f36468b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[o4.c.f36469c.ordinal()] = 3;
