...
public abstract class a {
    ...
    public static int f7777b = 20000;
    ...
    class C0165a extends Q4.a {
        ...
        public void c(int i8, String str) {
            if (i8 == 158) {
                this.f7778p.addAll(Arrays.asList(str.split(" ")));
            }
            super.c(i8, str);
        }
    }
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f7779a[c.ERROR.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f7779a[c.DEBUG.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f7779a[c.WARN.ordinal()] = 4;
    ...
    private static void a(Q4.b bVar, Q4.a aVar) {
        while (!aVar.i()) {
            ...
            e("RootShell v1.4", "Processed " + aVar.f8251d + " of " + aVar.f8250c + " output from command.");
            synchronized (aVar) {
                try {
                    if (!aVar.i()) {
    ...
    public static void f(String str, String str2, c cVar, Exception exc) {
        if (str2 != null && !str2.equals("") && f7776a) {
            if (str == null) {
                str = "RootShell v1.4";
            }
            int i8 = b.f7779a[cVar.ordinal()];
            if (i8 != 1) {
                if (i8 != 2) {
                    if (i8 != 3) {
                        if (i8 == 4) {
