...
public final class e implements S0.e, g {
    ...
    private e w(String str, Object obj) {
        y();
        this.f11052c.name(str);
        if (obj == null) {
            this.f11052c.nullValue();
            return this;
        }
        return k(obj, false);
    }
    ...
    private void y() {
        if (this.f11051b) {
            ...
            if (eVar != null) {
                eVar.y();
                this.f11050a.f11051b = false;
                this.f11050a = null;
                this.f11052c.endObject();
                return;
            }
            return;
        }
    ...
    public e h(double d8) {
        y();
        this.f11052c.value(d8);
        return this;
    }

    public e i(int i8) {
        y();
        this.f11052c.value(i8);
        return this;
    }

    public e j(long j8) {
        y();
        this.f11052c.value(j8);
        return this;
    }
    ...
    public e k(Object obj, boolean z8) {
        ...
        if (obj.getClass().isArray()) {
            ...
            this.f11052c.beginArray();
            if (obj instanceof int[]) {
                int length = ((int[]) obj).length;
                while (i8 < length) {
                    this.f11052c.value(r7[i8]);
                    i8++;
                }
        ...
        S0.d dVar = (S0.d) this.f11053d.get(obj.getClass());
        if (dVar != null) {
            return v(dVar, obj, z8);
        }
        S0.f fVar = (S0.f) this.f11054e.get(obj.getClass());
        if (fVar != null) {
            fVar.a(obj, this);
            return this;
        }
    ...
    public e s(byte[] bArr) {
        ...
        if (bArr == null) {
            ...
            this.f11052c.value(Base64.encodeToString(bArr, 2));
        }
        return this;
    }
