...
public final class o {
    ...
    public static final class b extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f9582a == 0) {
                t.b(obj);
                if (!SettingsPreferences.f29309b.m0(o.this.f9579a)) {
                    C3326n a8 = C3326n.f34490t.a(o.this.f9579a);
                    a8.a();
                    ...
                    while (it.hasNext()) {
                        ...
                        if (g6.n.t(yVar.a(), "upcoming_release", false, 2, null) && yVar.b() != null) {
                            ...
                            if (j8 > 0 && a8.t0(j8) == null) {
                                X4.I Q8 = new C3312F(o.this.f9579a).Q(j8);
                                if (!Q8.b() && Q8.d() != null) {
                                    String d8 = Q8.d();
                                    AbstractC3159y.f(d8);
                                    ...
                                    if (!jSONObject2.isNull("success")) {
                                        ...
                                        if (i8 == 1 && jSONObject != null) {
                                            c1498h = C1498h.f12529L0.a(jSONObject);
                                        }
                                    }
                                }
                                if (c1498h != null && c1498h.i() > 0 && c1498h.s0() != null) {
                                    ...
                                    new D(i9, s02, c1498h.m0(), c1498h.e()).h(o.this.f9579a);
                                    a8.H(yVar.c());
                                    Bundle bundle = new Bundle();
                                    bundle.putString("type", "recovered");
                                    new C3330r(o.this.f9579a).b("upcoming_release", bundle);
                                }
                            }
                        }
                    }
                    a8.g();
                    SettingsPreferences.f29309b.g1(o.this.f9579a, true);
                }
                return I.f6474a;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
