...
public final class C3750b {
    ...
    private static final a f37850b = new a(null);

    /* renamed from: c, reason: collision with root package name */
    public static final int f37851c = 8;

    /* renamed from: a, reason: collision with root package name */
    private final InterfaceC1227k f37852a;
    ...
    static final class c extends AbstractC3160z implements Function0 {
        ...
        public final J1.a invoke() {
            try {
                return J1.a.G(C3750b.this.f(this.f37855b, this.f37856c), 1, 1, this.f37857d);
    ...
    public C3750b(Context context, String cacheFolder, long j8) {
        ...
        this.f37852a = l.b(new c(context, cacheFolder, j8));
    }

    private final Bitmap.CompressFormat b(String str) {
        Bitmap.CompressFormat b8;
        EnumC3752d a8 = EnumC3752d.f37860c.a(str);
    ...
    private final J1.a g() {
        return (J1.a) this.f37852a.getValue();
    }

    private final int i(Bitmap.CompressFormat compressFormat) {
        int i8 = C0875b.f37853a[compressFormat.ordinal()];
        if (i8 == 1) {
            return 80;
        }
        if (i8 != 2) {
