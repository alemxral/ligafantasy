...
public final class q {
    ...
    private final C1504n f9591b;

    /* renamed from: c, reason: collision with root package name */
    private final M f9592c;
    ...
    public static final class b extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f9595a == 0) {
                t.b(obj);
                String d8 = new C3312F(q.this.f9590a).O0(q.this.f9591b, q.this.f9592c, null).d();
                if (d8 != null && d8.length() != 0) {
                    try {
                        ...
                        SettingsPreferences.f29309b.X0(q.this.f9590a, z8);
                    } catch (JSONException e8) {
                        e8.printStackTrace();
                        SettingsPreferences.f29309b.X0(q.this.f9590a, false);
                    }
                }
                return I.f6474a;
            }
    ...
    public q(Context context, C1504n deviceInfo, M settingsUTD) {
        ...
        this.f9590a = context;
        this.f9591b = deviceInfo;
        this.f9592c = settingsUTD;
