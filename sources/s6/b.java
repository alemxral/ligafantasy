...
public abstract class b {
    ...
    public static final class a implements InterfaceC3674e {
        ...
        final /* synthetic */ InterfaceC2837o f38014a;

        a(InterfaceC2837o interfaceC2837o) {
            this.f38014a = interfaceC2837o;
        }
        ...
        public final void a(Task task) {
            ...
            if (i8 == null) {
                if (task.l()) {
                    InterfaceC2837o.a.a(this.f38014a, null, 1, null);
                    return;
                }
                InterfaceC2837o interfaceC2837o = this.f38014a;
                s.a aVar = s.f6498b;
                interfaceC2837o.resumeWith(s.b(task.j()));
                return;
            }
            InterfaceC2837o interfaceC2837o2 = this.f38014a;
            s.a aVar2 = s.f6498b;
    ...
    private static final Object b(Task task, AbstractC3670a abstractC3670a, d dVar) {
        ...
        c2839p.B();
        task.b(ExecutorC3762a.f38013a, new a(c2839p));
        Object y8 = c2839p.y();
        if (y8 == Q5.b.e()) {
            h.c(dVar);
        }
