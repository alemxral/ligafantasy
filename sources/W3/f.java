...
public final class f {
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[z0.d.f30890f.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[z0.d.f30886b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[z0.d.f30887c.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[z0.d.f30888d.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[z0.d.f30889e.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[z0.d.f30891g.ordinal()] = 6;
    ...
    static final class b implements InterfaceC3359g {
        ...
        public final Object emit(String str, P5.d dVar) {
            ...
            if ((str2 == null || n.u(str2)) && (s8 = this.f39030a) != null && (i8 = s8.i()) != null && (y8 = i8.y()) != null) {
                y8.r(str);
            }
            return I.f6474a;
        }
    ...
    public final void c(List placeholderFields, AbstractC2608f0 spec) {
        ...
        if (spec instanceof w0) {
            placeholderFields.remove(z0.d.f30886b);
            return;
        }
        if (spec instanceof Y) {
            placeholderFields.remove(z0.d.f30887c);
            return;
        }
        if (spec instanceof y0) {
            placeholderFields.remove(z0.d.f30888d);
            return;
        }
        if (spec instanceof C2597a) {
            placeholderFields.remove(z0.d.f30889e);
            return;
        }
        if (spec instanceof G0) {
            placeholderFields.remove(z0.d.f30891g);
            return;
        }
        if (spec instanceof z0) {
            z0 z0Var = (z0) spec;
            if (a.f39029a[z0Var.j().ordinal()] == 1) {
                placeholderFields.remove(z0.d.f30889e);
            } else {
    ...
    public final AbstractC2608f0 d(z0.d field, List placeholderOverrideList, boolean z8, u.d configuration) {
        ...
        switch (a.f39029a[field.ordinal()]) {
            ...
            case 2:
                ...
                c2597a = w0Var;
                if (configuration.n() != u.d.b.f26385c) {
                    if (!placeholderOverrideList.contains(w0Var.i())) {
                        return null;
                    }
                    c2597a = w0Var;
                    if (configuration.n() == u.d.b.f26384b) {
                        return null;
                    }
                }
                break;
            case 3:
                ...
                c2597a = y8;
                if (configuration.k() != u.d.b.f26385c) {
                    if (!placeholderOverrideList.contains(y8.f())) {
                        return null;
                    }
                    c2597a = y8;
                    if (configuration.k() == u.d.b.f26384b) {
                        return null;
                    }
                }
                break;
            case 4:
                ...
                c2597a = y0Var;
                if (configuration.o() != u.d.b.f26385c) {
                    if (!placeholderOverrideList.contains(y0Var.f())) {
                        return null;
                    }
                    c2597a = y0Var;
                    if (configuration.o() == u.d.b.f26384b) {
                        return null;
                    }
                }
                break;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x005f, code lost:
        ...
        if (r10.k() == com.stripe.android.paymentsheet.u.d.b.f26384b) goto L9;
     */
    /* JADX WARN: Code restructure failed: missing block: B:22:0x006c, code lost:
    
        if (r10.o() == com.stripe.android.paymentsheet.u.d.b.f26384b) goto L9;
     */
    /* JADX WARN: Code restructure failed: missing block: B:26:0x0079, code lost:
    
        if (r10.b() == com.stripe.android.paymentsheet.u.d.a.f26379b) goto L9;
     */
    /* JADX WARN: Code restructure failed: missing block: B:7:0x0051, code lost:
    
        if (r10.n() == com.stripe.android.paymentsheet.u.d.b.f26384b) goto L9;
     */
    ...
    */
    public final java.util.List f(java.util.List r7, java.util.List r8, boolean r9, com.stripe.android.paymentsheet.u.d r10) {
        /*
            ...
            e4.z0$d r1 = e4.z0.d.f30886b
            r2 = 0
            r0[r2] = r1
            e4.z0$d r1 = e4.z0.d.f30887c
            r2 = 1
            r0[r2] = r1
            e4.z0$d r1 = e4.z0.d.f30888d
            r2 = 2
            r0[r2] = r1
            e4.z0$d r1 = e4.z0.d.f30889e
            r2 = 3
            r0[r2] = r1
        ...
        L35:
            ...
            w3.f r3 = w3.f.f39028a
            r3.c(r0, r2)
            boolean r4 = r2 instanceof e4.w0
            r5 = 0
            if (r4 == 0) goto L55
            com.stripe.android.paymentsheet.u$d$b r3 = r10.n()
            com.stripe.android.paymentsheet.u$d$b r4 = com.stripe.android.paymentsheet.u.d.b.f26384b
            if (r3 != r4) goto L8a
        L53:
            r2 = r5
            goto L8a
        ...
        L6f:
            ...
            com.stripe.android.paymentsheet.u$d$a r4 = com.stripe.android.paymentsheet.u.d.a.f26379b
            if (r3 != r4) goto L8a
            goto L53
        L7c:
