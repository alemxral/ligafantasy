...
public final class C3846a {
    ...
    private final InterfaceC3358f f38979a;

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC3358f f38980b;

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC3358f f38981c;

    /* renamed from: d, reason: collision with root package name */
    private final Map f38982d;
    ...
    static final class C0902a extends l implements p {
        ...
        public final Object invoke(Map map, Set set, AbstractC3991f.a aVar, P5.d dVar) {
            ...
            c0902a.f38985c = set;
            c0902a.f38986d = aVar;
            return c0902a.invokeSuspend(I.f6474a);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f38983a == 0) {
                t.b(obj);
                Map map = (Map) this.f38984b;
                Set set = (Set) this.f38985c;
                AbstractC3991f.a aVar = (AbstractC3991f.a) this.f38986d;
                C3846a c3846a = C3846a.this;
                return c3846a.d(map, set, aVar, c3846a.f38982d);
            }
    ...
    public C3846a(InterfaceC3358f currentFieldValueMap, InterfaceC3358f hiddenIdentifiers, InterfaceC3358f userRequestedReuse, Map defaultValues) {
        ...
        this.f38979a = currentFieldValueMap;
        this.f38980b = hiddenIdentifiers;
        this.f38981c = userRequestedReuse;
        this.f38982d = defaultValues;
    }
    ...
    public final InterfaceC3358f c() {
        return AbstractC3360h.j(this.f38979a, this.f38980b, this.f38981c, new C0902a(null));
    }
}
