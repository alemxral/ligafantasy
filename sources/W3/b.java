...
public final class b implements W3.a {
    ...
    private static final a f11989g = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private final p f11990a;

    /* renamed from: b, reason: collision with root package name */
    private final Z3.b f11991b;

    /* renamed from: c, reason: collision with root package name */
    private final c f11992c;

    /* renamed from: d, reason: collision with root package name */
    private final t f11993d;

    /* renamed from: e, reason: collision with root package name */
    private final l f11994e;
    ...
    public b(p messageVersionRegistry, Z3.b imageCache, c errorReporter, t transactionFactory, l publicKeyFactory, List warnings) {
        ...
        this.f11990a = messageVersionRegistry;
        this.f11991b = imageCache;
        this.f11992c = errorReporter;
        this.f11993d = transactionFactory;
        this.f11994e = publicKeyFactory;
        this.f11995f = warnings;
    }

    private final s b(String str, String str2, boolean z8, String str3, List list, PublicKey publicKey, String str4, q qVar) {
        String str5 = str2;
        if (!this.f11990a.b(str2)) {
            if (str5 == null) {
                str5 = "";
            }
            throw new R3.a("Message version is unsupported: " + str5, null, 2, null);
        }
        return this.f11993d.a(str, list, publicKey, str4, qVar, z8, com.stripe.android.stripe3ds2.views.a.f26988e.a(str3, this.f11992c));
    }
    ...
    public b(Context context, String sdkReferenceNumber, boolean z8, g workContext) {
        this(context, b.a.f13388a, sdkReferenceNumber, z8, workContext);
        AbstractC3159y.i(context, "context");
    ...
    */
    private b(android.content.Context r13, Z3.b r14, java.lang.String r15, boolean r16, P5.g r17) {
        /*
            ...
            com.stripe.android.stripe3ds2.transaction.o$a r0 = com.stripe.android.stripe3ds2.transaction.o.f26879a
            r2 = r16
