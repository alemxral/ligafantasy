...
public final class C2705b {
    ...
    private C2704a f31166c;

    /* renamed from: d, reason: collision with root package name */
    private ConnectivityManager.NetworkCallback f31167d;
    ...
    public static final class C0746b extends ConnectivityManager.NetworkCallback {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Handler f31168a = new Handler(Looper.getMainLooper());
    ...
    public final void a() {
        if (Build.VERSION.SDK_INT >= 24) {
            ConnectivityManager.NetworkCallback networkCallback = this.f31167d;
            if (networkCallback == null) {
                return;
            }
            Object systemService = this.f31164a.getSystemService("connectivity");
            AbstractC3159y.g(systemService, "null cannot be cast to non-null type android.net.ConnectivityManager");
            ((ConnectivityManager) systemService).unregisterNetworkCallback(networkCallback);
        } else {
            C2704a c2704a = this.f31166c;
            if (c2704a == null) {
                return;
            }
            try {
                s.a aVar = s.f6498b;
                this.f31164a.unregisterReceiver(c2704a);
                s.b(I.f6474a);
            } catch (Throwable th) {
                s.a aVar2 = s.f6498b;
                s.b(t.a(th));
