...
public final class r implements ViewBinding {
    ...
    public final ShippingInfoWidget f3159b;

    private r(ScrollView scrollView, ShippingInfoWidget shippingInfoWidget) {
        this.f3158a = scrollView;
        this.f3159b = shippingInfoWidget;
    }

    public static r a(View view) {
        int i8 = AbstractC3049A.f32737O;
    ...
    public static r c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z8) {
        View inflate = layoutInflater.inflate(AbstractC3051C.f32808u, viewGroup, false);
        if (z8) {
