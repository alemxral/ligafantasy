...
public final class m implements ViewBinding {
    ...
    private final FrameLayout f3139a;

    /* renamed from: b, reason: collision with root package name */
    public final MaskedCardView f3140b;

    private m(FrameLayout frameLayout, MaskedCardView maskedCardView) {
        this.f3139a = frameLayout;
        this.f3140b = maskedCardView;
    }

    public static m a(View view) {
        int i8 = AbstractC3049A.f32727E;
    ...
    public static m c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z8) {
        View inflate = layoutInflater.inflate(AbstractC3051C.f32802o, viewGroup, false);
        if (z8) {
