...
public final class e implements ViewBinding {
    ...
    private final LinearLayout f3095a;

    /* renamed from: b, reason: collision with root package name */
    public final AppCompatTextView f3096b;

    private e(LinearLayout linearLayout, AppCompatTextView appCompatTextView) {
        this.f3095a = linearLayout;
        this.f3096b = appCompatTextView;
    }

    public static e a(View view) {
        int i8 = AbstractC3049A.f32726D;
    ...
    public static e c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z8) {
        View inflate = layoutInflater.inflate(AbstractC3051C.f32792e, viewGroup, false);
        if (z8) {
