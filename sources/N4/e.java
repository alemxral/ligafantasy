...
public final class e {
    ...
    public static final class a extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            return new a(this.f7190b, this.f7191c, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f7189a == 0) {
                L5.t.b(obj);
                Toast.makeText(this.f7190b, this.f7191c, 0).show();
                return I.f6474a;
            }
    ...
    public static final class c extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f7196a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(Function0 function0) {
            super(0);
            this.f7196a = function0;
        }
    ...
    public static final class d extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f7197a;
    ...
    public static final class C0153e extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new C0153e(this.f7199b, this.f7200c, this.f7201d, dVar);
        }

        @Override // X5.n
        public final Object invoke(M m8, P5.d dVar) {
            return ((C0153e) create(m8, dVar)).invokeSuspend(I.f6474a);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f7198a == 0) {
                L5.t.b(obj);
                Toast.makeText(this.f7199b, this.f7200c, 0).show();
                this.f7201d.invoke();
                return I.f6474a;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    */
    ...
    public final boolean l(String name) {
        ...
        if ((!g6.n.r(name, ".apk", false, 2, null) && !w.f7268b.a(name)) || g6.n.C(name, ".", false, 2, null)) {
            return false;
        }
        return true;
    }
