...
public abstract class AbstractC3470f {
    ...
    public static final class a extends l implements n {
        ...
        final /* synthetic */ C3471g f36135b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function0 f36136c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(C3471g c3471g, Function0 function0, P5.d dVar) {
            super(2, dVar);
            this.f36135b = c3471g;
            this.f36136c = function0;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new a(this.f36135b, this.f36136c, dVar);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r5) {
            ...
            L37:
                ...
                n4.g$a r0 = n4.C3471g.a.f36151b
                if (r5 != r0) goto L42
                kotlin.jvm.functions.Function0 r5 = r4.f36136c
                r5.invoke()
            L42:
                L5.I r5 = L5.I.f6474a
                return r5
    ...
    public static final class c extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ C3471g f36138a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C3468d f36139b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Modifier f36140c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function0 f36141d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ n f36142e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ int f36143f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f36144g;
        ...
        c(C3471g c3471g, C3468d c3468d, Modifier modifier, Function0 function0, n nVar, int i8, int i9) {
            ...
            this.f36138a = c3471g;
            this.f36139b = c3468d;
            this.f36140c = modifier;
            this.f36141d = function0;
            this.f36142e = nVar;
            this.f36143f = i8;
            this.f36144g = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            AbstractC3470f.a(this.f36138a, this.f36139b, this.f36140c, this.f36141d, this.f36142e, composer, RecomposeScopeImplKt.updateChangedFlags(this.f36143f | 1), this.f36144g);
        }
    }
    ...
    public static final void a(C3471g state, C3468d layoutInfo, Modifier modifier, Function0 onDismissed, n sheetContent, Composer composer, int i8, int i9) {
        ...
        EffectsKt.LaunchedEffect(I.f6474a, new a(state, onDismissed, null), startRestartGroup, 70);
        ...
        ModalBottomSheetKt.m1277ModalBottomSheetLayoutGs3lGvM(ComposableLambdaKt.composableLambda(startRestartGroup, 1959122039, true, new b(sheetContent)), imePadding, state.b(), false, layoutInfo.c(), m5178constructorimpl, b8, 0L, a8, C3465a.f36121a.a(), startRestartGroup, (ModalBottomSheetState.$stable << 6) | 805506054, 128);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
