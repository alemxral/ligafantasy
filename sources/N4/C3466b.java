...
public final class C3466b {
    ...
    public static final int f36124c = TextInputService.$stable;

    /* renamed from: a, reason: collision with root package name */
    private final TextInputService f36125a;

    /* renamed from: b, reason: collision with root package name */
    private final State f36126b;
    ...
    public static final class a extends AbstractC3160z implements Function0 {
        ...
        public final Boolean invoke() {
            return (Boolean) C3466b.this.f36126b.getValue();
        }
    }
    ...
    public static final class C0833b extends l implements n {
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            ...
            c0833b.f36129b = ((Boolean) obj).booleanValue();
            return c0833b;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f36128a == 0) {
                t.b(obj);
                return kotlin.coroutines.jvm.internal.b.a(!this.f36129b);
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }

        public final Object invoke(boolean z8, P5.d dVar) {
            return ((C0833b) create(Boolean.valueOf(z8), dVar)).invokeSuspend(I.f6474a);
        }
    }
    ...
    public C3466b(TextInputService textInputService, State isKeyboardVisible) {
        ...
        this.f36125a = textInputService;
        this.f36126b = isKeyboardVisible;
    }
    ...
    public final Object c(P5.d dVar) {
        if (((Boolean) this.f36126b.getValue()).booleanValue()) {
            TextInputService textInputService = this.f36125a;
