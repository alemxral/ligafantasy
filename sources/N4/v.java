...
public final class v {
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f7265a == 0) {
                L5.t.b(obj);
                try {
                    if (new G4.a(v.this.f7259a).s()) {
                        v.this.g(this.f7267c);
                        i8 = I.f6474a;
                    } else {
                        J4.a aVar = v.this.f7260b;
                        if (aVar != null) {
                            aVar.f(this.f7267c.getPath());
                            i8 = I.f6474a;
                        } else {
                            i8 = null;
                        }
    ...
    public final void g(File file) {
        try {
            PackageManager pm = this.f7259a.getPackageManager();
            ...
            if (c8 != null) {
                ...
                J4.a aVar3 = this.f7260b;
                if (aVar3 != null) {
                    String name2 = file.getName();
                    AbstractC3159y.h(name2, "apkFile.name");
                    aVar3.a(name2);
                }
                j.a aVar4 = E4.j.f2272g;
                if (aVar4.s() != null) {
            ...
            J4.a aVar5 = this.f7260b;
            if (aVar5 != null) {
                String name3 = file.getName();
                AbstractC3159y.h(name3, "apkFile.name");
                aVar5.d(name3);
            }
            j.a aVar6 = E4.j.f2272g;
            if (aVar6.s() != null) {
            ...
            j.a aVar7 = E4.j.f2272g;
            aVar7.e();
            J4.a aVar8 = this.f7260b;
            if (aVar8 != null) {
            ...
            j.a aVar9 = E4.j.f2272g;
            aVar9.e();
            J4.a aVar10 = this.f7260b;
            if (aVar10 != null) {
    ...
    public final boolean e() {
        PackageManager pm = this.f7259a.getPackageManager();
        int checkPermission = pm.checkPermission("android.permission.INSTALL_PACKAGES", this.f7259a.getPackageName());
        int checkPermission2 = pm.checkPermission("android.permission.DELETE_PACKAGES", this.f7259a.getPackageName());
        if (checkPermission == 0 && checkPermission2 == 0) {
            return true;
        }
        try {
            AbstractC3159y.h(pm, "pm");
            String packageName = this.f7259a.getPackageName();
