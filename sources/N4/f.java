...
public final class f {
    ...
    public final File c(Context context) {
        ...
        if (externalStorageDirectory != null) {
            File file = new File(externalStorageDirectory.getAbsolutePath() + '/' + context.getResources().getString(E4.h.f2230c) + "/Backups");
            if (!file.exists()) {
                file.mkdirs();
            }
            return file;
    ...
    public final boolean o(String path) {
        ...
        if (!g6.n.r(path, ".apk", false, 2, null) && !w.f7268b.a(path)) {
            return false;
        }
        return true;
    }
