...
public final class C3115g {
    ...
    private static boolean f33369b;

    /* renamed from: a, reason: collision with root package name */
    public static final C3115g f33368a = new C3115g();
    ...
    public static final class a extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ SavedStateHandle f33371a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(SavedStateHandle savedStateHandle) {
            super(0);
            this.f33371a = savedStateHandle;
        }
    ...
    private final void g(SavedStateHandle savedStateHandle) {
        ...
        if (!f33369b) {
            ...
            parcelable = InterfaceC3113e.a.f33365a;
        }
