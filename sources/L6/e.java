...
public abstract class e {
    ...
    static final C1282h f6559a = C1282h.f("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");

    /* renamed from: b, reason: collision with root package name */
    private static final String[] f6560b = {"DATA", "HEADERS", "PRIORITY", "RST_STREAM", "SETTINGS", "PUSH_PROMISE", "PING", "GOAWAY", "WINDOW_UPDATE", "CONTINUATION"};

    /* renamed from: c, reason: collision with root package name */
    static final String[] f6561c = new String[64];

    /* renamed from: d, reason: collision with root package name */
    static final String[] f6562d = new String[256];

    static {
        int i8 = 0;
        int i9 = 0;
        while (true) {
            String[] strArr = f6562d;
            if (i9 >= strArr.length) {
                break;
            }
