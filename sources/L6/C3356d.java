...
public class C3356d extends m6.e {
    ...
    protected m6.e i(P5.g gVar, int i8, EnumC3132a enumC3132a) {
        return new C3356d(this.f34617d, gVar, i8, enumC3132a);
    }

    @Override // m6.e
    public String toString() {
        return "block[" + this.f34617d + "] -> " + super.toString();
    }
