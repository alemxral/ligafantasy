...
public abstract /* synthetic */ class AbstractC3363k {
    ...
    public static final class a extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        final /* synthetic */ InterfaceC3358f f34635b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(InterfaceC3358f interfaceC3358f, P5.d dVar) {
            super(2, dVar);
            this.f34635b = interfaceC3358f;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new a(this.f34635b, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                L5.t.b(obj);
                InterfaceC3358f interfaceC3358f = this.f34635b;
                this.f34634a = 1;
    ...
    public static final Object a(InterfaceC3358f interfaceC3358f, P5.d dVar) {
        Object collect = interfaceC3358f.collect(m6.r.f35919a, dVar);
        if (collect == Q5.b.e()) {
            return collect;
        }
        return L5.I.f6474a;
