...
public final class C3352N extends m6.d {
    ...
    private static final AtomicReferenceFieldUpdater f34603a = AtomicReferenceFieldUpdater.newUpdater(C3352N.class, Object.class, "_state");
    ...
    public boolean a(C3350L c3350l) {
        C3486F c3486f;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f34603a;
        if (atomicReferenceFieldUpdater.get(this) == null) {
            c3486f = AbstractC3351M.f34601a;
    ...
    public final void g() {
        ...
        while (true) {
            ...
            if (obj != null) {
                c3486f = AbstractC3351M.f34602b;
                if (obj != c3486f) {
                    c3486f2 = AbstractC3351M.f34601a;
                    if (obj == c3486f2) {
                        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = f34603a;
                        c3486f3 = AbstractC3351M.f34602b;
                        if (androidx.concurrent.futures.a.a(atomicReferenceFieldUpdater2, this, obj, c3486f3)) {
                            return;
                        }
                    } else {
                        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater3 = f34603a;
                        c3486f4 = AbstractC3351M.f34601a;
                        if (androidx.concurrent.futures.a.a(atomicReferenceFieldUpdater3, this, obj, c3486f4)) {
                            s.a aVar = L5.s.f6498b;
                            ((C2839p) obj).resumeWith(L5.s.b(L5.I.f6474a));
                            return;
                        }
                    }
                } else {
    ...
    public final boolean h() {
        ...
        c3486f2 = AbstractC3351M.f34602b;
        if (andSet == c3486f2) {
            return true;
        }
        return false;
