...
public final class C3348J implements InterfaceC3344F {
    ...
    static final class a extends kotlin.coroutines.jvm.internal.l implements X5.o {
        ...
        /* renamed from: b, reason: collision with root package name */
        private /* synthetic */ Object f34586b;

        /* renamed from: c, reason: collision with root package name */
        /* synthetic */ int f34587c;
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r10) {
            ...
            L18:
                ...
                throw r10
            L20:
                java.lang.Object r1 = r9.f34586b
            ...
            L3c:
                L5.t.b(r10)
                java.lang.Object r10 = r9.f34586b
                r1 = r10
                l6.g r1 = (l6.InterfaceC3359g) r1
                int r10 = r9.f34587c
                if (r10 <= 0) goto L53
    ...
    static final class b extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f34589a == 0) {
                L5.t.b(obj);
                if (((EnumC3342D) this.f34590b) != EnumC3342D.START) {
                    z8 = true;
                } else {
                    z8 = false;
                }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof C3348J) {
            ...
            if (this.f34583b == c3348j.f34583b && this.f34584c == c3348j.f34584c) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (androidx.collection.a.a(this.f34583b) * 31) + androidx.collection.a.a(this.f34584c);
    }

    public String toString() {
        List d8 = AbstractC1246t.d(2);
        if (this.f34583b > 0) {
            d8.add("stopTimeout=" + this.f34583b + "ms");
        }
        if (this.f34584c < Long.MAX_VALUE) {
            d8.add("replayExpiration=" + this.f34584c + "ms");
        }
