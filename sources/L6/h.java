...
public final class h implements Closeable {
    ...
    static final Logger f6643e = Logger.getLogger(e.class.getName());

    /* renamed from: a, reason: collision with root package name */
    private final InterfaceC1281g f6644a;
    ...
    public h(InterfaceC1281g interfaceC1281g, boolean z8) {
        this.f6644a = interfaceC1281g;
        this.f6646c = z8;
        a aVar = new a(interfaceC1281g);
        this.f6645b = aVar;
        this.f6647d = new d.a(4096, aVar);
    }

    private void A(b bVar, int i8, byte b8, int i9) {
        if (i8 == 4) {
            long readInt = this.f6644a.readInt() & 2147483647L;
            if (readInt != 0) {
    ...
    private void f(b bVar, int i8, byte b8, int i9) {
        ...
        if (i9 != 0) {
            ...
            if ((b8 & 32) == 0) {
                if ((b8 & 8) != 0) {
                    s8 = (short) (this.f6644a.readByte() & 255);
                }
                bVar.a(z8, i9, this.f6644a, a(i8, b8, s8));
                this.f6644a.skip(s8);
                return;
            }
    ...
    private void g(b bVar, int i8, byte b8, int i9) {
        if (i8 >= 8) {
            if (i9 == 0) {
                int readInt = this.f6644a.readInt();
                int readInt2 = this.f6644a.readInt();
                int i10 = i8 - 8;
                L6.b a8 = L6.b.a(readInt2);
                if (a8 != null) {
                    C1282h c1282h = C1282h.f8054e;
                    if (i10 > 0) {
                        c1282h = this.f6644a.readByteString(i10);
                    }
    ...
    private void r(b bVar, int i8) {
        ...
        bVar.priority(i8, readInt & Integer.MAX_VALUE, (this.f6644a.readByte() & 255) + 1, z8);
    }
    ...
    private void u(b bVar, int i8, byte b8, int i9) {
        ...
        if (i9 != 0) {
            ...
            bVar.pushPromise(i9, this.f6644a.readInt() & Integer.MAX_VALUE, h(a(i8 - 4, b8, s8), s8, b8, i9));
            return;
        }
        ...
        if (i9 == 0) {
            ...
            if (i8 % 6 == 0) {
                ...
                for (int i10 = 0; i10 < i8; i10 += 6) {
                    int readShort = this.f6644a.readShort() & 65535;
                    int readInt = this.f6644a.readInt();
                    if (readShort != 2) {
                        if (readShort != 3) {
                            if (readShort != 4) {
    ...
    public boolean b(boolean z8, b bVar) {
        try {
            this.f6644a.require(9L);
            int m8 = m(this.f6644a);
            if (m8 >= 0 && m8 <= 16384) {
                byte readByte = (byte) (this.f6644a.readByte() & 255);
                if (z8 && readByte != 4) {
                    throw e.d("Expected a SETTINGS frame but was %s", Byte.valueOf(readByte));
                }
                byte readByte2 = (byte) (this.f6644a.readByte() & 255);
                int readInt = this.f6644a.readInt() & Integer.MAX_VALUE;
                Logger logger = f6643e;
    ...
    public void e(b bVar) {
        ...
        InterfaceC1281g interfaceC1281g = this.f6644a;
        C1282h c1282h = e.f6559a;
    ...
    public static final class a implements Z {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final InterfaceC1281g f6648a;
        ...
        a(InterfaceC1281g interfaceC1281g) {
            this.f6648a = interfaceC1281g;
        }

        private void a() {
            int i8 = this.f6651d;
            int m8 = h.m(this.f6648a);
            this.f6652e = m8;
            this.f6649b = m8;
            byte readByte = (byte) (this.f6648a.readByte() & 255);
            this.f6650c = (byte) (this.f6648a.readByte() & 255);
            Logger logger = h.f6643e;
            if (logger.isLoggable(Level.FINE)) {
                logger.fine(e.b(true, this.f6651d, this.f6649b, readByte, this.f6650c));
            }
            int readInt = this.f6648a.readInt() & Integer.MAX_VALUE;
            this.f6651d = readInt;
            if (readByte == 9) {
                if (readInt == i8) {
                    return;
        ...
        public long y(C1279e c1279e, long j8) {
            while (true) {
                ...
                if (i8 == 0) {
                    ...
                    long y8 = this.f6648a.y(c1279e, Math.min(j8, i8));
                    if (y8 == -1) {
                        return -1L;
                    }
                    this.f6652e = (int) (this.f6652e - y8);
                    return y8;
                }
            }
        }
