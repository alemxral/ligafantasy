...
public class r extends g {
    ...
    private final AtomicReference f5844f;
    ...
    private void g() {
        if (this.f5844f.get() != a.SIGNED && this.f5844f.get() != a.VERIFIED) {
    ...
    public byte[] k() {
        return this.f5842d.getBytes(Z1.m.f13234a);
    }
    ...
    public String n(boolean z8) {
        g();
        if (z8) {
            return this.f5841c.h().toString() + ".." + this.f5843e.toString();
        }
        return this.f5842d + '.' + this.f5843e.toString();
    }
    ...
    public r(Z1.c cVar, w wVar, Z1.c cVar2) {
        ...
        this.f5844f = atomicReference;
        if (cVar != null) {
            try {
                this.f5841c = q.w(cVar);
                if (wVar != null) {
                    d(wVar);
                    this.f5842d = f();
                    if (cVar2 != null) {
