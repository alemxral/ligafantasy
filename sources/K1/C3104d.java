...
public final class C3104d implements InterfaceC3101a {
    ...
    public static final a f33304d = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private final C2768b f33305a;

    /* renamed from: b, reason: collision with root package name */
    private final P5.g f33306b;
    ...
    static final class b extends l implements n {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ n f33311d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ n f33312e;
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            return new b(this.f33310c, this.f33311d, this.f33312e, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i8 != 0) {
                    ...
                    for (Map.Entry entry : this.f33310c.entrySet()) {
    ...
    public C3104d(C2768b appInfo, P5.g blockingDispatcher, String baseUrl) {
        ...
        this.f33305a = appInfo;
        this.f33306b = blockingDispatcher;
        this.f33307c = baseUrl;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final URL c() {
        return new URL(new Uri.Builder().scheme("https").authority(this.f33307c).appendPath("spi").appendPath("v2").appendPath("platforms").appendPath("android").appendPath("gmp").appendPath(this.f33305a.b()).appendPath("settings").appendQueryParameter("build_version", this.f33305a.a().a()).appendQueryParameter("display_version", this.f33305a.a().d()).build().toString());
    }

    @Override // k1.InterfaceC3101a
    public Object a(Map map, n nVar, n nVar2, P5.d dVar) {
        Object g8 = AbstractC2825i.g(this.f33306b, new b(map, nVar, nVar2, null), dVar);
        if (g8 == Q5.b.e()) {
            return g8;
        }
        return I.f6474a;
