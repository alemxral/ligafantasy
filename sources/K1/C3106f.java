...
public final class C3106f {
    ...
    private static final a f33318c = new a(null);

    /* renamed from: d, reason: collision with root package name */
    private static final InterfaceC1579d f33319d = PreferenceDataStoreDelegateKt.preferencesDataStore$default("firebase_session_settings", null, null, null, 14, null);

    /* renamed from: a, reason: collision with root package name */
    private final InterfaceC3108h f33320a;

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC3108h f33321b;
    ...
    private static final class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ i[] f33322a = {U.h(new M(a.class, "dataStore", "getDataStore(Landroid/content/Context;)Landroidx/datastore/core/DataStore;", 0))};
        ...
        public final DataStore b(Context context) {
            return (DataStore) C3106f.f33319d.getValue(context, f33322a[0]);
        }
    ...
    public C3106f(InterfaceC3108h localOverrideSettings, InterfaceC3108h remoteSettings) {
        ...
        this.f33320a = localOverrideSettings;
        this.f33321b = remoteSettings;
    }
    ...
    public final long c() {
        ...
        return AbstractC2760c.s(30, EnumC2761d.f31406f);
    }

    public final boolean d() {
        Boolean a8 = this.f33320a.a();
        if (a8 != null) {
            return a8.booleanValue();
        }
        Boolean a9 = this.f33321b.a();
        if (a9 != null) {
    ...
    */
    public final java.lang.Object g(P5.d r6) {
        ...
        L13:
            ...
            r0.<init>(r6)
        L18:
            java.lang.Object r6 = r0.f33324b
        ...
        L2c:
            ...
            throw r6
        L34:
            java.lang.Object r2 = r0.f33323a
    ...
    public C3106f(Context context, P5.g blockingDispatcher, P5.g backgroundDispatcher, InterfaceC1554e firebaseInstallationsApi, C2768b appInfo) {
        this(new C3102b(context), new C3103c(backgroundDispatcher, firebaseInstallationsApi, appInfo, new C3104d(appInfo, blockingDispatcher, null, 4, null), f33318c.b(context)));
