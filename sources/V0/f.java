...
public final class f implements S0.e {
    ...
    private static final Charset f11818f = Charset.forName(C.UTF8_NAME);

    /* renamed from: g, reason: collision with root package name */
    private static final S0.c f11819g = S0.c.a(LeanbackPreferenceDialogFragment.ARG_KEY).b(V0.a.b().c(1).a()).a();

    /* renamed from: h, reason: collision with root package name */
    private static final S0.c f11820h = S0.c.a("value").b(V0.a.b().c(2).a()).a();

    /* renamed from: i, reason: collision with root package name */
    private static final S0.d f11821i = new S0.d() { // from class: V0.e
        @Override // S0.d
    ...
    private final S0.d f11825d;

    /* renamed from: e, reason: collision with root package name */
    private final i f11826e = new i(this);
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f11827a[d.a.SIGNED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f11827a[d.a.FIXED.ordinal()] = 3;
    ...
    private long q(S0.d dVar, Object obj) {
        b bVar = new b();
        try {
            OutputStream outputStream = this.f11822a;
            this.f11822a = bVar;
            try {
                dVar.a(obj, this);
                this.f11822a = outputStream;
    ...
    private f s(S0.f fVar, S0.c cVar, Object obj, boolean z8) {
        this.f11826e.b(cVar, z8);
        fVar.a(obj, this.f11826e);
        return this;
    }
    ...
    public static /* synthetic */ void w(Map.Entry entry, S0.e eVar) {
        eVar.a(f11819g, entry.getKey());
        eVar.a(f11820h, entry.getValue());
    }

    private void x(int i8) {
        while ((i8 & (-128)) != 0) {
            this.f11822a.write((i8 & 127) | 128);
            i8 >>>= 7;
        }
        this.f11822a.write(i8 & 127);
    }

    private void y(long j8) {
        while (((-128) & j8) != 0) {
            this.f11822a.write((((int) j8) & 127) | 128);
            j8 >>>= 7;
        }
        this.f11822a.write(((int) j8) & 127);
    }
    ...
    S0.e g(S0.c cVar, double d8, boolean z8) {
        ...
        x((v(cVar) << 3) | 1);
        this.f11822a.write(p(8).putDouble(d8).array());
        return this;
    }
    ...
    S0.e h(S0.c cVar, float f8, boolean z8) {
        ...
        x((v(cVar) << 3) | 5);
        this.f11822a.write(p(4).putFloat(f8).array());
        return this;
    }
    ...
    public S0.e i(S0.c cVar, Object obj, boolean z8) {
        ...
        if (obj instanceof CharSequence) {
            ...
            x((v(cVar) << 3) | 2);
            byte[] bytes = charSequence.toString().getBytes(f11818f);
            x(bytes.length);
            this.f11822a.write(bytes);
            return this;
        }
        ...
        if (obj instanceof Map) {
            ...
            while (it2.hasNext()) {
                r(f11821i, cVar, (Map.Entry) it2.next(), false);
            }
            return this;
        }
        ...
        if (obj instanceof byte[]) {
            ...
            x((v(cVar) << 3) | 2);
            x(bArr.length);
            this.f11822a.write(bArr);
            return this;
        }
        S0.d dVar = (S0.d) this.f11823b.get(obj.getClass());
        if (dVar != null) {
            return r(dVar, cVar, obj, z8);
        }
        S0.f fVar = (S0.f) this.f11824c.get(obj.getClass());
        if (fVar != null) {
        ...
        return r(this.f11825d, cVar, obj, z8);
    }
    ...
    f k(S0.c cVar, int i8, boolean z8) {
        ...
        d u8 = u(cVar);
        int i9 = a.f11827a[u8.intEncoding().ordinal()];
        if (i9 != 1) {
            if (i9 != 2) {
                if (i9 == 3) {
                    x((u8.tag() << 3) | 5);
                    this.f11822a.write(p(4).putInt(i8).array());
                }
            } else {
                x(u8.tag() << 3);
                x((i8 << 1) ^ (i8 >> 31));
    ...
    f m(S0.c cVar, long j8, boolean z8) {
        ...
        d u8 = u(cVar);
        int i8 = a.f11827a[u8.intEncoding().ordinal()];
        if (i8 != 1) {
            if (i8 != 2) {
                if (i8 == 3) {
                    x((u8.tag() << 3) | 1);
                    this.f11822a.write(p(8).putLong(j8).array());
                }
            } else {
                x(u8.tag() << 3);
                y((j8 >> 63) ^ (j8 << 1));
