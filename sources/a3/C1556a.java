...
public final class C1556a extends A0 {
    ...
    private final Function1 f13485f;
    ...
    public static final class C0260a extends AbstractC3160z implements n {
        ...
        public final void invoke(Composer composer, int i8) {
            C1556a.this.f(this.f13487b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f13488c | 1));
        }
    }
    ...
    public C1556a(b configuration, e linkConfigurationCoordinator, Function1 onLinkInlineSignupStateChanged) {
        ...
        this.f13483d = configuration;
        this.f13484e = linkConfigurationCoordinator;
        this.f13485f = onLinkInlineSignupStateChanged;
    }
    ...
    public void f(boolean z8, Composer composer, int i8) {
        ...
        f.a(this.f13484e, this.f13483d.b(), this.f13483d.c(), z8, this.f13485f, startRestartGroup, (d.f5877h << 3) | 8 | ((i8 << 9) & 7168));
        if (ComposerKt.isTraceInProgress()) {
