...
class e {
    ...
    private Method a(Class cls) {
        ...
        Method b8 = b(cls, str, this.f7527c);
        if (b8 != null && (cls2 = this.f7525a) != null && !cls2.isAssignableFrom(b8.getReturnType())) {
            return null;
        }
        return b8;
    }
    ...
    public Object c(Object obj, Object... objArr) {
        ...
        throw new AssertionError("Method " + this.f7526b + " not supported for object " + obj);
    }
