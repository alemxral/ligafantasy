...
public class f {
    ...
    private static final f f7528a = h();

    /* renamed from: b, reason: collision with root package name */
    private static final Logger f7529b = Logger.getLogger(u.class.getName());
    ...
    public Object m(String str) {
        if (f7529b.isLoggable(Level.FINE)) {
