...
public abstract class J {
    ...
    public static final C3486F f36225a = new C3486F("NO_THREAD_ELEMENTS");

    /* renamed from: b, reason: collision with root package name */
    private static final X5.n f36226b = a.f36229a;

    /* renamed from: c, reason: collision with root package name */
    private static final X5.n f36227c = b.f36230a;

    /* renamed from: d, reason: collision with root package name */
    private static final X5.n f36228d = c.f36231a;
    ...
    static final class c extends AbstractC3160z implements X5.n {
        ...
        public final P invoke(P p8, g.b bVar) {
            if (bVar instanceof V0) {
                V0 v02 = (V0) bVar;
                p8.a(v02, v02.updateThreadContext(p8.f36238a));
            }
            return p8;
        }
    }
    ...
    public static final void a(P5.g gVar, Object obj) {
        ...
        Object fold = gVar.fold(null, f36227c);
    ...
    public static final Object b(P5.g gVar) {
        Object fold = gVar.fold(0, f36226b);
    ...
    public static final Object c(P5.g gVar, Object obj) {
        ...
        if (obj instanceof Integer) {
            return gVar.fold(new P(gVar, ((Number) obj).intValue()), f36228d);
        }
