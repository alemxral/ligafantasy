...
public abstract class AbstractC3497k {
    ...
    /* renamed from: a */
    private static final C3486F f36256a = new C3486F("UNDEFINED");

    /* renamed from: b */
    public static final C3486F f36257b = new C3486F("REUSABLE_CLAIMED");
    ...
    public static final void b(P5.d dVar, Object obj, Function1 function1) {
        ...
        if (dVar instanceof C3496j) {
            ...
            if (c3496j.f36252d.isDispatchNeeded(c3496j.getContext())) {
                c3496j.f36254f = c8;
                c3496j.f31725c = 1;
                c3496j.f36252d.dispatch(c3496j.getContext(), c3496j);
                return;
            }
            ...
            b8.J(true);
            try {
                InterfaceC2855x0 interfaceC2855x0 = (InterfaceC2855x0) c3496j.getContext().get(InterfaceC2855x0.f31795n0);
                if (interfaceC2855x0 != null && !interfaceC2855x0.isActive()) {
                    ...
                    P5.d dVar2 = c3496j.f36253e;
                    Object obj2 = c3496j.f36255g;
