...
public class a extends f {
    ...
    private final e f7503d;

    /* renamed from: e, reason: collision with root package name */
    private final e f7504e;

    /* renamed from: f, reason: collision with root package name */
    private final e f7505f;

    /* renamed from: g, reason: collision with root package name */
    private final e f7506g;

    /* renamed from: h, reason: collision with root package name */
    private final c f7507h = c.b();
    ...
    static final class C0163a extends O6.c {
        ...
        public List a(List list, String str) {
            try {
                return (List) this.f7509b.invoke(this.f7508a, (X509Certificate[]) list.toArray(new X509Certificate[list.size()]), "RSA", str);
    ...
    static final class b implements O6.e {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final X509TrustManager f7510a;

        /* renamed from: b, reason: collision with root package name */
        private final Method f7511b;

        b(X509TrustManager x509TrustManager, Method method) {
            this.f7511b = method;
            this.f7510a = x509TrustManager;
        }
        ...
        public boolean equals(Object obj) {
            ...
            b bVar = (b) obj;
            if (this.f7510a.equals(bVar.f7510a) && this.f7511b.equals(bVar.f7511b)) {
                return true;
            }
            return false;
        }
        ...
        public X509Certificate findByIssuerAndSignature(X509Certificate x509Certificate) {
            try {
                TrustAnchor trustAnchor = (TrustAnchor) this.f7511b.invoke(this.f7510a, x509Certificate);
                if (trustAnchor == null) {
                    return null;
                }
        ...
        public int hashCode() {
            return this.f7510a.hashCode() + (this.f7511b.hashCode() * 31);
        }
    }
    ...
    static final class c {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Method f7512a;

        /* renamed from: b, reason: collision with root package name */
        private final Method f7513b;

        /* renamed from: c, reason: collision with root package name */
        private final Method f7514c;
        ...
        Object a(String str) {
            Method method = this.f7512a;
            if (method != null) {
                try {
                    Object invoke = method.invoke(null, null);
                    this.f7513b.invoke(invoke, str);
                    return invoke;
                } catch (Exception unused) {
                }
            }
    ...
    public void f(SSLSocket sSLSocket, String str, List list) {
        if (str != null) {
            this.f7503d.e(sSLSocket, Boolean.TRUE);
            this.f7504e.e(sSLSocket, str);
        }
        e eVar = this.f7506g;
        if (eVar != null && eVar.g(sSLSocket)) {
            this.f7506g.f(sSLSocket, f.e(list));
        }
    }
    ...
    public String l(SSLSocket sSLSocket) {
        byte[] bArr;
        e eVar = this.f7505f;
        if (eVar == null || !eVar.g(sSLSocket) || (bArr = (byte[]) this.f7505f.f(sSLSocket, new Object[0])) == null) {
            return null;
        }
        return new String(bArr, G6.c.f3216j);
    }

    @Override // N6.f
    public Object m(String str) {
        return this.f7507h.a(str);
    }
