...
public abstract class AbstractC3490d {
    ...
    /* renamed from: a */
    private static final C3486F f36245a = new C3486F("CLOSED");
    ...
    public static final Object c(AbstractC3483C abstractC3483C, long j8, X5.n nVar) {
        while (true) {
            if (abstractC3483C.f36219c < j8 || abstractC3483C.h()) {
                Object f8 = abstractC3483C.f();
                if (f8 == f36245a) {
                    return AbstractC3484D.a(f36245a);
                }
                AbstractC3483C abstractC3483C2 = (AbstractC3483C) ((AbstractC3491e) f8);
                if (abstractC3483C2 == null) {
                    abstractC3483C2 = (AbstractC3483C) nVar.invoke(Long.valueOf(abstractC3483C.f36219c + 1), abstractC3483C);
