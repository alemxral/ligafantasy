...
public abstract class b {
    public static W6.b a(AbstractC2565b abstractC2565b, AbstractC1355w abstractC1355w) {
        ...
        if (abstractC2565b instanceof C3697b) {
            ...
            return new W6.b(new X6.a(k7.e.f33681r, new h(e.f(c3697b.a()))), new C1330a0(c3697b.b()));
        }
        if (abstractC2565b instanceof C3504a) {
            X6.a aVar = new X6.a(k7.e.f33685v);
        ...
        if (abstractC2565b instanceof C3375h) {
            ...
            return new W6.b(new X6.a(W6.a.f12021I0), new C1330a0(b8), abstractC1355w, C3368a.f().i(1).c(c3375h.i()).b());
        }
        if (abstractC2565b instanceof C3370c) {
            C3370c c3370c = (C3370c) abstractC2565b;
            byte[] b9 = C3368a.f().i(c3370c.c()).c(c3370c).b();
            return new W6.b(new X6.a(W6.a.f12021I0), new C1330a0(b9), abstractC1355w, C3368a.f().i(c3370c.c()).c(c3370c.d().c()).b());
        }
        if (abstractC2565b instanceof y) {
            y yVar = (y) abstractC2565b;
            return new W6.b(new X6.a(k7.e.f33686w, new i(yVar.b().b(), e.h(yVar.a()))), b(yVar), abstractC1355w);
        }
        if (abstractC2565b instanceof s) {
            s sVar = (s) abstractC2565b;
            return new W6.b(new X6.a(k7.e.f33644F, new j(sVar.b().a(), sVar.b().b(), e.h(sVar.a()))), c(sVar), abstractC1355w);
        }
        if (abstractC2565b instanceof C3442b) {
            C3442b c3442b = (C3442b) abstractC2565b;
            return new W6.b(new X6.a(k7.e.f33677n), new C3133a(c3442b.f(), c3442b.e(), c3442b.b(), c3442b.c(), c3442b.g(), e.a(c3442b.a())));
        }
