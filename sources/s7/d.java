...
public abstract class d {
    public static X6.b a(AbstractC2565b abstractC2565b) {
        ...
        if (abstractC2565b instanceof C3698c) {
            ...
            return new X6.b(new X6.a(k7.e.f33681r, new h(e.f(c3698c.a()))), c3698c.b());
        }
        if (abstractC2565b instanceof n7.b) {
            return new X6.b(new X6.a(k7.e.f33685v), ((n7.b) abstractC2565b).a());
        }
        if (abstractC2565b instanceof C3376i) {
            return new X6.b(new X6.a(W6.a.f12021I0), new C1330a0(C3368a.f().i(1).c((C3376i) abstractC2565b).b()));
        }
        if (abstractC2565b instanceof C3371d) {
            C3371d c3371d = (C3371d) abstractC2565b;
            return new X6.b(new X6.a(W6.a.f12021I0), new C1330a0(C3368a.f().i(c3371d.b()).c(c3371d.c()).b()));
        }
        if (abstractC2565b instanceof z) {
            ...
            if (encoded.length > c8.length + d8.length) {
                return new X6.b(new X6.a(T6.a.f11034a), new C1330a0(encoded));
            }
            return new X6.b(new X6.a(k7.e.f33686w, new i(zVar.b().b(), e.h(zVar.a()))), new n(c8, d8));
        }
        if (abstractC2565b instanceof t) {
            ...
            if (encoded2.length > c9.length + d9.length) {
                return new X6.b(new X6.a(T6.a.f11035b), new C1330a0(encoded2));
            }
            return new X6.b(new X6.a(k7.e.f33644F, new j(tVar.b().a(), tVar.b().b(), e.h(tVar.a()))), new l(tVar.c(), tVar.d()));
        }
        if (abstractC2565b instanceof C3443c) {
            C3443c c3443c = (C3443c) abstractC2565b;
            return new X6.b(new X6.a(k7.e.f33677n), new C3134b(c3443c.c(), c3443c.d(), c3443c.b(), e.a(c3443c.a())));
        }
