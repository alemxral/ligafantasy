...
public final class C3319g {
    ...
    public static final a f34476a = new a(null);
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f34479a == 0) {
                L5.t.b(obj);
                C3307A.f34459a.k(this.f34480b, this.f34481c.packageName, R.drawable.vector_uptodown_logo_bag_disabled);
                return I.f6474a;
            }
    ...
    private final void d(C1496f c1496f, C3326n c3326n, PackageManager packageManager) {
        ...
        if (c1496f.X() == null && c1496f.j() == 0) {
            ...
            if (applicationInfo != null) {
                c1496f.G0(N4.d.f7188a.e(applicationInfo.sourceDir));
            }
            if (c1496f.X() != null) {
                c3326n.q1(c1496f);
            } else {
    ...
    private final String n(PackageManager packageManager, String str, String str2) {
        ...
        if (m8 != null) {
            if (AbstractC3159y.d(str2, SameMD5.TAG)) {
                return N4.d.f7188a.g(m8);
            }
            if (AbstractC3159y.d(str2, "SHA256")) {
                return N4.d.f7188a.d(m8);
            }
        }
        return null;
    }
    ...
    */
    ...
    public final ArrayList A(Context context) {
        ...
        AbstractC3159y.i(context, "context");
        synchronized (UptodownApp.f27990B.i()) {
    ...
    public final void e(ArrayList apps, Context context) {
        ...
        AbstractC3159y.i(context, "context");
        synchronized (UptodownApp.f27990B.j()) {
            try {
    ...
    public final ArrayList f(ArrayList arrayList, Context context) {
        AbstractC3159y.i(context, "context");
        synchronized (UptodownApp.f27990B.k()) {
            if (arrayList != null) {
                try {
                    PackageManager packageManager = context.getPackageManager();
                    C3326n a8 = C3326n.f34490t.a(context);
    ...
    public final String i(ArrayList apps) {
        ...
        if (str != null) {
            return N4.d.f7188a.f(str + Build.VERSION.SDK_INT);
        }
        return str;
    }
