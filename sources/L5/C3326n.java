...
public final class C3326n extends SQLiteOpenHelper {
    ...
    public static final a f34490t = new a(null);

    /* renamed from: u, reason: collision with root package name */
    private static C3326n f34491u;

    /* renamed from: a, reason: collision with root package name */
    private SQLiteDatabase f34492a;
    ...
    private final AtomicInteger f34510s;
    ...
    public static final class a {
        ...
        public final synchronized C3326n a(Context context) {
            ...
            try {
                ...
                if (C3326n.f34491u == null) {
                    C3326n.f34491u = new C3326n(context.getApplicationContext());
                }
                c3326n = C3326n.f34491u;
    ...
    public C3326n(Context context) {
        ...
        this.f34493b = new String[]{"id", "name", "packagename", "versionCode", "issystemapp", "isSystemService", "urlFicha", "md5", "md5signature", "exclude", "size", "excludeFromTracking", "defaultName", "sha256", "positiveNotified", "appID", "hasOldVersions", "trackInfoRegistered"};
        this.f34494c = new String[]{"id", MBridgeConstans.APP_ID, "md5", "sha256", "size", MBridgeConstans.DYNAMIC_VIEW_WX_PATH};
        this.f34495d = new String[]{"packagename", "versionCode", "versionName", "size", "notified", "nameApkFile", "progress", "ignoreVersion", "filehash", "fileId"};
        this.f34496e = new String[]{"id", "packagename", "apk_name", "progress", "checked", "incomplete", "size", "downloadedSize", "md5", "versioncode", "attempts", "idPrograma", "downloadAnyway", "filehash", "fileId", "md5signature", "supportedAbis", "minsdk", "urlIcon", "appName"};
        this.f34497f = new String[]{"search", CampaignEx.JSON_KEY_TIMESTAMP};
        this.f34498g = new String[]{"id", MBridgeConstans.DYNAMIC_VIEW_WX_PATH};
        this.f34499h = new String[]{"id", CampaignEx.JSON_KEY_TIMESTAMP, CampaignEx.JSON_KEY_TITLE, NotificationCompat.CATEGORY_MESSAGE, "actions", "extra_info"};
        this.f34500i = new String[]{"id_program", "name", RewardPlus.ICON, "release_date", "notified"};
        this.f34501j = new String[]{"appId"};
        this.f34502k = new String[]{"appId"};
        this.f34503l = new String[]{"id", "id_program", "name", RewardPlus.ICON, "packagename", "can_download"};
        this.f34504m = new String[]{MBridgeConstans.DYNAMIC_VIEW_WX_PATH, "date"};
        this.f34505n = new String[]{"id", "notificationId", "packagename", "versioncode", "type"};
        this.f34506o = new String[]{"id", "type", "packagename", "versionname_old", "versionname_new", "versioncode_old", "versioncode_new", "size", CampaignEx.JSON_KEY_TIMESTAMP};
        this.f34507p = new String[]{"id", "type", "json", CampaignEx.JSON_KEY_TIMESTAMP};
        this.f34508q = new String[]{"id", CampaignEx.JSON_KEY_TIMESTAMP, "filePath", "attempts"};
        this.f34509r = new String[]{"id", "json", CampaignEx.JSON_KEY_TIMESTAMP};
        this.f34510s = new AtomicInteger();
    }
    ...
    private final C1491a Q0(Cursor cursor) {
        ...
        c1491a.i(i8);
        c1491a.h(i9);
        c1491a.j(C1491a.f12453f.a(cursor.getInt(4)));
        return c1491a;
    }
    ...
    private final ArrayList f(String[] strArr) {
        ...
        Cursor cursor = null;
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
    ...
    private final ArrayList x1() {
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                arrayList.add(U.f12442h.b(cursor));
                while (cursor.moveToNext()) {
                    arrayList.add(U.f12442h.b(cursor));
                }
            }
    ...
    private final I z0() {
        this.f34492a = getWritableDatabase();
        return I.f6474a;
    }
    ...
    public final C1491a O(int i8) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("active_notifications", this.f34505n, "notificationId=?", strArr, null, null, null);
            try {
                if (cursor.moveToFirst()) {
                    c1491a = Q0(cursor);
                } else {
    ...
    public final C1491a P(String packageName, long j8) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("active_notifications", this.f34505n, "packagename=? AND versioncode=?", strArr, null, null, null);
        } catch (Exception e8) {
            e = e8;
            cursor = null;
        }
    ...
    public final C1491a Q(int i8) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("active_notifications", this.f34505n, "id=?", strArr, null, null, null);
            try {
                if (cursor.moveToFirst()) {
                    c1491a = Q0(cursor);
                } else {
    ...
    public final ArrayList R() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("active_notifications", this.f34505n, null, null, null, null, null);
            if (cursor.moveToFirst()) {
    ...
    public final C1496f S(String packagename) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("apps", this.f34493b, "packagename=?", new String[]{packagename}, null, null, null);
            try {
                if (cursor.moveToFirst()) {
                    c1496f = R0(cursor);
                } else {
    ...
    public final ArrayList T(long j8) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("app_files", this.f34494c, "app_id=?", strArr, null, null, null);
            if (cursor.moveToFirst()) {
    ...
    public final ArrayList V() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("apps", this.f34493b, null, null, null, null, null);
            if (cursor.moveToFirst()) {
    ...
    public final ArrayList X() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("deep_link_files", this.f34504m, null, null, null, null, null);
            if (cursor.moveToFirst()) {
    ...
    public final C1505o Y(String filename) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("downloads", this.f34496e, "apk_name=?", new String[]{filename}, null, null, null);
            try {
                if (cursor.moveToFirst()) {
                    c1505o = U0(cursor);
                } else {
    ...
    public final C1505o Z(String fileId) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("downloads", this.f34496e, "fileId=?", new String[]{fileId}, null, null, null);
            try {
                if (cursor.moveToFirst()) {
                    c1505o = U0(cursor);
                } else {
    ...
    public final synchronized void a() {
        if (this.f34510s.incrementAndGet() == 1) {
            C3326n c3326n = f34491u;
            AbstractC3159y.f(c3326n);
            c3326n.z0();
        }
    ...
    public final C1505o a0(String packagename) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("downloads", this.f34496e, "packagename=?", new String[]{packagename}, null, null, "versioncode DESC");
            try {
                if (cursor.moveToFirst()) {
                    c1505o = U0(cursor);
                } else {
    ...
    public final C1505o b0(String packagename, long j8) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("downloads", this.f34496e, "packagename=? AND versioncode=?", new String[]{packagename, String.valueOf(j8)}, null, null, null);
        } catch (Exception e8) {
            e = e8;
            cursor = null;
        }
    ...
    public final ArrayList c0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("downloads", this.f34496e, null, null, null, null, null);
            if (cursor.moveToFirst()) {
    ...
    public final ArrayList d0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("events", this.f34509r, null, null, null, null, null);
            if (cursor.moveToFirst()) {
    ...
    public final ArrayList e0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("installable_files", this.f34498g, null, null, null, null, null);
            if (cursor.moveToFirst()) {
    ...
    public final C1509t f0(String filePath) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            Cursor query = sQLiteDatabase.query("installationAttempts", this.f34508q, "filePath=?", new String[]{filePath}, null, null, null);
            try {
    ...
    public final synchronized void g() {
        try {
            if (this.f34510s.decrementAndGet() == 0) {
                C3326n c3326n = f34491u;
                AbstractC3159y.f(c3326n);
                c3326n.close();
            } else if (this.f34510s.get() < 0) {
                this.f34510s.set(0);
            }
        } catch (Throwable th) {
            throw th;
    ...
    public final ArrayList g0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("installationAttempts", this.f34508q, null, null, null, null, null);
            if (cursor.moveToFirst()) {
    ...
    public final C1505o g1(int i8) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("downloads", this.f34496e, "id=?", strArr, null, null, null);
            try {
                if (cursor.moveToFirst()) {
                    c1505o = U0(cursor);
                } else {
    ...
    public final X4.y h0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            query = sQLiteDatabase.query("notifications", this.f34499h, "actions=?", new String[]{"update_uptodown"}, null, null, "id DESC");
        } catch (Exception e8) {
            e = e8;
            yVar = null;
        }
    ...
    public final int l(C1491a activeNotification) {
        ...
        if (activeNotification.a() > -1) {
            ...
            SQLiteDatabase sQLiteDatabase2 = this.f34492a;
        ...
        if (activeNotification.c().length() > 0) {
            ...
            SQLiteDatabase sQLiteDatabase3 = this.f34492a;
    ...
    public final ArrayList l0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("notifications", this.f34499h, null, null, null, null, "id DESC");
            if (cursor.moveToFirst()) {
                X4.y yVar = new X4.y();
                yVar.g(cursor);
                arrayList.add(yVar);
    ...
    public final ArrayList m0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("notifications", this.f34499h, "actions=?", new String[]{"upcoming_release"}, null, null, null);
            if (cursor.moveToFirst()) {
                X4.y yVar = new X4.y();
                yVar.g(cursor);
                arrayList.add(yVar);
    ...
    public final X4.D n0(long j8) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("preregistrations", this.f34501j, "appId=?", strArr, null, null, null);
            try {
                if (cursor.moveToFirst()) {
                    d8 = X4.D.f12322f.c(cursor);
                } else {
                    d8 = null;
                }
                cursor.close();
    ...
    public final X4.D o0(long j8) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("preregistrations_to_notify", this.f34502k, "appId=?", strArr, null, null, null);
            try {
                if (cursor.moveToFirst()) {
                    d8 = X4.D.f12322f.c(cursor);
                } else {
    ...
    public void onCreate(SQLiteDatabase mSQLiteDatabase) {
        ...
        SQLiteDatabase sQLiteDatabase4 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase5 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase6 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase7 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase8 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase9 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase10 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase11 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase12 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase13 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase14 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase15 = this.f34492a;
        ...
        SQLiteDatabase sQLiteDatabase16 = this.f34492a;
    ...
    public final ArrayList p0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("preregistrations", this.f34501j, null, null, null, null, null);
            if (cursor.moveToFirst()) {
                X4.D d8 = new X4.D();
                d8.f(cursor);
                arrayList.add(d8);
    ...
    public final ArrayList q0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("preregistrations_to_notify", this.f34502k, null, null, null, null, null);
            if (cursor.moveToFirst()) {
                X4.D d8 = new X4.D();
                d8.f(cursor);
                arrayList.add(d8);
    ...
    public final ArrayList r0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("recent_searches", this.f34497f, null, null, null, null, null);
            if (cursor.moveToFirst()) {
    ...
    public final J s0(String type) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            Cursor query = sQLiteDatabase.query("responses", this.f34507p, "type=?", new String[]{type}, null, null, null);
            try {
                if (query.moveToFirst()) {
                    j9 = Y0(query);
                }
    ...
    public final X4.D t0(long j8) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("upcoming_releases", this.f34500i, "id_program=?", strArr, null, null, null);
            try {
                if (cursor.moveToFirst()) {
                    d8 = X4.D.f12322f.d(cursor);
                } else {
                    d8 = null;
                }
                cursor.close();
    ...
    public final O u0(String packagename) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("updates", this.f34495d, "packagename=?", new String[]{packagename}, null, null, null);
            try {
                if (cursor.moveToFirst()) {
                    o8 = Z0(cursor);
                } else {
    ...
    public final ArrayList v0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("updates", this.f34495d, null, null, null, null, null);
            if (cursor.moveToFirst()) {
    ...
    public final ArrayList w0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("wishlist", this.f34503l, null, null, null, null, null);
            if (cursor.moveToFirst()) {
                U u8 = new U();
                u8.g(cursor);
                arrayList.add(u8);
    ...
    public final U x0(long j8) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f34492a;
            AbstractC3159y.f(sQLiteDatabase);
            cursor = sQLiteDatabase.query("wishlist", this.f34503l, "id_program=?", strArr, null, null, null);
            try {
                if (cursor.moveToFirst()) {
                    u8 = U.f12442h.a(cursor);
                } else {
                    u8 = null;
                }
                cursor.close();
