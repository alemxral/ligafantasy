...
public final class G implements Collection, Y5.a {
    ...
    public static final class a implements Iterator, Y5.a {
        ...
        public short b() {
            int i8 = this.f6473b;
            short[] sArr = this.f6472a;
            if (i8 < sArr.length) {
                this.f6473b = i8 + 1;
                return F.b(sArr[i8]);
            }
            throw new NoSuchElementException(String.valueOf(this.f6473b));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f6473b < this.f6472a.length) {
                return true;
            }
            return false;
        }
    ...
    public boolean containsAll(Collection elements) {
        AbstractC3159y.i(elements, "elements");
        return m(this.f6471a, elements);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return p(this.f6471a, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return t(this.f6471a);
    }

    public boolean i(short s8) {
        return l(this.f6471a, s8);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return u(this.f6471a);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return v(this.f6471a);
    }

    @Override // java.util.Collection
    /* renamed from: r, reason: merged with bridge method [inline-methods] */
    public int size() {
        return s(this.f6471a);
    }
