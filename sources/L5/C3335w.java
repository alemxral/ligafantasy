...
public final class C3335w {
    ...
    public static final C3335w f34532a = new C3335w();
    ...
    private final void v(Context context) {
        ...
        if (b8 > 0) {
            ...
            SettingsPreferences.f29309b.M0(context, String.valueOf(System.currentTimeMillis()));
    ...
    private final void y(NotificationCompat.Builder builder, int i8) {
        builder.setOnlyAlertOnce(true);
        z(builder);
        builder.setAutoCancel(false);
    ...
    public final boolean a(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            if (s(context) && SettingsPreferences.f29309b.b0(context)) {
                return true;
            }
            return false;
        }
        return SettingsPreferences.f29309b.b0(context);
    }
    ...
    public final void i(Context context) {
        ...
        AbstractC3159y.i(context, "context");
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "CHANNEL_ID_UPTODOWN");
        C1505o b8 = DownloadApkWorker.f29987k.b();
        if (b8 != null) {
            C3326n a8 = C3326n.f34490t.a(context);
            a8.a();
            ArrayList c02 = a8.c0();
            ...
            while (it.hasNext()) {
                ...
                if (c1505o.Z() == 0 && !DownloadApkWorker.f29987k.c(c1505o.f())) {
                    i9++;
                }
            }
            String i10 = b8.i();
    ...
    */
    ...
    public final void l(Context context, String contentText) {
        ...
        if (a(context) && SettingsPreferences.f29309b.Z(context)) {
            NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "CHANNEL_ID_UPTODOWN");
            z(builder);
    ...
    public final void m(Context context, File file, boolean z8, int i8) {
        ...
        if (a(context) && new G4.a(context).p()) {
            ...
            w(name3, String.valueOf(System.currentTimeMillis()), str, sb.toString(), file.getAbsolutePath(), context);
        }
    }
    ...
    public final void o(Context context, C1498h appInfo, int i8, Bitmap bitmap, X4.D preRegister) {
        ...
        if (a(context)) {
            ...
            w(null, String.valueOf(System.currentTimeMillis()), format, "preregister", String.valueOf(appInfo.i()), context);
    ...
    public final void t(Context context, C1505o c1505o, String str) {
        ...
        String string;
        AbstractC3159y.i(context, "context");
        if (a(context) && SettingsPreferences.f29309b.T(context)) {
            String str5 = null;
            if (c1505o != null) {
                str2 = c1505o.i();
            } else {
            ...
            w(str6, String.valueOf(System.currentTimeMillis()), str, null, null, context);
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void x(android.content.Context r17, boolean r18) {
        /*
            Method dump skipped, instructions count: 339
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: l5.C3335w.x(android.content.Context, boolean):void");
    }
}
