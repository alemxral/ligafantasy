...
public final class B implements Collection, Y5.a {
    ...
    public static final class a implements Iterator, Y5.a {
        ...
        public int b() {
            int i8 = this.f6462b;
            int[] iArr = this.f6461a;
            if (i8 < iArr.length) {
                this.f6462b = i8 + 1;
                return A.b(iArr[i8]);
            }
            throw new NoSuchElementException(String.valueOf(this.f6462b));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f6462b < this.f6461a.length) {
                return true;
            }
            return false;
        }
    ...
    public boolean containsAll(Collection elements) {
        AbstractC3159y.i(elements, "elements");
        return m(this.f6460a, elements);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return p(this.f6460a, obj);
    }
    ...
    public boolean i(int i8) {
        return l(this.f6460a, i8);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return u(this.f6460a);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return v(this.f6460a);
    }

    @Override // java.util.Collection
    /* renamed from: r, reason: merged with bridge method [inline-methods] */
    public int size() {
        return s(this.f6460a);
    }
