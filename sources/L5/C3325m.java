...
public final class C3325m extends AbstractAccountAuthenticator {
    ...
    public C3325m(Context mContext) {
        ...
        this.f34489a = mContext;
    }

    @Override // android.accounts.AbstractAccountAuthenticator
    public Bundle addAccount(AccountAuthenticatorResponse accountAuthenticatorResponse, String str, String str2, String[] strArr, Bundle bundle) {
        Intent intent = new Intent(this.f34489a, (Class<?>) LoginActivity.class);
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) {
        ...
        AbstractC3159y.i(options, "options");
        AccountManager accountManager = AccountManager.get(this.f34489a);
        ...
        if (TextUtils.isEmpty(peekAuthToken) && (password = accountManager.getPassword(account)) != null) {
            ...
            C3312F c3312f = new C3312F(this.f34489a);
                ...
                if (A02.d() != null) {
                    ...
                    if (d8.length() > 0) {
                        ...
                        if (!jSONObject.isNull(DataSchemeDataSource.SCHEME_DATA)) {
                            ...
                            String J8 = SettingsPreferences.f29309b.J(this.f34489a);
