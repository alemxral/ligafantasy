...
public final class C3330r {
    ...
    private FirebaseAnalytics f34514b;

    public C3330r(Context context) {
        this.f34513a = context;
        if (context != null && SettingsPreferences.f29309b.M(context)) {
            this.f34514b = FirebaseAnalytics.getInstance(context);
        } else {
            this.f34514b = null;
        }
    }
    ...
    public final void a(String event) {
        ...
        FirebaseAnalytics firebaseAnalytics = this.f34514b;
    ...
    public final void b(String event, Bundle params) {
        ...
        C1506p.f12685d.g(event, params, this.f34513a);
    }
    ...
    public final void f() {
        if (this.f34513a != null) {
            com.google.firebase.crashlytics.a.a().c(SettingsPreferences.f29309b.Q(this.f34513a));
        }
    }
}
