...
public final class D implements Collection, Y5.a {
    ...
    public static final class a implements Iterator, Y5.a {
        ...
        public long b() {
            int i8 = this.f6467b;
            long[] jArr = this.f6466a;
            if (i8 < jArr.length) {
                this.f6467b = i8 + 1;
                return C.b(jArr[i8]);
            }
            throw new NoSuchElementException(String.valueOf(this.f6467b));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f6467b < this.f6466a.length) {
                return true;
            }
            return false;
        }
    ...
    public boolean containsAll(Collection elements) {
        AbstractC3159y.i(elements, "elements");
        return m(this.f6465a, elements);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return p(this.f6465a, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return t(this.f6465a);
    }

    public boolean i(long j8) {
        return l(this.f6465a, j8);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return u(this.f6465a);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return v(this.f6465a);
    }

    @Override // java.util.Collection
    /* renamed from: r, reason: merged with bridge method [inline-methods] */
    public int size() {
        return s(this.f6465a);
    }
