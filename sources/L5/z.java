...
public final class z implements Collection, Y5.a {
    ...
    public static final class a implements Iterator, Y5.a {
        ...
        public byte b() {
            int i8 = this.f6516b;
            byte[] bArr = this.f6515a;
            if (i8 < bArr.length) {
                this.f6516b = i8 + 1;
                return y.b(bArr[i8]);
            }
            throw new NoSuchElementException(String.valueOf(this.f6516b));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f6516b < this.f6515a.length) {
                return true;
            }
            return false;
        }
    ...
    public boolean containsAll(Collection elements) {
        AbstractC3159y.i(elements, "elements");
        return m(this.f6514a, elements);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return p(this.f6514a, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return t(this.f6514a);
    }

    public boolean i(byte b8) {
        return l(this.f6514a, b8);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return u(this.f6514a);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return v(this.f6514a);
    }

    @Override // java.util.Collection
    /* renamed from: r, reason: merged with bridge method [inline-methods] */
    public int size() {
        return s(this.f6514a);
    }
