...
public abstract class d {
    ...
    public static final class a extends AbstractC3160z implements n {
        ...
        final /* synthetic */ Function0 f2465b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Modifier f2466c;
        ...
        public final void invoke(Composer composer, int i8) {
            d.a(this.f2464a, this.f2465b, this.f2466c, this.f2467d, composer, RecomposeScopeImplKt.updateChangedFlags(this.f2468e | 1), this.f2469f);
        }
    }
    ...
    public static final class b extends AbstractC3160z implements n {
        ...
        public static final class a extends AbstractC3160z implements n {
            ...
            public final void invoke(Composer composer, int i8) {
                ...
                IconButtonKt.IconButton(this.f2471a, null, false, null, F3.a.f2444a.c(), composer, 24576, 14);
                if (ComposerKt.isTraceInProgress()) {
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            AppBarKt.m1107TopAppBarxWeB9s(F3.a.f2444a.b(), null, ComposableLambdaKt.composableLambda(composer, -1411609844, true, new a(this.f2470a)), null, MaterialTheme.INSTANCE.getColors(composer, MaterialTheme.$stable).m1182getSurface0d7_KjU(), 0L, Dp.m5178constructorimpl(0), composer, 1573254, 42);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final class c extends AbstractC3160z implements n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Modifier f2473b;
        ...
        public final void invoke(Composer composer, int i8) {
            d.b(this.f2472a, this.f2473b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f2474c | 1), this.f2475d);
        }
    }
    ...
    public static final class C0042d extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.paymentsheet.paymentdatacollection.polling.b f2476a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ LifecycleOwner f2477b;
        ...
        public static final class a implements DisposableEffectResult {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ LifecycleOwner f2478a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ F3.c f2479b;

            public a(LifecycleOwner lifecycleOwner, F3.c cVar) {
                this.f2478a = lifecycleOwner;
                this.f2479b = cVar;
            }

            @Override // androidx.compose.runtime.DisposableEffectResult
            public void dispose() {
                this.f2478a.getLifecycle().removeObserver(this.f2479b);
            }
        }
        ...
        C0042d(com.stripe.android.paymentsheet.paymentdatacollection.polling.b bVar, LifecycleOwner lifecycleOwner) {
            super(1);
            this.f2476a = bVar;
            this.f2477b = lifecycleOwner;
        }

        @Override // kotlin.jvm.functions.Function1
        public final DisposableEffectResult invoke(DisposableEffectScope DisposableEffect) {
            AbstractC3159y.i(DisposableEffect, "$this$DisposableEffect");
            F3.c cVar = new F3.c(this.f2476a);
            this.f2477b.getLifecycle().addObserver(cVar);
            return new a(this.f2477b, cVar);
        }
    }
    ...
    public static final class f extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.paymentsheet.paymentdatacollection.polling.b f2480a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Modifier f2481b;
        ...
        public final void invoke(Composer composer, int i8) {
            d.d(this.f2480a, this.f2481b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f2482c | 1), this.f2483d);
        }
    }
    ...
    public static final class g extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ F3.f f2484a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function0 f2485b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Modifier f2486c;
        ...
        g(F3.f fVar, Function0 function0, Modifier modifier, int i8, int i9) {
            super(2);
            this.f2484a = fVar;
            this.f2485b = function0;
            this.f2486c = modifier;
            this.f2487d = i8;
            this.f2488e = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            d.c(this.f2484a, this.f2485b, this.f2486c, composer, RecomposeScopeImplKt.updateChangedFlags(this.f2487d | 1), this.f2488e);
        }
    }
    ...
    public /* synthetic */ class h {
        ...
        static {
            ...
            try {
                iArr[F3.e.f2490a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[F3.e.f2491b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[F3.e.f2493d.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[F3.e.f2492c.ordinal()] = 4;
    ...
    */
    ...
    public static final void c(F3.f fVar, Function0 function0, Modifier modifier, Composer composer, int i8, int i9) {
        ...
        if ((i10 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            int i15 = h.f2489a[fVar.e().ordinal()];
