...
public abstract class AbstractC3087m {
    ...
    private static final long f33228a = ColorKt.Color(4280595582L);

    /* renamed from: b, reason: collision with root package name */
    private static final ProvidableCompositionLocal f33229b = CompositionLocalKt.staticCompositionLocalOf(a.f33233a);

    /* renamed from: c, reason: collision with root package name */
    private static final ProvidableCompositionLocal f33230c = CompositionLocalKt.staticCompositionLocalOf(c.f33235a);

    /* renamed from: d, reason: collision with root package name */
    private static final ProvidableCompositionLocal f33231d = CompositionLocalKt.staticCompositionLocalOf(d.f33236a);

    /* renamed from: e, reason: collision with root package name */
    private static final ProvidableCompositionLocal f33232e = CompositionLocalKt.staticCompositionLocalOf(b.f33234a);
    ...
    static final class a extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final a f33233a = new a();
    ...
    public static final class e extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ C3082h f33237a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ n f33238b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ C3084j f33239c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ X5.n f33240d;
        ...
        public static final class a extends AbstractC3160z implements X5.n {
            ...
            public static final class C0769a extends AbstractC3160z implements X5.n {
                ...
                public final void invoke(Composer composer, int i8) {
                    ...
                    this.f33242a.invoke(composer, 0);
                    if (ComposerKt.isTraceInProgress()) {
            ...
            public final void invoke(Composer composer, int i8) {
                ...
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{TextKt.getLocalTextStyle().provides(AbstractC3087m.t((TextStyle) composer.consume(TextKt.getLocalTextStyle())))}, ComposableLambdaKt.composableLambda(composer, 734609044, true, new C0769a(this.f33241a)), composer, 56);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            MaterialThemeKt.MaterialTheme(this.f33237a.g(), AbstractC3087m.v(this.f33238b, composer, 0), AbstractC3087m.u(this.f33239c, composer, 0).a(), ComposableLambdaKt.composableLambda(composer, -1485460652, true, new a(this.f33240d)), composer, 3072, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final class f extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ C3082h f33243a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C3084j f33244b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ n f33245c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ X5.n f33246d;
        ...
        public final void invoke(Composer composer, int i8) {
            AbstractC3087m.a(this.f33243a, this.f33244b, this.f33245c, this.f33246d, composer, RecomposeScopeImplKt.updateChangedFlags(this.f33247e | 1), this.f33248f);
        }
    }
    ...
    */
    ...
    public static final C3082h n(MaterialTheme materialTheme, Composer composer, int i8) {
        ...
        C3082h c3082h = (C3082h) composer.consume(f33229b);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return c3082h;
    ...
    public static final C3084j o(MaterialTheme materialTheme, Composer composer, int i8) {
        ...
        C3084j c3084j = (C3084j) composer.consume(f33230c);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return c3084j;
    ...
    public static final n p(MaterialTheme materialTheme, Composer composer, int i8) {
        ...
        n nVar = (n) composer.consume(f33231d);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return nVar;
