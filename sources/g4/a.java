...
public final class a {
    ...
    public static final C0049a f3194b = new C0049a(null);
    ...
    private final void K(String str, String str2) {
        try {
            SharedPreferences.Editor edit = this.f3195a.getSharedPreferences("CoreSettings", 0).edit();
    ...
    private final boolean d(String str, boolean z8) {
        try {
            SharedPreferences sharedPreferences = this.f3195a.getSharedPreferences("CoreSettings", 0);
    ...
    public final Object b() {
        ...
        if (g8 != null) {
            if (n() && (n8 = new f().n(this.f3195a)) != null) {
                DocumentFile fromTreeUri = DocumentFile.fromTreeUri(this.f3195a, n8);
                if (fromTreeUri != null) {
    ...
    public final void h() {
        boolean z8;
        boolean e8 = new v(this.f3195a, null).e();
