...
public final class C2553q {
    ...
    private final b f30133a;

    /* renamed from: b, reason: collision with root package name */
    private final Handler f30134b;
    ...
    public C2553q(b youTubePlayerOwner) {
        ...
        this.f30133a = youTubePlayerOwner;
        this.f30134b = new Handler(Looper.getMainLooper());
    }
    ...
    public static final void p(C2553q this$0) {
        ...
        Iterator it = this$0.f30133a.getListeners().iterator();
        while (it.hasNext()) {
            ((e2.c) it.next()).f(this$0.f30133a.getInstance());
        }
    }
    ...
    public static final void q(C2553q this$0, EnumC2539c playerError) {
        ...
        Iterator it = this$0.f30133a.getListeners().iterator();
        while (it.hasNext()) {
            ((e2.c) it.next()).c(this$0.f30133a.getInstance(), playerError);
        }
    }
    ...
    public static final void r(C2553q this$0, EnumC2537a playbackQuality) {
        ...
        Iterator it = this$0.f30133a.getListeners().iterator();
        while (it.hasNext()) {
            ((e2.c) it.next()).b(this$0.f30133a.getInstance(), playbackQuality);
        }
    }
    ...
    public static final void s(C2553q this$0, EnumC2538b playbackRate) {
        ...
        Iterator it = this$0.f30133a.getListeners().iterator();
        while (it.hasNext()) {
            ((e2.c) it.next()).d(this$0.f30133a.getInstance(), playbackRate);
        }
    }
    ...
    public static final void t(C2553q this$0) {
        ...
        Iterator it = this$0.f30133a.getListeners().iterator();
        while (it.hasNext()) {
            ((e2.c) it.next()).g(this$0.f30133a.getInstance());
        }
    }
    ...
    public static final void u(C2553q this$0, EnumC2540d playerState) {
        ...
        Iterator it = this$0.f30133a.getListeners().iterator();
        while (it.hasNext()) {
            ((e2.c) it.next()).j(this$0.f30133a.getInstance(), playerState);
        }
    }
    ...
    public static final void v(C2553q this$0, float f8) {
        ...
        Iterator it = this$0.f30133a.getListeners().iterator();
        while (it.hasNext()) {
            ((e2.c) it.next()).i(this$0.f30133a.getInstance(), f8);
        }
    }
    ...
    public static final void w(C2553q this$0, float f8) {
        ...
        Iterator it = this$0.f30133a.getListeners().iterator();
        while (it.hasNext()) {
            ((e2.c) it.next()).a(this$0.f30133a.getInstance(), f8);
        }
    }
    ...
    public static final void x(C2553q this$0, String videoId) {
        ...
        Iterator it = this$0.f30133a.getListeners().iterator();
        while (it.hasNext()) {
            ((e2.c) it.next()).h(this$0.f30133a.getInstance(), videoId);
        }
    }
    ...
    public static final void y(C2553q this$0, float f8) {
        ...
        Iterator it = this$0.f30133a.getListeners().iterator();
        while (it.hasNext()) {
            ((e2.c) it.next()).e(this$0.f30133a.getInstance(), f8);
        }
    }
    ...
    public final boolean sendApiChange() {
        return this.f30134b.post(new Runnable() { // from class: d2.l
    ...
    public final void sendError(String error) {
        ...
        this.f30134b.post(new Runnable() { // from class: d2.o
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void sendPlaybackQualityChange(String quality) {
        ...
        this.f30134b.post(new Runnable() { // from class: d2.h
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void sendPlaybackRateChange(String rate) {
        ...
        this.f30134b.post(new Runnable() { // from class: d2.j
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final boolean sendReady() {
        return this.f30134b.post(new Runnable() { // from class: d2.m
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void sendStateChange(String state) {
        ...
        this.f30134b.post(new Runnable() { // from class: d2.p
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void sendVideoCurrentTime(String seconds) {
        ...
        try {
            ...
            this.f30134b.post(new Runnable() { // from class: d2.f
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public final void sendVideoDuration(String seconds) {
        ...
        try {
            ...
            final float parseFloat = Float.parseFloat(seconds);
            this.f30134b.post(new Runnable() { // from class: d2.i
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public final boolean sendVideoId(final String videoId) {
        AbstractC3159y.i(videoId, "videoId");
        return this.f30134b.post(new Runnable() { // from class: d2.k
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void sendVideoLoadedFraction(String fraction) {
        ...
        try {
            ...
            this.f30134b.post(new Runnable() { // from class: d2.n
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public final boolean sendYouTubeIFrameAPIReady() {
        return this.f30134b.post(new Runnable() { // from class: d2.g
            @Override // java.lang.Runnable
            public final void run() {
