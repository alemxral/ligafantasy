...
public abstract class b extends FragmentActivity {
    ...
    private UptodownApp f31389a;

    /* renamed from: b, reason: collision with root package name */
    private C3330r f31390b;
    ...
    public final class a implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final C1505o f31392a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ b f31393b;

        public a(b bVar, C1505o download) {
            AbstractC3159y.i(download, "download");
            this.f31393b = bVar;
            this.f31392a = download;
        }

        @Override // java.lang.Runnable
        public void run() {
            List<Fragment> fragments = this.f31393b.getSupportFragmentManager().getFragments();
            AbstractC3159y.h(fragments, "supportFragmentManager.fragments");
            if (fragments.size() > 0) {
                Fragment fragment = fragments.get(0);
                String string = this.f31393b.getString(R.string.tv_msg_download_complete, this.f31392a.X());
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f31389a = (UptodownApp) application;
        this.f31390b = new C3330r(this);
        C3307A.f34459a.d().add(this);
    }
    ...
    public void onPause() {
        super.onPause();
        this.f31391c = false;
        UptodownApp uptodownApp = this.f31389a;
