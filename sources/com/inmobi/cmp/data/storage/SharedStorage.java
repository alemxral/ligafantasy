...
public class SharedStorage {
    ...
    public SharedPreferences f17832a;
    ...
    public SharedStorage(Application app) {
        ...
        this.f17832a = defaultSharedPreferences;
    }
    ...
    public static void f(SharedStorage sharedStorage, int i8, h explicitNotice, h optOut, h coveredTransaction, int i9, Object obj) {
        ...
        String str = i8 + explicitNotice.f2384a + optOut.f2384a + coveredTransaction.f2384a;
    ...
    public final void b(a preferenceKey) {
        ...
        SharedPreferences.Editor editor = this.f17832a.edit();
        AbstractC3159y.h(editor, "editor");
        editor.remove(preferenceKey.f7604a);
        editor.apply();
    }
    ...
    public final void c(a preferenceKey, int i8) {
        ...
        SharedPreferences.Editor editor = this.f17832a.edit();
        AbstractC3159y.h(editor, "editor");
        editor.putInt(preferenceKey.f7604a, i8);
        editor.apply();
    }
    ...
    public final void e(a preferenceKey, String value) {
        ...
        SharedPreferences.Editor editor = this.f17832a.edit();
        AbstractC3159y.h(editor, "editor");
        editor.putString(preferenceKey.f7604a, value);
        editor.apply();
    }
    ...
    public final boolean h(a preferenceKey) {
        AbstractC3159y.i(preferenceKey, "preferenceKey");
        return this.f17832a.getBoolean(preferenceKey.f7604a, false);
    }

    public final int i(a preferenceKey) {
        AbstractC3159y.i(preferenceKey, "preferenceKey");
        return this.f17832a.getInt(preferenceKey.f7604a, 0);
    }

    public final String j(a preferenceKey) {
        AbstractC3159y.i(preferenceKey, "preferenceKey");
        String string = this.f17832a.getString(preferenceKey.f7604a, "");
        if (string == null) {
            return "";
        }
        return string;
