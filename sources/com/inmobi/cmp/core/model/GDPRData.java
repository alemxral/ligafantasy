...
public final class GDPRData {
            ...
            if (1 <= a8) {
                while (true) {
                    ...
                    for (i iVar : jVar.b(Integer.valueOf(i8))) {
                        if (!linkedHashMap.containsKey(String.valueOf(iVar.f39881a))) {
                            linkedHashMap.put(String.valueOf(iVar.f39881a), new LinkedHashMap());
                        }
                        Map map = (Map) linkedHashMap.get(String.valueOf(iVar.f39881a));
                        if (map != null) {
                        }
                    }
                    if (i8 == a8) {
    ...
    private final int getPublisherVendorId() {
        Vector vector;
        s sVar = C3590a.f36947c;
        if (sVar == null || (vector = sVar.f39932t) == null || vector.isEmpty()) {
            return -1;
        }
    ...
    public GDPRData(Set<Integer> set) {
        ...
        int i8 = privacyEncodingMode == null ? -1 : a.f17825a[privacyEncodingMode.ordinal()];
        if (i8 == 1) {
            c3590a.e(v.f39942a.a(f8, new f(Boolean.TRUE, 2, AbstractC1246t.s(l.CORE))));
            setTcString(c3590a.g());
        } else if (i8 != 2) {
            c3590a.e(v.f39942a.a(f8, new f(Boolean.TRUE, 2, AbstractC1246t.s(l.CORE))));
            setTcString(c3590a.g());
            c3590a.b(AbstractC3997d.f39869a.a(f8));
