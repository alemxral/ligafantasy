...
public final class Vector {
    ...
    public Map<Integer, Boolean> f17826a;
    ...
    public static final class c extends AbstractC3160z implements n {
        ...
        /* renamed from: b, reason: collision with root package name */
        public final /* synthetic */ Vector f17831b;
    ...
    public final boolean contains(int i8) {
        return this.f17826a.containsKey(Integer.valueOf(i8));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof Vector) && AbstractC3159y.d(this.f17826a, ((Vector) obj).f17826a);
    }

    public final void forEach(n action) {
        AbstractC3159y.i(action, "action");
        for (Map.Entry<Integer, Boolean> entry : this.f17826a.entrySet()) {
            action.invoke(entry.getKey(), entry.getValue());
        }
    }

    public final Boolean get(int i8) {
        return this.f17826a.get(Integer.valueOf(i8));
    }
    ...
    public final int getMaxId() {
        Integer num = (Integer) AbstractC1246t.A0(this.f17826a.keySet());
        if (num == null) {
            return 0;
        }
        return num.intValue();
    ...
    public final void set(int i8) {
        this.f17826a.put(Integer.valueOf(i8), Boolean.TRUE);
    }

    public final void setAllOwnedItems() {
        Iterator<Map.Entry<Integer, Boolean>> it = this.f17826a.entrySet().iterator();
        while (it.hasNext()) {
    ...
    public String toString() {
        ...
        a8.append(this.f17826a);
        a8.append(')');
        return a8.toString();
    }

    public final void unset(int i8) {
        this.f17826a.put(Integer.valueOf(i8), Boolean.FALSE);
        this.f17827b = 0;
    }
