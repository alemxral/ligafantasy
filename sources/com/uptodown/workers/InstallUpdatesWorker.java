...
public final class InstallUpdatesWorker extends Worker {
    ...
    public static final class a {
        ...
        private final boolean a(Context context) {
            ...
            if ((!Y7 && !z8) || UptodownApp.f27990B.W("InstallUpdatesWorker", context)) {
                return false;
            }
            return true;
        }
        ...
        public final void b(Context context) {
            ...
            if (a(context)) {
                ...
                UploadFileWorker.f30065c.a(context);
            }
        }
    ...
    public InstallUpdatesWorker(Context context, WorkerParameters params) {
        ...
        this.f30029a = j.f2272g.a(context);
    }
    ...
    public ListenableWorker.Result doWork() {
        ...
        SettingsPreferences.a aVar = SettingsPreferences.f29309b;
        boolean Y7 = aVar.Y(this.f30029a);
        if (aVar.O(this.f30029a) || Y7) {
            C1509t.f12698e.a(this.f30029a);
            File g8 = new C3329q().g(this.f30029a);
            ...
            boolean x8 = new C3319g().x(this.f30029a);
            ...
            while (true) {
                ...
                O o9 = (O) it2.next();
                if (o9.f() == 0 && o9.j() != null && o9.o() == 100 && (S7 = a8.S(o9.n())) != null && c(this.f30029a, S7)) {
                    String j9 = o9.j();
                    AbstractC3159y.f(j9);
                    ...
                    if (file2.exists()) {
                        ...
                        if (Y7) {
                            ...
                            if (n.q(j10, ".apk", true)) {
                                UptodownApp.a.Z(UptodownApp.f27990B, file2, this.f30029a, null, 4, null);
                                break;
                            }
                        } else if (x8) {
                            continue;
                            ...
                            try {
                                PackageManager packageManager = this.f30029a.getPackageManager();
                            ...
                            if (packageInfo != null) {
                                h hVar = new h(this.f30029a, null);
                                if (!hVar.y(packageInfo.applicationInfo.targetSdkVersion)) {
                                    continue;
                                } else {
                                    if (AbstractC3159y.d(this.f30029a.getPackageName(), new C3319g().h(this.f30029a, o9.n()))) {
            ...
            a8.g();
            if (!z8) {
                UploadFileWorker.f30065c.a(this.f30029a);
            }
        }
