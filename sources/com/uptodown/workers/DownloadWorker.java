...
public class DownloadWorker extends Worker {
    ...
    /* renamed from: d */
    private static boolean f30006d;

    /* renamed from: e */
    private static boolean f30007e;

    /* renamed from: f */
    private static boolean f30008f;

    /* renamed from: g */
    private static boolean f30009g;

    /* renamed from: h */
    private static boolean f30010h;

    /* renamed from: a */
    private Context f30011a;

    /* renamed from: b */
    private C3330r f30012b;
    ...
    public static final class a {
        ...
        public final boolean a() {
            return DownloadWorker.f30006d;
        }

        public final boolean b() {
            return DownloadWorker.f30008f;
        }

        public final boolean c() {
            return DownloadWorker.f30007e;
        }

        public final boolean d() {
            return DownloadWorker.f30009g;
        }

        public final boolean e() {
            return DownloadWorker.f30010h;
        }
        ...
        public final void j(boolean z8) {
            DownloadWorker.f30006d = z8;
        }

        public final void k(boolean z8) {
            DownloadWorker.f30008f = z8;
        }

        public final void l(boolean z8) {
            DownloadWorker.f30007e = z8;
        }

        public final void m(boolean z8) {
            DownloadWorker.f30009g = z8;
        }

        public final void n(boolean z8) {
            DownloadWorker.f30010h = z8;
        }
    ...
    private final void E(O o8, String str, String str2, long j8) {
        if (o8 != null) {
            ...
            C3307A.f34459a.g().send(102, bundle);
    ...
    */
    ...
    public final Bundle k(long j8, long j9, File file, long j10, String filehashExpected) {
        ...
        if (file.length() > 0) {
            ...
            while (!z8 && i8 < 3) {
                i8++;
                if (file.length() == j11 && (str = d.f7188a.e(file.getAbsolutePath())) != null && n.s(str, filehashExpected, true)) {
                    z8 = true;
                }
            }
            if (str == null) {
    ...
    public final void w() {
        Context a8 = j.f2272g.a(this.f30011a);
        this.f30011a = a8;
        this.f30012b = new C3330r(a8);
    }
