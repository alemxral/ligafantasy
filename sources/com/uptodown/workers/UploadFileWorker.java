...
public final class UploadFileWorker extends Worker {
    ...
    public static final a f30065c = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private Context f30066a;

    /* renamed from: b, reason: collision with root package name */
    private final C3330r f30067b;
    ...
    public UploadFileWorker(Context context, WorkerParameters params) {
        ...
        this.f30067b = new C3330r(context);
        this.f30066a = j.f2272g.a(this.f30066a);
    }

    private final String a(String str, ArrayList arrayList) {
        PackageManager pm = this.f30066a.getPackageManager();
        ...
        while (it.hasNext()) {
            ...
            if (appAux.u() != null && n.s(appAux.u(), str, true)) {
                ...
                this.f30067b.b("upload", C3331s.f34515a.a(bundle));
                C3326n a9 = C3326n.f34490t.a(this.f30066a);
                a9.a();
                appAux.A0(h8);
            ...
            C3326n a10 = C3326n.f34490t.a(this.f30066a);
            a10.a();
            AbstractC3159y.h(appAux, "appAux");
            ...
            if (U7 != null) {
                ...
                while (it2.hasNext()) {
                    ...
                    if (n.s(str, rVar.b(), true) && rVar.a() != null) {
                        ...
                        this.f30067b.b("upload", C3331s.f34515a.a(bundle2));
                        return null;
                    }
                    pm = packageManager;
                }
        ...
        this.f30067b.b("upload", C3331s.f34515a.a(bundle3));
        return null;
    }

    private final String b() {
        Y4.d a8 = Y4.d.f13217a.a();
        if (new C3328p().c(this.f30066a) && c()) {
            C1504n c1504n = new C1504n();
            c1504n.h(this.f30066a);
            C3312F c3312f = new C3312F(this.f30066a, a8);
            String d8 = c1504n.d();
            AbstractC3159y.f(d8);
            I u8 = c3312f.u(d8);
            this.f30067b.e("getFileToUpload", null, u8, null);
    ...
    private final boolean c() {
        UptodownApp.a aVar = UptodownApp.f27990B;
        if (!aVar.V("DownloadUpdatesWorker", this.f30066a) && !aVar.V("downloadApkWorker", this.f30066a)) {
            return true;
        }
        return false;
    }
    ...
    private final boolean d(String str, String str2, Y4.d dVar) {
        boolean c8 = new C3328p().c(this.f30066a);
        if (c8 && c()) {
            ...
            if (file.exists()) {
                ...
                if (c3332t.f()) {
                    return C3439d.b(new C3439d(), this.f30066a, file, str2, dVar, false, 16, null);
                }
                if (c3332t.e()) {
                    P a8 = P.f12421c.a(this.f30066a);
                    if (length > 0 && length < a8.a(this.f30066a)) {
                        return new C3439d().a(this.f30066a, file, str2, dVar, true);
                    }
                    Bundle bundle = new Bundle();
                    bundle.putString("type", "ignored");
                    bundle.putString(CampaignEx.JSON_NATIVE_VIDEO_ERROR, "size");
                    C3331s c3331s = C3331s.f34515a;
                    bundle.putString("size", c3331s.d(length));
                    this.f30067b.b("upload", c3331s.a(bundle));
                } else {
                    Bundle bundle2 = new Bundle();
                    bundle2.putString("type", "ignored");
                    bundle2.putString(CampaignEx.JSON_NATIVE_VIDEO_ERROR, "connection");
                    C3331s c3331s2 = C3331s.f34515a;
                    bundle2.putString("size", c3331s2.d(length));
                    this.f30067b.b("upload", c3331s2.a(bundle2));
                }
            } else {
                Bundle bundle3 = new Bundle();
                bundle3.putString("type", "ignored");
            ...
            this.f30067b.b("upload", C3331s.f34515a.a(bundle4));
        }
        return false;
    }
    ...
    public ListenableWorker.Result doWork() {
        String b8 = b();
        if (b8 != null) {
            C3326n a8 = C3326n.f34490t.a(this.f30066a);
            a8.a();
            ArrayList V7 = a8.V();
            a8.g();
            String a9 = a(b8, V7);
            if (a9 != null && d(a9, b8, Y4.d.f13217a.a())) {
                UptodownApp.a.N0(UptodownApp.f27990B, this.f30066a, false, false, 6, null);
            }
        }
