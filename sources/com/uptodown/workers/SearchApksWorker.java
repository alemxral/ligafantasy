...
public final class SearchApksWorker extends Worker {
    ...
    public SearchApksWorker(Context context, WorkerParameters params) {
        ...
        this.f30057a = j.f2272g.a(context);
    }
    ...
    */
    private final boolean a(java.io.File r10, int r11) {
        /*
            ...
            r2 = -1
            if (r0 == 0) goto L58
            android.content.Context r0 = r9.f30057a     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L48
            ...
            if (r0 == 0) goto L4a
            android.content.Context r1 = r9.f30057a     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L46
        ...
        L58:
            ...
            N4.w r0 = new N4.w
            r0.<init>()
            android.content.Context r1 = r9.f30057a
            K4.f r0 = r0.e(r10, r1)
            if (r0 == 0) goto L8c
            long r6 = r0.b()
            android.content.Context r1 = r9.f30057a     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L89
    ...
    public ListenableWorker.Result doWork() {
        ...
        try {
            ArrayList o8 = new e().o(this.f30057a);
            C3326n a8 = C3326n.f34490t.a(this.f30057a);
            a8.a();
            ArrayList e02 = a8.e0();
