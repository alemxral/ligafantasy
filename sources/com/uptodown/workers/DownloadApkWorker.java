...
public final class DownloadApkWorker extends DownloadWorker {
    ...
    public static final a f29987k = new a(null);

    /* renamed from: l, reason: collision with root package name */
    private static C1505o f29988l;
    ...
    public static final class a {
        ...
        public final void a(long j8) {
            DownloadWorker.f30005c.j(c(j8));
        }

        public final C1505o b() {
            return DownloadApkWorker.f29988l;
        }

        public final boolean c(long j8) {
            if (DownloadApkWorker.f29988l != null) {
                C1505o c1505o = DownloadApkWorker.f29988l;
        ...
        public final boolean d(long j8, long j9) {
            if (DownloadApkWorker.f29988l != null) {
                ...
                AbstractC3159y.f(c1505o);
                if (c1505o.f() == j8) {
                    C1505o c1505o2 = DownloadApkWorker.f29988l;
        ...
        public final boolean f(Context context, int i8) {
            ...
            if (!UptodownApp.f27990B.W("downloadApkWorker", context)) {
    ...
    public static final class b implements DownloadWorker.b {
        ...
        final /* synthetic */ S f29991a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ S f29992b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ DownloadApkWorker f29993c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ T f29994d;

        b(S s8, S s9, DownloadApkWorker downloadApkWorker, T t8) {
            this.f29991a = s8;
            this.f29992b = s9;
            this.f29993c = downloadApkWorker;
            this.f29994d = t8;
        }
        ...
        public void a(int i8, long j8) {
            if (DownloadApkWorker.f29988l != null) {
                ...
                this.f29993c.setProgressAsync(builder.build());
                C1505o c1505o = DownloadApkWorker.f29988l;
                AbstractC3159y.f(c1505o);
                c1505o.F0(i8);
                C1505o c1505o2 = DownloadApkWorker.f29988l;
                AbstractC3159y.f(c1505o2);
                c1505o2.v0(j8);
                C3326n a8 = C3326n.f34490t.a(this.f29993c.s());
                a8.a();
                C1505o c1505o3 = DownloadApkWorker.f29988l;
                AbstractC3159y.f(c1505o3);
                a8.s1(c1505o3);
                a8.g();
                C3335w.f34532a.i(this.f29993c.s());
                if (!((File) this.f29994d.f33747a).exists()) {
                    DownloadWorker.f30005c.j(true);
                }
                DownloadApkWorker downloadApkWorker = this.f29993c;
                C1505o c1505o4 = DownloadApkWorker.f29988l;
        ...
        public void d(long j8) {
            this.f29992b.f33746a = j8;
            Bundle bundle = new Bundle();
            bundle.putString("type", "first_data");
            DownloadApkWorker downloadApkWorker = this.f29993c;
            downloadApkWorker.z(bundle, downloadApkWorker.f29990j);
        }
    ...
    public DownloadApkWorker(Context c8, WorkerParameters params) {
        ...
        this.f29989i = params.getInputData().getString("url");
    }
    ...
    */
    private final android.os.Bundle N(android.os.Bundle r7) {
        /*
            r6 = this;
            com.uptodown.UptodownApp$a r0 = com.uptodown.UptodownApp.f27990B
            X4.l r1 = r0.p()
            r2 = 1
            java.lang.String r3 = "deeplink"
            r4 = 0
            if (r1 == 0) goto L2a
            X4.o r1 = com.uptodown.workers.DownloadApkWorker.f29988l
            if (r1 == 0) goto L2a
            X4.l r0 = r0.p()
        ...
        L52:
            r7.putInt(r3, r4)
        L55:
            X4.j$a r0 = X4.C1500j.f12617n
            android.content.Context r1 = r6.s()
            X4.j r0 = r0.d(r1)
            java.lang.String r1 = "adView"
            if (r0 == 0) goto L79
            X4.o r2 = com.uptodown.workers.DownloadApkWorker.f29988l
            if (r2 == 0) goto L79
            int r3 = r0.m()
            int r2 = r2.G()
            if (r3 != r2) goto L79
        ...
        L79:
            ...
            r7.putString(r1, r0)
        L9a:
            java.lang.String r0 = r6.f29990j
            if (r0 == 0) goto La3
            java.lang.String r1 = "host"
            r7.putString(r1, r0)
        La3:
            X4.o r0 = com.uptodown.workers.DownloadApkWorker.f29988l
            if (r0 == 0) goto Le4
            kotlin.jvm.internal.AbstractC3159y.f(r0)
    ...
    private final void O() {
        C1505o c1505o;
        if (!C3332t.f34516a.d()) {
            C3307A.f34459a.f().send(209, null);
            return;
        }
        ...
        while (true) {
            if (it.hasNext()) {
                ...
                if (!c1505o.c(s()) && (SettingsPreferences.f29309b.c0(s()) || C3332t.f34516a.f() || c1505o.n() == 1)) {
                    break;
                }
            } else {
                c1505o = null;
    ...
    private final void Q(String str) {
        ...
        this.f29990j = I8.getURL().getHost();
        ...
        C1505o c1505o = f29988l;
        if (c1505o == null) {
            C1505o c1505o2 = new C1505o();
            f29988l = c1505o2;
            AbstractC3159y.f(c1505o2);
            c1505o2.D0(u8);
            C1505o c1505o3 = f29988l;
            AbstractC3159y.f(c1505o3);
            c1505o3.m0(s());
        } else {
            AbstractC3159y.f(c1505o);
        ...
        if (C(I8, currentTimeMillis)) {
            C1505o c1505o5 = f29988l;
            AbstractC3159y.f(c1505o5);
            if (new C3313a().c(new C3329q().k(s(), f8), c1505o5.a0() - ((File) t8.f33747a).length())) {
                C1505o c1505o6 = f29988l;
                AbstractC3159y.f(c1505o6);
                J(c1505o6, 200);
                C1505o c1505o7 = f29988l;
                AbstractC3159y.f(c1505o7);
                if (c1505o7.Y() != null) {
                    C3326n a8 = C3326n.f34490t.a(s());
                    a8.a();
                    C1505o c1505o8 = f29988l;
                    AbstractC3159y.f(c1505o8);
                    String Y7 = c1505o8.Y();
                    AbstractC3159y.f(Y7);
                    O u02 = a8.u0(Y7);
                    if (u02 != null) {
                        C1505o c1505o9 = f29988l;
                ...
                C1505o c1505o14 = f29988l;
                AbstractC3159y.f(c1505o14);
                J(c1505o14, 205);
                File file3 = (File) t8.f33747a;
                C1505o c1505o15 = f29988l;
                AbstractC3159y.f(c1505o15);
                long a02 = c1505o15.a0();
                C1505o c1505o16 = f29988l;
                ...
                if (s8.f33746a == 0) {
                    ...
                    if (currentTimeMillis2 > 0) {
                        s8.f33746a = n8 / currentTimeMillis2;
                    }
                }
                bundle3.putLong("speed", s8.f33746a);
                bundle3.putLong(TypedValues.TransitionType.S_DURATION, (System.currentTimeMillis() - currentTimeMillis) / 1000);
                z(bundle3, this.f29990j);
                if (new G4.a(s()).m()) {
                    UptodownApp.a.Z(UptodownApp.f27990B, (File) t8.f33747a, s(), null, 4, null);
                }
                C1505o c1505o19 = f29988l;
    ...
    */
    ...
    private final void U(C1505o c1505o) {
        ...
        C3307A.f34459a.f().send(ComposerKt.reuseKey, bundle);
    }

    private final void V(C1505o c1505o) {
        Bundle bundle = new Bundle();
        bundle.putParcelable("download", c1505o);
        C3307A.f34459a.f().send(ComposerKt.providerValuesKey, bundle);
    }
    ...
    public void J(C1505o download, int i8) {
        ...
        C3307A.f34459a.f().send(i8, bundle);
    }
    ...
    public ListenableWorker.Result doWork() {
        ...
        C3307A.f34459a.f().send(210, null);
    ...
    @Override // com.uptodown.workers.DownloadWorker
    public boolean x() {
        return DownloadWorker.f30005c.a();
    }
