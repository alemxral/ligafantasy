...
public final class UsernameTextView extends AppCompatTextView {
    ...
    public static final a f29975k = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private ValueAnimator f29976a;

    /* renamed from: b, reason: collision with root package name */
    private float f29977b;

    /* renamed from: c, reason: collision with root package name */
    private int[] f29978c;

    /* renamed from: d, reason: collision with root package name */
    private Integer f29979d;

    /* renamed from: e, reason: collision with root package name */
    private long f29980e;

    /* renamed from: f, reason: collision with root package name */
    private long f29981f;
    ...
    public static final class a {
        ...
        public final void a(UsernameTextView usernameTextView, boolean z8, String str) {
            ...
            b(usernameTextView);
            ValueAnimator valueAnimator = usernameTextView.f29976a;
            ...
            if (str != null) {
                switch (str.hashCode()) {
                    case 110843959:
                        if (str.equals("type1")) {
                            usernameTextView.f29980e = 4000L;
                            usernameTextView.f29981f = 1000L;
                            break;
                        }
                        break;
                    case 110843960:
                        if (str.equals("type2")) {
                            usernameTextView.f29980e = 6000L;
                            usernameTextView.f29981f = 3000L;
                            break;
                        }
                        break;
                    case 110843961:
                        if (str.equals("type3")) {
                            usernameTextView.f29980e = 5000L;
                            usernameTextView.f29981f = AdaptiveTrackSelection.DEFAULT_MIN_TIME_BETWEEN_BUFFER_REEVALUTATION_MS;
                            break;
                        }
                        break;
                }
        ...
        public final void b(UsernameTextView usernameTextView) {
            ...
            usernameTextView.f29976a = null;
            usernameTextView.f29977b = 0.0f;
            usernameTextView.f29978c = null;
            usernameTextView.f29979d = Integer.valueOf(ContextCompat.getColor(usernameTextView.getContext(), R.color.text_terciary));
            usernameTextView.f29980e = 0L;
            usernameTextView.f29981f = 0L;
            usernameTextView.f29982g = false;
            ...
            Integer num = usernameTextView.f29979d;
    ...
    public static final class b implements Runnable {
        ...
        public static final void b(UsernameTextView this$0, ValueAnimator it) {
            ...
            this$0.f29977b = ((Float) animatedValue).floatValue();
            this$0.invalidate();
        }

        @Override // java.lang.Runnable
        public void run() {
            ValueAnimator valueAnimator = UsernameTextView.this.f29976a;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            ...
            usernameTextView.f29976a = ofFloat;
            ValueAnimator valueAnimator2 = UsernameTextView.this.f29976a;
            if (valueAnimator2 != null) {
                valueAnimator2.start();
            }
            UsernameTextView.this.f29982g = true;
            Handler animationHandler = UsernameTextView.this.getAnimationHandler();
            if (animationHandler != null) {
                animationHandler.postDelayed(this, UsernameTextView.this.f29980e);
            }
        }
    }
    ...
    public final void l() {
        if (this.f29983h) {
            m();
            this.f29985j = new Handler(Looper.getMainLooper());
            b bVar = new b();
                ...
                switch (str.hashCode()) {
                    case 110843959:
                        if (str.equals("type1")) {
                            ...
                            this.f29978c = new int[]{color, ContextCompat.getColor(getContext(), R.color.turbo_username_type_1_2), color, color, color};
                            break;
                        }
                        break;
                    case 110843960:
                        if (str.equals("type2")) {
                            ...
                            this.f29978c = new int[]{color2, ContextCompat.getColor(getContext(), R.color.turbo_username_type_2_2), color2, color2, color2};
                            break;
                        }
                        break;
                    case 110843961:
                        if (str.equals("type3")) {
                            ...
                            this.f29978c = new int[]{color3, ContextCompat.getColor(getContext(), R.color.turbo_username_type_3_2), color3, color3, color3};
                            break;
                        }
                        break;
                }
            }
            Handler handler = this.f29985j;
            if (handler != null) {
                handler.post(bVar);
            }
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.f29978c != null) {
            ValueAnimator valueAnimator = this.f29976a;
            if (valueAnimator != null && valueAnimator.isRunning()) {
                float width = getWidth();
                int[] iArr = this.f29978c;
                AbstractC3159y.f(iArr);
                float f8 = this.f29977b;
    ...
    public UsernameTextView(Context context, AttributeSet attributeSet, int i8) {
        ...
        AbstractC3159y.i(context, "context");
        this.f29985j = new Handler(Looper.getMainLooper());
        this.f29979d = Integer.valueOf(getCurrentTextColor());
    }
}
