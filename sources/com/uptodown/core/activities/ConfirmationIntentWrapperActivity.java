...
public final class ConfirmationIntentWrapperActivity extends AppCompatActivity {
    ...
    public static final a f29466c = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private boolean f29467a;

    /* renamed from: b, reason: collision with root package name */
    private final ActivityResultLauncher f29468b;
    ...
    public ConfirmationIntentWrapperActivity() {
        ...
        this.f29468b = registerForActivityResult;
    }
    ...
    public static final void o(ConfirmationIntentWrapperActivity this$0, ActivityResult activityResult) {
        ...
        if (this$0.getPackageManager().getPackageInstaller().getSessionInfo(j.f2272g.k()) != null && r6.getProgress() >= 0.81d) {
            z8 = true;
        } else {
            z8 = false;
        }
        InterfaceC2854x b8 = h.f7202d.b();
        if (b8 != null) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            this.f29468b.launch((Intent) parcelableExtra);
        } catch (Exception e8) {
            e8.printStackTrace();
            p("installer_error");
            finish();
