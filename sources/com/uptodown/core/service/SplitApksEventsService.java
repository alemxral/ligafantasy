...
public final class SplitApksEventsService extends Service {
    ...
    public static final a f29783a = new a(null);
    ...
    */
    private final java.lang.String a(int r7, android.content.Intent r8) {
        ...
        L5a:
            ...
            if (r7 == 0) goto L74
            com.uptodown.core.service.SplitApksEventsService$a r8 = com.uptodown.core.service.SplitApksEventsService.f29783a
    ...
    public int onStartCommand(Intent intent, int i8, int i9) {
        ...
        if (intExtra != -1) {
            if (intExtra != 0) {
                ...
                InterfaceC2854x a10 = h.f7202d.a();
                if (a10 != null) {
                    a10.x(Boolean.TRUE);
                }
            }
