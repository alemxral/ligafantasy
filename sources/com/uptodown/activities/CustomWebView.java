...
public final class CustomWebView extends AbstractActivityC2489a {
    ...
    public static final a f28169Q = new a(null);
    ...
    public static final void a3(CustomWebView this$0, View view) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (extras != null) {
            if (extras.containsKey(CampaignEx.JSON_KEY_TITLE)) {
                this.f28170O = extras.getString(CampaignEx.JSON_KEY_TITLE);
            }
            if (extras.containsKey("url")) {
                this.f28171P = extras.getString("url");
            }
        }
