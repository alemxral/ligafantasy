...
public final class n extends ViewModel {
    ...
    private final l6.v f29240a;

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC3349K f29241b;

    /* renamed from: c, reason: collision with root package name */
    private final l6.v f29242c;

    /* renamed from: d, reason: collision with root package name */
    private final l6.v f29243d;

    /* loaded from: classes4.dex */
    public static final class a {

        /* renamed from: a, reason: collision with root package name */
        private final ArrayList f29244a;

        /* renamed from: b, reason: collision with root package name */
        private final ArrayList f29245b;
        ...
        public a(ArrayList downloads, ArrayList downloadsQueue) {
            ...
            this.f29244a = downloads;
            this.f29245b = downloadsQueue;
        }
        ...
        public boolean equals(Object obj) {
            ...
            a aVar = (a) obj;
            return AbstractC3159y.d(this.f29244a, aVar.f29244a) && AbstractC3159y.d(this.f29245b, aVar.f29245b);
        }
        ...
        public String toString() {
            return "MyDownloadsData(downloads=" + this.f29244a + ", downloadsQueue=" + this.f29245b + ')';
        }
    }
    ...
    public static final class d extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C1505o f29252b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Context f29253c;
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            return new d(this.f29252b, this.f29253c, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f29251a == 0) {
                ...
                if (aVar.d(this.f29252b.f(), this.f29252b.e0())) {
                    aVar.a(this.f29252b.f());
                }
                C3326n a8 = C3326n.f34490t.a(this.f29253c);
                a8.a();
                int x8 = a8.x(this.f29252b);
                a8.g();
                if (this.f29252b.e() != null) {
                    String e8 = this.f29252b.e();
                    AbstractC3159y.f(e8);
                    File file = new File(e8);
                    if (file.exists()) {
                        file.delete();
                    }
                } else if (this.f29252b.X() != null) {
                    File f8 = new C3329q().f(this.f29253c);
                    String X7 = this.f29252b.X();
                    AbstractC3159y.f(X7);
                ...
                boolean z8 = true;
                if (x8 == 1) {
                    Y4.e f9 = C3307A.f34459a.f();
                    Bundle bundle = new Bundle();
                    bundle.putParcelable("download", this.f29252b);
                    L5.I i8 = L5.I.f6474a;
    ...
    public static final class e extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ n f29256c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Context f29257d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ b f29258e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ boolean f29259f;
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new e(this.f29255b, this.f29256c, this.f29257d, this.f29258e, this.f29259f, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f29254a == 0) {
                L5.t.b(obj);
                if (this.f29255b) {
                    this.f29256c.f29240a.setValue(AbstractC3337y.a.f34533a);
                }
                this.f29256c.g(this.f29257d);
                ArrayList arrayList = new ArrayList();
                ArrayList arrayList2 = new ArrayList();
                File externalStoragePublicDirectory = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);
                File f8 = new C3329q().f(this.f29257d);
                C3326n a8 = C3326n.f34490t.a(this.f29257d);
                a8.a();
                ...
                a8.g();
                this.f29256c.m(arrayList2, this.f29258e, this.f29259f);
                this.f29256c.f29243d.setValue(arrayList);
                this.f29256c.f29242c.setValue(arrayList2);
                this.f29256c.f29240a.setValue(new AbstractC3337y.c(new a(arrayList2, arrayList)));
                return L5.I.f6474a;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
    ...
    public static final class f extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ b f29263d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ boolean f29264e;
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new f(this.f29262c, this.f29263d, this.f29264e, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f29260a == 0) {
                L5.t.b(obj);
                n nVar = n.this;
                ArrayList l8 = nVar.l((ArrayList) nVar.f29242c.getValue(), this.f29262c);
                n.this.m(l8, this.f29263d, this.f29264e);
                n nVar2 = n.this;
                n.this.f29240a.setValue(new AbstractC3337y.c(new a(l8, nVar2.l((ArrayList) nVar2.f29243d.getValue(), this.f29262c))));
                return L5.I.f6474a;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
    ...
    public n() {
        ...
        this.f29240a = a8;
        this.f29241b = a8;
        this.f29242c = AbstractC3351M.a(new ArrayList());
        this.f29243d = AbstractC3351M.a(new ArrayList());
    }
