...
public final class NotificationsPreferences extends g {
    ...
    public static final class a extends PreferenceFragmentCompat {
        ...
        private SwitchPreference f29301a;

        /* renamed from: b, reason: collision with root package name */
        private ListPreference f29302b;

        /* renamed from: c, reason: collision with root package name */
        private SwitchPreference f29303c;

        /* renamed from: d, reason: collision with root package name */
        private SwitchPreference f29304d;

        /* renamed from: e, reason: collision with root package name */
        private SwitchPreference f29305e;

        /* renamed from: f, reason: collision with root package name */
        private final int f29306f = 2;
        ...
        public static final class C0707a extends l implements n {
            ...
            public final Object invoke(M m8, d dVar) {
                return ((C0707a) create(m8, dVar)).invokeSuspend(I.f6474a);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                ListPreference listPreference = a.this.f29302b;
                ...
                a aVar = a.this;
                ListPreference listPreference3 = aVar.f29302b;
        ...
        private final void m() {
            ListPreference listPreference = this.f29302b;
            ...
            SwitchPreference switchPreference2 = this.f29303c;
            if (switchPreference2 == null) {
                AbstractC3159y.y("switchDownloadsNotifications");
                switchPreference2 = null;
            }
            switchPreference2.setEnabled(false);
            SwitchPreference switchPreference3 = this.f29304d;
            if (switchPreference3 == null) {
                AbstractC3159y.y("switchInstallationNotifications");
                switchPreference3 = null;
            }
            switchPreference3.setEnabled(false);
            SwitchPreference switchPreference4 = this.f29305e;
        ...
        public void onActivityResult(int i8, int i9, Intent intent) {
            ...
            if (i8 == 646) {
                ...
                SwitchPreference switchPreference = this.f29301a;
        ...
        public void onCreatePreferences(Bundle bundle, String str) {
            ...
            this.f29301a = (SwitchPreference) findPreference;
            ...
            this.f29302b = (ListPreference) findPreference2;
            ...
            this.f29303c = (SwitchPreference) findPreference3;
            ...
            this.f29304d = (SwitchPreference) findPreference4;
            ...
            this.f29305e = (SwitchPreference) findPreference5;
            SwitchPreference switchPreference = this.f29301a;
            ...
            SwitchPreference switchPreference3 = this.f29301a;
            if (switchPreference3 == null) {
                AbstractC3159y.y("switchNotifications");
                switchPreference3 = null;
            }
            ...
            ListPreference listPreference2 = this.f29302b;
            if (listPreference2 == null) {
                AbstractC3159y.y("lpNotificationsFrecuency");
                listPreference2 = null;
            }
            ListPreference listPreference3 = this.f29302b;
            if (listPreference3 == null) {
                AbstractC3159y.y("lpNotificationsFrecuency");
                listPreference3 = null;
            }
            listPreference2.setSummary(getString(R.string.updates_notification_permission_description, listPreference3.getEntry()));
            ListPreference listPreference4 = this.f29302b;
            ...
            if (UptodownApp.f27990B.S()) {
                ...
                SwitchPreference switchPreference5 = this.f29305e;
                if (switchPreference5 == null) {
                    AbstractC3159y.y("switchInstallableFilesNotifications");
                    switchPreference5 = null;
                }
                switchPreference5.setChecked(aVar2.p());
                SwitchPreference switchPreference6 = this.f29305e;
            ...
            if (i8 == 646) {
                ...
                if (getContext() != null) {
                    ...
                    if (Build.VERSION.SDK_INT >= 33) {
                        Context requireContext4 = requireContext();
                        AbstractC3159y.h(requireContext4, "requireContext()");
                        if (aVar2.B(requireContext4) >= this.f29306f) {
                            C3335w c3335w = C3335w.f34532a;
        ...
        public void onResume() {
            ...
            SwitchPreference switchPreference = null;
            if (a8) {
                SwitchPreference switchPreference2 = this.f29301a;
                if (switchPreference2 == null) {
                    AbstractC3159y.y("switchNotifications");
                } else {
