...
public final class TvOldVersionsFragment extends VerticalGridSupportFragment {
    ...
    private C1498h f29933a;

    /* renamed from: b, reason: collision with root package name */
    private C1496f f29934b;

    /* renamed from: c, reason: collision with root package name */
    private AlertDialog f29935c;
    ...
    public final class c implements OnItemViewClickedListener {
        ...
        public void onItemClicked(Presenter.ViewHolder viewHolder, Object obj, RowPresenter.ViewHolder viewHolder2, Row row) {
            if (obj instanceof z) {
                if (TvOldVersionsFragment.this.f29934b != null) {
                    long j8 = ((z) obj).j();
                    C1496f c1496f = TvOldVersionsFragment.this.f29934b;
                    AbstractC3159y.f(c1496f);
                    if (j8 == c1496f.f0()) {
                        return;
                    }
                }
                TvOldVersionsFragment.this.f29937e = null;
    ...
    public static final class d extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f29940b = obj;
            this.f29942d |= Integer.MIN_VALUE;
    ...
    public static final class e extends l implements n {
        ...
        public static final class a implements w {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ TvOldVersionsFragment f29945a;

            a(TvOldVersionsFragment tvOldVersionsFragment) {
                this.f29945a = tvOldVersionsFragment;
            }
            ...
            public void b(C1498h appInfo, C1496f c1496f) {
                ...
                this.f29945a.f29934b = c1496f;
                this.f29945a.f29933a = appInfo;
                if (this.f29945a.f29933a != null) {
                    C1498h c1498h = this.f29945a.f29933a;
                    AbstractC3159y.f(c1498h);
                    if (c1498h.w0() != null) {
                        TvOldVersionsFragment tvOldVersionsFragment = this.f29945a;
                        C1498h c1498h2 = tvOldVersionsFragment.f29933a;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f29943a == 0) {
                t.b(obj);
                if (TvOldVersionsFragment.this.f29933a != null && TvOldVersionsFragment.this.getContext() != null) {
                    C1498h c1498h = TvOldVersionsFragment.this.f29933a;
                    AbstractC3159y.f(c1498h);
                    if (c1498h.w0() != null) {
                        C1498h c1498h2 = TvOldVersionsFragment.this.f29933a;
                        AbstractC3159y.f(c1498h2);
                        ArrayList w02 = c1498h2.w0();
                        AbstractC3159y.f(w02);
                        if (w02.size() != 0) {
                            C1498h c1498h3 = TvOldVersionsFragment.this.f29933a;
                            ...
                            AbstractC3159y.h(requireContext, "requireContext()");
                            C1496f c1496f = TvOldVersionsFragment.this.f29934b;
                            C1498h c1498h4 = TvOldVersionsFragment.this.f29933a;
                    ...
                    C1496f c1496f2 = TvOldVersionsFragment.this.f29934b;
                    C1498h c1498h42 = TvOldVersionsFragment.this.f29933a;
    ...
    public static final class f extends l implements n {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f29946a == 0) {
                t.b(obj);
                try {
                    if (TvOldVersionsFragment.this.f29933a != null) {
                        C1498h c1498h = TvOldVersionsFragment.this.f29933a;
                        AbstractC3159y.f(c1498h);
                        if (c1498h.w0() != null) {
                            TvOldVersionsFragment tvOldVersionsFragment = TvOldVersionsFragment.this;
    ...
    private final void u(final String str) {
        AlertDialog alertDialog = this.f29935c;
        if (alertDialog != null) {
            alertDialog.dismiss();
        }
    ...
    */
    public final java.lang.Object z(P5.d r7) {
        ...
        L2d:
            ...
            throw r7
        L35:
            java.lang.Object r2 = r0.f29939a
    ...
    public final void G(int i8) {
        switch (i8) {
            ...
            case ComposerKt.providerValuesKey /* 203 */:
                b bVar3 = this.f29936d;
                AbstractC3159y.f(bVar3);
                b bVar4 = this.f29936d;
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (activity != null && (extras = activity.getIntent().getExtras()) != null) {
            if (extras.containsKey(MBridgeConstans.DYNAMIC_VIEW_WX_APP)) {
                ...
                this.f29934b = (C1496f) parcelable3;
            }
            if (extras.containsKey("appInfo")) {
                ...
                this.f29933a = (C1498h) parcelable;
                C3319g c3319g = new C3319g();
                Context requireContext = requireContext();
                AbstractC3159y.h(requireContext, "requireContext()");
                C1498h c1498h = this.f29933a;
                AbstractC3159y.f(c1498h);
                this.f29934b = c3319g.z(requireContext, c1498h.y0());
            }
        }
        if (this.f29934b != null) {
            C1496f c1496f = this.f29934b;
            AbstractC3159y.f(c1496f);
            this.f29936d = new b(new o(c1496f));
        } else if (this.f29933a != null) {
            C1498h c1498h2 = this.f29933a;
            AbstractC3159y.f(c1498h2);
            this.f29936d = new b(new o(c1498h2.y0()));
        }
        setAdapter(this.f29936d);
