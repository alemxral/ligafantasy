...
public final class TvMyDownloadsFragment extends VerticalGridSupportFragment implements BrowseSupportFragment.MainFragmentAdapterProvider {
    ...
    private ArrayObjectAdapter f29921a;

    /* renamed from: b, reason: collision with root package name */
    private AlertDialog f29922b;

    /* renamed from: c, reason: collision with root package name */
    private final BrowseSupportFragment.MainFragmentAdapter f29923c = new d(this);

    /* renamed from: d, reason: collision with root package name */
    private ArrayList f29924d = new ArrayList();
    ...
    public static final class c extends l implements n {
        ...
        public static final class a extends l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ TvMyDownloadsFragment f29929b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(TvMyDownloadsFragment tvMyDownloadsFragment, P5.d dVar) {
                super(2, dVar);
                this.f29929b = tvMyDownloadsFragment;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new a(this.f29929b, dVar);
            }
            ...
            if (i8 != 0) {
                ...
                try {
                    ...
                    if (TvMyDownloadsFragment.this.getContext() != null) {
                        ...
                        TvMyDownloadsFragment.this.f29924d = arrayList;
                    }
                } catch (Exception e10) {
                    e10.printStackTrace();
                }
    ...
    public final void o(final File file) {
        AlertDialog alertDialog = this.f29922b;
        if (alertDialog != null) {
            alertDialog.dismiss();
        }
    ...
    public static final void p(TvMyDownloadsFragment this$0, File file, View view) {
        ...
        AlertDialog alertDialog = this$0.f29922b;
        if (alertDialog != null) {
            alertDialog.dismiss();
        }
    }
    ...
    public static final void q(File file, TvMyDownloadsFragment this$0, View view) {
        ...
        if (file.delete()) {
            ...
            a8.A(name);
            a8.g();
            ArrayObjectAdapter arrayObjectAdapter = this$0.f29921a;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void r() {
        ArrayObjectAdapter arrayObjectAdapter = this.f29921a;
        AbstractC3159y.f(arrayObjectAdapter);
        arrayObjectAdapter.clear();
        ArrayList arrayList = this.f29924d;
        AbstractC3159y.f(arrayList);
        int size = arrayList.size();
        for (int i8 = 0; i8 < size; i8++) {
            ArrayObjectAdapter arrayObjectAdapter2 = this.f29921a;
            AbstractC3159y.f(arrayObjectAdapter2);
            ArrayList arrayList2 = this.f29924d;
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f29921a = arrayObjectAdapter;
    ...
    public final void u(int i8) {
        switch (i8) {
            ...
            case ComposerKt.providerValuesKey /* 203 */:
                ArrayObjectAdapter arrayObjectAdapter3 = this.f29921a;
                AbstractC3159y.f(arrayObjectAdapter3);
                ArrayObjectAdapter arrayObjectAdapter4 = this.f29921a;
