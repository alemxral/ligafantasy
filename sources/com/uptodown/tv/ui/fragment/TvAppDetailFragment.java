...
public final class TvAppDetailFragment extends DetailsSupportFragment {
    ...
    public static final a f29830r = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private C1498h f29831a;

    /* renamed from: d, reason: collision with root package name */
    private ArrayObjectAdapter f29834d;

    /* renamed from: e, reason: collision with root package name */
    private BackgroundManager f29835e;

    /* renamed from: f, reason: collision with root package name */
    private AlertDialog f29836f;

    /* renamed from: g, reason: collision with root package name */
    private AlertDialog f29837g;

    /* renamed from: h, reason: collision with root package name */
    private DetailsOverviewRow f29838h;
    ...
    private C2719b f29843m;

    /* renamed from: p, reason: collision with root package name */
    private boolean f29846p;

    /* renamed from: q, reason: collision with root package name */
    private final ActivityResultLauncher f29847q;
    ...
    private boolean f29844n = true;

    /* renamed from: o, reason: collision with root package name */
    private boolean f29845o = true;
    ...
    public static final class b extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ C1498h f29850c;
        ...
        public static final class a extends kotlin.coroutines.jvm.internal.l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ TvAppDetailFragment f29852b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ T f29853c;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(TvAppDetailFragment tvAppDetailFragment, T t8, P5.d dVar) {
                super(2, dVar);
                this.f29852b = tvAppDetailFragment;
                this.f29853c = t8;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new a(this.f29852b, this.f29853c, dVar);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.f29851a == 0) {
                    t.b(obj);
                    this.f29852b.o0((C1505o) this.f29853c.f33747a);
                    return I.f6474a;
                }
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new b(this.f29850c, dVar);
        }
    ...
    public static final class c implements r {
        ...
        static final class a extends kotlin.coroutines.jvm.internal.l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ TvAppDetailFragment f29856b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(TvAppDetailFragment tvAppDetailFragment, P5.d dVar) {
                super(2, dVar);
                this.f29856b = tvAppDetailFragment;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new a(this.f29856b, dVar);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i8 != 0) {
                    ...
                    t.b(obj);
                    TvAppDetailFragment tvAppDetailFragment = this.f29856b;
                    this.f29855a = 1;
        ...
        public void f(C1498h appInfo) {
            ...
            TvAppDetailFragment.this.f29831a = appInfo;
    ...
    public static final class d extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        public static final class b extends kotlin.coroutines.jvm.internal.l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ TvAppDetailFragment f29861b;
            ...
            public static final class a extends kotlin.coroutines.jvm.internal.l implements n {
                ...
                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ TvAppDetailFragment f29863b;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                a(TvAppDetailFragment tvAppDetailFragment, P5.d dVar) {
                    super(2, dVar);
                    this.f29863b = tvAppDetailFragment;
                }

                @Override // kotlin.coroutines.jvm.internal.a
                public final P5.d create(Object obj, P5.d dVar) {
                    return new a(this.f29863b, dVar);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i8 != 0) {
                        ...
                        t.b(obj);
                        TvAppDetailFragment tvAppDetailFragment = this.f29863b;
                        this.f29862a = 1;
            ...
            b(TvAppDetailFragment tvAppDetailFragment, P5.d dVar) {
                super(2, dVar);
                this.f29861b = tvAppDetailFragment;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new b(this.f29861b, dVar);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.f29860a == 0) {
                    t.b(obj);
                    if (this.f29861b.getContext() != null) {
                        C2719b c2719b = this.f29861b.f29843m;
                        AbstractC3159y.f(c2719b);
                        Context requireContext = this.f29861b.requireContext();
                        AbstractC3159y.h(requireContext, "requireContext()");
                        c2719b.b(requireContext, this.f29861b.f29831a);
                    }
                    this.f29861b.L0();
                    d8 = AbstractC2829k.d(LifecycleOwnerKt.getLifecycleScope(this.f29861b), null, null, new a(this.f29861b, null), 3, null);
                    return d8;
                }
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
        ...
        public static final class a extends kotlin.coroutines.jvm.internal.l implements n {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.f29866a == 0) {
                    t.b(obj);
                    try {
                        C2719b c2719b = this.f29867b.f29843m;
                        AbstractC3159y.f(c2719b);
                        c2719b.a(this.f29867b.getContext(), this.f29867b.f29831a);
                    } catch (Exception e8) {
                        e8.printStackTrace();
                    }
                    return I.f6474a;
            ...
            if (i9 != 0) {
                ...
                try {
                    if (TvAppDetailFragment.this.getContext() != null) {
                        ...
                        if (TvAppDetailFragment.this.f29831a != null) {
                            C1498h c1498h = TvAppDetailFragment.this.f29831a;
                            ...
                            if (c1498h.N0() == null) {
                                ...
                                C1498h c1498h2 = TvAppDetailFragment.this.f29831a;
                                ...
                                C1498h c1498h3 = TvAppDetailFragment.this.f29831a;
    ...
    public static final class f implements r {
        ...
        public void c(int i8) {
            if (i8 == 404) {
                TvAppDetailFragment.this.f29846p = true;
            }
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f29871a == 0) {
                ...
                try {
                    ...
                    if (str != null) {
                        BackgroundManager backgroundManager = TvAppDetailFragment.this.f29835e;
                    ...
                    BackgroundManager backgroundManager2 = TvAppDetailFragment.this.f29835e;
    ...
    public static final class i extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ DetailsOverviewRow f29875c;
        ...
        public static final class a extends kotlin.coroutines.jvm.internal.l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ TvAppDetailFragment f29877b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(TvAppDetailFragment tvAppDetailFragment, P5.d dVar) {
                super(2, dVar);
                this.f29877b = tvAppDetailFragment;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new a(this.f29877b, dVar);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.f29876a == 0) {
                    t.b(obj);
                    this.f29877b.startEntranceTransition();
                    return I.f6474a;
                }
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
        ...
        i(DetailsOverviewRow detailsOverviewRow, P5.d dVar) {
            super(2, dVar);
            this.f29875c = detailsOverviewRow;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new i(this.f29875c, dVar);
        }
            ...
            if (i8 != 0) {
                ...
                try {
                    if (TvAppDetailFragment.this.getContext() != null) {
                        ...
                        if (str != null) {
                            DetailsOverviewRow detailsOverviewRow = this.f29875c;
    ...
    public static final class j implements InterfaceC2774b {
        ...
        static final class a extends kotlin.coroutines.jvm.internal.l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ TvAppDetailFragment f29880b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(TvAppDetailFragment tvAppDetailFragment, P5.d dVar) {
                super(2, dVar);
                this.f29880b = tvAppDetailFragment;
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i8 != 0) {
                    ...
                    t.b(obj);
                    TvAppDetailFragment tvAppDetailFragment = this.f29880b;
                    this.f29879a = 1;
                    if (tvAppDetailFragment.s0(this) == e8) {
                        return e8;
                    }
    ...
    public static final class k implements InterfaceC2774b {
        ...
        static final class a extends kotlin.coroutines.jvm.internal.l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ TvAppDetailFragment f29883b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(TvAppDetailFragment tvAppDetailFragment, P5.d dVar) {
                super(2, dVar);
                this.f29883b = tvAppDetailFragment;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new a(this.f29883b, dVar);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i8 != 0) {
                    ...
                    t.b(obj);
                    TvAppDetailFragment tvAppDetailFragment = this.f29883b;
                    DetailsOverviewRow detailsOverviewRow = tvAppDetailFragment.f29838h;
    ...
    public static final class l extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                t.b(obj);
                TvAppDetailFragment tvAppDetailFragment = TvAppDetailFragment.this;
                C1498h c1498h = tvAppDetailFragment.f29831a;
                this.f29884a = 1;
    ...
    public TvAppDetailFragment() {
        ...
        this.f29847q = registerForActivityResult;
    }
    ...
    private final void A0() {
        if (getActivity() != null) {
            if (this.f29833c != 2) {
                ...
                if (getActivity() != null && this.f29831a != null) {
                    String packageName = requireActivity().getPackageName();
                    C1498h c1498h = this.f29831a;
                    AbstractC3159y.f(c1498h);
                ...
                DetailsOverviewRow detailsOverviewRow = this.f29838h;
                AbstractC3159y.f(detailsOverviewRow);
                detailsOverviewRow.setActionsAdapter(sparseArrayObjectAdapter);
                this.f29833c = 2;
            }
            C2719b c2719b = this.f29843m;
            AbstractC3159y.f(c2719b);
            c2719b.c(0);
        }
    }
    ...
    private final void C0() {
        if (getActivity() != null && this.f29833c != 11) {
            SparseArrayObjectAdapter sparseArrayObjectAdapter = new SparseArrayObjectAdapter(new C2718a());
    ...
    private final void D0() {
        if (getActivity() != null && this.f29833c != 0) {
            SparseArrayObjectAdapter sparseArrayObjectAdapter = new SparseArrayObjectAdapter(new C2718a());
            if (getActivity() != null && this.f29831a != null) {
                String packageName = requireActivity().getPackageName();
                C1498h c1498h = this.f29831a;
    ...
    */
    private final void H0() {
        /*
            ...
            if (r1 == 0) goto Lbf
            X4.h r1 = r8.f29831a     // Catch: java.lang.Exception -> L31
            if (r1 == 0) goto Lbf
            ...
            X4.h r2 = r8.f29831a     // Catch: java.lang.Exception -> L31 java.lang.NumberFormatException -> L34
        ...
        L3a:
            ...
            X4.h r4 = r8.f29831a     // Catch: java.lang.Exception -> L31
        ...
        L90:
            ...
            androidx.leanback.widget.DetailsOverviewRow r2 = r8.f29838h     // Catch: java.lang.Exception -> L31
    ...
    private final void I0(final FragmentActivity fragmentActivity) {
        this.f29843m = new C2719b();
        FullWidthDetailsOverviewRowPresenter fullWidthDetailsOverviewRowPresenter = new FullWidthDetailsOverviewRowPresenter(this.f29843m, new C2720c());
        ...
        this.f29834d = arrayObjectAdapter;
    ...
    public static final void J0(TvAppDetailFragment this$0, FragmentActivity activity, Action action) {
        ...
        if (action.getId() == 3) {
            if (this$0.f29831a != null) {
                Intent intent = new Intent(activity, (Class<?>) TvOldVersionsActivity.class);
                intent.putExtra("appInfo", this$0.f29831a);
                this$0.startActivity(intent, UptodownApp.f27990B.a(activity));
                return;
            }
            return;
        }
        if (action.getId() == 4) {
            if (this$0.f29831a != null) {
                ...
                intent2.putExtra("appInfo", this$0.f29831a);
                this$0.startActivity(intent2, UptodownApp.f27990B.a(activity));
                return;
            }
            return;
        }
    ...
    private final void K0() {
        SparseArrayObjectAdapter sparseArrayObjectAdapter = new SparseArrayObjectAdapter(new C2718a());
        DetailsOverviewRow detailsOverviewRow = new DetailsOverviewRow(this.f29831a);
        this.f29838h = detailsOverviewRow;
        AbstractC3159y.f(detailsOverviewRow);
        detailsOverviewRow.setActionsAdapter(sparseArrayObjectAdapter);
        C1498h c1498h = this.f29831a;
        AbstractC3159y.f(c1498h);
    ...
    private final void M() {
        String str;
        if (this.f29831a != null && getContext() != null) {
    ...
    */
    public static final void P(com.uptodown.tv.ui.fragment.TvAppDetailFragment r11, android.content.DialogInterface r12, int r13) {
        ...
        Lc4:
            r12.g()
            if (r6 == 0) goto Lda
            com.uptodown.UptodownApp$a r5 = com.uptodown.UptodownApp.f27990B
    ...
    private final void R(final C1505o c1505o, String str) {
        AlertDialog alertDialog = this.f29836f;
        if (alertDialog != null) {
    ...
    private final boolean U() {
        AlertDialog alertDialog = this.f29837g;
        if (alertDialog != null) {
            alertDialog.dismiss();
        }
        ...
        if (aVar.W(requireContext)) {
            ...
            if (!aVar.k0(requireContext2)) {
                ...
                builder.setCancelable(true);
                this.f29837g = builder.create();
                if (!requireActivity().isFinishing()) {
                    AlertDialog alertDialog2 = this.f29837g;
    ...
    */
    ...
    private final void a0(C1505o c1505o) {
        ...
        if (activity != null) {
            ...
            if (l02 >= 0) {
                if (!DownloadApkWorker.f29987k.f(activity, l02)) {
                    Y y8 = Y.f33752a;
    ...
    private final void e0() {
        Context requireContext = requireContext();
        AbstractC3159y.h(requireContext, "requireContext()");
        new S4.i(requireContext, this.f29832b, new f(), LifecycleOwnerKt.getLifecycleScope(this));
    }
    ...
    public final void h0() {
        if (this.f29831a != null && getActivity() != null && !j0() && !U()) {
            p0();
        }
    }
    ...
    private final void n0() {
        ...
        if (this.f29831a != null) {
            ...
            intent.putExtra("appInfo", this.f29831a);
            FragmentActivity activity = getActivity();
            if (activity != null) {
    ...
    public final void o0(C1505o c1505o) {
        String str;
        if (getContext() != null && this.f29831a != null) {
            if (this.f29839i) {
    ...
    private final void r0() {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (!isExternalStorageManager) {
                try {
                    this.f29847q.launch(new Intent("android.settings.MANAGE_APP_ALL_FILES_ACCESS_PERMISSION", Uri.parse("package:" + requireContext().getPackageName())));
                    return;
    ...
    private final void u0() {
        if (getActivity() != null && this.f29833c != 9) {
            SparseArrayObjectAdapter sparseArrayObjectAdapter = new SparseArrayObjectAdapter(new C2718a());
    ...
    private final void v0() {
        if (getActivity() != null && this.f29833c != 8) {
            SparseArrayObjectAdapter sparseArrayObjectAdapter = new SparseArrayObjectAdapter(new C2718a());
    ...
    private final void w0() {
        if (getActivity() != null && this.f29833c != 13) {
            SparseArrayObjectAdapter sparseArrayObjectAdapter = new SparseArrayObjectAdapter(new C2718a());
    ...
    private final void x0() {
        ...
        if (getActivity() != null) {
            if (this.f29833c != 1) {
                ...
                sparseArrayObjectAdapter.set(4, new Action(4L, requireActivity().getString(R.string.virustotal_safety_report_title)));
                sparseArrayObjectAdapter.set(5, new Action(5L, requireActivity().getString(R.string.app_detail_more_info_title)));
                DetailsOverviewRow detailsOverviewRow2 = this.f29838h;
    ...
    private final void z0() {
        if (getActivity() != null && this.f29833c != 10) {
            SparseArrayObjectAdapter sparseArrayObjectAdapter = new SparseArrayObjectAdapter(new C2718a());
    ...
    public final void P0(int i8, C1505o c1505o) {
        if (this.f29831a != null && c1505o != null && c1505o.Y() != null) {
            String Y7 = c1505o.Y();
            C1498h c1498h = this.f29831a;
            AbstractC3159y.f(c1498h);
    ...
    public final void b0() {
        Context requireContext = requireContext();
        AbstractC3159y.h(requireContext, "requireContext()");
        new S4.i(requireContext, this.f29832b, new c(), LifecycleOwnerKt.getLifecycleScope(this));
    }
        ...
        if (activity != null) {
            ...
            if (extras != null) {
                if (extras.containsKey("appId")) {
                    this.f29832b = extras.getLong("appId");
                }
                if (extras.containsKey("appInfo")) {
                    ...
                    if (c1498h != null) {
                        AbstractC3159y.f(c1498h);
                        this.f29832b = c1498h.i();
                    }
                }
            }
            BackgroundManager backgroundManager2 = BackgroundManager.getInstance(activity);
            this.f29835e = backgroundManager2;
            if (backgroundManager2 != null && !backgroundManager2.isAttached() && (backgroundManager = this.f29835e) != null) {
                backgroundManager.attach(activity.getWindow());
            }
            Drawable drawable = ContextCompat.getDrawable(activity, R.drawable.tv_default_background);
            BackgroundManager backgroundManager3 = this.f29835e;
