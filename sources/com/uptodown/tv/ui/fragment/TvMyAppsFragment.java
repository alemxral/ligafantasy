...
public final class TvMyAppsFragment extends VerticalGridSupportFragment {
    ...
    private C3330r f29901b;

    /* renamed from: c, reason: collision with root package name */
    private ArrayObjectAdapter f29902c;

    /* renamed from: d, reason: collision with root package name */
    private AlertDialog f29903d;
    ...
    private final LifecycleCoroutineScope f29900a = LifecycleOwnerKt.getLifecycleScope(this);

    /* renamed from: g, reason: collision with root package name */
    private final int f29906g = 5;
    ...
    public final class b implements OnItemViewClickedListener {
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item, RowPresenter.ViewHolder viewHolder, Row row) {
            ...
            if (item instanceof C1496f) {
                if (!TvMyAppsFragment.this.f29905f) {
    ...
    public static final class d implements r {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Presenter.ViewHolder f29910b;

        d(Presenter.ViewHolder viewHolder) {
            this.f29910b = viewHolder;
        }
    ...
    public static final class g extends l implements n {
        ...
        public static final class a extends l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ TvMyAppsFragment f29917b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ T f29918c;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(TvMyAppsFragment tvMyAppsFragment, T t8, P5.d dVar) {
                super(2, dVar);
                this.f29917b = tvMyAppsFragment;
                this.f29918c = t8;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new a(this.f29917b, this.f29918c, dVar);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.f29916a == 0) {
                    t.b(obj);
                    this.f29917b.Y((ArrayList) this.f29918c.f33747a);
                    return I.f6474a;
                }
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                if (TvMyAppsFragment.this.getContext() != null) {
                    ...
                    t8.f33747a = c3319g.A(requireContext);
                    if (TvMyAppsFragment.this.f29904e) {
                        ...
                        t8.f33747a = arrayList;
                    } else {
                        ArrayList arrayList2 = new ArrayList();
                        Iterator it2 = ((ArrayList) t8.f33747a).iterator();
                        while (it2.hasNext()) {
                        ...
                        t8.f33747a = arrayList2;
                    }
                    TvMyAppsFragment.this.Z((ArrayList) t8.f33747a);
                    J0 c8 = C2812b0.c();
    ...
    public static final class h extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final h f29919a = new h();
    ...
    public static final void H(TvMyAppsFragment this$0, C1496f c1496f, View view) {
        ...
        AlertDialog alertDialog = this$0.f29903d;
        if (alertDialog != null) {
            alertDialog.dismiss();
        }
    }
    ...
    private final void U() {
        if (getContext() != null) {
            ...
            Context requireContext = requireContext();
            AbstractC3159y.h(requireContext, "requireContext()");
            UptodownApp.a.N0(aVar, requireContext, false, false, 6, null);
        }
    }
    ...
    private final void W() {
        AbstractC2829k.d(this.f29900a, null, null, new f(null), 3, null);
    }
    ...
    public final void Y(ArrayList arrayList) {
        ArrayObjectAdapter arrayObjectAdapter = this.f29902c;
        AbstractC3159y.f(arrayObjectAdapter);
        arrayObjectAdapter.clear();
        if (arrayList != null && !arrayList.isEmpty()) {
            int size = arrayList.size();
            for (int i8 = 0; i8 < size; i8++) {
                ArrayObjectAdapter arrayObjectAdapter2 = this.f29902c;
                AbstractC3159y.f(arrayObjectAdapter2);
                arrayObjectAdapter2.add(arrayList.get(i8));
            }
        }
        ArrayObjectAdapter arrayObjectAdapter3 = this.f29902c;
    ...
    private final void c0() {
        ...
        verticalGridPresenter.setNumberOfColumns(this.f29906g);
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f29901b = new C3330r(requireContext());
        a aVar = new a(new m());
        this.f29902c = aVar;
        setAdapter(aVar);
        FragmentActivity activity = getActivity();
        if (activity != null && (extras = activity.getIntent().getExtras()) != null) {
            if (extras.containsKey("updates")) {
                this.f29904e = extras.getBoolean("updates");
            }
            if (extras.containsKey("rollback")) {
                this.f29905f = extras.getBoolean("rollback");
            }
        }
        if (this.f29904e) {
            setTitle(getString(R.string.updates));
        } else if (this.f29905f) {
