...
public final class TvAppsListFragment extends VerticalGridSupportFragment {
    ...
    private ArrayObjectAdapter f29887a;

    /* renamed from: b, reason: collision with root package name */
    private C1501k f29888b;
    ...
    public final class c implements OnItemViewSelectedListener {
        ...
        public void onItemSelected(Presenter.ViewHolder viewHolder, Object obj, RowPresenter.ViewHolder viewHolder2, Row row) {
            if (obj != null) {
                ArrayObjectAdapter arrayObjectAdapter = TvAppsListFragment.this.f29887a;
                AbstractC3159y.f(arrayObjectAdapter);
                int indexOf = arrayObjectAdapter.indexOf(obj);
                if (indexOf < TvAppsListFragment.this.f29889c && indexOf >= TvAppsListFragment.this.f29889c - 5 && !TvAppsListFragment.this.f29890d) {
    ...
    public static final class d extends l implements n {
        ...
        public static final class a extends l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ TvAppsListFragment f29896b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ T f29897c;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(TvAppsListFragment tvAppsListFragment, T t8, P5.d dVar) {
                super(2, dVar);
                this.f29896b = tvAppsListFragment;
                this.f29897c = t8;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new a(this.f29896b, this.f29897c, dVar);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.f29895a == 0) {
                    t.b(obj);
                    try {
                        this.f29896b.v((ArrayList) this.f29897c.f33747a);
                    } catch (Exception e8) {
                        e8.printStackTrace();
                    }
                    this.f29896b.f29890d = false;
                    return I.f6474a;
                }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                T t8 = new T();
                try {
                    TvAppsListFragment.this.f29890d = true;
                    ...
                    if (TvAppsListFragment.this.f29888b != null) {
                        C1501k c1501k = TvAppsListFragment.this.f29888b;
                        AbstractC3159y.f(c1501k);
                        int c8 = c1501k.c();
                        if (c8 != -2) {
                            if (c8 != -1) {
                                C1501k c1501k2 = TvAppsListFragment.this.f29888b;
                                AbstractC3159y.f(c1501k2);
                                if (c1501k2.n()) {
                                    C1501k c1501k3 = TvAppsListFragment.this.f29888b;
                                    AbstractC3159y.f(c1501k3);
                                    i8 = c3312f.f0(c1501k3.c(), 75, TvAppsListFragment.this.f29889c);
                                } else {
                                    C1501k c1501k4 = TvAppsListFragment.this.f29888b;
                                    AbstractC3159y.f(c1501k4);
                                    i8 = c3312f.b0(c1501k4.c(), 75, TvAppsListFragment.this.f29889c);
                                }
                            } else {
                                i8 = c3312f.a0(75, TvAppsListFragment.this.f29889c);
                            }
                        } else {
                            i8 = c3312f.H(75, TvAppsListFragment.this.f29889c);
                        }
                    } else {
                        i8 = null;
                    }
                    if (i8 != null && !i8.b() && i8.d() != null) {
                        ...
                        if (i9 == 1 && jSONArray != null) {
                            ...
                            for (int i11 = 0; i11 < length; i11++) {
                                ...
                                TvAppsListFragment.this.f29889c++;
                            }
                        }
                    }
                } catch (Error e9) {
    ...
    public final void v(ArrayList arrayList) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ArrayObjectAdapter arrayObjectAdapter = this.f29887a;
            AbstractC3159y.f(arrayObjectAdapter);
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f29887a = arrayObjectAdapter;
        ...
        if (activity != null && (extras = activity.getIntent().getExtras()) != null && extras.containsKey("category")) {
            ...
            this.f29888b = (C1501k) parcelable;
        }
        C1501k c1501k = this.f29888b;
        if (c1501k != null) {
