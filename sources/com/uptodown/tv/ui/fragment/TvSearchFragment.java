...
public final class TvSearchFragment extends SearchSupportFragment implements SearchSupportFragment.SearchResultProvider {
    ...
    private ArrayObjectAdapter f29950a;

    /* renamed from: b, reason: collision with root package name */
    private String f29951b;

    /* renamed from: c, reason: collision with root package name */
    private ArrayList f29952c;
    ...
    public static final class a extends l implements n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ C1498h f29955c;
        ...
        public static final class C0712a extends l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ TvSearchFragment f29957b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ C1498h f29958c;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0712a(TvSearchFragment tvSearchFragment, C1498h c1498h, P5.d dVar) {
                super(2, dVar);
                this.f29957b = tvSearchFragment;
                this.f29958c = c1498h;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new C0712a(this.f29957b, this.f29958c, dVar);
            }

            @Override // X5.n
            public final Object invoke(M m8, P5.d dVar) {
                return ((C0712a) create(m8, dVar)).invokeSuspend(I.f6474a);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.f29956a == 0) {
                    t.b(obj);
                    Intent intent = new Intent(this.f29957b.getActivity(), (Class<?>) TvAppDetailActivity.class);
                    intent.putExtra("appInfo", this.f29958c);
                    this.f29957b.startActivity(intent);
                    return I.f6474a;
                }
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new a(this.f29955c, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i9 != 0) {
                ...
                try {
                    ...
                    X4.I Q8 = new C3312F(requireContext).Q(this.f29955c.i());
                    if (!Q8.b() && Q8.d() != null) {
                        String d8 = Q8.d();
                        AbstractC3159y.f(d8);
                ...
                J0 c8 = C2812b0.c();
                C0712a c0712a = new C0712a(TvSearchFragment.this, this.f29955c, null);
                this.f29953a = 1;
    ...
    public static final class c extends l implements n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ C1498h f29964c;
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new c(this.f29964c, dVar);
        }
    ...
    public static final class d implements SearchBar.SearchBarListener {
        ...
        public void onSearchQueryChange(String str) {
            if (str != null && str.length() > 2 && !g6.n.s(str, TvSearchFragment.this.f29951b, true)) {
                TvSearchFragment.this.f29951b = str;
    ...
    public static final class e extends l implements n {
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new e(this.f29968c, dVar);
        }
    ...
    public final void x(String str) {
        ArrayObjectAdapter arrayObjectAdapter = this.f29950a;
    ...
    public final void z(String str, List list) {
        ...
        ArrayObjectAdapter arrayObjectAdapter2 = this.f29950a;
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f29950a = new ArrayObjectAdapter(new ListRowPresenter());
    ...
    public boolean onQueryTextChange(String str) {
        if (str != null && str.length() > 2 && !g6.n.s(str, this.f29951b, true)) {
            this.f29951b = str;
            x(str);
        }
        return true;
