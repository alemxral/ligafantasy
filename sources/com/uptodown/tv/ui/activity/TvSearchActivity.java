...
public final class TvSearchActivity extends b {
    ...
    private SpeechRecognizer f29829d;
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (SpeechRecognizer.isRecognitionAvailable(this)) {
            this.f29829d = SpeechRecognizer.createSpeechRecognizer(this);
        }
    }

    @Override // h5.b, androidx.fragment.app.FragmentActivity, android.app.Activity
    protected void onPause() {
        if (this.f29829d != null && SpeechRecognizer.isRecognitionAvailable(this)) {
            SpeechRecognizer speechRecognizer = this.f29829d;
            AbstractC3159y.f(speechRecognizer);
            speechRecognizer.stopListening();
            SpeechRecognizer speechRecognizer2 = this.f29829d;
            AbstractC3159y.f(speechRecognizer2);
            speechRecognizer2.cancel();
            SpeechRecognizer speechRecognizer3 = this.f29829d;
