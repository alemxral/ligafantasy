...
public final class TvMainActivity extends b implements r {
    ...
    private AlertDialog f29820d;

    /* renamed from: e, reason: collision with root package name */
    public Fragment f29821e;
    ...
    private final void u() {
        ...
        AlertDialog alertDialog2 = this.f29820d;
        ...
        if (aVar.W(this) && !aVar.k0(this)) {
            ...
            builder.setCancelable(true);
            this.f29820d = builder.create();
            if (!isFinishing() && (alertDialog = this.f29820d) != null) {
                alertDialog.show();
            }
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (intent != null && !z(intent) && (data = intent.getData()) != null) {
            ...
            if (j8 != null && (w.f7268b.a(j8) || n.r(j8, ".apk", false, 2, null))) {
    ...
    public final Fragment x() {
        Fragment fragment = this.f29821e;
        if (fragment != null) {
            return fragment;
        }
