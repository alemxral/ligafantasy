        ...
        if (str != null) {
            ...
            if (hashCode != -1881097171) {
                if (hashCode != 75902422) {
                    if (hashCode == 1980572282 && str.equals("CANCEL") && (intExtra = intent.getIntExtra("notificationID", -1)) == 261 && (b8 = (aVar = DownloadApkWorker.f29987k).b()) != null) {
                        aVar.a(b8.f());
                        if (context != null) {
                            b8.n0(context);
                            if (new C3323k().k(context).isEmpty()) {
                                C3335w.f34532a.c(context, intExtra);
                            }
                            String X7 = b8.X();
