...
public final class YouTubePlayerView extends h2.b implements LifecycleEventObserver {
    ...
    public static final class b implements InterfaceC2578b {
        ...
        public void a(View fullscreenView, Function0 exitFullscreen) {
            ...
            if (!YouTubePlayerView.this.f23180a.isEmpty()) {
                Iterator it = YouTubePlayerView.this.f23180a.iterator();
                while (it.hasNext()) {
    ...
    public static final class c extends AbstractC2577a {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ YouTubePlayerView f23187b;
        ...
        c(String str, YouTubePlayerView youTubePlayerView, boolean z8) {
            this.f23186a = str;
            this.f23187b = youTubePlayerView;
            this.f23188c = z8;
        }
        ...
        public void g(InterfaceC2541e youTubePlayer) {
            ...
            if (str != null) {
                YouTubePlayerView youTubePlayerView = this.f23187b;
                boolean z9 = this.f23188c;
                if (youTubePlayerView.f23182c.getCanPlay$core_release() && z9) {
                    z8 = true;
                } else {
                    z8 = false;
                }
    ...
    public YouTubePlayerView(Context context, AttributeSet attributeSet, int i8) {
        ...
        b8 = g.b();
        addView(c2745a, b8);
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, AbstractC1907b.f14869a, 0, 0);
        AbstractC3159y.h(obtainStyledAttributes, "context.theme.obtainStyl….YouTubePlayerView, 0, 0)");
        this.f23183d = obtainStyledAttributes.getBoolean(AbstractC1907b.f14871c, true);
        boolean z8 = obtainStyledAttributes.getBoolean(AbstractC1907b.f14870b, false);
        boolean z9 = obtainStyledAttributes.getBoolean(AbstractC1907b.f14872d, true);
        String string = obtainStyledAttributes.getString(AbstractC1907b.f14873e);
        ...
        if (this.f23183d) {
            c2745a.e(cVar, z9, C2659a.f30990b.a());
        }
    }
    ...
    public final boolean c(InterfaceC2578b fullscreenListener) {
        ...
        return this.f23180a.add(fullscreenListener);
    }

    public final View d(int i8) {
        return this.f23182c.d(i8);
    }
    ...
    public final void e(e2.c youTubePlayerListener, C2659a playerOptions) {
        ...
        if (!this.f23183d) {
            this.f23182c.e(youTubePlayerListener, true, playerOptions);
            return;
        }
    ...
    public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
        ...
        int i8 = a.f23184a[event.ordinal()];
        if (i8 != 1) {
            if (i8 != 2) {
                if (i8 == 3) {
                    h();
    ...
    public final void setCustomPlayerUi(View view) {
        ...
        this.f23182c.setCustomPlayerUi(view);
    }
