...
public final class CollectBankAccountActivity extends AppCompatActivity {
    ...
    private o3.c f25106b;

    /* renamed from: a, reason: collision with root package name */
    private final InterfaceC1227k f25105a = l.b(new f());

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC1227k f25107c = new ViewModelLazy(U.b(com.stripe.android.payments.bankaccount.ui.b.class), new d(this), new g(), new e(null, this));
    ...
    static final class c extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        public static final class a implements InterfaceC3359g {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ CollectBankAccountActivity f25110a;

            a(CollectBankAccountActivity collectBankAccountActivity) {
                this.f25110a = collectBankAccountActivity;
            }
            ...
            public final Object emit(com.stripe.android.payments.bankaccount.ui.a aVar, P5.d dVar) {
                if (aVar instanceof a.b) {
                    this.f25110a.v((a.b) aVar);
                } else if (aVar instanceof a.C0547a) {
                    this.f25110a.u((a.C0547a) aVar);
                }
                return I.f6474a;
            }
        }
    ...
    public static final class d extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f25111a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(ComponentActivity componentActivity) {
            super(0);
            this.f25111a = componentActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final ViewModelStore invoke() {
            return this.f25111a.getViewModelStore();
        }
    }
    ...
    public static final class e extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f25113b;
        ...
        public final CreationExtras invoke() {
            ...
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f25113b.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    static final class f extends AbstractC3160z implements Function0 {
        ...
        public final CollectBankAccountContract.a invoke() {
            CollectBankAccountContract.a.C0536a c0536a = CollectBankAccountContract.a.f25048g;
    ...
    static final class g extends AbstractC3160z implements Function0 {
        ...
        public static final class a extends AbstractC3160z implements Function0 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ CollectBankAccountActivity f25116a;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(CollectBankAccountActivity collectBankAccountActivity) {
                super(0);
                this.f25116a = collectBankAccountActivity;
            }

            @Override // kotlin.jvm.functions.Function0
            /* renamed from: a, reason: merged with bridge method [inline-methods] */
            public final CollectBankAccountContract.a invoke() {
                CollectBankAccountContract.a r8 = this.f25116a.r();
                if (r8 != null) {
                    return r8;
                }
    ...
    public final CollectBankAccountContract.a r() {
        return (CollectBankAccountContract.a) this.f25105a.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final com.stripe.android.payments.bankaccount.ui.b s() {
        return (com.stripe.android.payments.bankaccount.ui.b) this.f25107c.getValue();
    }

    private final void t(InterfaceC2712a interfaceC2712a) {
        o3.c b8;
        if (interfaceC2712a instanceof InterfaceC2712a.C0747a) {
            b8 = c.a.d(o3.c.f36364a, this, new a(s()), null, null, 12, null);
        } else if (interfaceC2712a instanceof InterfaceC2712a.b) {
            b8 = c.a.b(o3.c.f36364a, this, new b(s()), null, null, 12, null);
        } else {
            throw new p();
        }
        this.f25106b = b8;
