...
public final class b extends ViewModel {
    ...
    public static final C0548b f25121i = new C0548b(null);

    /* renamed from: j, reason: collision with root package name */
    public static final int f25122j = 8;

    /* renamed from: a, reason: collision with root package name */
    private final CollectBankAccountContract.a f25123a;

    /* renamed from: b, reason: collision with root package name */
    private final u f25124b;

    /* renamed from: c, reason: collision with root package name */
    private final C2779b f25125c;

    /* renamed from: d, reason: collision with root package name */
    private final C2778a f25126d;

    /* renamed from: e, reason: collision with root package name */
    private final C2780c f25127e;

    /* renamed from: f, reason: collision with root package name */
    private final SavedStateHandle f25128f;

    /* renamed from: g, reason: collision with root package name */
    private final InterfaceC3684d f25129g;

    /* renamed from: h, reason: collision with root package name */
    private final z f25130h;
    ...
    public static final class c implements ViewModelProvider.Factory {
        ...
        public ViewModel create(Class modelClass, CreationExtras extras) {
            ...
            b a8 = AbstractC2753h.a().a(SavedStateHandleSupport.createSavedStateHandle(extras)).b(A2.b.a(extras)).d(AbstractC3340B.b(0, 0, null, 7, null)).c((CollectBankAccountContract.a) this.f25133a.invoke()).build().a();
    ...
    public static final class d extends l implements n {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ FinancialConnectionsSession f25137d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        d(FinancialConnectionsSession financialConnectionsSession, P5.d dVar) {
            super(2, dVar);
            this.f25137d = financialConnectionsSession;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new d(this.f25137d, dVar);
        }
    ...
    public static final class f extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ FinancialConnectionsSheetInstantDebitsResult.Completed f25143a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        f(FinancialConnectionsSheetInstantDebitsResult.Completed completed) {
            super(1);
            this.f25143a = completed;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final com.stripe.android.payments.bankaccount.navigation.c invoke(StripeIntent stripeIntent) {
            return new com.stripe.android.payments.bankaccount.navigation.c(stripeIntent, null, new c.b(this.f25143a.getPaymentMethodId(), this.f25143a.getLast4(), this.f25143a.getBankName()));
        }
    }
    ...
    public static final class g extends l implements n {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function1 f25147d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        g(Function1 function1, P5.d dVar) {
            super(2, dVar);
            this.f25147d = function1;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new g(this.f25147d, dVar);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r7) {
            ...
            L16:
                ...
                throw r7
            L1e:
                java.lang.Object r1 = r6.f25144a
                L5.t.b(r7)
                goto L70
            L24:
                L5.t.b(r7)
            ...
            L5d:
                ...
                return r0
            L70:
                kotlin.jvm.functions.Function1 r7 = r6.f25147d
    ...
    public static final class h extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ FinancialConnectionsSession f25148a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        h(FinancialConnectionsSession financialConnectionsSession) {
            super(1);
            this.f25148a = financialConnectionsSession;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final com.stripe.android.payments.bankaccount.navigation.c invoke(StripeIntent stripeIntent) {
            return new com.stripe.android.payments.bankaccount.navigation.c(stripeIntent, new c.C0545c(this.f25148a), null);
        }
    }
    ...
    public static final class i extends l implements n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ FinancialConnectionsSheetResult f25150b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ b f25151c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        i(FinancialConnectionsSheetResult financialConnectionsSheetResult, b bVar, P5.d dVar) {
            super(2, dVar);
            this.f25150b = financialConnectionsSheetResult;
            this.f25151c = bVar;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new i(this.f25150b, this.f25151c, dVar);
        }
    ...
    public static final class j extends l implements n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ FinancialConnectionsSheetInstantDebitsResult f25153b;
        ...
        j(FinancialConnectionsSheetInstantDebitsResult financialConnectionsSheetInstantDebitsResult, b bVar, P5.d dVar) {
            super(2, dVar);
            this.f25153b = financialConnectionsSheetInstantDebitsResult;
            this.f25154c = bVar;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new j(this.f25153b, this.f25154c, dVar);
        }
    ...
    public b(CollectBankAccountContract.a args, u _viewEffect, C2779b createFinancialConnectionsSession, C2778a attachFinancialConnectionsSession, C2780c retrieveStripeIntent, SavedStateHandle savedStateHandle, InterfaceC3684d logger) {
        ...
        this.f25123a = args;
        this.f25124b = _viewEffect;
        this.f25125c = createFinancialConnectionsSession;
        this.f25126d = attachFinancialConnectionsSession;
        this.f25127e = retrieveStripeIntent;
        this.f25128f = savedStateHandle;
        this.f25129g = logger;
        this.f25130h = _viewEffect;
        if (!r()) {
    ...
    */
    ...
    public final Object m(Throwable th, P5.d dVar) {
        this.f25129g.a("Error", new Exception(th));
    ...
    public final Object p(com.stripe.android.payments.bankaccount.navigation.d dVar, P5.d dVar2) {
        Object emit = this.f25124b.emit(new a.C0547a(dVar), dVar2);
        if (emit == Q5.b.e()) {
            return emit;
        }
        return I.f6474a;
    ...
    private final boolean r() {
        return AbstractC3159y.d(this.f25128f.get("key_has_launched"), Boolean.TRUE);
    }

    private final void v(boolean z8) {
        this.f25128f.set("key_has_launched", Boolean.valueOf(z8));
    }
