...
public abstract class d implements Parcelable {
    ...
    public static final int f25100a = 0;
    ...
    public static final class b extends d {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final com.stripe.android.payments.bankaccount.navigation.c f25103b;

        /* renamed from: c, reason: collision with root package name */
        public static final int f25102c = FinancialConnectionsSession.$stable;
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof b) && AbstractC3159y.d(this.f25103b, ((b) obj).f25103b);
        }
        ...
        public String toString() {
            return "Completed(response=" + this.f25103b + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            this.f25103b.writeToParcel(out, i8);
        }
    }
    ...
    public static final class c extends d {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final Throwable f25104b;
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof c) && AbstractC3159y.d(this.f25104b, ((c) obj).f25104b);
        }
        ...
        public String toString() {
            return "Failed(error=" + this.f25104b + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeSerializable(this.f25104b);
        }
    }
