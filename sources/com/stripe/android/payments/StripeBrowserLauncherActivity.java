...
public final class StripeBrowserLauncherActivity extends AppCompatActivity {
    ...
    private final InterfaceC1227k f25032a;

    /* loaded from: classes4.dex */
    public static final class a extends AbstractC3160z implements Function0 {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f25033a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(ComponentActivity componentActivity) {
            super(0);
            this.f25033a = componentActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final ViewModelProvider.Factory invoke() {
            return this.f25033a.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class b extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f25034a;
        ...
        public final ViewModelStore invoke() {
            return this.f25034a.getViewModelStore();
        }
    }
    ...
    public static final class c extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f25035a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f25036b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f25035a = function0;
            this.f25036b = componentActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final CreationExtras invoke() {
            CreationExtras creationExtras;
            Function0 function0 = this.f25035a;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f25036b.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    public StripeBrowserLauncherActivity() {
        Function0 function0 = d.f25037a;
        this.f25032a = new ViewModelLazy(U.b(com.stripe.android.payments.a.class), new b(this), function0 == null ? new a(this) : function0, new c(null, this));
    }
    ...
    private final com.stripe.android.payments.a q() {
        return (com.stripe.android.payments.a) this.f25032a.getValue();
    }
    ...
    private final void r(final PaymentBrowserAuthContract.a aVar) {
        ...
        try {
            ...
            i.b.a(i.a.b(aVar2, applicationContext, null, 2, null), i.d.f33394n, AbstractC3790k.f38210e.b(e8), null, 4, null);
            o(aVar);
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (a8 == null) {
            ...
            Context applicationContext = getApplicationContext();
            AbstractC3159y.h(applicationContext, "getApplicationContext(...)");
            i.b.a(i.a.b(aVar, applicationContext, null, 2, null), i.d.f33395o, null, null, 6, null);
            return;
        }
        if (q().d()) {
            p(a8);
