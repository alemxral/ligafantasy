...
public final class a extends ViewModel {
    ...
    public static final C0535a f25038g = new C0535a(null);

    /* renamed from: h, reason: collision with root package name */
    public static final int f25039h = 8;

    /* renamed from: a, reason: collision with root package name */
    private final InterfaceC3873c f25040a;

    /* renamed from: b, reason: collision with root package name */
    private final PaymentAnalyticsRequestFactory f25041b;

    /* renamed from: c, reason: collision with root package name */
    private final EnumC3743a f25042c;
    ...
    private final SavedStateHandle f25045f;
    ...
    public static final class b implements ViewModelProvider.Factory {
        ...
        public ViewModel create(Class modelClass, CreationExtras extras) {
            ...
            String string = a8.getString(AbstractC3053E.f32841N0);
            AbstractC3159y.h(string, "getString(...)");
            String string2 = a8.getString(AbstractC3053E.f32881n0);
    ...
    public /* synthetic */ class c {
        ...
        static {
            ...
            try {
                iArr[EnumC3743a.f37823a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[EnumC3743a.f37824b.ordinal()] = 2;
    ...
    public a(InterfaceC3873c analyticsRequestExecutor, PaymentAnalyticsRequestFactory paymentAnalyticsRequestFactory, EnumC3743a browserCapabilities, String intentChooserTitle, String resolveErrorMessage, SavedStateHandle savedStateHandle) {
        ...
        this.f25040a = analyticsRequestExecutor;
        this.f25041b = paymentAnalyticsRequestFactory;
        this.f25042c = browserCapabilities;
        this.f25043d = intentChooserTitle;
        this.f25044e = resolveErrorMessage;
        this.f25045f = savedStateHandle;
    }
    ...
    private final void f() {
        ...
        int i8 = c.f25046a[this.f25042c.ordinal()];
        if (i8 != 1) {
            if (i8 == 2) {
                paymentAnalyticsEvent = PaymentAnalyticsEvent.f24811M;
            } else {
                throw new p();
            }
        } else {
            paymentAnalyticsEvent = PaymentAnalyticsEvent.f24810L;
        }
        this.f25040a.a(PaymentAnalyticsRequestFactory.v(this.f25041b, paymentAnalyticsEvent, null, null, null, null, null, 62, null));
    }
    ...
    public final Intent b(PaymentBrowserAuthContract.a args) {
        ...
        Intent createChooser = Intent.createChooser(intent, this.f25043d);
    ...
    public final Intent c(PaymentBrowserAuthContract.a args) {
        AbstractC3159y.i(args, "args");
        Uri parse = Uri.parse(args.G());
        C3787h c3787h = new C3787h(this.f25044e, "failedBrowserLaunchError");
    ...
    public final boolean d() {
        Boolean bool = (Boolean) this.f25045f.get("has_launched");
        if (bool != null) {
    ...
    public final void g(boolean z8) {
        this.f25045f.set("has_launched", Boolean.valueOf(z8));
    }
}
