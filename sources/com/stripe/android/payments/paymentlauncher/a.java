...
public abstract class a implements Parcelable {
    ...
    public static final b f25287a = new b(null);
    ...
    public static final class C0556a extends a {
        ...
        public static final C0556a f25288b = new C0556a();
    ...
    public static final class c extends a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final StripeIntent f25289b;
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof c) && AbstractC3159y.d(this.f25289b, ((c) obj).f25289b);
        }
        ...
        public String toString() {
            return "Completed(intent=" + this.f25289b + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeParcelable(this.f25289b, i8);
        }
    }
    ...
    public static final class d extends a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final Throwable f25290b;
        ...
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeSerializable(this.f25290b);
        }
    }
