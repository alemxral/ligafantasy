...
public final class PaymentLauncherConfirmationActivity extends AppCompatActivity {
    ...
    public static final int f25244e = 8;

    /* renamed from: a, reason: collision with root package name */
    private final InterfaceC1227k f25245a = l.b(new f());

    /* renamed from: b, reason: collision with root package name */
    private ViewModelProvider.Factory f25246b = new b.C0560b(new h());

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC1227k f25247c = new ViewModelLazy(U.b(com.stripe.android.payments.paymentlauncher.b.class), new d(this), new g(), new e(null, this));
    ...
    static final class c extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        public static final class a implements InterfaceC3359g {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ PaymentLauncherConfirmationActivity f25251a;

            a(PaymentLauncherConfirmationActivity paymentLauncherConfirmationActivity) {
                this.f25251a = paymentLauncherConfirmationActivity;
            }
    ...
    public static final class d extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f25252a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(ComponentActivity componentActivity) {
            super(0);
            this.f25252a = componentActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final ViewModelStore invoke() {
            return this.f25252a.getViewModelStore();
        }
    }
    ...
    public static final class e extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f25254b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f25253a = function0;
            this.f25254b = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f25254b.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    static final class f extends AbstractC3160z implements Function0 {
        ...
        public final PaymentLauncherContract.a invoke() {
            PaymentLauncherContract.a.C0552a c0552a = PaymentLauncherContract.a.f25258g;
    ...
    public final PaymentLauncherContract.a q() {
        return (PaymentLauncherContract.a) this.f25245a.getValue();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (q8 != null) {
            ...
            if (e8 == null) {
                ...
                OnBackPressedDispatcherKt.addCallback$default(onBackPressedDispatcher, null, false, b.f25248a, 3, null);
                AbstractC2829k.d(LifecycleOwnerKt.getLifecycleScope(this), null, null, new c(null), 3, null);
                r().D(this, this);
                InterfaceC2464p a8 = InterfaceC2464p.f27882a.a(this, aVar3.i());
            ...
            i.b.a(i.a.b(aVar4, applicationContext, null, 2, null), i.d.f33393m, AbstractC3790k.f38210e.b(e8), null, 4, null);
            return;
        }
    ...
    public final com.stripe.android.payments.paymentlauncher.b r() {
        return (com.stripe.android.payments.paymentlauncher.b) this.f25247c.getValue();
    }
