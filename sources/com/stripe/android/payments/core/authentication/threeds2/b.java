...
public final class b extends AbstractC3176f {
    ...
    private final p f25191a;

    /* renamed from: b, reason: collision with root package name */
    private final boolean f25192b;

    /* renamed from: c, reason: collision with root package name */
    private final Function0 f25193c;

    /* renamed from: d, reason: collision with root package name */
    private final Set f25194d;

    /* renamed from: e, reason: collision with root package name */
    private ActivityResultLauncher f25195e;

    /* renamed from: f, reason: collision with root package name */
    private final Function1 f25196f;
    ...
    public b(p config, boolean z8, Function0 publishableKeyProvider, Set productUsage) {
        ...
        this.f25191a = config;
        this.f25192b = z8;
        this.f25193c = publishableKeyProvider;
        this.f25194d = productUsage;
        this.f25196f = new a();
    }
    ...
    public void b(ActivityResultCaller activityResultCaller, ActivityResultCallback activityResultCallback) {
        ...
        this.f25195e = activityResultCaller.registerForActivityResult(new Stripe3ds2TransactionContract(), activityResultCallback);
    }

    @Override // l3.AbstractC3176f, j3.InterfaceC3074a
    public void c() {
        ActivityResultLauncher activityResultLauncher = this.f25195e;
    ...
    public Object e(InterfaceC2464p interfaceC2464p, StripeIntent stripeIntent, j.c cVar, P5.d dVar) {
        c cVar2 = (c) this.f25196f.invoke(interfaceC2464p);
        q a8 = q.f12282b.a();
        p.c c8 = this.f25191a.c();
        ...
        cVar2.a(new Stripe3ds2TransactionContract.a(a8, c8, stripeIntent, (StripeIntent.a.j.b) l8, cVar, this.f25192b, interfaceC2464p.b(), (String) this.f25193c.invoke(), this.f25194d));
        return I.f6474a;
    }
}
