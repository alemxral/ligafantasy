...
public abstract class m implements Parcelable {
    ...
    public static final class b extends m {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof b) && AbstractC3159y.d(this.f26871b, ((b) obj).f26871b);
        }

        public int hashCode() {
            return this.f26871b.hashCode();
        }

        public String toString() {
            return "End(challengeResult=" + this.f26871b + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeParcelable(this.f26871b, i8);
        }
    }
    ...
    public static final class c extends m {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final com.stripe.android.stripe3ds2.views.d f26872b;
        ...
        public c(com.stripe.android.stripe3ds2.views.d challengeViewArgs) {
            ...
            this.f26872b = challengeViewArgs;
        }
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof c) && AbstractC3159y.d(this.f26872b, ((c) obj).f26872b);
        }
        ...
        public String toString() {
            return "Start(challengeViewArgs=" + this.f26872b + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            this.f26872b.writeToParcel(out, i8);
        }
    }
