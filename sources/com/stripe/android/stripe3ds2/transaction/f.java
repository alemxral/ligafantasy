...
public interface f {
    ...
    public static final class a implements f {
        ...
        private final SecretKey f26818b;

        /* renamed from: c, reason: collision with root package name */
        private final U3.c f26819c;

        /* renamed from: d, reason: collision with root package name */
        private final c.a f26820d;
        ...
        public Object a(Y3.a aVar, X3.l lVar, P5.d dVar) {
            ...
            Throwable e8 = s.e(b8);
            if (e8 != null) {
                this.f26819c.i(new RuntimeException(g6.n.e("\n                            Failed to process challenge response.\n\n                            CReq = " + aVar.u() + "\n                            "), e8));
            }
            Throwable e9 = s.e(b8);
            if (e9 == null) {
                return f(aVar, (JSONObject) b8);
            }
            Y3.f fVar = Y3.f.f13154i;
            int b9 = fVar.b();
            String c8 = fVar.c();
        ...
        public final d f(Y3.a creqData, JSONObject payload) {
            ...
            d.a aVar = Y3.d.f13123k;
            if (aVar.b(payload)) {
                return new d.b(aVar.a(payload));
            }
            try {
                s.a aVar2 = s.f6498b;
                b8 = s.b(Y3.b.f13081C.d(payload));
            } catch (Throwable th) {
                s.a aVar3 = s.f6498b;
                b8 = s.b(t.a(th));
            }
