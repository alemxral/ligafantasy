...
public final class r implements X3.k {
    ...
    private final U3.c f26915c;

    /* renamed from: d, reason: collision with root package name */
    private final P5.g f26916d;
    ...
    static final class d extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            d dVar2 = new d(this.f26923d, this.f26924e, dVar);
            dVar2.f26921b = obj;
            return dVar2;
        }
    ...
    public r(String url, a connectionFactory, U3.c errorReporter, P5.g workContext) {
        ...
        this.f26913a = url;
        this.f26914b = connectionFactory;
        this.f26915c = errorReporter;
        this.f26916d = workContext;
    }

    private final HttpURLConnection e() {
        return this.f26914b.a(this.f26913a);
    }
    ...
    private final String j(InputStream inputStream) {
        ...
        try {
            s.a aVar = s.f6498b;
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream, C2728d.f31279b), 8192);
            try {
    ...
    public Object a(String str, String str2, P5.d dVar) {
        return AbstractC2825i.g(this.f26916d, new d(str, str2, null), dVar);
    }

    public Object h(P5.d dVar) {
        return AbstractC2825i.g(this.f26916d, new c(null), dVar);
    }
    ...
    public final X3.l k(HttpURLConnection conn) {
        ...
        throw new R3.b("Unsuccessful response code from " + this.f26913a + ": " + responseCode, null, 2, null);
    }
