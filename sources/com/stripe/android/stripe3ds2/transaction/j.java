...
public final class j implements X3.n {
    ...
    private final X3.q f26845a;

    /* renamed from: b, reason: collision with root package name */
    private final X3.p f26846b;

    /* renamed from: c, reason: collision with root package name */
    private final X3.o f26847c;

    /* renamed from: d, reason: collision with root package name */
    private final V3.k f26848d;

    /* renamed from: e, reason: collision with root package name */
    private final X3.b f26849e;

    /* renamed from: f, reason: collision with root package name */
    private final e f26850f;

    /* renamed from: g, reason: collision with root package name */
    private final k.a f26851g;

    /* renamed from: h, reason: collision with root package name */
    private final T3.m f26852h;

    /* renamed from: i, reason: collision with root package name */
    private final U3.c f26853i;

    /* renamed from: j, reason: collision with root package name */
    private final o f26854j;
    ...
    public static final class a extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f26860f = obj;
            this.f26862h |= Integer.MIN_VALUE;
    ...
    public j(X3.q sdkTransactionId, X3.p messageVersionRegistry, X3.o jwsValidator, V3.k messageTransformer, X3.b acsDataParser, e challengeRequestResultRepository, k.a errorRequestExecutorFactory, T3.m uiCustomization, U3.c errorReporter, o logger) {
        ...
        this.f26845a = sdkTransactionId;
        this.f26846b = messageVersionRegistry;
        this.f26847c = jwsValidator;
        this.f26848d = messageTransformer;
        this.f26849e = acsDataParser;
        this.f26850f = challengeRequestResultRepository;
        this.f26851g = errorRequestExecutorFactory;
        this.f26852h = uiCustomization;
        this.f26853i = errorReporter;
        this.f26854j = logger;
    }
    ...
    private final Y3.a b(X3.q qVar, X3.e eVar) {
        ...
        if (c8 != null) {
            String e8 = eVar.e();
            if (e8 != null) {
                return new Y3.a(this.f26846b.a(), e8, c8, qVar, null, null, null, null, null, null, PointerIconCompat.TYPE_TEXT, null);
            }
