...
public final class ChallengeProgressFragment extends Fragment {
    ...
    public ChallengeProgressFragment(String directoryServerName, q sdkTransactionId, Integer num) {
        ...
        this.f26963a = directoryServerName;
        this.f26964b = sdkTransactionId;
        this.f26965c = num;
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        a a9 = a.f26988e.a(this.f26963a, new U3.a(requireContext, new U3.e(this.f26964b), null, null, null, null, null, 0, 252, null));
        ImageView imageView = a8.f8246b;
        ...
        if (num != null) {
            a8.f8247c.setIndicatorColor(num.intValue());
        }
    }
}
