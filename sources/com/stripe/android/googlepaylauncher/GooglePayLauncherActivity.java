...
public final class GooglePayLauncherActivity extends AppCompatActivity {
    ...
    private final InterfaceC1227k f23750a = new ViewModelLazy(U.b(g.class), new d(this), new f(), new e(null, this));

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC1227k f23751b = l.b(new a());

    /* renamed from: c, reason: collision with root package name */
    private GooglePayLauncherContract.a f23752c;
    ...
    static final class a extends AbstractC3160z implements Function0 {
        ...
        public final k3.i invoke() {
            return i.a.b(k3.i.f33380a, GooglePayLauncherActivity.this, null, 2, null);
        }
    }
    ...
    static final class b extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        public static final class a implements InterfaceC3359g {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ GooglePayLauncherActivity f23756a;

            a(GooglePayLauncherActivity googlePayLauncherActivity) {
                this.f23756a = googlePayLauncherActivity;
            }
    ...
    static final class c extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ ActivityResultLauncher f23759c;
        ...
        public static final class a extends kotlin.coroutines.jvm.internal.l implements n {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ GooglePayLauncherActivity f23761b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ ActivityResultLauncher f23762c;
            ...
            public static final class C0467a implements InterfaceC3359g {
                ...
                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ ActivityResultLauncher f23763a;

                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ GooglePayLauncherActivity f23764b;

                C0467a(ActivityResultLauncher activityResultLauncher, GooglePayLauncherActivity googlePayLauncherActivity) {
                    this.f23763a = activityResultLauncher;
                    this.f23764b = googlePayLauncherActivity;
                }
            ...
            a(GooglePayLauncherActivity googlePayLauncherActivity, ActivityResultLauncher activityResultLauncher, P5.d dVar) {
                super(2, dVar);
                this.f23761b = googlePayLauncherActivity;
                this.f23762c = activityResultLauncher;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final P5.d create(Object obj, P5.d dVar) {
                return new a(this.f23761b, this.f23762c, dVar);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i8 != 0) {
                    ...
                    t.b(obj);
                    z l8 = this.f23761b.t().l();
                    C0467a c0467a = new C0467a(this.f23762c, this.f23761b);
                    this.f23760a = 1;
        ...
        c(ActivityResultLauncher activityResultLauncher, P5.d dVar) {
            super(2, dVar);
            this.f23759c = activityResultLauncher;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new c(this.f23759c, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                a aVar = new a(googlePayLauncherActivity, this.f23759c, null);
                this.f23757a = 1;
    ...
    public static final class d extends AbstractC3160z implements Function0 {
        ...
        public final ViewModelStore invoke() {
            return this.f23765a.getViewModelStore();
        }
    }
    ...
    public static final class e extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f23766a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f23767b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f23766a = function0;
            this.f23767b = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f23767b.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    static final class f extends AbstractC3160z implements Function0 {
        ...
        public final ViewModelProvider.Factory invoke() {
            GooglePayLauncherContract.a aVar = GooglePayLauncherActivity.this.f23752c;
            if (aVar == null) {
    ...
    private final k3.i s() {
        return (k3.i) this.f23751b.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final g t() {
        return (g) this.f23750a.getValue();
    }
    ...
    private final void v(C3799a c3799a) {
        ...
        if (z8 != 0) {
            if (z8 != 16) {
                ...
                i.b.a(s(), i.d.f33396p, null, Q.k(x.a("status_message", G8), x.a("status_code", String.valueOf(b8.z()))), 2, null);
                g t8 = t();
                int z9 = b8.z();
                String G9 = b8.G();
                if (G9 != null) {
        ...
        if (c3719i != null) {
            t().h(InterfaceC2464p.a.b(InterfaceC2464p.f27882a, this, null, 2, null), p.f24568u.j(new JSONObject(c3719i.u())));
        } else {
            i.b.a(s(), i.f.f33418h, null, null, 6, null);
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            s.a aVar = s.f6498b;
            GooglePayLauncherContract.a.C0468a c0468a = GooglePayLauncherContract.a.f23770a;
        ...
        if (a8 != null) {
            ...
            Throwable e8 = s.e(b8);
            if (e8 == null) {
                this.f23752c = (GooglePayLauncherContract.a) b8;
