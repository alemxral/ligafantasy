...
public final class SepaMandateContract extends ActivityResultContract<a, e> {
    ...
    public static final b f26541a = new b(null);
    ...
    public static final class a implements Parcelable {
        ...
        public static final C0658a f26542b = new C0658a(null);
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof a) && AbstractC3159y.d(this.f26543a, ((a) obj).f26543a);
        }
        ...
        public String toString() {
            return "Args(merchantName=" + this.f26543a + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeString(this.f26543a);
        }
    }
