...
public final class SepaMandateActivity extends AppCompatActivity {
    ...
    static final class a extends AbstractC3160z implements n {
        ...
        public static final class C0654a extends AbstractC3160z implements n {
            ...
            final /* synthetic */ SepaMandateActivity f26535a;
            ...
            public static final class b extends AbstractC3160z implements n {
                ...
                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ SepaMandateActivity f26538b;
                ...
                public static final class C0656a extends AbstractC3160z implements Function0 {
                    ...
                    /* renamed from: a, reason: collision with root package name */
                    final /* synthetic */ SepaMandateActivity f26539a;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C0656a(SepaMandateActivity sepaMandateActivity) {
                        super(0);
                        this.f26539a = sepaMandateActivity;
                    }
                    ...
                    public final void m5541invoke() {
                        Intent putExtra = new Intent().putExtra("extra_activity_result", e.a.f26695a);
                        AbstractC3159y.h(putExtra, "putExtra(...)");
                        this.f26539a.setResult(-1, putExtra);
                        this.f26539a.finish();
                    }
                }
                ...
                public static final class C0657b extends AbstractC3160z implements Function0 {
                    ...
                    /* renamed from: a, reason: collision with root package name */
                    final /* synthetic */ SepaMandateActivity f26540a;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C0657b(SepaMandateActivity sepaMandateActivity) {
                        super(0);
                        this.f26540a = sepaMandateActivity;
                    }
                ...
                b(String str, SepaMandateActivity sepaMandateActivity) {
                    super(2);
                    this.f26537a = str;
                    this.f26538b = sepaMandateActivity;
                }
                ...
                public final void invoke(Composer composer, int i8) {
                    ...
                    boolean changed = composer.changed(this.f26538b);
                    SepaMandateActivity sepaMandateActivity = this.f26538b;
                    ...
                    boolean changed2 = composer.changed(this.f26538b);
                    SepaMandateActivity sepaMandateActivity2 = this.f26538b;
            ...
            C0654a(SepaMandateActivity sepaMandateActivity, String str) {
                super(2);
                this.f26535a = sepaMandateActivity;
                this.f26536b = str;
            }
            ...
            public final void invoke(Composer composer, int i8) {
                ...
                SepaMandateActivity sepaMandateActivity = this.f26535a;
                ...
                composer.endReplaceableGroup();
                AbstractC3647a.a(b8, null, (Function0) ((InterfaceC2645e) rememberedValue), ComposableLambdaKt.composableLambda(composer, -380837143, true, new b(this.f26536b, this.f26535a)), composer, C3471g.f36145e | 3072, 2);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            AbstractC3087m.a(null, null, null, ComposableLambdaKt.composableLambda(composer, -620021374, true, new C0654a(SepaMandateActivity.this, this.f26534b)), composer, 3072, 7);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            s.a aVar = s.f6498b;
            SepaMandateContract.a.C0658a c0658a = SepaMandateContract.a.f26542b;
