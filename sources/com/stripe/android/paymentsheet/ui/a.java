...
public abstract class a {
    ...
    public static final class C0659a extends AbstractC3160z implements n {
        ...
        final /* synthetic */ PrimaryButton.a f26544a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ boolean f26545b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ EnumC3987b f26546c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ C3073m.a f26547d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ boolean f26548e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f26549f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Modifier f26550g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f26551h;
        ...
        C0659a(PrimaryButton.a aVar, boolean z8, EnumC3987b enumC3987b, C3073m.a aVar2, boolean z9, Function0 function0, Modifier modifier, int i8, int i9) {
            ...
            this.f26544a = aVar;
            this.f26545b = z8;
            this.f26546c = enumC3987b;
            this.f26547d = aVar2;
            this.f26548e = z9;
            this.f26549f = function0;
            this.f26550g = modifier;
            this.f26551h = i8;
            this.f26552i = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            a.a(this.f26544a, this.f26545b, this.f26546c, this.f26547d, this.f26548e, this.f26549f, this.f26550g, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26551h | 1), this.f26552i);
        }
    }
    ...
    public static final class b extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Modifier f26553a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.paymentsheet.ui.d f26554b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ PrimaryButton.a f26555c;
        ...
        public static final class C0660a extends AbstractC3160z implements Function0 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ PrimaryButton.a f26556a;
            ...
            public final void m5543invoke() {
                PrimaryButton.a aVar = this.f26556a;
        ...
        public static final class C0661b extends AbstractC3160z implements Function0 {
            ...
            /* renamed from: a, reason: collision with root package name */
            public static final C0661b f26557a = new C0661b();
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            Modifier testTag = TestTagKt.testTag(this.f26553a, "google-pay-primary-button");
            com.stripe.android.paymentsheet.ui.d dVar = this.f26554b;
            PrimaryButton.a aVar = this.f26555c;
            ...
            com.stripe.android.paymentsheet.ui.c.i("", true, true, dVar, (Function0) rememberedValue, C0661b.f26557a, composer, 197046, 0);
            composer.endReplaceableGroup();
            composer.endNode();
            composer.endReplaceableGroup();
            composer.endReplaceableGroup();
    ...
    public static final class c extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Modifier f26558a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ PrimaryButton.a f26559b;
        ...
        public final void invoke(Composer composer, int i8) {
            a.b(this.f26558a, this.f26559b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26560c | 1), this.f26561d);
        }
    }
    ...
    public /* synthetic */ class d {
        ...
        static {
            ...
            try {
                iArr[EnumC3987b.f39733b.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[EnumC3987b.f39732a.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[EnumC3987b.f39734c.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[EnumC3987b.f39735d.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[EnumC3987b.f39736e.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[EnumC3987b.f39737f.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                iArr[EnumC3987b.f39739h.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                iArr[EnumC3987b.f39738g.ordinal()] = 8;
    ...
    */
    ...
    private static final EnumC3645b d(EnumC3987b enumC3987b) {
        switch (d.f26562a[enumC3987b.ordinal()]) {
            case 1:
