...
public abstract class c {
    ...
    private static final ContentTransform f26643a = AnimatedContentKt.togetherWith(EnterExitTransitionKt.fadeIn$default(AnimationSpecKt.tween$default(100, 0, null, 6, null), 0.0f, 2, null), EnterExitTransitionKt.fadeOut$default(AnimationSpecKt.tween$default(100, 90, null, 4, null), 0.0f, 2, null));
    ...
    public static final class a extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        final /* synthetic */ MutableFloatState f26645b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(MutableFloatState mutableFloatState, P5.d dVar) {
            super(2, dVar);
            this.f26645b = mutableFloatState;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new a(this.f26645b, dVar);
        }
    ...
    public static final class b extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ MutableState f26647b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ State f26648c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(MutableState mutableState, State state, P5.d dVar) {
            super(2, dVar);
            this.f26647b = mutableState;
            this.f26648c = state;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new b(this.f26647b, this.f26648c, dVar);
        }
    ...
    public static final class C0664c extends kotlin.coroutines.jvm.internal.l implements n {
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new C0664c(this.f26650b, dVar);
        }

        @Override // X5.n
        public final Object invoke(M m8, P5.d dVar) {
            return ((C0664c) create(m8, dVar)).invokeSuspend(I.f6474a);
        }
    ...
    public static final class d extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ BoxScope f26651a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function0 f26652b;
        ...
        public final void invoke(Composer composer, int i8) {
            c.a(this.f26651a, this.f26652b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26653c | 1));
        }
    }
    ...
    public static final class e extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ MutableState f26654a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(MutableState mutableState) {
            super(1);
            this.f26654a = mutableState;
        }
    ...
    public static final class g extends AbstractC3160z implements p {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f26656a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.paymentsheet.ui.d f26657b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ String f26658c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ boolean f26659d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        g(Function0 function0, com.stripe.android.paymentsheet.ui.d dVar, String str, boolean z8) {
            super(4);
            this.f26656a = function0;
            this.f26657b = dVar;
            this.f26658c = str;
            this.f26659d = z8;
        }
        ...
        public final void a(AnimatedContentScope AnimatedContent, boolean z8, Composer composer, int i8) {
            ...
            Function0 function0 = this.f26656a;
            com.stripe.android.paymentsheet.ui.d dVar = this.f26657b;
            String str = this.f26658c;
            boolean z9 = this.f26659d;
            ...
            if (z8) {
                ...
                if (!z10) {
                    str = StringResources_androidKt.stringResource(w.f37427V, composer, 0);
                }
                String str2 = str;
                composer.endReplaceableGroup();
    ...
    public static final class h extends AbstractC3160z implements n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.paymentsheet.ui.d f26661b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ boolean f26662c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function0 f26663d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ int f26664e;
        ...
        public final void invoke(Composer composer, int i8) {
            c.h(this.f26660a, this.f26661b, this.f26662c, this.f26663d, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26664e | 1));
        }
    }
    ...
    public static final class j extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f26666a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ boolean f26667b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ J3.M f26668c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ K f26669d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ long f26670e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ String f26671f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.paymentsheet.ui.d f26672g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ boolean f26673h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Function0 f26674i;
        ...
        public static final class a extends AbstractC3160z implements o {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ com.stripe.android.paymentsheet.ui.d f26676b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ boolean f26677c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ Function0 f26678d;
            ...
            public final void invoke(RowScope TextButton, Composer composer, int i8) {
                ...
                c.h(this.f26675a, this.f26676b, this.f26677c, this.f26678d, composer, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            Function0 function0 = this.f26666a;
            boolean z8 = this.f26667b;
            J3.M m8 = this.f26668c;
            K k8 = this.f26669d;
            long j8 = this.f26670e;
            String str = this.f26671f;
            com.stripe.android.paymentsheet.ui.d dVar = this.f26672g;
            boolean z9 = this.f26673h;
            Function0 function02 = this.f26674i;
            composer.startReplaceableGroup(733328855);
    ...
    public static final class k extends AbstractC3160z implements n {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.paymentsheet.ui.d f26682d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Function0 f26683e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f26684f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f26685g;
        ...
        k(String str, boolean z8, boolean z9, com.stripe.android.paymentsheet.ui.d dVar, Function0 function0, Function0 function02, int i8, int i9) {
            ...
            this.f26681c = z9;
            this.f26682d = dVar;
            this.f26683e = function0;
            this.f26684f = function02;
            this.f26685g = i8;
            this.f26686h = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            c.i(this.f26679a, this.f26680b, this.f26681c, this.f26682d, this.f26683e, this.f26684f, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26685g | 1), this.f26686h);
        }
    }
    ...
    public static final class l extends AbstractC3160z implements n {
        ...
        public final void invoke(Composer composer, int i8) {
            c.j(this.f26687a, this.f26688b, this.f26689c, this.f26690d, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26691e | 1));
        }
    }
    ...
    public static final void a(BoxScope boxScope, Function0 function0, Composer composer, int i8) {
        ...
        if ((i12 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            IconKt.m1266Iconww6aTOc(PainterResources_androidKt.painterResource(q3.t.f37393s, startRestartGroup, 0), (String) null, boxScope.align(Modifier.Companion, new BiasAlignment(f(animateFloatAsState), 0.0f)), N.f4848a.a(startRestartGroup, 6).d(), startRestartGroup, 56, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void h(String str, com.stripe.android.paymentsheet.ui.d dVar, boolean z8, Function0 function0, Composer composer, int i8) {
        ...
        if ((i9 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            composer2 = startRestartGroup;
            AnimatedContentKt.AnimatedContent(Boolean.valueOf(dVar instanceof d.a), IntrinsicKt.height(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), IntrinsicSize.Max), f.f26655a, null, "ContentAnimation", null, ComposableLambdaKt.composableLambda(startRestartGroup, 975531133, true, new g(function0, dVar, str, z8)), startRestartGroup, 1597872, 40);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void j(BoxScope boxScope, String str, boolean z8, boolean z9, Composer composer, int i8) {
        ...
        if ((i9 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            if (z8) {
                ...
                IconKt.m1266Iconww6aTOc(PainterResources_androidKt.painterResource(q3.t.f37394t, startRestartGroup, 0), (String) null, boxScope.align(companion, companion2.getCenterEnd()), m2970copywmQWz5c$default, startRestartGroup, 56, 0);
                startRestartGroup.endReplaceableGroup();
            } else {
