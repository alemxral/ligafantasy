...
public abstract class b {
    ...
    public static final class a extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        final /* synthetic */ TextInputService f26564b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(TextInputService textInputService, P5.d dVar) {
            super(2, dVar);
            this.f26564b = textInputService;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new a(this.f26564b, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f26563a == 0) {
                L5.t.b(obj);
                TextInputService textInputService = this.f26564b;
    ...
    public static final class C0662b extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ boolean f26565a;
        ...
        public final void invoke(Composer composer, int i8) {
            b.a(this.f26565a, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26566b | 1));
        }
    }
    ...
    public /* synthetic */ class d implements InterfaceC2754a, InterfaceC3153s {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ EventReporter f26567a;

        d(EventReporter eventReporter) {
            this.f26567a = eventReporter;
        }
        ...
        public final InterfaceC1223g getFunctionDelegate() {
            return new C3156v(0, this.f26567a, EventReporter.class, "onCardNumberCompleted", "onCardNumberCompleted()V", 0);
        }
    ...
    public static final class e extends AbstractC3160z implements X5.n {
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            this.f26568a.invoke(composer, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class f extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ M3.a f26569a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ X5.n f26570b;
        ...
        public final void invoke(Composer composer, int i8) {
            b.b(this.f26569a, this.f26570b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26571c | 1));
        }
    }
    ...
    public static final class g extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ M3.a f26572a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ InterfaceC3983b f26573b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ I3.n f26574c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ I3.m f26575d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ InterfaceC3983b f26576e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC4021c f26577f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ C3989d f26578g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f26579h;
        ...
        g(M3.a aVar, InterfaceC3983b interfaceC3983b, I3.n nVar, I3.m mVar, InterfaceC3983b interfaceC3983b2, InterfaceC4021c interfaceC4021c, C3989d c3989d, int i8) {
            super(2);
            this.f26572a = aVar;
            this.f26573b = interfaceC3983b;
            this.f26574c = nVar;
            this.f26575d = mVar;
            this.f26576e = interfaceC3983b2;
            this.f26577f = interfaceC4021c;
            this.f26578g = c3989d;
            this.f26579h = i8;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            b.c(this.f26572a, this.f26573b, this.f26574c, this.f26575d, this.f26576e, this.f26577f, this.f26578g, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26579h | 1));
        }
    }
    ...
    public static final class h extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ InterfaceC4021c f26580a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        h(InterfaceC4021c interfaceC4021c) {
            super(2);
            this.f26580a = interfaceC4021c;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            this.f26580a.f(PaddingKt.m604paddingqDBjuR0$default(Modifier.Companion, 0.0f, 0.0f, 0.0f, Dp.m5178constructorimpl(8), 7, null), composer, 6);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final class i extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ M3.a f26581a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ InterfaceC3983b f26582b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ I3.n f26583c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ I3.m f26584d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ InterfaceC3983b f26585e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC4021c f26586f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ C3989d f26587g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Modifier f26588h;
        ...
        i(M3.a aVar, InterfaceC3983b interfaceC3983b, I3.n nVar, I3.m mVar, InterfaceC3983b interfaceC3983b2, InterfaceC4021c interfaceC4021c, C3989d c3989d, Modifier modifier, int i8) {
            super(2);
            this.f26581a = aVar;
            this.f26582b = interfaceC3983b;
            this.f26583c = nVar;
            this.f26584d = mVar;
            this.f26585e = interfaceC3983b2;
            this.f26586f = interfaceC4021c;
            this.f26587g = c3989d;
        ...
        public final void invoke(Composer composer, int i8) {
            b.d(this.f26581a, this.f26582b, this.f26583c, this.f26584d, this.f26585e, this.f26586f, this.f26587g, this.f26588h, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26589i | 1));
        }
    }
    ...
    public static final class j extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ State f26590a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.paymentsheet.y f26591b;
        ...
        public static final class a extends AbstractC3160z implements X5.o {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ com.stripe.android.paymentsheet.y f26592a;
            ...
            public final void invoke(AnimatedVisibilityScope AnimatedVisibility, Composer composer, int i8) {
                ...
                b.n(this.f26592a, D.f4765a, null, composer, 56, 4);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            AnimatedVisibilityKt.AnimatedVisibility(b.i(this.f26590a), (Modifier) null, (EnterTransition) null, (ExitTransition) null, (String) null, ComposableLambdaKt.composableLambda(composer, 1471340973, true, new a(this.f26591b)), composer, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 30);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final class k extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ M3.a f26593a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ boolean f26594b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ X5.n f26595c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ int f26596d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ int f26597e;
        ...
        public final void invoke(Composer composer, int i8) {
            b.f(this.f26593a, this.f26594b, this.f26595c, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26596d | 1), this.f26597e);
        }
    }
    ...
    public static final class l extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.paymentsheet.y f26598a;
        ...
        public final void invoke(Composer composer, int i8) {
            b.h(this.f26598a, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26599b | 1));
        }
    }
    ...
    public static final class m extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.paymentsheet.t f26600a;
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            b.n(this.f26600a, D.f4766b, null, composer, 56, 4);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final class n extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.paymentsheet.t f26601a;
        ...
        public final void invoke(Composer composer, int i8) {
            b.g(this.f26601a, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26602b | 1));
        }
    }
    ...
    public static final class o extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ M3.a f26603a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ State f26604b;
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            State a8 = v4.f.a(this.f26603a.r().f(), composer, 8);
            ...
            F.b(b(v4.f.a((InterfaceC3349K) rememberedValue, composer, 8)), !b.j(this.f26604b), new a(this.f26603a), 0.0f, composer, 0, 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final class p extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Density f26605a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ MutableState f26606b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        p(Density density, MutableState mutableState) {
            super(1);
            this.f26605a = density;
            this.f26606b = mutableState;
        }
        ...
        public final void invoke(LayoutCoordinates it) {
            ...
            b.m(this.f26606b, this.f26605a.mo445toDpu2uoSUM(IntSize.m5343getHeightimpl(it.mo4138getSizeYbymL2g())));
        }
    }
    ...
    public static final class q extends AbstractC3160z implements X5.o {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ MutableState f26607a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ State f26608b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        q(MutableState mutableState, State state) {
            super(3);
            this.f26607a = mutableState;
            this.f26608b = state;
        }
    ...
    public static final class r extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ M3.a f26609a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ D f26610b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Modifier f26611c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ int f26612d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ int f26613e;
        ...
        public final void invoke(Composer composer, int i8) {
            b.n(this.f26609a, this.f26610b, this.f26611c, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26612d | 1), this.f26613e);
        }
    }
    ...
    public static final class s extends AbstractC3160z implements X5.o {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ M3.a f26614a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Context f26615b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ MutableState f26616c;
        ...
        public final C3827a a(LayoutInflater inflater, ViewGroup parent, boolean z8) {
            ...
            PrimaryButton primaryButton = c8.f38772b;
            AbstractC3159y.h(primaryButton, "primaryButton");
            b.x(this.f26616c, primaryButton);
            C3085k c3085k = C3085k.f33215a;
            C3077c b8 = c3085k.b();
            ColorStateList I8 = this.f26614a.f().I();
            if (I8 == null) {
                I8 = ColorStateList.valueOf(AbstractC3087m.d(c3085k.b(), this.f26615b));
    ...
    public static final class t extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ M3.a f26618b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ MutableState f26619c;
        ...
        public static final class a implements InterfaceC3359g {
            ...
            public final Object emit(PrimaryButton.b bVar, P5.d dVar) {
                PrimaryButton w8 = b.w(this.f26620a);
                if (w8 != null) {
                    w8.j(bVar);
                }
                return I.f6474a;
        ...
        t(M3.a aVar, MutableState mutableState, P5.d dVar) {
            super(2, dVar);
            this.f26618b = aVar;
            this.f26619c = mutableState;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new t(this.f26618b, this.f26619c, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                L5.t.b(obj);
                InterfaceC3349K u8 = this.f26618b.u();
                a aVar = new a(this.f26619c);
                this.f26617a = 1;
    ...
    public static final class u extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ M3.a f26622b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ MutableState f26623c;
        ...
        public static final class a implements InterfaceC3359g {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ MutableState f26624a;
            ...
            public static final class C0663a extends kotlin.coroutines.jvm.internal.l implements X5.n {
                ...
                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ y3.h f26626b;

                /* renamed from: c, reason: collision with root package name */
                final /* synthetic */ MutableState f26627c;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C0663a(y3.h hVar, MutableState mutableState, P5.d dVar) {
                    super(2, dVar);
                    this.f26626b = hVar;
                    this.f26627c = mutableState;
                }

                @Override // kotlin.coroutines.jvm.internal.a
                public final P5.d create(Object obj, P5.d dVar) {
                    return new C0663a(this.f26626b, this.f26627c, dVar);
                }

                @Override // X5.n
                public final Object invoke(M m8, P5.d dVar) {
                    return ((C0663a) create(m8, dVar)).invokeSuspend(I.f6474a);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (this.f26625a == 0) {
                        L5.t.b(obj);
                        PrimaryButton w8 = b.w(this.f26627c);
                        if (w8 != null) {
                            y3.h hVar = this.f26626b;
                            if (hVar != null) {
                                aVar = b.O(hVar);
                            } else {
                                aVar = null;
            ...
            public final Object emit(y3.h hVar, P5.d dVar) {
                Object g8 = AbstractC2825i.g(C2812b0.c(), new C0663a(hVar, this.f26624a, null), dVar);
                if (g8 == Q5.b.e()) {
                    return g8;
                }
                return I.f6474a;
        ...
        u(M3.a aVar, MutableState mutableState, P5.d dVar) {
            super(2, dVar);
            this.f26622b = aVar;
            this.f26623c = mutableState;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new u(this.f26622b, this.f26623c, dVar);
        }

        @Override // X5.n
        public final Object invoke(M m8, P5.d dVar) {
            return ((u) create(m8, dVar)).invokeSuspend(I.f6474a);
        }
    ...
    public static final class v extends AbstractC3160z implements X5.n {
        ...
        public final void invoke(Composer composer, int i8) {
            b.v(this.f26628a, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26629b | 1));
        }
    }
    ...
    public static final class w extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(SemanticsPropertyReceiver semantics) {
            ...
            PrimaryButton.b bVar = (PrimaryButton.b) this.f26630a.getValue();
            if (bVar == null || !bVar.c()) {
    ...
    public static final class x extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ BoxScope f26631a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ I3.m f26632b;
        ...
        public final void invoke(Composer composer, int i8) {
            b.y(this.f26631a, this.f26632b, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26633c | 1));
        }
    }
    ...
    public static final class y extends AbstractC3160z implements X5.n {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ I3.n f26634a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ I3.m f26635b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function0 f26636c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function0 f26637d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ float f26638e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Modifier f26639f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f26640g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f26641h;
        ...
        y(I3.n nVar, I3.m mVar, Function0 function0, Function0 function02, float f8, Modifier modifier, int i8, int i9) {
            ...
            this.f26634a = nVar;
            this.f26635b = mVar;
            this.f26636c = function0;
            this.f26637d = function02;
            this.f26638e = f8;
            this.f26639f = modifier;
            this.f26640g = i8;
            this.f26641h = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            b.z(this.f26634a, this.f26635b, this.f26636c, this.f26637d, this.f26638e, this.f26639f, composer, RecomposeScopeImplKt.updateChangedFlags(this.f26640g | 1), this.f26641h);
        }
    }
    ...
    public /* synthetic */ class z {
        ...
        static {
            ...
            try {
                iArr[InterfaceC4021c.EnumC0926c.f40088a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[InterfaceC4021c.EnumC0926c.f40089b.ordinal()] = 2;
    ...
    public static final PrimaryButton.a O(y3.h hVar) {
        ...
        if (hVar instanceof h.b) {
            return PrimaryButton.a.b.f26524b;
        }
        if (hVar instanceof h.c) {
            return PrimaryButton.a.c.f26525b;
        }
    ...
    public static final void a(boolean z8, Composer composer, int i8) {
        ...
        if ((i9 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            if (z8) {
                EffectsKt.LaunchedEffect(I.f6474a, new a(textInputService, null), startRestartGroup, 70);
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final void c(M3.a aVar, InterfaceC3983b interfaceC3983b, I3.n nVar, I3.m mVar, InterfaceC3983b interfaceC3983b2, InterfaceC4021c interfaceC4021c, C3989d c3989d, Composer composer, int i8) {
        ...
        int i9 = z.f26642a[interfaceC4021c.b().ordinal()];
        if (i9 != 1) {
            if (i9 != 2) {
    ...
    public static final void d(M3.a aVar, InterfaceC3983b interfaceC3983b, I3.n nVar, I3.m mVar, InterfaceC3983b interfaceC3983b2, InterfaceC4021c interfaceC4021c, C3989d c3989d, Modifier modifier, Composer composer, int i8) {
        ...
        if (nVar == null) {
            ...
            str = null;
            f8 = 0.0f;
            z(nVar, mVar, nVar.e(), nVar.f(), interfaceC4021c.r(), PaddingKt.m604paddingqDBjuR0$default(Modifier.Companion, 0.0f, 0.0f, 0.0f, Dp.m5178constructorimpl(interfaceC4021c.r() - interfaceC4021c.o()), 7, null), startRestartGroup, C3073m.a.f32993d | ((i8 >> 6) & 112), 0);
            I i13 = I.f6474a;
        }
        startRestartGroup.endReplaceableGroup();
    ...
    private static final void e(M3.a aVar, InterfaceC3983b interfaceC3983b, I3.n nVar, I3.m mVar, InterfaceC3983b interfaceC3983b2, InterfaceC4021c interfaceC4021c, C3989d c3989d, Modifier modifier, Composer composer, int i8) {
        ...
        d(aVar, interfaceC3983b, nVar, mVar, interfaceC3983b2, interfaceC4021c, c3989d, modifier, composer, (C3073m.a.f32993d << 6) | 2129992 | ((i8 << 21) & 29360128));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final void n(M3.a viewModel, D type, Modifier modifier, Composer composer, int i8, int i9) {
        ...
        startRestartGroup.startReplaceableGroup(2058660585);
        ColumnScopeInstance columnScopeInstance = ColumnScopeInstance.INSTANCE;
        c(viewModel, r(a14), s8, t(a9), u(a10), p(a12), o(a11), startRestartGroup, (C3073m.a.f32993d << 6) | 2129992);
    ...
    public static final void y(BoxScope boxScope, I3.m mVar, Composer composer, int i8) {
        ...
        if ((i9 & 81) == 16 && startRestartGroup.getSkipping()) {
            ...
            AnimatedContentKt.AnimatedContent(mVar, null, null, null, "AnimatedProcessingState", null, C1199g.f5166a.a(), startRestartGroup, ((i9 >> 3) & 14) | 1597440, 46);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
