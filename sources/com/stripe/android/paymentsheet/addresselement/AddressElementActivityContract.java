...
public final class AddressElementActivityContract extends ActivityResultContract<a, d> {
    ...
    public static final b f25550a = new b(null);
    ...
    public static final class a implements Parcelable {
        ...
        private final r3.e f25554b;

        /* renamed from: c, reason: collision with root package name */
        public static final C0586a f25551c = new C0586a(null);

        /* renamed from: d, reason: collision with root package name */
        public static final int f25552d = 8;
        ...
        public boolean equals(Object obj) {
            ...
            a aVar = (a) obj;
            return AbstractC3159y.d(this.f25553a, aVar.f25553a) && AbstractC3159y.d(this.f25554b, aVar.f25554b);
        }

        public int hashCode() {
            int hashCode = this.f25553a.hashCode() * 31;
            r3.e eVar = this.f25554b;
            return hashCode + (eVar == null ? 0 : eVar.hashCode());
        }

        public String toString() {
            return "Args(publishableKey=" + this.f25553a + ", config=" + this.f25554b + ")";
        }
    ...
    public static final class c implements Parcelable {
        ...
        public c(d addressOptionsResult) {
            ...
            this.f25555a = addressOptionsResult;
        }
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof c) && AbstractC3159y.d(this.f25555a, ((c) obj).f25555a);
        }
        ...
        public String toString() {
            return "Result(addressOptionsResult=" + this.f25555a + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeParcelable(this.f25555a, i8);
        }
    }
