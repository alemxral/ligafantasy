...
public final class j extends ViewModel {
    ...
    static final class a extends l implements n {
        ...
        public static final class C0600a implements InterfaceC3359g {
            ...
            public final Object emit(C3686a c3686a, P5.d dVar) {
                ...
                Object emit = this.f25696a.f25684d.emit(new C3686a(str, aVar, str2, bool), dVar);
                if (emit == Q5.b.e()) {
                    return emit;
                }
                return I.f6474a;
    ...
    public final void k(C3686a addressDetails) {
        ...
        if (b9 != null && (c8 = b9.c()) != null) {
            ...
            interfaceC3746b.b(c8, z8, Integer.valueOf(r3.g.b(addressDetails, (C3686a) this.f25685e.getValue())));
        }
