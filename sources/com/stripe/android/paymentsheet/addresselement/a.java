...
public final class a {
    ...
    public static final C0587a f25556c = new C0587a(null);

    /* renamed from: d, reason: collision with root package name */
    public static final int f25557d = 8;

    /* renamed from: a, reason: collision with root package name */
    private NavHostController f25558a;

    /* renamed from: b, reason: collision with root package name */
    private Function1 f25559b;
    ...
    public final void a(d result) {
        ...
        Function1 function1 = this.f25559b;
        if (function1 != null) {
    ...
    public final InterfaceC3358f c(String key) {
        ...
        NavHostController navHostController = this.f25558a;
    ...
    public final void f(NavHostController navHostController) {
        this.f25558a = navHostController;
    }

    public final void g(Function1 function1) {
        this.f25559b = function1;
    }
