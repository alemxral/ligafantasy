...
public final class CvcRecollectionActivity extends AppCompatActivity {
    ...
    private final InterfaceC1227k f26173a = l.b(new a());

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC1227k f26174b = new ViewModelLazy(U.b(com.stripe.android.paymentsheet.paymentdatacollection.cvcrecollection.d.class), new c(this), new e(), new d(null, this));
    ...
    static final class a extends AbstractC3160z implements Function0 {
        ...
        public final CvcRecollectionContract.a invoke() {
            CvcRecollectionContract.a.C0633a c0633a = CvcRecollectionContract.a.f26193e;
    ...
    static final class b extends AbstractC3160z implements n {
        ...
        public static final class a extends AbstractC3160z implements n {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ CvcRecollectionActivity f26177a;
            ...
            public static final class C0629a extends kotlin.coroutines.jvm.internal.l implements n {
                ...
                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ CvcRecollectionActivity f26179b;

                /* renamed from: c, reason: collision with root package name */
                final /* synthetic */ C3471g f26180c;
                ...
                public static final class C0630a extends kotlin.coroutines.jvm.internal.l implements n {
                    ...
                    /* renamed from: b, reason: collision with root package name */
                    /* synthetic */ Object f26182b;

                    /* renamed from: c, reason: collision with root package name */
                    final /* synthetic */ CvcRecollectionActivity f26183c;

                    /* renamed from: d, reason: collision with root package name */
                    final /* synthetic */ C3471g f26184d;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C0630a(CvcRecollectionActivity cvcRecollectionActivity, C3471g c3471g, P5.d dVar) {
                        super(2, dVar);
                        this.f26183c = cvcRecollectionActivity;
                        this.f26184d = c3471g;
                    }

                    @Override // kotlin.coroutines.jvm.internal.a
                    public final P5.d create(Object obj, P5.d dVar) {
                        C0630a c0630a = new C0630a(this.f26183c, this.f26184d, dVar);
                        c0630a.f26182b = obj;
                        return c0630a;
                    }
                    ...
                    public final Object invoke(com.stripe.android.paymentsheet.paymentdatacollection.cvcrecollection.a aVar, P5.d dVar) {
                        return ((C0630a) create(aVar, dVar)).invokeSuspend(I.f6474a);
                    }
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i8 != 0) {
                            ...
                            t.b(obj);
                            com.stripe.android.paymentsheet.paymentdatacollection.cvcrecollection.a aVar = (com.stripe.android.paymentsheet.paymentdatacollection.cvcrecollection.a) this.f26182b;
                            CvcRecollectionActivity cvcRecollectionActivity = this.f26183c;
                            a.b bVar = com.stripe.android.paymentsheet.paymentdatacollection.cvcrecollection.a.f26198l0;
                            Intent intent = cvcRecollectionActivity.getIntent();
                            AbstractC3159y.h(intent, "getIntent(...)");
                            cvcRecollectionActivity.setResult(-1, bVar.b(intent, aVar));
                            C3471g c3471g = this.f26184d;
                            this.f26181a = 1;
                            if (c3471g.c(this) == e8) {
                                return e8;
                            }
                ...
                C0629a(CvcRecollectionActivity cvcRecollectionActivity, C3471g c3471g, P5.d dVar) {
                    super(2, dVar);
                    this.f26179b = cvcRecollectionActivity;
                    this.f26180c = c3471g;
                }

                @Override // kotlin.coroutines.jvm.internal.a
                public final P5.d create(Object obj, P5.d dVar) {
                    return new C0629a(this.f26179b, this.f26180c, dVar);
                }

                @Override // X5.n
                public final Object invoke(M m8, P5.d dVar) {
                    return ((C0629a) create(m8, dVar)).invokeSuspend(I.f6474a);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i8 != 0) {
                        ...
                        t.b(obj);
                        z b8 = this.f26179b.q().b();
                        C0630a c0630a = new C0630a(this.f26179b, this.f26180c, null);
                        this.f26178a = 1;
            ...
            public static final class C0631b extends AbstractC3160z implements Function0 {
                ...
                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ CvcRecollectionActivity f26185a;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C0631b(CvcRecollectionActivity cvcRecollectionActivity) {
                    super(0);
                    this.f26185a = cvcRecollectionActivity;
                }
            ...
            public static final class c extends AbstractC3160z implements n {
                ...
                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ State f26186a;

                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ CvcRecollectionActivity f26187b;
                ...
                c(State state, CvcRecollectionActivity cvcRecollectionActivity) {
                    super(2);
                    this.f26186a = state;
                    this.f26187b = cvcRecollectionActivity;
                }
                ...
                public final void invoke(Composer composer, int i8) {
                    ...
                    com.stripe.android.paymentsheet.paymentdatacollection.cvcrecollection.b.e(((f) this.f26186a.getValue()).d(), ((f) this.f26186a.getValue()).e(), ((f) this.f26186a.getValue()).c(), new C0632a(this.f26187b.q()), composer, 0);
                    if (ComposerKt.isTraceInProgress()) {
            ...
            a(CvcRecollectionActivity cvcRecollectionActivity) {
                super(2);
                this.f26177a = cvcRecollectionActivity;
            }
            ...
            public final void invoke(Composer composer, int i8) {
                ...
                State a8 = v4.f.a(this.f26177a.q().c(), composer, 8);
                C0629a c0629a = new C0629a(this.f26177a, b8, null);
                int i9 = C3471g.f36145e;
                EffectsKt.LaunchedEffect(b8, c0629a, composer, i9 | 64);
                AbstractC3647a.a(b8, null, new C0631b(this.f26177a), ComposableLambdaKt.composableLambda(composer, -943727818, true, new c(a8, this.f26177a)), composer, i9 | 3072, 2);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
    ...
    public static final class c extends AbstractC3160z implements Function0 {
        ...
        public final ViewModelStore invoke() {
            return this.f26188a.getViewModelStore();
        }
    }
    ...
    public static final class d extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f26189a;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f26189a;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f26190b.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    public final CvcRecollectionContract.a p() {
        return (CvcRecollectionContract.a) this.f26173a.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final com.stripe.android.paymentsheet.paymentdatacollection.cvcrecollection.d q() {
        return (com.stripe.android.paymentsheet.paymentdatacollection.cvcrecollection.d) this.f26174b.getValue();
    }
