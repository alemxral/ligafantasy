...
public final class d extends ViewModel {
    ...
    private final Q f26244a;

    /* renamed from: b, reason: collision with root package name */
    private final v f26245b;

    /* renamed from: c, reason: collision with root package name */
    private final u f26246c;

    /* renamed from: d, reason: collision with root package name */
    private final z f26247d;

    /* loaded from: classes4.dex */
    public static final class a implements ViewModelProvider.Factory {

        /* renamed from: a, reason: collision with root package name */
        private final CvcRecollectionContract.a f26248a;
        ...
        public ViewModel create(Class modelClass, CreationExtras extras) {
            ...
            return new d(new E3.a(this.f26248a.e(), this.f26248a.c(), null, this.f26248a.f()));
        }
    }
    ...
    public static final class b extends l implements X5.n {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                t.b(obj);
                u uVar = d.this.f26246c;
                a.C0634a c0634a = a.C0634a.f26199a;
                this.f26249a = 1;
    ...
    public static final class c extends l implements X5.n {
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new c(this.f26253c, dVar);
        }
    ...
    public d(E3.a args) {
        AbstractC3159y.i(args, "args");
        this.f26244a = new Q(null, g.n(args.a()), null, false, 13, null);
        String c8 = args.c();
        boolean d8 = args.d();
        String b8 = args.b();
        this.f26245b = AbstractC3351M.a(new f(c8, d8, new E3.g(b8 == null ? "" : b8, args.a())));
        u b9 = AbstractC3340B.b(0, 0, null, 7, null);
        this.f26246c = b9;
        this.f26247d = AbstractC3360h.a(b9);
    }
