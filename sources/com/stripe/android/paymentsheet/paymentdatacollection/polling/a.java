...
public final class a extends AbstractC3176f {
    ...
    private ActivityResultLauncher f26282a;
    ...
    public /* synthetic */ class C0644a {
        ...
        static {
            ...
            try {
                iArr[o.p.f24527q.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[o.p.f24496B.ordinal()] = 2;
    ...
    public void b(ActivityResultCaller activityResultCaller, ActivityResultCallback activityResultCallback) {
        ...
        this.f26282a = activityResultCaller.registerForActivityResult(new PollingContract(), activityResultCallback);
    }

    @Override // l3.AbstractC3176f, j3.InterfaceC3074a
    public void c() {
        ActivityResultLauncher activityResultLauncher = this.f26282a;
    ...
    public Object e(InterfaceC2464p interfaceC2464p, StripeIntent stripeIntent, j.c cVar, d dVar) {
        ...
        if (pVar == null) {
            ...
            i8 = C0644a.f26283a[pVar.ordinal()];
        }
        if (i8 != 1) {
            if (i8 != 2) {
                o v9 = stripeIntent.v();
                if (v9 != null && (pVar2 = v9.f24399e) != null) {
                    str = pVar2.f24537a;
                }
            ...
            if (d8 != null) {
                aVar = new PollingContract.a(d8, interfaceC2464p.b(), 60, 5, 12, w.f37438d);
            } else {
            ...
            if (d9 != null) {
                aVar = new PollingContract.a(d9, interfaceC2464p.b(), 300, 5, 12, w.f37453k0);
            } else {
                throw new IllegalArgumentException("Required value was null.".toString());
            }
        }
        ...
        ActivityResultLauncher activityResultLauncher = this.f26282a;
        if (activityResultLauncher == null) {
            i.b.a(i.a.b(i.f33380a, interfaceC2464p.c(), null, 2, null), i.f.f33415e, null, null, 6, null);
        } else {
