...
public final class C2433b implements w {
    ...
    private final ActivityResultLauncher f25873a;

    /* renamed from: b, reason: collision with root package name */
    private final Activity f25874b;

    /* renamed from: c, reason: collision with root package name */
    private final LifecycleOwner f25875c;

    /* renamed from: d, reason: collision with root package name */
    private final Application f25876d;

    /* renamed from: e, reason: collision with root package name */
    private final q3.p f25877e;
    ...
    public C2433b(ActivityResultLauncher activityResultLauncher, Activity activity, LifecycleOwner lifecycleOwner, Application application, q3.p callback, boolean z8) {
        ...
        this.f25873a = activityResultLauncher;
        this.f25874b = activity;
        this.f25875c = lifecycleOwner;
        this.f25876d = application;
        this.f25877e = callback;
        this.f25878f = z8;
    ...
    public void a(u.l mode, u.g gVar) {
        ...
        if (gVar == null) {
            gVar = u.g.f26403q.a(this.f25874b);
        }
        Window window = this.f25874b.getWindow();
        if (window != null) {
            num = Integer.valueOf(window.getStatusBarColor());
        } else {
            num = null;
        }
        PaymentSheetContractV2.a aVar = new PaymentSheetContractV2.a(mode, gVar, num, this.f25878f);
        Context applicationContext = this.f25876d.getApplicationContext();
        C3829a c3829a = C3829a.f38778a;
        ...
        try {
            this.f25873a.launch(aVar, makeCustomAnimation);
        } catch (IllegalStateException e8) {
            this.f25877e.a(new x.c(new IllegalStateException("The host activity is not in a valid state (" + this.f25875c.getLifecycle().getCurrentState() + ").", e8)));
        }
    }
