...
public final class ExternalPaymentMethodProxyActivity extends AppCompatActivity {
    ...
    public static final int f25434c = 8;
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            this.f25435a = bundle.getBoolean("has_confirm_started");
        }
        String stringExtra = getIntent().getStringExtra("external_payment_method_type");
        if (stringExtra != null && !this.f25435a) {
            this.f25435a = true;
            C3657j.f37319a.a();
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean("has_confirm_started", this.f25435a);
