...
public abstract class z {
    ...
    public static final class a extends AbstractC3160z implements Function0 {
        ...
        public final Boolean invoke() {
            return Boolean.valueOf(this.f26783a.f().u() != u.n.f26481d);
        }
    }
    ...
    public static final class b extends AbstractC3160z implements Function0 {
        ...
        @Override // kotlin.jvm.functions.Function0
        public final Boolean invoke() {
            return Boolean.valueOf(this.f26784a.f().u() == u.n.f26481d && !(this.f26784a.r().f().getValue() instanceof InterfaceC4021c.d));
        }
    }
