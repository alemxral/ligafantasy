...
public final class K0 extends RecyclerView.Adapter {
    ...
    private Function1 f27385a = b.f27389a;

    /* renamed from: b, reason: collision with root package name */
    private List f27386b = AbstractC1246t.m();

    /* renamed from: c, reason: collision with root package name */
    private /* synthetic */ int f27387c;

    /* loaded from: classes4.dex */
    public static final class a extends RecyclerView.ViewHolder {

        /* renamed from: a, reason: collision with root package name */
        private final L0 f27388a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(L0 shippingMethodView) {
            super(shippingMethodView);
            AbstractC3159y.i(shippingMethodView, "shippingMethodView");
            this.f27388a = shippingMethodView;
        }
    ...
    public final C1859D b() {
        return (C1859D) AbstractC1246t.p0(this.f27386b, this.f27387c);
    }
    ...
    public void onBindViewHolder(final a holder, int i8) {
        boolean z8;
        AbstractC3159y.i(holder, "holder");
        holder.c((C1859D) this.f27386b.get(i8));
        if (i8 == this.f27387c) {
            z8 = true;
        } else {
            z8 = false;
    ...
    public final void g(C1859D shippingMethod) {
        AbstractC3159y.i(shippingMethod, "shippingMethod");
        h(this.f27386b.indexOf(shippingMethod));
    }
    ...
    public long getItemId(int i8) {
        return ((C1859D) this.f27386b.get(i8)).hashCode();
    }
    ...
    public final void h(int i8) {
        ...
        if (i9 != i8) {
            ...
            this.f27387c = i8;
            this.f27385a.invoke(this.f27386b.get(i8));
        }
    }
