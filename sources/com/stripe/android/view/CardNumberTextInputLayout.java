...
public final class CardNumberTextInputLayout extends TextInputLayout {
    ...
    static final /* synthetic */ e6.i[] f27303c = {kotlin.jvm.internal.U.e(new kotlin.jvm.internal.E(CardNumberTextInputLayout.class, "isLoading", "isLoading$payments_core_release()Z", 0))};

    /* renamed from: d, reason: collision with root package name */
    public static final int f27304d = 8;

    /* renamed from: a, reason: collision with root package name */
    private final M f27305a;

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC1580e f27306b;
    ...
    public static final class b extends AbstractC1577b {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ CardNumberTextInputLayout f27308b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(Object obj, CardNumberTextInputLayout cardNumberTextInputLayout) {
            super(obj);
            this.f27308b = cardNumberTextInputLayout;
        }
        ...
        protected void a(e6.i property, Object obj, Object obj2) {
            ...
            if (((Boolean) obj).booleanValue() != booleanValue) {
                if (booleanValue) {
                    this.f27308b.f27305a.b();
                } else {
                    this.f27308b.f27305a.a();
                }
            }
        }
    }
    ...
    public final void e() {
        ViewGroup viewGroup;
        ViewParent parent = this.f27305a.getParent();
        ...
        if (viewGroup != null) {
            viewGroup.removeView(this.f27305a);
        }
        ...
        frameLayout.addView(this.f27305a);
        M m8 = this.f27305a;
        ViewGroup.LayoutParams layoutParams = m8.getLayoutParams();
        if (layoutParams != null) {
            FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) layoutParams;
            layoutParams2.setMarginStart(frameLayout.getWidth() - getResources().getDimensionPixelSize(j2.y.f33095c));
            layoutParams2.topMargin = getResources().getDimensionPixelSize(j2.y.f33096d);
    ...
    public final void setLoading$payments_core_release(boolean z8) {
        this.f27306b.setValue(this, f27303c[0], Boolean.valueOf(z8));
    }
    ...
    public CardNumberTextInputLayout(Context context, AttributeSet attributeSet, int i8) {
        ...
        AbstractC3159y.i(context, "context");
        this.f27305a = new M(context, attributeSet, i8);
        C1576a c1576a = C1576a.f13550a;
        this.f27306b = new b(Boolean.FALSE, this);
        addOnLayoutChangeListener(new a());
        setPlaceholderText(getResources().getString(AbstractC3053E.f32855a0));
    }
}
