...
public final class AddPaymentMethodActivity extends M0 {
    ...
    public static final a f27103n = new a(null);

    /* renamed from: o, reason: collision with root package name */
    public static final int f27104o = 8;

    /* renamed from: g, reason: collision with root package name */
    private final InterfaceC1227k f27105g = L5.l.b(new d());

    /* renamed from: h, reason: collision with root package name */
    private final InterfaceC1227k f27106h = L5.l.b(new m());

    /* renamed from: i, reason: collision with root package name */
    private final InterfaceC1227k f27107i = L5.l.b(new i());

    /* renamed from: j, reason: collision with root package name */
    private final InterfaceC1227k f27108j = L5.l.b(new j());

    /* renamed from: k, reason: collision with root package name */
    private final InterfaceC1227k f27109k = L5.l.b(new c());

    /* renamed from: l, reason: collision with root package name */
    private final InterfaceC1227k f27110l = new ViewModelLazy(kotlin.jvm.internal.U.b(C2456l.class), new k(this), new n(), new l(null, this));

    /* renamed from: m, reason: collision with root package name */
    private final f f27111m = new f();
    ...
    static final class c extends AbstractC3160z implements Function0 {
        ...
        public final AbstractC2454k invoke() {
            ...
            J8.setId(AbstractC3049A.f32740R);
            return J8;
        }
    }
    ...
    public static final class e extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        final /* synthetic */ com.stripe.android.model.o f27117c;
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            return new e(null, this.f27117c, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                com.stripe.android.model.o oVar = this.f27117c;
                this.f27115a = 1;
    ...
    public static final class g extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        final /* synthetic */ C2456l f27120b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ com.stripe.android.model.p f27121c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ AddPaymentMethodActivity f27122d;
        ...
        g(C2456l c2456l, com.stripe.android.model.p pVar, AddPaymentMethodActivity addPaymentMethodActivity, P5.d dVar) {
            ...
            this.f27120b = c2456l;
            this.f27121c = pVar;
            this.f27122d = addPaymentMethodActivity;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new g(this.f27120b, this.f27121c, this.f27122d, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                L5.t.b(obj);
                C2456l c2456l = this.f27120b;
                com.stripe.android.model.p pVar = this.f27121c;
                this.f27119a = 1;
            ...
            AddPaymentMethodActivity addPaymentMethodActivity = this.f27122d;
    ...
    static final class j extends AbstractC3160z implements Function0 {
        ...
        public final Boolean invoke() {
            return Boolean.valueOf(AddPaymentMethodActivity.this.O().f24538b && AddPaymentMethodActivity.this.N().i());
        }
    }
    ...
    public static final class k extends AbstractC3160z implements Function0 {
        ...
        public final ViewModelStore invoke() {
            return this.f27126a.getViewModelStore();
        }
    }
    ...
    public static final class l extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f27127a;
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f27127a;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f27128b.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    static final class m extends AbstractC3160z implements Function0 {
        ...
        public final C3057I invoke() {
            ...
            if (e8 == null) {
                e8 = j2.r.f33047c.a(AddPaymentMethodActivity.this);
            }
    ...
    private final void G(C2440d c2440d) {
        ...
        s().setLayoutResource(AbstractC3051C.f32790c);
    ...
    private final View H(ViewGroup viewGroup) {
        if (N().b() > 0) {
            ...
            inflate.setId(AbstractC3049A.f32739Q);
    ...
    public final AbstractC2454k J(C2440d c2440d) {
        int i8 = b.f27112a[O().ordinal()];
        if (i8 != 1) {
            if (i8 != 2) {
                if (i8 == 3) {
                    return C2452j.f27730c.a(this);
                }
                throw new IllegalArgumentException("Unsupported Payment Method type: " + O().f24537a);
            }
            return C2446g.f27695d.a(this);
        }
        C2444f c2444f = new C2444f(this, null, 0, c2440d.c(), 6, null);
        c2444f.setCardInputListener(this.f27111m);
        return c2444f;
    }
    ...
    private final AbstractC2454k M() {
        return (AbstractC2454k) this.f27109k.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final C2440d N() {
        return (C2440d) this.f27105g.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final o.p O() {
        return (o.p) this.f27107i.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final boolean P() {
        return ((Boolean) this.f27108j.getValue()).booleanValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final C3057I Q() {
        return (C3057I) this.f27106h.getValue();
    }
    ...
    private final int R() {
        ...
        if (i8 != 1) {
            if (i8 != 2) {
                if (i8 == 3) {
                    return AbstractC3053E.f32833J0;
                }
                throw new IllegalArgumentException("Unsupported Payment Method type: " + O().f24537a);
            }
            return AbstractC3053E.f32833J0;
        }
        return AbstractC3053E.f32829H0;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final C2456l S() {
        return (C2456l) this.f27110l.getValue();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        S().g();
        G(N());
        setResult(-1, new Intent().putExtras(AbstractC2442e.a.f27659b.b()));
    }
