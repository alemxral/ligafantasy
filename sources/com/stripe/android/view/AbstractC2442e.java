...
public abstract class AbstractC2442e implements Parcelable {
    ...
    public static final b f27658a = new b(null);
    ...
    public static final class c extends AbstractC2442e {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof c) && AbstractC3159y.d(this.f27660b, ((c) obj).f27660b);
        }

        public int hashCode() {
            return this.f27660b.hashCode();
        }

        public String toString() {
            return "Failure(exception=" + this.f27660b + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeSerializable(this.f27660b);
        }
    }
    ...
    public static final class d extends AbstractC2442e {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final com.stripe.android.model.o f27661b;
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof d) && AbstractC3159y.d(this.f27661b, ((d) obj).f27661b);
        }
        ...
        public String toString() {
            return "Success(paymentMethod=" + this.f27661b + ")";
        }
        ...
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            this.f27661b.writeToParcel(out, i8);
        }
    }
