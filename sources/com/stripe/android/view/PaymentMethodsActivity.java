...
public final class PaymentMethodsActivity extends AppCompatActivity {
    ...
    public static final int f27501k = 8;

    /* renamed from: a, reason: collision with root package name */
    private final InterfaceC1227k f27502a = L5.l.b(new s());

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC1227k f27503b = L5.l.b(new r());

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC1227k f27504c = L5.l.b(new f());

    /* renamed from: d, reason: collision with root package name */
    private final InterfaceC1227k f27505d = L5.l.b(new e());

    /* renamed from: e, reason: collision with root package name */
    private final InterfaceC1227k f27506e = L5.l.b(new c());

    /* renamed from: f, reason: collision with root package name */
    private final InterfaceC1227k f27507f = L5.l.b(new d());

    /* renamed from: g, reason: collision with root package name */
    private final InterfaceC1227k f27508g = new ViewModelLazy(kotlin.jvm.internal.U.b(D0.class), new p(this), new t(), new q(null, this));

    /* renamed from: h, reason: collision with root package name */
    private final InterfaceC1227k f27509h = L5.l.b(new b());
    ...
    public static final class g extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public static final class a implements InterfaceC3359g {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ PaymentMethodsActivity f27518a;

            a(PaymentMethodsActivity paymentMethodsActivity) {
                this.f27518a = paymentMethodsActivity;
            }
            ...
            public final Object emit(L5.s sVar, P5.d dVar) {
                ...
                if (sVar != null) {
                    Object k8 = sVar.k();
                    PaymentMethodsActivity paymentMethodsActivity = this.f27518a;
                    ...
                    if (e8 == null) {
                        ...
                        if (e8 instanceof AbstractC3790k) {
                            ...
                            message = C3927b.f39469a.a().a(abstractC3790k.c(), e8.getMessage(), abstractC3790k.d());
                        } else {
    ...
    static final class j extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public static final class a implements InterfaceC3359g {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ PaymentMethodsActivity f27523a;

            a(PaymentMethodsActivity paymentMethodsActivity) {
                this.f27523a = paymentMethodsActivity;
            }
            ...
            public final Object emit(String str, P5.d dVar) {
                if (str != null) {
                    Snackbar.make(this.f27523a.F().f3153b, str, -1).show();
                }
                return L5.I.f6474a;
            }
        }
    ...
    static final class k extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        public static final class a implements InterfaceC3359g {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ PaymentMethodsActivity f27526a;

            a(PaymentMethodsActivity paymentMethodsActivity) {
                this.f27526a = paymentMethodsActivity;
            }

            public final Object b(boolean z8, P5.d dVar) {
                int i8;
                LinearProgressIndicator progressBar = this.f27526a.F().f3155d;
    ...
    public static final class m implements C0.b {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ActivityResultLauncher f27529b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ C2437b0 f27530c;

        m(ActivityResultLauncher activityResultLauncher, C2437b0 c2437b0) {
            this.f27529b = activityResultLauncher;
            this.f27530c = c2437b0;
        }
        ...
        public void a(com.stripe.android.model.o paymentMethod) {
            ...
            this.f27530c.d(paymentMethod).show();
        }
        ...
        public void c(C2440d args) {
            ...
            this.f27529b.launch(args);
        }

        @Override // com.stripe.android.view.C0.b
        public void d(com.stripe.android.model.o paymentMethod) {
            AbstractC3159y.i(paymentMethod, "paymentMethod");
            PaymentMethodsActivity.this.F().f3156e.setTappedPaymentMethod$payments_core_release(paymentMethod);
        }
    }
    ...
    public static final class p extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f27533a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public p(ComponentActivity componentActivity) {
            super(0);
            this.f27533a = componentActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final ViewModelStore invoke() {
            return this.f27533a.getViewModelStore();
        }
    }
    ...
    public static final class q extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f27534a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f27535b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public q(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f27534a = function0;
            this.f27535b = componentActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final CreationExtras invoke() {
            CreationExtras creationExtras;
            Function0 function0 = this.f27534a;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f27535b.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    public final InterfaceC2460n A() {
        return (InterfaceC2460n) this.f27506e.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final v0 B() {
        return (v0) this.f27507f.getValue();
    }

    private final C2477z C() {
        return (C2477z) this.f27505d.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final Object D() {
        return ((L5.s) this.f27504c.getValue()).k();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final boolean E() {
        return ((Boolean) this.f27503b.getValue()).booleanValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final D0 G() {
        return (D0) this.f27508g.getValue();
    }
    ...
    private final void K(ActivityResultLauncher activityResultLauncher) {
        ...
        F().f3156e.setAdapter(z());
        F().f3156e.setPaymentMethodSelectedCallback$payments_core_release(new n());
        if (B().e()) {
            F().f3156e.a(new t0(this, z(), new R0(c2437b0)));
        }
    }
    ...
    private final View v(ViewGroup viewGroup) {
        if (B().k() > 0) {
            ...
            inflate.setId(AbstractC3049A.f32744V);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final C0 z() {
        return (C0) this.f27509h.getValue();
    }

    public final G2.q F() {
        return (G2.q) this.f27502a.getValue();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setSupportActionBar(F().f3157f);
        ActionBar supportActionBar = getSupportActionBar();
        if (supportActionBar != null) {
            supportActionBar.setDisplayHomeAsUpEnabled(true);
            supportActionBar.setDisplayShowHomeEnabled(true);
        }
        FrameLayout footerContainer = F().f3154c;
        AbstractC3159y.h(footerContainer, "footerContainer");
        View v8 = v(footerContainer);
        if (v8 != null) {
            if (Build.VERSION.SDK_INT >= 22) {
                F().f3156e.setAccessibilityTraversalBefore(v8.getId());
                v8.setAccessibilityTraversalAfter(F().f3156e.getId());
            }
            F().f3154c.addView(v8);
            FrameLayout footerContainer2 = F().f3154c;
            AbstractC3159y.h(footerContainer2, "footerContainer");
            footerContainer2.setVisibility(0);
        }
        F().f3156e.requestFocusFromTouch();
    }
