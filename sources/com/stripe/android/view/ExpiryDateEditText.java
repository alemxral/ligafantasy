...
public final class ExpiryDateEditText extends StripeEditText {
    ...
    private /* synthetic */ Function0 f27363p;

    /* renamed from: q, reason: collision with root package name */
    private boolean f27364q;

    /* renamed from: r, reason: collision with root package name */
    private final InterfaceC1580e f27365r;

    /* renamed from: s, reason: collision with root package name */
    private final int f27366s;

    /* renamed from: t, reason: collision with root package name */
    private String f27367t;

    /* renamed from: v, reason: collision with root package name */
    static final /* synthetic */ e6.i[] f27361v = {kotlin.jvm.internal.U.e(new kotlin.jvm.internal.E(ExpiryDateEditText.class, "includeSeparatorGaps", "getIncludeSeparatorGaps$payments_core_release()Z", 0))};

    /* renamed from: u, reason: collision with root package name */
    private static final a f27360u = new a(null);

    /* renamed from: w, reason: collision with root package name */
    public static final int f27362w = 8;
    ...
    static final class b extends AbstractC3160z implements Function0 {
        ...
        public static final b f27368a = new b();
    ...
    public static final class c extends Q0 {
        ...
        private w.a f27371c = w.a.f14572f.b();

        /* renamed from: d, reason: collision with root package name */
        private Integer f27372d;
        ...
        public void afterTextChanged(Editable editable) {
            ...
            String b8 = this.f27371c.b();
            String c8 = this.f27371c.c();
            if (b8.length() == 2 && !this.f27371c.e()) {
                z8 = true;
            } else {
                z8 = false;
            }
            if (b8.length() != 2 || c8.length() != 2) {
                ExpiryDateEditText.this.f27364q = false;
            } else {
                boolean s8 = ExpiryDateEditText.this.s();
                ExpiryDateEditText expiryDateEditText2 = ExpiryDateEditText.this;
                expiryDateEditText2.f27364q = expiryDateEditText2.t(b8, c8);
            ...
            if (this.f27371c.f()) {
                i8 = AbstractC3081g.f33170F;
            } else if (!this.f27371c.e()) {
                i8 = AbstractC3081g.f33172H;
            } else {
                i8 = AbstractC3081g.f33173I;
            }
            expiryDateEditText3.setErrorMessage(resources.getString(i8));
            ExpiryDateEditText expiryDateEditText4 = ExpiryDateEditText.this;
            if (z8 && (this.f27371c.f() || this.f27371c.d())) {
                z9 = true;
            }
        ...
        public void onTextChanged(CharSequence charSequence, int i8, int i9, int i10) {
            ...
            if (sb2.length() == 1 && this.f27369a == 0 && this.f27370b == 1) {
                char charAt2 = sb2.charAt(0);
                if (charAt2 != '0' && charAt2 != '1') {
                    sb2 = MBridgeConstans.ENDCARD_URL_TYPE_PL + sb2;
                    this.f27370b++;
                }
            } else if (sb2.length() == 2 && this.f27369a == 2 && this.f27370b == 0) {
                sb2 = sb2.substring(0, 1);
                AbstractC3159y.h(sb2, "substring(...)");
            }
            w.a a8 = w.a.f14572f.a(sb2);
            this.f27371c = a8;
            boolean z8 = !a8.e();
            StringBuilder sb3 = new StringBuilder();
            sb3.append(a8.b());
            if ((a8.b().length() == 2 && this.f27370b > 0 && !z8) || sb2.length() > 2) {
                sb3.append(ExpiryDateEditText.this.f27367t);
            }
            sb3.append(a8.c());
            String sb4 = sb3.toString();
            AbstractC3159y.h(sb4, "toString(...)");
            this.f27372d = Integer.valueOf(ExpiryDateEditText.this.u(sb4.length(), this.f27369a, this.f27370b, ExpiryDateEditText.this.f27366s + ExpiryDateEditText.this.f27367t.length()));
            this.f27373e = sb4;
        }
    }
    ...
    public static final class d extends AbstractC1577b {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ExpiryDateEditText f27375b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(Object obj, ExpiryDateEditText expiryDateEditText) {
            super(obj);
            this.f27375b = expiryDateEditText;
        }
    ...
    public static final void m(ExpiryDateEditText this$0, View view, boolean z8) {
        ...
        if (!z8 && (text = this$0.getText()) != null && text.length() != 0 && !this$0.f27364q) {
    ...
    public final boolean t(String str, String str2) {
        ...
        if (str2.length() == 2) {
            try {
                ...
                obj = L5.s.b(Integer.valueOf(X.f27626a.a(Integer.parseInt(str2))));
            } catch (Throwable th2) {
    ...
    public final void v(boolean z8) {
        ...
        this.f27367t = str;
        setFilters((InputFilter[]) AbstractC1246t.e(new InputFilter.LengthFilter(this.f27366s + this.f27367t.length())).toArray(new InputFilter.LengthFilter[0]));
    }
    ...
    protected String getAccessibilityText() {
        String string = getResources().getString(AbstractC3053E.f32862e, getText());
    ...
    public final boolean getIncludeSeparatorGaps$payments_core_release() {
        return ((Boolean) this.f27365r.getValue(this, f27361v[0])).booleanValue();
    }

    public final w.b getValidatedDate() {
        boolean z8 = this.f27364q;
        if (z8) {
            return w.a.f14572f.a(getFieldText$payments_core_release()).g();
        }
        if (!z8) {
            return null;
        }
    ...
    public final void setIncludeSeparatorGaps$payments_core_release(boolean z8) {
        this.f27365r.setValue(this, f27361v[0], Boolean.valueOf(z8));
    }
    ...
    public final int u(int i8, int i9, int i10, int i11) {
        ...
        int i13 = 0;
        if (i9 <= 2 && i9 + i10 >= 2) {
            i12 = this.f27367t.length();
        } else {
            i12 = 0;
        }
        if (i10 == 0 && i9 == this.f27367t.length() + 2) {
            z8 = true;
        } else {
            z8 = false;
        }
    ...
    public ExpiryDateEditText(Context context, AttributeSet attributeSet, int i8) {
        ...
        AbstractC3159y.i(context, "context");
        this.f27363p = b.f27368a;
        C1576a c1576a = C1576a.f13550a;
        this.f27365r = new d(Boolean.FALSE, this);
        this.f27366s = context.getResources().getInteger(AbstractC3050B.f32786a);
        this.f27367t = "/";
        j();
        w(this, false, 1, null);
        i();
