...
public final class C2459m0 extends WebChromeClient {
    ...
    private final Activity f27854a;

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC3684d f27855b;
    ...
    public boolean onJsConfirm(WebView webView, String str, String str2, final JsResult jsResult) {
        new AlertDialog.Builder(this.f27854a, AbstractC3054F.f32906a).setMessage(str2).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() { // from class: com.stripe.android.view.k0
