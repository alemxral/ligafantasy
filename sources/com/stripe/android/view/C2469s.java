...
public final class C2469s {
    ...
    private static final b f27912c = new b(null);

    /* renamed from: d, reason: collision with root package name */
    public static final int f27913d = 8;

    /* renamed from: e, reason: collision with root package name */
    private static final a f27914e = new a("00", "Stripe Test Bank");

    /* renamed from: a, reason: collision with root package name */
    private final List f27915a;
    ...
    public static final class a implements Parcelable {
        ...
        public boolean equals(Object obj) {
            ...
            a aVar = (a) obj;
            return AbstractC3159y.d(this.f27917a, aVar.f27917a) && AbstractC3159y.d(this.f27918b, aVar.f27918b);
        }

        public int hashCode() {
            return (this.f27917a.hashCode() * 31) + this.f27918b.hashCode();
        }

        public String toString() {
            return "Bank(prefix=" + this.f27917a + ", name=" + this.f27918b + ")";
        }
    ...
    private static final class b {
        ...
        public final List b(Context context) {
            Map b8 = v2.e.f38770a.b(new JSONObject(c(context)));
            if (b8 == null) {
                b8 = M5.Q.h();
            }
