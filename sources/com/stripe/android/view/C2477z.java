...
public final class C2477z {
    ...
    private final Resources f27986a;

    /* renamed from: b, reason: collision with root package name */
    private final S0 f27987b;
    ...
    public C2477z(Resources resources, S0 themeConfig) {
        ...
        this.f27986a = resources;
        this.f27987b = themeConfig;
    }
    ...
    public final /* synthetic */ SpannableString a(EnumC1870e brand, String str, boolean z8) {
        ...
        if (str != null && !g6.n.u(str)) {
            String string = this.f27986a.getString(AbstractC3053E.f32853Z, h8, str);
            ...
            int c8 = this.f27987b.c(z8);
            int b8 = this.f27987b.b(z8);
    ...
    public final /* synthetic */ String b(o.g card) {
        ...
        String string = this.f27986a.getString(AbstractC3053E.f32853Z, card.f24462a.h(), card.f24469h);
        AbstractC3159y.h(string, "getString(...)");
        return string;
    }
