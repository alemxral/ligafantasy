...
public final class BecsDebitAccountNumberEditText extends StripeEditText {
    ...
    public static final a f27134q = new a(null);

    /* renamed from: r, reason: collision with root package name */
    public static final int f27135r = 8;
    ...
    public final String getAccountNumber() {
        ...
        if (g6.n.u(getFieldText$payments_core_release())) {
            str = getResources().getString(AbstractC3053E.f32843P);
        } else if (getFieldText$payments_core_release().length() < this.f27136p) {
            str = getResources().getString(AbstractC3053E.f32842O);
        } else {
            str = null;
        }
