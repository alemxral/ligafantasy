...
public interface InterfaceC2460n {
    ...
    public static final class a implements InterfaceC2460n {
        ...
        private final Activity f27856a;
        ...
        public void show(String message) {
            ...
            if (!this.f27856a.isFinishing()) {
                new AlertDialog.Builder(this.f27856a, AbstractC3054F.f32906a).setMessage(message).setCancelable(true).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() { // from class: com.stripe.android.view.m
