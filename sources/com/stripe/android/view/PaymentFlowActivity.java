...
public final class PaymentFlowActivity extends M0 {
    ...
    public static final a f27466o = new a(null);

    /* renamed from: p, reason: collision with root package name */
    public static final int f27467p = 8;

    /* renamed from: g, reason: collision with root package name */
    private final InterfaceC1227k f27468g = L5.l.b(new n());

    /* renamed from: h, reason: collision with root package name */
    private final InterfaceC1227k f27469h = L5.l.b(new p());

    /* renamed from: i, reason: collision with root package name */
    private final InterfaceC1227k f27470i = L5.l.b(c.f27477a);

    /* renamed from: j, reason: collision with root package name */
    private final InterfaceC1227k f27471j = L5.l.b(new b());

    /* renamed from: k, reason: collision with root package name */
    private final InterfaceC1227k f27472k = L5.l.b(new j());

    /* renamed from: l, reason: collision with root package name */
    private final InterfaceC1227k f27473l = new ViewModelLazy(kotlin.jvm.internal.U.b(C2470s0.class), new k(this), new o(), new l(null, this));

    /* renamed from: m, reason: collision with root package name */
    private final InterfaceC1227k f27474m = L5.l.b(new i());

    /* renamed from: n, reason: collision with root package name */
    private final InterfaceC1227k f27475n = L5.l.b(new d());
    ...
    static final class b extends AbstractC3160z implements Function0 {
        ...
        public final C2465p0 invoke() {
            C2465p0.a aVar = C2465p0.f27884e;
    ...
    public static final class f implements ViewPager.OnPageChangeListener {
        ...
        final /* synthetic */ OnBackPressedCallback f27481b;

        f(OnBackPressedCallback onBackPressedCallback) {
            this.f27481b = onBackPressedCallback;
        }
        ...
        public void onPageSelected(int i8) {
            ...
            if (PaymentFlowActivity.this.L().b(i8) == EnumC2467q0.f27891b) {
                PaymentFlowActivity.this.P().k(false);
                PaymentFlowActivity.this.L().g(false);
            }
            this.f27481b.setEnabled(PaymentFlowActivity.this.S());
        }
    }
    ...
    public static final class h extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        final /* synthetic */ C1858C f27485c;
        ...
        public final P5.d create(Object obj, P5.d dVar) {
            return new h(this.f27485c, this.f27486d, dVar);
        }
    ...
    static final class i extends AbstractC3160z implements Function0 {
        ...
        public static final class a extends AbstractC3160z implements Function1 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ PaymentFlowActivity f27488a;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(PaymentFlowActivity paymentFlowActivity) {
                super(1);
                this.f27488a = paymentFlowActivity;
            }
    ...
    public static final class k extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f27490a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public k(ComponentActivity componentActivity) {
            super(0);
            this.f27490a = componentActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final ViewModelStore invoke() {
            return this.f27490a.getViewModelStore();
        }
    }
    ...
    public static final class l extends AbstractC3160z implements Function0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0 f27491a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f27492b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public l(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f27491a = function0;
            this.f27492b = componentActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        public final CreationExtras invoke() {
            CreationExtras creationExtras;
            Function0 function0 = this.f27491a;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f27492b.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    public static final class m extends kotlin.coroutines.jvm.internal.l implements X5.n {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ C1858C f27495c;
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final P5.d create(Object obj, P5.d dVar) {
            return new m(null, null, this.f27495c, dVar);
        }
    ...
    static final class n extends AbstractC3160z implements Function0 {
        ...
        public final G2.p invoke() {
            PaymentFlowActivity.this.s().setLayoutResource(AbstractC3051C.f32805r);
    ...
    static final class p extends AbstractC3160z implements Function0 {
        ...
        public final PaymentFlowViewPager invoke() {
            PaymentFlowViewPager shippingFlowViewpager = PaymentFlowActivity.this.O().f3151b;
    ...
    public final C2465p0 I() {
        return (C2465p0) this.f27471j.getValue();
    }

    private final AbstractC3066f J() {
        android.support.v4.media.a.a(this.f27470i.getValue());
        return null;
    }

    private final C2449h0 K() {
        return (C2449h0) this.f27475n.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final C2468r0 L() {
        return (C2468r0) this.f27474m.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final j2.u M() {
        return (j2.u) this.f27472k.getValue();
    }

    private final C1858C N() {
        return ((ShippingInfoWidget) Q().findViewById(AbstractC3049A.f32737O)).getShippingInformation();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final G2.p O() {
        return (G2.p) this.f27468g.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final C2470s0 P() {
        return (C2470s0) this.f27473l.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final PaymentFlowViewPager Q() {
        return (PaymentFlowViewPager) this.f27469h.getValue();
    }
    ...
    public final void T(Throwable th) {
        ...
        if (message != null && message.length() != 0) {
            ...
            String string = getString(AbstractC3053E.f32901x0);
    ...
    private final void X() {
        H(j2.v.c(P().b(), false, false, 0L, 0L, null, ((SelectShippingMethodWidget) Q().findViewById(AbstractC3049A.f32734L)).getSelectedShippingMethod(), null, false, 223, null));
    }
    ...
    public void t() {
        if (EnumC2467q0.f27891b == L().b(Q().getCurrentItem())) {
            V();
        } else {
            X();
        }
