...
public final class w0 implements Parcelable {
    ...
    public final com.stripe.android.model.o f27979a;

    /* renamed from: b, reason: collision with root package name */
    private final boolean f27980b;

    /* renamed from: c, reason: collision with root package name */
    public static final a f27977c = new a(null);

    /* renamed from: d, reason: collision with root package name */
    public static final int f27978d = 8;
    ...
    public boolean equals(Object obj) {
        ...
        w0 w0Var = (w0) obj;
        return AbstractC3159y.d(this.f27979a, w0Var.f27979a) && this.f27980b == w0Var.f27980b;
    }

    public int hashCode() {
        com.stripe.android.model.o oVar = this.f27979a;
        return ((oVar == null ? 0 : oVar.hashCode()) * 31) + androidx.compose.foundation.a.a(this.f27980b);
    }

    public String toString() {
        return "Result(paymentMethod=" + this.f27979a + ", useGooglePay=" + this.f27980b + ")";
    }
