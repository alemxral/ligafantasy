...
public final class Q extends ArrayAdapter {
    ...
    private final Function1 f27556b;

    /* renamed from: c, reason: collision with root package name */
    private final a f27557c;

    /* renamed from: d, reason: collision with root package name */
    private List f27558d;

    /* loaded from: classes4.dex */
    private static final class a extends Filter {

        /* renamed from: a, reason: collision with root package name */
        private List f27559a;

        /* renamed from: b, reason: collision with root package name */
        private final Q f27560b;

        /* renamed from: c, reason: collision with root package name */
        private final WeakReference f27561c;
        ...
        public a(List unfilteredCountries, Q adapter, Activity activity) {
            ...
            this.f27559a = unfilteredCountries;
            this.f27560b = adapter;
        ...
        protected void publishResults(CharSequence charSequence, Filter.FilterResults filterResults) {
            ...
            List list = (List) obj;
            Activity activity = (Activity) this.f27561c.get();
            if (activity != null) {
                List list2 = list;
            ...
            this.f27560b.f27558d = list;
            this.f27560b.notifyDataSetChanged();
        }
    }
    ...
    public Q(Context context, List unfilteredCountries, int i8, Function1 textViewFactory) {
        ...
        this.f27555a = unfilteredCountries;
        this.f27556b = textViewFactory;
        List list = this.f27555a;
        if (context instanceof Activity) {
            activity = (Activity) context;
        } else {
            activity = null;
        }
        this.f27557c = new a(list, this, activity);
    ...
    public C3825a getItem(int i8) {
        return (C3825a) this.f27558d.get(i8);
    }

    @Override // android.widget.ArrayAdapter
    /* renamed from: d, reason: merged with bridge method [inline-methods] */
    public int getPosition(C3825a c3825a) {
        return AbstractC1246t.r0(this.f27558d, c3825a);
    }
    ...
    public View getView(int i8, View view, ViewGroup viewGroup) {
        ...
        if (view instanceof TextView) {
            ...
            textView = (TextView) this.f27556b.invoke(viewGroup);
        }
