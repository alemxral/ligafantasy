...
public final class PostalCodeEditText extends StripeEditText {
    ...
    private final InterfaceC1580e f27547p;

    /* renamed from: r, reason: collision with root package name */
    static final /* synthetic */ e6.i[] f27544r = {kotlin.jvm.internal.U.e(new kotlin.jvm.internal.E(PostalCodeEditText.class, "config", "getConfig$payments_core_release()Lcom/stripe/android/view/PostalCodeEditText$Config;", 0))};

    /* renamed from: q, reason: collision with root package name */
    private static final a f27543q = new a(null);

    /* renamed from: s, reason: collision with root package name */
    public static final int f27545s = 8;

    /* renamed from: t, reason: collision with root package name */
    private static final Pattern f27546t = Pattern.compile("^[0-9]{5}$");
    ...
    public static final class b {
        ...
        public static final b f27548a = new b("Global", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final b f27549b = new b("US", 1);

        /* renamed from: c, reason: collision with root package name */
        private static final /* synthetic */ b[] f27550c;

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ R5.a f27551d;
    ...
    public /* synthetic */ class c {
        ...
        static {
            ...
            try {
                iArr[b.f27548a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[b.f27549b.ordinal()] = 2;
    ...
    public final b getConfig$payments_core_release() {
        return (b) this.f27547p.getValue(this, f27544r[0]);
    }

    public final String getPostalCode$payments_core_release() {
        if (getConfig$payments_core_release() == b.f27549b) {
            String fieldText$payments_core_release = getFieldText$payments_core_release();
            if (!f27546t.matcher(getFieldText$payments_core_release()).matches()) {
                return null;
            }
    ...
    public final boolean p() {
        if ((getConfig$payments_core_release() == b.f27549b && f27546t.matcher(getFieldText$payments_core_release()).matches()) || (getConfig$payments_core_release() == b.f27548a && getFieldText$payments_core_release().length() > 0)) {
            return true;
        }
        return false;
    }
    ...
    public final void setConfig$payments_core_release(b bVar) {
        ...
        this.f27547p.setValue(this, f27544r[0], bVar);
    }
    ...
    public PostalCodeEditText(Context context, AttributeSet attributeSet, int i8) {
        ...
        this.f27547p = new e(b.f27548a, this);
        setErrorMessage(getResources().getString(AbstractC3053E.f32903y0));
        setMaxLines(1);
