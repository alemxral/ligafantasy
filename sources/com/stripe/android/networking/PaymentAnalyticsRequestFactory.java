...
public final class PaymentAnalyticsRequestFactory extends C3875e {
    ...
    /* renamed from: l */
    public static final b f24862l = new b(null);

    /* renamed from: m */
    public static final int f24863m = 8;

    /* renamed from: k */
    private final Set f24864k;
    ...
    public static final class ThreeDS2UiType extends Enum<ThreeDS2UiType> {
        ...
        /* renamed from: d */
        public static final ThreeDS2UiType f24866d = new ThreeDS2UiType("None", 0, null, "none");

        /* renamed from: e */
        public static final ThreeDS2UiType f24867e = new ThreeDS2UiType("Text", 1, "01", MimeTypes.BASE_TYPE_TEXT);

        /* renamed from: f */
        public static final ThreeDS2UiType f24868f = new ThreeDS2UiType("SingleSelect", 2, "02", "single_select");

        /* renamed from: g */
        public static final ThreeDS2UiType f24869g = new ThreeDS2UiType("MultiSelect", 3, "03", "multi_select");

        /* renamed from: h */
        public static final ThreeDS2UiType f24870h = new ThreeDS2UiType("Oob", 4, "04", "oob");

        /* renamed from: i */
        public static final ThreeDS2UiType f24871i = new ThreeDS2UiType("Html", 5, "05", "html");

        /* renamed from: j */
        private static final /* synthetic */ ThreeDS2UiType[] f24872j;

        /* renamed from: k */
        private static final /* synthetic */ R5.a f24873k;
        ...
        public static final class a {
            ...
            public final ThreeDS2UiType a(String str) {
                ...
                while (true) {
                    if (it.hasNext()) {
                        obj = it.next();
                        if (AbstractC3159y.d(((ThreeDS2UiType) obj).f24874a, str)) {
                            break;
                        }
                    } else {
                        obj = null;
        ...
        private static final /* synthetic */ ThreeDS2UiType[] a() {
            return new ThreeDS2UiType[]{f24866d, f24867e, f24868f, f24869g, f24870h, f24871i};
        }
        ...
        public static ThreeDS2UiType[] values() {
            return (ThreeDS2UiType[]) f24872j.clone();
        }
    ...
    public final /* synthetic */ C3872b p(PaymentAnalyticsEvent event, String str) {
        ...
        return v(this, event, null, null, null, ThreeDS2UiType.f24865c.a(str), null, 46, null);
    }

    public final /* synthetic */ C3872b q(Set productUsageTokens) {
        AbstractC3159y.i(productUsageTokens, "productUsageTokens");
        return v(this, PaymentAnalyticsEvent.f24832i, productUsageTokens, null, null, null, null, 60, null);
    }

    public final /* synthetic */ C3872b r(String str, String str2) {
        return v(this, PaymentAnalyticsEvent.f24843r, null, str, null, null, str2, 26, null);
    }
    ...
    public final /* synthetic */ C3872b s(String paymentMethodCode, Set productUsageTokens) {
        ...
        AbstractC3159y.i(productUsageTokens, "productUsageTokens");
        return v(this, PaymentAnalyticsEvent.f24827d, productUsageTokens, paymentMethodCode, null, null, null, 56, null);
    }

    public final /* synthetic */ C3872b t(String str, Set productUsageTokens) {
        AbstractC3159y.i(productUsageTokens, "productUsageTokens");
        return v(this, PaymentAnalyticsEvent.f24828e, productUsageTokens, str, null, null, null, 56, null);
    }
    ...
    public final /* synthetic */ C3872b w(String str, String str2) {
        return v(this, PaymentAnalyticsEvent.f24853w, null, str, null, null, str2, 26, null);
    }
    ...
    public PaymentAnalyticsRequestFactory(PackageManager packageManager, PackageInfo packageInfo, String packageName, I5.a publishableKeyProvider, I5.a networkTypeProvider, Set defaultProductUsageTokens) {
        ...
        this.f24864k = defaultProductUsageTokens;
    }
