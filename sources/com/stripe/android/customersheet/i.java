...
public abstract class i implements Parcelable {
    ...
    public static final b f23746a = new b(null);
    ...
    public static final class a extends i {
        ...
        private final AbstractC3991f f23747b;
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof a) && AbstractC3159y.d(this.f23747b, ((a) obj).f23747b);
        }

        public int hashCode() {
            AbstractC3991f abstractC3991f = this.f23747b;
        ...
        public String toString() {
            return "Canceled(paymentSelection=" + this.f23747b + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeParcelable(this.f23747b, i8);
        }
    }
    ...
    public static final class c extends i {
        ...
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeSerializable(this.f23748b);
        }
    }
    ...
    public static final class d extends i {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final AbstractC3991f f23749b;
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof d) && AbstractC3159y.d(this.f23749b, ((d) obj).f23749b);
        }

        public int hashCode() {
            AbstractC3991f abstractC3991f = this.f23749b;
            if (abstractC3991f == null) {
                return 0;
            }
            return abstractC3991f.hashCode();
        ...
        public String toString() {
            return "Selected(paymentSelection=" + this.f23749b + ")";
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel out, int i8) {
            AbstractC3159y.i(out, "out");
            out.writeParcelable(this.f23749b, i8);
        }
    }
