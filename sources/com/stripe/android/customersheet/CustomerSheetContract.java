...
public final class CustomerSheetContract extends ActivityResultContract<a, i> {
    ...
    public static final class a implements Parcelable {
        ...
        private final B2.a f23532a;

        /* renamed from: b, reason: collision with root package name */
        private final Integer f23533b;

        /* renamed from: c, reason: collision with root package name */
        public static final C0457a f23530c = new C0457a(null);

        /* renamed from: d, reason: collision with root package name */
        public static final int f23531d = 8;
        ...
        public boolean equals(Object obj) {
            ...
            a aVar = (a) obj;
            return AbstractC3159y.d(this.f23532a, aVar.f23532a) && AbstractC3159y.d(this.f23533b, aVar.f23533b);
        }
        ...
        public String toString() {
            return "Args(configuration=" + this.f23532a + ", statusBarColor=" + this.f23533b + ")";
        }
        ...
        public void writeToParcel(Parcel out, int i8) {
            ...
            this.f23532a.writeToParcel(out, i8);
            Integer num = this.f23533b;
            if (num == null) {
                intValue = 0;
            } else {
