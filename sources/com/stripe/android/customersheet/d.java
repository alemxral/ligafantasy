...
public final class d extends ViewModel {
            ...
            if (i8 != 0) {
                if (i8 != 1) {
                    if (i8 == 2) {
                        ...
                        d dVar = d.this;
                        if (bVar instanceof a.b.c) {
                            dVar.y(AbstractC3991f.c.f39757a, "google_pay");
                        }
                        d dVar2 = d.this;
                        a.b.C0461b a8 = com.stripe.android.customersheet.b.a(bVar);
                        if (a8 != null) {
                            ...
                            dVar2.z(AbstractC3991f.c.f39757a, "google_pay", a8.a(), str);
                        }
                        return I.f6474a;
                    }
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            if (i8 != 0) {
                if (i8 != 1) {
                    if (i8 == 2) {
                        ...
                        if (bVar instanceof a.b.c) {
                            if (c0916f != null && (v9 = c0916f.v()) != null && (pVar2 = v9.f24399e) != null) {
                                str = pVar2.f24537a;
                            } else {
                                str = null;
                            }
    ...
    public static final class y extends AbstractC3160z implements Function1 {
        ...
        public final e.d invoke(e.d it) {
            AbstractC3159y.i(it, "it");
            return e.d.k(it, null, this.f23643a, this.f23644b, false, false, false, false, false, null, false, false, null, null, null, this.f23645c, 16377, null);
        }
    }
    ...
    */
        ...
        do {
            ...
            for (Object obj : list) {
                if (obj instanceof e.a) {
                    ...
                    List list2 = m8;
                    if (AbstractC3159y.d(gVar.d(), o.p.f24509O.f24537a) && !(aVar2.l() instanceof d.b)) {
                        a8 = AbstractC3984c.a(b4.n.f14729o);
                    } else {
                        a8 = AbstractC3984c.a(q3.w.f37433a0);
                    }
                    InterfaceC3983b interfaceC3983b2 = a8;
                    AbstractC3991f o8 = aVar2.o();
                    if (o8 != null) {
                        interfaceC3983b = o8.c(this.f23567e.k(), true);
                    } else {
        ...
        do {
            ...
            for (Object obj : list) {
                if (obj instanceof e.a) {
                    ...
                    obj = aVar.j((r39 & 1) != 0 ? aVar.f23660i : null, (r39 & 2) != 0 ? aVar.f23661j : null, (r39 & 4) != 0 ? aVar.f23662k : null, (r39 & 8) != 0 ? aVar.f23663l : null, (r39 & 16) != 0 ? aVar.f23664m : null, (r39 & 32) != 0 ? aVar.f23665n : null, (r39 & 64) != 0 ? aVar.f23666o : null, (r39 & 128) != 0 ? aVar.f23667p : false, (r39 & 256) != 0 ? aVar.f23668q : false, (r39 & 512) != 0 ? aVar.f23669r : false, (r39 & 1024) != 0 ? aVar.f23670s : null, (r39 & 2048) != 0 ? aVar.f23671t : false, (r39 & 4096) != 0 ? aVar.f23672u : a8, (r39 & 8192) != 0 ? aVar.f23673v : false, (r39 & 16384) != 0 ? aVar.f23674w : null, (r39 & 32768) != 0 ? aVar.f23675x : null, (r39 & 65536) != 0 ? aVar.f23676y : false, (r39 & 131072) != 0 ? aVar.f23677z : false, (r39 & 262144) != 0 ? aVar.f23657A : dVar, (r39 & 524288) != 0 ? aVar.f23658B : null, (r39 & 1048576) != 0 ? aVar.f23659C : null);
                }
                arrayList.add(obj);
            }
        } while (!vVar.a(value, arrayList));
        ...
        do {
            ...
            for (Object obj : list) {
                if (obj instanceof e.d) {
                    e.d dVar = (e.d) obj;
                    boolean z9 = !dVar.e();
                    if (!z9 && !AbstractC3159y.d(this.f23563a, dVar.o())) {
                        z8 = true;
                    } else {
                        z8 = false;
                    }
                ...
                while (true) {
                    ...
                    for (Object obj2 : list) {
                        if (obj2 instanceof e.d) {
                            e.d dVar2 = (e.d) obj2;
                            boolean z9 = !AbstractC3159y.d(dVar.f23563a, abstractC3991f3);
    ...
    private final void X(com.stripe.android.model.o oVar) {
        ...
        if (this.f23567e.b() || eVar.d().size() > 1) {
            z8 = true;
        } else {
            z8 = false;
        }
        ...
        if (eVar instanceof e.d) {
            ...
            while (true) {
                ...
                for (Object obj3 : list) {
                    if (obj3 instanceof e.d) {
                        e.d dVar2 = (e.d) obj3;
                        AbstractC3991f abstractC3991f3 = this.f23563a;
                        if ((dVar2.o() instanceof AbstractC3991f.C0916f) && AbstractC3159y.d(((AbstractC3991f.C0916f) dVar2.o()).v().f24395a, oVar.f24395a)) {
                            z8 = true;
                        } else {
                            z8 = false;
                        }
                        if ((dVar2.o() instanceof AbstractC3991f.C0916f) && (abstractC3991f3 instanceof AbstractC3991f.C0916f) && AbstractC3159y.d(((AbstractC3991f.C0916f) dVar2.o()).v().f24395a, ((AbstractC3991f.C0916f) abstractC3991f3).v().f24395a)) {
                            this.f23563a = abstractC3991f2;
                        }
