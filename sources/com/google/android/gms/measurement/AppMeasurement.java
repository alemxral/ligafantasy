...
public class AppMeasurement {
    ...
    private static volatile AppMeasurement f15975b;
        ...
        if (f15975b == null) {
            synchronized (AppMeasurement.class) {
                if (f15975b == null) {
                    ...
                    if (vVar != null) {
                        f15975b = new AppMeasurement(vVar);
                    } else {
                        f15975b = new AppMeasurement(Y1.H(context, new C2077q0(0L, 0L, true, null, null, null, null, null), null));
                    }
                }
            }
        }
    ...
    public void clearConditionalUserProperty(@NonNull @Size(max = 24, min = 1) String str, @NonNull String str2, @NonNull Bundle bundle) {
        this.f15976a.l(str, str2, bundle);
    }
    ...
    public List<ConditionalUserProperty> getConditionalUserProperties(@NonNull String str, @NonNull @Size(max = 23, min = 1) String str2) {
        int size;
        List c8 = this.f15976a.c(str, str2);
        if (c8 == null) {
            size = 0;
        } else {
            size = c8.size();
    ...
    protected Map<String, Object> getUserProperties(@NonNull String str, @NonNull @Size(max = 24, min = 1) String str2, boolean z8) {
        return this.f15976a.d(str, str2, z8);
    }

    @Keep
    public void logEventInternal(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle) {
        this.f15976a.h(str, str2, bundle);
    }
