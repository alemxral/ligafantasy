...
final class C4 implements m0.u {
    ...
    public final InterfaceC2053n0 f16022a;

    /* renamed from: b, reason: collision with root package name */
    final /* synthetic */ AppMeasurementDynamiteService f16023b;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C4(AppMeasurementDynamiteService appMeasurementDynamiteService, InterfaceC2053n0 interfaceC2053n0) {
        this.f16023b = appMeasurementDynamiteService;
        this.f16022a = interfaceC2053n0;
    }

    @Override // m0.u
    public final void a(String str, String str2, Bundle bundle, long j8) {
        try {
            this.f16022a.m(str, str2, bundle, j8);
        } catch (RemoteException e8) {
            Y1 y12 = this.f16023b.f15996a;
            if (y12 != null) {
