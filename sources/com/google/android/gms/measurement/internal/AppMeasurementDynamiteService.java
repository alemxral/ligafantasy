...
public class AppMeasurementDynamiteService extends AbstractBinderC1996g0 {
    ...
    private final Map f15997b = new ArrayMap();
    ...
    private final void l(InterfaceC2029k0 interfaceC2029k0, String str) {
        j();
        this.f15996a.N().K(interfaceC2029k0, str);
    }
    ...
    public void getGmpAppId(InterfaceC2029k0 interfaceC2029k0) throws RemoteException {
        String str;
        j();
        Y2 I8 = this.f15996a.I();
        if (I8.f16764a.O() != null) {
            str = I8.f16764a.O();
        } else {
            try {
                str = m0.w.b(I8.f16764a.c(), "google_app_id", I8.f16764a.R());
            } catch (IllegalStateException e8) {
                I8.f16764a.d().r().b("getGoogleAppId failed with exception", e8);
                str = null;
            }
        }
    ...
    public void getMaxUserProperties(String str, InterfaceC2029k0 interfaceC2029k0) throws RemoteException {
        j();
        this.f15996a.I().Q(str);
        j();
        this.f15996a.N().I(interfaceC2029k0, 25);
    }
    ...
    public void getSessionId(InterfaceC2029k0 interfaceC2029k0) throws RemoteException {
        j();
        Y2 I8 = this.f15996a.I();
        I8.f16764a.f().z(new L2(I8, interfaceC2029k0));
    }
            ...
            if (i8 != 1) {
                if (i8 != 2) {
                    if (i8 != 3) {
                        ...
                        this.f15996a.N().E(interfaceC2029k0, this.f15996a.I().R().booleanValue());
                        return;
                    }
                    this.f15996a.N().I(interfaceC2029k0, this.f15996a.I().T().intValue());
                    return;
                }
                y4 N8 = this.f15996a.N();
                double doubleValue = this.f15996a.I().S().doubleValue();
                ...
                try {
                    ...
                    N8.f16764a.d().w().b("Error returning double value to wrapper", e8);
                    return;
                }
            }
            this.f15996a.N().J(interfaceC2029k0, this.f15996a.I().U().longValue());
            return;
        }
        this.f15996a.N().K(interfaceC2029k0, this.f15996a.I().Y());
    }

    @Override // com.google.android.gms.internal.measurement.InterfaceC2005h0
    public void getUserProperties(String str, String str2, boolean z8, InterfaceC2029k0 interfaceC2029k0) throws RemoteException {
        j();
        this.f15996a.f().z(new L3(this, interfaceC2029k0, str, str2, z8));
    }
    ...
    public void initialize(Z.a aVar, C2077q0 c2077q0, long j8) throws RemoteException {
        Y1 y12 = this.f15996a;
        if (y12 == null) {
            this.f15996a = Y1.H((Context) AbstractC1319p.l((Context) Z.b.l(aVar)), c2077q0, Long.valueOf(j8));
        } else {
    ...
    public void isDataCollectionEnabled(InterfaceC2029k0 interfaceC2029k0) throws RemoteException {
        j();
        this.f15996a.f().z(new A4(this, interfaceC2029k0));
    }
    ...
    public void logEvent(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle, boolean z8, boolean z9, long j8) throws RemoteException {
        j();
        this.f15996a.I().s(str, str2, bundle, z8, z9, j8);
    }
    ...
    public void logEventAndBundle(String str, String str2, Bundle bundle, InterfaceC2029k0 interfaceC2029k0, long j8) throws RemoteException {
        ...
        this.f15996a.f().z(new RunnableC2225l3(this, interfaceC2029k0, new C2270v(str2, new C2260t(bundle), MBridgeConstans.DYNAMIC_VIEW_WX_APP, j8), str));
    }
    ...
    public void onActivitySaveInstanceState(Z.a aVar, InterfaceC2029k0 interfaceC2029k0, long j8) throws RemoteException {
        ...
        try {
            ...
            this.f15996a.d().w().b("Error returning bundle value to wrapper", e8);
        }
    }
    ...
    public void onActivityStarted(@NonNull Z.a aVar, long j8) throws RemoteException {
        j();
        if (this.f15996a.I().f16370c != null) {
            this.f15996a.I().p();
        }
    }
    ...
    public void registerOnMeasurementEventListener(InterfaceC2053n0 interfaceC2053n0) throws RemoteException {
        ...
        synchronized (this.f15997b) {
            try {
                uVar = (m0.u) this.f15997b.get(Integer.valueOf(interfaceC2053n0.d()));
                if (uVar == null) {
                    uVar = new C4(this, interfaceC2053n0);
                    this.f15997b.put(Integer.valueOf(interfaceC2053n0.d()), uVar);
                }
            } catch (Throwable th) {
                throw th;
            }
        }
        this.f15996a.I().x(uVar);
    }
    ...
    public void setConditionalUserProperty(@NonNull Bundle bundle, long j8) throws RemoteException {
        j();
        if (bundle == null) {
            this.f15996a.d().r().a("Conditional user property must not be null");
        } else {
            this.f15996a.I().E(bundle, j8);
        }
    }
    ...
    public void setConsent(@NonNull final Bundle bundle, final long j8) throws RemoteException {
        j();
        final Y2 I8 = this.f15996a.I();
        I8.f16764a.f().A(new Runnable() { // from class: com.google.android.gms.measurement.internal.x2
            @Override // java.lang.Runnable
            public final void run() {
                Y2 y22 = Y2.this;
                Bundle bundle2 = bundle;
                long j9 = j8;
                if (TextUtils.isEmpty(y22.f16764a.B().t())) {
                    y22.G(bundle2, 0, j9);
                } else {
                    y22.f16764a.d().x().a("Using developer consent only; google app id found");
                }
            }
        });
    }
    ...
    public void setDefaultEventParameters(@NonNull Bundle bundle) {
        ...
        I8.f16764a.f().z(new Runnable() { // from class: com.google.android.gms.measurement.internal.y2
            @Override // java.lang.Runnable
            public final void run() {
                Y2.this.q(bundle2);
            }
    ...
    public void setEventInterceptor(InterfaceC2053n0 interfaceC2053n0) throws RemoteException {
        ...
        if (this.f15996a.f().C()) {
            this.f15996a.I().H(b42);
        } else {
            this.f15996a.f().z(new l4(this, b42));
        }
    }
    ...
    public void setMeasurementEnabled(boolean z8, long j8) throws RemoteException {
        j();
        this.f15996a.I().I(Boolean.valueOf(z8));
    }
    ...
    public void setUserId(@NonNull final String str, long j8) throws RemoteException {
        ...
        if (str != null && TextUtils.isEmpty(str)) {
            I8.f16764a.d().w().a("User ID must be non-empty or null");
        } else {
            I8.f16764a.f().z(new Runnable() { // from class: com.google.android.gms.measurement.internal.z2
                @Override // java.lang.Runnable
                public final void run() {
                    Y2 y22 = Y2.this;
                    if (y22.f16764a.B().w(str)) {
                        y22.f16764a.B().v();
                    }
                }
            });
    ...
    public void setUserProperty(@NonNull String str, @NonNull String str2, @NonNull Z.a aVar, boolean z8, long j8) throws RemoteException {
        j();
        this.f15996a.I().L(str, str2, Z.b.l(aVar), z8, j8);
    }
    ...
    public void unregisterOnMeasurementEventListener(InterfaceC2053n0 interfaceC2053n0) throws RemoteException {
        ...
        j();
        synchronized (this.f15997b) {
            uVar = (m0.u) this.f15997b.remove(Integer.valueOf(interfaceC2053n0.d()));
        }
        if (uVar == null) {
            uVar = new C4(this, interfaceC2053n0);
        }
        this.f15996a.I().N(uVar);
    }
}
