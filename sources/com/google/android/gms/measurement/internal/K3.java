...
public final class K3 extends A1 {
    ...
    private final J3 f16188c;

    /* renamed from: d, reason: collision with root package name */
    private InterfaceC3391d f16189d;

    /* renamed from: e, reason: collision with root package name */
    private volatile Boolean f16190e;

    /* renamed from: f, reason: collision with root package name */
    private final AbstractC2236o f16191f;

    /* renamed from: g, reason: collision with root package name */
    private final C2166b4 f16192g;

    /* renamed from: h, reason: collision with root package name */
    private final List f16193h;

    /* renamed from: i, reason: collision with root package name */
    private final AbstractC2236o f16194i;

    /* JADX INFO: Access modifiers changed from: protected */
    public K3(Y1 y12) {
        super(y12);
        this.f16193h = new ArrayList();
        this.f16192g = new C2166b4(y12.a());
        this.f16188c = new J3(this);
        this.f16191f = new C2269u3(this, y12);
        this.f16194i = new C2279w3(this, y12);
    }

    private final D4 C(boolean z8) {
        Pair a8;
        this.f16764a.b();
        C2228m1 B8 = this.f16764a.B();
        String str = null;
        if (z8) {
            C2267u1 d8 = this.f16764a.d();
            if (d8.f16764a.F().f16135d != null && (a8 = d8.f16764a.F().f16135d.a()) != null && a8 != I1.f16133y) {
    ...
    public final void D() {
        h();
        this.f16764a.d().v().b("Processing queued up service tasks", Integer.valueOf(this.f16193h.size()));
        Iterator it = this.f16193h.iterator();
        while (it.hasNext()) {
            try {
                ((Runnable) it.next()).run();
            } catch (RuntimeException e8) {
                this.f16764a.d().r().b("Task exception while flushing queue", e8);
            }
        }
        this.f16193h.clear();
        this.f16194i.b();
    ...
    public final void E() {
        h();
        this.f16192g.b();
        AbstractC2236o abstractC2236o = this.f16191f;
        this.f16764a.z();
        abstractC2236o.d(((Long) AbstractC2217k1.f16554L.a(null)).longValue());
    }
    ...
    private final void F(Runnable runnable) {
        ...
        long size = this.f16193h.size();
        this.f16764a.z();
        if (size >= 1000) {
            this.f16764a.d().r().a("Discarding data. Max runnable queue size reached");
            return;
        }
        this.f16193h.add(runnable);
        this.f16194i.d(ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
        P();
    }
    ...
    public static /* bridge */ /* synthetic */ void M(K3 k32, ComponentName componentName) {
        ...
        if (k32.f16189d != null) {
            k32.f16189d = null;
            k32.f16764a.d().v().b("Disconnected from device MeasurementService", componentName);
            k32.h();
            k32.P();
        }
    }
    ...
    public final boolean A() {
        h();
        i();
        if (!B() || this.f16764a.N().q0() >= ((Integer) AbstractC2217k1.f16588j0.a(null)).intValue()) {
            return true;
        }
        return false;
    }
    ...
    */
    ...
    public final void P() {
        ...
        if (!B()) {
            if (!this.f16764a.z().G()) {
                this.f16764a.b();
                List<ResolveInfo> queryIntentServices = this.f16764a.c().getPackageManager().queryIntentServices(new Intent().setClassName(this.f16764a.c(), "com.google.android.gms.measurement.AppMeasurementService"), 65536);
                if (queryIntentServices != null && !queryIntentServices.isEmpty()) {
                    ...
                    this.f16188c.b(intent);
                    return;
                }
                this.f16764a.d().r().a("Unable to use remote or local measurement implementation. Please register the AppMeasurementService service in the app manifest");
                return;
            }
            return;
        }
    ...
    public final void Q() {
        ...
        this.f16188c.d();
        try {
            V.b.b().c(this.f16764a.c(), this.f16188c);
    ...
    public final void o(C2270v c2270v, String str) {
        ...
        i();
        G();
        F(new RunnableC2294z3(this, true, C(true), this.f16764a.C().v(c2270v), c2270v, str));
    }

    public final void p(InterfaceC2029k0 interfaceC2029k0, C2270v c2270v, String str) {
        h();
        i();
        if (this.f16764a.N().r0(AbstractC1268l.f7658a) != 0) {
            this.f16764a.d().w().a("Not bundling data. Service unavailable or out of date");
            this.f16764a.N().H(interfaceC2029k0, new byte[0]);
        } else {
            ...
            for (int i11 = 0; i11 < size; i11++) {
                ...
                if (aVar2 instanceof C2270v) {
                    try {
                        ...
                        this.f16764a.d().r().b("Failed to send event to the service", e8);
                    }
                } else if (aVar2 instanceof u4) {
                    try {
                        interfaceC3391d.h0((u4) aVar2, d42);
                    } catch (RemoteException e9) {
                        this.f16764a.d().r().b("Failed to send user property to the service", e9);
                    }
                } else if (aVar2 instanceof C2173d) {
                    try {
                        interfaceC3391d.e0((C2173d) aVar2, d42);
                    } catch (RemoteException e10) {
                        this.f16764a.d().r().b("Failed to send conditional user property to the service", e10);
                    }
                } else {
                    this.f16764a.d().r().a("Discarding data. Unrecognized parcel type.");
                }
            }
            i9++;
            i10 = i8;
    ...
    public final void s(C2173d c2173d) {
        ...
        i();
        this.f16764a.b();
        F(new A3(this, true, C(true), this.f16764a.C().u(c2173d), new C2173d(c2173d), c2173d));
    }
    ...
    public final void y(u4 u4Var) {
        ...
        i();
        G();
        F(new RunnableC2235n3(this, C(true), this.f16764a.C().w(u4Var), u4Var));
    }
