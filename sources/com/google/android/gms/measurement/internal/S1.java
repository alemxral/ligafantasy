...
public final class S1 extends AbstractC2190f4 implements InterfaceC2191g {
    ...
    private final Map f16263h;

    /* renamed from: i, reason: collision with root package name */
    private final Map f16264i;

    /* renamed from: j, reason: collision with root package name */
    final LruCache f16265j;

    /* renamed from: k, reason: collision with root package name */
    final InterfaceC2003g7 f16266k;

    /* renamed from: l, reason: collision with root package name */
    private final Map f16267l;

    /* renamed from: m, reason: collision with root package name */
    private final Map f16268m;

    /* renamed from: n, reason: collision with root package name */
    private final Map f16269n;

    /* JADX INFO: Access modifiers changed from: package-private */
    public S1(r4 r4Var) {
        super(r4Var);
        this.f16259d = new ArrayMap();
        this.f16260e = new ArrayMap();
        this.f16261f = new ArrayMap();
        this.f16262g = new ArrayMap();
        this.f16263h = new ArrayMap();
        this.f16267l = new ArrayMap();
        this.f16268m = new ArrayMap();
        this.f16269n = new ArrayMap();
        this.f16264i = new ArrayMap();
        this.f16265j = new P1(this, 20);
        this.f16266k = new Q1(this);
    }
    ...
    private final C2141y1 m(String str, byte[] bArr) {
        ...
        try {
            ...
            this.f16764a.d().w().c("Unable to merge remote config. appId", C2267u1.z(str), e8);
            return C2141y1.H();
        } catch (RuntimeException e9) {
            this.f16764a.d().w().c("Unable to merge remote config. appId", C2267u1.z(str), e9);
            return C2141y1.H();
        }
    }
    ...
    private final void n(String str, C2133x1 c2133x1) {
        ...
        for (int i8 = 0; i8 < c2133x1.o(); i8++) {
            ...
            if (c2117v1.q().isEmpty()) {
                this.f16764a.d().w().a("EventConfig contained null event name");
            } else {
                String q8 = c2117v1.q();
                ...
                if (c2117v1.w()) {
                    if (c2117v1.o() >= 2 && c2117v1.o() <= 65535) {
                        ...
                        this.f16764a.d().w().c("Invalid sampling rate. Event name, sample rate", c2117v1.q(), Integer.valueOf(c2117v1.o()));
                    }
                }
            }
        }
        this.f16260e.put(str, hashSet);
        this.f16261f.put(str, arrayMap);
        this.f16262g.put(str, arrayMap2);
        this.f16264i.put(str, arrayMap3);
    }
    ...
    */
    ...
    private final void p(final String str, C2141y1 c2141y1) {
        if (c2141y1.B() != 0) {
            this.f16764a.d().v().b("EES programs found", Integer.valueOf(c2141y1.B()));
            ...
            try {
                    ...
                    public final Object call() {
                        ...
                        return new B7("internal.appMetadata", new Callable() { // from class: com.google.android.gms.measurement.internal.M1
                            ...
                            public final Object call() {
                                S1 s13 = S1.this;
                                String str3 = str2;
                                C2268u2 R8 = s13.f16469b.V().R(str3);
                ...
                c1978e0.d("internal.logger", new Callable() { // from class: com.google.android.gms.measurement.internal.O1
                    @Override // java.util.concurrent.Callable
                    public final Object call() {
                        return new A7(S1.this.f16266k);
                    }
                });
                c1978e0.c(c2055n2);
                this.f16265j.put(str, c1978e0);
                this.f16764a.d().v().c("EES program loaded for appId, activities", str, Integer.valueOf(c2055n2.B().B()));
                Iterator it = c2055n2.B().E().iterator();
                while (it.hasNext()) {
                    this.f16764a.d().v().b("EES program activity", ((C2039l2) it.next()).C());
                }
                return;
            } catch (C2148z0 unused) {
                this.f16764a.d().r().b("Failed to load EES program. appId", str);
                return;
            }
        }
    ...
    public static /* bridge */ /* synthetic */ C1978e0 s(S1 s12, String str) {
        ...
        if (s12.f16263h.containsKey(str) && s12.f16263h.get(str) != null) {
            s12.p(str, (C2141y1) s12.f16263h.get(str));
        } else {
            s12.o(str);
        }
        return (C1978e0) s12.f16265j.snapshot().get(str);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void A(String str) {
        h();
        this.f16263h.remove(str);
    }
    ...
    public final boolean C(String str) {
        C2141y1 c2141y1;
        if (TextUtils.isEmpty(str) || (c2141y1 = (C2141y1) this.f16263h.get(str)) == null || c2141y1.B() == 0) {
            return false;
        }
        return true;
    }
    ...
    public final boolean E(String str, String str2) {
        ...
        Map map = (Map) this.f16262g.get(str);
    ...
    public final boolean F(String str, String str2) {
        ...
        Map map = (Map) this.f16261f.get(str);
        if (map == null || (bool = (Boolean) map.get(str2)) == null) {
            return false;
        }
        return bool.booleanValue();
    ...
    public final boolean H(String str, byte[] bArr, String str2, String str3) {
        ...
        this.f16263h.put(str, (C2141y1) c2133x1.k());
        this.f16267l.put(str, c2133x1.s());
        this.f16268m.put(str, str2);
        this.f16269n.put(str, str3);
        this.f16259d.put(str, q((C2141y1) c2133x1.k()));
        this.f16469b.V().n(str, new ArrayList(c2133x1.t()));
        try {
            c2133x1.q();
            bArr = ((C2141y1) c2133x1.k()).g();
        } catch (RuntimeException e8) {
            this.f16764a.d().w().c("Unable to serialize reduced-size config. Storing full config instead. appId", C2267u1.z(str), e8);
        }
        C2221l V7 = this.f16469b.V();
        AbstractC1319p.f(str);
        V7.h();
        V7.i();
        ...
        try {
            if (V7.P().update("apps", contentValues, "app_id = ?", new String[]{str}) == 0) {
                V7.f16764a.d().r().b("Failed to update remote config (got 0). appId", C2267u1.z(str));
            }
        } catch (SQLiteException e9) {
            V7.f16764a.d().r().c("Error storing remote config. appId", C2267u1.z(str), e9);
        }
        this.f16263h.put(str, (C2141y1) c2133x1.k());
        return true;
    }
    ...
    public final boolean I(String str) {
        h();
        o(str);
        if (this.f16260e.get(str) != null && ((Set) this.f16260e.get(str)).contains("app_instance_id")) {
            return true;
        }
        return false;
    }
    ...
    public final boolean J(String str) {
        h();
        o(str);
        if (this.f16260e.get(str) == null) {
            return false;
        }
        if (!((Set) this.f16260e.get(str)).contains("device_model") && !((Set) this.f16260e.get(str)).contains("device_info")) {
            return false;
        }
        return true;
    }
    ...
    public final boolean K(String str) {
        h();
        o(str);
        if (this.f16260e.get(str) != null && ((Set) this.f16260e.get(str)).contains("enhanced_user_id")) {
            return true;
        }
        return false;
    }
    ...
    public final boolean L(String str) {
        h();
        o(str);
        if (this.f16260e.get(str) != null && ((Set) this.f16260e.get(str)).contains("google_signals")) {
            return true;
        }
        return false;
    }
    ...
    public final boolean M(String str) {
        ...
        if (!((Set) this.f16260e.get(str)).contains("os_version") && !((Set) this.f16260e.get(str)).contains("device_info")) {
            return false;
        }
        return true;
    }
    ...
    public final boolean N(String str) {
        h();
        o(str);
        if (this.f16260e.get(str) != null && ((Set) this.f16260e.get(str)).contains("user_id")) {
            return true;
        }
        return false;
    }
    ...
    public final String e(String str, String str2) {
        h();
        o(str);
        Map map = (Map) this.f16259d.get(str);
        if (map != null) {
    ...
    public final int r(String str, String str2) {
        ...
        h();
        o(str);
        Map map = (Map) this.f16264i.get(str);
    ...
    public final C2141y1 t(String str) {
        ...
        AbstractC1319p.f(str);
        o(str);
        return (C2141y1) this.f16263h.get(str);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final String u(String str) {
        h();
        return (String) this.f16269n.get(str);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final String v(String str) {
        h();
        return (String) this.f16268m.get(str);
    }
    ...
    public final String w(String str) {
        h();
        o(str);
        return (String) this.f16267l.get(str);
    }
    ...
    public final Set y(String str) {
        h();
        o(str);
        return (Set) this.f16260e.get(str);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final void z(String str) {
        h();
        this.f16268m.put(str, null);
    }
}
