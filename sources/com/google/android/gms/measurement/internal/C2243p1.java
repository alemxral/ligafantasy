...
public final class C2243p1 {
    ...
    protected static final AtomicReference f16714b = new AtomicReference();

    /* renamed from: c, reason: collision with root package name */
    protected static final AtomicReference f16715c = new AtomicReference();

    /* renamed from: d, reason: collision with root package name */
    protected static final AtomicReference f16716d = new AtomicReference();

    /* renamed from: a, reason: collision with root package name */
    private final InterfaceC3392e f16717a;

    public C2243p1(InterfaceC3392e interfaceC3392e) {
        this.f16717a = interfaceC3392e;
    }
    ...
    public final String c(C2270v c2270v) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("origin=");
        sb.append(c2270v.f16873c);
        sb.append(",name=");
        sb.append(d(c2270v.f16871a));
        sb.append(",params=");
        C2260t c2260t = c2270v.f16872b;
        if (c2260t == null) {
            b8 = null;
        } else if (!this.f16717a.a()) {
            b8 = c2260t.toString();
        } else {
            b8 = b(c2260t.z());
        }
    ...
    public final String d(String str) {
        ...
        return g(str, m0.q.f34871c, m0.q.f34869a, f16714b);
    }
    ...
    public final String e(String str) {
        ...
        return g(str, m0.r.f34874b, m0.r.f34873a, f16715c);
    }
    ...
    public final String f(String str) {
        ...
        return g(str, m0.s.f34878b, m0.s.f34877a, f16716d);
    }
}
