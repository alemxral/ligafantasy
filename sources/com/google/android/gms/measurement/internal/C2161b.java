...
public final class C2161b extends AbstractC2190f4 {
    ...
    private final G4 n(Integer num) {
        if (this.f16416f.containsKey(num)) {
            return (G4) this.f16416f.get(num);
        }
        G4 g42 = new G4(this, this.f16414d, null);
        this.f16416f.put(num, g42);
        return g42;
    }

    private final boolean o(int i8, int i9) {
        G4 g42 = (G4) this.f16416f.get(Integer.valueOf(i8));
        if (g42 == null) {
            return false;
        }
