...
final class B4 implements m0.t {
    ...
    public final InterfaceC2053n0 f16008a;

    /* renamed from: b, reason: collision with root package name */
    final /* synthetic */ AppMeasurementDynamiteService f16009b;

    /* JADX INFO: Access modifiers changed from: package-private */
    public B4(AppMeasurementDynamiteService appMeasurementDynamiteService, InterfaceC2053n0 interfaceC2053n0) {
        this.f16009b = appMeasurementDynamiteService;
        this.f16008a = interfaceC2053n0;
    }

    @Override // m0.t
    public final void a(String str, String str2, Bundle bundle, long j8) {
        try {
            this.f16008a.m(str, str2, bundle, j8);
        } catch (RemoteException e8) {
            Y1 y12 = this.f16009b.f15996a;
            if (y12 != null) {
