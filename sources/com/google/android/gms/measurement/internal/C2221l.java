...
public final class C2221l extends AbstractC2190f4 {
    ...
    private static final String[] f16635f = {"last_bundled_timestamp", "ALTER TABLE events ADD COLUMN last_bundled_timestamp INTEGER;", "last_bundled_day", "ALTER TABLE events ADD COLUMN last_bundled_day INTEGER;", "last_sampled_complex_event_id", "ALTER TABLE events ADD COLUMN last_sampled_complex_event_id INTEGER;", "last_sampling_rate", "ALTER TABLE events ADD COLUMN last_sampling_rate INTEGER;", "last_exempt_from_sampling", "ALTER TABLE events ADD COLUMN last_exempt_from_sampling INTEGER;", "current_session_count", "ALTER TABLE events ADD COLUMN current_session_count INTEGER;"};

    /* renamed from: g, reason: collision with root package name */
    private static final String[] f16636g = {TtmlNode.ATTR_TTS_ORIGIN, "ALTER TABLE user_attributes ADD COLUMN origin TEXT;"};

    /* renamed from: h, reason: collision with root package name */
    private static final String[] f16637h = {"app_version", "ALTER TABLE apps ADD COLUMN app_version TEXT;", "app_store", "ALTER TABLE apps ADD COLUMN app_store TEXT;", "gmp_version", "ALTER TABLE apps ADD COLUMN gmp_version INTEGER;", "dev_cert_hash", "ALTER TABLE apps ADD COLUMN dev_cert_hash INTEGER;", "measurement_enabled", "ALTER TABLE apps ADD COLUMN measurement_enabled INTEGER;", "last_bundle_start_timestamp", "ALTER TABLE apps ADD COLUMN last_bundle_start_timestamp INTEGER;", "day", "ALTER TABLE apps ADD COLUMN day INTEGER;", "daily_public_events_count", "ALTER TABLE apps ADD COLUMN daily_public_events_count INTEGER;", "daily_events_count", "ALTER TABLE apps ADD COLUMN daily_events_count INTEGER;", "daily_conversions_count", "ALTER TABLE apps ADD COLUMN daily_conversions_count INTEGER;", "remote_config", "ALTER TABLE apps ADD COLUMN remote_config BLOB;", "config_fetched_time", "ALTER TABLE apps ADD COLUMN config_fetched_time INTEGER;", "failed_config_fetch_time", "ALTER TABLE apps ADD COLUMN failed_config_fetch_time INTEGER;", "app_version_int", "ALTER TABLE apps ADD COLUMN app_version_int INTEGER;", "firebase_instance_id", "ALTER TABLE apps ADD COLUMN firebase_instance_id TEXT;", "daily_error_events_count", "ALTER TABLE apps ADD COLUMN daily_error_events_count INTEGER;", "daily_realtime_events_count", "ALTER TABLE apps ADD COLUMN daily_realtime_events_count INTEGER;", "health_monitor_sample", "ALTER TABLE apps ADD COLUMN health_monitor_sample TEXT;", "android_id", "ALTER TABLE apps ADD COLUMN android_id INTEGER;", "adid_reporting_enabled", "ALTER TABLE apps ADD COLUMN adid_reporting_enabled INTEGER;", "ssaid_reporting_enabled", "ALTER TABLE apps ADD COLUMN ssaid_reporting_enabled INTEGER;", "admob_app_id", "ALTER TABLE apps ADD COLUMN admob_app_id TEXT;", "linked_admob_app_id", "ALTER TABLE apps ADD COLUMN linked_admob_app_id TEXT;", "dynamite_version", "ALTER TABLE apps ADD COLUMN dynamite_version INTEGER;", "safelisted_events", "ALTER TABLE apps ADD COLUMN safelisted_events TEXT;", "ga_app_id", "ALTER TABLE apps ADD COLUMN ga_app_id TEXT;", "config_last_modified_time", "ALTER TABLE apps ADD COLUMN config_last_modified_time TEXT;", "e_tag", "ALTER TABLE apps ADD COLUMN e_tag TEXT;", "session_stitching_token", "ALTER TABLE apps ADD COLUMN session_stitching_token TEXT;", "sgtm_upload_enabled", "ALTER TABLE apps ADD COLUMN sgtm_upload_enabled INTEGER;", "target_os_version", "ALTER TABLE apps ADD COLUMN target_os_version INTEGER;", "session_stitching_token_hash", "ALTER TABLE apps ADD COLUMN session_stitching_token_hash INTEGER;"};

    /* renamed from: i, reason: collision with root package name */
    private static final String[] f16638i = {"realtime", "ALTER TABLE raw_events ADD COLUMN realtime INTEGER;"};

    /* renamed from: j, reason: collision with root package name */
    private static final String[] f16639j = {"has_realtime", "ALTER TABLE queue ADD COLUMN has_realtime INTEGER;", "retry_count", "ALTER TABLE queue ADD COLUMN retry_count INTEGER;"};

    /* renamed from: k, reason: collision with root package name */
    private static final String[] f16640k = {"session_scoped", "ALTER TABLE event_filters ADD COLUMN session_scoped BOOLEAN;"};

    /* renamed from: l, reason: collision with root package name */
    private static final String[] f16641l = {"session_scoped", "ALTER TABLE property_filters ADD COLUMN session_scoped BOOLEAN;"};

    /* renamed from: m, reason: collision with root package name */
    private static final String[] f16642m = {"previous_install_count", "ALTER TABLE app2 ADD COLUMN previous_install_count INTEGER;"};

    /* renamed from: d, reason: collision with root package name */
    private final C2215k f16643d;

    /* renamed from: e, reason: collision with root package name */
    private final C2166b4 f16644e;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C2221l(r4 r4Var) {
        super(r4Var);
        this.f16644e = new C2166b4(this.f16764a.a());
        this.f16764a.z();
        this.f16643d = new C2215k(this, this.f16764a.c(), "google_app_measurement.db");
    }
    ...
    private final long I(String str, String[] strArr) {
        ...
        try {
            try {
                ...
                this.f16764a.d().r().c("Database error", str, e8);
                throw e8;
            }
        } catch (Throwable th) {
            if (0 != 0) {
            ...
            try {
                ...
                try {
                    if (r42 != 0) {
                        ...
                        rawQuery = P8.rawQuery("select app_id, metadata_fingerprint from raw_events where " + str4 + "app_id in (select app_id from apps where config_fetched_time >= ?) order by rowid limit 1;", strArr3);
                        if (!rawQuery.moveToFirst()) {
                            rawQuery.close();
                            return;
                        } else {
                        ...
                        rawQuery = P8.rawQuery("select metadata_fingerprint from raw_events where app_id = ?" + str4 + " order by rowid limit 1;", strArr);
                        if (!rawQuery.moveToFirst()) {
                            rawQuery.close();
                            return;
                        } else {
                    ...
                    String str5 = string;
                    try {
                        Cursor query = P8.query("raw_events_metadata", new String[]{TtmlNode.TAG_METADATA}, "app_id = ? and metadata_fingerprint = ?", new String[]{str3, str5}, null, null, "rowid", "2");
                        try {
                            if (!query.moveToFirst()) {
                                this.f16764a.d().r().b("Raw event metadata record is missing. appId", C2267u1.z(str3));
                                query.close();
                                return;
                            }
                            try {
                                ...
                                if (query.moveToNext()) {
                                    this.f16764a.d().w().b("Get multiple raw event metadata records, expected one. appId", C2267u1.z(str3));
                                }
                                query.close();
                                ...
                                if (j9 != -1) {
                                    ...
                                    strArr2 = new String[]{str3, str5, String.valueOf(j9)};
                                } else {
                                    str2 = "app_id = ? and metadata_fingerprint = ?";
                                    strArr2 = new String[]{str3, str5};
                                }
                                Cursor query2 = P8.query("raw_events", new String[]{"rowid", "name", CampaignEx.JSON_KEY_TIMESTAMP, DataSchemeDataSource.SCHEME_DATA}, str2, strArr2, null, null, "rowid", null);
                                if (!query2.moveToFirst()) {
                                    this.f16764a.d().w().b("Raw event data disappeared while in transaction. appId", C2267u1.z(str3));
                                    query2.close();
                                    return;
                                }
                                do {
                                    ...
                                    try {
                                        ...
                                        this.f16764a.d().r().c("Data loss. Failed to merge raw event. appId", C2267u1.z(str3), e8);
                                    }
                                } while (query2.moveToNext());
                                query2.close();
                            } catch (IOException e9) {
                                this.f16764a.d().r().c("Data loss. Failed to merge raw event metadata. appId", C2267u1.z(str3), e9);
                                query.close();
                            }
                        } catch (SQLiteException e10) {
                            e = e10;
                            r42 = query;
                            this.f16764a.d().r().c("Data loss. Error selecting raw event. appId", C2267u1.z(str3), e);
                            if (r42 != 0) {
                                r42.close();
                            }
                        } catch (Throwable th) {
    ...
    public final int J(String str, String str2) {
        ...
        try {
            ...
            this.f16764a.d().r().d("Error deleting conditional property", C2267u1.z(str), this.f16764a.D().f(str2), e8);
            return 0;
        }
    }
    ...
    public final long L(String str, String str2) {
        ...
        try {
            try {
                long K8 = K("select first_open_count from app2 where app_id=?", new String[]{str}, -1L);
                if (K8 == -1) {
                    ...
                    if (P8.insertWithOnConflict("app2", null, contentValues, 5) == -1) {
                        this.f16764a.d().r().c("Failed to insert column (got -1). appId", C2267u1.z(str), "first_open_count");
                        return -1L;
                    }
                    K8 = 0;
                }
                try {
                    ...
                    if (P8.update("app2", contentValues2, "app_id = ?", new String[]{str}) == 0) {
                        this.f16764a.d().r().c("Failed to update column (got 0). appId", C2267u1.z(str), "first_open_count");
                        return -1L;
                    }
                    ...
                    e = e8;
                    j8 = K8;
                    this.f16764a.d().r().d("Error inserting column. appId", C2267u1.z(str), "first_open_count", e);
                    P8.endTransaction();
                    return j8;
                }
            } finally {
    ...
    public final SQLiteDatabase P() {
        h();
        try {
            return this.f16643d.getWritableDatabase();
        } catch (SQLiteException e8) {
            this.f16764a.d().w().b("Error opening database", e8);
            throw e8;
        }
    }
    ...
    */
    public final android.os.Bundle Q(java.lang.String r8) {
        /*
            ...
            if (r2 != 0) goto L34
            com.google.android.gms.measurement.internal.Y1 r8 = r7.f16764a     // Catch: java.lang.Throwable -> L2e android.database.sqlite.SQLiteException -> L31
        ...
        L34:
            ...
            com.google.android.gms.measurement.internal.r4 r8 = r7.f16469b     // Catch: java.lang.Throwable -> L2e android.database.sqlite.SQLiteException -> L31
        ...
        La7:
            r2 = move-exception
            com.google.android.gms.measurement.internal.Y1 r3 = r7.f16764a     // Catch: java.lang.Throwable -> L2e android.database.sqlite.SQLiteException -> L31
        ...
        Lc3:
            ...
            r1 = r0
        Lc5:
            com.google.android.gms.measurement.internal.Y1 r2 = r7.f16764a     // Catch: java.lang.Throwable -> L2e
    ...
    public final C2209j U(long j8, String str, long j9, boolean z8, boolean z9, boolean z10, boolean z11, boolean z12) {
        ...
        try {
            try {
                ...
                if (!query.moveToFirst()) {
                    this.f16764a.d().w().b("Not updating daily counts, app is not known. appId", C2267u1.z(str));
                    query.close();
                    return c2209j;
                }
                if (query.getLong(0) == j8) {
                    c2209j.f16511b = query.getLong(1);
                    c2209j.f16510a = query.getLong(2);
                    c2209j.f16512c = query.getLong(3);
                    c2209j.f16513d = query.getLong(4);
                    c2209j.f16514e = query.getLong(5);
                }
                if (z8) {
                    c2209j.f16511b += j9;
                }
                ...
                contentValues.put("daily_public_events_count", Long.valueOf(c2209j.f16510a));
                contentValues.put("daily_events_count", Long.valueOf(c2209j.f16511b));
                contentValues.put("daily_conversions_count", Long.valueOf(c2209j.f16512c));
                contentValues.put("daily_error_events_count", Long.valueOf(c2209j.f16513d));
                contentValues.put("daily_realtime_events_count", Long.valueOf(c2209j.f16514e));
                P8.update("apps", contentValues, "app_id=?", strArr);
                query.close();
                return c2209j;
            } catch (SQLiteException e8) {
                this.f16764a.d().r().c("Error updating daily counts. appId", C2267u1.z(str), e8);
                if (0 != 0) {
                    cursor.close();
                }
                return c2209j;
    ...
    */
    public final com.google.android.gms.measurement.internal.w4 X(java.lang.String r11, java.lang.String r12) {
        ...
        L44:
            ...
            if (r3 == 0) goto L6f
            com.google.android.gms.measurement.internal.Y1 r3 = r10.f16764a     // Catch: java.lang.Throwable -> L6b android.database.sqlite.SQLiteException -> L6d
        ...
        L77:
            ...
            r1 = r0
        L7a:
            com.google.android.gms.measurement.internal.Y1 r3 = r10.f16764a     // Catch: java.lang.Throwable -> L6b
            ...
            com.google.android.gms.measurement.internal.Y1 r5 = r10.f16764a     // Catch: java.lang.Throwable -> L6b
    ...
    final Object Y(Cursor cursor, int i8) {
        ...
        if (type != 0) {
            if (type != 1) {
                if (type != 2) {
                    if (type != 3) {
                        if (type != 4) {
                            this.f16764a.d().r().b("Loaded invalid unknown value type, ignoring it", Integer.valueOf(type));
                            return null;
                        }
                        this.f16764a.d().r().a("Loaded invalid blob type value, ignoring it");
                        return null;
                    }
        ...
        this.f16764a.d().r().a("Loaded invalid null value from database");
        return null;
    }
    ...
    */
    public final java.lang.String Z() {
        ...
        L28:
            ...
            r0 = r1
        L2b:
            com.google.android.gms.measurement.internal.Y1 r3 = r6.f16764a     // Catch: java.lang.Throwable -> L1a
        ...
        try {
            try {
                ...
                do {
                    ...
                    if (Y7 == null) {
                        this.f16764a.d().r().b("Read invalid user property value, ignoring it. appId", C2267u1.z(str));
                    } else {
                ...
                this.f16764a.d().r().c("Error querying user properties. appId", C2267u1.z(str), e8);
    ...
    */
    ...
    public final void g0(List list) {
        ...
        if (I("SELECT COUNT(1) FROM queue WHERE rowid IN " + str + " AND retry_count =  2147483647 LIMIT 1", null) > 0) {
            this.f16764a.d().w().a("The number of upload retries exceeds the limit. Will remain unchanged.");
        }
        try {
            ...
            this.f16764a.d().r().b("Error incrementing retry count. error", e8);
        }
    }
    ...
    public final void h0() {
        ...
        i();
        if (u()) {
            long a8 = this.f16469b.e0().f16222e.a();
            long elapsedRealtime = this.f16764a.a().elapsedRealtime();
            long abs = Math.abs(elapsedRealtime - a8);
            this.f16764a.z();
            if (abs > ((Long) AbstractC2217k1.f16532A.a(null)).longValue()) {
                this.f16469b.e0().f16222e.b(elapsedRealtime);
                h();
                i();
                if (u()) {
                    SQLiteDatabase P8 = P();
                    String valueOf = String.valueOf(this.f16764a.a().currentTimeMillis());
                    this.f16764a.z();
                    int delete = P8.delete("queue", "abs(bundle_end_timestamp - ?) > cast(? as integer)", new String[]{valueOf, String.valueOf(C2197h.i())});
                    if (delete > 0) {
                        this.f16764a.d().v().b("Deleted stale rows. rowsDeleted", Integer.valueOf(delete));
                    }
                }
            }
        }
    ...
    public final void m(String str, String str2) {
        ...
        try {
            ...
            this.f16764a.d().r().d("Error deleting user property. appId", C2267u1.z(str), this.f16764a.D().f(str2), e8);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:126:0x034d, code lost:
        ...
        r23.f16764a.d().r().b("Failed to insert property filter (got -1). appId", com.google.android.gms.measurement.internal.C2267u1.z(r24));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:129:0x0367, code lost:
        ...
        r23.f16764a.d().r().c("Error storing property filter. appId", com.google.android.gms.measurement.internal.C2267u1.z(r24), r0);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:70:0x0195, code lost:
        ...
        r23.f16764a.d().w().c("Property filter with no ID. Audience definition ignored. appId, audienceId", com.google.android.gms.measurement.internal.C2267u1.z(r24), java.lang.Integer.valueOf(r9));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:90:0x026b, code lost:
        ...
        r23.f16764a.d().r().b("Failed to insert event filter (got -1). appId", com.google.android.gms.measurement.internal.C2267u1.z(r24));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:96:0x0285, code lost:
        ...
        r23.f16764a.d().r().c("Error storing event filter. appId", com.google.android.gms.measurement.internal.C2267u1.z(r24), r0);
     */
    ...
    */
    ...
    public final void p(C2268u2 c2268u2) {
        ...
        if (e8 != null) {
            if (e8.isEmpty()) {
                this.f16764a.d().w().b("Safelisted events should not be an empty list. appId", l02);
            } else {
                contentValues.put("safelisted_events", TextUtils.join(",", e8));
            }
        }
        T5.c();
        if (this.f16764a.z().B(null, AbstractC2217k1.f16594m0) && !contentValues.containsKey("safelisted_events")) {
            contentValues.put("safelisted_events", (String) null);
        }
        try {
            SQLiteDatabase P8 = P();
            if (P8.update("apps", contentValues, "app_id = ?", new String[]{l02}) == 0 && P8.insertWithOnConflict("apps", null, contentValues, 5) == -1) {
                this.f16764a.d().r().b("Failed to insert/update app (got -1). appId", C2267u1.z(l02));
            }
        } catch (SQLiteException e9) {
            this.f16764a.d().r().c("Error storing app. appId", C2267u1.z(l02), e9);
        }
    }
    ...
    public final void q(r rVar) {
        ...
        i();
        ContentValues contentValues = new ContentValues();
        contentValues.put(MBridgeConstans.APP_ID, rVar.f16746a);
        contentValues.put("name", rVar.f16747b);
        contentValues.put("lifetime_count", Long.valueOf(rVar.f16748c));
        contentValues.put("current_bundle_count", Long.valueOf(rVar.f16749d));
        contentValues.put("last_fire_timestamp", Long.valueOf(rVar.f16751f));
        contentValues.put("last_bundled_timestamp", Long.valueOf(rVar.f16752g));
        contentValues.put("last_bundled_day", rVar.f16753h);
        contentValues.put("last_sampled_complex_event_id", rVar.f16754i);
        contentValues.put("last_sampling_rate", rVar.f16755j);
        contentValues.put("current_session_count", Long.valueOf(rVar.f16750e));
        Boolean bool = rVar.f16756k;
        ...
        try {
            if (P().insertWithOnConflict("events", null, contentValues, 5) == -1) {
                this.f16764a.d().r().b("Failed to insert/update event aggregates (got -1). appId", C2267u1.z(rVar.f16746a));
            }
        } catch (SQLiteException e8) {
            this.f16764a.d().r().c("Error storing event aggregates. appId", C2267u1.z(rVar.f16746a), e8);
        }
    }
    ...
    public final boolean v(String str, Long l8, long j8, com.google.android.gms.internal.measurement.M1 m12) {
        ...
        AbstractC1319p.l(l8);
        byte[] g8 = m12.g();
        this.f16764a.d().v().c("Saving complex main event, appId, data size", this.f16764a.D().d(str), Integer.valueOf(g8.length));
        ContentValues contentValues = new ContentValues();
        contentValues.put(MBridgeConstans.APP_ID, str);
        ...
        try {
            if (P().insertWithOnConflict("main_event_params", null, contentValues, 5) == -1) {
                this.f16764a.d().r().b("Failed to insert complex main event (got -1). appId", C2267u1.z(str));
                return false;
            }
            return true;
        } catch (SQLiteException e8) {
            this.f16764a.d().r().c("Error storing complex main event. appId", C2267u1.z(str), e8);
            return false;
        }
    }
    ...
    public final boolean w(C2173d c2173d) {
        ...
        h();
        i();
        String str = c2173d.f16433a;
        AbstractC1319p.l(str);
        if (X(str, c2173d.f16435c.f16865b) == null) {
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put(MBridgeConstans.APP_ID, str);
        contentValues.put(TtmlNode.ATTR_TTS_ORIGIN, c2173d.f16434b);
        contentValues.put("name", c2173d.f16435c.f16865b);
        H(contentValues, "value", AbstractC1319p.l(c2173d.f16435c.s()));
        contentValues.put("active", Boolean.valueOf(c2173d.f16437e));
        contentValues.put("trigger_event_name", c2173d.f16438f);
        contentValues.put("trigger_timeout", Long.valueOf(c2173d.f16440h));
        contentValues.put("timed_out_event", this.f16764a.N().e0(c2173d.f16439g));
        contentValues.put("creation_timestamp", Long.valueOf(c2173d.f16436d));
        contentValues.put("triggered_event", this.f16764a.N().e0(c2173d.f16441i));
        contentValues.put("triggered_timestamp", Long.valueOf(c2173d.f16435c.f16866c));
        contentValues.put("time_to_live", Long.valueOf(c2173d.f16442j));
        contentValues.put("expired_event", this.f16764a.N().e0(c2173d.f16443k));
        try {
            if (P().insertWithOnConflict("conditional_properties", null, contentValues, 5) == -1) {
                this.f16764a.d().r().b("Failed to insert/update conditional user property (got -1)", C2267u1.z(str));
                return true;
            }
            return true;
        } catch (SQLiteException e8) {
            this.f16764a.d().r().c("Error storing conditional user property", C2267u1.z(str), e8);
            return true;
        }
    }
    ...
    public final boolean x(w4 w4Var) {
        ...
        h();
        i();
        if (X(w4Var.f16897a, w4Var.f16899c) == null) {
            if (y4.Z(w4Var.f16899c)) {
                if (I("select count(1) from user_attributes where app_id=? and name not like '!_%' escape '!'", new String[]{w4Var.f16897a}) >= this.f16764a.z().p(w4Var.f16897a, AbstractC2217k1.f16548I, 25, 100)) {
                    return false;
                }
            } else if (!"_npa".equals(w4Var.f16899c)) {
                long I8 = I("select count(1) from user_attributes where app_id=? and origin=? AND name like '!_%' escape '!'", new String[]{w4Var.f16897a, w4Var.f16898b});
                this.f16764a.z();
                if (I8 >= 25) {
                    return false;
                }
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put(MBridgeConstans.APP_ID, w4Var.f16897a);
        contentValues.put(TtmlNode.ATTR_TTS_ORIGIN, w4Var.f16898b);
        contentValues.put("name", w4Var.f16899c);
        contentValues.put("set_timestamp", Long.valueOf(w4Var.f16900d));
        H(contentValues, "value", w4Var.f16901e);
        try {
            if (P().insertWithOnConflict("user_attributes", null, contentValues, 5) == -1) {
                this.f16764a.d().r().b("Failed to insert/update user property (got -1). appId", C2267u1.z(w4Var.f16897a));
                return true;
            }
            return true;
        } catch (SQLiteException e8) {
            this.f16764a.d().r().c("Error storing user property. appId", C2267u1.z(w4Var.f16897a), e8);
            return true;
        }
    }
}
