...
public final class y4 extends AbstractC2258s2 {
    ...
    private static final String[] f16927g = {"firebase_", "google_", "ga_"};

    /* renamed from: h, reason: collision with root package name */
    private static final String[] f16928h = {"_err"};

    /* renamed from: c, reason: collision with root package name */
    private SecureRandom f16929c;

    /* renamed from: d, reason: collision with root package name */
    private final AtomicLong f16930d;
    ...
    public y4(Y1 y12) {
        super(y12);
        this.f16932f = null;
        this.f16930d = new AtomicLong(0L);
    }
    ...
    public static ArrayList v(List list) {
        ...
        while (it.hasNext()) {
            ...
            bundle.putString(MBridgeConstans.APP_ID, c2173d.f16433a);
            bundle.putString(TtmlNode.ATTR_TTS_ORIGIN, c2173d.f16434b);
            bundle.putLong("creation_timestamp", c2173d.f16436d);
            bundle.putString("name", c2173d.f16435c.f16865b);
            m0.n.b(bundle, AbstractC1319p.l(c2173d.f16435c.s()));
            bundle.putBoolean("active", c2173d.f16437e);
            String str = c2173d.f16438f;
            if (str != null) {
                bundle.putString("trigger_event_name", str);
            }
            C2270v c2270v = c2173d.f16439g;
            if (c2270v != null) {
                bundle.putString("timed_out_event_name", c2270v.f16871a);
                C2260t c2260t = c2270v.f16872b;
                if (c2260t != null) {
                    bundle.putBundle("timed_out_event_params", c2260t.z());
                }
            }
            bundle.putLong("trigger_timeout", c2173d.f16440h);
            C2270v c2270v2 = c2173d.f16441i;
            if (c2270v2 != null) {
                bundle.putString("triggered_event_name", c2270v2.f16871a);
                C2260t c2260t2 = c2270v2.f16872b;
                if (c2260t2 != null) {
                    bundle.putBundle("triggered_event_params", c2260t2.z());
                }
            }
            bundle.putLong("triggered_timestamp", c2173d.f16435c.f16866c);
            bundle.putLong("time_to_live", c2173d.f16442j);
            C2270v c2270v3 = c2173d.f16443k;
            if (c2270v3 != null) {
                bundle.putString("expired_event_name", c2270v3.f16871a);
                C2260t c2260t3 = c2270v3.f16872b;
                if (c2260t3 != null) {
    ...
    public static void y(C2177d3 c2177d3, Bundle bundle, boolean z8) {
        if (bundle != null && c2177d3 != null) {
            if (bundle.containsKey("_sc") && !z8) {
                ...
                String str = c2177d3.f16450a;
                if (str != null) {
                    bundle.putString("_sn", str);
                } else {
                    bundle.remove("_sn");
                }
                String str2 = c2177d3.f16451b;
                if (str2 != null) {
                    bundle.putString("_sc", str2);
                } else {
                    bundle.remove("_sc");
                }
                bundle.putLong("_si", c2177d3.f16452c);
                return;
            }
        }
    ...
    public final void A(Parcelable[] parcelableArr, int i8, boolean z8) {
        ...
        for (Parcelable parcelable : parcelableArr) {
            ...
            for (String str : new TreeSet(bundle.keySet())) {
                if (Z(str) && !j0(str, m0.r.f34876d) && (i9 = i9 + 1) > i8) {
                    if (z8) {
                        this.f16764a.d().s().c("Param can't contain more than " + i8 + " item-scoped custom parameters", this.f16764a.D().e(str), this.f16764a.D().b(bundle));
                        f0(bundle, 28);
                    } else {
                        this.f16764a.d().s().c("Param cannot contain item-scoped custom parameters", this.f16764a.D().e(str), this.f16764a.D().b(bundle));
                        f0(bundle, 23);
                    }
                    bundle.remove(str);
                }
    ...
    public final void B(C2272v1 c2272v1, int i8) {
        int i9 = 0;
        for (String str : new TreeSet(c2272v1.f16879d.keySet())) {
            if (Z(str) && (i9 = i9 + 1) > i8) {
                this.f16764a.d().s().c("Event can't contain more than " + i8 + " params", this.f16764a.D().d(c2272v1.f16876a), this.f16764a.D().b(c2272v1.f16879d));
                f0(c2272v1.f16879d, 5);
                c2272v1.f16879d.remove(str);
            }
        }
    }
    ...
    public final void D(Bundle bundle, String str, Object obj) {
        ...
        if (obj instanceof Bundle[]) {
            ...
            this.f16764a.d().x().c("Not putting event parameter. Invalid value type. name, type", this.f16764a.D().e(str), str2);
        }
    }
    ...
    public final void E(InterfaceC2029k0 interfaceC2029k0, boolean z8) {
        ...
        try {
            ...
            this.f16764a.d().w().b("Error returning boolean value to wrapper", e8);
        }
    }
    ...
    public final void F(InterfaceC2029k0 interfaceC2029k0, ArrayList arrayList) {
        ...
        try {
            ...
            this.f16764a.d().w().b("Error returning bundle list to wrapper", e8);
        }
    }
    ...
    public final void G(InterfaceC2029k0 interfaceC2029k0, Bundle bundle) {
        try {
            ...
            this.f16764a.d().w().b("Error returning bundle value to wrapper", e8);
        }
    }
    ...
    public final void H(InterfaceC2029k0 interfaceC2029k0, byte[] bArr) {
        ...
        try {
            ...
            this.f16764a.d().w().b("Error returning byte array to wrapper", e8);
        }
    }
    ...
    public final void I(InterfaceC2029k0 interfaceC2029k0, int i8) {
        ...
        try {
            ...
            this.f16764a.d().w().b("Error returning int value to wrapper", e8);
        }
    }
    ...
    public final void J(InterfaceC2029k0 interfaceC2029k0, long j8) {
        ...
        try {
            ...
            this.f16764a.d().w().b("Error returning long value to wrapper", e8);
        }
    }
    ...
    public final void K(InterfaceC2029k0 interfaceC2029k0, String str) {
        ...
        try {
            ...
            this.f16764a.d().w().b("Error returning string value to wrapper", e8);
        }
    }
    ...
    final void L(String str, String str2, String str3, Bundle bundle, List list, boolean z8) {
        ...
        C2197h z9 = this.f16764a.z();
        C2122v6.c();
        String str7 = null;
        if (z9.f16764a.z().B(null, AbstractC2217k1.f16535B0) && z9.f16764a.N().X(231100000, true)) {
            i8 = 35;
        } else {
            i8 = 0;
        }
        ...
        for (String str8 : new TreeSet(bundle.keySet())) {
            ...
            if (i10 != 0) {
                ...
                if (V(bundle.get(str8))) {
                    this.f16764a.d().x().d("Nested Bundle parameters are not allowed; discarded. event name, param name, child param name", str2, str3, str8);
                    str4 = str8;
                    i11 = i8;
                    O8 = 22;
                } else {
                ...
                if (O8 != 0 && !"_ev".equals(str4)) {
                    ...
                    bundle.remove(str4);
                } else if (Z(str4) && !j0(str4, m0.r.f34876d)) {
                    int i14 = i13 + 1;
                    if (!X(231100000, true)) {
                        this.f16764a.d().s().c("Item array not supported on client's version of Google Play Services (Android Only)", this.f16764a.D().d(str2), this.f16764a.D().b(bundle));
                        f0(bundle, 23);
                        bundle.remove(str4);
                        i12 = i11;
                    } else {
                        ...
                        if (i14 > i12) {
                            C2122v6.c();
                            str5 = null;
                            if (this.f16764a.z().B(null, AbstractC2217k1.f16535B0)) {
                                this.f16764a.d().s().c("Item can't contain more than " + i12 + " item-scoped custom params", this.f16764a.D().d(str2), this.f16764a.D().b(bundle));
                                f0(bundle, 28);
                                bundle.remove(str4);
                            } else {
                                this.f16764a.d().s().c("Item cannot contain custom parameters", this.f16764a.D().d(str2), this.f16764a.D().b(bundle));
                                f0(bundle, 23);
                                bundle.remove(str4);
                            }
                            i13 = i14;
    ...
    public final boolean M(String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            if (!g0(str)) {
                if (this.f16764a.q()) {
                    this.f16764a.d().s().b("Invalid google_app_id. Firebase Analytics disabled. See https://goo.gl/NAOOOI. provided id", C2267u1.z(str));
                }
                return false;
            }
            return true;
        ...
        if (!TextUtils.isEmpty(str2)) {
            if (!g0(str2)) {
                this.f16764a.d().s().b("Invalid admob_app_id. Analytics disabled.", C2267u1.z(str2));
                return false;
            }
            return true;
        }
        if (this.f16764a.q()) {
            this.f16764a.d().s().a("Missing google_app_id. Firebase Analytics disabled. See https://goo.gl/NAOOOI");
        }
        return false;
    }
    ...
    public final boolean N(String str, int i8, String str2) {
        if (str2 == null) {
            this.f16764a.d().s().b("Name is required and can't be null. Type", str);
            return false;
        }
        if (str2.codePointCount(0, str2.length()) > i8) {
            this.f16764a.d().s().d("Name is too long. Type, maximum supported length, name", str, Integer.valueOf(i8), str2);
            return false;
        }
        return true;
    }
    ...
    */
    ...
    public final boolean P(String str, String[] strArr, String[] strArr2, String str2) {
        ...
        String[] strArr3 = f16927g;
        for (int i8 = 0; i8 < 3; i8++) {
            if (str2.startsWith(strArr3[i8])) {
                this.f16764a.d().s().c("Name starts with reserved prefix. Type, name", str, str2);
                return false;
            }
        }
        if (strArr != null && j0(str2, strArr)) {
            if (strArr2 == null || !j0(str2, strArr2)) {
                this.f16764a.d().s().c("Name is reserved. Type, name", str, str2);
                return false;
            }
            return true;
        }
    ...
    public final boolean Q(String str, String str2, int i8, Object obj) {
        if (obj != null && !(obj instanceof Long) && !(obj instanceof Float) && !(obj instanceof Integer) && !(obj instanceof Byte) && !(obj instanceof Short) && !(obj instanceof Boolean) && !(obj instanceof Double)) {
            ...
            if (obj2.codePointCount(0, obj2.length()) > i8) {
                this.f16764a.d().x().d("Value is too long; discarded. Value kind, name, value length", str, str2, Integer.valueOf(obj2.length()));
                return false;
            }
        }
        return true;
    ...
    public final boolean R(String str, String str2) {
        ...
        if (str2.length() == 0) {
            this.f16764a.d().s().b("Name is required and can't be empty. Type", str);
            return false;
        }
        ...
        if (!Character.isLetter(codePointAt)) {
            if (codePointAt == 95) {
                ...
                this.f16764a.d().s().c("Name must start with a letter or _ (underscore). Type, name", str, str2);
                return false;
            }
        }
        ...
        while (charCount < length) {
            ...
            if (codePointAt2 != 95 && !Character.isLetterOrDigit(codePointAt2)) {
                this.f16764a.d().s().c("Name must consist of letters, digits or _ (underscores). Type, name", str, str2);
                return false;
            }
    ...
    public final boolean S(String str, String str2) {
        ...
        int codePointAt = str2.codePointAt(0);
        if (!Character.isLetter(codePointAt)) {
            this.f16764a.d().s().c("Name must start with a letter. Type, name", str, str2);
            return false;
        }
        int length = str2.length();
        int charCount = Character.charCount(codePointAt);
    ...
    public final boolean T(String str) {
        h();
        if (Y.e.a(this.f16764a.c()).a(str) == 0) {
            return true;
        }
        this.f16764a.d().q().b("Permission not granted", str);
        return false;
    }
    ...
    public final boolean W(Context context, String str) {
        ...
        try {
            ...
            this.f16764a.d().r().b("Package name not found", e9);
            return true;
        } catch (CertificateException e10) {
            this.f16764a.d().r().b("Error obtaining certificate", e10);
            return true;
        }
    }

    public final boolean X(int i8, boolean z8) {
        Boolean J8 = this.f16764a.L().J();
        if (q0() >= i8 / 1000) {
            return true;
        }
    ...
    protected final void i() {
        ...
        if (nextLong == 0) {
            ...
            if (nextLong == 0) {
                this.f16764a.d().w().a("Utils falling back to Random for random id");
            }
        }
        this.f16930d.set(nextLong);
    }
    ...
    public final int m0(String str) {
        ...
        if (!P(NotificationCompat.CATEGORY_EVENT, m0.q.f34869a, m0.q.f34870b, str)) {
            return 13;
        }
        this.f16764a.z();
    ...
    public final int p0(String str) {
        ...
        if (!P("user property", m0.s.f34877a, null, str)) {
            return 15;
        }
        this.f16764a.z();
    ...
    public final int q0() {
        if (this.f16932f == null) {
            this.f16932f = Integer.valueOf(C1264h.f().a(this.f16764a.c()) / 1000);
        }
        return this.f16932f.intValue();
    }
    ...
    public final int r0(int i8) {
        return C1264h.f().h(this.f16764a.c(), AbstractC1268l.f7658a);
    }
    ...
    public final URL s(long j8, String str, String str2, long j9) {
        try {
            ...
            if (str.equals(this.f16764a.z().v())) {
                format = format.concat("&ddl_test=1");
            }
            return new URL(format);
        } catch (IllegalArgumentException e8) {
            e = e8;
            this.f16764a.d().r().b("Failed to create BOW URL for Deferred Deep Link. exception", e.getMessage());
            return null;
    ...
    public final long t0() {
        long andIncrement;
        long j8;
        if (this.f16930d.get() == 0) {
            synchronized (this.f16930d) {
                long nextLong = new Random(System.nanoTime() ^ this.f16764a.a().currentTimeMillis()).nextLong();
                int i8 = this.f16931e + 1;
                this.f16931e = i8;
                j8 = nextLong + i8;
            }
            return j8;
        ...
        synchronized (this.f16930d) {
            this.f16930d.compareAndSet(-1L, 1L);
            andIncrement = this.f16930d.getAndIncrement();
        }
        return andIncrement;
    }
    ...
    public final Bundle v0(Uri uri, boolean z8) {
        ...
        try {
            ...
            this.f16764a.d().w().b("Install referrer url isn't a hierarchical URI", e8);
            return null;
        }
    }
    ...
    public final void w(Bundle bundle, long j8) {
        ...
        if (j9 != 0) {
            this.f16764a.d().w().b("Params already contained engagement", Long.valueOf(j9));
        } else {
            j9 = 0;
        }
    ...
    public final Bundle w0(Bundle bundle) {
        ...
        if (bundle != null) {
            for (String str : bundle.keySet()) {
                ...
                if (o8 == null) {
                    this.f16764a.d().x().b("Param value can't be null", this.f16764a.D().e(str));
                } else {
                    D(bundle2, str, o8);
                }
            }
    ...
    */
    ...
    public final C2270v y0(String str, String str2, Bundle bundle, String str3, long j8, boolean z8, boolean z9) {
        ...
        this.f16764a.d().r().b("Invalid conditional property event name", this.f16764a.D().f(str2));
    ...
    public final void z(Bundle bundle, Bundle bundle2) {
        ...
        for (String str : bundle2.keySet()) {
            if (!bundle.containsKey(str)) {
                this.f16764a.N().D(bundle, str, bundle2.get(str));
            }
        }
    }
}
