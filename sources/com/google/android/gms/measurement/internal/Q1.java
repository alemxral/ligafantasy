    ...
    public final void a(int i8, String str, List list, boolean z8, boolean z9) {
        ...
        if (i9 != 0) {
            if (i9 != 1) {
                if (i9 != 3) {
                    if (i9 != 4) {
                        q8 = this.f16246a.f16764a.d().u();
                    } else if (z8) {
                        q8 = this.f16246a.f16764a.d().y();
                    } else if (!z9) {
                        q8 = this.f16246a.f16764a.d().x();
                    } else {
                        q8 = this.f16246a.f16764a.d().w();
                    }
                } else {
                    q8 = this.f16246a.f16764a.d().v();
                }
            } else if (z8) {
                q8 = this.f16246a.f16764a.d().t();
            } else if (!z9) {
                q8 = this.f16246a.f16764a.d().s();
            } else {
                q8 = this.f16246a.f16764a.d().r();
            }
        } else {
            q8 = this.f16246a.f16764a.d().q();
        }
        int size = list.size();
        if (size != 1) {
            if (size != 2) {
