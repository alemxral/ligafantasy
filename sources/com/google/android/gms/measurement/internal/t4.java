...
public final class t4 extends AbstractC2190f4 {
    ...
    private final void r(StringBuilder sb, int i8, C1979e1 c1979e1) {
        ...
        if (c1979e1.M()) {
            v(sb, i8, "param_name", this.f16764a.D().e(c1979e1.F()));
        }
        if (c1979e1.N()) {
            int i9 = i8 + 1;
    ...
    public final Parcelable B(byte[] bArr, Parcelable.Creator creator) {
        ...
        try {
            ...
            this.f16764a.d().r().a("Failed to load parcelable from buffer");
            return null;
        } finally {
            obtain.recycle();
        }
    ...
    public final String F(com.google.android.gms.internal.measurement.V1 v12) {
        ...
        for (com.google.android.gms.internal.measurement.X1 x12 : v12.E()) {
            if (x12 != null) {
                ...
                C1949a7.c();
                if (this.f16764a.z().B(x12.W1(), AbstractC2217k1.f16602q0) && x12.v1()) {
                ...
                E6.c();
                if (this.f16764a.z().B(null, AbstractC2217k1.f16545G0) && x12.x1()) {
                ...
                if (S7 != null) {
                    for (C1998g2 c1998g2 : S7) {
                        if (c1998g2 != null) {
                            ...
                            v(sb, 2, "name", this.f16764a.D().f(c1998g2.G()));
                ...
                if (R8 != null) {
                    for (com.google.android.gms.internal.measurement.M1 m12 : R8) {
                        if (m12 != null) {
                            s(sb, 2);
                            sb.append("event {\n");
                            v(sb, 2, "name", this.f16764a.D().d(m12.J()));
                            if (m12.W()) {
    ...
    public final String G(C1961c1 c1961c1) {
        ...
        v(sb, 0, "event_name", this.f16764a.D().d(c1961c1.H()));
    ...
    public final String H(C2038l1 c2038l1) {
        ...
        v(sb, 0, "property_name", this.f16764a.D().f(c2038l1.F()));
    ...
    public final List I(List list, List list2) {
        ...
        while (it.hasNext()) {
            ...
            if (num.intValue() < 0) {
                this.f16764a.d().w().b("Ignoring negative bit index to be cleared", num);
            } else {
                int intValue = num.intValue() / 64;
                if (intValue >= arrayList.size()) {
                    this.f16764a.d().w().c("Ignoring bit index greater than bitSet size", num, Integer.valueOf(arrayList.size()));
                } else {
    ...
    */
    ...
    public final void L(com.google.android.gms.internal.measurement.P1 p12, Object obj) {
        ...
        this.f16764a.d().r().b("Ignoring invalid (type) event param value", obj);
    }
    ...
    public final void M(C1989f2 c1989f2, Object obj) {
        ...
        if (obj instanceof Long) {
            ...
            this.f16764a.d().r().b("Ignoring invalid (type) user attribute value", obj);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final boolean O(long j8, long j9) {
        if (j8 != 0 && j9 > 0 && Math.abs(this.f16764a.a().currentTimeMillis() - j8) <= j9) {
            return false;
        }
        return true;
    }
    ...
    public final byte[] Q(byte[] bArr) {
        try {
            ...
            this.f16764a.d().r().b("Failed to gzip content", e8);
            throw e8;
        }
    }
    ...
    public final long z(byte[] bArr) {
        ...
        if (t8 == null) {
            this.f16764a.d().r().a("Failed to get MD5");
            return 0L;
        }
