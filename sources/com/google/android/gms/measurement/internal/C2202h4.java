...
public final class C2202h4 extends AbstractC2184e4 {
    ...
    private final String j(String str) {
        String w8 = this.f16469b.Z().w(str);
        if (!TextUtils.isEmpty(w8)) {
            Uri parse = Uri.parse((String) AbstractC2217k1.f16605s.a(null));
            Uri.Builder buildUpon = parse.buildUpon();
            buildUpon.authority(w8 + "." + parse.getAuthority());
            return buildUpon.build().toString();
        }
        return (String) AbstractC2217k1.f16605s.a(null);
    }
    ...
    public final C2196g4 i(String str) {
        ...
        if (this.f16764a.z().B(null, AbstractC2217k1.f16606s0)) {
            this.f16764a.d().v().a("sgtm feature flag enabled.");
            C2268u2 R8 = this.f16469b.V().R(str);
            if (R8 == null) {
                return new C2196g4(j(str));
            }
            if (R8.Q()) {
                this.f16764a.d().v().a("sgtm upload enabled in manifest.");
                C2141y1 t8 = this.f16469b.Z().t(R8.l0());
                if (t8 != null) {
                    String M8 = t8.M();
