...
public final class r4 implements InterfaceC2263t2 {
    ...
    private static volatile r4 f16767F;

    /* renamed from: A, reason: collision with root package name */
    private final Map f16768A;

    /* renamed from: B, reason: collision with root package name */
    private final Map f16769B;

    /* renamed from: C, reason: collision with root package name */
    private C2177d3 f16770C;

    /* renamed from: D, reason: collision with root package name */
    private String f16771D;

    /* renamed from: a, reason: collision with root package name */
    private final S1 f16773a;

    /* renamed from: b, reason: collision with root package name */
    private final C2292z1 f16774b;

    /* renamed from: c, reason: collision with root package name */
    private C2221l f16775c;

    /* renamed from: d, reason: collision with root package name */
    private C1 f16776d;

    /* renamed from: e, reason: collision with root package name */
    private C2178d4 f16777e;

    /* renamed from: f, reason: collision with root package name */
    private C2161b f16778f;

    /* renamed from: g, reason: collision with root package name */
    private final t4 f16779g;

    /* renamed from: h, reason: collision with root package name */
    private C2171c3 f16780h;

    /* renamed from: i, reason: collision with root package name */
    private N3 f16781i;

    /* renamed from: j, reason: collision with root package name */
    private final C2202h4 f16782j;

    /* renamed from: k, reason: collision with root package name */
    private L1 f16783k;

    /* renamed from: l, reason: collision with root package name */
    private final Y1 f16784l;
    ...
    private FileLock f16794v;

    /* renamed from: w, reason: collision with root package name */
    private FileChannel f16795w;

    /* renamed from: x, reason: collision with root package name */
    private List f16796x;

    /* renamed from: y, reason: collision with root package name */
    private List f16797y;

    /* renamed from: z, reason: collision with root package name */
    private long f16798z;

    /* renamed from: m, reason: collision with root package name */
    private boolean f16785m = false;

    /* renamed from: E, reason: collision with root package name */
    private final x4 f16772E = new o4(this);

    r4(s4 s4Var, Y1 y12) {
        AbstractC1319p.l(s4Var);
        this.f16784l = Y1.H(s4Var.f16809a, null, null);
        this.f16798z = -1L;
        this.f16782j = new C2202h4(this);
        t4 t4Var = new t4(this);
        t4Var.j();
        this.f16779g = t4Var;
        C2292z1 c2292z1 = new C2292z1(this);
        c2292z1.j();
        this.f16774b = c2292z1;
        S1 s12 = new S1(this);
        s12.j();
        this.f16773a = s12;
        this.f16768A = new HashMap();
        this.f16769B = new HashMap();
    ...
    private final Boolean J(C2268u2 c2268u2) {
        try {
            if (c2268u2.R() != -2147483648L) {
                if (c2268u2.R() == Y.e.a(this.f16784l.c()).e(c2268u2.l0(), 0).versionCode) {
                    return Boolean.TRUE;
                }
            } else {
                String str = Y.e.a(this.f16784l.c()).e(c2268u2.l0(), 0).versionName;
    ...
    private final void K() {
        f().h();
        if (!this.f16791s && !this.f16792t && !this.f16793u) {
            d().v().a("Stopping uploading service(s)");
            List list = this.f16788p;
            if (list == null) {
                return;
            }
            ...
            ((List) AbstractC1319p.l(this.f16788p)).clear();
            return;
        }
        d().v().d("Not stopping services. fetch, network, upload", Boolean.valueOf(this.f16791s), Boolean.valueOf(this.f16792t), Boolean.valueOf(this.f16793u));
    }
    ...
    private final void L(com.google.android.gms.internal.measurement.W1 w12, long j8, boolean z8) {
        ...
        if (X7 != null && X7.f16901e != null) {
            w4Var = new w4(w12.i0(), "auto", str, a().currentTimeMillis(), Long.valueOf(((Long) X7.f16901e).longValue() + j8));
        } else {
        ...
        E8.s(((Long) w4Var.f16901e).longValue());
        ...
        if (j8 > 0) {
            ...
            d().v().c("Updated engagement user property. scope, value", str2, w4Var.f16901e);
        }
    }
    ...
    */
    ...
    private static final boolean Q(D4 d42) {
        if (TextUtils.isEmpty(d42.f16049b) && TextUtils.isEmpty(d42.f16064q)) {
            return false;
        }
        return true;
    }
    ...
    public static r4 f0(Context context) {
        ...
        if (f16767F == null) {
            synchronized (r4.class) {
                try {
                    if (f16767F == null) {
                        f16767F = new r4((s4) AbstractC1319p.l(new s4(context)), null);
                    }
                } finally {
                }
            }
    ...
    public static /* bridge */ /* synthetic */ void k0(r4 r4Var, s4 s4Var) {
        r4Var.f().h();
        r4Var.f16783k = new L1(r4Var);
        C2221l c2221l = new C2221l(r4Var);
        c2221l.j();
        r4Var.f16775c = c2221l;
        r4Var.U().z((InterfaceC2191g) AbstractC1319p.l(r4Var.f16773a));
        N3 n32 = new N3(r4Var);
        n32.j();
        r4Var.f16781i = n32;
        C2161b c2161b = new C2161b(r4Var);
        c2161b.j();
        r4Var.f16778f = c2161b;
        C2171c3 c2171c3 = new C2171c3(r4Var);
        c2171c3.j();
        r4Var.f16780h = c2171c3;
        C2178d4 c2178d4 = new C2178d4(r4Var);
        c2178d4.j();
        r4Var.f16777e = c2178d4;
        r4Var.f16776d = new C1(r4Var);
        if (r4Var.f16789q != r4Var.f16790r) {
            r4Var.d().r().c("Not all upload components initialized", Integer.valueOf(r4Var.f16789q), Integer.valueOf(r4Var.f16790r));
        }
        r4Var.f16785m = true;
    }
    ...
    public final void A(String str, m0.p pVar) {
        ...
        try {
            if (c2221l.P().insertWithOnConflict("consent_settings", null, contentValues, 5) == -1) {
                c2221l.f16764a.d().r().b("Failed to insert/update consent setting (got -1). appId", C2267u1.z(str));
            }
        } catch (SQLiteException e8) {
            c2221l.f16764a.d().r().c("Error storing consent setting. appId, error", C2267u1.z(str), e8);
        }
    }
    ...
    public final void B(u4 u4Var, D4 d42) {
        ...
        int p02 = h0().p0(u4Var.f16865b);
        if (p02 != 0) {
            y4 h02 = h0();
            String str = u4Var.f16865b;
            U();
            String r8 = h02.r(str, 24, true);
            String str2 = u4Var.f16865b;
            if (str2 != null) {
                i9 = str2.length();
            } else {
                i9 = 0;
            }
            h0().C(this.f16772E, d42.f16048a, p02, "_ev", r8, i9);
            return;
        }
        int l02 = h0().l0(u4Var.f16865b, u4Var.s());
        if (l02 != 0) {
            y4 h03 = h0();
            String str3 = u4Var.f16865b;
            U();
            ...
            h0().C(this.f16772E, d42.f16048a, l02, "_ev", r9, i8);
            return;
        }
        Object p8 = h0().p(u4Var.f16865b, u4Var.s());
        if (p8 == null) {
            return;
        }
        if ("_sid".equals(u4Var.f16865b)) {
            long j9 = u4Var.f16866c;
            String str4 = u4Var.f16869f;
            String str5 = (String) AbstractC1319p.l(d42.f16048a);
            C2221l c2221l = this.f16775c;
            R(c2221l);
            w4 X7 = c2221l.X(str5, "_sno");
            if (X7 != null) {
                Object obj = X7.f16901e;
            ...
            if (X7 != null) {
                d().w().b("Retrieved last session number from database does not contain a valid (long) value", X7.f16901e);
            }
            C2221l c2221l2 = this.f16775c;
            R(c2221l2);
        ...
        w4 w4Var = new w4((String) AbstractC1319p.l(d42.f16048a), (String) AbstractC1319p.l(u4Var.f16869f), u4Var.f16865b, u4Var.f16866c, p8);
        d().v().c("Setting user property", this.f16784l.D().f(w4Var.f16899c), p8);
        C2221l c2221l3 = this.f16775c;
        R(c2221l3);
        c2221l3.e0();
        try {
            if ("_id".equals(w4Var.f16899c)) {
                C2221l c2221l4 = this.f16775c;
                R(c2221l4);
                w4 X8 = c2221l4.X(d42.f16048a, "_id");
                if (X8 != null && !w4Var.f16901e.equals(X8.f16901e)) {
                    C2221l c2221l5 = this.f16775c;
                    R(c2221l5);
                    c2221l5.m(d42.f16048a, "_lair");
                }
            }
            S(d42);
            C2221l c2221l6 = this.f16775c;
            R(c2221l6);
            boolean x8 = c2221l6.x(w4Var);
            if (U().B(null, AbstractC2217k1.f16551J0) && "_sid".equals(u4Var.f16865b)) {
                t4 t4Var = this.f16779g;
                R(t4Var);
                long y8 = t4Var.y(d42.f16071x);
                C2221l c2221l7 = this.f16775c;
                R(c2221l7);
                C2268u2 R8 = c2221l7.R(d42.f16048a);
                if (R8 != null) {
                    R8.K(y8);
                    if (R8.P()) {
                        C2221l c2221l8 = this.f16775c;
                        R(c2221l8);
                        c2221l8.p(R8);
                    }
                }
            }
            C2221l c2221l9 = this.f16775c;
            R(c2221l9);
            c2221l9.o();
            if (!x8) {
                d().r().c("Too many unique user properties are set. Ignoring user property", this.f16784l.D().f(w4Var.f16899c), w4Var.f16901e);
                h0().C(this.f16772E, d42.f16048a, 9, null, null, 0);
            }
            C2221l c2221l10 = this.f16775c;
            R(c2221l10);
            c2221l10.f0();
        } catch (Throwable th) {
            C2221l c2221l11 = this.f16775c;
            R(c2221l11);
            c2221l11.f0();
            throw th;
        }
    ...
    */
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(14:(3:103|104|105)|(37:155|(4:158|(3:160|161|(3:163|164|(3:166|167|169)(1:276))(1:278))(1:283)|277|156)|284|170|(1:172)|(1:174)|175|(2:179|(2:183|(1:185)))|186|(1:188)|189|(2:191|(1:193))|194|(3:196|(1:198)|199)|200|(1:204)|205|(1:207)|208|(4:211|(2:217|(2:219|220)(1:222))|221|209)|226|227|228|229|230|231|232|233|(2:234|(2:236|(1:238)(1:254))(3:255|256|(1:261)(1:260)))|239|240|241|242|(1:244)(2:249|250)|245|246|247)|231|232|233|(3:234|(0)(0)|254)|239|240|241|242|(0)(0)|245|246|247) */
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(55:(2:70|(5:72|(1:74)|75|76|77))|78|(2:80|(5:82|(1:84)|85|86|87))|88|89|(1:91)|92|(2:94|(1:98))|99|(3:100|101|102)|(14:(3:103|104|105)|(37:155|(4:158|(3:160|161|(3:163|164|(3:166|167|169)(1:276))(1:278))(1:283)|277|156)|284|170|(1:172)|(1:174)|175|(2:179|(2:183|(1:185)))|186|(1:188)|189|(2:191|(1:193))|194|(3:196|(1:198)|199)|200|(1:204)|205|(1:207)|208|(4:211|(2:217|(2:219|220)(1:222))|221|209)|226|227|228|229|230|231|232|233|(2:234|(2:236|(1:238)(1:254))(3:255|256|(1:261)(1:260)))|239|240|241|242|(1:244)(2:249|250)|245|246|247)|231|232|233|(3:234|(0)(0)|254)|239|240|241|242|(0)(0)|245|246|247)|106|107|(1:109)|110|(2:112|(1:118)(3:115|116|117))(1:287)|119|(1:121)|122|(1:124)|125|(1:127)|128|(1:134)|135|(1:137)|138|(1:140)|141|(1:145)|146|(1:148)|149|(1:151)(1:286)|285|(0)|175|(3:177|179|(3:181|183|(0)))|186|(0)|189|(0)|194|(0)|200|(2:202|204)|205|(0)|208|(1:209)|226|227|228|229|230) */
    /* JADX WARN: Can't wrap try/catch for region: R(72:(2:70|(5:72|(1:74)|75|76|77))|78|(2:80|(5:82|(1:84)|85|86|87))|88|89|(1:91)|92|(2:94|(1:98))|99|100|101|102|103|104|105|106|107|(1:109)|110|(2:112|(1:118)(3:115|116|117))(1:287)|119|(1:121)|122|(1:124)|125|(1:127)|128|(1:134)|135|(1:137)|138|(1:140)|141|(1:145)|146|(1:148)|149|(1:151)(1:286)|(37:155|(4:158|(3:160|161|(3:163|164|(3:166|167|169)(1:276))(1:278))(1:283)|277|156)|284|170|(1:172)|(1:174)|175|(2:179|(2:183|(1:185)))|186|(1:188)|189|(2:191|(1:193))|194|(3:196|(1:198)|199)|200|(1:204)|205|(1:207)|208|(4:211|(2:217|(2:219|220)(1:222))|221|209)|226|227|228|229|230|231|232|233|(2:234|(2:236|(1:238)(1:254))(3:255|256|(1:261)(1:260)))|239|240|241|242|(1:244)(2:249|250)|245|246|247)|285|(0)|175|(3:177|179|(3:181|183|(0)))|186|(0)|189|(0)|194|(0)|200|(2:202|204)|205|(0)|208|(1:209)|226|227|228|229|230|231|232|233|(3:234|(0)(0)|254)|239|240|241|242|(0)(0)|245|246|247) */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:253:0x0aad, code lost:
        ...
        r2.f16764a.d().r().c("Error storing raw event. appId", com.google.android.gms.measurement.internal.C2267u1.z(r5.f16731a), r0);
     */
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:272:0x0acd, code lost:
    
        r0 = e;
     */
    /* JADX WARN: Code restructure failed: missing block: B:273:0x0ace, code lost:
    ...
    /* JADX WARN: Code restructure failed: missing block: B:342:0x02e3, code lost:
        ...
        r11.f16764a.d().r().c("Error pruning currencies. appId", com.google.android.gms.measurement.internal.C2267u1.z(r10), r0);
     */
    ...
    */
    ...
    final boolean E() {
        f().h();
        FileLock fileLock = this.f16794v;
        if (fileLock != null && fileLock.isValid()) {
            d().v().a("Storage concurrent access okay");
            return true;
        }
        this.f16775c.f16764a.z();
        try {
            FileChannel channel = new RandomAccessFile(new File(this.f16784l.c().getFilesDir(), "google_app_measurement.db"), "rw").getChannel();
            this.f16795w = channel;
            FileLock tryLock = channel.tryLock();
            this.f16794v = tryLock;
            if (tryLock != null) {
                d().v().a("Storage concurrent access okay");
                return true;
            }
    ...
    final long F() {
        ...
        n32.i();
        n32.h();
        long a8 = n32.f16226i.a();
        if (a8 == 0) {
            a8 = n32.f16764a.N().u().nextInt(86400000) + 1;
            n32.f16226i.b(a8);
        }
    ...
    public final C2268u2 S(D4 d42) {
        ...
        if (!d42.f16070w.isEmpty()) {
            this.f16769B.put(d42.f16048a, new q4(this, d42.f16070w));
        }
        C2221l c2221l = this.f16775c;
        R(c2221l);
        C2268u2 R8 = c2221l.R(d42.f16048a);
        m0.p d8 = c0(d42.f16048a).d(m0.p.c(d42.f16069v, 100));
        m0.o oVar = m0.o.AD_STORAGE;
        if (d8.j(oVar)) {
            str = this.f16781i.o(d42.f16048a, d42.f16062o);
        } else {
            str = "";
        }
        if (R8 == null) {
            R8 = new C2268u2(this.f16784l, d42.f16048a);
            ...
            R8.H(str);
            if (d42.f16062o && !"00000000-0000-0000-0000-000000000000".equals(this.f16781i.n(d42.f16048a, d8).first)) {
                R8.j(i0(d8));
                C2221l c2221l2 = this.f16775c;
                R(c2221l2);
                if (c2221l2.X(d42.f16048a, "_id") != null) {
                    C2221l c2221l3 = this.f16775c;
                    R(c2221l3);
                    if (c2221l3.X(d42.f16048a, "_lair") == null) {
                        w4 w4Var = new w4(d42.f16048a, "auto", "_lair", a().currentTimeMillis(), 1L);
                        C2221l c2221l4 = this.f16775c;
                        R(c2221l4);
                        c2221l4.x(w4Var);
                    }
        ...
        R8.y(d42.f16049b);
        R8.h(d42.f16064q);
        if (!TextUtils.isEmpty(d42.f16058k)) {
            R8.x(d42.f16058k);
        }
        long j8 = d42.f16052e;
        if (j8 != 0) {
        ...
        if (!TextUtils.isEmpty(d42.f16050c)) {
            R8.l(d42.f16050c);
        }
        R8.m(d42.f16057j);
        String str2 = d42.f16051d;
        if (str2 != null) {
            R8.k(str2);
        }
        R8.u(d42.f16053f);
        R8.F(d42.f16055h);
        if (!TextUtils.isEmpty(d42.f16054g)) {
            R8.B(d42.f16054g);
        }
        R8.i(d42.f16062o);
        R8.G(d42.f16065r);
        R8.v(d42.f16066s);
        C1949a7.c();
        if (U().B(null, AbstractC2217k1.f16598o0) || U().B(d42.f16048a, AbstractC2217k1.f16602q0)) {
            R8.J(d42.f16071x);
        }
        T5.c();
        if (U().B(null, AbstractC2217k1.f16596n0)) {
            R8.I(d42.f16067t);
        } else {
            T5.c();
            if (U().B(null, AbstractC2217k1.f16594m0)) {
                R8.I(null);
            }
        }
        k7.c();
        if (U().B(null, AbstractC2217k1.f16606s0)) {
            R8.L(d42.f16072y);
        }
        E6.c();
        if (U().B(null, AbstractC2217k1.f16545G0)) {
            R8.M(d42.f16073z);
        }
        if (R8.P()) {
            C2221l c2221l5 = this.f16775c;
    ...
    public final C2161b T() {
        C2161b c2161b = this.f16778f;
        R(c2161b);
        return c2161b;
    }

    public final C2197h U() {
        return ((Y1) AbstractC1319p.l(this.f16784l)).z();
    }
    ...
    public final C2243p1 W() {
        return this.f16784l.D();
    }

    public final C2292z1 X() {
        C2292z1 c2292z1 = this.f16774b;
        R(c2292z1);
        return c2292z1;
    }
    ...
    public final W.d a() {
        return ((Y1) AbstractC1319p.l(this.f16784l)).a();
    }
    ...
    public final Context c() {
        return this.f16784l.c();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final m0.p c0(String str) {
        String str2;
        m0.p pVar = m0.p.f34866c;
        f().h();
        g();
        m0.p pVar2 = (m0.p) this.f16768A.get(str);
        if (pVar2 == null) {
            C2221l c2221l = this.f16775c;
            R(c2221l);
            AbstractC1319p.l(str);
            ...
            try {
                try {
                    ...
                    c2221l.f16764a.d().r().c("Database error", "select consent_state from consent_settings where app_id=? limit 1;", e8);
                    throw e8;
                }
            } catch (Throwable th) {
                if (cursor != null) {
    ...
    public final C2267u1 d() {
        return ((Y1) AbstractC1319p.l(this.f16784l)).d();
    }

    public final C2171c3 d0() {
        C2171c3 c2171c3 = this.f16780h;
        R(c2171c3);
        return c2171c3;
    }
    ...
    public final void e() {
        ...
        if (!this.f16786n) {
            this.f16786n = true;
            if (E()) {
                FileChannel fileChannel = this.f16795w;
                f().h();
                int i8 = 0;
                ...
                if (i8 < p8) {
                    FileChannel fileChannel2 = this.f16795w;
                    f().h();
    ...
    @Override // com.google.android.gms.measurement.internal.InterfaceC2263t2
    public final W1 f() {
        return ((Y1) AbstractC1319p.l(this.f16784l)).f();
    }
    ...
    public final void h(String str, com.google.android.gms.internal.measurement.W1 w12) {
        ...
        R(s14);
        if (s14.M(str)) {
            if (U().B(str, AbstractC2217k1.f16608t0)) {
                String k02 = w12.k0();
        ...
        if (s17.I(str)) {
            w12.z0();
            q4 q4Var = (q4) this.f16769B.get(str);
            if (q4Var == null || q4Var.f16745b + U().r(str, AbstractC2217k1.f16564V) < a().elapsedRealtime()) {
                q4Var = new q4(this);
                this.f16769B.put(str, q4Var);
            }
            w12.G(q4Var.f16744a);
        }
        S1 s18 = this.f16773a;
    ...
    public final y4 h0() {
        return ((Y1) AbstractC1319p.l(this.f16784l)).N();
    }
    ...
    final void i(C2268u2 c2268u2) {
        ...
        Uri.Builder appendQueryParameter = builder.scheme((String) AbstractC2217k1.f16581g.a(null)).encodedAuthority((String) AbstractC2217k1.f16583h.a(null)).path("config/app/".concat(String.valueOf(a8))).appendQueryParameter("platform", "android");
        c2202h4.f16764a.z().q();
        ...
        try {
            ...
            c2292z1.f16764a.f().y(new RunnableC2287y1(c2292z1, str, url, null, arrayMap, c2220k4));
    ...
    public final void j(C2270v c2270v, D4 d42) {
        ...
        f().h();
        g();
        String str2 = d42.f16048a;
        long j8 = c2270v.f16874d;
        C2272v1 b8 = C2272v1.b(c2270v);
        f().h();
        C2177d3 c2177d3 = null;
        if (this.f16770C != null && (str = this.f16771D) != null && str.equals(str2)) {
            c2177d3 = this.f16770C;
        }
        y4.y(c2177d3, b8.f16879d, false);
        C2270v a8 = b8.a();
        R(this.f16779g);
        if (!t4.n(a8, d42)) {
            return;
        ...
        List list = d42.f16067t;
        if (list != null) {
            if (list.contains(a8.f16871a)) {
                Bundle z8 = a8.f16872b.z();
                z8.putLong("ga_safelisted", 1L);
                c2270v2 = new C2270v(a8.f16871a, new C2260t(z8), a8.f16873c, a8.f16874d);
            } else {
                d().q().d("Dropping non-safelisted event. appId, event name, origin", str2, a8.f16871a, a8.f16873c);
                return;
            }
        } else {
            c2270v2 = a8;
        ...
        try {
            ...
            c2221l2.i();
            if (j8 < 0) {
                c2221l2.f16764a.d().w().c("Invalid time querying timed out conditional properties", C2267u1.z(str2), Long.valueOf(j8));
            ...
            for (C2173d c2173d : b02) {
                if (c2173d != null) {
                    d().v().d("User property timed out", c2173d.f16433a, this.f16784l.D().f(c2173d.f16435c.f16865b), c2173d.f16435c.s());
                    C2270v c2270v3 = c2173d.f16439g;
                    if (c2270v3 != null) {
                        D(new C2270v(c2270v3, j8), d42);
                    }
                    C2221l c2221l3 = this.f16775c;
                    R(c2221l3);
                    c2221l3.J(str2, c2173d.f16435c.f16865b);
                }
            }
            C2221l c2221l4 = this.f16775c;
            R(c2221l4);
            ...
            c2221l4.i();
            if (j8 < 0) {
                c2221l4.f16764a.d().w().c("Invalid time querying expired conditional properties", C2267u1.z(str2), Long.valueOf(j8));
            ...
            for (C2173d c2173d2 : b03) {
                if (c2173d2 != null) {
                    d().v().d("User property expired", c2173d2.f16433a, this.f16784l.D().f(c2173d2.f16435c.f16865b), c2173d2.f16435c.s());
                    C2221l c2221l5 = this.f16775c;
                    R(c2221l5);
                    c2221l5.m(str2, c2173d2.f16435c.f16865b);
                    C2270v c2270v4 = c2173d2.f16443k;
                    if (c2270v4 != null) {
                        arrayList.add(c2270v4);
                    }
                    C2221l c2221l6 = this.f16775c;
                    R(c2221l6);
                    c2221l6.J(str2, c2173d2.f16435c.f16865b);
                }
            }
            ...
            C2221l c2221l7 = this.f16775c;
            R(c2221l7);
            String str3 = c2270v2.f16871a;
            AbstractC1319p.f(str2);
            AbstractC1319p.f(str3);
            c2221l7.h();
            c2221l7.i();
            if (j8 < 0) {
                c2221l7.f16764a.d().w().d("Invalid time querying triggered conditional properties", C2267u1.z(str2), c2221l7.f16764a.D().d(str3), Long.valueOf(j8));
            ...
            for (C2173d c2173d3 : b04) {
                if (c2173d3 != null) {
                    u4 u4Var = c2173d3.f16435c;
                    w4 w4Var = new w4((String) AbstractC1319p.l(c2173d3.f16433a), c2173d3.f16434b, u4Var.f16865b, j8, AbstractC1319p.l(u4Var.s()));
                    C2221l c2221l8 = this.f16775c;
                    R(c2221l8);
                    if (c2221l8.x(w4Var)) {
                        d().v().d("User property triggered", c2173d3.f16433a, this.f16784l.D().f(w4Var.f16899c), w4Var.f16901e);
                    } else {
                        d().r().d("Too many active user properties, ignoring", C2267u1.z(c2173d3.f16433a), this.f16784l.D().f(w4Var.f16899c), w4Var.f16901e);
                    }
                    C2270v c2270v5 = c2173d3.f16441i;
                    if (c2270v5 != null) {
                        arrayList2.add(c2270v5);
                    }
                    c2173d3.f16435c = new u4(w4Var);
                    c2173d3.f16437e = true;
                    C2221l c2221l9 = this.f16775c;
                    R(c2221l9);
                    c2221l9.w(c2173d3);
                }
    ...
    public final String j0(D4 d42) {
        try {
            ...
            d().r().c("Failed to get app instance id. appId", C2267u1.z(d42.f16048a), e8);
            return null;
        }
    }
    ...
    final void l(C2270v c2270v, D4 d42) {
        ...
        C2272v1 b8 = C2272v1.b(c2270v);
        y4 h02 = h0();
        Bundle bundle = b8.f16879d;
        C2221l c2221l = this.f16775c;
        R(c2221l);
        h02.z(bundle, c2221l.Q(d42.f16048a));
        h0().B(b8, U().n(d42.f16048a));
        C2270v a8 = b8.a();
        if ("_cmp".equals(a8.f16871a) && "referrer API v2".equals(a8.f16872b.V("_cis"))) {
            String V7 = a8.f16872b.V("gclid");
            if (!TextUtils.isEmpty(V7)) {
                B(new u4("_lgclid", a8.f16874d, V7, "auto"), d42);
            }
        }
        j(a8, d42);
    }
    ...
    */
    ...
    public final void p(int i8, Throwable th, byte[] bArr, String str) {
        ...
        List<Long> list = (List) AbstractC1319p.l(this.f16796x);
        this.f16796x = null;
        if (i8 != 200) {
            if (i8 == 204) {
            ...
            this.f16781i.f16225h.b(a().currentTimeMillis());
            if (i8 != 503 || i8 == 429) {
                this.f16781i.f16223f.b(a().currentTimeMillis());
            }
            C2221l c2221l2 = this.f16775c;
            R(c2221l2);
            c2221l2.g0(list);
        ...
        if (th == null) {
            try {
                this.f16781i.f16224g.b(a().currentTimeMillis());
                this.f16781i.f16225h.b(0L);
                M();
                ...
                d().r().b("Database error while trying to delete uploaded bundles", e8);
                this.f16787o = a().elapsedRealtime();
                d().v().b("Disable upload, time", Long.valueOf(this.f16787o));
            }
            try {
                for (Long l8 : list) {
                    try {
                    ...
                    try {
                        ...
                        c2221l.f16764a.d().r().b("Failed to delete a bundle in a queue table", e10);
                        throw e10;
                        break;
                    }
                }
    ...
    */
    ...
    public final void s(C2173d c2173d) {
        D4 I8 = I((String) AbstractC1319p.l(c2173d.f16433a));
        if (I8 != null) {
            t(c2173d, I8);
        }
    }
    ...
    public final void t(C2173d c2173d, D4 d42) {
        ...
        AbstractC1319p.f(c2173d.f16435c.f16865b);
        f().h();
        g();
        if (!Q(d42)) {
            return;
        ...
        if (d42.f16055h) {
            ...
            try {
                S(d42);
                String str = (String) AbstractC1319p.l(c2173d.f16433a);
                C2221l c2221l2 = this.f16775c;
                R(c2221l2);
                C2173d S7 = c2221l2.S(str, c2173d.f16435c.f16865b);
                if (S7 != null) {
                    d().q().c("Removing conditional user property", c2173d.f16433a, this.f16784l.D().f(c2173d.f16435c.f16865b));
                    C2221l c2221l3 = this.f16775c;
                    R(c2221l3);
                    c2221l3.J(str, c2173d.f16435c.f16865b);
                    if (S7.f16437e) {
                        C2221l c2221l4 = this.f16775c;
                        R(c2221l4);
                        c2221l4.m(str, c2173d.f16435c.f16865b);
                    }
                    C2270v c2270v = c2173d.f16443k;
                    if (c2270v != null) {
                        C2260t c2260t = c2270v.f16872b;
                        if (c2260t != null) {
                            bundle = c2260t.z();
                        } else {
                            bundle = null;
                        }
                        D((C2270v) AbstractC1319p.l(h0().y0(str, ((C2270v) AbstractC1319p.l(c2173d.f16443k)).f16871a, bundle, S7.f16434b, c2173d.f16443k.f16874d, true, true)), d42);
                    }
                } else {
                    d().w().c("Conditional user property doesn't exist", C2267u1.z(c2173d.f16433a), this.f16784l.D().f(c2173d.f16435c.f16865b));
                }
                C2221l c2221l5 = this.f16775c;
                R(c2221l5);
                c2221l5.o();
    ...
    public final void u(String str, D4 d42) {
        ...
        d().q().b("Removing user property", this.f16784l.D().f(str));
        C2221l c2221l = this.f16775c;
        R(c2221l);
        c2221l.e0();
        try {
            ...
            if ("_id".equals(str)) {
                C2221l c2221l2 = this.f16775c;
                R(c2221l2);
                c2221l2.m((String) AbstractC1319p.l(d42.f16048a), "_lair");
            }
            C2221l c2221l3 = this.f16775c;
            R(c2221l3);
            c2221l3.m((String) AbstractC1319p.l(d42.f16048a), str);
            C2221l c2221l4 = this.f16775c;
            R(c2221l4);
            c2221l4.o();
            d().q().b("User property removed", this.f16784l.D().f(str));
            C2221l c2221l5 = this.f16775c;
            R(c2221l5);
            c2221l5.f0();
        } catch (Throwable th) {
    ...
    public final void v(D4 d42) {
        if (this.f16796x != null) {
            ...
            this.f16797y = arrayList;
            arrayList.addAll(this.f16796x);
        }
        C2221l c2221l = this.f16775c;
        R(c2221l);
        String str = (String) AbstractC1319p.l(d42.f16048a);
        ...
        try {
            ...
            if (delete > 0) {
                c2221l.f16764a.d().v().c("Reset analytics data. app, records", str, Integer.valueOf(delete));
            }
        } catch (SQLiteException e8) {
            c2221l.f16764a.d().r().c("Error resetting analytics data. appId, error", C2267u1.z(str), e8);
        }
        if (d42.f16055h) {
            q(d42);
        }
    ...
    public final void z(C2173d c2173d, D4 d42) {
        AbstractC1319p.l(c2173d);
        AbstractC1319p.f(c2173d.f16433a);
        AbstractC1319p.l(c2173d.f16434b);
        AbstractC1319p.l(c2173d.f16435c);
        AbstractC1319p.f(c2173d.f16435c.f16865b);
        f().h();
        g();
        ...
        try {
            C2221l c2221l2 = this.f16775c;
            R(c2221l2);
            C2173d S7 = c2221l2.S((String) AbstractC1319p.l(c2173d2.f16433a), c2173d2.f16435c.f16865b);
            if (S7 != null && !S7.f16434b.equals(c2173d2.f16434b)) {
                d().w().d("Updating a conditional user property with different origin. name, origin, origin (from DB)", this.f16784l.D().f(c2173d2.f16435c.f16865b), c2173d2.f16434b, S7.f16434b);
            }
            if (S7 != null && S7.f16437e) {
                c2173d2.f16434b = S7.f16434b;
                c2173d2.f16436d = S7.f16436d;
                c2173d2.f16440h = S7.f16440h;
                c2173d2.f16438f = S7.f16438f;
                c2173d2.f16441i = S7.f16441i;
                c2173d2.f16437e = true;
                u4 u4Var = c2173d2.f16435c;
                c2173d2.f16435c = new u4(u4Var.f16865b, S7.f16435c.f16866c, u4Var.s(), S7.f16435c.f16869f);
            } else if (TextUtils.isEmpty(c2173d2.f16438f)) {
                u4 u4Var2 = c2173d2.f16435c;
                c2173d2.f16435c = new u4(u4Var2.f16865b, c2173d2.f16436d, u4Var2.s(), c2173d2.f16435c.f16869f);
                c2173d2.f16437e = true;
                z8 = true;
            }
            if (c2173d2.f16437e) {
                u4 u4Var3 = c2173d2.f16435c;
                w4 w4Var = new w4((String) AbstractC1319p.l(c2173d2.f16433a), c2173d2.f16434b, u4Var3.f16865b, u4Var3.f16866c, AbstractC1319p.l(u4Var3.s()));
                C2221l c2221l3 = this.f16775c;
                R(c2221l3);
                if (c2221l3.x(w4Var)) {
                    d().q().d("User property updated immediately", c2173d2.f16433a, this.f16784l.D().f(w4Var.f16899c), w4Var.f16901e);
                } else {
                    d().r().d("(2)Too many active user properties, ignoring", C2267u1.z(c2173d2.f16433a), this.f16784l.D().f(w4Var.f16899c), w4Var.f16901e);
                }
                if (z8 && c2173d2.f16441i != null) {
                    D(new C2270v(c2173d2.f16441i, c2173d2.f16436d), d42);
                }
            }
            C2221l c2221l4 = this.f16775c;
            R(c2221l4);
            if (c2221l4.w(c2173d2)) {
                d().q().d("Conditional property added", c2173d2.f16433a, this.f16784l.D().f(c2173d2.f16435c.f16865b), c2173d2.f16435c.s());
            } else {
                d().r().d("Too many conditional properties, ignoring", C2267u1.z(c2173d2.f16433a), this.f16784l.D().f(c2173d2.f16435c.f16865b), c2173d2.f16435c.s());
            }
            C2221l c2221l5 = this.f16775c;
            R(c2221l5);
            c2221l5.o();
