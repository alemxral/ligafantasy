...
public final class C2197h extends AbstractC2253r2 {
    ...
    private InterfaceC2191g f16491c;
    ...
    public C2197h(Y1 y12) {
        super(y12);
        this.f16491c = new InterfaceC2191g() { // from class: com.google.android.gms.measurement.internal.f
    ...
    public static final long I() {
        return ((Long) AbstractC2217k1.f16579f.a(null)).longValue();
    }

    public static final long i() {
        return ((Long) AbstractC2217k1.f16542F.a(null)).longValue();
    }
    ...
    private final String j(String str, String str2) {
        try {
            ...
            this.f16764a.d().r().b("Could not find SystemProperties class", e8);
            return "";
        } catch (IllegalAccessException e9) {
            this.f16764a.d().r().b("Could not access SystemProperties.get()", e9);
            return "";
        } catch (NoSuchMethodException e10) {
            this.f16764a.d().r().b("Could not find SystemProperties.get() method", e10);
            return "";
        } catch (InvocationTargetException e11) {
            this.f16764a.d().r().b("SystemProperties.get() threw an exception", e11);
            return "";
        }
    }
    ...
    public final boolean B(String str, C2211j1 c2211j1) {
        ...
        String e8 = this.f16491c.e(str, c2211j1.b());
    ...
    public final boolean C(String str) {
        return "1".equals(this.f16491c.e(str, "gaia_collection_enabled"));
    }
    ...
    public final boolean F(String str) {
        return "1".equals(this.f16491c.e(str, "measurement.event_sampling_enabled"));
    }
    ...
    public final boolean G() {
        if (this.f16490b == null) {
            ...
            this.f16490b = t8;
            if (t8 == null) {
                this.f16490b = Boolean.FALSE;
            }
        }
        if (!this.f16490b.booleanValue() && this.f16764a.s()) {
            return false;
        }
        return true;
    }
    ...
    public final boolean H() {
        if (this.f16492d == null) {
            synchronized (this) {
                try {
                    if (this.f16492d == null) {
                        ApplicationInfo applicationInfo = this.f16764a.c().getApplicationInfo();
                        String a8 = W.m.a();
                        if (applicationInfo != null) {
                            ...
                            this.f16492d = Boolean.valueOf(z8);
                        }
                        if (this.f16492d == null) {
                            this.f16492d = Boolean.TRUE;
                            this.f16764a.d().r().a("My process not in the list of running processes");
                        }
                    }
                } finally {
                }
        ...
        return this.f16492d.booleanValue();
    }
    ...
    public final int l(String str) {
        return p(str, AbstractC2217k1.f16550J, 500, 2000);
    }

    public final int m() {
        if (this.f16764a.N().X(201500000, true)) {
            return 100;
        }
        return 25;
    }
    ...
    public final int n(String str) {
        return p(str, AbstractC2217k1.f16552K, 25, 100);
    }
    ...
    final Bundle s() {
        try {
            if (this.f16764a.c().getPackageManager() == null) {
                this.f16764a.d().r().a("Failed to load metadata: PackageManager is null");
                return null;
            }
            ApplicationInfo c8 = Y.e.a(this.f16764a.c()).c(this.f16764a.c().getPackageName(), 128);
            if (c8 == null) {
                this.f16764a.d().r().a("Failed to load metadata: ApplicationInfo is null");
                return null;
            }
            return c8.metaData;
        } catch (PackageManager.NameNotFoundException e8) {
            this.f16764a.d().r().b("Failed to load metadata: Package name not found", e8);
            return null;
        }
    }
    ...
    public final Boolean t(String str) {
        ...
        Bundle s8 = s();
        if (s8 == null) {
            this.f16764a.d().r().a("Failed to load metadata: Metadata bundle is null");
            return null;
        }
    ...
    public final String x(String str, C2211j1 c2211j1) {
        ...
        return (String) c2211j1.a(this.f16491c.e(str, c2211j1.b()));
    }
    ...
    */
    public final java.util.List y(java.lang.String r4) {
        ...
        L2c:
            if (r4 == 0) goto L58
            com.google.android.gms.measurement.internal.Y1 r0 = r3.f16764a     // Catch: android.content.res.Resources.NotFoundException -> L48
