...
public final class C2267u1 extends AbstractC2258s2 {
    ...
    private final C2257s1 f16820f;

    /* renamed from: g, reason: collision with root package name */
    private final C2257s1 f16821g;

    /* renamed from: h, reason: collision with root package name */
    private final C2257s1 f16822h;

    /* renamed from: i, reason: collision with root package name */
    private final C2257s1 f16823i;

    /* renamed from: j, reason: collision with root package name */
    private final C2257s1 f16824j;

    /* renamed from: k, reason: collision with root package name */
    private final C2257s1 f16825k;

    /* renamed from: l, reason: collision with root package name */
    private final C2257s1 f16826l;

    /* renamed from: m, reason: collision with root package name */
    private final C2257s1 f16827m;

    /* renamed from: n, reason: collision with root package name */
    private final C2257s1 f16828n;
    ...
    public C2267u1(Y1 y12) {
        ...
        this.f16817c = (char) 0;
        this.f16818d = -1L;
        this.f16820f = new C2257s1(this, 6, false, false);
        this.f16821g = new C2257s1(this, 6, true, false);
        this.f16822h = new C2257s1(this, 6, false, true);
        this.f16823i = new C2257s1(this, 5, false, false);
        this.f16824j = new C2257s1(this, 5, true, false);
        this.f16825k = new C2257s1(this, 5, false, true);
        this.f16826l = new C2257s1(this, 4, false, false);
        this.f16827m = new C2257s1(this, 3, false, false);
        this.f16828n = new C2257s1(this, 2, false, false);
    }
    ...
    static String C(String str) {
        ...
        if (lastIndexOf == -1) {
            C2027j6.c();
            if (((Boolean) AbstractC2217k1.f16533A0.a(null)).booleanValue()) {
                return "";
            }
            return str;
        }
        ...
        synchronized (this) {
            try {
                if (this.f16819e == null) {
                    if (this.f16764a.Q() != null) {
                        this.f16819e = this.f16764a.Q();
                    } else {
                        this.f16819e = this.f16764a.z().w();
                    }
                }
                AbstractC1319p.l(this.f16819e);
                str = this.f16819e;
            } catch (Throwable th) {
                throw th;
            }
