...
public final class DynamiteModule {
    ...
    private static Boolean f15202h = null;

    /* renamed from: i, reason: collision with root package name */
    private static String f15203i = null;

    /* renamed from: j, reason: collision with root package name */
    private static boolean f15204j = false;

    /* renamed from: k, reason: collision with root package name */
    private static int f15205k = -1;

    /* renamed from: l, reason: collision with root package name */
    private static Boolean f15206l;

    /* renamed from: q, reason: collision with root package name */
    private static m f15211q;

    /* renamed from: r, reason: collision with root package name */
    private static n f15212r;

    /* renamed from: a, reason: collision with root package name */
    private final Context f15213a;

    /* renamed from: m, reason: collision with root package name */
    private static final ThreadLocal f15207m = new ThreadLocal();

    /* renamed from: n, reason: collision with root package name */
    private static final ThreadLocal f15208n = new com.google.android.gms.dynamite.b();

    /* renamed from: o, reason: collision with root package name */
    private static final b.a f15209o = new c();

    /* renamed from: b, reason: collision with root package name */
    public static final b f15196b = new d();

    /* renamed from: c, reason: collision with root package name */
    public static final b f15197c = new e();

    /* renamed from: d, reason: collision with root package name */
    public static final b f15198d = new f();

    /* renamed from: e, reason: collision with root package name */
    public static final b f15199e = new g();

    /* renamed from: f, reason: collision with root package name */
    public static final b f15200f = new h();

    /* renamed from: g, reason: collision with root package name */
    public static final b f15201g = new i();

    /* renamed from: p, reason: collision with root package name */
    public static final b f15210p = new j();
    ...
    public interface b {
        ...
        public static class C0377b {
            ...
            /* renamed from: b, reason: collision with root package name */
            public int f15215b = 0;

            /* renamed from: c, reason: collision with root package name */
            public int f15216c = 0;
        }
                ...
                try {
                    if (l8 != null) {
                        try {
                            int l9 = l8.l();
                            if (l9 >= 3) {
                                k kVar = (k) f15207m.get();
                                if (kVar != null && (cursor = kVar.f15217a) != null) {
                                    i8 = cursor.getInt(0);
                                } else {
                                    Cursor cursor3 = (Cursor) Z.b.l(l8.r0(Z.b.m0(context), str, z8, ((Long) f15208n.get()).longValue()));
                                    if (cursor3 != null) {
                                        try {
    ...
    */
    ...
    private static boolean j(Cursor cursor) {
        k kVar = (k) f15207m.get();
        if (kVar != null && kVar.f15217a == null) {
            kVar.f15217a = cursor;
            return true;
        }
        return false;
    ...
    private static boolean k(Context context) {
        ...
        if (bool.equals(null) || bool.equals(f15206l)) {
            return true;
        }
        boolean z8 = false;
        if (f15206l == null) {
    ...
    public IBinder d(String str) {
        try {
            return (IBinder) this.f15213a.getClassLoader().loadClass(str).newInstance();
