...
public abstract class AbstractC2028k implements r, InterfaceC2052n {
    ...
    protected final String f15736a;

    /* renamed from: b, reason: collision with root package name */
    protected final Map f15737b = new HashMap();
    ...
    public final boolean a(String str) {
        return this.f15737b.containsKey(str);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return str.equals(abstractC2028k.f15736a);
    }
    ...
    public final Iterator i() {
        return AbstractC2036l.b(this.f15737b);
    }

    @Override // com.google.android.gms.internal.measurement.InterfaceC2052n
    public final void l(String str, r rVar) {
        if (rVar == null) {
            this.f15737b.remove(str);
        } else {
            this.f15737b.put(str, rVar);
        }
    }
    ...
    public final r m(String str, T1 t12, List list) {
        if ("toString".equals(str)) {
            return new C2115v(this.f15736a);
        }
    ...
    public final r p(String str) {
        if (this.f15737b.containsKey(str)) {
            return (r) this.f15737b.get(str);
        }
        return r.f15853c0;
    }
}
