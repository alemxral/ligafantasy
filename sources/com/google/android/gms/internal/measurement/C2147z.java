...
public final class C2147z {
    ...
    final Map f15957a = new HashMap();

    /* renamed from: b, reason: collision with root package name */
    final M f15958b = new M();
    ...
    public final r a(T1 t12, r rVar) {
        ...
        if (rVar instanceof C2091s) {
            ...
            String a8 = c2091s.a();
            if (this.f15957a.containsKey(a8)) {
                abstractC2139y = (AbstractC2139y) this.f15957a.get(a8);
            } else {
                abstractC2139y = this.f15958b;
            }
    ...
    final void b(AbstractC2139y abstractC2139y) {
        Iterator it = abstractC2139y.f15947a.iterator();
        while (it.hasNext()) {
            this.f15957a.put(((O) it.next()).b().toString(), abstractC2139y);
        }
    }
}
