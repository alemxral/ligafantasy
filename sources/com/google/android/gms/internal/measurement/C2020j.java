...
public final class C2020j implements r {
    ...
    public C2020j(Double d8) {
        if (d8 == null) {
            this.f15725a = Double.valueOf(Double.NaN);
        } else {
            this.f15725a = d8;
        }
    }
    ...
    public final r d() {
        return new C2020j(this.f15725a);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f15725a.equals(((C2020j) obj).f15725a);
    }
    ...
    public final String g() {
        int scale;
        if (Double.isNaN(this.f15725a.doubleValue())) {
            return "NaN";
        }
        if (Double.isInfinite(this.f15725a.doubleValue())) {
            if (this.f15725a.doubleValue() > 0.0d) {
                return "Infinity";
            }
            return "-Infinity";
        }
        BigDecimal a8 = AbstractC2012i.a(BigDecimal.valueOf(this.f15725a.doubleValue()));
    ...
    public final Boolean h() {
        boolean z8 = false;
        if (!Double.isNaN(this.f15725a.doubleValue()) && this.f15725a.doubleValue() != 0.0d) {
            z8 = true;
        }
