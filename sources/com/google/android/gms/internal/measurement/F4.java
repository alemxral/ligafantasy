...
public final class F4 extends I3 implements RandomAccess, G4 {
    ...
    private static final F4 f15313c;

    /* renamed from: d, reason: collision with root package name */
    public static final G4 f15314d;

    /* renamed from: b, reason: collision with root package name */
    private final List f15315b;
    ...
    public final /* bridge */ /* synthetic */ void add(int i8, Object obj) {
        a();
        this.f15315b.add(i8, (String) obj);
        ((AbstractList) this).modCount++;
    }
    ...
    public final boolean addAll(int i8, Collection collection) {
        ...
        boolean addAll = this.f15315b.addAll(i8, collection);
        ((AbstractList) this).modCount++;
        return addAll;
    }
    ...
    public final String get(int i8) {
        Object obj = this.f15315b.get(i8);
        if (obj instanceof String) {
            return (String) obj;
        }
        if (obj instanceof X3) {
            X3 x32 = (X3) obj;
            String v8 = x32.v(B4.f15257b);
            if (x32.q()) {
                this.f15315b.set(i8, v8);
            }
            return v8;
        }
        byte[] bArr = (byte[]) obj;
    ...
    @Override // com.google.android.gms.internal.measurement.G4
    public final List f() {
        return DesugarCollections.unmodifiableList(this.f15315b);
    }
    ...
    public final Object o(int i8) {
        return this.f15315b.get(i8);
    }

    @Override // com.google.android.gms.internal.measurement.I3, java.util.AbstractList, java.util.List
    public final /* bridge */ /* synthetic */ Object remove(int i8) {
        a();
        Object remove = this.f15315b.remove(i8);
        ((AbstractList) this).modCount++;
        return g(remove);
    }
    ...
    public final /* bridge */ /* synthetic */ Object set(int i8, Object obj) {
        a();
        return g(this.f15315b.set(i8, (String) obj));
    }
    ...
    private F4(boolean z8) {
        super(false);
        this.f15315b = Collections.emptyList();
    }
