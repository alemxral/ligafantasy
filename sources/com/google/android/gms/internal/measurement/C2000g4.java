...
final class C2000g4 implements G5 {
    ...
    private final AbstractC1991f4 f15703a;

    private C2000g4(AbstractC1991f4 abstractC1991f4) {
        byte[] bArr = B4.f15259d;
        this.f15703a = abstractC1991f4;
        abstractC1991f4.f15690a = this;
    }

    public static C2000g4 K(AbstractC1991f4 abstractC1991f4) {
        C2000g4 c2000g4 = abstractC1991f4.f15690a;
        if (c2000g4 != null) {
            return c2000g4;
        }
    ...
    public final void B(int i8, List list, boolean z8) {
        ...
        if (z8) {
            ...
            this.f15703a.r(i10);
            while (i9 < list.size()) {
                this.f15703a.i(((Integer) list.get(i9)).intValue());
                i9++;
            }
            return;
        }
        while (i9 < list.size()) {
            this.f15703a.h(i8, ((Integer) list.get(i9)).intValue());
            i9++;
        }
    }
    ...
    public final void C(int i8, List list, boolean z8) {
        ...
        if (z8) {
            ...
            this.f15703a.r(i10);
            while (i9 < list.size()) {
                this.f15703a.k(Double.doubleToRawLongBits(((Double) list.get(i9)).doubleValue()));
                i9++;
            }
            return;
        }
        while (i9 < list.size()) {
            this.f15703a.j(i8, Double.doubleToRawLongBits(((Double) list.get(i9)).doubleValue()));
            i9++;
        }
    }
    ...
    public final void F(int i8, List list, boolean z8) {
        ...
        if (z8) {
            ...
            this.f15703a.r(i10);
            while (i9 < list.size()) {
                this.f15703a.i(Float.floatToRawIntBits(((Float) list.get(i9)).floatValue()));
                i9++;
            }
            return;
        }
        while (i9 < list.size()) {
            this.f15703a.h(i8, Float.floatToRawIntBits(((Float) list.get(i9)).floatValue()));
            i9++;
        }
    }
    ...
    public final void H(int i8, List list, boolean z8) {
        ...
        if (z8) {
            ...
            this.f15703a.r(i10);
            while (i9 < list.size()) {
                AbstractC1991f4 abstractC1991f4 = this.f15703a;
        ...
        while (i9 < list.size()) {
            AbstractC1991f4 abstractC1991f42 = this.f15703a;
    ...
    public final void a(int i8, Object obj, InterfaceC2026j5 interfaceC2026j5) {
        ...
        interfaceC2026j5.b((Y4) obj, abstractC1991f4.f15690a);
        abstractC1991f4.p(i8, 4);
    }

    @Override // com.google.android.gms.internal.measurement.G5
    public final void b(int i8, int i9) {
        this.f15703a.q(i8, i9);
    }
    ...
    public final void c(int i8, List list, boolean z8) {
        ...
        if (z8) {
            ...
            this.f15703a.r(i10);
            while (i9 < list.size()) {
                this.f15703a.k(((Long) list.get(i9)).longValue());
                i9++;
            }
            return;
        }
        while (i9 < list.size()) {
            this.f15703a.j(i8, ((Long) list.get(i9)).longValue());
            i9++;
        }
    }
    ...
    public final void d(int i8, List list) {
        for (int i9 = 0; i9 < list.size(); i9++) {
            this.f15703a.g(i8, (X3) list.get(i9));
        }
    }

    @Override // com.google.android.gms.internal.measurement.G5
    public final void e(int i8, int i9) {
        this.f15703a.h(i8, i9);
    }

    @Override // com.google.android.gms.internal.measurement.G5
    public final void f(int i8, boolean z8) {
        this.f15703a.f(i8, z8);
    }

    @Override // com.google.android.gms.internal.measurement.G5
    public final void g(int i8, int i9) {
        this.f15703a.q(i8, (i9 >> 31) ^ (i9 + i9));
    }

    @Override // com.google.android.gms.internal.measurement.G5
    public final void h(int i8, String str) {
        this.f15703a.o(i8, str);
    }
    ...
    public final void j(int i8, List list, boolean z8) {
        ...
        if (z8) {
            ...
            this.f15703a.r(i10);
            while (i9 < list.size()) {
                this.f15703a.e(((Boolean) list.get(i9)).booleanValue() ? (byte) 1 : (byte) 0);
                i9++;
            }
            return;
        }
        while (i9 < list.size()) {
            this.f15703a.f(i8, ((Boolean) list.get(i9)).booleanValue());
            i9++;
        }
    }
    ...
    public final void l(int i8, List list, boolean z8) {
        ...
        if (z8) {
            ...
            this.f15703a.r(i10);
            while (i9 < list.size()) {
                this.f15703a.r(((Integer) list.get(i9)).intValue());
                i9++;
            }
            return;
        }
        while (i9 < list.size()) {
            this.f15703a.q(i8, ((Integer) list.get(i9)).intValue());
            i9++;
        }
    }
    ...
    public final void n(int i8, List list, boolean z8) {
        ...
        if (z8) {
            ...
            this.f15703a.r(i10);
            while (i9 < list.size()) {
                this.f15703a.m(((Integer) list.get(i9)).intValue());
                i9++;
            }
            return;
        }
        while (i9 < list.size()) {
            this.f15703a.l(i8, ((Integer) list.get(i9)).intValue());
            i9++;
        }
    }
    ...
    public final void r(int i8, List list) {
        ...
        if (list instanceof G4) {
            ...
            while (i9 < list.size()) {
                ...
                if (o8 instanceof String) {
                    this.f15703a.o(i8, (String) o8);
                } else {
                    this.f15703a.g(i8, (X3) o8);
                }
                i9++;
            }
            return;
        ...
        while (i9 < list.size()) {
            this.f15703a.o(i8, (String) list.get(i9));
            i9++;
        }
    }
    ...
    public final void s(int i8, double d8) {
        this.f15703a.j(i8, Double.doubleToRawLongBits(d8));
    }

    @Override // com.google.android.gms.internal.measurement.G5
    public final void t(int i8, Object obj, InterfaceC2026j5 interfaceC2026j5) {
        Y4 y42 = (Y4) obj;
        C1964c4 c1964c4 = (C1964c4) this.f15703a;
        c1964c4.r((i8 << 3) | 2);
        c1964c4.r(((H3) y42).e(interfaceC2026j5));
        interfaceC2026j5.b(y42, c1964c4.f15690a);
    }
    ...
    public final void w(int i8, float f8) {
        this.f15703a.h(i8, Float.floatToRawIntBits(f8));
    }
    ...
    public final void y(int i8, List list, boolean z8) {
        ...
        if (z8) {
            ...
            this.f15703a.r(i10);
            while (i9 < list.size()) {
                this.f15703a.t(((Long) list.get(i9)).longValue());
                i9++;
            }
            return;
        }
        while (i9 < list.size()) {
            this.f15703a.s(i8, ((Long) list.get(i9)).longValue());
            i9++;
        }
    }
