...
final class C2048m3 implements Serializable, InterfaceC2016i3 {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof C2048m3) {
            return AbstractC1972d3.a(this.f15750a, ((C2048m3) obj).f15750a);
        }
        return false;
    }

    public final int hashCode() {
        return Arrays.hashCode(new Object[]{this.f15750a});
    }

    public final String toString() {
        return "Suppliers.ofInstance(" + this.f15750a.toString() + ")";
    }
}
