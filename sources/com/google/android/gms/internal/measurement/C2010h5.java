...
final class C2010h5 extends I3 implements RandomAccess {
    ...
    private static final C2010h5 f15712d = new C2010h5(new Object[0], 0, false);

    /* renamed from: b, reason: collision with root package name */
    private Object[] f15713b;
    ...
    private final String g(int i8) {
        return "Index:" + i8 + ", Size:" + this.f15714c;
    }

    private final void h(int i8) {
        if (i8 >= 0 && i8 < this.f15714c) {
        } else {
    ...
    public final void add(int i8, Object obj) {
        int i9;
        a();
        if (i8 >= 0 && i8 <= (i9 = this.f15714c)) {
            Object[] objArr = this.f15713b;
            if (i9 < objArr.length) {
                System.arraycopy(objArr, i8, objArr, i8 + 1, i9 - i8);
            } else {
                Object[] objArr2 = new Object[((i9 * 3) / 2) + 1];
                System.arraycopy(objArr, 0, objArr2, 0, i8);
                System.arraycopy(this.f15713b, i8, objArr2, i8 + 1, this.f15714c - i8);
                this.f15713b = objArr2;
            }
            this.f15713b[i8] = obj;
            this.f15714c++;
    ...
    public final Object get(int i8) {
        h(i8);
        return this.f15713b[i8];
    }

    @Override // com.google.android.gms.internal.measurement.A4
    public final /* bridge */ /* synthetic */ A4 k(int i8) {
        if (i8 >= this.f15714c) {
            return new C2010h5(Arrays.copyOf(this.f15713b, i8), this.f15714c, true);
        }
    ...
    public final boolean add(Object obj) {
        ...
        Object[] objArr = this.f15713b;
        if (i8 == objArr.length) {
            this.f15713b = Arrays.copyOf(objArr, ((i8 * 3) / 2) + 1);
        }
        Object[] objArr2 = this.f15713b;
        int i9 = this.f15714c;
        this.f15714c = i9 + 1;
        objArr2[i9] = obj;
        ((AbstractList) this).modCount++;
