...
public final class L extends AbstractC2139y {
    ...
    public L() {
        this.f15947a.add(O.ADD);
        this.f15947a.add(O.DIVIDE);
        this.f15947a.add(O.MODULUS);
        this.f15947a.add(O.MULTIPLY);
        this.f15947a.add(O.NEGATE);
        this.f15947a.add(O.POST_DECREMENT);
        this.f15947a.add(O.POST_INCREMENT);
        this.f15947a.add(O.PRE_DECREMENT);
        this.f15947a.add(O.PRE_INCREMENT);
        this.f15947a.add(O.SUBTRACT);
    }
