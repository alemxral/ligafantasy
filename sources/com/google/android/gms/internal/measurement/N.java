...
public final class N extends AbstractC2139y {
    ...
    public N() {
        this.f15947a.add(O.ASSIGN);
        this.f15947a.add(O.CONST);
        this.f15947a.add(O.CREATE_ARRAY);
        this.f15947a.add(O.CREATE_OBJECT);
        this.f15947a.add(O.EXPRESSION_LIST);
        this.f15947a.add(O.GET);
        this.f15947a.add(O.GET_INDEX);
        this.f15947a.add(O.GET_PROPERTY);
        this.f15947a.add(O.NULL);
        this.f15947a.add(O.SET_PROPERTY);
        this.f15947a.add(O.TYPEOF);
        this.f15947a.add(O.UNDEFINED);
        this.f15947a.add(O.VAR);
    }
    ...
    public final r a(String str, T1 t12, List list) {
        ...
        if (ordinal == 58) {
            ...
            if (b12 != r.f15853c0 && b12 != r.f15854d0) {
