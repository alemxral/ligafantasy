...
public final class K extends AbstractC2139y {
    ...
    public K() {
        this.f15947a.add(O.FOR_IN);
        this.f15947a.add(O.FOR_IN_CONST);
        this.f15947a.add(O.FOR_IN_LET);
        this.f15947a.add(O.FOR_LET);
        this.f15947a.add(O.FOR_OF);
        this.f15947a.add(O.FOR_OF_CONST);
        this.f15947a.add(O.FOR_OF_LET);
        this.f15947a.add(O.WHILE);
    }
