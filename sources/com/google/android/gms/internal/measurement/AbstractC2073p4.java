...
abstract class AbstractC2073p4 {
    ...
    private static final Logger f15824a = Logger.getLogger(AbstractC1991f4.class.getName());

    /* renamed from: b, reason: collision with root package name */
    private static final String f15825b = "com.google.protobuf.BlazeGeneratedExtensionRegistryLiteLoader";
        ...
        try {
            ...
            while (it.hasNext()) {
                try {
                    ...
                    f15824a.logp(Level.SEVERE, "com.google.protobuf.GeneratedExtensionRegistryLoader", "load", "Unable to load ".concat(cls.getSimpleName()), (Throwable) e12);
                }
            }
            if (arrayList.size() == 1) {
