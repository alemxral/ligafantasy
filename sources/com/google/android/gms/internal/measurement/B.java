...
public final class B extends AbstractC2139y {
    ...
    public B() {
        this.f15947a.add(O.APPLY);
        this.f15947a.add(O.BLOCK);
        this.f15947a.add(O.BREAK);
        this.f15947a.add(O.CASE);
        this.f15947a.add(O.DEFAULT);
        this.f15947a.add(O.CONTINUE);
        this.f15947a.add(O.DEFINE_FUNCTION);
        this.f15947a.add(O.FN);
        this.f15947a.add(O.IF);
        this.f15947a.add(O.QUOTE);
        this.f15947a.add(O.RETURN);
        this.f15947a.add(O.SWITCH);
        this.f15947a.add(O.TERNARY);
    }
