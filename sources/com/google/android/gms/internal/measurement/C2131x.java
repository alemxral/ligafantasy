...
public final class C2131x extends AbstractC2139y {
    public C2131x() {
        this.f15947a.add(O.BITWISE_AND);
        this.f15947a.add(O.BITWISE_LEFT_SHIFT);
        this.f15947a.add(O.BITWISE_NOT);
        this.f15947a.add(O.BITWISE_OR);
        this.f15947a.add(O.BITWISE_RIGHT_SHIFT);
        this.f15947a.add(O.BITWISE_UNSIGNED_RIGHT_SHIFT);
        this.f15947a.add(O.BITWISE_XOR);
    }
