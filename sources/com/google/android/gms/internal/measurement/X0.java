...
public final class X0 {
    ...
    private static volatile X0 f15588j;

    /* renamed from: a, reason: collision with root package name */
    private final String f15589a;

    /* renamed from: b, reason: collision with root package name */
    protected final W.d f15590b;

    /* renamed from: c, reason: collision with root package name */
    protected final ExecutorService f15591c;

    /* renamed from: d, reason: collision with root package name */
    private final C3162a f15592d;
    ...
    private volatile InterfaceC2005h0 f15597i;
    ...
    protected X0(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        this.f15592d = new C3162a(this);
        this.f15593e = new ArrayList();
        try {
            if (m0.w.b(context, "google_app_id", m0.k.a(context)) != null && !h()) {
                this.f15596h = null;
                this.f15595g = true;
                Log.w(this.f15589a, "Disabling data collection. Found google_app_id in strings.xml but Google Analytics for Firebase is missing. Remove this value or add Google Analytics for Firebase to resume data collection.");
                return;
            }
        ...
        if (!l(str2, str3)) {
            ...
            if (str2 != null && str3 != null) {
                Log.v(this.f15589a, "Deferring to Google Analytics for Firebase for event data collection. https://firebase.google.com/docs/analytics");
            } else {
                if (str2 == null) {
                    z8 = true;
                } else {
                ...
                if (z8 ^ (str3 == null)) {
                    Log.w(this.f15589a, "Specified origin or custom app id is null. Both parameters will be ignored.");
                }
            }
        } else {
            this.f15596h = str2;
        ...
        if (application == null) {
            Log.w(this.f15589a, "Unable to register lifecycle notifications. Application null.");
        } else {
    ...
    public final void i(Exception exc, boolean z8, boolean z9) {
        this.f15595g |= z8;
        if (z8) {
            Log.w(this.f15589a, "Data collection startup failed. No data will be collected.", exc);
            return;
        }
        if (z9) {
            a(5, "Error with data collection. Data lost.", exc, null, null);
        }
        Log.w(this.f15589a, "Error with data collection. Data lost.", exc);
    }
    ...
    public static X0 r(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        if (f15588j == null) {
            synchronized (X0.class) {
                try {
                    if (f15588j == null) {
                        f15588j = new X0(context, str, str2, str3, bundle);
                    }
                } finally {
                }
            }
    ...
    public final void b(m0.u uVar) {
        ...
        synchronized (this.f15593e) {
            for (int i8 = 0; i8 < this.f15593e.size(); i8++) {
                try {
                    if (uVar.equals(((Pair) this.f15593e.get(i8)).first)) {
                        Log.w(this.f15589a, "OnEventListener already registered.");
                        return;
                    }
                } catch (Throwable th) {
                    throw th;
            ...
            N0 n02 = new N0(uVar);
            this.f15593e.add(new Pair(uVar, n02));
            if (this.f15597i != null) {
                try {
                    this.f15597i.registerOnMeasurementEventListener(n02);
                    return;
                } catch (BadParcelableException | NetworkOnMainThreadException | RemoteException | IllegalArgumentException | IllegalStateException | NullPointerException | SecurityException | UnsupportedOperationException unused) {
                    Log.w(this.f15589a, "Failed to register event listener on calling thread. Trying again on the dynamite thread.");
                }
            }
            k(new J0(this, n02));
        }
    ...
    public final long n() {
        ...
        if (l8 == null) {
            long nextLong = new Random(System.nanoTime() ^ this.f15590b.currentTimeMillis()).nextLong();
            int i8 = this.f15594f + 1;
            this.f15594f = i8;
            return nextLong + i8;
        }
        return l8.longValue();
    ...
    public final InterfaceC2005h0 q(Context context, boolean z8) {
        try {
            return AbstractBinderC1996g0.asInterface(DynamiteModule.e(context, DynamiteModule.f15199e, ModuleDescriptor.MODULE_ID).d("com.google.android.gms.measurement.internal.AppMeasurementDynamiteService"));
