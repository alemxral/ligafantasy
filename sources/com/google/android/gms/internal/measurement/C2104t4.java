...
public final class C2104t4 extends C2060o {
    ...
    public final r m(String str, T1 t12, List list) {
        ...
        if (c8 != 0) {
                ...
                if (c8 != 2) {
                    if (c8 != 3) {
                        if (c8 != 4) {
                            ...
                            this.f15889b.b().g(g8, AbstractC2110u2.f(b8));
                            return b8;
                        }
                        AbstractC2110u2.h("setEventName", 1, list);
                        r b9 = t12.b((r) list.get(0));
                        if (!r.f15853c0.equals(b9) && !r.f15854d0.equals(b9)) {
                            this.f15889b.b().f(b9.g());
                            return new C2115v(b9.g());
                        }
                        throw new IllegalArgumentException("Illegal event name");
                    }
                    AbstractC2110u2.h("getTimestamp", 0, list);
                    return new C2020j(Double.valueOf(this.f15889b.b().a()));
                }
                AbstractC2110u2.h("getParams", 0, list);
                Map e8 = this.f15889b.b().e();
            ...
            return V2.b(this.f15889b.b().c(t12.b((r) list.get(0)).g()));
        }
        AbstractC2110u2.h("getEventName", 0, list);
        return new C2115v(this.f15889b.b().d());
    }
}
