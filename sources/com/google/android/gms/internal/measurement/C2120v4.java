...
final class C2120v4 extends I3 implements RandomAccess, InterfaceC2144y4, InterfaceC1992f5 {
    ...
    private static final C2120v4 f15924d = new C2120v4(new int[0], 0, false);
    ...
    private final String i(int i8) {
        return "Index:" + i8 + ", Size:" + this.f15926c;
    }

    private final void l(int i8) {
        if (i8 >= 0 && i8 < this.f15926c) {
        } else {
    ...
    public final InterfaceC2144y4 k(int i8) {
        if (i8 >= this.f15926c) {
            return new C2120v4(Arrays.copyOf(this.f15925b, i8), this.f15926c, true);
        }
    ...
    public final /* synthetic */ void add(int i8, Object obj) {
        ...
        if (i8 >= 0 && i8 <= (i9 = this.f15926c)) {
            ...
            if (i9 < iArr.length) {
                ...
                System.arraycopy(this.f15925b, i8, iArr2, i8 + 1, this.f15926c - i8);
                this.f15925b = iArr2;
            }
            this.f15925b[i8] = intValue;
            this.f15926c++;
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i9 >= i8) {
            ...
            System.arraycopy(c2120v4.f15925b, 0, this.f15925b, this.f15926c, c2120v4.f15926c);
            this.f15926c = i10;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.f15926c != c2120v4.f15926c) {
            return false;
        }
        int[] iArr = c2120v4.f15925b;
        for (int i8 = 0; i8 < this.f15926c; i8++) {
            if (this.f15925b[i8] != iArr[i8]) {
                return false;
            }
        }
        return true;
    ...
    public final /* synthetic */ Object get(int i8) {
        l(i8);
        return Integer.valueOf(this.f15925b[i8]);
    }
    ...
    public final int hashCode() {
        int i8 = 1;
        for (int i9 = 0; i9 < this.f15926c; i9++) {
            i8 = (i8 * 31) + this.f15925b[i9];
        }
        return i8;
    }
    ...
    protected final void removeRange(int i8, int i9) {
        ...
        if (i9 >= i8) {
            int[] iArr = this.f15925b;
            System.arraycopy(iArr, i9, iArr, i8, this.f15926c - i9);
            this.f15926c -= i9 - i8;
            ((AbstractList) this).modCount++;
            return;
        }
