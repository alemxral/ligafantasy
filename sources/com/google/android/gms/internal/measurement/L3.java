...
public abstract class L3 {
    ...
    public static int a(byte[] bArr, int i8, K3 k32) {
        ...
        if (i9 >= 0) {
            if (i9 <= bArr.length - j8) {
                if (i9 == 0) {
                    k32.f15360c = X3.f15609b;
                    return j8;
                }
                k32.f15360c = X3.u(bArr, j8, i9);
                return j8 + i9;
            }
            throw D4.f();
        }
    ...
    public static int f(byte[] bArr, int i8, A4 a42, K3 k32) {
        ...
        int j8 = j(bArr, i8, k32);
        int i9 = k32.f15358a + j8;
        while (j8 < i9) {
            j8 = j(bArr, j8, k32);
            c2120v4.h(k32.f15358a);
        }
        if (j8 == i9) {
            return j8;
        }
    ...
    public static int g(byte[] bArr, int i8, K3 k32) {
        ...
        if (i9 >= 0) {
            ...
            k32.f15360c = new String(bArr, j8, i9, B4.f15257b);
            return j8 + i9;
        }
        throw D4.d();
    }
    ...
    public static int h(byte[] bArr, int i8, K3 k32) {
        ...
        if (i9 >= 0) {
            ...
            if ((((length - j8) - i9) | j8 | i9) >= 0) {
                ...
                k32.f15360c = new String(cArr, 0, i13);
                return i11;
            }
    ...
    public static int i(int i8, byte[] bArr, int i9, int i10, C2082q5 c2082q5, K3 k32) {
        if ((i8 >>> 3) != 0) {
            ...
            c2082q5.j(i8, Long.valueOf(k32.f15359b));
            return m8;
        }
        throw D4.b();
    }
