...
public abstract class AbstractC1991f4 extends M3 {
    ...
    private static final Logger f15687b = Logger.getLogger(AbstractC1991f4.class.getName());

    /* renamed from: c, reason: collision with root package name */
    private static final boolean f15688c = AbstractC2153z5.C();
    ...
    public static int x(String str) {
        ...
        try {
            ...
            length = str.getBytes(B4.f15257b).length;
        }
    ...
    public final void b(String str, D5 d52) {
        f15687b.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) d52);
        byte[] bytes = str.getBytes(B4.f15257b);
        try {
