...
public final class G7 {
    ...
    final TreeMap f15323a = new TreeMap();

    /* renamed from: b, reason: collision with root package name */
    final TreeMap f15324b = new TreeMap();
    ...
    public final void a(String str, int i8, C2076q c2076q, String str2) {
        ...
        if ("create".equals(str2)) {
            treeMap = this.f15324b;
        } else if ("edit".equals(str2)) {
            treeMap = this.f15323a;
        } else {
    ...
    public final void b(T1 t12, C1959c c1959c) {
        ...
        for (Integer num : this.f15323a.keySet()) {
            C1950b clone = c1959c.b().clone();
            int c8 = c(t12, (C2076q) this.f15323a.get(num), c2104t4);
            if (c8 == 2 || c8 == -1) {
                c1959c.f(clone);
            }
        }
        Iterator it = this.f15324b.keySet().iterator();
        while (it.hasNext()) {
            c(t12, (C2076q) this.f15324b.get((Integer) it.next()), c2104t4);
        }
    }
}
