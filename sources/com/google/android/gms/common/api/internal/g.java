...
public final class g {
    ...
    private final Map f15145a = DesugarCollections.synchronizedMap(new WeakHashMap());

    /* renamed from: b, reason: collision with root package name */
    private final Map f15146b = DesugarCollections.synchronizedMap(new WeakHashMap());

    private final void h(boolean z8, Status status) {
        HashMap hashMap;
        HashMap hashMap2;
        synchronized (this.f15145a) {
            hashMap = new HashMap(this.f15145a);
        }
        synchronized (this.f15146b) {
            hashMap2 = new HashMap(this.f15146b);
        }
    ...
    public final void c(BasePendingResult basePendingResult, boolean z8) {
        this.f15145a.put(basePendingResult, Boolean.valueOf(z8));
        basePendingResult.a(new e(this, basePendingResult));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void d(C3679j c3679j, boolean z8) {
        this.f15146b.put(c3679j, Boolean.valueOf(z8));
    ...
    public final void f() {
        h(false, C1939c.f15115p);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final boolean g() {
        if (this.f15145a.isEmpty() && this.f15146b.isEmpty()) {
            return false;
        }
        return true;
    }
