...
public final class r implements InterfaceC3674e {
    ...
    private final C1939c f15178a;

    /* renamed from: b, reason: collision with root package name */
    private final int f15179b;

    /* renamed from: c, reason: collision with root package name */
    private final C1301b f15180c;
    ...
    public final void a(Task task) {
        ...
        if (this.f15178a.e()) {
            R.r a8 = C1320q.b().a();
            if ((a8 == null || a8.z()) && (t8 = this.f15178a.t(this.f15180c)) != null && (t8.v() instanceof AbstractC1306c)) {
                AbstractC1306c abstractC1306c = (AbstractC1306c) t8.v();
                boolean z9 = true;
                if (this.f15181d > 0) {
                    z8 = true;
                ...
                if (a8 != null) {
                    ...
                    i8 = a8.I();
                    if (abstractC1306c.J() && !abstractC1306c.e()) {
                        C1308e c8 = c(t8, abstractC1306c, this.f15179b);
                        if (c8 != null) {
                            if (!c8.I() || this.f15181d <= 0) {
                                z9 = false;
                            }
                            u8 = c8.s();
                            z8 = z9;
                ...
                if (z8) {
                    long j10 = this.f15181d;
                    long j11 = this.f15182e;
                ...
                c1939c.C(new C1316m(this.f15179b, i11, s8, j8, j9, null, null, z10, i12), i8, i9, i10);
            }
        }
    }
}
