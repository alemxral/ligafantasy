...
public final class h extends C {
    ...
    private final ArraySet f15147f;

    /* renamed from: g, reason: collision with root package name */
    private final C1939c f15148g;

    h(Q.e eVar, C1939c c1939c, C1263g c1263g) {
        super(eVar, c1263g);
        this.f15147f = new ArraySet();
        this.f15148g = c1939c;
        this.f15107a.a("ConnectionlessLifecycleHelper", this);
    }
    ...
    public static void u(Activity activity, C1939c c1939c, C1301b c1301b) {
        ...
        hVar.f15147f.add(c1301b);
        c1939c.b(hVar);
    }

    private final void v() {
        if (!this.f15147f.isEmpty()) {
            this.f15148g.b(this);
        }
    }
