...
public class ShapePath {
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i8, Canvas canvas) {
            ...
            double hypot = Math.hypot(this.operation1.f17124x - this.startX, this.operation1.f17125y - this.startY);
            double hypot2 = Math.hypot(this.operation2.f17124x - this.operation1.f17124x, this.operation2.f17125y - this.operation1.f17125y);
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f17124x, this.operation1.f17125y);
            this.renderMatrix.preRotate(getStartAngle());
        ...
        float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f17125y - this.operation1.f17125y) / (this.operation2.f17124x - this.operation1.f17124x)));
        }

        float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f17125y - this.startY) / (this.operation1.f17124x - this.startX)));
        }
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, @NonNull ShadowRenderer shadowRenderer, int i8, @NonNull Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f17125y - this.startY, this.operation.f17124x - this.startX), 0.0f);
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.startX, this.startY);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f17125y - this.startY) / (this.operation.f17124x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(@NonNull Matrix matrix, @NonNull Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f17124x, this.f17125y);
            path.transform(matrix);
        }
    }
    ...
    public void lineTo(float f8, float f9) {
        ...
        pathLineOperation.f17124x = f8;
        pathLineOperation.f17125y = f9;
    ...
    public void lineTo(float f8, float f9, float f10, float f11) {
        ...
        pathLineOperation2.f17124x = f10;
        pathLineOperation2.f17125y = f11;
