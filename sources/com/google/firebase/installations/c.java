...
public class c implements InterfaceC1554e {
    ...
    private static final Object f17251m = new Object();

    /* renamed from: n, reason: collision with root package name */
    private static final ThreadFactory f17252n = new a();

    /* renamed from: a, reason: collision with root package name */
    private final y0.e f17253a;

    /* renamed from: b, reason: collision with root package name */
    private final C1904c f17254b;

    /* renamed from: c, reason: collision with root package name */
    private final C1853c f17255c;

    /* renamed from: d, reason: collision with root package name */
    private final i f17256d;

    /* renamed from: e, reason: collision with root package name */
    private final x f17257e;

    /* renamed from: f, reason: collision with root package name */
    private final a1.g f17258f;

    /* renamed from: g, reason: collision with root package name */
    private final Object f17259g;

    /* renamed from: h, reason: collision with root package name */
    private final ExecutorService f17260h;

    /* renamed from: i, reason: collision with root package name */
    private final Executor f17261i;
    ...
    private final List f17264l;

    /* loaded from: classes3.dex */
    class a implements ThreadFactory {

        /* renamed from: a, reason: collision with root package name */
        private final AtomicInteger f17265a = new AtomicInteger(1);
        ...
        public Thread newThread(Runnable runnable) {
            return new Thread(runnable, String.format("firebase-installations-executor-%d", Integer.valueOf(this.f17265a.getAndIncrement())));
        }
    }
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f17267b[f.b.BAD_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f17267b[f.b.AUTH_ERROR.ordinal()] = 3;
            ...
            try {
                f17266a[AbstractC1905d.b.BAD_CONFIG.ordinal()] = 2;
    ...
    private String A(AbstractC1854d abstractC1854d) {
        if ((!this.f17253a.m().equals("CHIME_ANDROID_SDK") && !this.f17253a.u()) || !abstractC1854d.m()) {
            return this.f17258f.a();
        }
        String f8 = o().f();
    ...
    private AbstractC1854d B(AbstractC1854d abstractC1854d) {
        ...
        AbstractC1905d d8 = this.f17254b.d(l(), abstractC1854d.d(), t(), m(), str);
        int i8 = b.f17266a[d8.e().ordinal()];
        if (i8 != 1) {
            if (i8 == 2) {
        ...
        return abstractC1854d.s(d8.c(), d8.d(), this.f17256d.b(), d8.b().c(), d8.b().d());
    }
    ...
    private synchronized void F(AbstractC1854d abstractC1854d, AbstractC1854d abstractC1854d2) {
        if (this.f17263k.size() != 0 && !TextUtils.equals(abstractC1854d.d(), abstractC1854d2.d())) {
    ...
    */
    public void v(boolean r3) {
        ...
        L11:
            if (r3 != 0) goto L1f
            com.google.firebase.installations.i r3 = r2.f17256d     // Catch: com.google.firebase.installations.d -> L1d
    ...
    public final void x(final boolean z8) {
        ...
        D(s8);
        this.f17261i.execute(new Runnable() { // from class: a1.c
    ...
    private AbstractC1854d k(AbstractC1854d abstractC1854d) {
        c1.f e8 = this.f17254b.e(l(), abstractC1854d.d(), t(), abstractC1854d.f());
        int i8 = b.f17267b[e8.b().ordinal()];
        if (i8 != 1) {
            if (i8 != 2) {
                if (i8 == 3) {
                    E(null);
        ...
        return abstractC1854d.o(e8.c(), e8.d(), this.f17256d.b());
    }
    ...
    private C1852b o() {
        return (C1852b) this.f17257e.get();
    }
    ...
    private AbstractC1854d r() {
        ...
        synchronized (f17251m) {
            try {
                com.google.firebase.installations.b a8 = com.google.firebase.installations.b.a(this.f17253a.k(), "generatefid.lock");
                try {
                    d8 = this.f17255c.d();
                    if (a8 != null) {
                        a8.b();
    ...
    public Task a(final boolean z8) {
        z();
        Task f8 = f();
        this.f17260h.execute(new Runnable() { // from class: a1.d
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public Task getId() {
        ...
        Task g8 = g();
        this.f17260h.execute(new Runnable() { // from class: a1.b
            @Override // java.lang.Runnable
            public final void run() {
    ...
    String l() {
        return this.f17253a.n().b();
    }

    String m() {
        return this.f17253a.n().c();
    }

    String t() {
        return this.f17253a.n().e();
    }
    ...
    c(ExecutorService executorService, Executor executor, y0.e eVar, C1904c c1904c, C1853c c1853c, i iVar, x xVar, a1.g gVar) {
        ...
        this.f17257e = xVar;
        this.f17258f = gVar;
        this.f17260h = executorService;
        this.f17261i = executor;
    }
}
