...
class X {
    ...
    final SharedPreferences f17375a;
    ...
    public static class a {
        ...
        private static final long f17376d = TimeUnit.DAYS.toMillis(7);

        /* renamed from: a, reason: collision with root package name */
        final String f17377a;

        /* renamed from: b, reason: collision with root package name */
        final String f17378b;
        ...
        public boolean b(String str) {
            if (System.currentTimeMillis() <= this.f17379c + f17376d && str.equals(this.f17378b)) {
                return false;
            }
            return true;
        }
    ...
    public synchronized a d(String str, String str2) {
        return a.c(this.f17375a.getString(b(str, str2), null));
    }
