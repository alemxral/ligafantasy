...
public class B {
    ...
    private final y0.e f17285a;

    /* renamed from: b, reason: collision with root package name */
    private final G f17286b;

    /* renamed from: c, reason: collision with root package name */
    private final C1255c f17287c;

    /* renamed from: d, reason: collision with root package name */
    private final Z0.b f17288d;

    /* renamed from: e, reason: collision with root package name */
    private final Z0.b f17289e;

    /* renamed from: f, reason: collision with root package name */
    private final InterfaceC1554e f17290f;
    ...
    private String d() {
        try {
            return b(MessageDigest.getInstance("SHA-1").digest(this.f17285a.m().getBytes()));
    ...
    */
    private void i(java.lang.String r3, java.lang.String r4, android.os.Bundle r5) {
        /*
            ...
            r5.putString(r4, r3)
            com.google.firebase.messaging.G r3 = r2.f17286b
            int r3 = r3.d()
            ...
            r5.putString(r3, r4)
            a1.e r3 = r2.f17290f     // Catch: java.lang.InterruptedException -> L76 java.util.concurrent.ExecutionException -> L78
            r4 = 0
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public Task e() {
        return c(j(G.c(this.f17285a), "*", new Bundle()));
    }
