...
public class S {
    ...
    private final Map f17361b = new ArrayMap();
    ...
    public synchronized Task b(final String str, a aVar) {
        Task task = (Task) this.f17361b.get(str);
        if (task != null) {
        ...
        Task h8 = aVar.start().h(this.f17360a, new InterfaceC3671b() { // from class: com.google.firebase.messaging.Q
