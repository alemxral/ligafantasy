...
public class H {
    ...
    private final Bundle f17324a;

    public H(Bundle bundle) {
        if (bundle != null) {
            this.f17324a = new Bundle(bundle);
            return;
        }
    ...
    private String w(String str) {
        if (!this.f17324a.containsKey(str) && str.startsWith("gcm.n.")) {
            String v8 = v(str);
            if (this.f17324a.containsKey(v8)) {
                return v8;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f17324a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f17324a);
        for (String str : this.f17324a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
