...
public abstract class f0 {
    ...
    static final long f17449a = TimeUnit.MINUTES.toMillis(1);

    /* renamed from: b, reason: collision with root package name */
    private static final Object f17450b = new Object();

    /* renamed from: c, reason: collision with root package name */
    private static C3643a f17451c;
    ...
    public static void c(Intent intent) {
        synchronized (f17450b) {
            try {
                if (f17451c != null && d(intent)) {
                    g(intent, false);
                    f17451c.c();
                }
            } catch (Throwable th) {
