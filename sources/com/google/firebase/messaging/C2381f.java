...
class C2381f {
    ...
    private final ExecutorService f17446a;
    ...
    private boolean b() {
        if (((KeyguardManager) this.f17447b.getSystemService("keyguard")).inKeyguardRestrictedInputMode()) {
            return false;
        }
        if (!W.k.f()) {
        ...
        List<ActivityManager.RunningAppProcessInfo> runningAppProcesses = ((ActivityManager) this.f17447b.getSystemService("activity")).getRunningAppProcesses();
    ...
    private void c(AbstractC2379d.a aVar) {
        ...
        ((NotificationManager) this.f17447b.getSystemService("notification")).notify(aVar.f17432b, aVar.f17433c, aVar.f17431a.build());
    }

    private D d() {
        D f8 = D.f(this.f17448c.p("gcm.n.image"));
        if (f8 != null) {
            f8.l(this.f17446a);
        }
        return f8;
    ...
    public boolean a() {
        ...
        D d8 = d();
        AbstractC2379d.a e8 = AbstractC2379d.e(this.f17447b, this.f17448c);
        e(e8.f17431a, d8);
        c(e8);
        return true;
    }
