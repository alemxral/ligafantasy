...
public class C2389n {
    ...
    private static final Object f17480c = new Object();

    /* renamed from: d, reason: collision with root package name */
    private static k0 f17481d;

    /* renamed from: a, reason: collision with root package name */
    private final Context f17482a;

    /* renamed from: b, reason: collision with root package name */
    private final Executor f17483b = new androidx.profileinstaller.c();
    ...
    private static k0 f(Context context, String str) {
        k0 k0Var;
        synchronized (f17480c) {
            try {
                if (f17481d == null) {
                    f17481d = new k0(context, str);
                }
                k0Var = f17481d;
            } catch (Throwable th) {
                throw th;
    ...
    public Task l(final Context context, final Intent intent) {
        ...
        return r0.l.c(this.f17483b, new Callable() { // from class: com.google.firebase.messaging.j
        ...
        }).h(this.f17483b, new InterfaceC3671b() { // from class: com.google.firebase.messaging.k
            @Override // r0.InterfaceC3671b
            public final Object a(Task task) {
                Task j8;
