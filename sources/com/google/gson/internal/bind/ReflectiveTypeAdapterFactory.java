...
public final class ReflectiveTypeAdapterFactory implements r {
    ...
    private final com.google.gson.c f17598b;

    /* renamed from: c, reason: collision with root package name */
    private final Excluder f17599c;

    /* renamed from: d, reason: collision with root package name */
    private final JsonAdapterAnnotationTypeAdapterFactory f17600d;

    /* renamed from: e, reason: collision with root package name */
    private final List f17601e;
    ...
    public static abstract class Adapter<T, A> extends TypeAdapter {
        ...
        public Object b(C3596a c3596a) {
            ...
            try {
                c3596a.b();
                while (c3596a.t()) {
                    b bVar = (b) this.f17602a.get(c3596a.H());
                    if (bVar != null && bVar.f17621e) {
                        g(e8, c3596a, bVar);
                    }
                    c3596a.X();
                }
        ...
        public void d(p1.c cVar, Object obj) {
            ...
            cVar.f();
            try {
                Iterator it = this.f17602a.values().iterator();
                while (it.hasNext()) {
    ...
    private static final class RecordAdapter<T> extends Adapter<T, Object[]> {
        ...
        /* renamed from: e, reason: collision with root package name */
        static final Map f17604e = j();

        /* renamed from: b, reason: collision with root package name */
        private final Constructor f17605b;

        /* renamed from: c, reason: collision with root package name */
        private final Object[] f17606c;

        /* renamed from: d, reason: collision with root package name */
        private final Map f17607d;

        RecordAdapter(Class cls, Map map, boolean z8) {
            super(map);
            this.f17607d = new HashMap();
            ...
            for (int i9 = 0; i9 < j8.length; i9++) {
                this.f17607d.put(j8[i9], Integer.valueOf(i9));
            }
            Class<?>[] parameterTypes = this.f17605b.getParameterTypes();
            this.f17606c = new Object[parameterTypes.length];
            for (int i10 = 0; i10 < parameterTypes.length; i10++) {
                this.f17606c[i10] = f17604e.get(parameterTypes[i10]);
            }
        }
        ...
        public Object[] e() {
            return (Object[]) this.f17606c.clone();
        }
        ...
        public Object f(Object[] objArr) {
            try {
                return this.f17605b.newInstance(objArr);
            } catch (IllegalAccessException e8) {
                throw AbstractC3525a.e(e8);
            } catch (IllegalArgumentException e9) {
                e = e9;
                throw new RuntimeException("Failed to invoke constructor '" + AbstractC3525a.c(this.f17605b) + "' with args " + Arrays.toString(objArr), e);
            } catch (InstantiationException e10) {
                e = e10;
                throw new RuntimeException("Failed to invoke constructor '" + AbstractC3525a.c(this.f17605b) + "' with args " + Arrays.toString(objArr), e);
            } catch (InvocationTargetException e11) {
                throw new RuntimeException("Failed to invoke constructor '" + AbstractC3525a.c(this.f17605b) + "' with args " + Arrays.toString(objArr), e11.getCause());
            }
        }
        ...
        public void g(Object[] objArr, C3596a c3596a, b bVar) {
            Integer num = (Integer) this.f17607d.get(bVar.f17619c);
            if (num != null) {
                bVar.a(c3596a, num.intValue(), objArr);
                return;
            }
            throw new IllegalStateException("Could not find the index in the constructor '" + AbstractC3525a.c(this.f17605b) + "' for field with name '" + bVar.f17619c + "', unable to determine which argument in the constructor the field corresponds to. This is unexpected behavior, as we expect the RecordComponents to have the same names as the fields in the Java class, and that the order of the RecordComponents is the same as the order of the canonical constructor parameters.");
        }
    }
    ...
    public class a extends b {
        ...
        final /* synthetic */ boolean f17608f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Method f17609g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ boolean f17610h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ TypeAdapter f17611i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Gson f17612j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ TypeToken f17613k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ boolean f17614l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ boolean f17615m;
        ...
        a(String str, Field field, boolean z8, boolean z9, boolean z10, Method method, boolean z11, TypeAdapter typeAdapter, Gson gson, TypeToken typeToken, boolean z12, boolean z13) {
            ...
            this.f17609g = method;
            this.f17610h = z11;
            this.f17611i = typeAdapter;
            this.f17612j = gson;
            this.f17613k = typeToken;
            this.f17614l = z12;
            this.f17615m = z13;
        }
        ...
        void a(C3596a c3596a, int i8, Object[] objArr) {
            Object b8 = this.f17611i.b(c3596a);
            if (b8 == null && this.f17614l) {
                throw new j("null is not allowed as value for record component '" + this.f17619c + "' of primitive type; at path " + c3596a.getPath());
            }
            objArr[i8] = b8;
        }
        ...
        void b(C3596a c3596a, Object obj) {
            ...
            if (b8 != null || !this.f17614l) {
                if (this.f17608f) {
                    ReflectiveTypeAdapterFactory.c(obj, this.f17618b);
                } else if (this.f17615m) {
                    throw new g("Cannot set value of 'static final' " + AbstractC3525a.g(this.f17618b, false));
                }
                this.f17618b.set(obj, b8);
            }
        }
        ...
        void c(p1.c cVar, Object obj) {
            ...
            Method method2 = this.f17609g;
            if (method2 != null) {
                try {
                    obj2 = method2.invoke(obj, null);
                } catch (InvocationTargetException e8) {
                    throw new g("Accessor " + AbstractC3525a.g(this.f17609g, false) + " threw exception", e8.getCause());
                }
            } else {
                obj2 = this.f17618b.get(obj);
            }
            if (obj2 == obj) {
                return;
            }
            cVar.u(this.f17617a);
            if (this.f17610h) {
                typeAdapterRuntimeTypeWrapper = this.f17611i;
            } else {
                typeAdapterRuntimeTypeWrapper = new TypeAdapterRuntimeTypeWrapper(this.f17612j, this.f17611i, this.f17613k.d());
            }
    ...
    public static abstract class b {
        ...
        /* renamed from: c, reason: collision with root package name */
        final String f17619c;

        /* renamed from: d, reason: collision with root package name */
        final boolean f17620d;

        /* renamed from: e, reason: collision with root package name */
        final boolean f17621e;

        protected b(String str, Field field, boolean z8, boolean z9) {
            this.f17617a = str;
            this.f17618b = field;
            this.f17619c = field.getName();
            this.f17620d = z8;
            this.f17621e = z9;
        }
    ...
    public ReflectiveTypeAdapterFactory(c cVar, com.google.gson.c cVar2, Excluder excluder, JsonAdapterAnnotationTypeAdapterFactory jsonAdapterAnnotationTypeAdapterFactory, List list) {
        this.f17597a = cVar;
        this.f17598b = cVar2;
        this.f17599c = excluder;
        this.f17600d = jsonAdapterAnnotationTypeAdapterFactory;
        this.f17601e = list;
    }
    ...
    private b d(Gson gson, Field field, Method method, String str, TypeToken typeToken, boolean z8, boolean z9, boolean z10) {
        ...
        if (bVar != null) {
            typeAdapter = this.f17600d.b(this.f17597a, gson, typeToken, bVar);
        } else {
            typeAdapter = null;
        }
        if (typeAdapter != null) {
    ...
    private Map e(Gson gson, TypeToken typeToken, Class cls, boolean z8, boolean z9) {
        ...
        while (cls2 != Object.class) {
            ...
            if (cls2 != cls && declaredFields.length > 0) {
                o b8 = k.b(reflectiveTypeAdapterFactory.f17601e, cls2);
                if (b8 != o.BLOCK_ALL) {
            ...
            while (i10 < length) {
                ...
                if (!g8 && !g9) {
                    ...
                    i9 = length;
                    if (bVar4 != null) {
                        throw new IllegalArgumentException("Class " + cls.getName() + " declares multiple JSON fields named '" + bVar4.f17617a + "'; conflict is caused by fields " + AbstractC3525a.f(bVar4.f17618b) + " and " + AbstractC3525a.f(field3));
                    }
                }
                i10 = i8 + 1;
                length = i9;
    ...
    private List f(Field field) {
        ...
        if (cVar == null) {
            return Collections.singletonList(this.f17598b.a(field));
        }
    ...
    private boolean g(Field field, boolean z8) {
        if (!this.f17599c.c(field.getType(), z8) && !this.f17599c.f(field, z8)) {
            return true;
        }
        return false;
    }
    ...
    public TypeAdapter a(Gson gson, TypeToken typeToken) {
        ...
        if (b8 != o.BLOCK_ALL) {
            ...
            return new FieldReflectionAdapter(this.f17597a.b(typeToken), e(gson, typeToken, c8, z8, false));
        }
