...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter {
    ...
    private final List f17578b;

    /* loaded from: classes3.dex */
    public static abstract class a {

        /* renamed from: b, reason: collision with root package name */
        public static final a f17579b = new C0383a(Date.class);
    ...
    public Date b(C3596a c3596a) {
        ...
        return this.f17577a.a(e(c3596a));
    }
    ...
    public void d(c cVar, Date date) {
        ...
        DateFormat dateFormat = (DateFormat) this.f17578b.get(0);
        synchronized (this.f17578b) {
