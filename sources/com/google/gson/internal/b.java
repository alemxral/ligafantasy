...
public abstract class b {
    ...
    static final Type[] f17562a = new Type[0];
    ...
    public static final class a implements GenericArrayType, Serializable {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Type f17563a;

        public a(Type type) {
            Objects.requireNonNull(type);
            this.f17563a = b.b(type);
        }
    ...
    public static final class C0382b implements ParameterizedType, Serializable {
        ...
        private final Type f17565b;

        /* renamed from: c, reason: collision with root package name */
        private final Type[] f17566c;
        ...
        public C0382b(Type type, Type type2, Type... typeArr) {
            ...
            this.f17564a = b8;
            this.f17565b = b.b(type2);
            Type[] typeArr2 = (Type[]) typeArr.clone();
            this.f17566c = typeArr2;
            int length = typeArr2.length;
            for (int i8 = 0; i8 < length; i8++) {
                Objects.requireNonNull(this.f17566c[i8]);
                b.c(this.f17566c[i8]);
                Type[] typeArr3 = this.f17566c;
        ...
        public Type[] getActualTypeArguments() {
            return (Type[]) this.f17566c.clone();
        }
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.f17566c) ^ this.f17565b.hashCode()) ^ a(this.f17564a);
        }

        public String toString() {
            int length = this.f17566c.length;
            if (length == 0) {
                return b.t(this.f17565b);
            }
            StringBuilder sb = new StringBuilder((length + 1) * 30);
            sb.append(b.t(this.f17565b));
            sb.append("<");
            sb.append(b.t(this.f17566c[0]));
            for (int i8 = 1; i8 < length; i8++) {
                sb.append(", ");
                sb.append(b.t(this.f17566c[i8]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class c implements WildcardType, Serializable {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Type f17567a;

        /* renamed from: b, reason: collision with root package name */
        private final Type f17568b;
        ...
        public c(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length == 1) {
                ...
                this.f17568b = b.b(typeArr2[0]);
                this.f17567a = Object.class;
                return;
            }
            Objects.requireNonNull(typeArr[0]);
            b.c(typeArr[0]);
            this.f17568b = null;
            this.f17567a = b.b(typeArr[0]);
        }
        ...
        public int hashCode() {
            ...
            return i8 ^ (this.f17567a.hashCode() + 31);
        }

        public String toString() {
            if (this.f17568b != null) {
                return "? super " + b.t(this.f17568b);
            }
            if (this.f17567a == Object.class) {
                return "?";
            }
            return "? extends " + b.t(this.f17567a);
        }
    }
