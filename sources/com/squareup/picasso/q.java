...
public class q extends x {
    ...
    private final InterfaceC2775c f23295a;

    /* renamed from: b, reason: collision with root package name */
    private final z f23296b;
    ...
    private static F6.x j(v vVar, int i8) {
        ...
        x.a h8 = new x.a().h(vVar.f23354d.toString());
        if (dVar != null) {
            h8.b(dVar);
        }
        return h8.a();
    ...
    public boolean c(v vVar) {
        String scheme = vVar.f23354d.getScheme();
    ...
    public x.a f(v vVar, int i8) {
        s.e eVar;
        F6.z a8 = this.f23295a.a(j(vVar, i8));
        F6.A a9 = a8.a();
        if (a8.o()) {
            if (a8.e() == null) {
                eVar = s.e.NETWORK;
