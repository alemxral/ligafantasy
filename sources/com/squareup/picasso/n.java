...
public class n extends e {
    ...
    private static final String[] f23278b = {"orientation"};
    ...
    */
    static int k(android.content.ContentResolver r8, android.net.Uri r9) {
        /*
            r0 = 0
            r1 = 0
            java.lang.String[] r4 = com.squareup.picasso.n.f23278b     // Catch: java.lang.Throwable -> L1e java.lang.RuntimeException -> L20
            r6 = 0
            r7 = 0
            r5 = 0
            r2 = r8
    ...
    static a l(int i8, int i9) {
        a aVar = a.MICRO;
        if (i8 <= aVar.f23284b && i9 <= aVar.f23285c) {
            return aVar;
        }
        a aVar2 = a.MINI;
        if (i8 <= aVar2.f23284b && i9 <= aVar2.f23285c) {
            return aVar2;
        }
        return a.FULL;
    }
    ...
    public x.a f(v vVar, int i8) {
        ...
        Bitmap thumbnail;
        int i9;
        ContentResolver contentResolver = this.f23240a.getContentResolver();
        int k8 = k(contentResolver, vVar.f23354d);
        String type = contentResolver.getType(vVar.f23354d);
        ...
        if (vVar.c()) {
            a l8 = l(vVar.f23358h, vVar.f23359i);
            if (!z8 && l8 == a.FULL) {
                return new x.a(null, L.l(j(vVar)), s.e.DISK, k8);
            }
            long parseId = ContentUris.parseId(vVar.f23354d);
            BitmapFactory.Options d8 = x.d(vVar);
            d8.inJustDecodeBounds = true;
            x.a(vVar.f23358h, vVar.f23359i, l8.f23284b, l8.f23285c, d8, vVar);
            if (z8) {
                if (l8 == a.FULL) {
                    i9 = 1;
                } else {
                ...
                thumbnail = MediaStore.Images.Thumbnails.getThumbnail(contentResolver, parseId, l8.f23283a, d8);
            }
            if (thumbnail != null) {
