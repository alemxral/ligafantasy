...
public class k extends AbstractC2403a {
    ...
    public void b(Bitmap bitmap, s.e eVar) {
        if (bitmap != null) {
            ImageView imageView = (ImageView) this.f23195c.get();
            if (imageView == null) {
                return;
            }
            s sVar = this.f23193a;
            t.c(imageView, sVar.f23307d, bitmap, eVar, this.f23196d, sVar.f23315l);
            InterfaceC2774b interfaceC2774b = this.f23266m;
    ...
    public void c(Exception exc) {
        ...
        if (i8 != 0) {
            ...
            Drawable drawable2 = this.f23200h;
            if (drawable2 != null) {
