...
public class MBAlertDialog extends Dialog {
    ...
    private Button f23159a;

    /* renamed from: b, reason: collision with root package name */
    private Button f23160b;
    ...
    public MBAlertDialog(Context context, final a aVar) {
        ...
        if (inflate != null) {
            ...
            try {
                this.f23163e = (TextView) inflate.findViewById(v.a(context, "mbridge_video_common_alertview_titleview", "id"));
            } catch (Exception e8) {
                ad.a("MBAlertDialog", e8.getMessage());
            }
            try {
                this.f23161c = (TextView) inflate.findViewById(v.a(context, "mbridge_video_common_alertview_contentview", "id"));
                this.f23160b = (Button) inflate.findViewById(v.a(context, "mbridge_video_common_alertview_confirm_button", "id"));
                this.f23159a = (Button) inflate.findViewById(v.a(context, "mbridge_video_common_alertview_cancel_button", "id"));
            } catch (Exception e9) {
                ad.a("MBAlertDialog", e9.getMessage());
            }
        }
        Button button = this.f23159a;
        if (button != null) {
    ...
    public void setContent(String str) {
        TextView textView = this.f23161c;
        if (textView != null) {
