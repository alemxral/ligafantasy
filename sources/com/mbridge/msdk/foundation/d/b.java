...
public final class b {
    ...
    public static int f19149a = -2;

    /* renamed from: b, reason: collision with root package name */
    public static int f19150b = -2;

    /* renamed from: c, reason: collision with root package name */
    public static volatile boolean f19151c = false;

    /* renamed from: d, reason: collision with root package name */
    private final RelativeLayout.LayoutParams f19152d;

    /* renamed from: e, reason: collision with root package name */
    private final ConcurrentHashMap<String, com.mbridge.msdk.foundation.d.a.a> f19153e;
    ...
    public static class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final b f19155a = new b();
    }
    ...
    private com.mbridge.msdk.foundation.d.a.a d(String str) {
        ...
        if (this.f19153e.containsKey(str)) {
            return this.f19153e.get(str);
        }
        return null;
    }
    ...
    private b() {
        this.f19152d = new RelativeLayout.LayoutParams(f19150b, f19149a);
        this.f19153e = new ConcurrentHashMap<>();
    }
        ...
        if (b()) {
            ...
            if (d8 != null) {
                if (layoutParams == null) {
                    ...
                    this.f19152d.setMargins(a9, a9, a9, a9);
                    layoutParams = this.f19152d;
                }
    ...
    public final Activity a(Context context) {
        ...
        try {
            ...
            try {
                ...
                if (a8 != null && (activity = a8.get()) != null && !activity.isFinishing() && !activity.isDestroyed()) {
                    activity3 = activity;
                }
