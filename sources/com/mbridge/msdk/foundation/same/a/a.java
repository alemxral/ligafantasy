...
public final class a implements c<String, Bitmap> {
    ...
    private final LinkedHashMap<String, Bitmap> f19426a;
    ...
    public a(int i8) {
        if (i8 > 0) {
            this.f19427b = i8;
            this.f19426a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public final /* synthetic */ void a(String str) {
        ...
        if (str2 != null) {
            synchronized (this) {
                try {
                    Bitmap remove = this.f19426a.remove(str2);
                    if (remove != null) {
                        this.f19428c -= b(str2, remove);
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public final synchronized String toString() {
        return String.format("LruCache[maxSize=%d]", Integer.valueOf(this.f19427b));
    }
    ...
    public boolean a(String str, Bitmap bitmap) {
        if (str != null && bitmap != null) {
            synchronized (this) {
                try {
                    this.f19428c += b(str, bitmap);
                    Bitmap put = this.f19426a.put(str, bitmap);
                    if (put != null) {
                        this.f19428c -= b(str, put);
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public Bitmap b(String str) {
        if (str != null) {
            synchronized (this) {
                try {
                    Bitmap bitmap = this.f19426a.get(str);
    ...
    */
    private void a(int r4) {
        ...
        L0:
            monitor-enter(r3)
            int r0 = r3.f19428c     // Catch: java.lang.Throwable -> L12
            if (r0 < 0) goto L59
            java.util.LinkedHashMap<java.lang.String, android.graphics.Bitmap> r0 = r3.f19426a     // Catch: java.lang.Throwable -> L12
        ...
        L35:
            ...
            java.util.LinkedHashMap<java.lang.String, android.graphics.Bitmap> r2 = r3.f19426a     // Catch: java.lang.Throwable -> L55
            ...
            int r1 = r3.f19428c     // Catch: java.lang.Throwable -> L55
            int r1 = r1 - r0
            r3.f19428c = r1     // Catch: java.lang.Throwable -> L55
        L55:
            monitor-exit(r3)     // Catch: java.lang.Throwable -> L12
            goto L0
        L57:
