...
public final class b implements c<String, JSONObject> {
    ...
    private final LinkedHashMap<String, JSONObject> f19429a;
    ...
    public b(int i8) {
        if (i8 > 0) {
            this.f19430b = i8;
            this.f19429a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public final /* synthetic */ void a(String str) {
        ...
        if (str2 != null) {
            synchronized (this) {
                try {
                    if (this.f19429a.remove(str2) != null) {
                        this.f19431c--;
                    }
                } catch (Throwable th) {
                    throw th;
    ...
    public final synchronized String toString() {
        return String.format("LruCache[maxSize=%d]", Integer.valueOf(this.f19430b));
    }
    ...
    public final boolean a(String str, JSONObject jSONObject) {
        if (str != null && jSONObject != null) {
            synchronized (this) {
                try {
                    this.f19431c++;
                    if (this.f19429a.put(str, jSONObject) != null) {
                        this.f19431c--;
                    }
                } catch (Throwable th) {
                    throw th;
    ...
    public final JSONObject b(String str) {
        ...
        if (str != null) {
            synchronized (this) {
                jSONObject = this.f19429a.get(str);
            }
            return jSONObject;
        }
        throw new NullPointerException("key == null");
    ...
    public final Collection<String> a() {
        HashSet hashSet;
        synchronized (this) {
            hashSet = new HashSet(this.f19429a.keySet());
        }
        return hashSet;
    }
    ...
    */
    private void a(int r3) {
        ...
        L0:
            monitor-enter(r2)
            int r0 = r2.f19431c     // Catch: java.lang.Throwable -> L12
            if (r0 < 0) goto L53
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r0 = r2.f19429a     // Catch: java.lang.Throwable -> L12
        ...
        L35:
            ...
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r0 = r2.f19429a     // Catch: java.lang.Throwable -> L4f
            ...
            int r0 = r2.f19431c     // Catch: java.lang.Throwable -> L4f
            int r0 = r0 + (-1)
            r2.f19431c = r0     // Catch: java.lang.Throwable -> L4f
        L4f:
            monitor-exit(r2)     // Catch: java.lang.Throwable -> L12
            goto L0
        L51:
