...
public final class a implements b {
    ...
    private BlockingQueue<com.mbridge.msdk.foundation.same.net.a.b> f19768a = new ArrayBlockingQueue(2, true);

    /* renamed from: b, reason: collision with root package name */
    private CronetEngine f19769b;

    public a() {
        ad.b("CronetStack", "Cronet stack init.");
        this.f19769b = com.mbridge.msdk.foundation.same.net.a.a.a().c();
    }
    ...
    public final com.mbridge.msdk.foundation.same.net.f.b performRequest(i<?> iVar) throws IOException {
        ...
        UrlRequest.Builder newUrlRequestBuilder = this.f19769b.newUrlRequestBuilder(iVar.s(), new com.mbridge.msdk.foundation.same.net.a.c(this.f19768a), com.mbridge.msdk.foundation.same.net.a.a.a().b());
        int b8 = iVar.b();
        if (b8 != 1) {
            i8 = 4;
            if (b8 != 3 && b8 != 4) {
        ...
        try {
            BlockingQueue<com.mbridge.msdk.foundation.same.net.a.b> blockingQueue = this.f19768a;
            long j8 = p8;
        ...
        if (poll != null) {
            if (poll.c() == 0) {
                poll = this.f19768a.poll(m8, timeUnit);
            }
            if (poll.c() == 1) {
                bVar = poll.b();
            }
