        ...
        public void callEnd(Call call) {
            ...
            if (this.isReportHttpStatus && this.httpStatus != null) {
                try {
                    ...
                    bVar.f19788k = 0;
                    bVar.f19787j = this.method;
                    bVar.f19778a = currentTimeMillis;
                    bVar.f19786i = this.hostName;
                    bVar.f19783f = this.dnsDuring;
                    bVar.f19784g = this.dnsResult;
                    bVar.f19780c = this.connectDuring;
                    bVar.f19782e = this.connectionDuring;
            ...
            if (this.isReportHttpStatus && this.httpStatus != null) {
                try {
                    ...
                    if (!TextUtils.isEmpty(this.connectErrorMessage)) {
                        c.b bVar = this.httpStatus;
                        bVar.f19788k = 1;
                        bVar.f19781d = this.connectErrorMessage;
                    } else {
                        this.httpStatus.f19788k = 2;
                    }
                    ...
                    bVar3.f19778a = this.callDuring;
                    bVar3.f19786i = this.hostName;
                    bVar3.f19787j = this.method;
                    bVar3.f19783f = this.dnsDuring;
                    bVar3.f19784g = this.dnsResult;
                    bVar3.f19780c = this.connectDuring;
                    bVar3.f19782e = this.connectionDuring;
                    c.a().a(this.httpStatus);
                } catch (Exception e8) {
                    ad.b("OkHttpStack", e8.getMessage());
                }
