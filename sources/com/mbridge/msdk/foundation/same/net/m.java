...
public final class m {
    ...
    private static volatile AtomicInteger f19749a = new AtomicInteger(1);

    /* renamed from: b, reason: collision with root package name */
    private ExecutorService f19750b;
    ...
    public static final class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static m f19763a = new m();
    }
    ...
    private m() {
        this.f19750b = new ThreadPoolExecutor(5, 10, 5L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue(), new ThreadFactory() { // from class: com.mbridge.msdk.foundation.same.net.m.1
    ...
    public final void a(String str, int i8, String str2, boolean z8, e eVar) {
        ...
        this.f19750b.execute(new Runnable() { // from class: com.mbridge.msdk.foundation.same.net.m.2
    ...
    public class a {
        ...
        private OutputStream f19759f;

        /* renamed from: g, reason: collision with root package name */
        private int f19760g;

        /* renamed from: h, reason: collision with root package name */
        private Socket f19761h;
        ...
        */
        ...
        private void a(String str) {
            if (this.f19758e != null) {
                ...
                this.f19758e.onError(new com.mbridge.msdk.foundation.same.net.b.a(13, new com.mbridge.msdk.foundation.same.net.f.c(MBridgeCommon.CampaignState.STATE_LOAD_FAILED_RESOURCE_DOWNLOAD_ERROR, str.getBytes(), null)));
            }
        }
    }
}
