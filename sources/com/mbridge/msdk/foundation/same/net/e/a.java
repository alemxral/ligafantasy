...
public class a extends i<Void> {
    ...
    private static final String f19616c = "a";

    /* renamed from: d, reason: collision with root package name */
    private File f19617d;

    /* renamed from: e, reason: collision with root package name */
    private File f19618e;

    public a(File file, String str) {
        super(0, str);
        this.f19617d = file;
        this.f19618e = new File(file + ".tmp");
    }
    ...
    */
    public final byte[] a(com.mbridge.msdk.foundation.same.net.f.b r17, com.mbridge.msdk.foundation.same.net.c r18) throws java.io.IOException {
        ...
        L21:
            ...
            if (r0 > 0) goto L2c
            java.lang.String r1 = com.mbridge.msdk.foundation.same.net.e.a.f19616c
            java.lang.String r4 = "Response doesn't present Content-Length!"
            com.mbridge.msdk.foundation.tools.ad.c(r1, r4)
        L2c:
            r11 = 0
            if (r0 <= 0) goto L4a
            java.io.File r0 = r7.f19617d
            long r0 = r0.length()
            int r4 = (r0 > r9 ? 1 : (r0 == r9 ? 0 : -1))
            if (r4 != 0) goto L4a
            java.io.File r0 = r7.f19617d
            java.io.File r1 = r7.f19618e
            r0.renameTo(r1)
            r1 = r18
            r2 = r16
            r3 = r9
        ...
        La5:
            ...
            goto Lae
        La9:
            java.lang.String r0 = com.mbridge.msdk.foundation.same.net.e.a.f19616c
    ...
    public final k<Void> a(com.mbridge.msdk.foundation.same.net.f.c cVar) {
        if (!q()) {
            if (this.f19618e.canRead() && this.f19618e.length() > 0) {
                if (this.f19618e.renameTo(this.f19617d)) {
                    return k.a(null, cVar);
                }
                ad.c(f19616c, "Can't rename the download temporary file!");
                return k.a(new com.mbridge.msdk.foundation.same.net.b.a(4, cVar));
            }
            ad.c(f19616c, "Download temporary file was invalid!");
            return k.a(new com.mbridge.msdk.foundation.same.net.b.a(4, cVar));
        }
