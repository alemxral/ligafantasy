...
public class c extends e<JSONArray> {
    ...
    private static final String f19630c = "c";
    ...
    public final k<JSONArray> a(com.mbridge.msdk.foundation.same.net.f.c cVar) {
        try {
            return k.a(new JSONArray(new String(cVar.f19642a, com.mbridge.msdk.foundation.same.net.g.b.a(cVar.f19643b))), cVar);
        } catch (UnsupportedEncodingException e8) {
            ad.b(f19630c, e8.getMessage());
            return k.a(new com.mbridge.msdk.foundation.same.net.b.a(8, cVar));
        } catch (JSONException e9) {
            ad.b(f19630c, e9.getMessage());
            return k.a(new com.mbridge.msdk.foundation.same.net.b.a(8, cVar));
        }
    }
}
