...
public class f<T> implements e<T> {
    ...
    public void onSuccess(k<T> kVar) {
        try {
            ...
            ad.b("Listener", kVar.f19748c + " " + str);
            T t8 = kVar.f19748c;
            if (t8 instanceof JSONObject) {
                com.mbridge.msdk.foundation.same.net.g.c.a().a(str, ((JSONObject) t8).optInt(NotificationCompat.CATEGORY_STATUS), ((JSONObject) kVar.f19748c).toString(), System.currentTimeMillis());
            }
            if (kVar.f19748c instanceof String) {
                com.mbridge.msdk.foundation.same.net.g.c.a().a(str, new JSONObject((String) kVar.f19748c).optInt(NotificationCompat.CATEGORY_STATUS), (String) kVar.f19748c, System.currentTimeMillis());
            }
        } catch (Exception e8) {
