...
public final class f {
    public static void a(e eVar) {
        eVar.a("api_version", com.mbridge.msdk.foundation.same.a.f19403d);
    }
    ...
    public static void b(e eVar) {
        try {
            ...
            if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19397U)) {
                eVar.a(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, com.mbridge.msdk.foundation.same.a.f19397U);
            }
            ...
            if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19406g)) {
                eVar.a("c", com.mbridge.msdk.foundation.same.a.f19406g);
            }
        } catch (Exception e8) {
    ...
    public static void c(e eVar) {
        eVar.a("dyview_type", com.mbridge.msdk.foundation.same.a.f19422w);
    }
    ...
    private static void i(e eVar) {
        String str = com.mbridge.msdk.f.c.f18980a;
    ...
    public static void a(e eVar, Context context) {
        if (com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().c(MBridgeConstans.AUTHORITY_GENERAL_DATA)) {
            ...
            eVar.a(e.f19715c, com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().f() + "");
            eVar.a("adid_limit", com.mbridge.msdk.foundation.tools.e.a() + "");
        ...
        if (com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().c(MBridgeConstans.AUTHORITY_OTHER)) {
            eVar.a(e.f19713a, ag.b() + "");
            eVar.a(e.f19714b, ag.a() + "");
            eVar.a(e.f19719g, z.n());
        }
