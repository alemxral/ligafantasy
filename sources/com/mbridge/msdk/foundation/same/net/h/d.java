...
public abstract class d extends com.mbridge.msdk.foundation.same.net.f<JSONObject> {
    ...
    private static final String f19712a = "d";
    ...
    private void a(k<JSONObject> kVar) {
        ...
        if (optInt != 1 && optInt != 200) {
            String optString = kVar.f19748c.optString(NotificationCompat.CATEGORY_MESSAGE);
        ...
        a(kVar.f19748c.optJSONObject(DataSchemeDataSource.SCHEME_DATA));
    }
    ...
    public void onError(com.mbridge.msdk.foundation.same.net.b.a aVar) {
        ad.b(f19712a, "errorCode = " + aVar.f19588a);
    ...
    public void onSuccess(k<JSONObject> kVar) {
        ...
        com.mbridge.msdk.foundation.same.net.f.c cVar = kVar.f19747b;
        if (cVar == null) {
            a(kVar);
        } else if (cVar.f19645d == 204) {
            a(new JSONObject());
        } else {
            a(kVar);
        }
