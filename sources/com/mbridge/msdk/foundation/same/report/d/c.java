...
public class c {
    ...
    private static c f19855a;

    /* renamed from: b, reason: collision with root package name */
    private volatile m f19856b;

    /* renamed from: c, reason: collision with root package name */
    private Map<String, d> f19857c = new HashMap();

    /* renamed from: d, reason: collision with root package name */
    private LinkedHashMap<String, b> f19858d = new LinkedHashMap<>();

    /* renamed from: e, reason: collision with root package name */
    private Map<String, d> f19859e = new HashMap();

    private c() {
        if (this.f19856b == null) {
            this.f19856b = m.a("metrics_sdk", com.mbridge.msdk.foundation.controller.c.m().c(), c());
        }
    ...
    private w c() {
        ...
        try {
            ...
            if (a13 == 1) {
                oVar = new o(new n((byte) 2), com.mbridge.msdk.foundation.same.net.g.d.f().f19689i, com.mbridge.msdk.foundation.same.net.g.d.f().f19693m);
            } else {
    ...
    public final void b(String str, d dVar) {
        try {
            ...
            bVar.a(str, dVar);
            new e().b(str, this.f19856b, bVar, null);
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                e8.printStackTrace();
            }
    ...
    public final d a(String str) {
        ...
        d dVar = new d();
        try {
            return (TextUtils.isEmpty(str) || (map = this.f19857c) == null || !map.containsKey(str)) ? dVar : this.f19857c.get(str);
        } catch (Exception e8) {
            if (!MBridgeConstans.DEBUG) {
                return dVar;
            }
    ...
    private void b(String str, b bVar, com.mbridge.msdk.foundation.same.report.d.a.a aVar) {
        try {
            if (Arrays.asList(a.f19821c).contains(str)) {
                bVar.m(str);
            }
            Map<String, d> map = this.f19859e;
            if (map != null && map.containsKey(str)) {
                bVar.a(str, this.f19859e.get(str));
            }
            new e().a(str, this.f19856b, bVar, aVar);
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                e8.printStackTrace();
            }
    ...
    public final b b(String str) {
        ...
        try {
            if (!TextUtils.isEmpty(str) && (linkedHashMap = this.f19858d) != null && linkedHashMap.containsKey(str)) {
    ...
    public final void a(String str, CampaignEx campaignEx, d dVar) {
        ...
        if (bVar != null) {
            if (Arrays.asList(a.f19826h).contains(str)) {
                bVar = b(bVar);
            }
        } else {
            bVar = new b();
    ...
    public final void a(String str, b bVar) {
        try {
            ...
            new e().a(str, this.f19856b, bVar, null);
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                e8.printStackTrace();
            }
