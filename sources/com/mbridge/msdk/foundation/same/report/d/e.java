...
public final class e {
    ...
    private Map<String, String> d(String str, b bVar) {
        ...
        try {
            if (Arrays.asList(a.f19823e).contains(str)) {
                String str2 = "";
                if (bVar != null) {
                    str2 = bVar.d();
                }
    ...
    public final void a(String str, m mVar, b bVar, com.mbridge.msdk.foundation.same.report.d.a.a aVar) {
        ...
        try {
            ...
            if (Arrays.asList(a.f19822d).contains(str) && (c8 = c(str, bVar)) != null) {
                hashMap.putAll(c8);
            }
            ...
            if (bVar.d() != null && bVar.d().equals("1") && Arrays.asList(a.f19820b).contains(str)) {
                return;
            }
            if (MBridgeConstans.DEBUG) {
