...
public final class m {
    ...
    private final Map<String, String> f19917a;
    ...
    public static class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Map<String, String> f19919a = new HashMap();
    ...
    public final void a(String str) {
        ...
        if (eVar != null) {
            try {
                new com.mbridge.msdk.foundation.same.report.e.a(com.mbridge.msdk.foundation.controller.c.m().c()).post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, eVar, new b());
            } catch (Exception e10) {
                if (MBridgeConstans.DEBUG) {
    ...
    private m(a aVar) {
        this.f19918b = aVar.f19920b;
        this.f19917a = aVar.f19919a;
    }
