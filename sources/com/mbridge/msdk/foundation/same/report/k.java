...
public class k extends b {
    ...
    public static final String f19912a = "k";
    ...
    public static void b(Context context, String str) {
        ...
        try {
            new com.mbridge.msdk.foundation.same.report.e.a(context).post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, a(str, context), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.k.3
    ...
    private static void d(final Context context, final String str) {
        if (context != null && !TextUtils.isEmpty(str)) {
            try {
                new com.mbridge.msdk.foundation.same.report.e.a(context).post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, a(str, context), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.k.2
                    @Override // com.mbridge.msdk.foundation.same.report.e.b
                    public final void onFailed(String str2) {
                        ...
                        lVar.c(com.mbridge.msdk.foundation.same.net.g.d.f().f19683c);
    ...
    public static void b(String str) {
        try {
            ...
            aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, a(sb.toString(), com.mbridge.msdk.foundation.controller.c.m().c(), ""), null);
        } catch (Exception e8) {
            ad.b(f19912a, e8.getMessage());
        }
    }
            ...
            com.mbridge.msdk.foundation.same.f.b.g().execute(new Runnable() { // from class: com.mbridge.msdk.foundation.same.report.k.5
                ...
                public final void run() {
                    ...
                    try {
                        ...
                        ad.b(k.f19912a, th.getMessage());
                    }
                }
            });
        } catch (Throwable th) {
            ad.b(f19912a, th.getMessage());
        }
    }
    ...
    public static com.mbridge.msdk.foundation.same.net.h.e a(String str, String str2, Context context, String str3) {
        ...
        try {
            if (!TextUtils.isEmpty(str2)) {
                ...
                String str4 = com.mbridge.msdk.foundation.controller.a.f19040b.get(str3);
                ...
                String str5 = com.mbridge.msdk.foundation.controller.a.f19040b.get(str3);
    ...
    private static void a(final Context context, final String str, String str2) {
        ...
        try {
            new com.mbridge.msdk.foundation.same.report.e.a(context).post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, a(str, context, str2), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.k.1
                @Override // com.mbridge.msdk.foundation.same.report.e.b
    ...
    public static com.mbridge.msdk.foundation.same.net.h.e a(String str, Context context, String str2) {
        ...
        try {
            if (!TextUtils.isEmpty(str2)) {
                String str3 = com.mbridge.msdk.foundation.controller.a.f19040b.get(str2);
                if (!TextUtils.isEmpty(str)) {
    ...
    public static void a(Context context, String str, String str2, boolean z8, String str3, String str4, String str5, String str6) {
        if (context != null) {
            try {
                ...
                if (!TextUtils.isEmpty(str2)) {
                    String str7 = com.mbridge.msdk.foundation.controller.a.f19040b.get(str2);
                    StringBuilder sb = new StringBuilder();
                    sb.append("u_stid=");
                    if (str7 == null) {
                        str7 = "";
    ...
    public static void a(String str) {
        try {
            ...
            if (b8 == null || b.a(b8, str2)) {
                aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, a(str2, com.mbridge.msdk.foundation.controller.c.m().c(), ""), null);
            }
        } catch (Throwable th) {
            ad.b(f19912a, th.getMessage());
        }
    ...
    public static void a(int i8, String str, String str2) {
        try {
            new com.mbridge.msdk.foundation.same.report.e.a(com.mbridge.msdk.foundation.controller.c.m().c()).post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, a("key=2000080&reason=" + str2 + "&ad_type=" + i8 + "&url=" + URLEncoder.encode(str, "utf-8"), com.mbridge.msdk.foundation.controller.c.m().c(), ""), null);
        } catch (Exception e8) {
            ad.b(f19912a, e8.getMessage());
        }
    }
    ...
    public static void a(CampaignEx campaignEx, String str, int i8, int i9, String str2) {
        try {
            ...
            if (e.a().b()) {
                ...
                aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, a(sb.toString(), com.mbridge.msdk.foundation.controller.c.m().c(), str), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.k.4
                    @Override // com.mbridge.msdk.foundation.same.report.e.b
                    public final void onFailed(String str3) {
                    }
