...
public class d implements Thread.UncaughtExceptionHandler {
    ...
    private static volatile d f19810b;

    /* renamed from: a, reason: collision with root package name */
    Handler f19811a = new Handler() { // from class: com.mbridge.msdk.foundation.same.report.b.d.1
        @Override // android.os.Handler
        public final void handleMessage(Message message) {
            Context context;
            HashMap hashMap;
            super.handleMessage(message);
            if (message.what != 101 || (context = (Context) d.this.f19812c.get()) == null) {
                return;
            }
    ...
    private final WeakReference<Context> f19812c;

    /* renamed from: d, reason: collision with root package name */
    private Throwable f19813d;

    /* renamed from: e, reason: collision with root package name */
    private Thread.UncaughtExceptionHandler f19814e;
    ...
    private HashMap<String, Object> c() {
        ...
        try {
            ...
            printWriter.println(a(this.f19813d, format));
            printWriter.println("====");
            this.f19813d.printStackTrace(printWriter);
            printWriter.close();
    ...
    public final JSONObject b(String str) throws JSONException {
        ...
        Context context = this.f19812c.get();
        if (context == null) {
            return null;
        }
    ...
    public final void b() {
        this.f19814e = Thread.getDefaultUncaughtExceptionHandler();
    ...
    private void a(String str, String str2, Throwable th, Thread thread) {
        ...
        Thread.UncaughtExceptionHandler uncaughtExceptionHandler = this.f19814e;
