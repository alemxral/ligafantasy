...
public class i {
    ...
    public static final String f19888a = "i";
    ...
    public final void b(String str, String str2, String str3, String str4, String str5, boolean z8) {
        try {
            if (!TextUtils.isEmpty(str5)) {
                com.mbridge.msdk.foundation.same.report.e.a aVar = new com.mbridge.msdk.foundation.same.report.e.a(this.f19889b);
                ...
                if (e.a().b()) {
                    ...
                    aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, k.a(sb.toString(), this.f19889b, str4), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.i.2
    ...
    public final void a(String str, com.mbridge.msdk.foundation.entity.e eVar, String str2) {
        ...
        if (e.a().b()) {
            ...
            aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, k.a(a8, this.f19889b, str2), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.i.9
                @Override // com.mbridge.msdk.foundation.same.report.e.b
    ...
    public final void a(final String str, String str2, String str3, Frame frame) {
        com.mbridge.msdk.foundation.same.report.e.a aVar = new com.mbridge.msdk.foundation.same.report.e.a(this.f19889b);
        com.mbridge.msdk.foundation.same.net.h.e a8 = k.a(str2, this.f19889b, str3);
        if (frame != null) {
        ...
        aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, a8, new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.i.10
            @Override // com.mbridge.msdk.foundation.same.report.e.b
    ...
    public final void a(int i8, int i9, String str, String str2, String str3) {
        ...
        try {
            ...
            if (!e.a().b()) {
                aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, k.a(sb.toString(), context, ""), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.j.1
                    @Override // com.mbridge.msdk.foundation.same.report.e.b
                    public final void onFailed(String str4) {
                    }
    ...
    public final void a(String str, final File file) {
        new com.mbridge.msdk.foundation.same.report.e.a(this.f19889b).post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, k.a(this.f19889b, str), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.i.11
            @Override // com.mbridge.msdk.foundation.same.report.e.b
    ...
    public final void a(String str, String str2, String str3, String str4, String str5, boolean z8) {
        try {
            ...
            if (e.a().b()) {
                ...
                aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, k.a(sb.toString(), this.f19889b, str4), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.i.1
                    @Override // com.mbridge.msdk.foundation.same.report.e.b
                    public final void onFailed(String str6) {
                    }
    ...
    public final void a(final com.mbridge.msdk.foundation.entity.l lVar, final Boolean bool) {
        if (lVar != null) {
            if (lVar.b().equals(ShareTarget.METHOD_GET)) {
                new com.mbridge.msdk.foundation.same.report.e.a(this.f19889b).get(0, lVar.f(), null, new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.i.3
                    @Override // com.mbridge.msdk.foundation.same.report.e.b
                    ...
                    public final void onSuccess(String str) {
                        com.mbridge.msdk.foundation.same.f.b.g().execute(new Runnable() { // from class: com.mbridge.msdk.foundation.same.report.i.3.1
                            ...
                            public final void run() {
                                try {
                                    if (i.this.f19889b != null) {
                                        AnonymousClass3 anonymousClass3 = AnonymousClass3.this;
                                        if (lVar != null) {
                                            com.mbridge.msdk.foundation.db.n.a(com.mbridge.msdk.foundation.db.h.a(i.this.f19889b)).a(lVar.f());
                                            if (bool.booleanValue() && com.mbridge.msdk.foundation.db.n.a(com.mbridge.msdk.foundation.db.h.a(i.this.f19889b)).b() > 20) {
                                                com.mbridge.msdk.foundation.controller.d.a().b();
                                            }
                                        }
                                    }
                                    ...
                                    if (MBridgeConstans.DEBUG) {
                                        ad.a(i.f19888a, "reportNetError", e8);
                                    }
                                }
                            }
                        });
            ...
            if (lVar.b().equals(ShareTarget.METHOD_POST)) {
                ...
                com.mbridge.msdk.foundation.same.net.h.e a8 = k.a(lVar.a(), this.f19889b, lVar.e());
                if (lVar.d() > 0) {
                    a8.a("retry", lVar.d() + "");
                }
                        ...
                        com.mbridge.msdk.foundation.same.f.b.g().execute(new Runnable() { // from class: com.mbridge.msdk.foundation.same.report.i.4.2
                            ...
                            public final void run() {
                                if (i.this.f19889b != null) {
                                    ...
                                    if (lVar != null) {
                                        com.mbridge.msdk.foundation.db.n.a(com.mbridge.msdk.foundation.db.h.a(i.this.f19889b)).a(lVar);
                                    }
                                }
                            }
                        });
                        ...
                        com.mbridge.msdk.foundation.same.f.b.g().execute(new Runnable() { // from class: com.mbridge.msdk.foundation.same.report.i.4.1
                            ...
                            public final void run() {
                                if (i.this.f19889b != null) {
                                    ...
                                    if (lVar != null) {
                                        try {
                                            com.mbridge.msdk.foundation.db.n.a(com.mbridge.msdk.foundation.db.h.a(i.this.f19889b)).a(lVar.a(), lVar.f(), lVar.c());
                                            if (bool.booleanValue() && com.mbridge.msdk.foundation.db.n.a(com.mbridge.msdk.foundation.db.h.a(i.this.f19889b)).a() > 0) {
                                                com.mbridge.msdk.foundation.controller.d.a().b();
                                            }
                                        } catch (Exception e8) {
                                            if (MBridgeConstans.DEBUG) {
    ...
    public final void a(String str, String str2, String str3, String str4, String str5) {
        try {
            ...
            if (e.a().b()) {
                ...
                aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, k.a(sb.toString(), this.f19889b, str4), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.i.5
                    @Override // com.mbridge.msdk.foundation.same.report.e.b
                    public final void onFailed(String str6) {
                    }
    ...
    public final void a() {
        try {
            if (k.a()) {
                ...
                aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, k.a(str2, this.f19889b, ""), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.i.6
                    @Override // com.mbridge.msdk.foundation.same.report.e.b
                    public final void onFailed(String str3) {
                    }
            ...
            ad.b(f19888a, th.getMessage());
        }
    }

    public final void a(int i8, String str) {
        new com.mbridge.msdk.foundation.same.report.e.a(this.f19889b).post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, k.a(NotificationCompat.CATEGORY_EVENT, k.a((Campaign) null, i8, "request"), this.f19889b, str), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.i.7
            @Override // com.mbridge.msdk.foundation.same.report.e.b
            public final void onFailed(String str2) {
            }
    ...
    public final void a(String str, String str2, String str3) {
        try {
            ...
            if (e.a().b()) {
                ...
                aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, k.a(str4, this.f19889b, str2), new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.foundation.same.report.i.8
                    @Override // com.mbridge.msdk.foundation.same.report.e.b
