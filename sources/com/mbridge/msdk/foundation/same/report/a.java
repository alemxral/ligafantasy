...
public final class a {
    public static JSONObject a() {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19397U)) {
                jSONObject.put(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, com.mbridge.msdk.foundation.same.a.f19397U);
            }
            ...
            if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19406g)) {
                jSONObject.put("c", com.mbridge.msdk.foundation.same.a.f19406g);
            }
            jSONObject.put("open", com.mbridge.msdk.foundation.same.a.f19394R);
            String a8 = Aa.a();
            if (a8 == null) {
                a8 = "";
            }
