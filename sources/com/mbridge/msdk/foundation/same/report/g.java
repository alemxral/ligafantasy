...
public class g {
    ...
    private static volatile g f19883a;

    /* renamed from: b, reason: collision with root package name */
    private Executor f19884b = Executors.newSingleThreadExecutor(new ThreadFactory() { // from class: com.mbridge.msdk.foundation.same.report.g.1
    ...
    private volatile com.mbridge.msdk.e.m f19885c;
    ...
    private w e() {
        ...
        try {
            ...
            if (a13 == 1) {
                oVar = new com.mbridge.msdk.e.o(new n((byte) 2), com.mbridge.msdk.foundation.same.net.g.d.f().f19689i, com.mbridge.msdk.foundation.same.net.g.d.f().f19693m);
            } else {
    ...
    public final com.mbridge.msdk.e.m d() {
        if (this.f19885c == null) {
            this.f19885c = com.mbridge.msdk.e.m.a("mtg_sdk", com.mbridge.msdk.foundation.controller.c.m().c(), e());
            this.f19885c.a(c.a());
            this.f19885c.a();
        }
        return this.f19885c;
