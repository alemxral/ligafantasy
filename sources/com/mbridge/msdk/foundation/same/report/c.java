...
public class c {
    ...
    private static final String f19816a = "c";
            ...
            public final JSONObject a(com.mbridge.msdk.e.e eVar) {
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(optString)) {
                        String str2 = com.mbridge.msdk.foundation.controller.a.f19040b.get(optString);
                        if (str2 != null) {
                            str = str2;
                        }
                        d8.put("u_stid", str);
                    }
                    if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19397U) && !d8.has(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B)) {
                        d8.put(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, com.mbridge.msdk.foundation.same.a.f19397U);
                    }
                    if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19406g) && !d8.has(c.f19816a)) {
                        d8.put(c.f19816a, com.mbridge.msdk.foundation.same.a.f19406g);
                    }
                } catch (Exception e8) {
                    ad.b(c.f19816a, e8.getMessage());
                }
                return d8;
            }
        };
    ...
    public static void a(JSONObject jSONObject) {
        ...
        if (!com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().c(MBridgeConstans.AUTHORITY_OTHER)) {
            jSONObject.remove(com.mbridge.msdk.foundation.same.net.h.e.f19713a);
            jSONObject.remove(com.mbridge.msdk.foundation.same.net.h.e.f19714b);
