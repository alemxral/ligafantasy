...
public final class b {
    ...
    private static b f19473a;

    /* renamed from: c, reason: collision with root package name */
    private com.mbridge.msdk.foundation.same.a.c<String, Bitmap> f19475c;

    /* renamed from: e, reason: collision with root package name */
    private com.mbridge.msdk.foundation.same.e.b f19477e;

    /* renamed from: b, reason: collision with root package name */
    private LinkedHashMap<String, List<c>> f19474b = new LinkedHashMap<>();

    /* renamed from: d, reason: collision with root package name */
    private Handler f19476d = new Handler(Looper.getMainLooper()) { // from class: com.mbridge.msdk.foundation.same.c.b.1
        ...
        public final void handleMessage(Message message) {
            try {
                ...
                if (i8 == 1) {
                    ...
                    b.this.a(string, a8);
                    LinkedList linkedList = (LinkedList) b.this.f19474b.get(string);
                    if (linkedList != null) {
    ...
    private b(Context context) {
        int i8;
        this.f19477e = new com.mbridge.msdk.foundation.same.e.b(context);
        ...
        this.f19475c = new com.mbridge.msdk.foundation.same.a.a(((int) Runtime.getRuntime().maxMemory()) / (i8 > 0 ? i8 : 10));
    }

    private Bitmap d(String str) {
        return this.f19475c.b(str);
    }
    ...
    public final void a(String str, Bitmap bitmap) {
        ...
        this.f19475c.a(str, bitmap);
    }

    private void a(String str, String str2, String str3, boolean z8, boolean z9, c cVar) {
        if (!this.f19474b.containsKey(str2)) {
            LinkedList linkedList = new LinkedList();
            linkedList.add(cVar);
            this.f19474b.put(str2, linkedList);
            e.a aVar = new e.a() { // from class: com.mbridge.msdk.foundation.same.c.b.6
                ...
                public final void a(String str4, String str5) {
                    Message obtainMessage = b.this.f19476d.obtainMessage();
                    obtainMessage.what = 1;
                    Bundle bundle = new Bundle();
                    bundle.putString("message_key", str4);
                    bundle.putString("message_bitmap", str5);
                    obtainMessage.setData(bundle);
                    b.this.f19476d.sendMessage(obtainMessage);
                }
        ...
        LinkedList linkedList2 = (LinkedList) this.f19474b.get(str2);
    ...
    public final void c() {
        ...
        this.f19475c.b();
        LinkedHashMap<String, List<c>> linkedHashMap = this.f19474b;
    ...
    public final void a(String str) {
        ...
        try {
            com.mbridge.msdk.foundation.same.a.c<String, Bitmap> cVar = this.f19475c;
    ...
    static /* synthetic */ void a(b bVar, final String str, final Bitmap bitmap, final c cVar) {
        ...
        bVar.f19476d.post(new Runnable() { // from class: com.mbridge.msdk.foundation.same.c.b.3
            @Override // java.lang.Runnable
            public final void run() {
                c cVar2 = cVar;
                if (cVar2 != null) {
                    ...
                    try {
                        LinkedList linkedList = (LinkedList) b.this.f19474b.get(str);
                        if (linkedList != null) {
    ...
    static /* synthetic */ void a(b bVar, final String str, final String str2, final c cVar) {
        ...
        bVar.f19476d.post(new Runnable() { // from class: com.mbridge.msdk.foundation.same.c.b.4
            @Override // java.lang.Runnable
            public final void run() {
                c cVar2 = cVar;
                if (cVar2 != null) {
    ...
    static /* synthetic */ void a(b bVar, final String str, String str2, String str3, boolean z8, boolean z9, final c cVar, final h hVar) {
        if (!bVar.f19474b.containsKey(str2)) {
            LinkedList linkedList = new LinkedList();
            linkedList.add(cVar);
            bVar.f19474b.put(str2, linkedList);
        ...
        LinkedList linkedList2 = (LinkedList) bVar.f19474b.get(str2);
        if (linkedList2 == null || linkedList2.contains(cVar)) {
            return;
        }
        linkedList2.add(cVar);
