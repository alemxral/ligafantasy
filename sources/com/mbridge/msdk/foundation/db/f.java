...
public class f extends a<Campaign> {
    ...
    private static final String f19168a = "com.mbridge.msdk.foundation.db.f";

    /* renamed from: b, reason: collision with root package name */
    private static f f19169b;
    ...
    private final String f19178k;

    /* renamed from: l, reason: collision with root package name */
    private final String f19179l;

    /* renamed from: m, reason: collision with root package name */
    private final String f19180m;

    /* renamed from: n, reason: collision with root package name */
    private final String f19181n;

    /* renamed from: o, reason: collision with root package name */
    private final String f19182o;

    /* renamed from: p, reason: collision with root package name */
    private final String f19183p;

    /* renamed from: q, reason: collision with root package name */
    private final String f19184q;

    /* renamed from: r, reason: collision with root package name */
    private final String f19185r;
    ...
    private f(g gVar) {
        ...
        this.f19171d = "lrid";
        this.f19172e = "cid";
        this.f19173f = CampaignEx.JSON_KEY_PLCT;
        this.f19174g = CampaignEx.JSON_KEY_PLCTB;
        this.f19175h = CampaignEx.JSON_KEY_TIMESTAMP;
        this.f19176i = "ridCount";
        this.f19177j = " WHERE ";
        this.f19178k = " AND ";
        this.f19179l = "SELECT ";
        this.f19180m = "*";
        this.f19181n = " FROM ";
        this.f19182o = " AND readyState = '0'";
        this.f19183p = " AND is_bid_campaign = 1";
        this.f19184q = " order by ts ASC";
        this.f19185r = " group by request_id";
        this.f19186s = " group by bid_token";
    }
