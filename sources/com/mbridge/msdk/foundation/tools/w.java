...
public final class w {
    ...
    public static final char[] f20089a;

    /* renamed from: b, reason: collision with root package name */
    public static final int[] f20090b;
    ...
    public static String a(String str) {
        ...
        if (length == 0) {
            ...
            int i11 = length - 1;
            int i12 = 0;
            while (i12 < i11 && f20090b[str.charAt(i12) & 255] < 0) {
                i12++;
            }
            while (i11 > 0 && f20090b[str.charAt(i11) & 255] < 0) {
                i11--;
            }
            if (str.charAt(i11) == '=') {
                if (str.charAt(i11 - 1) == '=') {
            ...
            if (i16 < i14) {
                ...
                int i22 = 0;
                while (i12 <= i11 - i8) {
                    i21 |= f20090b[str.charAt(i12)] << (18 - (i22 * 6));
                    i22++;
                    i12++;
                }
                int i23 = 16;
