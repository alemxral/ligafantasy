...
public final class ag {
    ...
    public static char[] f19979a = {'P', 'a', 'c', 'k', 'a', 'g', 'e', 'M', 'a', 'n', 'a', 'g', 'e', 'r'};

    /* renamed from: b, reason: collision with root package name */
    static String f19980b = "";

    /* renamed from: c, reason: collision with root package name */
    static boolean f19981c = false;

    /* renamed from: d, reason: collision with root package name */
    private static int f19982d = -1;

    /* renamed from: e, reason: collision with root package name */
    private static int f19983e = -1;

    /* renamed from: f, reason: collision with root package name */
    private static boolean f19984f = false;

    /* renamed from: g, reason: collision with root package name */
    private static int f19985g = -1;

    /* renamed from: h, reason: collision with root package name */
    private static int f19986h = -1;
    ...
    public static int a() {
        ...
        f19983e = Long.valueOf((c() / 1000) / 1000).intValue();
    ...
    public static int b() {
        if (f19986h == -1) {
            try {
                f19986h = new Long((e() / 1000) / 1000).intValue();
            } catch (Throwable th) {
                ad.a("SameSDCardTool", th.getMessage(), th);
            }
        }
    ...
    */
    private static java.lang.String c(android.content.Context r7) {
        ...
        L14:
            r1 = r0
        L15:
            boolean r2 = com.mbridge.msdk.foundation.tools.ag.f19981c
            if (r2 == 0) goto L5f
            if (r1 != 0) goto L54
    ...
    public static void a(Context context) {
        if (context == null || f19984f) {
            return;
        }
        try {
            try {
                f19980b = context.getFilesDir().getAbsolutePath() + File.separator;
                f19981c = false;
                b(context);
            } catch (Exception unused) {
            }
