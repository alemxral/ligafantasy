...
public final class C2401a {
    ...
    private static byte[] f19953b = new byte[32];

    /* renamed from: a, reason: collision with root package name */
    private static byte[] f19952a = new byte[16];
    ...
    static {
        if (!TextUtils.isEmpty("ebmclXzZOhtU2sRlZxGL8A")) {
            try {
                ...
                System.arraycopy(digest, 0, f19953b, 0, 32);
                System.arraycopy(digest, 32, f19952a, 0, 16);
            } catch (Exception e8) {
                e8.printStackTrace();
            }
        }
