...
public final class MIMManager {
    ...
    /* renamed from: a */
    private static volatile String f19926a;
    ...
    /* renamed from: d */
    private CopyOnWriteArrayList<CampaignEx> f19929d;

    /* renamed from: e */
    private Context f19930e;

    /* renamed from: f */
    private volatile Boolean f19931f;

    /* renamed from: g */
    private CampaignEx f19932g;

    /* renamed from: h */
    private volatile b f19933h;

    /* renamed from: i */
    private volatile MiOverseaMiniCardBroadcasterReceiver f19934i;
    ...
    public final class AnonymousClass1 implements Runnable {
        ...
        public final void run() {
            if (MIMManager.this.f19927b.compareAndSet(false, true)) {
                try {
                    MIMManager mIMManager = MIMManager.this;
                    mIMManager.f19931f = mIMManager.g();
                } catch (Exception e8) {
                    ad.a("MIMManager", e8.getMessage());
                }
                if (MIMManager.this.f19931f != null && MIMManager.this.f19931f.booleanValue() && r2 != null) {
                    try {
                        MIMManager.this.f19933h = new b();
                        ...
                        r2.registerReceiver(MIMManager.this.f19933h, intentFilter);
                    } catch (Exception e9) {
    ...
    final class AnonymousClass2 implements Runnable {
        ...
        /* renamed from: b */
        final /* synthetic */ CampaignEx f19938b;
    ...
    final class AnonymousClass3 implements Runnable {
        ...
        /* renamed from: b */
        final /* synthetic */ CampaignEx f19941b;
    ...
    final class AnonymousClass4 implements Runnable {
        ...
        /* renamed from: b */
        final /* synthetic */ CampaignEx f19944b;
        ...
        public final void run() {
            ...
            try {
                try {
                    ...
                    if (MIMManager.this.f19929d == null || !MIMManager.this.f19929d.contains(r3)) {
                        return;
                    }
                } catch (Exception e9) {
                    ad.b("MIMManager", e9.getMessage());
                ...
                MIMManager.this.f19929d.remove(r3);
            } catch (Throwable th) {
                if (MIMManager.this.f19929d != null && MIMManager.this.f19929d.contains(r3)) {
                    MIMManager.this.f19929d.remove(r3);
                }
    ...
    final class AnonymousClass5 implements Runnable {
        ...
        /* renamed from: c */
        final /* synthetic */ CampaignEx f19948c;

        /* renamed from: d */
        final /* synthetic */ int f19949d;
            ...
            try {
                if (r2 != null && !TextUtils.isEmpty(r3) && r4 != null) {
                    ...
                    if (!TextUtils.isEmpty(r4.getCampaignUnitId())) {
                        ...
                        stringBuffer.append("&");
                        String str = com.mbridge.msdk.foundation.controller.a.f19040b.get(r4.getCampaignUnitId());
                    ...
                    try {
                        new com.mbridge.msdk.foundation.same.report.e.a(r2).post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, com.mbridge.msdk.foundation.same.report.k.a(stringBuffer.toString(), r2), null);
                    } catch (Exception e8) {
                        e8.printStackTrace();
                        ad.b("MIMManager", e8.getMessage());
                    }
            ...
            if (x.a("DFKwWgtuDkKwLZPwD+z8H+N/xjK+n3eyNVx6ZVPn5jcincKZx5f5ncN=").equals(intent.getAction())) {
                ...
                if (intExtra == 1 || intExtra == 2 || intExtra == 3 || intExtra == 4 || intExtra == 7) {
                    try {
                        ...
                        CampaignEx a8 = a.f19951a.a(stringExtra);
                        if (a8 != null) {
                            ...
                            dVar.a("u_stid", com.mbridge.msdk.foundation.controller.a.f19040b.get(a8.getCampaignUnitId()));
                            bVar.a(a8);
                        }
    ...
    public static final class a {
        ...
        /* renamed from: a */
        private static final MIMManager f19951a = new MIMManager();
    }
                ...
                if (c8.getContentResolver() != null) {
                    ...
                    if (cursor != null) {
                        while (cursor.moveToNext()) {
                            ...
                            try {
                                f19926a = cursor.getString(cursor.getColumnIndex("detailStyle"));
                            } catch (Exception e9) {
                                ad.a("MIMManager", e9.getMessage());
                            }
                        }
    ...
    public final void f() {
        int i8 = this.f19928c - 1;
        this.f19928c = i8;
        if (i8 <= 0) {
            Context context = this.f19930e;
            if (context != null) {
                try {
                    try {
                        if (this.f19933h != null) {
                            context.unregisterReceiver(this.f19933h);
                        }
                        if (this.f19934i != null) {
                            context.unregisterReceiver(this.f19934i);
                        }
                    } catch (Exception e8) {
                        ad.a("MIMManager", e8.getMessage());
                    }
            ...
            try {
                try {
                    if (this.f19934i != null) {
                        Context c8 = com.mbridge.msdk.foundation.controller.c.m().c();
                        if (c8 != null) {
                            c8.unregisterReceiver(this.f19934i);
                        }
                        this.f19932g = null;
                        this.f19929d.clear();
                        this.f19929d = null;
    ...
    private MIMManager() {
        this.f19928c = 0;
        this.f19929d = new CopyOnWriteArrayList<>();
    ...
    public final String c() {
        try {
            return f19926a == null ? "" : String.format("[%s]", f19926a);
        } catch (Exception unused) {
            return "";
        }
    }
    ...
    public final void b(CampaignEx campaignEx) {
        try {
            if (this.f19931f == null || campaignEx == null || !this.f19931f.booleanValue()) {
                return;
            }
            this.f19932g = null;
            try {
                this.f19929d.remove(campaignEx);
            } catch (Exception e8) {
                ad.a("MIMManager", e8.getMessage());
            }
        } catch (Exception e9) {
    ...
    public CampaignEx a(String str) {
        try {
            CampaignEx campaignEx = this.f19932g;
            if (campaignEx != null && TextUtils.equals(campaignEx.getPackageName(), str)) {
                return this.f19932g;
            }
            CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList = this.f19929d;
            if (copyOnWriteArrayList == null || copyOnWriteArrayList.size() <= 0) {
                return null;
            }
            Iterator<CampaignEx> it = this.f19929d.iterator();
            while (it.hasNext()) {
