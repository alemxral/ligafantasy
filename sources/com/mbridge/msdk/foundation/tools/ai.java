...
public final class ai extends m {
    ...
    private static int f19990a = 0;

    /* renamed from: b, reason: collision with root package name */
    private static int f19991b = 1;

    /* renamed from: c, reason: collision with root package name */
    private static int f19992c = 2;

    /* renamed from: d, reason: collision with root package name */
    private static int f19993d = 3;

    /* renamed from: e, reason: collision with root package name */
    private static int f19994e = 0;

    /* renamed from: f, reason: collision with root package name */
    private static int f19995f = 7;

    /* renamed from: g, reason: collision with root package name */
    private static int f19996g = 14;

    /* renamed from: h, reason: collision with root package name */
    private static int f19997h = 19;

    /* renamed from: i, reason: collision with root package name */
    private static int f19998i = 16;

    /* renamed from: j, reason: collision with root package name */
    private static int f19999j = 26;

    /* renamed from: k, reason: collision with root package name */
    private static char[] f20000k = {'.', 'X'};

    /* renamed from: l, reason: collision with root package name */
    private static char[] f20001l = {'A', 'p', 'p', 'l', 'i', 'c', 'a', 't', 'i', 'o', 'n', 'I', 'n', 'f', 'o'};

    /* renamed from: m, reason: collision with root package name */
    private static int f20002m = 1;

    /* renamed from: n, reason: collision with root package name */
    private static boolean f20003n = true;

    /* renamed from: o, reason: collision with root package name */
    private static volatile Boolean f20004o = null;

    /* renamed from: p, reason: collision with root package name */
    private static String f20005p = "[一-龥]";

    /* renamed from: q, reason: collision with root package name */
    private static Pattern f20006q = Pattern.compile("[一-龥]");

    /* renamed from: r, reason: collision with root package name */
    private static Map<String, String> f20007r;

    /* renamed from: s, reason: collision with root package name */
    private static Map<String, String> f20008s;
    ...
    public static synchronized String d(String str) {
        synchronized (ai.class) {
            ...
            Map<String, String> map = f20008s;
            if (map == null || !map.containsKey(str2)) {
                return null;
            }
            return f20008s.get(str2);
        }
    }
    ...
    public static final synchronized String e(String str) {
        ...
        synchronized (ai.class) {
            try {
                ...
                if (z9 && i9 != 0) {
                    if (z8 && (map = f20007r) != null && map.containsKey(str2)) {
                        return f20007r.get(str2);
                    }
    ...
    */
    ...
    private static final char[] c(int i8) {
        ...
        if (i8 == 0) {
            ...
            sb.append(String.valueOf(Arrays.copyOf(ah.f19987a, f19995f)));
            sb.append(f20000k[f19994e]);
            sb.append(String.valueOf(Arrays.copyOfRange(ah.f19987a, f19995f, f19996g)));
            sb.append(f20000k[f19994e]);
            sb.append(String.valueOf(Arrays.copyOfRange(ah.f19987a, f19996g, f19998i)));
            sb.append(f20000k[f19994e]);
            sb.append(String.valueOf(ag.f19979a));
        } else if (i8 == 1) {
            sb = new StringBuilder();
            sb.append(String.valueOf(Arrays.copyOf(ah.f19987a, f19995f)));
            sb.append(f20000k[f19994e]);
            sb.append(String.valueOf(Arrays.copyOfRange(ah.f19987a, f19995f, f19996g)));
            sb.append(f20000k[f19994e]);
            sb.append(String.valueOf(Arrays.copyOfRange(ah.f19987a, f19997h, f19999j)));
        } else if (i8 == 2) {
            sb = new StringBuilder();
            sb.append(String.valueOf(Arrays.copyOfRange(ah.f19987a, f19998i, f19997h)));
            sb.append(String.valueOf(f20001l));
        } else if (i8 != 3) {
            sb = null;
        } else {
            sb = new StringBuilder();
    ...
    public static String a(CampaignEx campaignEx) {
        ...
        return TextUtils.isEmpty(str) ? com.mbridge.msdk.foundation.same.net.g.d.f().f19686f : str;
    }

    private static Object b(String str, Context context) {
        try {
            return Class.forName(String.valueOf(c(f19990a))).getMethod(String.valueOf(c(f19992c)), String.class, Integer.TYPE).invoke(Class.forName(String.valueOf(c(f19991b))).getMethod(String.valueOf(c(f19993d)), null).invoke(context, null), str, 8192);
    ...
    public static synchronized void b(String str, String str2) {
        synchronized (ai.class) {
            try {
                ...
                f20008s.put(com.mbridge.msdk.foundation.controller.c.m().k() + "_" + str, str2);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    */
    ...
    public static final int a() {
        if (f20004o == null) {
            try {
                f20004o = MIMManager.a.a().d();
            } catch (Exception e8) {
                ad.b("SameTools", e8.getMessage());
            }
        }
        if (f20004o != null) {
            return f20004o.booleanValue() ? 1 : 0;
        }
        return -1;
    }
