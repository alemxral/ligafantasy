...
public final class p {
    ...
    public final String a(int i8) {
        ...
        if (i8 > 2048) {
            str = new String(this.f20079a, this.f20080b, i8, StandardCharsets.UTF_8);
        } else {
            char[] cArr = this.f20081c;
            if (cArr == null) {
                if (i8 <= 256) {
                    this.f20081c = new char[256];
                } else {
                    this.f20081c = new char[2048];
                }
            } else if (cArr.length < i8) {
                this.f20081c = new char[2048];
            }
            char[] cArr2 = this.f20081c;
            byte[] bArr = this.f20079a;
            int i9 = this.f20080b;
            int i10 = i9 + i8;
            int i11 = 0;
    ...
    public final void a(byte[] bArr) {
        ...
        if (length > 0) {
            System.arraycopy(bArr, 0, this.f20079a, this.f20080b, length);
            this.f20080b += length;
        }
    }
