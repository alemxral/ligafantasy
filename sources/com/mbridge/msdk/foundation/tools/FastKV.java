...
public class FastKV {
    ...
    private final b logger = q.f20083b;
    ...
    public static class c implements Comparable<c> {
        ...
        public final /* bridge */ /* synthetic */ int compareTo(c cVar) {
            return this.f19925b - cVar.f19925b;
        }
    }
    ...
    FastKV(String str, String str2, a[] aVarArr, int i8) {
        ...
        hashMap.put("StringSet", am.f20014a);
    ...
    private void addOrUpdate(String str, Object obj, byte[] bArr, f.j jVar, byte b8) {
        ...
        } else if (!jVar.f20062b && jVar.f20065e == bArr.length) {
            updateBytes(jVar.f20056a, bArr);
            jVar.f20064d = obj;
        } else {
    ...
    private void clearData() {
        ...
        if (pVar != null && pVar.f20079a.length == PAGE_SIZE) {
            pVar.b(0, 0);
    ...
    private void ensureSize(int i8) {
        int length = this.fastBuffer.f20079a.length;
        ...
        if (i9 >= length) {
            ...
            System.arraycopy(this.fastBuffer.f20079a, 0, bArr, 0, this.dataEnd);
            this.fastBuffer.f20079a = bArr;
    ...
    private void fastPutString(String str, String str2, f.i iVar) {
        ...
        if (iVar == null) {
            ...
            int i10 = iVar.f20056a;
            int i11 = i10 - iVar.f20063c;
            int i12 = iVar.f20065e;
            boolean z8 = false;
            String str3 = null;
            if (i12 == a8) {
                this.checksum ^= this.fastBuffer.a(i10, i12);
                if (a8 == str2.length()) {
                    str2.getBytes(0, a8, this.fastBuffer.f20079a, iVar.f20056a);
                } else {
                    p pVar = this.fastBuffer;
                    pVar.f20080b = iVar.f20056a;
                    pVar.b(str2);
                }
                this.updateStart = iVar.f20056a;
                this.updateSize = a8;
            } else {
                ...
                byte[] bArr = pVar2.f20079a;
                System.arraycopy(bArr, iVar.f20063c + 1, bArr, pVar2.f20080b, i13);
                this.fastBuffer.f20080b += i13;
                putStringValue(str2, a8);
                remove((byte) 6, iVar.f20063c, iVar.f20056a + iVar.f20065e);
                if (iVar.f20062b) {
                    str3 = (String) iVar.f20064d;
                }
                iVar.f20062b = false;
                int i14 = this.updateStart;
                iVar.f20063c = i14;
                iVar.f20056a = i14 + i11;
                iVar.f20065e = a8;
                z8 = true;
            }
            iVar.f20064d = str2;
    ...
    private byte[] getArrayFromFile(f.a aVar) {
        try {
            byte[] b8 = ap.b(new File(this.path + this.name, (String) aVar.f20064d));
            if (b8 == null) {
                return EMPTY_ARRAY;
            }
            return b8;
    ...
    private Object getObjectFromFile(f.h hVar) {
        try {
            byte[] b8 = ap.b(new File(this.path + this.name, (String) hVar.f20064d));
            if (b8 != null) {
                int i8 = b8[0] & 255;
    ...
    private String getStringFromFile(f.i iVar) {
        try {
            byte[] b8 = ap.b(new File(this.path + this.name, (String) iVar.f20064d));
    ...
    private boolean isABFileEqual() {
        ...
        this.bBuffer.rewind();
        this.bBuffer.get(pVar.f20079a, 0, this.dataEnd);
        byte[] bArr = this.fastBuffer.f20079a;
        byte[] bArr2 = pVar.f20079a;
                ...
                try {
                    ...
                    if (i8 >= 0) {
                        if (i8 <= length - 12) {
                            ...
                            fastKV.aBuffer.get(fastKV.fastBuffer.f20079a, 0, fastKV.dataEnd);
                    ...
                    if (i9 >= 0 && i9 <= length2 - 12) {
                        ...
                        if (fastKV.fastBuffer.f20079a.length != fastKV.bBuffer.capacity()) {
                            fastKV.fastBuffer = new p(fastKV.bBuffer.capacity());
                        }
                        fastKV.bBuffer.rewind();
                        fastKV.bBuffer.get(fastKV.fastBuffer.f20079a, 0, fastKV.dataEnd);
    ...
    private boolean loadWithBlockingIO(File file) throws IOException {
        ...
        if (length != 0 && length <= 536870912) {
            ...
            p pVar = this.fastBuffer;
            if (pVar != null && pVar.f20079a.length == newCapacity) {
                pVar.f20080b = 0;
            } else {
                pVar = new p(new byte[newCapacity]);
                this.fastBuffer = pVar;
            }
            ap.a(file, pVar.f20079a, i8);
            int c8 = pVar.c();
            long b8 = pVar.b();
            this.dataEnd = c8 + 12;
    ...
    private void mergeInvalids() {
        ...
        while (size > 0) {
            ...
            if (cVar.f19925b == cVar2.f19924a) {
                cVar2.f19924a = cVar.f19924a;
    ...
    */
    ...
    private void putKey(String str, int i8) {
        ...
        if (i8 == str.length()) {
            p pVar = this.fastBuffer;
            str.getBytes(0, i8, pVar.f20079a, pVar.f20080b);
            this.fastBuffer.f20080b += i8;
            return;
        }
    ...
    private void syncABBuffer(MappedByteBuffer mappedByteBuffer) {
        ...
        if (i8 != 0) {
            mappedByteBuffer.put(i8, this.fastBuffer.f20079a[i8]);
        }
        if (this.updateSize != 0) {
            mappedByteBuffer.position(this.updateStart);
            mappedByteBuffer.put(this.fastBuffer.f20079a, this.updateStart, this.updateSize);
        }
    }
    ...
    private void updateObject(String str, Object obj, byte[] bArr, f.j jVar) {
        ...
        if (saveArray != 0) {
            if (jVar.f20062b) {
                str2 = (String) jVar.f20064d;
            } else {
                str2 = null;
            }
            remove(jVar.a(), jVar.f20063c, jVar.f20056a + jVar.f20065e);
            ...
            jVar.f20063c = this.updateStart;
            jVar.f20056a = saveArray;
            jVar.f20062b = z8;
            if (z8) {
                jVar.f20064d = str3;
                jVar.f20065e = 32;
    ...
    private boolean writeToABFile(p pVar) {
        int length = pVar.f20079a.length;
        ...
        try {
            if (ap.c(file) && ap.c(file2)) {
                ...
                this.bBuffer = map2;
                map2.order(byteOrder);
                this.aBuffer.put(pVar.f20079a, 0, this.dataEnd);
                this.bBuffer.put(pVar.f20079a, 0, this.dataEnd);
                return true;
            }
        ...
        try {
            try {
                ...
                if (ap.c(file)) {
                    ...
                    randomAccessFile.write(this.fastBuffer.f20079a, 0, this.dataEnd);
    ...
    void gc(int i8) {
        ...
        int size = this.invalids.size();
        int i16 = size - 1;
        int i17 = this.dataEnd - this.invalids.get(i16).f19924a;
        if (i17 > 0) {
            i9 = size;
        } else {
            i9 = i16;
        ...
        int i18 = cVar.f19925b;
        int i19 = cVar.f19924a;
        for (int i20 = 1; i20 < size; i20++) {
            c cVar2 = this.invalids.get(i20);
            int i21 = cVar2.f19925b - i19;
            byte[] bArr = this.fastBuffer.f20079a;
        ...
        if (i17 > 0) {
            byte[] bArr2 = this.fastBuffer.f20079a;
        ...
        if (this.writingMode == 0) {
            ...
            this.aBuffer.put(this.fastBuffer.f20079a, i10, i14);
            this.aBuffer.putInt(0, i13);
            this.bBuffer.putInt(0, i13);
            this.bBuffer.putLong(4, this.checksum);
            this.bBuffer.position(i10);
            this.bBuffer.put(this.fastBuffer.f20079a, i10, i14);
        } else {
        ...
        int i24 = i12 + i8;
        if (this.fastBuffer.f20079a.length - i24 > TRUNCATE_THRESHOLD) {
            truncate(i24);
        }
        info(GC_FINISH);
    }
    ...
    public synchronized Map<String, Object> getAll() {
        ...
        for (Map.Entry<String, f.b> entry : this.data.entrySet()) {
            ...
            switch (value.a()) {
                case 1:
                    valueOf = Boolean.valueOf(((f.c) value).f20057b);
                    break;
                case 2:
                    valueOf = Integer.valueOf(((f.C0406f) value).f20060b);
                    break;
                case 3:
                    valueOf = Float.valueOf(((f.e) value).f20059b);
                    break;
                case 4:
                    valueOf = Long.valueOf(((f.g) value).f20061b);
                    break;
                case 5:
                    valueOf = Double.valueOf(((f.d) value).f20058b);
                    break;
                case 6:
                    f.i iVar = (f.i) value;
                    if (iVar.f20062b) {
    ...
    public synchronized long getLong(String str) {
        ...
        return gVar == null ? 0L : gVar.f20061b;
    }
    ...
    public synchronized void putBoolean(String str, boolean z8) {
        try {
            ...
            if (cVar == null) {
                ...
                checkIfCommit();
            } else if (cVar.f20057b != z8) {
                cVar.f20057b = z8;
                updateBoolean(z8 ? (byte) 1 : (byte) 0, cVar.f20056a);
                checkIfCommit();
            }
        } catch (Throwable th) {
            throw th;
    ...
    public synchronized void putDouble(String str, double d8) {
        try {
            ...
            if (dVar == null) {
                ...
                checkIfCommit();
            } else if (dVar.f20058b != d8) {
                long doubleToRawLongBits = Double.doubleToRawLongBits(d8);
                long doubleToRawLongBits2 = Double.doubleToRawLongBits(dVar.f20058b) ^ doubleToRawLongBits;
                dVar.f20058b = d8;
                updateInt64(doubleToRawLongBits, doubleToRawLongBits2, dVar.f20056a);
                checkIfCommit();
            }
        } catch (Throwable th) {
            throw th;
    ...
    public synchronized void putFloat(String str, float f8) {
        try {
            ...
            if (eVar == null) {
                ...
                checkIfCommit();
            } else if (eVar.f20059b != f8) {
                eVar.f20059b = f8;
                updateInt32(Float.floatToRawIntBits(f8), (Float.floatToRawIntBits(eVar.f20059b) ^ r6) & 4294967295L, eVar.f20056a);
                checkIfCommit();
            }
        } catch (Throwable th) {
            throw th;
    ...
    public synchronized void putInt(String str, int i8) {
        try {
            ...
            if (c0406f == null) {
                ...
                if (c0406f.f20060b != i8) {
                    c0406f.f20060b = i8;
                    updateInt32(i8, (r6 ^ i8) & 4294967295L, c0406f.f20056a);
                    checkIfCommit();
                }
            }
        } catch (Throwable th) {
    ...
    public synchronized void putLong(String str, long j8) {
        try {
            ...
            if (gVar == null) {
                ...
                long j9 = gVar.f20061b;
                if (j9 != j8) {
                    gVar.f20061b = j8;
                    updateInt64(j8, j8 ^ j9, gVar.f20056a);
                    checkIfCommit();
                }
            }
        } catch (Throwable th) {
        ...
        if (aVar != null) {
            ...
            if (a8 != null && !a8.isEmpty() && a8.length() <= 50) {
                if (this.encoderMap.containsKey(a8)) {
                    ...
                    pVar.b(a8);
                    pVar.a(bArr);
                    addOrUpdate(str, t8, pVar.f20079a, (f.h) this.data.get(str), (byte) 8);
                    return;
                }
        ...
        try {
            ...
            if (bVar != null) {
                ...
                if (a8 <= 5) {
                    ...
                    f.j jVar = (f.j) bVar;
                    remove(a8, jVar.f20063c, jVar.f20056a + jVar.f20065e);
                    if (jVar.f20062b) {
                        str2 = (String) jVar.f20064d;
                    }
                }
    ...
    public synchronized byte[] getArray(String str, byte[] bArr) {
        try {
            ...
            if (aVar != null) {
                return aVar.f20062b ? getArrayFromFile(aVar) : (byte[]) aVar.f20064d;
            }
            return bArr;
        } catch (Throwable th) {
            throw th;
    ...
    public synchronized String getString(String str, String str2) {
        try {
            f.i iVar = (f.i) this.data.get(str);
            if (iVar != null) {
                return iVar.f20062b ? getStringFromFile(iVar) : (String) iVar.f20064d;
            }
            return str2;
        } catch (Throwable th) {
            throw th;
