...
public class CampaignEx extends DomainCampaignEx implements NoProGuard, Serializable {
    ...
    public static final class a implements Serializable {
        ...
        private static a a(JSONObject jSONObject) {
            ...
            try {
                aVar.f19210c = jSONObject.optString("adchoice_icon");
                aVar.f19211d = jSONObject.optString("adchoice_link");
                String optString = jSONObject.optString("adchoice_size");
                aVar.f19212e = optString;
                aVar.f19208a = jSONObject.optString("ad_logo_link");
                aVar.f19215h = jSONObject.optString("adv_logo");
                aVar.f19216i = jSONObject.optString("adv_name");
                aVar.f19217j = jSONObject.optString("platform_logo");
                aVar.f19218k = jSONObject.optString("platform_name");
                aVar.f19213f = c(optString);
                aVar.f19214g = d(optString);
                aVar.f19209b = jSONObject.toString();
                return aVar;
            } catch (Exception e9) {
                e = e9;
                aVar2 = aVar;
    ...
    public static final class b implements Serializable {
        ...
        /* renamed from: a, reason: collision with root package name */
        public Map<Integer, String> f19219a;
        ...
        /* renamed from: f, reason: collision with root package name */
        public boolean f19224f = false;

        /* renamed from: g, reason: collision with root package name */
        public boolean f19225g = false;

        /* renamed from: h, reason: collision with root package name */
        public boolean f19226h = false;

        /* renamed from: i, reason: collision with root package name */
        public boolean f19227i = false;
    ...
    public static final class c implements Serializable {
        ...
        public static final class a implements Serializable {
            ...
            /* renamed from: a, reason: collision with root package name */
            public List<String> f19237a = new ArrayList();
        ...
        public static c a(JSONObject jSONObject) {
            ...
            try {
                ...
                cVar.f19236f = jSONObject.optInt("video_template", 1);
                cVar.f19235e = jSONObject.optString("template_url");
                cVar.f19232b = jSONObject.optInt("orientation");
                cVar.f19233c = jSONObject.optString("paused_url");
                ...
                if (optJSONObject != null) {
                    ...
                    while (keys != null && keys.hasNext()) {
                        ...
                        if (b8 != null && b8.size() > 0) {
                            a aVar = new a();
                            aVar.f19238b = next;
                            aVar.f19237a.addAll(b8);
                            arrayList.add(aVar);
                        }
                    }
                    cVar.f19231a = arrayList;
                }
                return cVar;
            } catch (Throwable unused) {
                return null;
    ...
    public void setendcard_url(String str) {
        ...
        if (TextUtils.isEmpty(this.mof_template_url) && (((cVar = this.rewardTemplateMode) == null || TextUtils.isEmpty(cVar.f19235e)) && !TextUtils.isEmpty(str) && str.contains(KEY_IS_CMPT_ENTRY))) {
            setCMPTEntryUrl(str);
        }
