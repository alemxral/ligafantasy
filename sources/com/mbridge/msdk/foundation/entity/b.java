    ...
    private static void getSysIDAndBKUPID(JSONObject jSONObject) {
        ...
        if (fastKV != null) {
            try {
                ...
                if (jSONObject != null && c8 != null) {
                    ...
                    if (!TextUtils.isEmpty(optString) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.f19397U, optString)) {
                        com.mbridge.msdk.foundation.same.a.f19397U = optString;
                        com.mbridge.msdk.foundation.a.a.a.a().a("b", com.mbridge.msdk.foundation.same.a.f19397U);
                        try {
                            fastKV.putString(x.a("H+tU+bfPhM=="), com.mbridge.msdk.foundation.same.a.f19397U);
                        } catch (Exception unused2) {
                        }
                    }
                    String optString2 = jSONObject.optString("c");
                    if (!TextUtils.isEmpty(optString2) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.f19406g, optString2)) {
                        com.mbridge.msdk.foundation.same.a.f19406g = optString2;
                        com.mbridge.msdk.foundation.a.a.a.a().a("c", com.mbridge.msdk.foundation.same.a.f19406g);
                        try {
                            fastKV.putString(x.a("H+tU+Fz8"), com.mbridge.msdk.foundation.same.a.f19406g);
                            return;
        ...
        try {
            ...
            if (jSONObject != null && c9 != null) {
                ...
                if (!TextUtils.isEmpty(optString3) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.f19397U, optString3)) {
                    com.mbridge.msdk.foundation.same.a.f19397U = optString3;
                    com.mbridge.msdk.foundation.a.a.a.a().a("b", com.mbridge.msdk.foundation.same.a.f19397U);
                ...
                if (!TextUtils.isEmpty(optString4) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.f19406g, optString4)) {
                    com.mbridge.msdk.foundation.same.a.f19406g = optString4;
                    com.mbridge.msdk.foundation.a.a.a.a().a("c", com.mbridge.msdk.foundation.same.a.f19406g);
                    SharedPreferences sharedPreferences2 = c9.getSharedPreferences(x.a("H+tU+FeXHM=="), 0);
                    if (sharedPreferences2 != null) {
                        SharedPreferences.Editor edit2 = sharedPreferences2.edit();
                        edit2.putString(x.a("H+tU+Fz8"), com.mbridge.msdk.foundation.same.a.f19406g);
                        edit2.apply();
                    }
                }
            }
