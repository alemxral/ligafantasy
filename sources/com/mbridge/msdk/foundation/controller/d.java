...
public class d {
    ...
    private static volatile d f19076e;

    /* renamed from: f, reason: collision with root package name */
    private int f19081f;

    /* renamed from: g, reason: collision with root package name */
    private Map<String, Object> f19082g;

    /* renamed from: h, reason: collision with root package name */
    private FastKV f19083h;
    ...
    private Context f19088m;

    /* renamed from: n, reason: collision with root package name */
    private String f19089n;

    /* renamed from: o, reason: collision with root package name */
    private com.mbridge.msdk.b.a f19090o;

    /* renamed from: p, reason: collision with root package name */
    private String f19091p;

    /* renamed from: a, reason: collision with root package name */
    public final int f19077a = 4;

    /* renamed from: b, reason: collision with root package name */
    public final int f19078b = 5;

    /* renamed from: c, reason: collision with root package name */
    public final int f19079c = 2;

    /* renamed from: i, reason: collision with root package name */
    private boolean f19084i = false;

    /* renamed from: d, reason: collision with root package name */
    Handler f19080d = new Handler(Looper.getMainLooper()) { // from class: com.mbridge.msdk.foundation.controller.d.6
                ...
                if (i8 != 2) {
                    if (i8 != 7) {
                        if (i8 != 9) {
                                ...
                                if (i8 == 5) {
                                    ...
                                    if (!TextUtils.isEmpty(str)) {
                                        if (com.mbridge.msdk.foundation.same.report.e.a().b()) {
                                            ...
                                            new i(d.this.f19088m, 0).a("load_duration", str, null, null);
                                            return;
                                        }
                                    }
                                    return;
                            ...
                            if (!TextUtils.isEmpty(str2)) {
                                if (com.mbridge.msdk.foundation.same.report.e.a().b()) {
                                    ...
                                    new i(d.this.f19088m, 0).a("click_duration", str2, null, null);
                                    return;
                                }
                            }
                            return;
                        ...
                        if (d8 != null && d8.b() && gVar != null && gVar.J() == 1) {
                            com.mbridge.msdk.foundation.same.report.b.d.a(d.this.f19088m).b();
                        }
                        if (d8 != null && d8.a()) {
        ...
        if (context != null) {
            ...
            if (map != null) {
                if (map.containsKey(MBridgeConstans.ID_MBRIDGE_APPID)) {
                    this.f19085j = (String) map.get(MBridgeConstans.ID_MBRIDGE_APPID);
                }
                if (map.containsKey(MBridgeConstans.ID_MBRIDGE_APPKEY)) {
                    this.f19086k = (String) map.get(MBridgeConstans.ID_MBRIDGE_APPKEY);
                }
                if (map.containsKey(MBridgeConstans.ID_MBRIDGE_WX_APPID)) {
                    this.f19091p = (String) map.get(MBridgeConstans.ID_MBRIDGE_WX_APPID);
                }
                if (map.containsKey(MBridgeConstans.PACKAGE_NAME_MANIFEST)) {
                    this.f19087l = (String) map.get(MBridgeConstans.PACKAGE_NAME_MANIFEST);
                }
                if (map.containsKey(MBridgeConstans.ID_MBRIDGE_STARTUPCRASH)) {
                    this.f19089n = (String) map.get(MBridgeConstans.ID_MBRIDGE_STARTUPCRASH);
                }
            }
            this.f19088m = context.getApplicationContext();
            c.m().b(this.f19088m);
            c.m().d(this.f19085j);
            c.m().e(this.f19086k);
            c.m().a(this.f19091p);
            ...
            ag.a(this.f19088m);
            Context applicationContext = this.f19088m.getApplicationContext();
            try {
                if (this.f19083h == null) {
                    try {
                        this.f19083h = new FastKV.Builder(com.mbridge.msdk.foundation.same.b.e.a(com.mbridge.msdk.foundation.same.b.c.MBRIDGE_700_CONFIG), x.a("H+tU+FeXHM==")).build();
                    } catch (Exception unused) {
                        this.f19083h = null;
                    }
                }
                FastKV fastKV = this.f19083h;
                String str3 = "";
                if (fastKV != null) {
                    String string = fastKV.getString(x.a("H+tU+bfPhM=="), "");
                    String string2 = this.f19083h.getString(x.a("H+tU+Fz8"), "");
                    if (TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19397U) && TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19406g)) {
                        com.mbridge.msdk.foundation.same.a.f19397U = com.mbridge.msdk.foundation.a.a.a.a().a(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B);
                        com.mbridge.msdk.foundation.same.a.f19406g = com.mbridge.msdk.foundation.a.a.a.a().a("c");
                    }
                    if (TextUtils.isEmpty(string) && TextUtils.isEmpty(string2)) {
                        if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19397U) || !TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19406g)) {
                            this.f19083h.putString(x.a("H+tU+bfPhM=="), com.mbridge.msdk.foundation.same.a.f19397U);
                            this.f19083h.putString(x.a("H+tU+Fz8"), com.mbridge.msdk.foundation.same.a.f19406g);
                        }
                    } else {
                        com.mbridge.msdk.foundation.same.a.f19397U = string;
                        com.mbridge.msdk.foundation.same.a.f19406g = string2;
                        com.mbridge.msdk.foundation.a.a.a.a().a(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, com.mbridge.msdk.foundation.same.a.f19397U);
                        com.mbridge.msdk.foundation.a.a.a.a().a("c", com.mbridge.msdk.foundation.same.a.f19406g);
                    }
                } else {
                    ...
                    if (TextUtils.isEmpty(str3) && TextUtils.isEmpty(str)) {
                        if ((!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19397U) || !TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f19406g)) && sharedPreferences != null) {
                            SharedPreferences.Editor edit = sharedPreferences.edit();
                            edit.putString(x.a("H+tU+bfPhM=="), com.mbridge.msdk.foundation.same.a.f19397U);
                            edit.putString(x.a("H+tU+Fz8"), com.mbridge.msdk.foundation.same.a.f19406g);
                            edit.apply();
                        }
                    } else {
                        com.mbridge.msdk.foundation.same.a.f19397U = str3;
                        com.mbridge.msdk.foundation.same.a.f19406g = str;
                        com.mbridge.msdk.foundation.a.a.a.a().a(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, com.mbridge.msdk.foundation.same.a.f19397U);
                        com.mbridge.msdk.foundation.a.a.a.a().a("c", com.mbridge.msdk.foundation.same.a.f19406g);
                    }
                }
            ...
            try {
                ...
                com.mbridge.msdk.foundation.same.f.b.b().execute(new Runnable() { // from class: com.mbridge.msdk.foundation.controller.d.3
                    ...
                    public final void run() {
                        d dVar = d.this;
                        d.a(dVar, dVar.f19085j);
                        if (!TextUtils.isEmpty(d.this.f19085j)) {
                            com.mbridge.msdk.foundation.a.a.a.a().a(MBridgeConstans.SDK_APP_ID, d.this.f19085j);
                        }
                        new i(d.this.f19088m).a();
                        d.this.b();
                    }
                });
                k.c();
            ...
            this.f19084i = true;
            z.f(context);
            long az = h.a().a(this.f19085j).az();
            if (az != 1300) {
                this.f19080d.postDelayed(new Runnable() { // from class: com.mbridge.msdk.foundation.controller.d.1
                    @Override // java.lang.Runnable
                    public final void run() {
                        z.d(context);
                    }
    ...
    static /* synthetic */ void b(d dVar) {
        ...
        try {
            ...
            for (com.mbridge.msdk.foundation.entity.a aVar : k8) {
                if (aVar.a() == 287) {
                    if (dVar.f19088m != null && (newInstance = MBInterstitialVideoHandler.class.getConstructor(String.class, String.class).newInstance("", aVar.b())) != null) {
    ...
    public final void a(Map<String, Object> map, int i8) {
        ...
        if (map != null) {
            if (this.f19090o == null) {
                this.f19090o = new com.mbridge.msdk.b.a();
            }
            try {
                Map<String, Object> map2 = this.f19082g;
                if (map2 != null && map2.size() > 0 && this.f19082g.containsKey(MBridgeConstans.PROPERTIES_LAYOUT_TYPE)) {
                    int intValue = ((Integer) this.f19082g.get(MBridgeConstans.PROPERTIES_LAYOUT_TYPE)).intValue();
                    if (intValue == 0) {
                        Map<String, Object> map3 = this.f19082g;
                        int i9 = this.f19081f;
                        try {
        ...
        if (a8 != null) {
            ...
            if (b8 != null) {
                ...
                if (!TextUtils.isEmpty(b8.y())) {
                    com.mbridge.msdk.foundation.same.net.g.d.f().f19688h = b8.y();
                    com.mbridge.msdk.foundation.same.net.g.d.f().b();
                }
                if (!TextUtils.isEmpty(b8.z())) {
                    com.mbridge.msdk.foundation.same.net.g.d.f().f19692l = b8.z();
                    com.mbridge.msdk.foundation.same.net.g.d.f().c();
                }
            } else {
                MBridgeConstans.OMID_JS_SERVICE_URL = com.mbridge.msdk.c.a.b.f17869b;
                MBridgeConstans.OMID_JS_H5_URL = com.mbridge.msdk.c.a.b.f17868a;
            }
        }
            ...
            if (com.mbridge.msdk.foundation.a.a.a.a().a("is_first_init", 0) == 0) {
                try {
                    ...
                    if (TextUtils.isEmpty(com.mbridge.msdk.foundation.tools.e.c())) {
                        dVar.f19080d.postDelayed(new Runnable() { // from class: com.mbridge.msdk.foundation.controller.d.5
                            @Override // java.lang.Runnable
                            public final void run() {
                                new j().a(d.this.f19088m, str, d.this.f19086k);
                            }
                        }, 350L);
                    } else {
                        new j().a(dVar.f19088m, str, dVar.f19086k);
                    }
                    return;
