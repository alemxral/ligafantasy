...
public abstract class c extends f<JSONObject> {
    ...
    private static final String f21656a = "c";
    ...
    private com.mbridge.msdk.foundation.same.report.d.b f21659d;
    ...
    public void onError(com.mbridge.msdk.foundation.same.net.b.a aVar) {
        ad.b(f21656a, "errorCode = " + aVar.f19588a);
        com.mbridge.msdk.foundation.c.b bVar = new com.mbridge.msdk.foundation.c.b(aVar.f19588a, com.mbridge.msdk.foundation.same.net.g.a.a(aVar));
        bVar.a("campaign_request_error", aVar);
        bVar.e(aVar.f19589b);
        this.f21659d.a(bVar);
        b(aVar.f19588a, com.mbridge.msdk.foundation.same.net.g.a.a(aVar), this.f21659d);
    }
    ...
    public void onSuccess(k<JSONObject> kVar) {
        ...
        if (kVar != null && (cVar = kVar.f19747b) != null) {
            int i8 = this.f21657b;
            if (i8 == 0) {
                final List<com.mbridge.msdk.foundation.same.net.d.b> list = cVar.f19643b;
                final JSONObject jSONObject = kVar.f19748c;
                    ...
                    com.mbridge.msdk.foundation.same.f.b.b().execute(new Runnable() { // from class: com.mbridge.msdk.reward.d.c.1
                        ...
                        public final void run() {
                            ...
                            if ("v5".equals(optString)) {
                                parseCampaignUnit2 = com.mbridge.msdk.foundation.entity.b.parseV5CampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), c.this.f21658c);
                            } else {
                                parseCampaignUnit2 = com.mbridge.msdk.foundation.entity.b.parseCampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), c.this.f21658c);
                            }
                            com.mbridge.msdk.foundation.same.f.b.e().post(new Runnable() { // from class: com.mbridge.msdk.reward.d.c.1.1
                                ...
                                public final void run() {
                                    ...
                                    if (campaignUnit != null && campaignUnit.getAds() != null && parseCampaignUnit2.getAds().size() > 0) {
                                        parseCampaignUnit2.setMetricsData(c.this.f21659d);
                                    ...
                                    c cVar2 = c.this;
                                    cVar2.b(optInt, str2, cVar2.f21659d);
                                }
                            });
                        }
                    });
                ...
                a(list, jSONObject, optInt, this.f21659d);
                return;
            }
            if (i8 == 1) {
                List<com.mbridge.msdk.foundation.same.net.d.b> list2 = cVar.f19643b;
                JSONObject jSONObject2 = kVar.f19748c;
                int optInt2 = jSONObject2.optInt(NotificationCompat.CATEGORY_STATUS);
                if (1 == optInt2) {
                    calcRequestTime(System.currentTimeMillis());
                    if ("v5".equals(jSONObject2.optString("version"))) {
                        parseCampaignUnit = com.mbridge.msdk.foundation.entity.b.parseV5CampaignUnit(jSONObject2.optJSONObject(DataSchemeDataSource.SCHEME_DATA), this.f21658c);
                    } else {
                        parseCampaignUnit = com.mbridge.msdk.foundation.entity.b.parseCampaignUnit(jSONObject2.optJSONObject(DataSchemeDataSource.SCHEME_DATA), this.f21658c);
                    }
                    if (parseCampaignUnit != null && parseCampaignUnit.getListFrames() != null && parseCampaignUnit.getListFrames().size() > 0) {
                        ...
                        b(optInt2, str, this.f21659d);
                        return;
                    }
                }
                a(list2, jSONObject2, optInt2, this.f21659d);
            }
        }
    }
