...
public final class a {
    ...
    private static String f21257a = "RewardCandidateController";
    ...
    public a(String str, boolean z8) {
        try {
            this.f21258b = b.a().a(str, com.mbridge.msdk.videocommon.d.b.a().a(c.m().k(), str, z8).G());
        } catch (Exception e8) {
            e8.printStackTrace();
        }
    }
    ...
    public final void a(List<CampaignEx> list, String str, com.mbridge.msdk.reward.adapter.c cVar, String str2) {
        try {
            if (this.f21258b == null || TextUtils.isEmpty(str)) {
                return;
            }
            this.f21258b.a(com.mbridge.msdk.foundation.b.a.f18989b, 2, list, this.f21258b.a(list, str) > 0, "", "", -1, str2);
            d dVar = this.f21258b;
            JSONObject a8 = dVar.a(dVar.b(str));
            if (a8 == null || this.f21258b.d(str) <= 0.0d) {
                return;
            }
            a(this.f21258b.a(a8.optInt("max_usage_limit", 10), 0L), a8, a8.optInt("max_cache_num", 20), -1.0d, cVar, new com.mbridge.msdk.foundation.same.report.d.b(), str, false, 0);
        } catch (Exception e8) {
            e8.printStackTrace();
        }
    }
    ...
    public final com.mbridge.msdk.foundation.b.c a(String str, com.mbridge.msdk.foundation.same.report.d.b bVar, CampaignEx campaignEx, com.mbridge.msdk.foundation.c.b bVar2, int i8, com.mbridge.msdk.reward.adapter.c cVar) {
        ...
        if (dVar == null) {
            ...
            if (c8.g() > com.mbridge.msdk.foundation.b.c.f19009b) {
                return c8;
            }
            ...
            this.f21258b.a(a8.a(), bVar, requestId, i9, str2, i8, parseDouble);
        }
        return a8;
    }
    ...
    private com.mbridge.msdk.foundation.b.c a(double d8, String str, com.mbridge.msdk.reward.adapter.c cVar, com.mbridge.msdk.foundation.same.report.d.b bVar, String str2, int i8) {
        com.mbridge.msdk.foundation.b.c a8 = this.f21258b.a();
        try {
        } catch (Exception unused) {
        ...
        JSONObject a9 = this.f21258b.a(str);
        if (a9 != null) {
            ...
            if (optInt2 > 0) {
                ...
                List<com.mbridge.msdk.foundation.b.b> a10 = this.f21258b.a(optInt, System.currentTimeMillis() - (j8 * 1000));
    ...
    private com.mbridge.msdk.foundation.b.c a(List<com.mbridge.msdk.foundation.b.b> list, JSONObject jSONObject, int i8, double d8, com.mbridge.msdk.reward.adapter.c cVar, com.mbridge.msdk.foundation.same.report.d.b bVar, String str, boolean z8, int i9) {
        ...
        if (jSONObject == null) {
            ...
            cVar3.a(com.mbridge.msdk.foundation.b.c.f19010c);
            return cVar3;
        }
        if (list2 != null && list.size() != 0) {
            ...
            if (list2 == null || list2.size() <= 0) {
                ...
                if (bVar3 != null) {
                    cVar3 = cVar4;
                    cVar3.a(bVar3.b());
                    cVar3.a(com.mbridge.msdk.foundation.b.c.f19011d);
                } else {
                    cVar3 = cVar4;
    ...
    public final void a(com.mbridge.msdk.foundation.same.report.d.b bVar, String str, com.mbridge.msdk.foundation.b.c cVar, List<a.C0395a> list, JSONObject jSONObject, int i8) {
        ...
        try {
            ...
            if (cVar != null) {
                if (cVar.g() == com.mbridge.msdk.foundation.b.c.f19011d) {
                    dVar.a("result", 1);
                } else {
                    dVar.a("result", 2);
