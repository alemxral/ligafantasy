...
public final class d {
    ...
    private final com.mbridge.msdk.videocommon.d.c f21530d;
    ...
    public final e a(boolean z8, String str, int i8, String str2, String str3, String str4, String str5, boolean z9, int i9) {
        ...
        com.mbridge.msdk.videocommon.d.c cVar = this.f21530d;
        if (cVar != null) {
            i11 = cVar.t();
            i12 = this.f21530d.u();
        } else {
        ...
        String a8 = com.mbridge.msdk.foundation.same.a.d.a(this.f21528b, "reward");
        if (this.f21529c) {
            i13 = 287;
        } else {
            i13 = 94;
        ...
        com.mbridge.msdk.foundation.same.net.g.b.a(eVar, MBridgeConstans.PROPERTIES_UNIT_ID, this.f21528b);
        if (!TextUtils.isEmpty(this.f21527a)) {
            com.mbridge.msdk.foundation.same.net.g.b.a(eVar, MBridgeConstans.PLACEMENT_ID, this.f21527a);
        }
        String str10 = "";
        ...
        com.mbridge.msdk.foundation.same.net.g.b.a(eVar, e.f19716d, a8);
        String str12 = e.f19717e;
        if (str == null) {
            str6 = "";
        } else {
            str6 = str;
        ...
        com.mbridge.msdk.videocommon.d.c cVar2 = this.f21530d;
        if (cVar2 != null && !TextUtils.isEmpty(cVar2.k())) {
            com.mbridge.msdk.foundation.same.net.g.b.a(eVar, "u_stid", this.f21530d.k());
        }
