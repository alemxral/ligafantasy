...
public class a {
    ...
    private static final String f21649a = "com.mbridge.msdk.reward.c.a";

    /* renamed from: b, reason: collision with root package name */
    private static String f21650b = "";
        ...
        if (context != null) {
            try {
                ...
                try {
                    ...
                    aVar.post(0, d.f().f19683c, a16, new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.reward.c.a.1
    ...
    public static void a(final Context context, CampaignEx campaignEx, String str) {
        ...
        try {
            ...
            try {
                ...
                a9.a("r_stid", b.a().b().b());
                aVar.post(0, d.f().f19683c, a9, new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.reward.c.a.2
                    @Override // com.mbridge.msdk.foundation.same.report.e.b
