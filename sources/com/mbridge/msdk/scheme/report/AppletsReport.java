...
public class AppletsReport {
        ...
        if (context != null) {
            try {
                if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
                    ...
                    if (!TextUtils.isEmpty(a.f19397U)) {
                        stringBuffer.append("b=" + a.f19397U + "&");
                    }
                    if (!TextUtils.isEmpty(a.f19406g)) {
                        stringBuffer.append("c=" + a.f19406g + "&");
                    }
    ...
    private static void reportLoadData(Context context, String str) {
        if (context != null && !TextUtils.isEmpty(str)) {
            try {
                new com.mbridge.msdk.foundation.same.report.e.a(context).post(0, d.f().f19683c, k.a(str, context), new b() { // from class: com.mbridge.msdk.scheme.report.AppletsReport.1
