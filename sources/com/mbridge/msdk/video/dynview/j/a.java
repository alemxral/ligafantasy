...
public final class a {
    ...
    private static boolean f22087j = false;

    /* renamed from: b, reason: collision with root package name */
    private com.mbridge.msdk.video.dynview.i.c.b f22089b;

    /* renamed from: c, reason: collision with root package name */
    private Map<String, Bitmap> f22090c;

    /* renamed from: d, reason: collision with root package name */
    private volatile boolean f22091d;

    /* renamed from: e, reason: collision with root package name */
    private String f22092e = "#FFFFFFFF";

    /* renamed from: f, reason: collision with root package name */
    private String f22093f = "#60000000";

    /* renamed from: g, reason: collision with root package name */
    private String f22094g = "#FF5F5F5F";

    /* renamed from: h, reason: collision with root package name */
    private String f22095h = "#90ECECEC";

    /* renamed from: i, reason: collision with root package name */
    private volatile long f22096i = 0;

    /* renamed from: k, reason: collision with root package name */
    private com.mbridge.msdk.video.dynview.i.c.a f22097k = null;

    /* renamed from: l, reason: collision with root package name */
    private boolean f22098l = false;

    /* renamed from: m, reason: collision with root package name */
    private int f22099m = 0;

    /* renamed from: a, reason: collision with root package name */
    public com.mbridge.msdk.video.dynview.d.a f22088a = new com.mbridge.msdk.video.dynview.d.a() { // from class: com.mbridge.msdk.video.dynview.j.a.1
        @Override // com.mbridge.msdk.video.dynview.d.a
        public final void a() {
            if (a.this.f22098l && a.this.f22089b != null) {
                a.this.f22089b.a(a.this.f22099m * 1000, a.this.f22097k);
    ...
    public final class AnonymousClass9 implements com.mbridge.msdk.foundation.same.c.c {
        ...
        public final void onFailedLoad(String str, String str2) {
            try {
                int a8 = v.a(this.f22130b.getContext(), "mbridge_icon_play_bg", "drawable");
                this.f22130b.setBackgroundColor(Color.parseColor(a.this.f22094g));
                this.f22130b.setImageResource(a8);
                this.f22130b.setScaleType(ImageView.ScaleType.CENTER);
            } catch (Exception e8) {
        ...
        public final void onSuccessLoad(final Bitmap bitmap, String str) {
            if (bitmap != null && !bitmap.isRecycled()) {
                int i8 = this.f22129a;
                if (i8 != 501 && i8 != 802) {
                    this.f22130b.setImageBitmap(bitmap);
                    return;
                } else {
                    com.mbridge.msdk.foundation.same.f.b.a().execute(new Runnable() { // from class: com.mbridge.msdk.video.dynview.j.a.9.1
                        ...
                        public final void run() {
                            try {
                                ...
                                AnonymousClass9.this.f22130b.post(new Runnable() { // from class: com.mbridge.msdk.video.dynview.j.a.9.1.1
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        AnonymousClass9.this.f22130b.setImageBitmap(a8);
                                    }
                                });
                            } catch (Exception e8) {
    ...
    public final void c(com.mbridge.msdk.video.dynview.c cVar, View view, final Map map, e eVar) {
        try {
            ...
            if (map != null && map.containsKey("is_dy_success")) {
                f22087j = ((Boolean) map.get("is_dy_success")).booleanValue();
            }
            for (CampaignEx campaignEx : g8) {
                if (campaignEx != null) {
                    campaignEx.setECTemplateRenderSucc(f22087j);
                }
            }
            ListView listView = (ListView) view.findViewById(a(f22087j, "mbridge_order_view_lv"));
            GridView gridView = (GridView) view.findViewById(a(f22087j, "mbridge_order_view_h_lv"));
            ImageView imageView = (ImageView) view.findViewById(a(f22087j, "mbridge_order_view_iv_close"));
    ...
    public final void b(com.mbridge.msdk.video.dynview.c cVar, View view, Map map, e eVar) {
        ...
        ImageView imageView = (ImageView) view.findViewById(a(f22087j, "mbridge_reward_icon_riv"));
        TextView textView = (TextView) view.findViewById(a(f22087j, "mbridge_reward_title_tv"));
        LinearLayout linearLayout2 = (LinearLayout) view.findViewById(a(f22087j, "mbridge_reward_stars_mllv"));
        TextView textView2 = (TextView) view.findViewById(a(f22087j, "mbridge_reward_click_tv"));
        ImageView imageView2 = (ImageView) view.findViewById(a(f22087j, "mbridge_videoview_bg"));
        TextView textView3 = (TextView) view.findViewById(a(f22087j, "mbridge_reward_desc_tv"));
        View view2 = (RelativeLayout) view.findViewById(a(f22087j, "mbridge_reward_bottom_layout"));
    ...
    */
    ...
    private void b() {
        ...
        com.mbridge.msdk.video.dynview.i.c.b bVar = this.f22089b;
        if (bVar != null) {
            bVar.b();
            this.f22089b = null;
        }
        com.mbridge.msdk.video.dynview.b.a.a().f21988a = null;
        if (this.f22088a != null) {
            this.f22088a = null;
        }
        Map<String, Bitmap> map = this.f22090c;
        if (map != null) {
            if (map.entrySet() != null) {
                try {
                    Iterator<Map.Entry<String, Bitmap>> it = this.f22090c.entrySet().iterator();
                    while (it.hasNext()) {
        ...
        com.mbridge.msdk.foundation.same.c.b.a(imageView.getContext()).a(str, new com.mbridge.msdk.foundation.same.c.c() { // from class: com.mbridge.msdk.video.dynview.j.a.10
            ...
            public final void onSuccessLoad(Bitmap bitmap, String str2) {
                ...
                if (bitmap != null && !bitmap.isRecycled() && (imageView2 = imageView) != null) {
                    ...
                    if (a.this.f22090c != null) {
                        a.this.f22090c.put(SameMD5.getMD5(str), bitmap);
    ...
    private Bitmap a() {
        ...
        try {
            ...
            bitmap.eraseColor(Color.parseColor(this.f22095h));
            return bitmap;
        } catch (Exception e8) {
        ...
        if (map.containsKey("choice_one_callback") && (map.get("choice_one_callback") instanceof d)) {
            ...
            if (dVar != null) {
                ...
                try {
                    ...
                    dVar2.a("time", Long.valueOf(aVar.f22096i));
    ...
    static /* synthetic */ void a(a aVar, com.mbridge.msdk.video.dynview.c cVar, View view) {
        Map<String, Bitmap> map = aVar.f22090c;
        if (map == null || map.size() <= 1) {
            return;
        }
        new com.mbridge.msdk.video.dynview.h.b();
        Map<String, Bitmap> map2 = aVar.f22090c;
        if (view != null) {
