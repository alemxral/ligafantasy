...
public abstract class a extends f<JSONObject> {
    ...
    public void onSuccess(k<JSONObject> kVar) {
        ...
        if (kVar != null && (cVar = kVar.f19747b) != null && this.f22035a == 0) {
            List<b> list = cVar.f19643b;
            JSONObject jSONObject = kVar.f19748c;
            int optInt = jSONObject.optInt(NotificationCompat.CATEGORY_STATUS);
            if (1 == optInt) {
                calcRequestTime(System.currentTimeMillis());
                if ("v5".equals(jSONObject.optString("version"))) {
                    parseCampaignUnit = com.mbridge.msdk.foundation.entity.b.parseV5CampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), this.f22036b);
                } else {
                    parseCampaignUnit = com.mbridge.msdk.foundation.entity.b.parseCampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), this.f22036b);
                }
