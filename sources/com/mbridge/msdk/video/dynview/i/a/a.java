...
public class a {
    ...
    private static volatile a f22071a;

    /* renamed from: b, reason: collision with root package name */
    private View f22072b;

    /* renamed from: c, reason: collision with root package name */
    private Bitmap f22073c;

    /* renamed from: d, reason: collision with root package name */
    private Bitmap f22074d;
    ...
    public final void b() {
        ...
        Bitmap bitmap = this.f22073c;
        if (bitmap != null && !bitmap.isRecycled()) {
            this.f22073c.recycle();
            this.f22073c = null;
        }
        Bitmap bitmap2 = this.f22074d;
        if (bitmap2 != null && !bitmap2.isRecycled()) {
            this.f22074d.recycle();
            this.f22074d = null;
        }
    }
            ...
            b.a().execute(new Runnable() { // from class: com.mbridge.msdk.video.dynview.i.a.a.1
                ...
                public final void run() {
                    try {
                        ...
                        if (a.this.f22072b != null) {
                            a.this.f22072b.post(new Runnable() { // from class: com.mbridge.msdk.video.dynview.i.a.a.1.1
                                @Override // java.lang.Runnable
                                public final void run() {
                                    if (a.this.f22072b != null && a10.a() != null) {
                                        a.this.f22072b.setBackground(a10.a());
                                    }
                                }
                            });
                        }
