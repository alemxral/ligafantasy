...
public class a {
    ...
    private static volatile a f22177a;

    /* renamed from: b, reason: collision with root package name */
    private Map<String, SoftReference<MOfferModel>> f22178b = new ConcurrentHashMap();

    /* renamed from: c, reason: collision with root package name */
    private int f22179c = 500;
    ...
    public final void b() {
        ...
        try {
            Map<String, SoftReference<MOfferModel>> map = this.f22178b;
            if (map != null) {
    ...
    public final void a(final ViewGroup viewGroup, String str, com.mbridge.msdk.video.module.a.a aVar) {
        if (viewGroup == null || aVar == null || this.f22178b == null || TextUtils.isEmpty(str) || !this.f22178b.containsKey(str)) {
            return;
        }
        SoftReference<MOfferModel> softReference = this.f22178b.get(str);
    ...
    public final void a(CampaignEx campaignEx, int i8) {
        ...
        if (this.f22178b.containsKey(str)) {
            return;
        }
        try {
            ...
            if (softReference.get() != null) {
                this.f22178b.put(str, softReference);
    ...
    public final boolean a(String str) {
        if (this.f22178b == null || TextUtils.isEmpty(str)) {
            return false;
        }
        return this.f22178b.containsKey(str);
    }
        ...
        if (mOfferModel.getECParentTemplateCode() == 1302) {
            try {
                ...
                if (viewGroup instanceof MBridgeNativeEndCardView) {
                    ...
                    new com.mbridge.msdk.video.dynview.h.b().a(arrayList, 0, ai.a(com.mbridge.msdk.foundation.controller.c.m().c(), 100.0f), aVar.f22179c);
                } else {
                    relativeLayout = null;
                }
            ...
            try {
                if (viewGroup instanceof MBridgeNativeEndCardView) {
                    ...
                    new com.mbridge.msdk.video.dynview.h.b().a(arrayList2, 0, ai.a(com.mbridge.msdk.foundation.controller.c.m().c(), 100.0f), aVar.f22179c);
                }
