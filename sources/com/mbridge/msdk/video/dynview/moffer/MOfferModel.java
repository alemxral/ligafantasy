...
public class MOfferModel implements NoProGuard {
    ...
    private final String f22164K = "k";
    ...
    private final String f22163E = "e";
    ...
    */
    ...
    private void initData() {
        ...
        if (campaignEx != null && this.mContext != null) {
            ...
            String str2 = com.mbridge.msdk.foundation.same.net.g.d.f().f19667M;
            if (!TextUtils.isEmpty(this.mMainOfferCampaignEx.getReq_ext_data())) {
                try {
                    ...
                    ad.b(TAG, e8.getMessage());
                    str = com.mbridge.msdk.foundation.same.net.g.d.f().f19667M;
                }
            }
            str = str2;
            com.mbridge.msdk.foundation.same.report.d.d dVar = new com.mbridge.msdk.foundation.same.report.d.d();
