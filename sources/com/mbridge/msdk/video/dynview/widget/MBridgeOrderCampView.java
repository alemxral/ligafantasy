...
public class MBridgeOrderCampView extends MBridgeBaseView {
    ...
    private MBridgeOrderCampView f22214n;

    /* renamed from: o, reason: collision with root package name */
    private List<CampaignEx> f22215o;
    ...
    private FeedBackButton f22221u;

    /* renamed from: v, reason: collision with root package name */
    private ImageView f22222v;
    ...
    private boolean f22226z;

    public MBridgeOrderCampView(Context context) {
        super(context);
        this.f22223w = false;
        this.f22224x = new c() { // from class: com.mbridge.msdk.video.dynview.widget.MBridgeOrderCampView.1
    ...
    static /* synthetic */ void a(MBridgeOrderCampView mBridgeOrderCampView) {
        try {
            ...
            com.mbridge.msdk.foundation.same.report.d.c.a().a("2000134", mBridgeOrderCampView.f22242b);
        } catch (Throwable th) {
        ...
        com.mbridge.msdk.video.module.a.a aVar = mBridgeOrderCampView.f22245e;
        if (aVar != null) {
            aVar.a(104, "");
        }
    }
    ...
    public void createView(final ViewGroup viewGroup) {
        ...
        hashMap.put("order_view_callback", this.f22224x);
        com.mbridge.msdk.video.dynview.c b8 = new com.mbridge.msdk.video.dynview.j.c().b(com.mbridge.msdk.foundation.controller.c.m().c(), this.f22215o);
        ...
        new com.mbridge.msdk.video.dynview.h.a(b8, new g() { // from class: com.mbridge.msdk.video.dynview.widget.MBridgeOrderCampView.2
            ...
            public final void a(com.mbridge.msdk.video.dynview.a aVar) {
                if (aVar != null) {
                    try {
                        MBridgeOrderCampView.this.f22214n.addView(aVar.a());
                        MBridgeOrderCampView.this.f22223w = aVar.c();
                        viewGroup.removeAllViews();
                        viewGroup.addView(MBridgeOrderCampView.this.f22214n);
                        f.a(com.mbridge.msdk.foundation.controller.c.m().c(), (List<CampaignEx>) MBridgeOrderCampView.this.f22215o, ((CampaignEx) MBridgeOrderCampView.this.f22215o.get(0)).getCampaignUnitId());
                        MBridgeOrderCampView.this.setViewStatus();
                        if (MBridgeOrderCampView.this.f22225y != null) {
                            MBridgeOrderCampView.this.f22225y.a();
                        }
                    } catch (Exception e8) {
                        ad.b(MBridgeBaseView.TAG, e8.getMessage());
                    }
            ...
            public final void a(com.mbridge.msdk.video.dynview.c.a aVar) {
                try {
                    f.a(com.mbridge.msdk.foundation.controller.c.m().c(), (List<CampaignEx>) MBridgeOrderCampView.this.f22215o, ((CampaignEx) MBridgeOrderCampView.this.f22215o.get(0)).getCampaignUnitId(), aVar.b());
                    if (MBridgeOrderCampView.this.f22225y != null) {
                        MBridgeOrderCampView.this.f22225y.b();
                    }
                } catch (Exception e8) {
                    ad.b(MBridgeBaseView.TAG, e8.getMessage());
                }
    ...
    */
    protected void onAttachedToWindow() {
        /*
            ...
            java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> r0 = r5.f22215o
            if (r0 != 0) goto L8
            return
        L8:
            r0 = 0
        L9:
            java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> r1 = r5.f22215o
            int r1 = r1.size()
            if (r0 >= r1) goto L32
            r1 = 0
        ...
        L23:
            r1.printStackTrace()
        L26:
            com.mbridge.msdk.video.module.a.a r1 = r5.f22245e
            if (r1 == 0) goto L2f
    ...
    public void setViewStatus() {
        MBridgeOrderCampView mBridgeOrderCampView = this.f22214n;
        if (mBridgeOrderCampView != null && this.f22226z) {
            RelativeLayout relativeLayout = (RelativeLayout) mBridgeOrderCampView.findViewById(filterFindViewId(this.f22223w, "mbridge_native_order_camp_controller"));
            this.f22221u = (FeedBackButton) this.f22214n.findViewById(filterFindViewId(this.f22223w, "mbridge_native_order_camp_feed_btn"));
            this.f22222v = (ImageView) this.f22214n.findViewById(filterFindViewId(this.f22223w, "mbridge_iv_link"));
            if (relativeLayout != null) {
                relativeLayout.setPadding(this.f22216p, this.f22218r, this.f22217q, this.f22219s);
            }
            if (this.f22221u != null) {
                try {
                    List<CampaignEx> list = this.f22215o;
                    if (list != null && list.get(0) != null) {
                        this.f22220t = this.f22215o.get(0).getCampaignUnitId();
                        this.f22242b = this.f22215o.get(0);
                        com.mbridge.msdk.foundation.d.b.a().a(this.f22220t + "_2", this.f22242b);
                        if (this.f22221u != null) {
                            if (com.mbridge.msdk.foundation.d.b.a().b()) {
                                com.mbridge.msdk.foundation.d.b.a().a(this.f22220t + "_2", new com.mbridge.msdk.foundation.d.a() { // from class: com.mbridge.msdk.video.dynview.widget.MBridgeOrderCampView.3
                                ...
                                com.mbridge.msdk.foundation.d.b.a().a(this.f22220t + "_2", this.f22221u);
                            } else {
                                this.f22221u.setVisibility(8);
                            }
                        }
                    }
                    FeedBackButton feedBackButton = this.f22221u;
            ...
            ImageView imageView = this.f22222v;
                ...
                try {
                    ...
                    if (b8 != null) {
                        ...
                        if (TextUtils.isEmpty(g8)) {
                            this.f22222v.setVisibility(8);
                        }
                        this.f22222v.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.video.dynview.widget.MBridgeOrderCampView.4
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
                                com.mbridge.msdk.click.c.e(((MBridgeBaseView) MBridgeOrderCampView.this).f22241a, g8);
                            }
                        });
                        return;
                    }
    ...
    public void startAlphaAnimation() {
        ...
        this.f22214n.startAnimation(alphaAnimation);
    }

    public void startTranslateAnimation() {
        TranslateAnimation translateAnimation = new TranslateAnimation(2, 1.0f, 2, 0.0f, 2, 0.0f, 2, 0.0f);
        translateAnimation.setDuration(500L);
        this.f22214n.startAnimation(translateAnimation);
    }
    ...
    */
    static /* synthetic */ void a(com.mbridge.msdk.video.dynview.widget.MBridgeOrderCampView r8, com.mbridge.msdk.foundation.entity.CampaignEx r9, int r10, int r11) {
        ...
        L61:
            ...
            java.lang.String r9 = com.mbridge.msdk.foundation.same.a.f19409j     // Catch: org.json.JSONException -> L76
        ...
        L7b:
            r9.printStackTrace()
        L7e:
            com.mbridge.msdk.video.module.a.a r8 = r8.f22245e
            if (r8 == 0) goto L87
