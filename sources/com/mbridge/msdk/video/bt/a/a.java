...
public class a {
    ...
    private static ConcurrentHashMap<String, LinkedHashMap<String, View>> f21727a = new ConcurrentHashMap<>();

    /* renamed from: b, reason: collision with root package name */
    private static LinkedHashMap<String, String> f21728b = new LinkedHashMap<>();

    /* renamed from: c, reason: collision with root package name */
    private static LinkedHashMap<String, CampaignEx> f21729c = new LinkedHashMap<>();

    /* renamed from: d, reason: collision with root package name */
    private static LinkedHashMap<String, com.mbridge.msdk.videocommon.d.c> f21730d = new LinkedHashMap<>();

    /* renamed from: e, reason: collision with root package name */
    private static LinkedHashMap<String, String> f21731e = new LinkedHashMap<>();

    /* renamed from: f, reason: collision with root package name */
    private static LinkedHashMap<String, Integer> f21732f = new LinkedHashMap<>();

    /* renamed from: g, reason: collision with root package name */
    private static LinkedHashMap<String, Activity> f21733g = new LinkedHashMap<>();

    /* renamed from: h, reason: collision with root package name */
    private static volatile int f21734h = 10000;

    /* renamed from: i, reason: collision with root package name */
    private static int f21735i = 0;

    /* renamed from: j, reason: collision with root package name */
    private static int f21736j = 1;

    /* renamed from: k, reason: collision with root package name */
    private static String f21737k = "";

    /* renamed from: l, reason: collision with root package name */
    private static int f21738l;

    /* renamed from: m, reason: collision with root package name */
    private static int f21739m;

    /* renamed from: n, reason: collision with root package name */
    private static int f21740n;

    /* renamed from: o, reason: collision with root package name */
    private static int f21741o;

    /* renamed from: p, reason: collision with root package name */
    private static int f21742p;

    private String h(String str) {
        if (f21728b.containsKey(str)) {
            return f21728b.get(str);
        }
        return "";
    }
    ...
    public final void A(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(h8) && (windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f20580b) != null) {
    ...
    public final void K(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            LinkedHashMap<String, View> b8 = b(optString, str);
            if (b8.size() > 0 && f21731e.containsKey(optString2)) {
                View view = b8.get(optString2);
                if (view instanceof MBTempContainer) {
    ...
    public final String a() {
        f21734h++;
        return String.valueOf(f21734h);
    }

    public final String c(String str) {
        if (f21731e.containsKey(str)) {
            return f21731e.get(str);
        }
        return "";
    }
    ...
    public final int e(String str) {
        if (f21732f.containsKey(str)) {
            return f21732f.get(str).intValue();
        }
        return 2;
    }
    ...
    public final void f(String str) {
        ...
        if (f21730d.containsKey(str)) {
            f21730d.remove(str);
        }
        if (f21729c.containsKey(str)) {
            f21729c.remove(str);
        }
        if (f21728b.containsKey(str)) {
            f21728b.remove(str);
        ...
        try {
            ...
            if (b8.containsKey(optString3) && b8.containsKey(optString2)) {
                ...
                if (viewGroup != null && view != null) {
                    ...
                    if (view instanceof MBTempContainer) {
                        ad.b("OperateViews", "OperateViews setNotchString = " + String.format("%1$s-%2$s-%3$s-%4$s-%5$s", Integer.valueOf(f21738l), Integer.valueOf(f21739m), Integer.valueOf(f21740n), Integer.valueOf(f21741o), Integer.valueOf(f21742p)));
                        ((MBTempContainer) view).setNotchPadding(f21738l, f21739m, f21740n, f21741o, f21742p);
    ...
    public final void t(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            String optString2 = jSONObject.optString("id");
            String h8 = h(optString2);
            if (TextUtils.isEmpty(h8) && (windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj4).f20580b) != null) {
                h8 = windVaneWebView.getRid();
            }
            JSONObject optJSONObject = jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA);
            if (optJSONObject == null) {
    ...
    public final void d(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            if (optJSONObject != null && !TextUtils.isEmpty(optString)) {
                ...
                if (TextUtils.isEmpty(str) && (windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f20580b) != null) {
                    str = windVaneWebView.getRid();
                }
                LinkedHashMap<String, View> b8 = b(optString, str);
                String a9 = a();
                ...
                f21731e.put(a9, optString);
                f21729c.put(a9, parseCampaignWithBackData);
                f21730d.put(a9, a8);
                a(obj, a9);
    ...
    public final synchronized LinkedHashMap<String, View> b(String str, String str2) {
        if (f21727a.containsKey(str + "_" + str2)) {
            return f21727a.get(str + "_" + str2);
        }
        LinkedHashMap<String, View> linkedHashMap = new LinkedHashMap<>();
        f21727a.put(str + "_" + str2, linkedHashMap);
    ...
    public final void a(String str, String str2) {
        f21728b.put(str, str2);
    }

    public final void a(String str, Activity activity) {
        f21733g.put(str, activity);
    }

    public final void a(String str, int i8) {
        f21732f.put(str, Integer.valueOf(i8));
    }
    ...
    static /* synthetic */ void a(a aVar, String str, CampaignEx campaignEx) {
        if (com.mbridge.msdk.foundation.same.a.d.f19441j == null || TextUtils.isEmpty(campaignEx.getId())) {
            return;
        }
