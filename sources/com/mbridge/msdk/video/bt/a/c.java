...
public final class c {
    ...
    private static final class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static c f21764a = new c();
    }
    ...
    private c() {
        this.f21763c = "handlerNativeResult";
        this.f21761a = 0;
        this.f21762b = 1;
    }
            ...
            try {
                if (!TextUtils.isEmpty(jSONObject.toString())) {
                    ...
                    if (!TextUtils.isEmpty(optString) && !TextUtils.isEmpty(optString2)) {
                        ...
                        a(this.f21761a, "receivedMessage", obj);
                    ...
                    a(this.f21762b, "module or method is null", obj);
                    return;
                }
            } catch (Exception e8) {
                ad.a("HandlerH5MessageManager", e8.getMessage());
                a(this.f21762b, e8.getMessage(), obj);
                return;
            } catch (Throwable th) {
                ad.a("HandlerH5MessageManager", th.getMessage());
                a(this.f21762b, th.getMessage(), obj);
                return;
            }
        }
        a(this.f21762b, "params is null", obj);
    }
