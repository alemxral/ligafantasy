...
public class f {
    ...
    private static final String f21972a = "com.mbridge.msdk.video.bt.module.b.f";
        ...
        if (context != null) {
            try {
                ...
                try {
                    ...
                    aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, a16, new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.video.bt.module.b.f.1
    ...
    private static void a(final Context context, final String str, String str2) {
        ...
        try {
            ...
            aVar.post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19683c, a8, new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.video.bt.module.b.f.2
                @Override // com.mbridge.msdk.foundation.same.report.e.b
