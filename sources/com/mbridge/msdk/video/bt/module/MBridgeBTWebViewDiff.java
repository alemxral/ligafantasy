...
public abstract class MBridgeBTWebViewDiff extends BTBaseView implements i, b {
    ...
    public void open(String str) {
        try {
            ...
            a aVar = new a(getContext(), this.f21770c);
            aVar.a(this);
            aVar.a(this.f21769b);
    ...
    public void reportOpen(String str) {
        try {
            ...
            if (mraidCampaign != null) {
                new com.mbridge.msdk.foundation.same.report.i(getContext()).a(mraidCampaign.getRequestId(), mraidCampaign.getRequestIdNotice(), mraidCampaign.getId(), this.f21770c, str, this.f21769b.isBidCampaign());
            }
        } catch (Throwable th) {
