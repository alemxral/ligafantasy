...
public class BaseRewardSignalH5 extends a {
    ...
    public void getEndScreenInfo(Object obj, String str) {
        String str2;
        try {
            IJSFactory iJSFactory = this.f22622a;
            if (iJSFactory != null) {
    ...
    public void handlerPlayableException(Object obj, String str) {
        try {
            if (this.f22622a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22622a.getIJSRewardVideoV1().c(optString);
            }
        } catch (Throwable th) {
    ...
    public void initialize(Context context, WindVaneWebView windVaneWebView) {
        if (context instanceof IJSFactory) {
            this.f22622a = (IJSFactory) context;
        }
    }
    ...
    public void install(Object obj, String str) {
        try {
            if (this.f22622a != null) {
                ...
                if (this.f22622a.getJSContainerModule().endCardShowing()) {
                    this.f22622a.getJSCommon().click(3, str);
                } else {
                    this.f22622a.getJSCommon().click(1, str);
                }
            }
        } catch (Throwable th) {
    ...
    public void notifyCloseBtn(Object obj, String str) {
        try {
            if (this.f22622a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22622a.getIJSRewardVideoV1().notifyCloseBtn(optInt);
            }
        } catch (Throwable th) {
    ...
    public void openURL(Object obj, String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            if (c8 == null) {
                try {
                    if ((obj instanceof com.mbridge.msdk.mbsignalcommon.windvane.a) && (windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f20580b) != null) {
    ...
    public void setOrientation(Object obj, String str) {
        try {
            if (this.f22622a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22622a.getIJSRewardVideoV1().b(optString);
            }
        } catch (Throwable th) {
            ad.a("JS-Reward-Communication", "setOrientation", th);
        }
    ...
    public void toggleCloseBtn(Object obj, String str) {
        try {
            if (this.f22622a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22622a.getIJSRewardVideoV1().toggleCloseBtn(optInt);
            }
        } catch (Throwable th) {
    ...
    public void triggerCloseBtn(Object obj, String str) {
        try {
            if (this.f22622a != null && !TextUtils.isEmpty(str)) {
                g.a().a(obj, a(0));
                this.f22622a.getIJSRewardVideoV1().a(new JSONObject(str).optString("state"));
