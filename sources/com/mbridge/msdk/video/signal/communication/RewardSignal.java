...
public class RewardSignal extends BaseRewardSignal implements BaseIRewardCommunication {
    ...
    public static final /* synthetic */ int f22625g = 0;

    /* renamed from: e, reason: collision with root package name */
    private Handler f22626e = new Handler(Looper.getMainLooper());
    ...
    public void getEndScreenInfo(final Object obj, final String str) {
        if (ai.g()) {
            ...
            this.f22626e.post(new Runnable() { // from class: com.mbridge.msdk.video.signal.communication.RewardSignal.1
    ...
    public void handlerPlayableException(final Object obj, final String str) {
        if (ai.g()) {
            ...
            this.f22626e.post(new Runnable() { // from class: com.mbridge.msdk.video.signal.communication.RewardSignal.7
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void install(final Object obj, final String str) {
        if (ai.g()) {
            ...
            this.f22626e.post(new Runnable() { // from class: com.mbridge.msdk.video.signal.communication.RewardSignal.2
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void notifyCloseBtn(final Object obj, final String str) {
        if (ai.g()) {
            ...
            this.f22626e.post(new Runnable() { // from class: com.mbridge.msdk.video.signal.communication.RewardSignal.3
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void openURL(final Object obj, final String str) {
        if (ai.g()) {
            ...
            this.f22626e.post(new Runnable() { // from class: com.mbridge.msdk.video.signal.communication.RewardSignal.8
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void setOrientation(final Object obj, final String str) {
        if (ai.g()) {
            ...
            this.f22626e.post(new Runnable() { // from class: com.mbridge.msdk.video.signal.communication.RewardSignal.6
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void toggleCloseBtn(final Object obj, final String str) {
        if (ai.g()) {
            ...
            this.f22626e.post(new Runnable() { // from class: com.mbridge.msdk.video.signal.communication.RewardSignal.4
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void triggerCloseBtn(final Object obj, final String str) {
        if (ai.g()) {
            ...
            this.f22626e.post(new Runnable() { // from class: com.mbridge.msdk.video.signal.communication.RewardSignal.5
                @Override // java.lang.Runnable
                public final void run() {
                    RewardSignal.super.getEndScreenInfo(obj, str);
                }
