...
public class BaseVideoCommunication extends AbsFeedBackForH5 implements IVideoCommunication {
    ...
    protected IJSFactory f22623a;

    /* renamed from: e, reason: collision with root package name */
    private FastKV f22624e = null;
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                try {
                    ...
                    try {
                        JSONObject jSONObject = new JSONObject();
                        jSONObject.put("code", com.mbridge.msdk.mbsignalcommon.communication.d.f20539b);
    ...
    public void clearAllCache(Object obj, String str) {
        ...
        if (this.f22624e == null) {
            try {
                this.f22624e = new FastKV.Builder(e.a(com.mbridge.msdk.foundation.same.b.c.MBRIDGE_700_CONFIG), "MBridgeH5CacheSP").build();
            } catch (Exception unused) {
                this.f22624e = null;
            }
        }
        FastKV fastKV = this.f22624e;
        if (fastKV != null) {
            try {
                try {
                    fastKV.clear();
    ...
    public void click(Object obj, String str) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                IJSFactory iJSFactory = this.f22623a;
                if (iJSFactory != null) {
                ...
                if (obj != null) {
                    ...
                    if ((aVar.f20580b.getObject() instanceof k) && (kVar = (k) aVar.f20580b.getObject()) != null) {
                        kVar.click(i8, str2);
                    }
                }
            }
    ...
    public void closeVideoOperte(Object obj, String str) {
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                JSONObject jSONObject = new JSONObject(str);
                ...
                this.f22623a.getJSVideoModule().closeVideoOperate(optInt, optInt2);
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
    ...
    public void closeWeb(Object obj, String str) {
        ...
        try {
            if (!TextUtils.isEmpty(str) && this.f22623a != null && !TextUtils.isEmpty(str)) {
                int optInt = new JSONObject(str).optInt(NotificationCompat.CATEGORY_STATUS);
                this.f22623a.getJSContainerModule().hideAlertWebview();
                this.f22623a.getJSVideoModule().hideAlertView(optInt);
            }
        } catch (Throwable th) {
    ...
    */
    ...
    public void getCutout(Object obj, String str) {
        try {
            String i8 = this.f22623a.getJSCommon().i();
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                if (this.f22623a != null) {
                    while (i8 < jSONArray.length()) {
                        ...
                        jSONObject.put(a(i9), this.f22623a.getJSCommon().g(i9));
                        i8++;
                    }
                } else if (obj != null) {
                    while (i8 < jSONArray.length()) {
                        ...
                        com.mbridge.msdk.mbsignalcommon.windvane.a aVar = (com.mbridge.msdk.mbsignalcommon.windvane.a) obj;
                        if (aVar.f20580b.getObject() instanceof k) {
                            jSONObject.put(a(i10), ((k) aVar.f20580b.getObject()).g(i10));
                        }
                        i8++;
                    }
                }
    ...
    public void handlerH5Exception(Object obj, String str) {
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22623a.getJSCommon().handlerH5Exception(jSONObject.optInt("code", -999), jSONObject.optString("message", "h5 error"));
            }
        } catch (Throwable th) {
    ...
    public void init(Object obj, String str) {
        ...
        try {
            ...
            if (iJSFactory != null) {
                ...
                g.a().a(obj, c8);
                this.f22623a.getJSCommon().b(true);
                if (!TextUtils.isEmpty(str)) {
                    JSONObject jSONObject = new JSONObject(str);
                    ...
                    com.mbridge.msdk.video.signal.d jSCommon = this.f22623a.getJSCommon();
                    if (optInt == 1) {
                        z8 = true;
                    }
                    jSCommon.a(z8);
                    this.f22623a.getJSCommon().b(optInt2);
                    this.f22623a.getJSCommon().c(optInt3);
                    this.f22623a.getJSCommon().d(optInt4);
                    this.f22623a.getJSCommon().e(optInt5);
                    com.mbridge.msdk.video.signal.d jSCommon2 = this.f22623a.getJSCommon();
                    if (optInt6 != 0) {
                        i8 = optInt6;
                    }
                    jSCommon2.h(i8);
            ...
            if (obj != null) {
                com.mbridge.msdk.mbsignalcommon.windvane.a aVar = (com.mbridge.msdk.mbsignalcommon.windvane.a) obj;
                if (aVar.f20580b.getObject() instanceof k) {
                    k kVar = (k) aVar.f20580b.getObject();
                    String c9 = kVar.c();
                    if (!TextUtils.isEmpty(str)) {
    ...
    public void isSystemResume(Object obj, String str) {
        try {
            if (this.f22623a != null) {
                ...
                g.a().a(obj, b(this.f22623a.getActivityProxy().h()));
            }
        } catch (Throwable th) {
    ...
    public void ivRewardAdsWithoutVideo(Object obj, String str) {
        ...
        try {
            if (!TextUtils.isEmpty(str) && this.f22623a != null && !TextUtils.isEmpty(str)) {
                this.f22623a.getJSContainerModule().ivRewardAdsWithoutVideo(str);
            }
        } catch (Throwable th) {
    ...
    public void loadads(Object obj, String str) {
        ...
        try {
            ...
            if (obj != null) {
                WindVaneWebView windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f20580b;
    ...
    public void notifyCloseBtn(Object obj, String str) {
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22623a.getJSVideoModule().notifyCloseBtn(optInt);
            }
        } catch (Throwable th) {
    ...
    public void openURL(Object obj, String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                if (optInt == 1) {
                    com.mbridge.msdk.click.c.c(this.f20603b, optString);
                } else if (optInt == 2) {
                    com.mbridge.msdk.click.c.e(this.f20603b, optString);
                }
            } catch (JSONException e8) {
    ...
    public void playVideoFinishOperate(Object obj, String str) {
        try {
            if (!TextUtils.isEmpty(str) && this.f22623a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22623a.getJSCommon().f(optInt);
            }
        } catch (Throwable th) {
    ...
    public void progressBarOperate(Object obj, String str) {
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                this.f22623a.getJSVideoModule().progressBarOperate(new JSONObject(str).optInt("view_visible"));
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
    ...
    public void progressOperate(Object obj, String str) {
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22623a.getJSVideoModule().progressOperate(optInt, optInt2);
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
            ad.a("JS-Video-Brigde", "progressOperate error", th);
    ...
    public void reactDeveloper(Object obj, String str) {
        ...
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                this.f22623a.getJSBTModule().reactDeveloper(obj, str);
            } else {
                g.a().b(obj, b(1));
            }
        } catch (Throwable th) {
    ...
    public void readyStatus(Object obj, String str) {
        if (obj != null) {
            try {
                ...
                int optInt = new JSONObject(str).optInt("isReady", 1);
                if (aVar.f20580b.getObject() instanceof k) {
                    ((k) aVar.f20580b.getObject()).i(optInt);
                }
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                if (iJSFactory != null && iJSFactory.getJSBTModule() != null) {
                    if (this.f22623a.getJSBTModule() instanceof j) {
                        this.f22623a.getJSBTModule().reportUrls(obj, str);
                    } else {
                        d.c().b(obj, str);
                    }
                } else {
    ...
    */
    ...
    public void setScaleFitXY(Object obj, String str) {
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22623a.getJSVideoModule().setScaleFitXY(optInt);
            }
        } catch (Throwable th) {
    ...
    public void showAlertView(Object obj, String str) {
        ...
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                this.f22623a.getJSVideoModule().showIVRewardAlertView(str);
    ...
    public void showVideoClickView(Object obj, String str) {
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22623a.getJSContainerModule().showVideoClickView(optInt);
            }
        } catch (Throwable th) {
            ad.a("JS-Video-Brigde", "showVideoClickView error", th);
        }
    ...
    public void showVideoLocation(Object obj, String str) {
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22623a.getJSVideoModule().showVideoLocation(optInt, optInt2, optInt3, optInt4, optInt5, optInt6, optInt7, optInt8, optInt9);
                this.f22623a.getJSCommon().f();
            }
        } catch (Throwable th) {
    ...
    public void soundOperate(Object obj, String str) {
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                ...
                if (TextUtils.isEmpty(optString)) {
                    this.f22623a.getJSVideoModule().soundOperate(optInt, optInt2);
                } else {
                    this.f22623a.getJSVideoModule().soundOperate(optInt, optInt2, optString);
                }
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
    ...
    public void statistics(Object obj, String str) {
        ...
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                JSONObject jSONObject = new JSONObject(str);
                this.f22623a.getJSCommon().a(jSONObject.optInt("type"), jSONObject.optString(DataSchemeDataSource.SCHEME_DATA));
            }
        } catch (Throwable th) {
    ...
    public void toggleCloseBtn(Object obj, String str) {
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22623a.getJSVideoModule().closeVideoOperate(0, i8);
            }
        } catch (Throwable th) {
    ...
    public void triggerCloseBtn(Object obj, String str) {
        ...
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str) && new JSONObject(str).optString("state").equals(CampaignEx.JSON_NATIVE_VIDEO_CLICK)) {
                this.f22623a.getJSVideoModule().closeVideoOperate(1, -1);
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
    ...
    public void videoOperate(Object obj, String str) {
        try {
            if (this.f22623a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f22623a.getJSVideoModule().videoOperate(optInt);
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
