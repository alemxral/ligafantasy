...
public class BaseRewardSignal extends BaseRewardSignalDiff {
    ...
    protected BaseIRewardCommunication f22621a;
    ...
    public void getEndScreenInfo(Object obj, String str) {
        try {
            BaseIRewardCommunication baseIRewardCommunication = this.f22621a;
    ...
    public void handlerPlayableException(Object obj, String str) {
        try {
            if (this.f22621a != null && !TextUtils.isEmpty(str)) {
                this.f22621a.handlerPlayableException(obj, str);
            }
        } catch (Throwable th) {
    ...
    public void initialize(Context context, WindVaneWebView windVaneWebView) {
        ...
        try {
            if (z8) {
                this.f22621a = (BaseIRewardCommunication) BaseRewardSignalH5.class.newInstance();
                BaseRewardSignalH5.class.getMethod("initialize", Context.class, WindVaneWebView.class).invoke(this.f22621a, context, windVaneWebView);
            } else if (windVaneWebView.getObject() != null && (windVaneWebView.getObject() instanceof BaseIRewardCommunication)) {
                this.f22621a = (BaseIRewardCommunication) windVaneWebView.getObject();
            }
        } catch (Exception e9) {
        ...
        try {
            ...
            if (obj != null) {
                ...
                if (aVar.f20580b.getObject() instanceof k) {
                    ((k) aVar.f20580b.getObject()).click(1, str);
    ...
    public void notifyCloseBtn(Object obj, String str) {
        try {
            if (this.f22621a != null && !TextUtils.isEmpty(str)) {
                this.f22621a.notifyCloseBtn(obj, str);
            }
        } catch (Throwable th) {
    ...
    public void setOrientation(Object obj, String str) {
        try {
            if (this.f22621a != null && !TextUtils.isEmpty(str)) {
                this.f22621a.setOrientation(obj, str);
            }
        } catch (Throwable th) {
    ...
    public void toggleCloseBtn(Object obj, String str) {
        try {
            if (this.f22621a != null && !TextUtils.isEmpty(str)) {
                this.f22621a.toggleCloseBtn(obj, str);
            }
        } catch (Throwable th) {
    ...
    public void triggerCloseBtn(Object obj, String str) {
        try {
            if (this.f22621a != null && !TextUtils.isEmpty(str)) {
                this.f22621a.triggerCloseBtn(obj, str);
            }
        } catch (Throwable th) {
    ...
    public void initialize(Object obj, WindVaneWebView windVaneWebView) {
        ...
        try {
            if (z8) {
                this.f22621a = (BaseIRewardCommunication) BaseRewardSignalH5.class.newInstance();
                BaseRewardSignalH5.class.getMethod("initialize", Object.class, WindVaneWebView.class).invoke(this.f22621a, obj, windVaneWebView);
            } else if (windVaneWebView.getObject() != null && (windVaneWebView.getObject() instanceof BaseIRewardCommunication)) {
                this.f22621a = (BaseIRewardCommunication) windVaneWebView.getObject();
            }
        } catch (Exception e9) {
