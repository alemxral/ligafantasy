...
public final class o extends p {
    ...
    public final String a() {
        if (this.f22619b == null) {
            ...
            try {
                ...
                arrayList.add(this.f22619b.getCampaign());
                String unitID = this.f22619b.getUnitID();
                ...
                ad.a("JSRewardVideoV1", "getEndScreenInfo success campaign = " + this.f22619b.getCampaign());
        ...
        try {
            if (this.f22618a != null && !TextUtils.isEmpty(str)) {
                if (str.equals("landscape")) {
                    this.f22618a.setRequestedOrientation(0);
                } else if (str.equals("portrait")) {
                    this.f22618a.setRequestedOrientation(1);
                }
            }
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    public final void c(String str) {
        ...
        super.c(str);
        try {
            if (this.f22618a != null && !TextUtils.isEmpty(str) && (mBridgeContainerView = this.f22619b) != null) {
    ...
    public final void notifyCloseBtn(int i8) {
        ...
        MBridgeContainerView mBridgeContainerView = this.f22619b;
    ...
    public final void a(String str) {
        ...
        super.a(str);
        try {
            if (this.f22618a == null || TextUtils.isEmpty(str) || !str.equals(CampaignEx.JSON_NATIVE_VIDEO_CLICK) || (mBridgeContainerView = this.f22619b) == null) {
                return;
            }
