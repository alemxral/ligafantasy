...
public final class k extends l {
    ...
    private CampaignEx f22602s;

    /* renamed from: t, reason: collision with root package name */
    private List<CampaignEx> f22603t;
    ...
    private boolean f22607x = false;

    /* renamed from: y, reason: collision with root package name */
    private boolean f22608y = false;

    public k(Activity activity, CampaignEx campaignEx) {
        this.f22599p = activity;
        this.f22602s = campaignEx;
    }
    ...
    private String p() {
        ...
        try {
            jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, this.f22587j);
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put("instanceId", this.f22605v);
            jSONObject2.put("rootViewInstanceId", this.f22606w);
            jSONObject2.put("isRootTemplateWebView", this.f22607x);
            jSONObject.put("sdk_info", "MAL_16.7.31,3.0.1");
            jSONObject2.put("playVideoMute", this.f22591n);
            jSONObject.put("sdkSetting", jSONObject2);
            a(jSONObject);
            JSONArray jSONArray = new JSONArray();
            List<CampaignEx> list = this.f22603t;
            if (list != null && list.size() > 0) {
                for (CampaignEx campaignEx : this.f22603t) {
                    jSONArray.put(CampaignEx.campaignToJsonObject(campaignEx, campaignEx.isReady(), b(campaignEx)));
                }
            } else {
                jSONArray.put(CampaignEx.campaignToJsonObject(this.f22602s));
            }
            ...
            if (!TextUtils.isEmpty(g8)) {
                ...
                b(jSONObject3);
                String c8 = com.mbridge.msdk.c.h.a().c(this.f22587j);
            ...
            if (!TextUtils.isEmpty(this.f22587j)) {
                jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, this.f22587j);
            }
            if (this.f22608y) {
                obj = "1";
    ...
    private JSONObject u() {
        JSONObject jSONObject = new JSONObject();
        try {
            com.mbridge.msdk.videocommon.d.c cVar = this.f22588k;
            if (cVar != null) {
    ...
    public final void click(int i8, String str) {
        ...
        super.click(i8, str);
        CampaignEx campaignEx = this.f22602s;
        if (campaignEx != null) {
            if (campaignEx.getDynamicTempCode() == 5 && this.f22602s != null && (list2 = this.f22603t) != null && list2.size() != 0) {
                try {
                    JSONObject jSONObject = new JSONObject(str);
                    if (jSONObject.has("camp_position")) {
                        this.f22602s = this.f22603t.get(jSONObject.getInt("camp_position"));
                    }
                } catch (JSONException e8) {
                    e8.printStackTrace();
                }
            }
            CampaignEx campaignEx2 = this.f22602s;
            if (i8 == 3) {
        ...
        try {
            if (i8 != 1) {
                ...
                CampaignEx campaignEx3 = this.f22602s;
                if (campaignEx3 != null && campaignEx3.getCbd() > -2) {
                    i9 = this.f22602s.getCbd();
                } else {
                    com.mbridge.msdk.videocommon.d.c cVar = this.f22588k;
                    if (cVar != null) {
                        i9 = cVar.p();
                ...
                if (i9 == -1) {
                    a(new a.b(this, this.f22590m));
                }
                click(1, str);
                return;
            }
            if (this.f22602s == null && (list = this.f22603t) != null && list.size() > 0) {
                this.f22602s = this.f22603t.get(0);
            }
            CampaignEx campaignEx4 = this.f22602s;
            if (campaignEx4 == null) {
                return;
            }
    ...
    public final void f() {
        super.f();
        a.InterfaceC0437a interfaceC0437a = this.f22590m;
    ...
    private void b(JSONObject jSONObject) {
        try {
            ...
            String obj = al.a(c8, "MBridge_ConfirmTitle" + this.f22587j, "").toString();
            String obj2 = al.a(c8, "MBridge_ConfirmContent" + this.f22587j, "").toString();
            String obj3 = al.a(c8, "MBridge_CancelText" + this.f22587j, "").toString();
            String obj4 = al.a(c8, "MBridge_ConfirmText" + this.f22587j, "").toString();
    ...
    public final String c() {
        this.f22590m.a();
        this.f22578a = true;
        if (TextUtils.isEmpty(this.f22600q)) {
            this.f22600q = p();
        } else {
            this.f22600q = ai.b(this.f22600q, "tun", z.q() + "");
        }
        return this.f22600q;
    }
    ...
    public final void d() {
        super.d();
        try {
            Activity activity = this.f22599p;
            if (activity != null) {
                activity.finish();
            }
        } catch (Throwable th) {
        ...
        if (!str.contains("notice")) {
            try {
                ...
                if (!TextUtils.isEmpty(str)) {
                    ...
                    JSONObject optJSONObject = new JSONObject(str).optJSONObject(com.mbridge.msdk.foundation.same.a.f19409j);
                    if (optJSONObject != null) {
                        str2 = String.valueOf(ai.a(this.f22599p, Integer.valueOf(optJSONObject.getString(com.mbridge.msdk.foundation.same.a.f19407h)).intValue()));
                        str3 = String.valueOf(ai.a(this.f22599p, Integer.valueOf(optJSONObject.getString(com.mbridge.msdk.foundation.same.a.f19408i)).intValue()));
                    } else {
                        str2 = "-999";
                        str3 = "-999";
                    }
                    ...
                    if (optJSONObject != null) {
                        ...
                        while (keys.hasNext()) {
                            ...
                            if (com.mbridge.msdk.foundation.same.a.f19407h.equals(next) || com.mbridge.msdk.foundation.same.a.f19408i.equals(next)) {
                                optString = String.valueOf(ai.a(this.f22599p, Integer.valueOf(optString).intValue()));
                            }
                            sb.append(next);
                            sb.append("=");
                            sb.append(optString);
    ...
    public final void a(int i8, String str) {
        ...
        try {
            ...
            final String optString4 = jSONObject.optString(MBridgeConstans.PROPERTIES_UNIT_ID, this.f22587j);
            final int l8 = z.l(this.f22599p.getApplication());
            Runnable runnable = new Runnable() { // from class: com.mbridge.msdk.video.signal.a.k.1
                @Override // java.lang.Runnable
                public final void run() {
                    com.mbridge.msdk.foundation.db.q.a(com.mbridge.msdk.foundation.db.h.a(k.this.f22599p.getApplication())).a(new com.mbridge.msdk.foundation.entity.n("2000039", optString, optString2, optString3, optString4, k.this.f22602s.getId(), l8, z.a(k.this.f22599p.getApplication(), l8)));
                }
            };
