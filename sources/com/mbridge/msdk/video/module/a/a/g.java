...
public final class g extends i {
    ...
    public final void a(int i8, Object obj) {
        ...
        switch (i8) {
            case 100:
                MBridgeClickMiniCardView mBridgeClickMiniCardView = this.f22525a;
                if (mBridgeClickMiniCardView != null) {
                    mBridgeClickMiniCardView.webviewshow();
                    MBridgeClickMiniCardView mBridgeClickMiniCardView2 = this.f22525a;
