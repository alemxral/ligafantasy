...
public class MBridgeClickMiniCardView extends MBridgeH5EndCardView {
    ...
    public void resizeMiniCard(int i8, int i9) {
        View findViewById = ((Activity) this.f22241a).getWindow().findViewById(R.id.content);
        int width = findViewById.getWidth();
        int height = findViewById.getHeight();
        if (i8 > 0 && i9 > 0 && i8 <= width && i9 <= height) {
            ViewGroup.LayoutParams layoutParams = this.f22327n.getLayoutParams();
            layoutParams.width = i8;
            layoutParams.height = i9;
            this.f22327n.setLayoutParams(layoutParams);
        }
    }
    ...
    public void setRadius(int i8) {
        if (i8 > 0) {
            ...
            this.f22330q.setBackground(gradientDrawable);
            this.f22330q.setClipToOutline(true);
        }
    }
    ...
    public void webviewshow() {
        ...
        if (windVaneWebView != null) {
            windVaneWebView.post(new Runnable() { // from class: com.mbridge.msdk.video.module.MBridgeClickMiniCardView.1
                ...
                public final void run() {
                    try {
                        ...
                        try {
                            int[] iArr = new int[2];
                            MBridgeClickMiniCardView.this.f22330q.getLocationOnScreen(iArr);
                        ...
                        g.a().a((WebView) MBridgeClickMiniCardView.this.f22330q, "webviewshow", Base64.encodeToString(str.toString().getBytes(), 2));
                    } catch (Exception e8) {
                        e8.printStackTrace();
                    }
                }
            ...
            d dVar = new d();
            dVar.a("type", 3);
            com.mbridge.msdk.foundation.same.report.d.c.a().a("2000133", this.f22242b, dVar);
        }
    }
    ...
    private void a(View view) {
        ...
        layoutParams.height = (int) ((ai.e(this.f22241a) * 0.7f) + 0.5f);
