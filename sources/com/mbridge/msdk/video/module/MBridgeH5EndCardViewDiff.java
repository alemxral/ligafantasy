...
public abstract class MBridgeH5EndCardViewDiff extends MBridgeBaseView implements i, b, h {
    ...
    public void open(String str) {
        try {
            String clickURL = this.f22242b.getClickURL();
            if (!TextUtils.isEmpty(str)) {
                this.f22242b.setClickURL(str);
                reportOpen(str);
            }
            a aVar = new a(getContext(), this.unitId);
            aVar.a(this);
            aVar.a(this.f22242b);
            this.f22242b.setClickURL(clickURL);
            this.f22245e.a(126, "");
        } catch (Exception e8) {
    ...
    public void reportOpen(String str) {
        ...
        if (mraidCampaign != null) {
            new com.mbridge.msdk.foundation.same.report.i(getContext()).a(mraidCampaign.getRequestId(), mraidCampaign.getRequestIdNotice(), mraidCampaign.getId(), this.unitId, str, this.f22242b.isBidCampaign());
        }
    }
