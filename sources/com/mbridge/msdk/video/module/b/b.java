...
public final class b {
    ...
    public static HashMap<String, ArrayList<String>> f22577a = new HashMap<>();
    ...
    public static void d(Context context, CampaignEx campaignEx) {
        if (campaignEx != null && campaignEx.getNativeVideoTracking() != null && campaignEx.getNativeVideoTracking().l() != null) {
            ...
            ArrayList<String> arrayList = f22577a.get(campaignUnitId);
            if (arrayList == null) {
                arrayList = new ArrayList<>();
                f22577a.put(campaignUnitId, arrayList);
            }
    ...
    public static void a(String str, String str2) {
        try {
            ...
            aVar.post(0, d.f().f19683c, a8, new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.video.module.b.b.1
