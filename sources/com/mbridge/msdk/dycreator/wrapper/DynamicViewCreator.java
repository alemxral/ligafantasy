...
public class DynamicViewCreator {
    ...
    private static volatile DynamicViewCreator f18733a = null;

    /* renamed from: b, reason: collision with root package name */
    private static int f18734b = -201;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f18735a[DyAdType.REWARD.ordinal()] = 2;
    ...
    public static DynamicViewCreator getInstance() {
        if (f18733a == null) {
            synchronized (DynamicViewCreator.class) {
                try {
                    if (f18733a == null) {
                        f18733a = new DynamicViewCreator();
                    }
                } finally {
                }
            }
    ...
    public void createDynamicView(DyOption dyOption, DynamicViewBackListener dynamicViewBackListener) {
        ...
        if (z9) {
            try {
                ...
                int i8 = AnonymousClass1.f18735a[dyOption.getDyAdType().ordinal()];
                if (i8 == 1) {
                ...
                ad.b("DynamicViewCreator", e8.getMessage());
                dynamicViewBackListener.viewCreateFail(new a(f18734b, e8.getMessage()));
            }
        }
    }
