            ...
            for (int i8 = 0; i8 < attributeCount; i8++) {
                ...
                if (!TextUtils.isEmpty(attributeName)) {
                    if (attributeName.equals("mbridge_data")) {
                        try {
                            hashMap.put("mbridgeData", b.f18671a.get(attributeSet.getAttributeValue(i8).substring(8)));
                        } catch (Exception e8) {
                            e8.printStackTrace();
                        }
                    }
                    if (attributeName.equals("mbridge_click")) {
                        try {
                            hashMap.put("mbridgeAction", b.f18671a.get(attributeSet.getAttributeValue(i8).substring(8)));
                        } catch (Exception e9) {
                            e9.printStackTrace();
                        }
                    }
                    if (attributeName.equals("mbridge_strategy")) {
                        try {
                            hashMap.put("mbridgeStrategy", b.f18671a.get(attributeSet.getAttributeValue(i8).substring(8)));
                        } catch (Exception e10) {
                            e10.printStackTrace();
                        }
                    }
                    if (attributeName.equals("mbridge_effect")) {
                        try {
                            hashMap.put("mbridgeEffect", b.f18671a.get(attributeSet.getAttributeValue(i8).substring(8)));
                        } catch (Exception e11) {
                            e11.printStackTrace();
                        }
                    }
