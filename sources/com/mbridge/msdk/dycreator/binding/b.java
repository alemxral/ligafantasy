...
public final class b {
    ...
    private static volatile b f18577a;

    /* renamed from: b, reason: collision with root package name */
    private d f18578b = (d) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0393a.VIEW_OBSERVER);

    /* renamed from: c, reason: collision with root package name */
    private com.mbridge.msdk.dycreator.g.c f18579c = (com.mbridge.msdk.dycreator.g.c) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0393a.CLICK_OBSERVER);

    /* renamed from: d, reason: collision with root package name */
    private f f18580d = (f) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0393a.EFFECT_OBSERVER);

    /* renamed from: e, reason: collision with root package name */
    private h f18581e = (h) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0393a.REPORT_OBSERVER);

    /* renamed from: f, reason: collision with root package name */
    private BaseViewModel f18582f;

    /* renamed from: g, reason: collision with root package name */
    private com.mbridge.msdk.shake.b f18583g;
                ...
                if (view instanceof InterBase) {
                    ...
                    if (!TextUtils.isEmpty(actionDes)) {
                        if (actionDes.startsWith(CampaignEx.JSON_NATIVE_VIDEO_CLICK)) {
                            ...
                            int id = view.getId();
                            com.mbridge.msdk.dycreator.g.c cVar = this.f18579c;
                            if (cVar != null) {
                                cVar.a(bVar, id);
                            }
    ...
    public final void a(BaseViewModel baseViewModel) {
        this.f18582f = baseViewModel;
        if (baseViewModel != null) {
            baseViewModel.setClickSubject(this.f18579c);
            this.f18582f.setConcreteSubject(this.f18578b);
            this.f18582f.setEffectSubject(this.f18580d);
            this.f18582f.setReportSubject(this.f18581e);
        }
    }
    ...
    private com.mbridge.msdk.shake.b a(final View view, final MBSplashData mBSplashData) {
        if (mBSplashData != null) {
            try {
                ...
                if (dyOption != null && dyOption.isShakeVisible() && this.f18583g == null) {
                    this.f18583g = new com.mbridge.msdk.shake.b(dyOption.getShakeStrenght(), dyOption.getShakeTime() * 1000) { // from class: com.mbridge.msdk.dycreator.binding.b.7
                            ...
                            if (view2 != null) {
                                try {
                                    if (view2.getGlobalVisibleRect(new Rect())) {
                                        ...
                                        com.mbridge.msdk.shake.a.a().b(b.this.f18583g);
                                    }
                                } catch (Exception e8) {
                                    ad.b("MBDataBinding", e8.getMessage());
                                }
                ...
                if (effectDes != null) {
                    if (effectDes.equals("wobble") && (viewGroup instanceof MBSplashShakeView)) {
                        if (aVar.getEffectData().isShakeVisible()) {
                            if (bVar.f18583g != null) {
                                com.mbridge.msdk.shake.a.a().b(bVar.f18583g);
                            }
                            com.mbridge.msdk.shake.a.a().a(bVar.a(viewGroup, (MBSplashData) aVar));
                        } else if (bVar.f18583g != null) {
                            com.mbridge.msdk.shake.a.a().b(bVar.f18583g);
                        }
                    }
