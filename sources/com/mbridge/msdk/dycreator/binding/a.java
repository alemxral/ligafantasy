...
public final class a implements View.OnClickListener {
    ...
    private com.mbridge.msdk.dycreator.f.a.a f18576a;
    ...
    public final void onClick(View view) {
        ...
        if (view != 0 && (view instanceof InterBase)) {
            if ((view instanceof MBCountDownView) && (aVar = this.f18576a) != null && aVar.getEffectData() != null && !this.f18576a.getEffectData().isCanSkip()) {
                return;
            }
            com.mbridge.msdk.dycreator.f.a.a aVar2 = this.f18576a;
            if (aVar2 != null && (view instanceof MBRelativeLayout) && d.a(view, aVar2)) {
                com.mbridge.msdk.dycreator.f.a.a aVar3 = this.f18576a;
                if (aVar3 instanceof MBSplashData) {
                    ...
                    ((MBSplashData) this.f18576a).setyInScreen(mBRelativeLayout.getyInScreen());
                    ((MBSplashData) this.f18576a).setClickType(1);
                }
            }
            com.mbridge.msdk.dycreator.f.a.a aVar4 = this.f18576a;
            if (aVar4 != null && (view instanceof MBLinearLayout) && d.a(view, aVar4)) {
                com.mbridge.msdk.dycreator.f.a.a aVar5 = this.f18576a;
                if (aVar5 instanceof MBSplashData) {
                    ...
                    ((MBSplashData) this.f18576a).setyInScreen(mBLinearLayout.getyInScreen());
                    ((MBSplashData) this.f18576a).setClickType(0);
                }
            }
            ...
            if (!TextUtils.isEmpty(strategyDes)) {
                ...
                if (baseStrategy != null) {
                    baseStrategy.bindClickData(view, this.f18576a);
                }
            }
        }
    }
