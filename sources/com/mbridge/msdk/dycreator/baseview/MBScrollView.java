...
public class MBScrollView extends ScrollView implements InterBase {
    ...
    private Map<String, String> f18357a;

    /* renamed from: b, reason: collision with root package name */
    private Map<String, Boolean> f18358b;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f18360a[c.background.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18360a[c.contentDescription.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18360a[c.fadingEdge.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f18360a[c.visibility.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f18360a[c.layout_marginBottom.ordinal()] = 6;
    ...
    public MBScrollView(Context context, AttributeSet attributeSet) {
        super(context);
        this.f18359c = "";
        this.f18357a = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
        setAttributeSet(attributeSet);
        setLayoutParams(generateLayoutParams(attributeSet));
        com.mbridge.msdk.dycreator.e.c.a(this.f18357a, this);
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getActionDes() {
        Map<String, String> map = this.f18357a;
        if (map != null && map.containsKey("mbridgeAction")) {
            return this.f18357a.get("mbridgeAction");
        }
        return "";
    }
    ...
    public String getBindDataDes() {
        ...
        if (map != null && map.containsKey("mbridgeData")) {
            return this.f18357a.get("mbridgeData");
        }
        return "";
    }
    ...
    public String getEffectDes() {
        ...
        if (map != null && map.containsKey("mbridgeEffect")) {
            return this.f18357a.get("mbridgeEffect");
        }
        return "";
    }
    ...
    public String getReportDes() {
        ...
        if (map != null && map.containsKey("mbridgeReport")) {
            return this.f18357a.get("mbridgeReport");
        }
        return "";
    }
    ...
    public String getStrategyDes() {
        ...
        if (map != null && map.containsKey("mbridgeStrategy")) {
            return this.f18357a.get("mbridgeStrategy");
        }
        return "";
    }
    ...
    protected void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f18358b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f18358b.get("mbridgeAttached").booleanValue()) {
            new m.a("mbridgeAttached").a().a(this.f18359c);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18358b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f18358b.get("mbridgeDetached").booleanValue()) {
            new m.a("mbridgeDetached").a().a(this.f18359c);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            ...
            if (cVar != null) {
                int i9 = AnonymousClass1.f18360a[cVar.ordinal()];
                if (i9 != 1) {
                    if (i9 != 2) {
                        if (i9 == 3) {
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18358b = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f18359c = campaignEx.getCampaignUnitId();
        }
    }
