...
public class MBSplashClickView extends MBRelativeLayout {
    ...
    private ImageView f18375o;

    /* renamed from: p, reason: collision with root package name */
    private ImageView f18376p;

    /* renamed from: q, reason: collision with root package name */
    private final RectF f18377q;

    /* renamed from: r, reason: collision with root package name */
    private final Paint f18378r;

    /* renamed from: s, reason: collision with root package name */
    private final Paint f18379s;

    public MBSplashClickView(Context context) {
        super(context);
        this.f18361a = "浏览第三方应用";
        this.f18362b = "View";
        this.f18363c = "打开第三方应用";
        this.f18364d = "Open";
        this.f18365e = "下载第三方应用";
        this.f18366f = "Install";
        this.f18367g = "mbridge_splash_btn_arrow_right";
        this.f18368h = "mbridge_splash_btn_circle";
        this.f18369i = "mbridge_splash_btn_finger";
        this.f18370j = "mbridge_splash_btn_go";
        this.f18371k = "mbridge_splash_btn_light";
        this.f18372l = "mbridge_expand_data";
        this.TYPE_SPLASH_BTN_OPEN = 1;
        this.TYPE_SPLASH_BTN_GO = 2;
        this.TYPE_SPLASH_BTN_CLICK = 3;
        this.f18377q = new RectF();
        this.f18378r = new Paint();
        this.f18379s = new Paint();
        a();
    }

    @Override // android.view.View
    public void draw(Canvas canvas) {
        canvas.saveLayer(this.f18377q, this.f18379s, 31);
        canvas.drawRoundRect(this.f18377q, 200.0f, 200.0f, this.f18379s);
        canvas.saveLayer(this.f18377q, this.f18378r, 31);
        super.draw(canvas);
        canvas.restore();
    }
    ...
    public void initView(String str) {
        ...
        switch (c8) {
            ...
            default:
                ...
                if (TextUtils.isEmpty(this.f18373m)) {
                    if (!contains) {
                        str3 = "View";
                    }
                    this.f18373m = str3;
        ...
        textView.setText(this.f18373m);
        this.f18375o = new ImageView(getContext());
        ...
        if (i10 == 2) {
            ...
            this.f18376p = new ImageView(getContext());
            ...
            this.f18376p.setLayoutParams(layoutParams4);
            this.f18376p.setImageResource(getResources().getIdentifier("mbridge_splash_btn_circle", "drawable", c.m().g()));
            addView(this.f18376p);
        } else {
            layoutParams = null;
        }
        this.f18375o.setLayoutParams(layoutParams);
        if (TextUtils.isEmpty(str2)) {
            this.f18375o.setImageResource(i8);
        } else {
            final ImageView imageView2 = this.f18375o;
            if (imageView2 != null) {
                try {
                    if (TextUtils.isEmpty(str2)) {
                        ...
                        public void onSuccessLoad(Bitmap bitmap, String str4) {
                            if (imageView2 != null) {
                                if (bitmap != null && !bitmap.isRecycled()) {
                                    if (MBSplashClickView.this.f18376p != null) {
                                        MBSplashClickView mBSplashClickView = MBSplashClickView.this;
                                        mBSplashClickView.removeView(mBSplashClickView.f18376p);
                                    }
    ...
    public void onAttachedToWindow() {
        ...
        if (i8 == 2) {
            ...
            this.f18375o.startAnimation(scaleAnimation);
            return;
        }
        if (i8 == 1) {
            ...
            translateAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: com.mbridge.msdk.dycreator.baseview.MBSplashClickView.3
                ...
                public void onAnimationEnd(final Animation animation) {
                    MBSplashClickView.this.f18375o.setVisibility(4);
                    MBSplashClickView.this.f18375o.postDelayed(new Runnable() { // from class: com.mbridge.msdk.dycreator.baseview.MBSplashClickView.3.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MBSplashClickView.this.f18375o.startAnimation(animation);
                        }
                ...
                public void onAnimationStart(Animation animation) {
                    MBSplashClickView.this.f18375o.setVisibility(0);
                }
            });
            this.f18375o.startAnimation(translateAnimation);
            return;
        }
        if (i8 == 3) {
            ...
            scaleAnimation3.setAnimationListener(new Animation.AnimationListener() { // from class: com.mbridge.msdk.dycreator.baseview.MBSplashClickView.1
                ...
                public void onAnimationEnd(Animation animation) {
                    MBSplashClickView.this.f18376p.setVisibility(4);
                    MBSplashClickView.this.f18376p.postDelayed(new Runnable() { // from class: com.mbridge.msdk.dycreator.baseview.MBSplashClickView.1.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MBSplashClickView.this.f18376p.startAnimation(scaleAnimation3);
                        }
                    }, 1600L);
                }
                ...
                @Override // android.view.animation.Animation.AnimationListener
                public void onAnimationStart(Animation animation) {
                    MBSplashClickView.this.f18376p.setVisibility(0);
                }
            });
            this.f18376p.setVisibility(4);
            this.f18375o.startAnimation(scaleAnimation2);
            this.f18376p.postDelayed(new Runnable() { // from class: com.mbridge.msdk.dycreator.baseview.MBSplashClickView.2
                @Override // java.lang.Runnable
                public void run() {
                    MBSplashClickView.this.f18376p.startAnimation(scaleAnimation3);
                }
    ...
    public void onLayout(boolean z8, int i8, int i9, int i10, int i11) {
        ...
        this.f18377q.set(0.0f, 0.0f, getWidth(), getHeight());
    }

    private void a() {
        this.f18378r.setAntiAlias(true);
        this.f18378r.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_IN));
        this.f18379s.setAntiAlias(true);
        this.f18379s.setColor(-1);
    }
