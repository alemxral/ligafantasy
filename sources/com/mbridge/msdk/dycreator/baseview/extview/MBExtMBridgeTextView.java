...
public class MBExtMBridgeTextView extends MBridgeTextView implements InterBase {
    ...
    private Map<String, String> f18530a;

    /* renamed from: b, reason: collision with root package name */
    private Map<String, Boolean> f18531b;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f18533a[c.text.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18533a[c.ellipsize.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18533a[c.singleLine.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f18533a[c.lines.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f18533a[c.drawableLeft.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f18533a[c.drawablePadding.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f18533a[c.fadingEdge.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f18533a[c.scrollHorizontally.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f18533a[c.textColor.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f18533a[c.textSize.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f18533a[c.visibility.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f18533a[c.background.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f18533a[c.textStyle.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f18533a[c.style.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f18533a[c.contentDescription.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f18533a[c.tag.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f18533a[c.gravity.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f18533a[c.padding.ordinal()] = 19;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f18533a[c.paddingTop.ordinal()] = 20;
            } catch (NoSuchFieldError unused20) {
            }
            try {
                f18533a[c.paddingBottom.ordinal()] = 21;
            } catch (NoSuchFieldError unused21) {
            }
            try {
                f18533a[c.paddingLeft.ordinal()] = 22;
            } catch (NoSuchFieldError unused22) {
            }
            try {
                f18533a[c.paddingRight.ordinal()] = 23;
            } catch (NoSuchFieldError unused23) {
            }
            try {
                f18533a[c.paddingStart.ordinal()] = 24;
            } catch (NoSuchFieldError unused24) {
            }
            try {
                f18533a[c.paddingEnd.ordinal()] = 25;
            } catch (NoSuchFieldError unused25) {
            }
            try {
                f18533a[c.maxLength.ordinal()] = 26;
            } catch (NoSuchFieldError unused26) {
            }
            try {
                f18533a[c.layout_width.ordinal()] = 27;
            } catch (NoSuchFieldError unused27) {
            }
            try {
                f18533a[c.layout_height.ordinal()] = 28;
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            ...
            if (cVar != null) {
                int i9 = AnonymousClass1.f18533a[cVar.ordinal()];
                if (i9 != 27) {
                    if (i9 == 28) {
    ...
    public String getActionDes() {
        Map<String, String> map = this.f18530a;
        if (map != null && map.containsKey("mbridgeAction")) {
            return this.f18530a.get("mbridgeAction");
        }
        return "";
    }
    ...
    public String getBindDataDes() {
        ...
        if (map != null && map.containsKey("mbridgeData")) {
            return this.f18530a.get("mbridgeData");
        }
        return "";
    }
    ...
    public String getEffectDes() {
        ...
        if (map != null && map.containsKey("mbridgeEffect")) {
            return this.f18530a.get("mbridgeEffect");
        }
        return "";
    }
    ...
    public String getReportDes() {
        ...
        if (map != null && map.containsKey("mbridgeReport")) {
            return this.f18530a.get("mbridgeReport");
        }
        return "";
    }
    ...
    public String getStrategyDes() {
        ...
        if (map != null && map.containsKey("mbridgeStrategy")) {
            return this.f18530a.get("mbridgeStrategy");
        }
        return "";
    }
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f18531b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f18531b.get("mbridgeAttached").booleanValue()) {
            new m.a("mbridgeAttached").a().a(this.f18532c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18531b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f18531b.get("mbridgeDetached").booleanValue()) {
            new m.a("mbridgeDetached").a().a(this.f18532c);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i12 = 0; i12 < attributeCount; i12++) {
            ...
            if (cVar != null) {
                ...
                String[] strArr = null;
                switch (AnonymousClass1.f18533a[cVar.ordinal()]) {
                    case 1:
                    ...
                    case 16:
                        ...
                        if (TextUtils.isEmpty(attributeValue8)) {
                            ...
                            CharSequence charSequence = (String) com.mbridge.msdk.dycreator.e.b.f18671a.get(attributeValue8.substring(8));
                    ...
                    case 17:
                        ...
                        if (TextUtils.isEmpty(attributeValue9)) {
                            ...
                            String str2 = com.mbridge.msdk.dycreator.e.b.f18671a.get(attributeValue9.substring(8));
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18531b = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f18532c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public MBExtMBridgeTextView(Context context, AttributeSet attributeSet) {
        ...
        this.f18532c = "";
        try {
            this.f18530a = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f18530a, this);
        } catch (Exception e8) {
