...
public class MBExtMBRotationView extends MBRotationView implements InterBase {
    ...
    private Map<String, String> f18512b;

    /* renamed from: c, reason: collision with root package name */
    private Map<String, Boolean> f18513c;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f18515a[c.background.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18515a[c.contentDescription.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18515a[c.visibility.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f18515a[c.layout_width.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f18515a[c.layout_height.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f18515a[c.layout_gravity.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f18515a[c.layout_marginLeft.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f18515a[c.layout_margin.ordinal()] = 9;
    ...
    public String getActionDes() {
        Map<String, String> map = this.f18512b;
        if (map != null && map.containsKey("mbridgeAction")) {
            return this.f18512b.get("mbridgeAction");
        }
        return "";
    }
    ...
    public String getBindDataDes() {
        ...
        if (map != null && map.containsKey("mbridgeData")) {
            return this.f18512b.get("mbridgeData");
        }
        return "";
    }
    ...
    public String getEffectDes() {
        ...
        if (map != null && map.containsKey("mbridgeEffect")) {
            return this.f18512b.get("mbridgeEffect");
        }
        return "";
    }
    ...
    public String getReportDes() {
        ...
        if (map != null && map.containsKey("mbridgeReport")) {
            return this.f18512b.get("mbridgeReport");
        }
        return "";
    }
    ...
    public String getStrategyDes() {
        ...
        if (map != null && map.containsKey("mbridgeStrategy")) {
            return this.f18512b.get("mbridgeStrategy");
        }
        return "";
    }
    ...
    protected void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f18513c;
        if (map != null && map.containsKey("mbridgeAttached") && this.f18513c.get("mbridgeAttached").booleanValue()) {
            new m.a("mbridgeAttached").a().a(this.f18514d);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18513c;
        if (map != null && map.containsKey("mbridgeDetached") && this.f18513c.get("mbridgeDetached").booleanValue()) {
            new m.a("mbridgeDetached").a().a(this.f18514d);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            ...
            if (cVar != null) {
                int i9 = AnonymousClass1.f18515a[cVar.ordinal()];
                if (i9 != 1) {
                    if (i9 != 2) {
                        if (i9 != 3) {
                            if (i9 == 4) {
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18513c = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f18514d = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f18515a[cVar.ordinal()]) {
                    case 5:
                        String attributeValue = attributeSet.getAttributeValue(i8);
    ...
    public MBExtMBRotationView(Context context, AttributeSet attributeSet) {
        ...
        this.f18514d = "";
        try {
            this.f18512b = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f18512b, this);
        } catch (Exception e8) {
