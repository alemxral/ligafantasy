            ...
            if (cVar != null) {
                switch (AnonymousClass1.f18538a[cVar.ordinal()]) {
                    ...
                    case 9:
                        ...
                        this.f18535b = b9;
                        setPadding(this.f18534a, b9, this.f18536c, this.f18537d);
                        break;
                    case 10:
                        int b10 = b.a().b(attributeSet.getAttributeValue(i8));
                        this.f18537d = b10;
                        setPadding(this.f18534a, this.f18535b, this.f18536c, b10);
                        break;
                    case 11:
                        int b11 = b.a().b(attributeSet.getAttributeValue(i8));
                        this.f18534a = b11;
                        setPadding(b11, this.f18535b, this.f18536c, this.f18537d);
                        break;
                    case 12:
                        int b12 = b.a().b(attributeSet.getAttributeValue(i8));
                        this.f18536c = b12;
                        setPadding(this.f18534a, this.f18535b, b12, this.f18537d);
                        break;
                }
            }
        }
