...
public class MBExtFrameLayout extends MBridgeFramLayout implements InterBase {
    ...
    private Map<String, String> f18508a;

    /* renamed from: b, reason: collision with root package name */
    private Map<String, Boolean> f18509b;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f18511a[c.layout_height.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18511a[c.layout_gravity.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18511a[c.layout_margin.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f18511a[c.layout_marginLeft.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f18511a[c.layout_marginRight.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f18511a[c.layout_marginTop.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f18511a[c.layout_marginBottom.ordinal()] = 8;
    ...
    public String getActionDes() {
        Map<String, String> map = this.f18508a;
        if (map != null && map.containsKey("mbridgeAction")) {
            return this.f18508a.get("mbridgeAction");
        }
        return "";
    }
    ...
    public String getBindDataDes() {
        ...
        if (map != null && map.containsKey("mbridgeData")) {
            return this.f18508a.get("mbridgeData");
        }
        return "";
    }
    ...
    public String getEffectDes() {
        ...
        if (map != null && map.containsKey("mbridgeEffect")) {
            return this.f18508a.get("mbridgeEffect");
        }
        return "";
    }
    ...
    public String getReportDes() {
        ...
        if (map != null && map.containsKey("mbridgeReport")) {
            return this.f18508a.get("mbridgeReport");
        }
        return "";
    }
    ...
    public String getStrategyDes() {
        ...
        if (map != null && map.containsKey("mbridgeStrategy")) {
            return this.f18508a.get("mbridgeStrategy");
        }
        return "";
    }
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f18509b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f18509b.get("mbridgeAttached").booleanValue()) {
            new m.a("mbridgeAttached").a().a(this.f18510c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18509b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f18509b.get("mbridgeDetached").booleanValue()) {
            new m.a("mbridgeDetached").a().a(this.f18510c);
        }
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18509b = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f18510c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f18511a[cVar.ordinal()]) {
                    case 1:
    ...
    public MBExtFrameLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f18510c = "";
        try {
            this.f18508a = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f18508a, this);
        } catch (Exception e8) {
