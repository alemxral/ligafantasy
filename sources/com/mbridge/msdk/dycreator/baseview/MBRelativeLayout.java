...
public class MBRelativeLayout extends RelativeLayout implements InterBase {
    ...
    private Map<String, String> f18352c;

    /* renamed from: d, reason: collision with root package name */
    private Map<String, Boolean> f18353d;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f18355a[c.layout_height.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18355a[c.layout_centerHorizontal.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18355a[c.layout_alignParentBottom.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f18355a[c.layout_alignParentTop.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f18355a[c.layout_centerVertical.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f18355a[c.layout_below.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f18355a[c.layout_above.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f18355a[c.layout_toLeftOf.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f18355a[c.layout_toRightOf.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f18355a[c.layout_toEndOf.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f18355a[c.layout_margin.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f18355a[c.layout_marginLeft.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f18355a[c.layout_marginRight.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f18355a[c.layout_marginTop.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f18355a[c.layout_marginBottom.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f18355a[c.layout_alignParentRight.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f18355a[c.layout_alignParentLeft.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f18355a[c.layout_alignTop.ordinal()] = 19;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f18355a[c.layout_alignLeft.ordinal()] = 20;
            } catch (NoSuchFieldError unused20) {
            }
            try {
                f18355a[c.layout_alignRight.ordinal()] = 21;
            } catch (NoSuchFieldError unused21) {
            }
            try {
                f18355a[c.layout_alignBottom.ordinal()] = 22;
            } catch (NoSuchFieldError unused22) {
            }
            try {
                f18355a[c.layout_centerInParent.ordinal()] = 23;
            } catch (NoSuchFieldError unused23) {
            }
            try {
                f18355a[c.layout_alignParentEnd.ordinal()] = 24;
    ...
    public String getActionDes() {
        Map<String, String> map = this.f18352c;
        if (map != null && map.containsKey("mbridgeAction")) {
            return this.f18352c.get("mbridgeAction");
        }
        return "";
    }
    ...
    public String getBindDataDes() {
        ...
        if (map != null && map.containsKey("mbridgeData")) {
            return this.f18352c.get("mbridgeData");
        }
        return "";
    }
    ...
    public String getEffectDes() {
        ...
        if (map != null && map.containsKey("mbridgeEffect")) {
            return this.f18352c.get("mbridgeEffect");
        }
        return "";
    }
    ...
    public String getReportDes() {
        ...
        if (map != null && map.containsKey("mbridgeReport")) {
            return this.f18352c.get("mbridgeReport");
        }
        return "";
    }
    ...
    public String getStrategyDes() {
        ...
        if (map != null && map.containsKey("mbridgeStrategy")) {
            return this.f18352c.get("mbridgeStrategy");
        }
        return "";
    }
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f18353d;
        if (map != null && map.containsKey("mbridgeAttached") && this.f18353d.get("mbridgeAttached").booleanValue()) {
            new m.a("mbridgeAttached").a().a(this.f18354e);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18353d;
        if (map != null && map.containsKey("mbridgeDetached") && this.f18353d.get("mbridgeDetached").booleanValue()) {
            new m.a("mbridgeDetached").a().a(this.f18354e);
        }
    }

    @Override // android.view.ViewGroup
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        this.f18350a = motionEvent.getRawX();
        this.f18351b = motionEvent.getRawY();
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18353d = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f18354e = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public RelativeLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f18355a[cVar.ordinal()]) {
                    case 1:
    ...
    public MBRelativeLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f18354e = "";
        try {
            this.f18352c = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f18352c, this);
        } catch (Exception e8) {
            ad.b("MBRelativeLayouts", e8.getMessage());
        }
    }
