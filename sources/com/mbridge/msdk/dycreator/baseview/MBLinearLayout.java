...
public class MBLinearLayout extends LinearLayout implements InterBase {
    ...
    private Map<String, String> f18336c;

    /* renamed from: d, reason: collision with root package name */
    private Map<String, Boolean> f18337d;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f18339a[c.layout_height.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18339a[c.layout_centerHorizontal.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18339a[c.layout_centerVertical.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f18339a[c.layout_weight.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f18339a[c.gravity.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f18339a[c.layout_margin.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f18339a[c.layout_marginLeft.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f18339a[c.layout_marginRight.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f18339a[c.layout_marginTop.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f18339a[c.layout_marginBottom.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f18339a[c.layout_gravity.ordinal()] = 12;
    ...
    public String getActionDes() {
        Map<String, String> map = this.f18336c;
        if (map != null && map.containsKey("mbridgeAction")) {
            return this.f18336c.get("mbridgeAction");
        }
        return "";
    }
    ...
    public String getBindDataDes() {
        ...
        if (map != null && map.containsKey("mbridgeData")) {
            return this.f18336c.get("mbridgeData");
        }
        return "";
    }
    ...
    public String getEffectDes() {
        ...
        if (map != null && map.containsKey("mbridgeEffect")) {
            return this.f18336c.get("mbridgeEffect");
        }
        return "";
    }
    ...
    public String getReportDes() {
        ...
        if (map != null && map.containsKey("mbridgeReport")) {
            return this.f18336c.get("mbridgeReport");
        }
        return "";
    }
    ...
    public String getStrategyDes() {
        ...
        if (map != null && map.containsKey("mbridgeStrategy")) {
            return this.f18336c.get("mbridgeStrategy");
        }
        return "";
    }
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f18337d;
        if (map != null && map.containsKey("mbridgeAttached") && this.f18337d.get("mbridgeAttached").booleanValue()) {
            new m.a("mbridgeAttached").a().a(this.f18338e);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18337d;
        if (map != null && map.containsKey("mbridgeDetached") && this.f18337d.get("mbridgeDetached").booleanValue()) {
            new m.a("mbridgeDetached").a().a(this.f18338e);
        }
    }

    @Override // android.view.ViewGroup
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        this.f18334a = motionEvent.getRawX();
        this.f18335b = motionEvent.getRawY();
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18337d = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f18338e = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public LinearLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f18339a[cVar.ordinal()]) {
                    case 1:
    ...
    public MBLinearLayout(Context context, AttributeSet attributeSet) {
        super(context);
        this.f18338e = "";
        this.f18336c = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
        a.a(this, attributeSet);
        setLayoutParams(generateLayoutParams(attributeSet));
        com.mbridge.msdk.dycreator.e.c.a(this.f18336c, this);
    }
