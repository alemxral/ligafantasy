...
public class MBCountDownView extends MBTextView {
    ...
    private MBCountDownView f18309b;
    ...
    public void initView(final String str, final String str2, int i8) {
        this.f18308a = new b().b(i8 * 1000).a(1000L).a(new a() { // from class: com.mbridge.msdk.dycreator.baseview.MBCountDownView.1
            @Override // com.mbridge.msdk.f.a.a
            public void onFinish() {
                MBCountDownView.this.f18308a.a();
            ...
            public void onTick(long j8) {
                if (str2.startsWith("zh")) {
                    MBCountDownView.this.f18309b.setText((j8 / 1000) + "s" + str);
                    return;
                }
                MBCountDownView.this.f18309b.setText(MBCountDownView.this.f18309b + " " + (j8 / 1000) + "s");
            }
        });
    }
