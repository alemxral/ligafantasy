...
public class MBGridView extends GridView implements InterBase {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f18321a[c.layout_height.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18321a[c.fadingEdge.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18321a[c.visibility.ordinal()] = 4;
    ...
    public MBGridView(Context context, AttributeSet attributeSet) {
        ...
        this.f18320c = "";
        try {
            this.f18318a = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f18318a, this);
        } catch (Exception e8) {
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18319b = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
    ...
    public AbsListView.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            ...
            if (cVar != null) {
                int i9 = AnonymousClass1.f18321a[cVar.ordinal()];
                if (i9 == 1) {
