...
class SubscriberMethodFinder {
    ...
    private static final Map<String, List<SubscriberMethod>> f18658a = new HashMap();

    /* renamed from: b, reason: collision with root package name */
    private static final Map<Class<?>, Class<?>> f18659b = new ConcurrentHashMap();
    ...
    public final List<SubscriberMethod> a(Class<?> cls, String str) {
        ...
        Map<String, List<SubscriberMethod>> map = f18658a;
        synchronized (map) {
            list = map.get(str2);
        }
        if (list != null) {
        ...
        if (!arrayList.isEmpty()) {
            Map<String, List<SubscriberMethod>> map2 = f18658a;
            synchronized (map2) {
