...
public class b {
    ...
    private static volatile b f18233g;

    /* renamed from: a, reason: collision with root package name */
    private SoftReference<HashMap<String, c>> f18234a;

    /* renamed from: b, reason: collision with root package name */
    private SoftReference<HashMap<String, String>> f18235b;

    /* renamed from: c, reason: collision with root package name */
    private SoftReference<HashMap<String, c>> f18236c;
    ...
    public final HashMap b() {
        SoftReference<HashMap<String, c>> softReference = this.f18234a;
        if (softReference == null || softReference.get() == null) {
            ...
            this.f18234a = new SoftReference<>(hashMap);
        }
        return this.f18234a.get();
    }

    public final HashMap<String, c> c() {
        SoftReference<HashMap<String, c>> softReference = this.f18236c;
        if (softReference == null || softReference.get() == null) {
            ...
            this.f18236c = new SoftReference<>(hashMap);
        }
        return this.f18236c.get();
    }
    ...
    public final int d(String str) {
        if (this.f18239f != null) {
            ...
            if (TextUtils.isEmpty(g8)) {
                g8 = this.f18239f.getPackageName();
            }
    ...
    public final String e(String str) {
        if (!TextUtils.isEmpty(str)) {
            ...
            SoftReference<HashMap<String, String>> softReference = this.f18235b;
            if (softReference == null || softReference.get() == null) {
                this.f18235b = new SoftReference<>(d());
            }
            String substring = str.substring(8);
            if (this.f18235b.get() != null && this.f18235b.get().size() > 0) {
                String str2 = this.f18235b.get().get(substring);
    ...
    public final void a(Context context, String str) {
        try {
            if (g.f18674a) {
                this.f18237d = context.getFilesDir().toString();
            } else {
                this.f18237d = str;
            }
            if (e.a(context).heightPixels > 320 && !g.f18674a) {
                this.f18238e = "/drawable-hdpi/";
                this.f18239f = context;
                com.mbridge.msdk.dycreator.e.b.f18671a = a().d();
            }
            this.f18238e = "/drawable-mdpi/";
            this.f18239f = context;
            com.mbridge.msdk.dycreator.e.b.f18671a = a().d();
        } catch (Exception e8) {
            ad.b("MBResource", e8.getMessage());
    ...
    private HashMap<String, String> d() {
        ...
        try {
            inputStream = this.f18239f.getAssets().open("rv_binddatas.xml");
    ...
    public final int b(String str) {
        try {
            ...
            if (str.contains("d")) {
                return (int) TypedValue.applyDimension(1, parseInt, this.f18239f.getResources().getDisplayMetrics());
            }
            str.contains("s");
            return parseInt;
        }
    ...
    public final void a(String str, ImageView imageView) {
        Context context;
        if (str == null || !str.startsWith("@drawable/") || (context = this.f18239f) == null) {
            return;
        }
        try {
