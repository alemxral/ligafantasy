...
public final class a {
    ...
    private static final Class[] f18223f = {Context.class, AttributeSet.class};

    /* renamed from: g, reason: collision with root package name */
    private static final HashMap<String, Constructor> f18224g = new HashMap<>();

    /* renamed from: j, reason: collision with root package name */
    private static String f18225j = "com.mbridge.msdk.dycreator.baseview.MB";

    /* renamed from: a, reason: collision with root package name */
    protected final Context f18226a;

    /* renamed from: c, reason: collision with root package name */
    private InterfaceC0391a f18228c;

    /* renamed from: d, reason: collision with root package name */
    private b f18229d;

    /* renamed from: h, reason: collision with root package name */
    private HashMap<String, Boolean> f18231h;

    /* renamed from: i, reason: collision with root package name */
    private long f18232i;

    /* renamed from: b, reason: collision with root package name */
    private final boolean f18227b = true;

    /* renamed from: e, reason: collision with root package name */
    private final Object[] f18230e = new Object[2];
    ...
    private View a(XmlPullParser xmlPullParser, ViewGroup viewGroup, boolean z8) {
        ...
        synchronized (this.f18230e) {
            try {
                AttributeSet asAttributeSet = Xml.asAttributeSet(xmlPullParser);
                this.f18230e[0] = this.f18226a;
                do {
    ...
    */
    private void b(org.xmlpull.v1.XmlPullParser r6, android.view.View r7, android.util.AttributeSet r8) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L1c:
            ...
            throw r7
        L38:
            android.content.Context r1 = r5.f18226a
    ...
    private View a(String str, String str2, AttributeSet attributeSet) throws ClassNotFoundException, InflateException {
        String str3;
        String str4;
        HashMap<String, Constructor> hashMap = f18224g;
        Constructor<?> constructor = hashMap.get(str);
        Class<?> cls = null;
        try {
            if (constructor == null) {
                ClassLoader classLoader = this.f18226a.getClassLoader();
                if (str2 != null) {
                    str4 = str2 + str;
                } else {
                    str4 = str;
                ...
                constructor = cls.getConstructor(f18223f);
                hashMap.put(str, constructor);
            } else if (this.f18229d != null) {
                Boolean bool = this.f18231h.get(str);
                if (bool == null) {
                    ClassLoader classLoader2 = this.f18226a.getClassLoader();
                    if (str2 != null) {
                        str3 = str2 + str;
                    } else {
                        str3 = str;
                    ...
                    boolean z8 = cls != null && this.f18229d.a(cls);
                    this.f18231h.put(str, Boolean.valueOf(z8));
                    if (!z8) {
                        b(str, str2, attributeSet);
                    }
    ...
    private View a(String str, AttributeSet attributeSet) {
        ...
        try {
            InterfaceC0391a interfaceC0391a = this.f18228c;
            View a9 = interfaceC0391a == null ? null : interfaceC0391a.a(str, this.f18226a, attributeSet);
            if (a9 == null) {
                if (-1 == str.indexOf(46)) {
                    if (!str.equals("MBStarLevelLayoutView") && !str.equals("LuckPan")) {
                        a8 = a(str, f18225j, attributeSet);
                        a9 = a8;
                    }
    ...
    public final View a(String str, ViewGroup viewGroup) {
        ...
        this.f18232i = System.currentTimeMillis();
