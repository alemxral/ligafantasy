...
public class d extends e {
    ...
    private static final String f20300a = "d";
    ...
    public static com.mbridge.msdk.foundation.same.net.h.e a(boolean z8, Context context, String str, String str2, int i8, b bVar) {
        ...
        com.mbridge.msdk.foundation.same.net.g.b.a(eVar, com.mbridge.msdk.foundation.same.net.h.e.f19717e, a8);
        com.mbridge.msdk.foundation.same.net.g.b.a(eVar, CampaignEx.JSON_KEY_AD_SOURCE_ID, "1");
        com.mbridge.msdk.foundation.same.net.g.b.a(eVar, com.mbridge.msdk.foundation.same.net.h.e.f19718f, str2);
        ...
        com.mbridge.msdk.foundation.same.net.g.b.a(eVar, com.mbridge.msdk.foundation.same.net.h.e.f19716d, a9);
