...
public final class a extends c {
    ...
    private WeakReference<Context> f20416b;

    /* renamed from: c, reason: collision with root package name */
    private List<CampaignEx> f20417c;
    ...
    private com.mbridge.msdk.mbbanner.common.b.a f20421g;

    /* renamed from: h, reason: collision with root package name */
    private BannerExpandDialog f20422h;
    ...
    public a(Context context, String str, String str2) {
        this.f20418d = str;
        this.f20419e = str2;
        this.f20416b = new WeakReference<>(context);
    }
    ...
    public final void b(Object obj, String str) {
        ...
        try {
            List<CampaignEx> list = this.f20417c;
            if (list == null) {
                return;
            }
            if (list != null && list.size() > 0) {
                campaignEx = this.f20417c.get(0);
            } else {
                campaignEx = null;
            }
            if (!TextUtils.isEmpty(str)) {
                ...
                com.mbridge.msdk.mbbanner.common.b.a aVar = this.f20421g;
                if (aVar != null) {
                    aVar.a(campaignEx);
                }
            }
    ...
    public final void expand(String str, boolean z8) {
        ...
        try {
            ...
            WeakReference<Context> weakReference = this.f20416b;
            if (weakReference != null && (context = weakReference.get()) != null) {
                BannerExpandDialog bannerExpandDialog = this.f20422h;
                if (bannerExpandDialog != null && bannerExpandDialog.isShowing()) {
                    return;
                }
                BannerExpandDialog bannerExpandDialog2 = new BannerExpandDialog(context, bundle, this.f20421g);
                this.f20422h = bannerExpandDialog2;
                bannerExpandDialog2.setCampaignList(this.f20419e, this.f20417c);
                this.f20422h.show();
            }
            com.mbridge.msdk.mbbanner.common.b.a aVar = this.f20421g;
            if (aVar != null) {
            ...
            com.mbridge.msdk.mbbanner.common.d.a.a(this.f20419e, getMraidCampaign(), str);
        } catch (Throwable th) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                for (int i8 = 0; i8 < jSONArray.length(); i8++) {
                    ...
                    for (CampaignEx campaignEx : this.f20417c) {
                        if (campaignEx.getId().equals(string)) {
                            com.mbridge.msdk.foundation.same.a.d.a(this.f20419e, campaignEx, "banner");
            ...
            try {
                ...
                for (int i8 = 0; i8 < jSONArray.length(); i8++) {
                    ...
                    if (optInt2 == 0) {
                        ...
                        List<CampaignEx> list2 = this.f20417c;
                        if (list2 != null) {
    ...
    public final void a(Object obj, String str) {
        ...
        try {
            ...
            jSONObject2.put("dev_close_state", this.f20420f);
            jSONObject.put("sdkSetting", jSONObject2);
            jSONObject.put("device", iVar.a());
            jSONObject.put("campaignList", CampaignEx.parseCamplistToJson(this.f20417c));
            com.mbridge.msdk.c.k d8 = com.mbridge.msdk.c.h.a().d(com.mbridge.msdk.foundation.controller.c.m().k(), this.f20419e);
            if (d8 == null) {
                d8 = com.mbridge.msdk.c.k.d(this.f20419e);
            }
            ...
            jSONObject.put("sdk_info", com.mbridge.msdk.mbsignalcommon.base.d.f20468a);
