...
public abstract class a extends f<JSONObject> {
    ...
    private static final String f20426a = "a";
    ...
    public void onError(com.mbridge.msdk.foundation.same.net.b.a aVar) {
        ad.c(f20426a, "onFailed errorCode = " + aVar.f19588a);
        a(aVar.f19588a, com.mbridge.msdk.foundation.same.net.g.a.a(aVar));
    }

    @Override // com.mbridge.msdk.foundation.same.net.f, com.mbridge.msdk.foundation.same.net.e
    public void onSuccess(k<JSONObject> kVar) {
        super.onSuccess(kVar);
        List<b> list = kVar.f19747b.f19643b;
        final JSONObject jSONObject = kVar.f19748c;
        ad.c(f20426a, "parseLoad content = " + jSONObject);
            ...
            com.mbridge.msdk.foundation.same.f.b.b().execute(new Runnable() { // from class: com.mbridge.msdk.mbbanner.common.f.a.1
                ...
                public final void run() {
                    ...
                    if ("v5".equals(optString)) {
                        parseCampaignUnit = com.mbridge.msdk.foundation.entity.b.parseV5CampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), a.this.f20427b);
                    } else {
                        parseCampaignUnit = com.mbridge.msdk.foundation.entity.b.parseCampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), a.this.f20427b);
                    }
                    com.mbridge.msdk.foundation.same.f.b.e().post(new Runnable() { // from class: com.mbridge.msdk.mbbanner.common.f.a.1.1
                        ...
                        public final void run() {
                            ...
                            if (campaignUnit != null && campaignUnit.getAds() != null && parseCampaignUnit.getAds().size() > 0) {
                                ...
                                if (!TextUtils.isEmpty(a.this.f20427b)) {
