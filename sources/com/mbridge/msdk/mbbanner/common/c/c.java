...
public final class c extends d {
    ...
    public final void a(CampaignEx campaignEx, boolean z8, String str) {
        ...
        if (this.f20364f == null) {
            this.f20364f = new com.mbridge.msdk.click.a(com.mbridge.msdk.foundation.controller.c.m().c(), this.f20363e);
        }
        this.f20364f.a(new NativeListener.TrackingExListener() { // from class: com.mbridge.msdk.mbbanner.common.c.c.1
            ...
            public final void onLeaveApp() {
                com.mbridge.msdk.mbbanner.common.b.c cVar = c.this.f20359a;
                if (cVar != null) {
                    cVar.b();
                }
            }
            ...
            public final void onStartRedirection(Campaign campaign, String str2) {
                ah.b(campaign, c.this.f20361c);
            }
        });
        campaignEx.setCampaignUnitId(this.f20363e);
        this.f20364f.a(campaignEx);
        if (!this.f20360b.isReportClick()) {
            this.f20360b.setReportClick(true);
