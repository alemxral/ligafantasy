...
public class BannerUtils {
    ...
    public static String getCloseIds(String str) {
        ...
        try {
            Map<String, List<com.mbridge.msdk.foundation.same.d.a>> map = d.f19432a;
            ...
            try {
                ...
                if (!TextUtils.isEmpty(str)) {
                    ...
                    if (optJSONObject != null) {
                        str2 = String.valueOf(ai.a(c.m().c(), Integer.valueOf(optJSONObject.getString(com.mbridge.msdk.foundation.same.a.f19407h)).intValue()));
                        str3 = String.valueOf(ai.a(c.m().c(), Integer.valueOf(optJSONObject.getString(com.mbridge.msdk.foundation.same.a.f19408i)).intValue()));
                    } else {
                        str2 = "-999";
                        str3 = "-999";
                    }
