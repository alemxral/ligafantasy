...
public final class a extends b {
    ...
    List<CampaignEx> f20451b;

    /* renamed from: c, reason: collision with root package name */
    com.mbridge.msdk.mbbanner.common.b.a f20452c;

    /* renamed from: d, reason: collision with root package name */
    private final String f20453d = "BannerWebViewClient";
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        try {
            ...
            if (System.currentTimeMillis() - baseWebView.lastTouchTime > com.mbridge.msdk.click.b.a.f18092c && com.mbridge.msdk.click.b.a.a(this.f20451b.get(0), baseWebView.getUrl(), com.mbridge.msdk.click.b.a.f18091b)) {
                return false;
            }
            if (this.f20451b.size() > 1) {
                c.m().c().startActivity(new Intent("android.intent.action.VIEW", Uri.parse(str)));
                str = null;
            }
            com.mbridge.msdk.mbbanner.common.b.a aVar = this.f20452c;
            if (aVar != null) {
                aVar.a(false, str);
            }
            return true;
