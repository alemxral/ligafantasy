...
public class PlayerView extends LinearLayout {
    ...
    public class MySurfaceHoldeCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceChanged(SurfaceHolder surfaceHolder, int i8, int i9, int i10) {
            try {
                ...
                if (PlayerView.this.mIsSurfaceHolderDestoryed && !PlayerView.this.mIsCovered && !PlayerView.this.isComplete() && !PlayerView.this.isBTVideo && !b.f19151c) {
    ...
    public JSONObject buildH5JsonObject(int i8) {
        ...
        try {
            ...
            try {
                jSONObject2.put(a.f19407h, ai.b(c.m().c(), this.xInScreen));
                jSONObject2.put(a.f19408i, ai.b(c.m().c(), this.yInScreen));
                ...
                jSONObject2.put(a.f19410k, this.orientation);
