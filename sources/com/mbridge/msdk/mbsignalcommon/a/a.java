...
public class a {
    ...
    private static final String f20455c = "a";

    /* renamed from: d, reason: collision with root package name */
    private String f20458d = "handlerNativeResult";
    ...
    private static final class C0408a {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static a f20460a = new a();
    }

    public static a a() {
        return C0408a.f20460a;
    }
    ...
    public final void a(Object obj, String str, JSONArray jSONArray, int i8) {
        ...
        try {
            ...
            ad.a(f20455c, th.getMessage());
            a(this.f20457b, "exception: " + th.getMessage(), obj);
        }
        if (jSONArray == null) {
            a(this.f20457b, "called reporter failed, params empty", obj);
            return;
        }
        ...
        if ("reportMessageR".equalsIgnoreCase(str)) {
            ...
            if (c8 != null && !TextUtils.isEmpty(stringBuffer2)) {
                try {
                    new com.mbridge.msdk.foundation.same.report.e.a(c8).post(0, d.f().f19683c, k.a(stringBuffer2, c8), new b() { // from class: com.mbridge.msdk.mbsignalcommon.a.a.1
                    ...
                    ad.b(f20455c, e8.getMessage());
                }
            }
            a(this.f20456a, "called reporter success", obj);
            return;
        }
