...
public class MraidSignalCommunication extends BaseMraidSignalCommunication {
    ...
    public void close(Object obj, String str) {
        if (obj instanceof com.mbridge.msdk.mbsignalcommon.windvane.a) {
            a.C0411a.f20544a.a(((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f20580b, CampaignEx.JSON_NATIVE_VIDEO_CLOSE);
        }
        try {
    ...
    public void expand(Object obj, String str) {
        if (obj instanceof com.mbridge.msdk.mbsignalcommon.windvane.a) {
            a.C0411a.f20544a.a(((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f20580b, "expand");
        }
        try {
            ...
            if (!TextUtils.isEmpty(optString) && !TextUtils.isEmpty(optString2) && this.f20543a != null) {
                this.f20543a.expand(optString, optString2.toLowerCase().equals("true"));
            }
        } catch (Throwable th) {
    ...
    public void open(Object obj, String str) {
        ...
        if (obj instanceof com.mbridge.msdk.mbsignalcommon.windvane.a) {
            ...
            windVaneWebView = aVar.f20580b;
            a.C0411a.f20544a.a(aVar.f20580b, "open");
        } else {
        ...
        try {
            ...
            if (this.f20543a != null && !TextUtils.isEmpty(optString)) {
                if (windVaneWebView != null && System.currentTimeMillis() - windVaneWebView.lastTouchTime > com.mbridge.msdk.click.b.a.f18092c && com.mbridge.msdk.click.b.a.a(this.f20543a.getMraidCampaign(), windVaneWebView.getUrl(), com.mbridge.msdk.click.b.a.f18090a)) {
                    return;
                }
                this.f20543a.open(optString);
            }
        } catch (Throwable th) {
    ...
    public void setOrientationProperties(Object obj, String str) {
        String str2;
        if (obj instanceof com.mbridge.msdk.mbsignalcommon.windvane.a) {
            a.C0411a.f20544a.a(((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f20580b, "setOrientationProperties");
        }
        try {
            JSONObject jSONObject = new JSONObject(str);
    ...
    public void unload(Object obj, String str) {
        if (obj instanceof com.mbridge.msdk.mbsignalcommon.windvane.a) {
            a.C0411a.f20544a.a(((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f20580b, "unload");
        }
        try {
    ...
    public void useCustomClose(Object obj, String str) {
        if (obj instanceof com.mbridge.msdk.mbsignalcommon.windvane.a) {
            a.C0411a.f20544a.a(((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f20580b, "useCustomClose");
        }
        try {
            ...
            if (!TextUtils.isEmpty(optString) && this.f20543a != null) {
                this.f20543a.useCustomClose(optString.toLowerCase().equals("true"));
            }
        } catch (Throwable th) {
