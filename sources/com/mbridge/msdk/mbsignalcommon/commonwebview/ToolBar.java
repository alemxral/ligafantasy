...
public class ToolBar extends LinearLayout {
    ...
    public static class a {
        ...
        public static int f20525b = 40;

        /* renamed from: c, reason: collision with root package name */
        public static int f20526c = 10;
    ...
    public static class b {
        ...
        public View.OnClickListener f20531d;
    ...
    private void a(a aVar, List<b> list) {
        ...
        try {
            for (b bVar : list) {
                ...
                imageView.setTag(bVar.f20528a);
                imageView.setImageDrawable(getResources().getDrawable(getResources().getIdentifier(bVar.f20529b, "drawable", com.mbridge.msdk.foundation.controller.c.m().g())));
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(a.f20525b, -1);
                layoutParams.setMargins(32, 0, 32, 0);
                imageView.setLayoutParams(layoutParams);
                imageView.setOnClickListener(bVar.f20531d);
                if (!bVar.f20530c) {
