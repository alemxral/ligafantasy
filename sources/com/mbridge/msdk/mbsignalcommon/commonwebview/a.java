...
public final class a extends WebChromeClient {
    ...
    private CopyOnWriteArrayList<WebChromeClient> f20532a = new CopyOnWriteArrayList<>();

    public final void a(WebChromeClient webChromeClient) {
        this.f20532a.add(webChromeClient);
    }

    public final void b(WebChromeClient webChromeClient) {
        this.f20532a.remove(webChromeClient);
    }
    ...
    public final void onCloseWindow(WebView webView) {
        Iterator<WebChromeClient> it = this.f20532a.iterator();
        while (it.hasNext()) {
