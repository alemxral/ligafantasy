...
public class j {
    ...
    private static final String f18008a = "j";

    /* JADX INFO: Access modifiers changed from: private */
    public void b(final Context context, final String str, final String str2) {
        if (!com.mbridge.msdk.foundation.same.net.g.d.f().a()) {
            try {
                if (com.mbridge.msdk.foundation.same.net.g.d.f().f19697q) {
                    return;
                }
                com.mbridge.msdk.foundation.same.net.g.d.f().f19697q = true;
                if (System.currentTimeMillis() >= com.mbridge.msdk.foundation.a.a.a.a().b("mkey_spare_host_ts").longValue() + 86400000) {
                    ...
                    if (!TextUtils.isEmpty(a8)) {
                        for (String str3 : a8.split("\n")) {
                            if (!TextUtils.isEmpty(str3.trim()) && !com.mbridge.msdk.foundation.same.net.g.d.f().f19700t.contains(str3.trim())) {
                                com.mbridge.msdk.foundation.same.net.g.d.f().f19700t.add(str3.trim());
                                com.mbridge.msdk.foundation.same.net.g.d.f().f19703w.add(str3.trim());
                            }
                        }
                        b(context, str, str2);
                        return;
                ...
                new com.mbridge.msdk.foundation.same.net.h.c(context.getApplicationContext()).get(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19682b, new com.mbridge.msdk.foundation.same.net.h.e(), new com.mbridge.msdk.foundation.same.net.c.a() { // from class: com.mbridge.msdk.c.j.2
                    @Override // com.mbridge.msdk.foundation.same.net.c.a
                    public final void a(String str4) {
                        com.mbridge.msdk.foundation.same.net.g.d.f().f19697q = false;
                        ad.a(j.f18008a, "fetch CNDSettingHost failed, errorCode = " + str4);
                    }

                    @Override // com.mbridge.msdk.foundation.same.net.c.a
                    public final void b(String str4) {
                        ad.a(j.f18008a, "fetch CNDSettingHost success, content = " + str4);
                        if (!TextUtils.isEmpty(str4)) {
                            ...
                            for (String str5 : str4.split("\n")) {
                                if (!TextUtils.isEmpty(str5.trim()) && !com.mbridge.msdk.foundation.same.net.g.d.f().f19700t.contains(str5.trim())) {
                                    com.mbridge.msdk.foundation.same.net.g.d.f().f19700t.add(str5.trim());
                                    com.mbridge.msdk.foundation.same.net.g.d.f().f19703w.add(str5.trim());
                                }
                            }
    ...
    public final void a(final Context context, final String str, final String str2) {
        ...
        if (com.mbridge.msdk.foundation.same.net.g.d.f().f19697q) {
            eVar.a("st_net", com.mbridge.msdk.foundation.same.net.g.d.f().f19699s + "");
        }
        com.mbridge.msdk.foundation.same.net.h.d dVar = new com.mbridge.msdk.foundation.same.net.h.d() { // from class: com.mbridge.msdk.c.j.1
                    ...
                    if (ai.a(jSONObject)) {
                        ...
                        if (com.mbridge.msdk.foundation.same.net.g.d.f().f19698r) {
                            if (TextUtils.isEmpty(jSONObject.optString("hst_st_t"))) {
                                jSONObject.put("hst_st_t", com.mbridge.msdk.foundation.same.net.g.d.f().f19692l);
                            }
                        } else if (TextUtils.isEmpty(jSONObject.optString("hst_st"))) {
                            jSONObject.put("hst_st", com.mbridge.msdk.foundation.same.net.g.d.f().f19688h);
                        }
            ...
            public final void a(String str3) {
                ...
                if (!com.mbridge.msdk.foundation.same.net.g.d.f().f19698r) {
                    com.mbridge.msdk.foundation.same.net.g.d.f().f19701u++;
                } else {
                    com.mbridge.msdk.foundation.same.net.g.d.f().f19702v++;
                }
                j.this.b(context, str, str2);
                j.a(j.this);
                ad.b(j.f18008a, "get app setting error" + str3);
            }
        };
        com.mbridge.msdk.c.a.c cVar = new com.mbridge.msdk.c.a.c(context);
        String str3 = com.mbridge.msdk.foundation.same.net.g.d.f().f19661G;
        try {
            if (com.mbridge.msdk.foundation.same.net.g.d.f().f19698r && com.mbridge.msdk.foundation.same.net.g.d.f().f19697q && com.mbridge.msdk.foundation.same.net.g.d.f().f19702v < com.mbridge.msdk.foundation.same.net.g.d.f().f19703w.size()) {
                String str4 = com.mbridge.msdk.foundation.same.net.g.d.f().f19703w.get(com.mbridge.msdk.foundation.same.net.g.d.f().f19702v);
                if (!TextUtils.isEmpty(str4)) {
    ...
    private String b() {
        String str = com.mbridge.msdk.foundation.same.net.g.d.f().f19698r ? com.mbridge.msdk.foundation.same.net.g.d.f().f19662H : com.mbridge.msdk.foundation.same.net.g.d.f().f19661G;
        try {
            if (!com.mbridge.msdk.foundation.same.net.g.d.f().f19698r || !com.mbridge.msdk.foundation.same.net.g.d.f().f19697q || com.mbridge.msdk.foundation.same.net.g.d.f().f19702v >= com.mbridge.msdk.foundation.same.net.g.d.f().f19703w.size()) {
                return str;
            }
            String str2 = com.mbridge.msdk.foundation.same.net.g.d.f().f19703w.get(com.mbridge.msdk.foundation.same.net.g.d.f().f19702v);
    ...
    public final void a(Context context, final String str, String str2, final String str3) {
        ...
        if (h.a().e(str3, str) && h.a().a(str, 2, str3)) {
            ...
            dVar.setUnitId(str3);
            new com.mbridge.msdk.c.a.c(context).get(1, com.mbridge.msdk.foundation.same.net.g.d.f().f19661G, eVar, dVar);
            a(3, 1, "");
        }
    }
    ...
    public void a(int i8, int i9, String str) {
        ...
        try {
            ...
            if (i9 == 0) {
                ...
                str2 = com.mbridge.msdk.foundation.same.net.g.d.f().f19698r ? com.mbridge.msdk.foundation.same.net.g.d.f().f19662H : com.mbridge.msdk.foundation.same.net.g.d.f().f19661G;
            }
            dVar.a("url", str2);
            dVar.a("reason", str);
            bVar.a("2000112", dVar);
