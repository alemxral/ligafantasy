...
public class h {
    ...
    public static final String f18004a = "h";

    /* renamed from: b, reason: collision with root package name */
    private static volatile h f18005b;

    /* renamed from: c, reason: collision with root package name */
    private static volatile g f18006c;

    /* renamed from: d, reason: collision with root package name */
    private static HashMap<String, k> f18007d = new HashMap<>();
                ...
                try {
                    for (String str2 : map.keySet()) {
                        if (str2.startsWith(str + "_")) {
                            f18007d.put(str2, k.g((String) map.get(str2)));
                        }
                    }
                    return;
                } catch (Exception e8) {
        ...
        try {
            ...
            for (String str3 : all.keySet()) {
                if (str3.startsWith(str + "_")) {
                    f18007d.put(str3, k.g((String) all.get(str3)));
                }
            }
        } catch (Exception e9) {
            e9.printStackTrace();
    ...
    private k i(String str, String str2) {
        ...
        if (f18007d.containsKey(str3)) {
            return f18007d.get(str3);
        }
        k kVar = null;
        try {
            kVar = k.g(com.mbridge.msdk.foundation.a.a.a.a().a(str3));
            f18007d.put(str3, kVar);
        } catch (Exception e8) {
            e8.printStackTrace();
        }
        return kVar;
        ...
        if (f18006c == null) {
            try {
                ...
                if (!TextUtils.isEmpty(a8)) {
                    ...
                    f18006c = g.e(jSONObject.toString());
                    if (f18006c != null) {
                        f18006c.aK();
                    }
                }
    ...
    public final boolean e(String str, String str2) {
        ...
        if (b8 != null && d8 != null) {
            ...
            if (i8 > currentTimeMillis) {
                ad.c(f18004a, "unit setting  nexttime is not ready  [settingNextRequestTime= " + i8 + " currentTime = " + currentTimeMillis + "]");
                return false;
            }
        }
        ad.c(f18004a, "unit setting timeout or not exists");
        return true;
    }
    ...
    public final boolean d(String str) {
        ...
        if (b8 != null) {
            ...
            if (A8 > currentTimeMillis) {
                ad.c(f18004a, "app setting nexttime is not ready  [settingNextRequestTime= " + A8 + " currentTime = " + currentTimeMillis + "]");
                return false;
            }
        }
        ad.c(f18004a, "app setting timeout or not exists");
        return true;
    }
