...
public class a {
    ...
    private static final String f22957a = "com.mbridge.msdk.videocommon.c.a";
    ...
    public final void a(Context context, final String str, String str2) {
        ...
        try {
            ...
            ad.b(f22957a, th.getMessage());
        }
        new b(context).get(1, d.f().f19663I, eVar, new com.mbridge.msdk.foundation.same.net.h.d() { // from class: com.mbridge.msdk.videocommon.c.a.1
    ...
    public final void a(Context context, final String str, String str2, String str3, final c cVar) {
        ...
        dVar.setUnitId(str3);
        new b(context).get(1, d.f().f19663I, eVar, dVar);
        a(3, 3, "");
    }
    ...
    public void a(int i8, int i9, String str) {
        try {
            ...
            dVar.a("st_net", Integer.valueOf(d.f().f19699s));
            dVar.a("result", Integer.valueOf(i8));
            dVar.a("type", Integer.valueOf(i9));
            dVar.a("url", d.f().f19698r ? d.f().f19664J : d.f().f19663I);
            dVar.a("reason", str);
            bVar.a("2000112", dVar);
