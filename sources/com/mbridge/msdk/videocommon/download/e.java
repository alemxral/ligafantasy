...
public final class e {
    ...
    public static class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static e f23099a = new e(null);
    }
    ...
    public final String b(String str) {
        try {
            File file = new File(this.f23097a + "/" + SameMD5.getMD5(ao.b(str)) + ".html");
            if (file.exists()) {
                return ab.b(file);
            }
            return null;
    ...
    private e() {
        this.f23097a = com.mbridge.msdk.foundation.same.b.e.a(com.mbridge.msdk.foundation.same.b.c.MBRIDGE_700_HTML);
    }
    ...
    public final String a(String str) {
        try {
            String str2 = this.f23097a + "/" + SameMD5.getMD5(ao.b(str)) + ".html";
