...
public class b {
    ...
    private ThreadPoolExecutor f23083b;

    /* renamed from: c, reason: collision with root package name */
    private boolean f23084c = false;

    /* renamed from: d, reason: collision with root package name */
    private ConcurrentHashMap<String, j> f23085d = new ConcurrentHashMap<>();

    /* renamed from: e, reason: collision with root package name */
    private ConcurrentHashMap<String, CopyOnWriteArrayList<Map<String, a>>> f23086e;

    /* renamed from: f, reason: collision with root package name */
    private ConcurrentHashMap<String, CopyOnWriteArrayList<CampaignEx>> f23087f;

    /* renamed from: g, reason: collision with root package name */
    private ConcurrentHashMap<String, CopyOnWriteArrayList<a>> f23088g;
    ...
    private b() {
        ...
        this.f23083b = threadPoolExecutor;
    ...
    public final CopyOnWriteArrayList<a> b(String str) {
        ConcurrentHashMap<String, CopyOnWriteArrayList<a>> concurrentHashMap = this.f23088g;
        if (concurrentHashMap == null || !concurrentHashMap.containsKey(str)) {
            return null;
        }
        return this.f23088g.get(str);
    }

    public final j c(String str) {
        ConcurrentHashMap<String, j> concurrentHashMap = this.f23085d;
        if (concurrentHashMap != null && concurrentHashMap.containsKey(str)) {
            return this.f23085d.get(str);
        }
        return null;
    }
    ...
    public j createUnitCache(Context context, String str, CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList, int i8, com.mbridge.msdk.videocommon.listener.a aVar) {
        ...
        if (this.f23085d.containsKey(str)) {
            jVar = this.f23085d.get(str);
            if (jVar == null) {
                jVar = new j(context, copyOnWriteArrayList, this.f23083b, str, i8);
                this.f23085d.put(str, jVar);
            }
            if (i8 != 94 && i8 != 287) {
                jVar.a(aVar);
            } else {
    ...
    public final CopyOnWriteArrayList<CampaignEx> a(String str) {
        ConcurrentHashMap<String, CopyOnWriteArrayList<CampaignEx>> concurrentHashMap = this.f23087f;
        if (concurrentHashMap == null || !concurrentHashMap.containsKey(str)) {
            return null;
        }
        return this.f23087f.get(str);
    }

    public final void b(String str, CopyOnWriteArrayList<a> copyOnWriteArrayList) {
        ConcurrentHashMap<String, CopyOnWriteArrayList<a>> concurrentHashMap = this.f23088g;
        if (concurrentHashMap == null) {
            this.f23088g = new ConcurrentHashMap<>();
        } else {
            concurrentHashMap.clear();
        }
        this.f23088g.put(str, copyOnWriteArrayList);
    }

    public final void a(String str, CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList) {
        ConcurrentHashMap<String, CopyOnWriteArrayList<CampaignEx>> concurrentHashMap = this.f23087f;
        if (concurrentHashMap == null) {
            this.f23087f = new ConcurrentHashMap<>();
        } else {
            concurrentHashMap.clear();
        }
        this.f23087f.put(str, copyOnWriteArrayList);
    }
    ...
    public j createUnitCache(Context context, String str, CampaignEx campaignEx, int i8, com.mbridge.msdk.videocommon.listener.a aVar) {
        ...
        if (this.f23085d.containsKey(str)) {
            jVar = this.f23085d.get(str);
            if (jVar == null) {
                jVar = new j(context, campaignEx, this.f23083b, str, i8);
                this.f23085d.put(str, jVar);
            }
            if (i8 != 94 && i8 != 287) {
                jVar.a(aVar);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:141:0x0197, code lost:
        ...
        r14.f23086e = new j$.util.concurrent.ConcurrentHashMap<>();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:144:0x01ae, code lost:
        ...
        r14.f23088g = new j$.util.concurrent.ConcurrentHashMap<>();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:147:0x01c5, code lost:
        ...
        r14.f23087f = new j$.util.concurrent.ConcurrentHashMap<>();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:156:0x0233, code lost:
        ...
        r14.f23086e.put(r16, r3);
        r14.f23087f.put(r16, r4);
        r14.f23088g.put(r16, r5);
     */
