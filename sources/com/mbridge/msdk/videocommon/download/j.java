...
public final class j {
    ...
    private com.mbridge.msdk.videocommon.listener.a f23122e;

    /* renamed from: g, reason: collision with root package name */
    private ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> f23124g;

    /* renamed from: j, reason: collision with root package name */
    private Context f23127j;

    /* renamed from: k, reason: collision with root package name */
    private ExecutorService f23128k;

    /* renamed from: m, reason: collision with root package name */
    private String f23130m;

    /* renamed from: n, reason: collision with root package name */
    private com.mbridge.msdk.videocommon.d.c f23131n;
    ...
    private List<CampaignEx> f23120c = new ArrayList();

    /* renamed from: d, reason: collision with root package name */
    private boolean f23121d = true;

    /* renamed from: f, reason: collision with root package name */
    private String f23123f = "";

    /* renamed from: h, reason: collision with root package name */
    private c f23125h = new c() { // from class: com.mbridge.msdk.videocommon.download.j.1
    ...
    private CopyOnWriteArrayList<Map<String, a>> f23126i = new CopyOnWriteArrayList<>();

    /* renamed from: l, reason: collision with root package name */
    private long f23129l = 3600;

    /* renamed from: o, reason: collision with root package name */
    private int f23132o = 1;
    ...
    public j(Context context, List<CampaignEx> list, ExecutorService executorService, String str, int i8) {
        this.f23133p = 1;
        try {
            boolean a8 = h.a.f23106a.a(i8);
            this.f23135r = a8;
            if (a8) {
                this.f23130m = str;
                this.f23133p = i8;
                this.f23134q = new i(list, str, i8);
                return;
            }
        ...
        this.f23127j = com.mbridge.msdk.foundation.controller.c.m().c();
        List<CampaignEx> list2 = this.f23120c;
        if (list2 != null && list != null) {
            list2.addAll(list);
        }
        this.f23128k = executorService;
        this.f23130m = str;
        this.f23133p = i8;
        b(this.f23120c);
    }
    ...
    private void d() {
        ...
        if ((this.f23135r && this.f23134q != null) || af.a().a("u_n_c_e_d", true) || (copyOnWriteArrayList = this.f23126i) == null) {
            return;
        }
        try {
            synchronized (copyOnWriteArrayList) {
                try {
                    ...
                    int i8 = 0;
                    while (i8 < this.f23126i.size()) {
                        Map<String, a> map = this.f23126i.get(i8);
                        Iterator<Map.Entry<String, a>> it = map.entrySet().iterator();
                        while (it.hasNext()) {
                            a value = it.next().getValue();
                            if (value != null) {
                                if (currentTimeMillis - value.g() > this.f23129l * 1000 && value.k() == 1) {
                                    value.b(MBridgeError.ERROR_MESSAGE_DOWNLOAD_DOWNLOAD_TIMEOUT);
                                    value.a(this.f23132o);
                                    value.s();
                                    this.f23126i.remove(map);
                                    i8--;
                                }
    ...
    private void e() {
        CopyOnWriteArrayList<Map<String, a>> copyOnWriteArrayList = this.f23126i;
    ...
    public final CopyOnWriteArrayList<Map<String, a>> c() {
        i iVar;
        if (this.f23135r && (iVar = this.f23134q) != null) {
            return iVar.d();
        }
        return this.f23126i;
    }
    ...
    */
    ...
    public final void a(String str, com.mbridge.msdk.videocommon.listener.a aVar) {
        ...
        if (this.f23124g == null) {
            this.f23124g = new ConcurrentHashMap<>();
        }
        if (aVar == null || TextUtils.isEmpty(str)) {
            return;
        }
        this.f23124g.put(str, aVar);
    }
        ...
        try {
            if (campaignEx.getAdType() == 298) {
                if (this.f23119b == null) {
                    this.f23119b = com.mbridge.msdk.c.h.a().c(com.mbridge.msdk.foundation.controller.c.m().k(), this.f23130m);
                }
                return this.f23119b.p();
            }
            if (campaignEx.getAdType() == 42) {
                return d(null);
            }
            if (this.f23131n == null) {
                this.f23131n = com.mbridge.msdk.videocommon.d.b.a().a(com.mbridge.msdk.foundation.controller.c.m().k(), this.f23130m, false);
            }
            return this.f23131n.r();
        } catch (Throwable th) {
    ...
    public final void a(CampaignEx campaignEx) {
        ...
        List<CampaignEx> list = this.f23120c;
    ...
    */
    ...
    public j(Context context, CampaignEx campaignEx, ExecutorService executorService, String str, int i8) {
        ...
        try {
            ...
            if (a8) {
                this.f23130m = str;
                this.f23133p = i8;
                this.f23134q = new i(campaignEx, str, i8);
                return;
            }
        } catch (Exception unused) {
            this.f23134q = null;
    ...
    public final void b() {
        CopyOnWriteArrayList<Map<String, a>> copyOnWriteArrayList;
        if ((!this.f23135r || this.f23134q == null) && (copyOnWriteArrayList = this.f23126i) != null) {
            try {
                synchronized (copyOnWriteArrayList) {
                    try {
                        Iterator<Map<String, a>> it = this.f23126i.iterator();
                        while (it.hasNext()) {
    ...
    public final void b(String str) {
        ...
        try {
            synchronized (this.f23126i) {
                try {
                    if (!TextUtils.isEmpty(str) && (copyOnWriteArrayList = this.f23126i) != null && copyOnWriteArrayList.size() > 0) {
                        Iterator<Map<String, a>> it = this.f23126i.iterator();
                        while (it.hasNext()) {
                            Map<String, a> next = it.next();
                            if (next != null) {
    ...
    public final boolean a(List<CampaignEx> list, String str) {
        ...
        for (int i8 = 0; i8 < list.size(); i8++) {
            ...
            if (campaignEx == null || !a(new a(com.mbridge.msdk.foundation.controller.c.m().c(), campaignEx, str, this.f23132o), b(campaignEx), false) || !a(campaignEx.getendcard_url(), campaignEx)) {
                return false;
            }
        }
        return true;
