...
public final class i {
    ...
    private com.mbridge.msdk.videocommon.listener.a f23107a;

    /* renamed from: b, reason: collision with root package name */
    private ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> f23108b;
    ...
    private com.mbridge.msdk.videocommon.d.c f23111e;

    /* renamed from: f, reason: collision with root package name */
    private final int f23112f;

    /* renamed from: g, reason: collision with root package name */
    private final CopyOnWriteArrayList<CampaignEx> f23113g;

    /* renamed from: h, reason: collision with root package name */
    private final ConcurrentHashMap<String, com.mbridge.msdk.videocommon.download.a> f23114h;

    public i(List<CampaignEx> list, String str, int i8) {
        CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList = new CopyOnWriteArrayList<>();
        this.f23113g = copyOnWriteArrayList;
        this.f23114h = new ConcurrentHashMap<>();
        this.f23109c = com.mbridge.msdk.foundation.controller.c.m().c();
        this.f23110d = str;
        this.f23112f = i8;
        if (list != null) {
    ...
    private String b(CampaignEx campaignEx) {
        ...
        try {
            ...
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f23110d + " getVideoTemplateUrl error", e8);
            }
        }
        return "";
    }
    ...
    private com.mbridge.msdk.videocommon.download.a c(CampaignEx campaignEx) {
        ...
        try {
            com.mbridge.msdk.videocommon.download.a aVar2 = new com.mbridge.msdk.videocommon.download.a(this.f23109c, campaignEx, this.f23110d, f());
            try {
                aVar2.a(campaignEx);
                aVar2.d(this.f23112f);
                aVar2.c(f(campaignEx));
                aVar2.b(e());
                aVar2.e(d(campaignEx));
                aVar2.a((c) null);
                aVar2.a(new a(this.f23110d, this.f23108b, this.f23107a));
                return aVar2;
            } catch (Exception e8) {
                e = e8;
                aVar = aVar2;
                if (MBridgeConstans.DEBUG) {
                    ad.a("RewardVideoRefactorManager", this.f23110d + " createAndStartCampaignDownloadTask error " + e.getMessage());
                }
                return aVar;
            }
        } catch (Exception e9) {
    ...
    private int d(CampaignEx campaignEx) {
        ...
        try {
            ...
            ad.a("RewardVideoRefactorManager", this.f23110d + " getVideoCtnType error " + e8.getMessage());
            return 1;
        }
    }
    ...
    private boolean e(CampaignEx campaignEx) {
        ...
        try {
            ...
            ad.a("RewardVideoRefactorManager", this.f23110d + " isPlayerAbleAds error:" + th.getMessage());
            return false;
        }
    }
    ...
    private int g() {
        try {
            return c(this.f23110d).r();
        } catch (Throwable th) {
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f23110d + " getRewardReadyRate error:" + th.getMessage());
                return 100;
            }
            return 100;
        }
    ...
    private int f() {
        ...
        try {
            com.mbridge.msdk.videocommon.d.c c8 = c(this.f23110d);
            if (c8 != null) {
                return c8.w();
            }
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f23110d + " getDlnet error " + e8.getMessage());
            }
        }
        return 1;
    }
    ...
    private int e() {
        ...
        try {
            ...
            ad.a("RewardVideoRefactorManager", this.f23110d + " getCDRate error " + e8.getMessage());
            return 0;
        }
    }
    ...
    public final void a(List<CampaignEx> list) {
        if (list != null) {
            try {
                ...
                if (MBridgeConstans.DEBUG) {
                    ad.a("RewardVideoRefactorManager", this.f23110d + " update error", e8);
                }
            }
        }
    }
    ...
    public final CopyOnWriteArrayList<Map<String, com.mbridge.msdk.videocommon.download.a>> d() {
        try {
            ...
            copyOnWriteArrayList.add(this.f23114h);
            return copyOnWriteArrayList;
        } catch (Exception e8) {
            if (!MBridgeConstans.DEBUG) {
                return null;
            }
            ad.b("RewardVideoRefactorManager", this.f23110d + " getCampaignDownLoadTaskList error:" + e8.getMessage());
            return null;
        }
    }
    ...
    public final com.mbridge.msdk.videocommon.download.a b() {
        ...
        if (this.f23113g.size() == 0) {
            ad.a("RewardVideoRefactorManager", this.f23110d + " isReady campaignExes is null");
            return null;
        }
        try {
            list = a((List<CampaignEx>) this.f23113g, false);
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f23110d + " isReady error", e8);
            }
            list = null;
        }
    ...
    public static final class a implements com.mbridge.msdk.videocommon.listener.a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> f23116b;

        /* renamed from: c, reason: collision with root package name */
        private final com.mbridge.msdk.videocommon.listener.a f23117c;
        ...
        public a(String str, ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> concurrentHashMap, com.mbridge.msdk.videocommon.listener.a aVar) {
            this.f23115a = str;
            this.f23116b = concurrentHashMap;
            this.f23117c = aVar;
        }

        @Override // com.mbridge.msdk.videocommon.listener.a
        public final void a(String str) {
            com.mbridge.msdk.videocommon.listener.a aVar = this.f23117c;
            if (aVar != null) {
                try {
                    aVar.a(str);
                } catch (Exception e8) {
                    if (MBridgeConstans.DEBUG) {
                        ad.b("RewardVideoRefactorManager", this.f23115a + " videoDownloadListener onDownLoadDone error: " + e8.getMessage());
                    }
                }
            }
            ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> concurrentHashMap = this.f23116b;
            if (concurrentHashMap != null) {
                ...
                while (it.hasNext()) {
                    try {
                        ...
                        if (MBridgeConstans.DEBUG) {
                            ad.b("RewardVideoRefactorManager", this.f23115a + " videoDownloadListener onDownLoadDone error: " + e9.getMessage());
                        }
                    }
                }
            }
        ...
        public final void a(String str, String str2) {
            ...
            if (aVar != null) {
                try {
                    ...
                    if (MBridgeConstans.DEBUG) {
                        ad.b("RewardVideoRefactorManager", this.f23115a + " videoDownloadListener onDownLoadFailed error: " + e8.getMessage());
                    }
                }
            }
            ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> concurrentHashMap = this.f23116b;
            if (concurrentHashMap != null) {
                ...
                while (it.hasNext()) {
                    try {
                        ...
                        if (MBridgeConstans.DEBUG) {
                            ad.b("RewardVideoRefactorManager", this.f23115a + " videoDownloadListener onDownLoadFailed error: " + e9.getMessage());
                        }
                    }
                }
            }
    ...
    public final void a() {
        CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList = this.f23113g;
            ...
            while (it.hasNext()) {
                ...
                if (next != null) {
                    try {
                        ...
                        if (!this.f23114h.containsKey(str)) {
                            a(next, str, (com.mbridge.msdk.videocommon.download.a) null);
                        }
                    } catch (Exception e8) {
                        if (MBridgeConstans.DEBUG) {
                            ad.a("RewardVideoRefactorManager", this.f23110d + " handlerCampaignLoadEvent error", e8);
                        }
                    }
                }
            }
        ...
        ad.a("RewardVideoRefactorManager", this.f23110d + " load campaignExes is null");
    }

    private com.mbridge.msdk.videocommon.d.c c(String str) {
        try {
            if (this.f23111e == null) {
                this.f23111e = com.mbridge.msdk.videocommon.d.b.a().a(com.mbridge.msdk.foundation.controller.c.m().k(), str, this.f23112f == 287);
            }
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f23110d + " getRewardUnitSetting error " + e8.getMessage());
            }
        }
        return this.f23111e;
    }
    ...
    public final void b(String str) {
        ...
        try {
            if (!this.f23114h.containsKey(str) || (remove = this.f23114h.remove(str)) == null || (l8 = remove.l()) == null) {
                return;
            }
            this.f23113g.remove(l8);
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f23110d + " removeCampaignDownloadTask campaign name: " + l8.getAppName());
            }
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                ad.b("RewardVideoRefactorManager", this.f23110d + " removeCampaignDownloadTask error:" + e8.getMessage());
            }
        }
    }
    ...
    public final com.mbridge.msdk.videocommon.download.a c() {
        try {
            ...
            ad.b("RewardVideoRefactorManager", this.f23110d + " getCampaignDownLoadTask error:" + th.getMessage());
            return null;
        }
    }
    ...
    */
    private boolean a(java.lang.String r6, com.mbridge.msdk.foundation.entity.CampaignEx r7, com.mbridge.msdk.videocommon.download.a r8) {
        ...
        L9:
            ...
            java.lang.String r7 = r5.f23110d     // Catch: java.lang.Throwable -> L27
        ...
        Lae:
            ...
            r7.<init>()
            java.lang.String r8 = r5.f23110d
            r7.append(r8)
    ...
    public final com.mbridge.msdk.videocommon.download.a a(String str) {
        if (!TextUtils.isEmpty(str) && this.f23114h.containsKey(str)) {
            return this.f23114h.get(str);
        }
        return null;
    }
}
