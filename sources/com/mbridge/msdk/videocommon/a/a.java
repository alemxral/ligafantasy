...
public class a {
    ...
    private static final String f22947a = "com.mbridge.msdk.videocommon.a.a";
    ...
    private a() {
        try {
            Context c8 = c.m().c();
            if (c8 != null) {
                this.f22949c = f.a(h.a(c8));
            } else {
                ad.b(f22947a, "RewardCampaignCache get Context is null");
            }
        } catch (Exception e8) {
            e8.printStackTrace();
        }
    ...
    public final int b(String str, int i8, boolean z8, String str2) {
        ...
        try {
            ...
            if (z8) {
                a8 = this.f22949c.a(str, 0, 0, i8, str2);
            } else {
                a8 = this.f22949c.a(str, 0, 0, i8, false);
            }
            if (a8 == null) {
                return 0;
            }
    ...
    public final CopyOnWriteArrayList<CampaignEx> a(String str, int i8) {
        ...
        try {
            if (TextUtils.isEmpty(str) || (a8 = this.f22949c.a(str, 0, 0, i8)) == null) {
                return null;
            }
    ...
    public final List<CampaignEx> b(String str, int i8, boolean z8) {
        try {
            ...
            return this.f22949c.a(str, 0, 0, i8, z8);
        } catch (Exception e8) {
            ad.b(f22947a, e8.getLocalizedMessage());
            return null;
        }
    }
    ...
    public final void a(String str, List<CampaignEx> list, String str2, int i8) {
        f fVar;
        if (TextUtils.isEmpty(str) || list == null || list.size() <= 0 || TextUtils.isEmpty(str2) || (fVar = this.f22949c) == null) {
            return;
        }
    ...
    public final void b(String str) {
        ...
        try {
            if (TextUtils.isEmpty(str) || (f8 = this.f22949c.f(str)) == null || f8.size() <= 0) {
                return;
            }
            g b8 = com.mbridge.msdk.c.h.a().b(c.m().k());
            if (b8 == null) {
    ...
    public final void a(String str, List<CampaignEx> list) {
        f fVar;
        if (TextUtils.isEmpty(str) || list == null || list.size() <= 0 || (fVar = this.f22949c) == null) {
            return;
        }
        fVar.b(str, list);
    }
    ...
    public final void a(String str, List<CampaignEx> list, String str2) {
        ...
        try {
            ...
            ad.b(f22947a, e8.getMessage());
        }
    }

    public final synchronized void c(String str, String str2) {
        try {
            this.f22949c.c(str2, str);
        } catch (Exception e8) {
            e8.printStackTrace();
        }
    }
    ...
    public final void a(String str, String str2) {
        if (this.f22949c == null || TextUtils.isEmpty(str)) {
            return;
        }
    ...
    public final synchronized void c(String str, int i8) {
        ...
        try {
            ...
            List<CampaignEx> b9 = this.f22949c.b(str, i8, j8 == 2);
    ...
    public final void b(String str, int i8) {
        int size;
        try {
            List<com.mbridge.msdk.foundation.entity.c> d8 = this.f22949c.d(str);
    ...
    public final void a(CampaignEx campaignEx, String str) {
        if (campaignEx != null) {
            try {
                ...
                this.f22949c.a(campaignEx.getId(), str, campaignEx.isBidCampaign(), campaignEx.getRequestId());
            } catch (Exception e8) {
                e8.printStackTrace();
            }
        }
    ...
    public final void a(CampaignEx campaignEx) {
        if (campaignEx != null) {
            try {
                ...
                this.f22949c.b(campaignEx.getId(), campaignEx.getRequestId());
            } catch (Exception e8) {
                e8.printStackTrace();
            }
        }
    ...
    public final void a(String str, String str2, List<CampaignEx> list) {
        try {
            ...
            this.f22949c.a(list, str, str2, 0);
        } catch (Exception e8) {
            e8.printStackTrace();
        }
    }
