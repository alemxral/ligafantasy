...
public final class a {
    ...
    private SQLiteDatabase f21152a;

    /* renamed from: b, reason: collision with root package name */
    private final Object f21153b = new Object();
    ...
    public final void b(int i8, String str, String str2, String str3, boolean z8, String str4, long j8) {
        ...
        Cursor query;
        if (!DatabaseUtils.isDatabaseAvailable(this.f21152a)) {
        ...
        synchronized (this.f21153b) {
            try {
                try {
                    query = this.f21152a.query("campaign", null, "ad_type=? and app_id=? and placement_id=? and unit_id=? and local_id=?", new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2, str3}, null, null, null);
                } catch (Exception e8) {
                    if (MBridgeConstans.DEBUG) {
                        ad.a("CampaignTable", "insert: ", e8);
                    }
                    sQLiteDatabase = this.f21152a;
                }
                if (query != null && query.getCount() > 0) {
                    ...
                    DatabaseUtils.endTransaction(this.f21152a);
                    return;
                }
                DatabaseUtils.beginTransaction(this.f21152a);
                ...
                long insert = this.f21152a.insert("campaign", null, contentValues);
                if (MBridgeConstans.DEBUG) {
                    ad.a("CampaignTable", "insert result:  " + insert);
                }
                DatabaseUtils.setTransactionSuccessful(this.f21152a);
                sQLiteDatabase = this.f21152a;
    ...
    public final void c(int i8, String str, String str2) {
        ...
        synchronized (this.f21153b) {
            try {
                try {
                    DatabaseUtils.beginTransaction(this.f21152a);
                    int delete = this.f21152a.delete("campaign", "ad_type=? and app_id=? and placement_id=? and unit_id=? and state in (0,405,401,404);", new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2});
                    if (MBridgeConstans.DEBUG) {
    ...
    public final void d(int i8, String str, String str2) {
        ...
        synchronized (this.f21153b) {
            try {
                try {
                    DatabaseUtils.beginTransaction(this.f21152a);
                    int delete = this.f21152a.delete("campaign", a(), new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2, String.valueOf(System.currentTimeMillis())});
                    if (MBridgeConstans.DEBUG) {
    ...
    public final List<String> e(int i8, String str, String str2) {
        ...
        synchronized (this.f21153b) {
            try {
                try {
                    try {
                        query = this.f21152a.query("campaign", null, a(), new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2, String.valueOf(System.currentTimeMillis())}, null, null, null, null);
                    } catch (Throwable th) {
                        th = th;
                    }
                } catch (Exception e8) {
    ...
    public final List<com.mbridge.msdk.newreward.function.d.a.b> a(int i8, String str, String str2, boolean z8) {
        ...
        synchronized (this.f21153b) {
            try {
                cursor = this.f21152a.query("campaign", null, "ad_type=? and app_id=? and placement_id=? and unit_id=? and header_bidding=? and state in (401,404,405)", new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2, String.valueOf(z8 ? 1 : 0)}, null, null, "load_start_time desc");
            } catch (Exception e8) {
                e = e8;
                cursor = null;
            } catch (Throwable th) {
            ...
            synchronized (this.f21153b) {
                try {
                    try {
                        ...
                        long update = this.f21152a.update("campaign", contentValues, "ad_type=? and app_id=? and placement_id=? and unit_id=? and local_id=?", new String[]{String.valueOf(bVar.a()), com.mbridge.msdk.foundation.controller.c.m().k(), bVar.b(), bVar.c(), bVar.e()});
                        if (MBridgeConstans.DEBUG) {
        ...
        synchronized (this.f21153b) {
            try {
                try {
                    ...
                    int update = this.f21152a.update("campaign", contentValues, "ad_type=? and app_id=? and placement_id=? and unit_id=? and local_id=?", new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2, str3});
                    if (MBridgeConstans.DEBUG) {
