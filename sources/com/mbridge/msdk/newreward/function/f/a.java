...
public final class a {
    ...
    private com.mbridge.msdk.newreward.function.d.a.b f21194a;

    /* renamed from: b, reason: collision with root package name */
    private com.mbridge.msdk.newreward.a.e f21195b;
    ...
    public final boolean c() {
        com.mbridge.msdk.newreward.function.d.a.b bVar = this.f21194a;
                ...
                if (g8 != null && g8.getOfferType() != 99) {
                    ...
                    if (z8) {
                        ...
                        try {
                            ...
                            b8.a(g8);
                            com.mbridge.msdk.newreward.a.e eVar = this.f21195b;
                            if (eVar != null && eVar.r() != null) {
                                com.mbridge.msdk.videocommon.d.a a8 = this.f21195b.r().a();
                                if (a8 != null) {
                                    b8.h(a8.b());
                                    b8.f(a8.c());
                                }
                                com.mbridge.msdk.videocommon.d.c b9 = this.f21195b.r().b();
                                if (b9 != null) {
                                    b8.g(b9.l());
                                    b8.n(b9.k());
                                }
                        ...
                        if (!com.mbridge.msdk.foundation.same.c.a(c8, g8)) {
                            ai.a(bVar.c(), g8, com.mbridge.msdk.foundation.same.a.f19423x);
    ...
    private static final class C0418a implements com.mbridge.msdk.newreward.a.b.b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private com.mbridge.msdk.newreward.a.e f21197a;

        /* renamed from: b, reason: collision with root package name */
        private a f21198b;

        /* renamed from: c, reason: collision with root package name */
        private com.mbridge.msdk.newreward.a.b.b f21199c;
        ...
        public final void a(Object obj) {
            try {
                ...
                bVar.b(this.f21197a.z());
                int J8 = (int) (this.f21197a.J() * 1.2d);
                bVar.d(J8);
                bVar.e(J8);
                bVar.b(Math.max(this.f21197a.L(), bVar.n()));
                this.f21198b.a(bVar);
                ...
                com.mbridge.msdk.newreward.a.b.b bVar2 = this.f21199c;
                if (bVar2 == null) {
                    return;
                }
                bVar2.a(obj);
                ...
                com.mbridge.msdk.newreward.a.b.b bVar3 = this.f21199c;
                if (bVar3 != null) {
