...
public final class a {
    ...
    private com.mbridge.msdk.newreward.function.c.a.a f20924a;

    /* renamed from: c, reason: collision with root package name */
    private long f20926c;

    /* renamed from: b, reason: collision with root package name */
    private volatile boolean f20925b = false;

    /* renamed from: d, reason: collision with root package name */
    private int f20927d = 0;

    /* renamed from: e, reason: collision with root package name */
    private long f20928e = 0;
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                f20934a[com.mbridge.msdk.newreward.function.c.e.REPORT_V3_RETRY_END.ordinal()] = 2;
    ...
    final void b(final e eVar, final com.mbridge.msdk.newreward.a.b.b bVar) {
        ...
        Runnable runnable = new Runnable() { // from class: com.mbridge.msdk.newreward.function.c.b.b.a.1
            ...
            public final void run() {
                ...
                bVar2.a(hashMap);
                b8.c();
                a.this.f20924a.a(bVar2, new com.mbridge.msdk.newreward.a.b.b() { // from class: com.mbridge.msdk.newreward.function.c.b.b.a.1.1
        ...
        ad.a("CampaignRetryStrategy", "retryReqCampaign，retryReqCampaign: " + this.f20926c);
        MBridgeTaskManager.directorExecute(runnable, this.f20926c);
    }
    ...
    */
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, e eVar2, String str, boolean z8) {
        ...
        try {
            Map a8 = d8.a("retry_count", Integer.valueOf(this.f20927d), "type", 1);
            int i8 = AnonymousClass2.f20934a[eVar.ordinal()];
            if (i8 == 1) {
            ...
            a8.put(TypedValues.TransitionType.S_DURATION, Long.valueOf(System.currentTimeMillis() - this.f20928e));
            if (z8) {
                a8.put("reason", str);
            }
