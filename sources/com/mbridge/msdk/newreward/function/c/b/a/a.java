...
public final class a implements com.mbridge.msdk.newreward.function.c.b.d {
    ...
    private com.mbridge.msdk.newreward.function.b.a f20895a;
    ...
    public final Object a(Object obj) {
        ...
        if (eVar != null && cVar != null) {
            ...
            if (this.f20895a == null) {
                ...
                this.f20895a = new com.mbridge.msdk.newreward.function.b.a(A8, z8, cVar);
            }
            ...
            if (i8 == 0) {
                ...
                try {
                    com.mbridge.msdk.newreward.function.a.b a8 = this.f20895a.a(bVar2, bVar, eVar, 2);
                    this.f20895a.a(bVar2, C8, a8, null, null, eVar, 3);
                    return a8;
                } catch (Exception e8) {
            ...
            if (i8 == 1) {
                ...
                try {
                    return Boolean.valueOf(this.f20895a.a(C9));
                } catch (Exception e9) {
            ...
            if (i8 == 2) {
                ...
                try {
                    com.mbridge.msdk.newreward.function.a.b a9 = this.f20895a.a(bVar2, bVar, eVar, 2);
                    com.mbridge.msdk.newreward.function.b.a aVar = this.f20895a;
                    if (aVar != null) {
            ...
            try {
                return this.f20895a.a(bVar2, bVar, eVar, 2);
            } catch (Exception e11) {
