...
public final class b {
    ...
    private com.mbridge.msdk.newreward.function.c.a.a f20935a;

    /* renamed from: b, reason: collision with root package name */
    private volatile boolean f20936b = false;

    /* renamed from: c, reason: collision with root package name */
    private int f20937c = 0;

    /* renamed from: d, reason: collision with root package name */
    private long f20938d = 0;
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                f20942a[com.mbridge.msdk.newreward.function.c.e.REPORT_V3_RETRY_END.ordinal()] = 2;
    ...
    public final void a(final e eVar, final com.mbridge.msdk.newreward.a.b.b bVar) {
        ...
        bVar2.a(hashMap);
        b8.c();
        this.f20935a.a(bVar2, new com.mbridge.msdk.newreward.a.b.b() { // from class: com.mbridge.msdk.newreward.function.c.b.b.b.1
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, e eVar2, String str, boolean z8) {
        ...
        if (this.f20938d == 0) {
            this.f20938d = System.currentTimeMillis();
        }
        ...
        try {
            ...
            int i8 = AnonymousClass2.f20942a[eVar.ordinal()];
            if (i8 == 1) {
            ...
            a8.put(TypedValues.TransitionType.S_DURATION, Long.valueOf(System.currentTimeMillis() - this.f20938d));
            if (!z8) {
                a8.put("reason", str);
            }
