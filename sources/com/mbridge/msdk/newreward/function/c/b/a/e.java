...
public final class e implements com.mbridge.msdk.newreward.function.c.b.a {
    ...
    com.mbridge.msdk.newreward.a.e f20911a;

    /* renamed from: b, reason: collision with root package name */
    com.mbridge.msdk.newreward.function.c.c f20912b;
    ...
    public final void a(com.mbridge.msdk.newreward.function.c.b bVar, com.mbridge.msdk.newreward.a.b.b bVar2) {
        ...
        try {
            Map map = (Map) bVar.b();
            this.f20911a = (com.mbridge.msdk.newreward.a.e) map.get("adapter_model");
            this.f20912b = (com.mbridge.msdk.newreward.function.c.c) map.get("command_manager");
            try {
                Map<String, Long> map2 = com.mbridge.msdk.foundation.same.a.d.f19442k;
            ...
            try {
                com.mbridge.msdk.foundation.db.j.a(com.mbridge.msdk.foundation.db.h.a(com.mbridge.msdk.foundation.controller.c.m().c())).a(this.f20911a.A());
            } catch (Exception e9) {
                if (MBridgeConstans.DEBUG) {
                    e9.printStackTrace();
                }
            ...
            try {
                com.mbridge.msdk.newreward.a.e eVar = this.f20911a;
                ...
                if (com.mbridge.msdk.system.a.map != null) {
                    if (((MBridgeDailyPlayModel) this.f20912b.a(new HashMap(), com.mbridge.msdk.newreward.function.c.e.CREATE_DAILY)).isOverDailyCap()) {
                        bVar2.a(new com.mbridge.msdk.foundation.c.b(880019));
                        return;
                    }
                    com.mbridge.msdk.newreward.a.e eVar2 = this.f20911a;
