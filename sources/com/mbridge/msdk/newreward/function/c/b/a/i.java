...
public final class i implements com.mbridge.msdk.newreward.function.c.b.b {
    ...
    com.mbridge.msdk.newreward.a.e f20918a;

    /* loaded from: classes4.dex */
    private static class a implements com.mbridge.msdk.video.bt.module.b.h {

        /* renamed from: a, reason: collision with root package name */
        private final com.mbridge.msdk.newreward.function.d.a.b f20919a;

        /* renamed from: b, reason: collision with root package name */
        private final com.mbridge.msdk.newreward.a.e f20920b;
        ...
        public final void b(String str, String str2) {
            try {
                ...
                this.f20920b.D().onEndcardShow(new MBridgeIds(this.f20920b.w(), this.f20920b.A()));
            } catch (Exception e8) {
        ...
        public final void a(com.mbridge.msdk.foundation.same.report.d.b bVar) {
            try {
                com.mbridge.msdk.newreward.function.e.c.a().b().a(this.f20919a.a(), this.f20919a.b(), this.f20919a.c(), this.f20919a.e(), 6);
                com.mbridge.msdk.foundation.same.report.d.c.a().a("2000130", bVar);
                this.f20920b.D().onAdShow(new MBridgeIds(this.f20920b.w(), this.f20920b.A()));
            } catch (Exception e8) {
        ...
        public final void a(com.mbridge.msdk.foundation.same.report.d.b bVar, boolean z8, com.mbridge.msdk.videocommon.b.c cVar) {
            try {
                ...
                this.f20920b.D().onAdClose(new MBridgeIds(this.f20920b.w(), this.f20920b.A()), new RewardInfo(z8, cVar.a(), String.valueOf(cVar.b())));
            } catch (Exception e8) {
        ...
        public final void a(com.mbridge.msdk.foundation.same.report.d.b bVar, String str) {
            try {
                com.mbridge.msdk.newreward.function.e.c.a().b().a(this.f20919a.a(), this.f20919a.b(), this.f20919a.c(), this.f20919a.e(), 7);
                com.mbridge.msdk.foundation.same.report.d.d dVar = new com.mbridge.msdk.foundation.same.report.d.d();
                dVar.a("reason", str);
                bVar.a("2000131", dVar);
                com.mbridge.msdk.foundation.same.report.d.c.a().a("2000131", bVar);
                this.f20920b.D().onShowFail(new MBridgeIds(this.f20920b.w(), this.f20920b.A()), str);
            } catch (Exception e8) {
        ...
        public final void a(boolean z8, String str, String str2) {
            try {
                this.f20920b.D().onVideoAdClicked(new MBridgeIds(this.f20920b.w(), this.f20920b.A()));
            } catch (Exception e8) {
        ...
        public final void a(String str, String str2) {
            try {
                this.f20920b.D().onVideoComplete(new MBridgeIds(this.f20920b.w(), this.f20920b.A()));
            } catch (Exception e8) {
        ...
        public final void a(boolean z8, int i8) {
            try {
                this.f20920b.D().onAdCloseWithIVReward(new MBridgeIds(this.f20920b.w(), this.f20920b.A()), z8, i8);
            } catch (Exception e8) {
    ...
    public final void a(Object obj) {
        ...
        if (eVar != null) {
            try {
                ...
                intent.putExtra(CampaignEx.JSON_KEY_CAMPAIGN_UNITID, this.f20918a.A());
                intent.putExtra(MBridgeConstans.PLACEMENT_ID, this.f20918a.w());
                intent.putExtra(CampaignEx.JSON_NATIVE_VIDEO_MUTE, this.f20918a.H());
                boolean z8 = false;
                if (this.f20918a.p() == 287) {
                    z8 = true;
                }
                intent.putExtra("isIV", z8);
                intent.putExtra("isBid", TextUtils.isEmpty(this.f20918a.C()));
                if (z8) {
                    intent.putExtra("ivRewardMode", this.f20918a.k());
                    intent.putExtra("ivRewardValueType", this.f20918a.j());
                    intent.putExtra("ivRewardValue", this.f20918a.k());
                }
                ...
                for (com.mbridge.msdk.newreward.function.d.a.a aVar : s8) {
                    ...
                    com.mbridge.msdk.videocommon.download.a aVar2 = new com.mbridge.msdk.videocommon.download.a(com.mbridge.msdk.foundation.controller.c.m().c(), g8, this.f20918a.A(), 1);
                    aVar2.d(this.f20918a.p());
                ...
                com.mbridge.msdk.videocommon.download.b.getInstance().a(this.f20918a.A(), copyOnWriteArrayList);
                com.mbridge.msdk.videocommon.download.b.getInstance().b(this.f20918a.A(), copyOnWriteArrayList2);
                intent.addFlags(268435456);
                MBridgeGlobalCommon.showRewardListener = new a(b8, this.f20918a);
