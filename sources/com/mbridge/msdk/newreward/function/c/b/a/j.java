...
public final class j implements com.mbridge.msdk.newreward.function.c.b.a {
    ...
    private com.mbridge.msdk.foundation.c.b f20921a;
    ...
    public final void a(com.mbridge.msdk.newreward.function.c.b bVar, com.mbridge.msdk.newreward.a.b.b bVar2) {
        if (bVar != null && bVar.b() != null) {
            try {
                Map map = (Map) bVar.b();
                this.f20921a = (com.mbridge.msdk.foundation.c.b) map.get("reason");
                ...
                if (bVar3.h() == com.mbridge.msdk.newreward.function.a.b.f20877d) {
                    eVar.x().a(bVar3.a());
                    if (bVar2 != null) {
                        try {
                            bVar2.a(bVar3.a());
                ...
                if (bVar2 != null) {
                    com.mbridge.msdk.foundation.c.b bVar4 = this.f20921a;
                    if (bVar4 == null) {
