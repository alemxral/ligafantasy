...
public class a {
    ...
    public static int f20860a = 4;

    /* renamed from: b, reason: collision with root package name */
    public static int f20861b = 5;

    /* renamed from: c, reason: collision with root package name */
    private static String f20862c = "BaseCandidateCache";

    /* renamed from: d, reason: collision with root package name */
    private JSONArray f20863d;

    /* renamed from: e, reason: collision with root package name */
    private JSONObject f20864e;
    ...
    private com.mbridge.msdk.newreward.function.c.c f20869j;
    ...
    public static class C0414a {
        ...
        /* renamed from: a, reason: collision with root package name */
        private com.mbridge.msdk.newreward.function.d.a.b f20871a;

        /* renamed from: b, reason: collision with root package name */
        private double f20872b;
    ...
    public final JSONObject a(String str) {
        JSONArray jSONArray = this.f20863d;
        if (jSONArray == null) {
            return null;
        }
        if (jSONArray.length() > 1) {
            ...
            for (int i8 = 0; i8 < this.f20863d.length(); i8++) {
                try {
                    JSONObject optJSONObject = this.f20863d.optJSONObject(i8);
                    if (optJSONObject != null && str.equals(optJSONObject.getString("g"))) {
                        this.f20864e = optJSONObject;
        ...
        return this.f20863d.optJSONObject(0);
    }

    public final String b(String str) {
        b c8 = c(str);
        if (c8 != null && c8.h() != com.mbridge.msdk.foundation.b.c.f19010c && c8.h() != com.mbridge.msdk.foundation.b.c.f19008a) {
        ...
        if (!TextUtils.isEmpty(str) && str.split("_").length > 3 && !TextUtils.isEmpty(str.split("_")[3])) {
            ...
            if (jSONArray != null && jSONArray.length() != 0) {
                ...
                if (TextUtils.isEmpty(a8)) {
                    ...
                    bVar.a(com.mbridge.msdk.foundation.b.c.f19008a);
                    return bVar;
                }
                ...
                if (TextUtils.isEmpty(this.f20865f)) {
                    ...
                    bVar.a(com.mbridge.msdk.foundation.b.c.f19010c);
                }
                return bVar;
            }
    ...
    public final List<com.mbridge.msdk.newreward.function.d.a.b> a(int i8, int i9, String str) {
        return com.mbridge.msdk.newreward.function.e.c.a().b().a(i9, str, this.f20865f, true, 0);
    }
    ...
    public final void a(String str, String str2, int i8, double d8) {
        ...
        try {
            if (i8 == 1) {
                a(f20860a, 3, null, true, str2, str, -1, this.f20865f);
            } else if (i8 == 2) {
                a(f20860a, 1, null, true, str2, str, -1, this.f20865f);
            } else if (i8 != 3) {
            } else {
                a(f20860a, 4, null, true, str2, str, -1, this.f20865f);
            }
        } catch (Exception e8) {
            e8.printStackTrace();
        }
