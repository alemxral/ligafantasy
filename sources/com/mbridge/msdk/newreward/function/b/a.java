...
public final class a {
    ...
    private static String f20887a = "RewardCandidateController";

    /* renamed from: b, reason: collision with root package name */
    private final c f20888b;

    /* renamed from: c, reason: collision with root package name */
    private com.mbridge.msdk.newreward.function.a.c f20889c;
    ...
    public final com.mbridge.msdk.newreward.function.a.b a(com.mbridge.msdk.foundation.same.report.d.b bVar, com.mbridge.msdk.foundation.c.b bVar2, e eVar, int i8) {
        ...
        if (eVar == null) {
            ...
            try {
                ...
                bVar3.a(com.mbridge.msdk.foundation.b.c.f19010c);
                return bVar3;
            }
        }
        if (campaignEx == null) {
        ...
        com.mbridge.msdk.newreward.function.a.c cVar = this.f20889c;
        if (cVar == null) {
            a8 = new com.mbridge.msdk.newreward.function.a.b();
            a8.d("can not get manager");
            a8.a(com.mbridge.msdk.foundation.b.c.f19010c);
        } else {
            com.mbridge.msdk.newreward.function.a.b c8 = cVar.c(str2);
            if (c8.h() > com.mbridge.msdk.foundation.b.c.f19009b) {
                return c8;
            }
            ...
            if (a8 != null && a8.a() != null) {
                this.f20889c.a(a8.a().s(), bVar, requestId, i10, str3, i8, parseDouble);
            }
        }
        return a8;
    }
    ...
    private com.mbridge.msdk.newreward.function.a.b a(double d8, String str, com.mbridge.msdk.foundation.same.report.d.b bVar, String str2, e eVar, int i8, int i9, String str3) {
        ...
        com.mbridge.msdk.newreward.function.a.b a8 = bVar3.f20889c.a();
        try {
        } catch (Exception unused) {
            bVar3 = a8;
        }
                    ...
                    if (a10 != null && a10.size() > 0) {
                        ...
                        if (a10.size() == 0) {
                                    ...
                                    for (int i12 = 0; i12 < a10.size(); i12++) {
                                        ...
                                        if (bVar6 != null && (s8 = bVar6.s()) != null && s8.size() != 0) {
                                            ...
                                            while (true) {
                                                ...
                                                if (c8) {
                                                    bVar4.c(bVar6.d());
                                                    com.mbridge.msdk.newreward.function.a.c cVar = bVar3.f20889c;
                                                    if (cVar != null) {
                            ...
                            if (a10 == null || a10.size() <= 0) {
                                ...
                                if (bVar7 != null) {
                                    bVar4.a(bVar7);
                                    bVar4.a(com.mbridge.msdk.foundation.b.c.f19011d);
                                } else {
    ...
    public final void a(com.mbridge.msdk.foundation.same.report.d.b bVar, String str, com.mbridge.msdk.newreward.function.a.b bVar2, List<a.C0414a> list, JSONObject jSONObject, e eVar, int i8) {
        ...
        try {
            ...
            if (cVar != null) {
                ...
                try {
                    com.mbridge.msdk.newreward.function.a.c cVar2 = this.f20889c;
            ...
            if (bVar2 != null) {
                if (bVar2.h() == com.mbridge.msdk.foundation.b.c.f19011d) {
                    dVar.a("result", 1);
                } else {
                    dVar.a("result", 2);
