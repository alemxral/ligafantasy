...
public final class d implements c {
    ...
    private Deque<e> f20791a;

    /* renamed from: c, reason: collision with root package name */
    private RewardVideoListener f20793c;

    /* renamed from: d, reason: collision with root package name */
    private com.mbridge.msdk.newreward.function.f.e f20794d;

    /* renamed from: e, reason: collision with root package name */
    private com.mbridge.msdk.newreward.function.c.c f20795e;

    /* renamed from: f, reason: collision with root package name */
    private MBridgeIds f20796f;

    /* renamed from: g, reason: collision with root package name */
    private Map f20797g;

    /* renamed from: h, reason: collision with root package name */
    private com.mbridge.msdk.newreward.b.b f20798h;

    /* renamed from: b, reason: collision with root package name */
    private final Object f20792b = new Object();

    /* renamed from: i, reason: collision with root package name */
    private int f20799i = 1;

    /* renamed from: j, reason: collision with root package name */
    private int f20800j = 1;

    public d() {
        if (this.f20791a == null) {
            this.f20791a = new ConcurrentLinkedDeque();
        }
    }

    @Override // com.mbridge.msdk.newreward.a.c
    public final boolean d() {
        Iterator<e> it = this.f20791a.iterator();
        while (it.hasNext()) {
            if (it.next().x().c()) {
                return true;
            }
    ...
    public final void b(Object obj) {
        for (com.mbridge.msdk.newreward.function.d.a.b bVar : (List) obj) {
            e eVar = new e(false, ((Integer) this.f20797g.get("mb_ad_type")).intValue(), bVar.f(), bVar.c(), bVar.g());
            com.mbridge.msdk.newreward.function.f.a aVar = new com.mbridge.msdk.newreward.function.f.a();
            aVar.a(bVar);
            eVar.a(aVar);
            eVar.a(this.f20794d);
            eVar.b(2);
            eVar.f20816a = new f(this.f20795e);
            eVar.a(this.f20793c);
            this.f20791a.add(eVar);
        }
    }
    ...
    public final void c() {
        ...
        synchronized (this.f20792b) {
            try {
                if (this.f20791a.size() == 0) {
                    this.f20798h.a(com.mbridge.msdk.newreward.function.h.b.a(""));
                    this.f20795e.a(this.f20798h, com.mbridge.msdk.newreward.function.c.e.REPORT_SHOW_START, (Object) null);
                    this.f20793c.onShowFail(this.f20796f, "no adapter_model");
                    a("no adapter_model");
                    return;
                }
                while (a(2) > this.f20799i) {
                    this.f20791a.pollFirst();
                }
                ...
                while (true) {
                    ...
                    try {
                        peek = this.f20791a.peek();
                    } catch (Exception e8) {
                        if (this.f20791a.size() == 1) {
                            this.f20798h.a(com.mbridge.msdk.newreward.function.h.b.a(""));
                            this.f20793c.onShowFail(this.f20796f, e8.getMessage());
                            a(e8.getMessage());
                            break;
                        }
                    }
                    ...
                    if (peek.s() == 2 && !peek.x().c()) {
                        if (this.f20791a.size() == 1) {
                            this.f20798h.a(peek);
                            this.f20793c.onShowFail(this.f20796f, "no isReadyCampaign");
                        ...
                        if (this.f20791a.size() == 1) {
                            this.f20798h.a(peek);
                            this.f20793c.onShowFail(this.f20796f, "all campaign is loading");
                            a("all campaign is loading");
                        }
                        concurrentLinkedDeque.push(this.f20791a.poll());
                    }
                }
                while (concurrentLinkedDeque.size() != 0) {
                    this.f20791a.push((e) concurrentLinkedDeque.poll());
                }
                com.mbridge.msdk.newreward.b.b bVar = this.f20798h;
                if (bVar != null) {
                    if (bVar.a() != null) {
                        this.f20795e.a(this.f20798h.a(), com.mbridge.msdk.newreward.function.c.e.REPORT_SHOW_START, (Object) null);
                    } else {
                        this.f20795e.a(this.f20798h, com.mbridge.msdk.newreward.function.c.e.REPORT_SHOW_START, (Object) null);
                    }
                }
    ...
    public final void a(Object obj) {
        this.f20793c = (RewardVideoListener) obj;
    }
    ...
    public final void a(Object... objArr) {
        ...
        this.f20798h = bVar;
        final Map a8 = cVar.a("mb_ad_type", Integer.valueOf(bVar.e()), "mb_ad_is_header_bidding", Boolean.valueOf(this.f20798h.f()), "mb_ad_pid", this.f20798h.d(), "mb_ad_unit_id", this.f20798h.c());
        this.f20796f = (MBridgeIds) this.f20795e.a(a8, com.mbridge.msdk.newreward.function.c.e.CREATE_BIDS);
        com.mbridge.msdk.newreward.function.c.c cVar2 = this.f20795e;
        cVar2.c(cVar2.a("mb_ad_unit_id", this.f20798h.c(), "command_type", com.mbridge.msdk.newreward.function.c.e.UNIT_INIT), new com.mbridge.msdk.newreward.a.b.b() { // from class: com.mbridge.msdk.newreward.a.d.1
        ...
        com.mbridge.msdk.newreward.function.e.c.a().b().a(this.f20798h.e(), this.f20798h.d(), this.f20798h.c());
        this.f20795e.a((Object) a8, com.mbridge.msdk.newreward.function.c.e.REQ_SETTING, new com.mbridge.msdk.newreward.a.b.b() { // from class: com.mbridge.msdk.newreward.a.d.2
            @Override // com.mbridge.msdk.newreward.a.b.b
            public final void a(com.mbridge.msdk.foundation.c.b bVar2) {
            }
            ...
            @Override // com.mbridge.msdk.newreward.a.b.b
            public final void a(Object obj) {
                d.this.f20794d = (com.mbridge.msdk.newreward.function.f.e) obj;
                d.this.f20797g = a8;
                if (d.this.f20798h != null) {
                    d.this.f20798h.a(d.this.f20794d);
                }
                ((MBridgeDailyPlayModel) d.this.f20795e.a(a8, com.mbridge.msdk.newreward.function.c.e.CREATE_DAILY)).setMaxPlayCount(d.this.f20794d.b() == null ? 0 : d.this.f20794d.b().d());
            }
        });
        Map map = this.f20797g;
        map.put("command_type", com.mbridge.msdk.newreward.function.c.e.RESTORE_DB);
        this.f20795e.c(map, new com.mbridge.msdk.newreward.a.b.b() { // from class: com.mbridge.msdk.newreward.a.d.3
            @Override // com.mbridge.msdk.newreward.a.b.b
            public final void a(com.mbridge.msdk.foundation.c.b bVar2) {
            }
        ...
        com.mbridge.msdk.newreward.function.c.c cVar3 = this.f20795e;
        cVar3.e(cVar3.a("controller_model", this.f20798h, "command_manager", cVar3, "adapter_manager", this));
    ...
    private void b(e eVar) {
        ...
        try {
            ...
            eVar2 = null;
            if (eVar2 != null) {
                com.mbridge.msdk.newreward.function.c.c cVar = this.f20795e;
    ...
    public final void a(e eVar, b bVar) {
        ...
        int integer = MBridgeSharedPreferenceModel.getInstance().getInteger(String.format(MBridgeCommon.SharedPreference.KEY_VCN, this.f20798h.c()), 1);
        this.f20799i = integer;
        if (integer <= 0) {
            this.f20799i = 1;
        }
        if (a(1) < this.f20800j) {
            try {
                synchronized (this.f20792b) {
                    try {
                        ...
                        if (d() && !eVar.l()) {
                            ...
                            if (this.f20791a.size() != 0 && this.f20791a.size() >= integer2) {
                                if (TextUtils.isEmpty(eVar.C()) && (peek = this.f20791a.peek()) != null && peek.x() != null && peek.x().b() != null) {
                                    eVar.x().a(peek.x().b());
                                } else {
                                    for (e eVar2 : this.f20791a) {
                        ...
                        for (e eVar3 : this.f20791a) {
                            if (!eVar3.x().c() && eVar3.s() == 2) {
                                this.f20791a.remove(eVar3);
                ...
                this.f20793c.onVideoLoadFail(new MBridgeIds(), e10.getMessage());
        ...
        this.f20793c.onVideoLoadFail(new MBridgeIds(), "current unit is loading");
    ...
    public final e b() {
        e peek;
        Deque<e> deque = this.f20791a;
        if (deque == null || deque.size() == 0 || (peek = this.f20791a.peek()) == null) {
            return null;
        }
        return peek;
    }
    ...
    */
    private boolean c(com.mbridge.msdk.newreward.a.e r10) {
        /*
            ...
            java.util.Deque<com.mbridge.msdk.newreward.a.e> r4 = r9.f20791a     // Catch: java.lang.Exception -> L37
            if (r4 == 0) goto L3b
        ...
        L3b:
            r4 = 0
        L3d:
            com.mbridge.msdk.newreward.function.c.c r6 = r9.f20795e     // Catch: java.lang.Exception -> L37
            ...
            if (r5 <= 0) goto La9
            com.mbridge.msdk.newout.RewardVideoListener r5 = r9.f20793c     // Catch: java.lang.Exception -> L8f
    ...
    public final void a(e eVar) {
        Deque<e> deque;
        if (eVar == null || (deque = this.f20791a) == null) {
            return;
        }
        deque.addLast(eVar);
    }
