...
public final class m implements a {
    ...
    private com.mbridge.msdk.newreward.function.c.c f20776a;

    /* renamed from: b, reason: collision with root package name */
    private com.mbridge.msdk.newreward.a.e f20777b;
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                f20782a[com.mbridge.msdk.newreward.function.c.e.REPORT_DOWNLOAD_END.ordinal()] = 2;
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        if (aVar.h().F() != null) {
            if (aVar.h().F().containsKey("command_manager")) {
                this.f20776a = (com.mbridge.msdk.newreward.function.c.c) aVar.h().F().get("command_manager");
            }
            if (aVar.h().F().containsKey("adapter_model")) {
                this.f20777b = (com.mbridge.msdk.newreward.a.e) aVar.h().F().get("adapter_model");
            }
        }
        if (d8 == null) {
            bVar.a(aVar);
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, int i8, com.mbridge.msdk.newreward.function.d.a.a aVar, MBridgeError mBridgeError) {
        com.mbridge.msdk.newreward.function.c.c cVar = this.f20776a;
        if (cVar == null || this.f20777b == null) {
            return;
        }
        try {
            ...
            int i9 = AnonymousClass2.f20782a[eVar.ordinal()];
            if (i9 != 1) {
                if (i9 == 2 && this.f20778c == 2) {
                    a8.put("result", Integer.valueOf(i8));
                    if (i8 != 1 && mBridgeError != null) {
                        a8.put("reason", mBridgeError.getErrorMessage());
                    }
                    this.f20776a.a(this.f20777b, eVar, a8);
                    return;
                }
                return;
            }
            a8.put("cache", Integer.valueOf(this.f20778c));
            this.f20776a.a(this.f20777b, eVar, a8);
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                e8.printStackTrace();
