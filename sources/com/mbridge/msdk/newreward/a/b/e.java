...
public final class e implements a {
    ...
    private com.mbridge.msdk.newreward.function.c.c f20733a;

    /* renamed from: b, reason: collision with root package name */
    private com.mbridge.msdk.newreward.a.e f20734b;
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                f20739a[com.mbridge.msdk.newreward.function.c.e.REPORT_DOWNLOAD_END.ordinal()] = 2;
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        if (aVar.h().F() != null) {
            if (aVar.h().F().containsKey("command_manager")) {
                this.f20733a = (com.mbridge.msdk.newreward.function.c.c) aVar.h().F().get("command_manager");
            }
            if (aVar.h().F().containsKey("adapter_model")) {
                this.f20734b = (com.mbridge.msdk.newreward.a.e) aVar.h().F().get("adapter_model");
            }
        }
        if (c8 == null) {
            bVar.a(aVar);
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, int i8, com.mbridge.msdk.newreward.function.d.a.a aVar, MBridgeError mBridgeError) {
        com.mbridge.msdk.newreward.function.c.c cVar = this.f20733a;
        if (cVar == null || this.f20734b == null) {
            return;
        }
        try {
            ...
            int i9 = AnonymousClass2.f20739a[eVar.ordinal()];
            if (i9 != 1) {
                if (i9 == 2 && this.f20735c == 2) {
                    a8.put("result", Integer.valueOf(i8));
                    if (i8 != 1 && mBridgeError != null) {
                        a8.put("reason", mBridgeError.getErrorMessage());
                    }
                    this.f20733a.a(this.f20734b, eVar, a8);
                    return;
                }
                return;
            }
            a8.put("cache", Integer.valueOf(this.f20735c));
            this.f20733a.a(this.f20734b, eVar, a8);
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                e8.printStackTrace();
