...
public final class c implements com.mbridge.msdk.newreward.a.b.a {
    ...
    private final com.mbridge.msdk.newreward.a.e f20716a;

    /* loaded from: classes4.dex */
    private static class a implements Runnable {

        /* renamed from: a, reason: collision with root package name */
        private final com.mbridge.msdk.newreward.function.d.a.b f20717a;

        /* renamed from: b, reason: collision with root package name */
        private final com.mbridge.msdk.newreward.function.d.b.b f20718b;
        ...
        private final com.mbridge.msdk.newreward.a.b.b f20721e;
        ...
        */
        private com.mbridge.msdk.foundation.c.b a(int r11) {
            /*
                ...
                com.mbridge.msdk.newreward.function.d.b.b r4 = r10.f20718b     // Catch: java.lang.Exception -> L3f
                if (r4 == 0) goto Ldc
            ...
            L42:
                ...
                com.mbridge.msdk.newreward.function.d.b.b r5 = r10.f20718b     // Catch: java.lang.Exception -> L5e
            ...
            L75:
                ...
                com.mbridge.msdk.newreward.function.d.b.b r5 = r10.f20718b     // Catch: java.lang.Exception -> L9a
            ...
            L9f:
                ...
                boolean r8 = r10.f20719c     // Catch: java.lang.Exception -> L3f
                ...
                com.mbridge.msdk.newreward.function.d.b.b r6 = r10.f20718b     // Catch: java.lang.Exception -> L3f
            ...
            Ld3:
                java.lang.String r11 = r10.f20722f     // Catch: java.lang.Exception -> L3f
        ...
        public final void run() {
            com.mbridge.msdk.newreward.a.b.b bVar = this.f20721e;
            if (bVar != null && this.f20718b != null) {
                try {
                    bVar.a(a(this.f20720d));
                } catch (Exception e8) {
    ...
    private static class b implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final com.mbridge.msdk.newreward.function.d.a.b f20723a;

        /* renamed from: b, reason: collision with root package name */
        private final com.mbridge.msdk.newreward.a.b.b f20724b;
        ...
        public final void run() {
            ...
            com.mbridge.msdk.newreward.a.b.b bVar2 = this.f20724b;
            if (bVar2 != null && (bVar = this.f20723a) != null) {
                try {
                    bVar2.a(bVar);
                } catch (Exception e8) {
                    ad.a("ReqCampaignService", "run: ", e8);
    ...
    public static class C0412c implements com.mbridge.msdk.newreward.function.d.b.c {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final com.mbridge.msdk.newreward.a.b.b f20725a;
        ...
        public final void a(com.mbridge.msdk.newreward.function.d.a.b bVar, com.mbridge.msdk.newreward.function.d.b.a aVar) {
            MBridgeTaskManager.commonExecute(new b(bVar, this.f20725a));
        }
        ...
        public final void b(com.mbridge.msdk.newreward.function.d.a.b bVar, com.mbridge.msdk.newreward.function.d.b.a aVar, com.mbridge.msdk.newreward.function.d.b.b bVar2) {
            MBridgeTaskManager.commonExecute(new a(bVar, bVar2, true, 401, this.f20725a, aVar.i()));
        }
        ...
        public final void a(com.mbridge.msdk.newreward.function.d.a.b bVar, com.mbridge.msdk.newreward.function.d.b.a aVar, com.mbridge.msdk.newreward.function.d.b.b bVar2) {
            MBridgeTaskManager.commonExecute(new a(bVar, bVar2, false, 402, this.f20725a, aVar.i()));
        }
        ...
        public final void a(com.mbridge.msdk.newreward.function.d.a.b bVar, com.mbridge.msdk.newreward.function.d.b.a aVar, long j8, com.mbridge.msdk.newreward.function.d.b.b bVar2) {
            MBridgeTaskManager.commonExecute(new a(bVar, bVar2, false, MBridgeCommon.CampaignState.STATE_LOAD_FAILED_TIMEOUT, this.f20725a, aVar.i()));
        }
    }
    ...
    public final void a(Object obj, com.mbridge.msdk.newreward.a.b.b bVar) throws IOException {
        ...
        if (obj != null) {
            try {
                long g8 = this.f20716a.g();
                long elapsedRealtime = SystemClock.elapsedRealtime();
                if (g8 <= 0) {
                    this.f20716a.b(elapsedRealtime);
                    g8 = elapsedRealtime;
                }
                com.mbridge.msdk.newreward.function.g.d dVar = (com.mbridge.msdk.newreward.function.g.d) obj;
                Map<String, String> f8 = dVar.f();
                com.mbridge.msdk.newreward.function.d.b.h hVar = new com.mbridge.msdk.newreward.function.d.b.h(dVar.b(), dVar.c(), dVar.d(), Math.max(this.f20716a.I() - (elapsedRealtime - g8), 0L), dVar.e());
                hVar.a(f8);
                hVar.b(this.f20716a.z());
                ...
                hVar.a(com.mbridge.msdk.foundation.same.net.h.e.f19720h, String.valueOf(i8));
