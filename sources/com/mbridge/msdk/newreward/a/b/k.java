...
public final class k implements com.mbridge.msdk.newreward.a.b.a {
    ...
    private static class a implements Runnable {
        ...
        private final com.mbridge.msdk.foundation.c.b f20763a;

        /* renamed from: b, reason: collision with root package name */
        private final com.mbridge.msdk.newreward.a.b.b f20764b;
        ...
        public final void run() {
            ...
            com.mbridge.msdk.newreward.a.b.b bVar2 = this.f20764b;
            if (bVar2 != null && (bVar = this.f20763a) != null) {
                bVar2.a(bVar);
            }
        }
    }
    ...
    private static class b implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        private JSONObject f20765a;

        /* renamed from: b, reason: collision with root package name */
        private final com.mbridge.msdk.newreward.a.b.b f20766b;

        public b(JSONObject jSONObject, com.mbridge.msdk.newreward.a.b.b bVar) {
            this.f20765a = jSONObject;
            this.f20766b = bVar;
        }
        ...
        public final void run() {
            ...
            if (this.f20766b != null && this.f20765a != null) {
                try {
                    String k8 = com.mbridge.msdk.foundation.controller.c.m().k();
                    if (ai.a(this.f20765a)) {
                        JSONObject optJSONObject = this.f20765a.optJSONObject(DataSchemeDataSource.SCHEME_DATA);
                        this.f20765a = optJSONObject;
                        if (optJSONObject != null) {
                            if (optJSONObject.optInt("vtag_status", 0) == 1) {
                                String g8 = com.mbridge.msdk.videocommon.d.b.a().g(k8);
                                if (!TextUtils.isEmpty(g8)) {
                                    this.f20765a = com.mbridge.msdk.c.h.a().a(new JSONObject(g8), this.f20765a);
                                }
                            }
                            this.f20765a.put("current_time", System.currentTimeMillis());
                            com.mbridge.msdk.videocommon.d.b.a().c(k8, this.f20765a.toString());
                            aVar = com.mbridge.msdk.videocommon.d.a.a(this.f20765a.toString());
                            this.f20766b.a(aVar);
                        }
                    } else {
    ...
    public final void a(Object obj, com.mbridge.msdk.newreward.a.b.b bVar) throws IOException {
        ...
        if (obj != null) {
            ...
            cVar.b(com.mbridge.msdk.newreward.function.d.b.g.f21085a);
            ...
            try {
                ...
                if (com.mbridge.msdk.foundation.same.net.g.d.f().f19698r) {
                    ...
                    com.mbridge.msdk.foundation.same.net.m.a().a(com.mbridge.msdk.foundation.same.net.g.d.f().f19692l, com.mbridge.msdk.foundation.same.net.g.d.f().f19696p, jSONObject.toString(), true, new c(bVar));
                    return;
                }
    ...
    public static final class c implements com.mbridge.msdk.foundation.same.net.e<JSONObject>, com.mbridge.msdk.newreward.function.d.b.e {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final com.mbridge.msdk.newreward.a.b.b f20767a;
        ...
        public final void a(JSONObject jSONObject, p<JSONObject> pVar) {
            ...
            MBridgeTaskManager.commonExecute(new b(jSONObject, this.f20767a));
        }
        ...
        public final void onError(com.mbridge.msdk.foundation.same.net.b.a aVar) {
            com.mbridge.msdk.videocommon.d.b.a().a(false);
            MBridgeTaskManager.commonExecute(new a(new com.mbridge.msdk.foundation.c.b(880002, aVar.getMessage()), this.f20767a));
        }
        ...
        public final void onSuccess(com.mbridge.msdk.foundation.same.net.k<JSONObject> kVar) {
            com.mbridge.msdk.videocommon.d.b.a().a(false);
            MBridgeTaskManager.commonExecute(new b(kVar.f19748c, this.f20767a));
        }

        @Override // com.mbridge.msdk.newreward.function.d.b.e
        public final void a(p<JSONObject> pVar, com.mbridge.msdk.newreward.function.d.b.d dVar) {
            com.mbridge.msdk.videocommon.d.b.a().a(false);
            MBridgeTaskManager.commonExecute(new a(new com.mbridge.msdk.foundation.c.b(880002, dVar.a()), this.f20767a));
        }
    }
}
