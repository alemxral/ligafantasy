...
public final class d implements a {
    ...
    private com.mbridge.msdk.newreward.function.c.c f20726a;

    /* renamed from: b, reason: collision with root package name */
    private com.mbridge.msdk.newreward.a.e f20727b;

    /* renamed from: c, reason: collision with root package name */
    private int f20728c = 0;
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                f20732a[com.mbridge.msdk.newreward.function.c.e.REPORT_DOWNLOAD_END.ordinal()] = 2;
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        if (bVar2.F() != null) {
            if (bVar2.F().containsKey("command_manager")) {
                this.f20726a = (com.mbridge.msdk.newreward.function.c.c) bVar2.F().get("command_manager");
            }
            if (bVar2.F().containsKey("adapter_model")) {
                this.f20727b = (com.mbridge.msdk.newreward.a.e) bVar2.F().get("adapter_model");
            }
        }
        if (u8 == null) {
            bVar.a(bVar2);
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, com.mbridge.msdk.newreward.function.d.a.b bVar, int i8, String str) {
        com.mbridge.msdk.newreward.function.c.c cVar = this.f20726a;
        if (cVar == null || this.f20727b == null) {
            return;
        }
        try {
            Map a8 = cVar.a("resource_type", 1, "url", bVar.u().j());
            int i9 = AnonymousClass2.f20732a[eVar.ordinal()];
            if (i9 != 1) {
                if (i9 == 2 && this.f20728c == 2) {
                    a8.put("result", Integer.valueOf(i8));
                    if (i8 != 1) {
                        a8.put("reason", str);
                    }
                    this.f20726a.a(this.f20727b, eVar, a8);
                    return;
                }
                return;
            }
            a8.put("cache", Integer.valueOf(this.f20728c));
            this.f20726a.a(this.f20727b, eVar, a8);
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                e8.printStackTrace();
