...
public final class g implements a {
    ...
    private com.mbridge.msdk.newreward.function.c.c f20747a;

    /* renamed from: b, reason: collision with root package name */
    private com.mbridge.msdk.newreward.a.e f20748b;
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        if (aVar.h().F() != null) {
            if (aVar.h().F().containsKey("command_manager")) {
                this.f20747a = (com.mbridge.msdk.newreward.function.c.c) aVar.h().F().get("command_manager");
            }
            if (aVar.h().F().containsKey("adapter_model")) {
                this.f20748b = (com.mbridge.msdk.newreward.a.e) aVar.h().F().get("adapter_model");
            }
        }
        if (b8 == null) {
            bVar.a(aVar);
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, int i8, com.mbridge.msdk.newreward.function.d.a.a aVar, MBridgeError mBridgeError) {
        com.mbridge.msdk.newreward.function.c.c cVar = this.f20747a;
        if (cVar == null || this.f20748b == null) {
            return;
        }
        try {
