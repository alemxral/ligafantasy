...
public final class e {
    public static b.a a(m mVar) {
        ...
        Map<String, String> map = mVar.f18802c;
        if (map == null) {
            return null;
        }
    ...
    public static List<com.mbridge.msdk.e.a.i> a(List<com.mbridge.msdk.e.a.i> list, b.a aVar) {
        ...
        List<com.mbridge.msdk.e.a.i> list2 = aVar.f18774h;
        if (list2 != null) {
            if (!list2.isEmpty()) {
                for (com.mbridge.msdk.e.a.i iVar : aVar.f18774h) {
                    if (!treeSet.contains(iVar.a())) {
                        arrayList.add(iVar);
                    }
                }
            }
        } else if (!aVar.f18773g.isEmpty()) {
            for (Map.Entry<String, String> entry : aVar.f18773g.entrySet()) {
