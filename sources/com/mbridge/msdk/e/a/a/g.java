...
public final class g extends com.mbridge.msdk.e.a.a.a {
    ...
    private final SSLSocketFactory f18750b;

    /* loaded from: classes4.dex */
    static class a extends FilterInputStream {

        /* renamed from: a, reason: collision with root package name */
        private final HttpURLConnection f18751a;
    ...
    public final f a(p<?> pVar, Map<String, String> map) throws IOException {
        ...
        if ("https".equals(url.getProtocol()) && (sSLSocketFactory = this.f18750b) != null) {
