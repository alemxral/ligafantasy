...
public final class a {
    ...
    public static Map<String, Long> f18021b = new HashMap();

    /* renamed from: c, reason: collision with root package name */
    public static Set<String> f18022c = new HashSet();
    ...
    private com.mbridge.msdk.foundation.db.h f18025f;

    /* renamed from: g, reason: collision with root package name */
    private Context f18026g;

    /* renamed from: h, reason: collision with root package name */
    private d f18027h;

    /* renamed from: j, reason: collision with root package name */
    private com.mbridge.msdk.foundation.same.report.i f18029j;

    /* renamed from: k, reason: collision with root package name */
    private com.mbridge.msdk.c.g f18030k;
    ...
    private NativeListener.NativeTrackingListener f18028i = null;

    /* renamed from: m, reason: collision with root package name */
    private boolean f18032m = false;

    /* renamed from: n, reason: collision with root package name */
    private boolean f18033n = true;
    ...
    public a(Context context, String str) {
        ...
        if (b8 == null) {
            ...
            this.f18030k = com.mbridge.msdk.c.i.a();
        }
        this.f18031l = this.f18030k.aJ();
        Context applicationContext = context.getApplicationContext();
        this.f18026g = applicationContext;
        this.f18023d = str;
        if (this.f18025f == null) {
            this.f18025f = com.mbridge.msdk.foundation.db.h.a(applicationContext);
        }
        this.f18029j = new com.mbridge.msdk.foundation.same.report.i(this.f18026g);
    }
    ...
    static /* synthetic */ void f(a aVar) {
        try {
            ...
            aVar.f18026g.sendBroadcast(intent);
        } catch (Exception e8) {
    ...
    private boolean b(CampaignEx campaignEx) {
        ...
        try {
            ...
            Map<String, Long> map = f18021b;
            if (map == null) {
                return true;
            }
            if (map.containsKey(id) && (l8 = f18021b.get(id)) != null) {
                if (l8.longValue() > System.currentTimeMillis() || f18022c.contains(campaignEx.getId())) {
                    return false;
                }
            }
            f18021b.put(campaignEx.getId(), Long.valueOf(System.currentTimeMillis() + (campaignEx.getClickTimeOutInterval() * 1000)));
            return true;
        } catch (Exception e8) {
            if (!MBridgeConstans.DEBUG) {
                return true;
    ...
    public static void a(Context context, CampaignEx campaignEx, String str, String str2, boolean z8, boolean z9) {
        ...
        new d(context.getApplicationContext()).a(str, campaignEx, null, str2, z8, z9, com.mbridge.msdk.click.a.a.f18058f);
    }
    ...
    public static void a(Context context, CampaignEx campaignEx, String str, String[] strArr, boolean z8, boolean z9) {
        ...
        for (String str2 : strArr) {
            ...
            }, str2, z8, z9, com.mbridge.msdk.click.a.a.f18058f);
        }
    }

    private int b() {
        try {
            com.mbridge.msdk.c.g gVar = this.f18030k;
            if (gVar != null) {
                return gVar.X();
            }
            return 1;
    ...
    public final void a(NativeListener.NativeTrackingListener nativeTrackingListener) {
        this.f18028i = nativeTrackingListener;
    }
    ...
    */
    ...
    private void a(Context context, CampaignEx campaignEx, List<String> list) {
        if (context == null) {
            com.mbridge.msdk.foundation.same.report.k.a(com.mbridge.msdk.foundation.controller.c.m().c(), campaignEx, 2, "context is null", this.f18023d);
            return;
        }
        boolean z8 = z.y() == 1;
        ...
        if (z8 && z9) {
            ...
            if (!TextUtils.isEmpty(ghId)) {
                try {
                    ...
                    com.mbridge.msdk.foundation.same.report.k.a(context, campaignEx, 1, "", this.f18023d);
                    return;
                } catch (Throwable th) {
                    com.mbridge.msdk.foundation.same.report.k.a(context, campaignEx, 2, th.getMessage(), this.f18023d);
                    a(campaignEx, list);
                    return;
                }
            }
            a(campaignEx, list);
            com.mbridge.msdk.foundation.same.report.k.a(context, campaignEx, 2, "ghid is empty", this.f18023d);
            return;
        }
        com.mbridge.msdk.foundation.same.report.k.a(context, campaignEx, 2, "integrated:" + z8 + "-hasWx:" + z9, this.f18023d);
        a(campaignEx, list);
    }

    private void a(CampaignEx campaignEx, List<String> list) {
        if (b() == 2) {
            ah.a(this.f18026g, campaignEx.getClickURL(), campaignEx, this.f18028i, list);
        } else {
            ah.a(this.f18026g, campaignEx.getClickURL(), this.f18028i, campaignEx, list);
        }
    }
    ...
    */
    ...
    public final void a(JumpLoaderResult jumpLoaderResult, CampaignEx campaignEx, int i8, boolean z8) {
        ...
        try {
            long currentTimeMillis = System.currentTimeMillis() - this.f18024e;
            com.mbridge.msdk.foundation.entity.e eVar = new com.mbridge.msdk.foundation.entity.e();
            int l8 = z.l(this.f18026g);
            eVar.a(l8);
            eVar.c(z.a(this.f18026g, l8));
            ...
            if (z8) {
                this.f18029j.a("click_jump_error", eVar, this.f18023d);
                return;
            }
            ...
            if (an.b(a8)) {
                if (com.mbridge.msdk.foundation.same.report.e.a().b()) {
                    ...
                    new com.mbridge.msdk.foundation.same.report.i(this.f18026g, 0).a("click_jump_success", a8, null, null);
                }
            }
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    public final void a(Campaign campaign, String str) {
        try {
            if (!TextUtils.isEmpty(str) && campaign != null) {
                ...
                if ((!str.startsWith("market://") && !str.startsWith("https://play.google.com/")) || ah.a.a(this.f18026g, str, this.f18028i) || campaignEx == null) {
                    return;
                }
                if (!TextUtils.isEmpty(campaignEx.getPackageName())) {
                    ah.a.a(this.f18026g, "market://details?id=" + campaignEx.getPackageName(), this.f18028i);
                    return;
                }
                if (b() == 2) {
                    ah.a(this.f18026g, campaignEx.getClickURL(), campaignEx, this.f18028i, new ArrayList());
                } else {
                    ah.a(this.f18026g, campaignEx.getClickURL(), this.f18028i, campaignEx, new ArrayList());
                }
            }
        } catch (Exception e8) {
            e8.printStackTrace();
    ...
    private void a(int i8, String str, CampaignEx campaignEx, NativeListener.NativeTrackingListener nativeTrackingListener, List<String> list) {
        try {
            if (!TextUtils.isEmpty(str)) {
                if (i8 == 2) {
                    ah.a(this.f18026g, str, campaignEx, nativeTrackingListener, list);
                } else {
                    ah.a(this.f18026g, str, nativeTrackingListener, campaignEx, list);
                }
            }
        } catch (Throwable th) {
            if (MBridgeConstans.DEBUG) {
    ...
    */
    private boolean a(com.mbridge.msdk.foundation.entity.CampaignEx r9, com.mbridge.msdk.click.entity.JumpLoaderResult r10, boolean r11, int r12, java.util.List<java.lang.String> r13) {
        /*
            ...
            if (r2 != r0) goto L20
            android.content.Context r12 = r8.f18026g     // Catch: java.lang.Throwable -> L1c
            java.lang.String r2 = r10.getUrl()     // Catch: java.lang.Throwable -> L1c
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r3 = r8.f18028i     // Catch: java.lang.Throwable -> L1c
        ...
        L2f:
            ...
            if (r2 == 0) goto L70
            android.content.Context r2 = r8.f18026g     // Catch: java.lang.Throwable -> L1c
            ...
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r4 = r8.f18028i     // Catch: java.lang.Throwable -> L1c
        ...
        L62:
            ...
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r6 = r8.f18028i     // Catch: java.lang.Throwable -> L1c
            r2 = r8
            r3 = r12
            r5 = r9
            r7 = r13
        ...
        L7d:
            ...
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r11 = r8.f18028i     // Catch: java.lang.Throwable -> L8e
            if (r11 == 0) goto Lb0
        ...
        L91:
            r8.a(r10, r9, r0)     // Catch: java.lang.Throwable -> L8e
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r12 = r8.f18028i     // Catch: java.lang.Throwable -> L8e
            if (r12 == 0) goto Lb0
            if (r11 == 0) goto Lb0
            java.lang.String r10 = r10.getUrl()     // Catch: java.lang.Throwable -> L8e
    ...
    private boolean a(CampaignEx campaignEx, JumpLoaderResult jumpLoaderResult, boolean z8, List<String> list) {
        ...
        if (z8) {
            try {
                if (com.mbridge.msdk.f.b.a()) {
                    b.a(this.f18026g, this.f18023d, campaignEx, campaignEx.getNoticeUrl(), com.mbridge.msdk.foundation.same.a.f19388L);
                }
                ah.a(this.f18026g, campaignEx.getClickURL(), this.f18028i, campaignEx, list);
                z9 = true;
            } catch (Throwable th) {
        ...
        if (z9) {
            NativeListener.NativeTrackingListener nativeTrackingListener = this.f18028i;
            ...
            NativeListener.NativeTrackingListener nativeTrackingListener2 = this.f18028i;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:64:0x00cf, code lost:
        ...
        if (com.mbridge.msdk.foundation.tools.ah.a.a(r16.f18026g, "market://details?id=" + r17.getPackageName(), r16.f18028i) == false) goto L47;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    ...
    */
    ...
    static /* synthetic */ void a(a aVar, CampaignEx campaignEx) {
        try {
            Intent intent = new Intent(aVar.f18026g, (Class<?>) LoadingActivity.class);
            intent.setFlags(268435456);
            intent.putExtra(CampaignEx.JSON_KEY_ICON_URL, campaignEx.getIconUrl());
            aVar.f18026g.startActivity(intent);
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                ad.a("CommonClickControl", "Exception", e8);
            }
    ...
    static /* synthetic */ void a(a aVar, final boolean z8, final Campaign campaign) {
        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.mbridge.msdk.click.a.5
            ...
            public final void run() {
                if (z8 && !a.f18020a && MBridgeConstans.NATIVE_SHOW_LOADINGPAGER) {
                    a.f(a.this);
                }
                if (a.this.f18028i != null && !a.f18020a && MBridgeConstans.NATIVE_SHOW_LOADINGPAGER) {
                    a.this.f18028i.onDismissLoading(campaign);
                }
            }
        });
    }
