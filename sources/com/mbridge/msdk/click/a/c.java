...
public final class c implements com.mbridge.msdk.foundation.same.a.c<String, b> {
    ...
    private final LinkedHashMap<String, b> f18087a;
    ...
    public c(int i8) {
        if (i8 > 0) {
            this.f18088b = i8;
            this.f18087a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public final synchronized String toString() {
        return String.format("LruCache[maxSize=%d]", Integer.valueOf(this.f18088b));
    }
    ...
    public final void a(String str) {
        if (str != null) {
            synchronized (this) {
                try {
                    if (this.f18087a.remove(str) != null) {
                        this.f18089c--;
                    }
                } catch (Throwable th) {
                    throw th;
    ...
    public final boolean a(String str, b bVar) {
        if (str != null && bVar != null) {
            synchronized (this) {
                try {
                    this.f18089c++;
                    if (this.f18087a.put(str, bVar) != null) {
                        this.f18089c--;
                    }
                } catch (Throwable th) {
                    throw th;
    ...
    */
    private void a(int r3) {
        ...
        L0:
            monitor-enter(r2)
            int r0 = r2.f18089c     // Catch: java.lang.Throwable -> L12
            if (r0 < 0) goto L50
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.click.a.b> r0 = r2.f18087a     // Catch: java.lang.Throwable -> L12
        ...
        L35:
            ...
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.click.a.b> r0 = r2.f18087a     // Catch: java.lang.Throwable -> L4c
            r0.remove(r1)     // Catch: java.lang.Throwable -> L4c
            int r0 = r2.f18089c     // Catch: java.lang.Throwable -> L4c
            int r0 = r0 + (-1)
            r2.f18089c = r0     // Catch: java.lang.Throwable -> L4c
        L4c:
            monitor-exit(r2)     // Catch: java.lang.Throwable -> L12
            goto L0
        L4e:
    ...
    public final Collection<String> a() {
        HashSet hashSet;
        synchronized (this) {
            hashSet = new HashSet(this.f18087a.keySet());
        }
        return hashSet;
    }
}
