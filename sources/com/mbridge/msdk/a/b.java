...
public final class b {
    ...
    public static final String f17840a = DomainNameUtils.VERIFICATION_URL;
    ...
    public static AbstractC3969b a(Context context, boolean z8, String str, String str2, String str3, String str4, String str5, String str6) {
        C3979l a8;
        EnumC3973f enumC3973f;
        EnumC3976i enumC3976i;
        EnumC3978k enumC3978k;
        ...
        if (!TextUtils.isEmpty(MBridgeConstans.OMID_JS_SERVICE_CONTENT) && !TextUtils.isEmpty(str)) {
            try {
                c(context);
                a8 = C3979l.a("Mintegral", MBConfiguration.SDK_VERSION);
                enumC3973f = EnumC3973f.NATIVE_DISPLAY;
                enumC3976i = EnumC3976i.LOADED;
                enumC3978k = EnumC3978k.NATIVE;
    ...
    public static String c(String str) {
        ...
        return TextUtils.isEmpty(str) ? str : str.replace("/*OMSDK_INSERT_HERE*/", MBridgeConstans.OMID_JS_H5_CONTENT).replace("[INSERT RESOURCE URL]", f17840a);
    }
