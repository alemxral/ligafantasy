...
public class DomainMBCommonActivity extends Activity {
    ...
    private final BrowserView.a f17846b = new BrowserView.a() { // from class: com.mbridge.msdk.activity.DomainMBCommonActivity.1
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f17845a = stringExtra;
        if (!TextUtils.isEmpty(stringExtra)) {
            this.f17847c = (CampaignEx) getIntent().getSerializableExtra("mvcommon");
            if (com.mbridge.msdk.foundation.webview.b.f20188a.containsKey(this.f17845a)) {
                BrowserView browserView = com.mbridge.msdk.foundation.webview.b.f20188a.get(this.f17845a);
                this.browserView = browserView;
                if (browserView != null) {
                    browserView.setListener(this.f17846b);
                }
            } else {
                BrowserView browserView2 = new BrowserView(this, this.f17847c);
                this.browserView = browserView2;
                browserView2.setListener(this.f17846b);
                this.browserView.loadUrl(this.f17845a);
            }
