...
public abstract class MBBaseActivity extends Activity {
    ...
    private Display f17849a;

    /* renamed from: b, reason: collision with root package name */
    private OrientationEventListener f17850b;
    ...
    static /* synthetic */ void e(MBBaseActivity mBBaseActivity) {
        OrientationEventListener orientationEventListener = new OrientationEventListener(mBBaseActivity, 1) { // from class: com.mbridge.msdk.activity.MBBaseActivity.2
            ...
            public final void onOrientationChanged(int i8) {
                int i9;
                if (MBBaseActivity.this.f17849a != null) {
                    i9 = MBBaseActivity.this.f17849a.getRotation();
                } else {
                    i9 = 0;
                }
                if (i9 == 1 && MBBaseActivity.this.f17851c != 1) {
                    MBBaseActivity.this.f17851c = 1;
                    MBBaseActivity.this.getNotchParams();
                    ad.b("MBBaseActivity", "Orientation Left");
                    return;
                }
                if (i9 == 3 && MBBaseActivity.this.f17851c != 2) {
                    MBBaseActivity.this.f17851c = 2;
                    MBBaseActivity.this.getNotchParams();
                    ad.b("MBBaseActivity", "Orientation Right");
                } else if (i9 == 0 && MBBaseActivity.this.f17851c != 3) {
                    MBBaseActivity.this.f17851c = 3;
                    MBBaseActivity.this.getNotchParams();
                    ad.b("MBBaseActivity", "Orientation Top");
                } else if (i9 == 2 && MBBaseActivity.this.f17851c != 4) {
                    MBBaseActivity.this.f17851c = 4;
                    MBBaseActivity.this.getNotchParams();
                    ad.b("MBBaseActivity", "Orientation Bottom");
                }
            }
        };
        mBBaseActivity.f17850b = orientationEventListener;
        if (orientationEventListener.canDetectOrientation()) {
            mBBaseActivity.f17850b.enable();
        } else {
            mBBaseActivity.f17850b.disable();
            mBBaseActivity.f17850b = null;
        }
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        OrientationEventListener orientationEventListener = this.f17850b;
    ...
    public int b() {
        ...
        if (this.f17849a == null) {
            if (Build.VERSION.SDK_INT >= 30) {
                display = getDisplay();
                this.f17849a = display;
            } else {
                this.f17849a = ((WindowManager) getSystemService("window")).getDefaultDisplay();
            }
        }
        Display display2 = this.f17849a;
        if (display2 != null) {
