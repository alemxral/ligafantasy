...
public class MBShakeView extends LinearLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        this.f21716a = rotateAnimation;
        rotateAnimation.setDuration(100L);
        this.f21716a.setRepeatMode(2);
        this.f21716a.setRepeatCount(-1);
        this.f21717b.startAnimation(this.f21716a);
    }
    ...
    public void initView(String str, boolean z8) {
        ...
        this.f21717b = new ImageView(getContext());
        ...
        this.f21717b.setImageResource(getResources().getIdentifier("mbridge_cm_btn_shake", "drawable", c.m().g()));
        FrameLayout frameLayout = new FrameLayout(getContext());
        frameLayout.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        frameLayout.addView(imageView);
        frameLayout.addView(this.f21717b);
