...
public final class j extends AbstractC3483C {
    ...
    private final b f33604e;

    /* renamed from: f, reason: collision with root package name */
    private final AtomicReferenceArray f33605f;

    public j(long j8, j jVar, b bVar, int i8) {
        super(j8, jVar, i8);
        this.f33604e = bVar;
        this.f33605f = new AtomicReferenceArray(c.f33577b * 2);
    }

    private final void z(int i8, Object obj) {
        this.f33605f.lazySet(i8 * 2, obj);
    }

    public final void A(int i8, Object obj) {
        this.f33605f.set((i8 * 2) + 1, obj);
    }
    ...
    */
    public void o(int r4, java.lang.Throwable r5, P5.g r6) {
        ...
        L63:
            ...
            if (r0 == 0) goto L73
            k6.b r4 = r3.u()
            kotlin.jvm.functions.Function1 r4 = r4.f33558b
            if (r4 == 0) goto L73
            n6.x.b(r4, r5, r6)
        L73:
            return
    ...
    public final boolean r(int i8, Object obj, Object obj2) {
        return i.a(this.f33605f, (i8 * 2) + 1, obj, obj2);
    }
    ...
    public final Object t(int i8, Object obj) {
        return this.f33605f.getAndSet((i8 * 2) + 1, obj);
    }
    ...
    public final Object v(int i8) {
        return this.f33605f.get(i8 * 2);
    }

    public final Object w(int i8) {
        return this.f33605f.get((i8 * 2) + 1);
    }

    public final void x(int i8, boolean z8) {
        if (z8) {
            u().M0((this.f36219c * c.f33577b) + i8);
        }
        p();
    }
