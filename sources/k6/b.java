...
public class b implements k6.d {
    ...
    private static final AtomicLongFieldUpdater f33548d = AtomicLongFieldUpdater.newUpdater(b.class, "sendersAndCloseStatus");

    /* renamed from: e, reason: collision with root package name */
    private static final AtomicLongFieldUpdater f33549e = AtomicLongFieldUpdater.newUpdater(b.class, "receivers");

    /* renamed from: f, reason: collision with root package name */
    private static final AtomicLongFieldUpdater f33550f = AtomicLongFieldUpdater.newUpdater(b.class, "bufferEnd");

    /* renamed from: g, reason: collision with root package name */
    private static final AtomicLongFieldUpdater f33551g = AtomicLongFieldUpdater.newUpdater(b.class, "completedExpandBuffersAndPauseFlag");

    /* renamed from: h, reason: collision with root package name */
    private static final AtomicReferenceFieldUpdater f33552h = AtomicReferenceFieldUpdater.newUpdater(b.class, Object.class, "sendSegment");

    /* renamed from: i, reason: collision with root package name */
    private static final AtomicReferenceFieldUpdater f33553i = AtomicReferenceFieldUpdater.newUpdater(b.class, Object.class, "receiveSegment");

    /* renamed from: j, reason: collision with root package name */
    private static final AtomicReferenceFieldUpdater f33554j = AtomicReferenceFieldUpdater.newUpdater(b.class, Object.class, "bufferEndSegment");

    /* renamed from: k, reason: collision with root package name */
    private static final AtomicReferenceFieldUpdater f33555k = AtomicReferenceFieldUpdater.newUpdater(b.class, Object.class, "_closeCause");

    /* renamed from: l, reason: collision with root package name */
    private static final AtomicReferenceFieldUpdater f33556l = AtomicReferenceFieldUpdater.newUpdater(b.class, Object.class, "closeHandler");
    ...
    public final Function1 f33558b;
    private volatile long bufferEnd;
    private volatile Object bufferEndSegment;

    /* renamed from: c, reason: collision with root package name */
    private final X5.o f33559c;
    ...
    public final class a implements f, e1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        private Object f33560a;

        /* renamed from: b, reason: collision with root package name */
        private C2839p f33561b;
        ...
        private final Object f(j jVar, int i8, long j8, P5.d dVar) {
            ...
            try {
                ...
                if (G02 == c3486f) {
                    ...
                    c3486f2 = k6.c.f33590o;
                    Function1 function1 = null;
                    if (G02 == c3486f2) {
                        if (j8 < bVar.R()) {
                            jVar.b();
                        }
                        j jVar2 = (j) b.f33553i.get(bVar);
                        while (true) {
                            if (bVar.Y()) {
                                h();
                                break;
                            }
                            long andIncrement = b.f33549e.getAndIncrement(bVar);
                            int i9 = k6.c.f33577b;
                            ...
                            c3486f3 = k6.c.f33588m;
                            if (G03 == c3486f3) {
                                bVar.p0(this, jVar2, i10);
                                break;
                            }
                            c3486f4 = k6.c.f33590o;
                            if (G03 != c3486f4) {
                                c3486f5 = k6.c.f33589n;
                                if (G03 != c3486f5) {
                                    jVar2.b();
                                    this.f33560a = G03;
                                    this.f33561b = null;
                                    a8 = kotlin.coroutines.jvm.internal.b.a(true);
                                    Function1 function12 = bVar.f33558b;
                                    if (function12 != null) {
                        ...
                        this.f33561b = null;
                        a8 = kotlin.coroutines.jvm.internal.b.a(true);
                        Function1 function13 = bVar.f33558b;
                        if (function13 != null) {
        ...
        public final boolean i(Object obj) {
            ...
            Function1 function12 = b.this.f33558b;
            if (function12 != null) {
        ...
        public Object next() {
            ...
            c3486f = k6.c.f33591p;
            if (obj != c3486f) {
                c3486f2 = k6.c.f33591p;
                this.f33560a = c3486f2;
                if (obj != k6.c.z()) {
                    return obj;
                }
    ...
    static final class C0776b extends AbstractC3160z implements X5.o {
        ...
        public static final class a extends AbstractC3160z implements Function1 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ Object f33564a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ b f33565b;
            ...
            public final void invoke(Throwable th) {
                if (this.f33564a == k6.c.z()) {
                    return;
                }
                Function1 function1 = this.f33565b.f33558b;
                throw null;
            }
        }
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f33566a = obj;
            this.f33568c |= Integer.MIN_VALUE;
    ...
    public static final class d extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f33573e = obj;
            this.f33575g |= Integer.MIN_VALUE;
    ...
    private final void A(j jVar, long j8) {
        ...
        loop0: while (jVar != null) {
            for (int i8 = k6.c.f33577b - 1; -1 < i8; i8--) {
                if ((jVar.f36219c * k6.c.f33577b) + i8 < j8) {
                    break loop0;
                }
                while (true) {
                    Object w8 = jVar.w(i8);
                        ...
                        if (w8 != c3486f) {
                            if (w8 instanceof w) {
                                if (jVar.r(i8, w8, k6.c.z())) {
                                    b8 = AbstractC3498l.c(b8, ((w) w8).f33618a);
                                    jVar.x(i8, true);
                                    break;
                                }
                            } else {
    ...
    */
    ...
    private final j C() {
        Object obj = f33554j.get(this);
        j jVar = (j) f33552h.get(this);
        if (jVar.f36219c > ((j) obj).f36219c) {
            obj = jVar;
        }
        j jVar2 = (j) f33553i.get(this);
        if (jVar2.f36219c > ((j) obj).f36219c) {
            obj = jVar2;
        }
    ...
    private final boolean C0(Object obj, Object obj2) {
        ...
        if (obj instanceof t) {
            ...
            t tVar = (t) obj;
            C2839p c2839p = tVar.f33617a;
            h b8 = h.b(h.f33600b.c(obj2));
            Function1 function12 = this.f33558b;
            if (function12 != null) {
                function1 = x.a(function12, obj2, tVar.f33617a.getContext());
            }
        ...
        if (obj instanceof InterfaceC2837o) {
            ...
            Function1 function13 = this.f33558b;
            if (function13 != null) {
    ...
    private final boolean D0(Object obj, j jVar, int i8) {
        if (obj instanceof InterfaceC2837o) {
            ...
            return k6.c.C((InterfaceC2837o) obj, I.f6474a, null, 2, null);
        }
    ...
    private final boolean E0(j jVar, int i8, long j8) {
        ...
        C3486F c3486f2;
        Object w8 = jVar.w(i8);
        if ((w8 instanceof e1) && j8 >= f33549e.get(this)) {
            c3486f = k6.c.f33582g;
            if (jVar.r(i8, w8, c3486f)) {
                if (!D0(w8, jVar, i8)) {
                    c3486f2 = k6.c.f33585j;
                    jVar.A(i8, c3486f2);
                    jVar.x(i8, false);
                    return false;
                }
                jVar.A(i8, k6.c.f33579d);
                return true;
            }
        }
    ...
    private final boolean F0(j jVar, int i8, long j8) {
        ...
        while (true) {
            Object w8 = jVar.w(i8);
            if (!(w8 instanceof e1)) {
                c3486f3 = k6.c.f33585j;
                if (w8 == c3486f3) {
                    return false;
                }
                if (w8 == null) {
                    c3486f4 = k6.c.f33580e;
                    if (jVar.r(i8, w8, c3486f4)) {
                        return true;
                    }
                } else if (w8 != k6.c.f33579d) {
                    c3486f5 = k6.c.f33583h;
                    if (w8 == c3486f5) {
                        break;
                    }
                    c3486f6 = k6.c.f33584i;
                    if (w8 == c3486f6) {
                        break;
                    }
                    c3486f7 = k6.c.f33586k;
                    if (w8 != c3486f7 && w8 != k6.c.z()) {
                        c3486f8 = k6.c.f33581f;
                        if (w8 != c3486f8) {
    ...
    public final Object G0(j jVar, int i8, long j8, Object obj) {
        ...
        Object w8 = jVar.w(i8);
        if (w8 == null) {
            if (j8 >= (f33548d.get(this) & 1152921504606846975L)) {
                if (obj == null) {
                    c3486f3 = k6.c.f33589n;
                    return c3486f3;
                }
            ...
            if (w8 != null) {
                ...
                if (w8 != c3486f5) {
                    if (w8 == k6.c.f33579d) {
                        ...
                        c3486f7 = k6.c.f33585j;
                        if (w8 == c3486f7) {
                            c3486f8 = k6.c.f33590o;
                            return c3486f8;
                        }
                        c3486f9 = k6.c.f33583h;
                        if (w8 == c3486f9) {
                            c3486f10 = k6.c.f33590o;
                            return c3486f10;
                        }
                        if (w8 != k6.c.z()) {
                            c3486f12 = k6.c.f33582g;
                            if (w8 != c3486f12) {
                                c3486f13 = k6.c.f33581f;
                                if (jVar.r(i8, w8, c3486f13)) {
                                    ...
                                    if (D0(w8, jVar, i8)) {
                                        c3486f16 = k6.c.f33584i;
                                        jVar.A(i8, c3486f16);
                                        I();
                                        return jVar.y(i8);
                                    }
                                    c3486f14 = k6.c.f33585j;
                                    jVar.A(i8, c3486f14);
                                    jVar.x(i8, false);
                                    if (z8) {
                                        I();
                                    }
                                    c3486f15 = k6.c.f33590o;
                                    return c3486f15;
                                }
                            } else {
                                continue;
    ...
    private final void I() {
        ...
        j jVar = (j) f33554j.get(this);
        while (true) {
            long andIncrement = f33550f.getAndIncrement(this);
            int i8 = k6.c.f33577b;
            long j8 = andIncrement / i8;
            if (R() <= andIncrement) {
                if (jVar.f36219c < j8 && jVar.e() != null) {
                    h0(j8, jVar);
                }
                U(this, 0L, 1, null);
                return;
    ...
    public final int I0(j jVar, int i8, Object obj, long j8, Object obj2, boolean z8) {
        ...
        if (w8 == null) {
            if (w(j8)) {
                if (jVar.r(i8, null, k6.c.f33579d)) {
                    return 1;
                }
            } else {
                if (obj2 == null) {
    ...
    private final j J(long j8, j jVar, long j9) {
        Object c8;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f33554j;
        ...
        long j10 = jVar2.f36219c;
        if (j10 > j8) {
            int i8 = k6.c.f33577b;
            if (f33550f.compareAndSet(this, j9 + 1, i8 * j10)) {
                T((jVar2.f36219c * i8) - j9);
                return null;
            }
            U(this, 0L, 1, null);
            return null;
    ...
    private final int J0(j jVar, int i8, Object obj, long j8, Object obj2, boolean z8) {
        ...
        while (true) {
            Object w8 = jVar.w(i8);
            if (w8 != null) {
                c3486f2 = k6.c.f33580e;
                if (w8 != c3486f2) {
                    c3486f3 = k6.c.f33586k;
                    if (w8 != c3486f3) {
                        c3486f4 = k6.c.f33583h;
                        if (w8 == c3486f4) {
                            jVar.s(i8);
                            return 5;
                        }
                        ...
                        if (C0(w8, obj)) {
                            c3486f7 = k6.c.f33584i;
                            jVar.A(i8, c3486f7);
                            n0();
                            return 0;
                        }
                        c3486f5 = k6.c.f33586k;
                        Object t8 = jVar.t(i8, c3486f5);
                        c3486f6 = k6.c.f33586k;
                        if (t8 != c3486f6) {
                            jVar.x(i8, true);
                        }
                        return 5;
    ...
    public final j K(long j8, j jVar) {
        Object c8;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f33553i;
        X5.n nVar = (X5.n) k6.c.y();
        loop0: while (true) {
            c8 = AbstractC3490d.c(jVar, j8, nVar);
            if (!AbstractC3484D.c(c8)) {
        ...
        if (AbstractC3484D.c(c8)) {
            G();
            if (jVar.f36219c * k6.c.f33577b >= R()) {
                return null;
            }
            jVar.b();
            return null;
        ...
        j jVar2 = (j) AbstractC3484D.b(c8);
        if (!c0() && j8 <= M() / k6.c.f33577b) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = f33554j;
            while (true) {
                AbstractC3483C abstractC3483C2 = (AbstractC3483C) atomicReferenceFieldUpdater2.get(this);
                if (abstractC3483C2.f36219c >= jVar2.f36219c || !jVar2.q()) {
                    break;
                }
        ...
        long j9 = jVar2.f36219c;
        if (j9 > j8) {
            int i8 = k6.c.f33577b;
            K0(j9 * i8);
            if (jVar2.f36219c * i8 >= R()) {
                return null;
            }
            jVar2.b();
            return null;
    ...
    private final void K0(long j8) {
        long j9;
        AtomicLongFieldUpdater atomicLongFieldUpdater = f33549e;
        do {
            j9 = atomicLongFieldUpdater.get(this);
            if (j9 >= j8) {
                return;
            }
        } while (!f33549e.compareAndSet(this, j9, j8));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final j L(long j8, j jVar) {
        Object c8;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f33552h;
        X5.n nVar = (X5.n) k6.c.y();
        loop0: while (true) {
            c8 = AbstractC3490d.c(jVar, j8, nVar);
            if (!AbstractC3484D.c(c8)) {
        ...
        if (AbstractC3484D.c(c8)) {
            G();
            if (jVar.f36219c * k6.c.f33577b >= P()) {
                return null;
            }
            jVar.b();
            return null;
    ...
    private final void L0(long j8) {
        long j9;
        long w8;
        AtomicLongFieldUpdater atomicLongFieldUpdater = f33548d;
        do {
            j9 = atomicLongFieldUpdater.get(this);
        ...
        } while (!f33548d.compareAndSet(this, j9, w8));
    }

    private final long M() {
        return f33550f.get(this);
    }
    ...
    private final void T(long j8) {
        if ((f33551g.addAndGet(this, j8) & 4611686018427387904L) == 0) {
            return;
        }
        do {
        } while ((f33551g.get(this) & 4611686018427387904L) != 0);
    }
    ...
    private final void V() {
        Object obj;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f33556l;
        do {
            obj = atomicReferenceFieldUpdater.get(this);
        } while (!androidx.concurrent.futures.a.a(atomicReferenceFieldUpdater, this, obj, obj == null ? k6.c.f33592q : k6.c.f33593r));
        if (obj == null) {
            return;
        }
                ...
                if (w8 != c3486f2) {
                    if (w8 != k6.c.f33579d) {
                        ...
                        if (w8 != c3486f3 && w8 != k6.c.z()) {
                            c3486f4 = k6.c.f33584i;
                            if (w8 != c3486f4) {
                                c3486f5 = k6.c.f33583h;
                                if (w8 != c3486f5) {
                                    c3486f6 = k6.c.f33582g;
                                    if (w8 != c3486f6) {
                                        c3486f7 = k6.c.f33581f;
                                        if (w8 == c3486f7 || j8 != P()) {
                                            return false;
                                        }
                                        return true;
    ...
    */
    private final void h0(long r6, k6.j r8) {
        ...
        L20:
            ...
            goto L11
        L22:
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r6 = k6.b.f33554j
        L24:
    ...
    public final void j0(InterfaceC2837o interfaceC2837o) {
        s.a aVar = L5.s.f6498b;
        interfaceC2837o.resumeWith(L5.s.b(h.b(h.f33600b.a(N()))));
    }
    ...
    private final Object l0(Object obj, P5.d dVar) {
        ...
        c2839p.B();
        Function1 function1 = this.f33558b;
    ...
    static /* synthetic */ Object r0(b bVar, P5.d dVar) {
        ...
        C3486F c3486f2;
        C3486F c3486f3;
        j jVar = (j) f33553i.get(bVar);
        while (!bVar.Y()) {
            long andIncrement = f33549e.getAndIncrement(bVar);
            int i8 = k6.c.f33577b;
            long j8 = andIncrement / i8;
            int i9 = (int) (andIncrement % i8);
            if (jVar.f36219c != j8) {
    ...
    */
    static /* synthetic */ java.lang.Object s0(k6.b r13, P5.d r14) {
        ...
        L14:
            ...
            goto L12
        L1a:
            java.lang.Object r14 = r6.f33566a
            ...
            if (G02 == c3486f) {
                ...
                if (G02 == c3486f2) {
                    ...
                    while (true) {
                        ...
                        long andIncrement = f33549e.getAndIncrement(this);
                        int i9 = k6.c.f33577b;
                        long j9 = andIncrement / i9;
                        int i10 = (int) (andIncrement % i9);
                        if (jVar2.f36219c != j9) {
    ...
    */
    private final void v0(k6.j r13) {
        /*
            r12 = this;
            kotlin.jvm.functions.Function1 r0 = r12.f33558b
            r1 = 0
            r2 = 1
    ...
    private final void y0(e1 e1Var, boolean z8) {
        ...
        if (e1Var instanceof t) {
            C2839p c2839p = ((t) e1Var).f33617a;
            s.a aVar2 = L5.s.f6498b;
            c2839p.resumeWith(L5.s.b(h.b(h.f33600b.a(N()))));
        } else {
    ...
    static /* synthetic */ Object z0(b bVar, Object obj, P5.d dVar) {
        j jVar = (j) f33552h.get(bVar);
        while (true) {
            long andIncrement = f33548d.getAndIncrement(bVar);
    ...
    protected boolean D(Throwable th, boolean z8) {
        ...
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f33555k;
        c3486f = k6.c.f33594s;
    ...
    public final void H(long j8) {
        C3486F c3486f;
        Q d8;
        j jVar = (j) f33553i.get(this);
        while (true) {
            AtomicLongFieldUpdater atomicLongFieldUpdater = f33549e;
            long j9 = atomicLongFieldUpdater.get(this);
            if (j8 < Math.max(this.f33557a + j9, M())) {
                return;
            }
    ...
    public final void M0(long j8) {
        ...
        for (int i9 = 0; i9 < i8; i9++) {
            long M8 = M();
            if (M8 == (f33551g.get(this) & 4611686018427387903L) && M8 == M()) {
                return;
            }
        }
        AtomicLongFieldUpdater atomicLongFieldUpdater2 = f33551g;
        do {
        ...
        while (true) {
            long M9 = M();
            atomicLongFieldUpdater = f33551g;
    ...
    protected final Throwable N() {
        return (Throwable) f33555k.get(this);
    }

    public final long P() {
        return f33549e.get(this);
    }
    ...
    public final long R() {
        return f33548d.get(this) & 1152921504606846975L;
    }
    ...
    public final boolean S() {
        while (true) {
            ...
            int i8 = k6.c.f33577b;
            long j8 = P8 / i8;
            if (jVar.f36219c != j8 && (jVar = K(j8, jVar)) == null) {
                if (((j) atomicReferenceFieldUpdater.get(this)).f36219c < j8) {
                    return false;
                }
            } else {
                jVar.b();
                ...
                f33549e.compareAndSet(this, P8, P8 + 1);
            }
        }
    }

    public boolean Y() {
        return Z(f33548d.get(this));
    }
    ...
    public Object d() {
        ...
        C3486F c3486f2;
        C3486F c3486f3;
        long j8 = f33549e.get(this);
        long j9 = f33548d.get(this);
        if (Z(j9)) {
            return h.f33600b.a(N());
        }
    ...
    public void s(Function1 function1) {
        ...
        C3486F c3486f3;
        C3486F c3486f4;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = f33556l;
        ...
        do {
            ...
            c3486f = k6.c.f33592q;
            if (obj != c3486f) {
                c3486f2 = k6.c.f33593r;
                if (obj == c3486f2) {
                    throw new IllegalStateException("Another handler was already registered and successfully invoked".toString());
                }
                throw new IllegalStateException(("Another handler is already registered: " + obj).toString());
            }
            atomicReferenceFieldUpdater = f33556l;
            c3486f3 = k6.c.f33592q;
            c3486f4 = k6.c.f33593r;
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:51:?, code lost:
        ...
        return k6.h.f33600b.c(L5.I.f6474a);
     */
    @Override // k6.v
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    public java.lang.Object y(java.lang.Object r15) {
        /*
            r14 = this;
            java.util.concurrent.atomic.AtomicLongFieldUpdater r0 = k6.b.f33548d
            long r0 = r0.get(r14)
            boolean r0 = r14.B0(r0)
            if (r0 == 0) goto L13
            k6.h$b r15 = k6.h.f33600b
