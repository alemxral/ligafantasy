...
public class p extends b {
    ...
    private final int f33610m;

    /* renamed from: n, reason: collision with root package name */
    private final EnumC3132a f33611n;

    public p(int i8, EnumC3132a enumC3132a, Function1 function1) {
        super(i8, function1);
        this.f33610m = i8;
        this.f33611n = enumC3132a;
    ...
    static /* synthetic */ Object N0(p pVar, Object obj, P5.d dVar) {
        ...
        if (Q02 instanceof h.a) {
            h.e(Q02);
            Function1 function1 = pVar.f33558b;
    ...
    private final Object O0(Object obj, boolean z8) {
        ...
        if (!h.i(y8) && !h.h(y8)) {
            if (z8 && (function1 = this.f33558b) != null && (d8 = x.d(function1, obj, null, 2, null)) != null) {
                throw d8;
            }
    ...
    private final Object P0(Object obj) {
        j jVar;
        e1 e1Var;
        Object obj2 = c.f33579d;
        j jVar2 = (j) b.f33552h.get(this);
        while (true) {
            long andIncrement = b.f33548d.getAndIncrement(this);
    ...
    private final Object Q0(Object obj, boolean z8) {
        if (this.f33611n == EnumC3132a.DROP_LATEST) {
            return O0(obj, z8);
        }
        return P0(obj);
    }
    ...
    protected boolean b0() {
        if (this.f33611n == EnumC3132a.DROP_OLDEST) {
            return true;
        }
        return false;
    }
