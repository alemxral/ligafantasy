...
public final class C1930e {
    ...
    public final long a() {
        try {
            return this.f14977a.getSharedPreferences("sp_uptodown_services", 0).getLong("versioncode_registered", -1L);
    ...
    public final void b(long j8) {
        try {
            SharedPreferences.Editor edit = this.f14977a.getSharedPreferences("sp_uptodown_services", 0).edit();
