...
public class C2528b implements Parcelable {
    ...
    final boolean f30070a = false;

    /* renamed from: b, reason: collision with root package name */
    final Handler f30071b = null;

    /* renamed from: c, reason: collision with root package name */
    InterfaceC2527a f30072c;
    ...
    class BinderC0716b extends InterfaceC2527a.AbstractBinderC0714a {
        ...
        public void k0(int i8, Bundle bundle) {
            ...
            Handler handler = c2528b.f30071b;
            if (handler != null) {
    ...
    class c implements Runnable {
        ...
        public void run() {
            C2528b.this.b(this.f30074a, this.f30075b);
        }
    }

    C2528b(Parcel parcel) {
        this.f30072c = InterfaceC2527a.AbstractBinderC0714a.i(parcel.readStrongBinder());
    }

    public void c(int i8, Bundle bundle) {
        if (this.f30070a) {
            Handler handler = this.f30071b;
            if (handler != null) {
                handler.post(new c(i8, bundle));
                return;
            } else {
        ...
        InterfaceC2527a interfaceC2527a = this.f30072c;
        ...
        synchronized (this) {
            try {
                if (this.f30072c == null) {
                    this.f30072c = new BinderC0716b();
                }
                parcel.writeStrongBinder(this.f30072c.asBinder());
            } catch (Throwable th) {
                throw th;
            }
        }
