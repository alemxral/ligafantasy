...
public interface InterfaceC2527a extends IInterface {
    ...
    public static final String f30068j = "android$support$v4$os$IResultReceiver".replace('$', '.');
    ...
    public static abstract class AbstractBinderC0714a extends Binder implements InterfaceC2527a {
        ...
        private static class C0715a implements InterfaceC2527a {
            ...
            private IBinder f30069a;

            C0715a(IBinder iBinder) {
                this.f30069a = iBinder;
            }
            ...
            public void k0(int i8, Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(InterfaceC2527a.f30068j);
                    obtain.writeInt(i8);
                    b.d(obtain, bundle, 0);
                    this.f30069a.transact(1, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public AbstractBinderC0714a() {
            attachInterface(this, InterfaceC2527a.f30068j);
        }
        ...
        public static InterfaceC2527a i(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(InterfaceC2527a.f30068j);
        ...
        public boolean onTransact(int i8, Parcel parcel, Parcel parcel2, int i9) {
            String str = InterfaceC2527a.f30068j;
            if (i8 >= 1 && i8 <= 16777215) {
