...
public final class t extends kotlin.coroutines.jvm.internal.d implements InterfaceC3359g, kotlin.coroutines.jvm.internal.e {
    ...
    public final InterfaceC3359g f35923a;

    /* renamed from: b, reason: collision with root package name */
    public final P5.g f35924b;

    /* renamed from: c, reason: collision with root package name */
    public final int f35925c;

    /* renamed from: d, reason: collision with root package name */
    private P5.g f35926d;

    /* renamed from: e, reason: collision with root package name */
    private P5.d f35927e;
    ...
    public t(InterfaceC3359g interfaceC3359g, P5.g gVar) {
        super(q.f35917a, P5.h.f7981a);
        this.f35923a = interfaceC3359g;
        this.f35924b = gVar;
        this.f35925c = ((Number) gVar.fold(0, a.f35928a)).intValue();
    }
    ...
    private final Object h(P5.d dVar, Object obj) {
        ...
        this.f35927e = dVar;
        X5.o a8 = u.a();
        InterfaceC3359g interfaceC3359g = this.f35923a;
    ...
    private final void l(l lVar, Object obj) {
        throw new IllegalStateException(g6.n.e("\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + lVar.f35915a + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ").toString());
    }
    ...
    public Object emit(Object obj, P5.d dVar) {
        try {
            ...
            this.f35926d = new l(th, dVar.getContext());
            throw th;
        }
    }
    ...
    public Object invokeSuspend(Object obj) {
        ...
        if (e8 != null) {
            this.f35926d = new l(e8, getContext());
        }
        P5.d dVar = this.f35927e;
        if (dVar != null) {
            dVar.resumeWith(obj);
