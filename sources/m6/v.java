...
public abstract class v {
    ...
    public static final class a extends AbstractC3160z implements X5.n {
        ...
        public final Integer a(int i8, g.b bVar) {
            int i9;
            g.c key = bVar.getKey();
            g.b bVar2 = this.f35931a.f35924b.get(key);
            if (key != InterfaceC2855x0.f31795n0) {
                if (bVar != bVar2) {
    ...
    public static final void a(t tVar, P5.g gVar) {
        if (((Number) gVar.fold(0, new a(tVar))).intValue() == tVar.f35925c) {
            return;
        }
        throw new IllegalStateException(("Flow invariant is violated:\n\t\tFlow was collected in " + tVar.f35924b + ",\n\t\tbut emission happened in " + gVar + ".\n\t\tPlease refer to 'flow' documentation or use 'flowOn' instead").toString());
    }
