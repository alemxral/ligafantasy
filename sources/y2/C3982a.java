...
public final class C3982a implements InterfaceC3983b {
    ...
    private final List f39728b;

    /* renamed from: c, reason: collision with root package name */
    private final List f39729c;
    ...
    public String R(Context context) {
        ...
        List list = this.f39728b;
        int i8 = this.f39727a;
        Object[] g8 = AbstractC3984c.g(context, this.f39729c);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f39727a == c3982a.f39727a && AbstractC3159y.d(this.f39728b, c3982a.f39728b) && AbstractC3159y.d(this.f39729c, c3982a.f39729c)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((this.f39727a * 31) + this.f39728b.hashCode()) * 31) + this.f39729c.hashCode();
    }

    public String toString() {
        return "IdentifierResolvableString(id=" + this.f39727a + ", transformations=" + this.f39728b + ", args=" + this.f39729c + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeInt(this.f39727a);
        List list = this.f39728b;
