...
public class b {
    ...
    private static volatile b f11807c;

    /* renamed from: a, reason: collision with root package name */
    public final ConcurrentHashMap f11808a = new ConcurrentHashMap();
    ...
    private final boolean f(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i8, boolean z8, Executor executor) {
        ...
        if (g(serviceConnection)) {
            ServiceConnection serviceConnection2 = (ServiceConnection) this.f11808a.putIfAbsent(serviceConnection, serviceConnection);
            ...
            try {
                ...
                this.f11808a.remove(serviceConnection, serviceConnection);
            }
        }
    ...
    public void c(Context context, ServiceConnection serviceConnection) {
        if (g(serviceConnection) && this.f11808a.containsKey(serviceConnection)) {
            try {
                e(context, (ServiceConnection) this.f11808a.get(serviceConnection));
                return;
            } finally {
                this.f11808a.remove(serviceConnection);
            }
        }
