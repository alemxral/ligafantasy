...
public abstract class g {
    ...
    private static final ThreadLocal f2393a = new ThreadLocal();
    ...
    public static class a implements PrivilegedAction {
        ...
        public Object run() {
            return Security.getProperty(this.f2394a);
        }
    }
    ...
    public static class b implements PrivilegedAction {
        ...
        @Override // java.security.PrivilegedAction
        public Object run() {
            return System.getProperty(this.f2395a);
        }
    }
