...
public final class C1095d extends RecyclerView.Adapter {
    ...
    private final InterfaceC1486i f1665b;

    /* renamed from: c, reason: collision with root package name */
    public ArrayList f1666c;
    ...
    private final void b(ArrayList arrayList, ArrayList arrayList2) {
        ...
        this.f1668e = new boolean[d().size()];
    }

    public final int c() {
        boolean[] zArr = this.f1668e;
        if (zArr == null) {
            return 0;
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i8) {
        ...
        View itemView = LayoutInflater.from(this.f1664a).inflate(R.layout.download_item, viewGroup, false);
        AbstractC3159y.h(itemView, "itemView");
        return new o5.r(itemView, this.f1665b);
    }
}
