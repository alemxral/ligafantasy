...
public final class C1100i extends RecyclerView.Adapter {
    ...
    public static final a f1692p = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private final W4.s f1693a;

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC1478a f1694b;
    ...
    public static final class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        public ArrayList f1708a;

        /* renamed from: b, reason: collision with root package name */
        public ArrayList f1709b;
    ...
    public C1100i(W4.s listener, InterfaceC1478a actionsClickListener, Context context, String fragmentName) {
        ...
        this.f1693a = listener;
        this.f1694b = actionsClickListener;
        this.f1695c = context;
        this.f1696d = fragmentName;
    ...
    private final void e(ArrayList arrayList) {
        ...
        cVar.d(7);
        this.f1697e.add(cVar);
        notifyItemInserted(this.f1697e.size() - 1);
    }
    ...
    private final void v(X4.N n8, int i8) {
        if (i8 >= 0 && i8 < this.f1697e.size()) {
            c cVar = new c();
            cVar.c(n8);
            cVar.d(n8.c());
            this.f1697e.set(i8, cVar);
    ...
    public final void j(C1498h mainApp) {
        ...
        cVar.c(mainApp);
        cVar.d(3);
        this.f1697e.set(this.f1701i, cVar);
        notifyItemChanged(this.f1701i);
    }
            ...
            if (c8 != 521) {
                if (c8 != 523) {
                    if (c8 != 524) {
                        ...
                        v(miniTop, this.f1704l);
                    }
                } else {
                    AbstractC3159y.h(miniTop, "miniTop");
                    v(miniTop, this.f1703k);
                }
            } else {
                AbstractC3159y.h(miniTop, "miniTop");
                v(miniTop, this.f1702j);
            }
        }
    }
    ...
    public final void o(ArrayList arrayList) {
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            v((X4.N) obj, this.f1705m);
            if (arrayList.size() > 1) {
                Object obj2 = arrayList.get(1);
                AbstractC3159y.h(obj2, "tops[1]");
                v((X4.N) obj2, this.f1706n);
            }
            if (arrayList.size() > 2) {
                Object obj3 = arrayList.get(2);
                AbstractC3159y.h(obj3, "tops[2]");
                v((X4.N) obj3, this.f1707o);
            }
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i8) {
        ...
        switch (i8) {
            case -1:
                View inflate = LayoutInflater.from(this.f1695c).inflate(R.layout.empty_view, viewGroup, false);
                AbstractC3159y.h(inflate, "from(context).inflate(R.…y_view, viewGroup, false)");
                return new C3569s(inflate);
            case 0:
                View inflate2 = LayoutInflater.from(this.f1695c).inflate(R.layout.home_fragment_header, viewGroup, false);
                AbstractC3159y.h(inflate2, "from(context).inflate(R.…header, viewGroup, false)");
                return new C3583z(inflate2, this.f1693a, this.f1694b, this.f1695c);
            case 1:
                View inflate3 = LayoutInflater.from(this.f1695c).inflate(R.layout.home_recycler_view_top, viewGroup, false);
                AbstractC3159y.h(inflate3, "from(context).inflate(R.…ew_top, viewGroup, false)");
                return new C3533D(inflate3, this.f1693a, this.f1694b, this.f1695c);
            case 2:
                View inflate4 = LayoutInflater.from(this.f1695c).inflate(R.layout.card_featured, viewGroup, false);
                AbstractC3159y.h(inflate4, "from(context).inflate(R.…atured, viewGroup, false)");
                return new C3558m(inflate4, this.f1693a, this.f1694b, this.f1695c);
            case 3:
                View inflate5 = LayoutInflater.from(this.f1695c).inflate(R.layout.home_gallery_featured, viewGroup, false);
                AbstractC3159y.h(inflate5, "from(context).inflate(R.…atured, viewGroup, false)");
                return new o5.M(inflate5, this.f1693a, this.f1694b, this.f1695c);
            case 4:
                View inflate6 = LayoutInflater.from(this.f1695c).inflate(R.layout.home_recycler_view_top, viewGroup, false);
                AbstractC3159y.h(inflate6, "from(context).inflate(R.…ew_top, viewGroup, false)");
                return new X0(inflate6, this.f1693a, this.f1694b, this.f1695c, this.f1696d);
            case 5:
                View inflate7 = LayoutInflater.from(this.f1695c).inflate(R.layout.home_recycler_view_top, viewGroup, false);
                AbstractC3159y.h(inflate7, "from(context).inflate(R.…ew_top, viewGroup, false)");
                return new B0(inflate7, this.f1693a, this.f1694b, this.f1695c);
            case 6:
                View inflate8 = LayoutInflater.from(this.f1695c).inflate(R.layout.home_recycler_view_top, viewGroup, false);
                AbstractC3159y.h(inflate8, "from(context).inflate(R.…ew_top, viewGroup, false)");
                return new o5.F(inflate8, this.f1693a, this.f1694b, this.f1695c);
            case 7:
                View inflate9 = LayoutInflater.from(this.f1695c).inflate(R.layout.floating_categories, viewGroup, false);
                AbstractC3159y.h(inflate9, "from(context).inflate(R.…gories, viewGroup, false)");
                return new C3573u(inflate9, this.f1693a, this.f1695c);
            case 8:
                View inflate10 = LayoutInflater.from(this.f1695c).inflate(R.layout.home_recycler_view_top, viewGroup, false);
                AbstractC3159y.h(inflate10, "from(context).inflate(R.…ew_top, viewGroup, false)");
                return new C3531B(inflate10, this.f1693a, this.f1694b, this.f1695c);
            default:
    ...
    public final void q(ArrayList homeFeatures, X4.N n8, X4.N n9) {
        ...
        h(n8);
        this.f1697e.add(null);
        this.f1698f = this.f1697e.size() - 1;
        h(n9);
        this.f1697e.add(null);
        this.f1699g = this.f1697e.size() - 1;
        this.f1697e.add(null);
        this.f1706n = this.f1697e.size() - 1;
        this.f1697e.add(null);
        this.f1700h = this.f1697e.size() - 1;
        this.f1697e.add(null);
        this.f1707o = this.f1697e.size() - 1;
        this.f1697e.add(null);
        this.f1701i = this.f1697e.size() - 1;
        this.f1697e.add(null);
        this.f1702j = this.f1697e.size() - 1;
        this.f1697e.add(null);
        this.f1703k = this.f1697e.size() - 1;
        this.f1697e.add(null);
        this.f1704l = this.f1697e.size() - 1;
    }
    ...
    public final void s(C1498h featuredApp) {
        ...
        if (this.f1699g > 0) {
            ...
            cVar.c(featuredApp);
            cVar.d(2);
            this.f1697e.set(this.f1699g, cVar);
            notifyItemChanged(this.f1699g);
        }
    }
