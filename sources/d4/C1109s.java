...
public final class C1109s extends RecyclerView.Adapter {
    ...
    private ArrayList f1784a;

    /* renamed from: b, reason: collision with root package name */
    private final Context f1785b;

    /* renamed from: c, reason: collision with root package name */
    private final W4.v f1786c;
    ...
    public o5.Q onCreateViewHolder(ViewGroup viewGroup, int i8) {
        ...
        View itemView = LayoutInflater.from(this.f1785b).inflate(R.layout.notification_registry_item, viewGroup, false);
        AbstractC3159y.h(itemView, "itemView");
        return new o5.Q(itemView, this.f1786c);
    }
