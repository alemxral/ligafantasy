...
public final class L extends RecyclerView.Adapter {
    ...
    private ArrayList f1560a;

    /* renamed from: b, reason: collision with root package name */
    private ArrayList f1561b;

    /* renamed from: c, reason: collision with root package name */
    private final Context f1562c;

    /* renamed from: d, reason: collision with root package name */
    private final W4.J f1563d;

    /* renamed from: e, reason: collision with root package name */
    public ArrayList f1564e;

    /* renamed from: f, reason: collision with root package name */
    private ArrayList f1565f;

    /* renamed from: g, reason: collision with root package name */
    private ArrayList f1566g;
    ...
    public L(ArrayList userData, ArrayList data, Context context, W4.J listener) {
        ...
        this.f1560a = userData;
        this.f1561b = data;
        this.f1562c = context;
        this.f1563d = listener;
    ...
    private final void a() {
        ...
        if (!this.f1560a.isEmpty()) {
            ...
            while (it.hasNext()) {
                this.f1565f.add((X4.D) it.next());
            }
        }
        if (!this.f1561b.isEmpty()) {
            Iterator it2 = this.f1561b.iterator();
            while (it2.hasNext()) {
                X4.D d8 = (X4.D) it2.next();
                Iterator it3 = this.f1565f.iterator();
                while (true) {
                    if (it3.hasNext()) {
                        obj = it3.next();
                        if (((X4.D) obj).b() == d8.b()) {
                ...
                if (obj == null) {
                    if (!this.f1566g.contains(d8)) {
                        this.f1566g.add(d8);
                    }
                } else {
                    this.f1566g.remove(d8);
                }
            }
        }
        if (!this.f1565f.isEmpty()) {
            b().add("title_user_upcoming_releases");
            b().addAll(AbstractC1246t.P0(this.f1565f, new b()));
        }
        if (!this.f1566g.isEmpty()) {
            b().add("title_upcoming_releases");
            b().addAll(this.f1566g);
        }
        notifyDataSetChanged();
    }

    public final ArrayList b() {
        ArrayList arrayList = this.f1564e;
        if (arrayList != null) {
            return arrayList;
        }
    ...
    public final void d(ArrayList userData, ArrayList data) {
        AbstractC3159y.i(userData, "userData");
        AbstractC3159y.i(data, "data");
        this.f1560a = new ArrayList(userData);
        this.f1561b = new ArrayList(data);
        a();
    }
        ...
        if (i8 != 0) {
            if (i8 != 1) {
                if (i8 != 2) {
                    ...
                    String string = this.f1562c.getString(R.string.upcoming_releases_title);
                ...
                String string2 = this.f1562c.getString(R.string.user_upcoming_releases_title);
                AbstractC3159y.h(string2, "context.getString(R.stri…_upcoming_releases_title)");
                return new C3563o0(itemView3, string2, null);
            }
            o0 c8 = o0.c(LayoutInflater.from(this.f1562c), viewGroup, false);
            AbstractC3159y.h(c8, "inflate(LayoutInflater.f…ntext), viewGroup, false)");
            return new E0(c8, this.f1562c, this.f1563d, false);
        }
        o0 c9 = o0.c(LayoutInflater.from(this.f1562c), viewGroup, false);
        AbstractC3159y.h(c9, "inflate(LayoutInflater.f…ntext), viewGroup, false)");
        return new E0(c9, this.f1562c, this.f1563d, true);
    }
}
