...
public final class C1112v extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i8) {
        ...
        if (i8 != 0) {
            if (i8 != 1) {
                View itemView = LayoutInflater.from(this.f1792c).inflate(R.layout.load_more_versions, viewGroup, false);
                AbstractC3159y.h(itemView, "itemView");
                return new o5.I(itemView);
            }
            View itemView2 = LayoutInflater.from(this.f1792c).inflate(R.layout.old_version_item, viewGroup, false);
            AbstractC3159y.h(itemView2, "itemView");
            return new W(itemView2, this.f1793d);
        }
        View itemView3 = LayoutInflater.from(this.f1792c).inflate(R.layout.header_installed_app, viewGroup, false);
        AbstractC3159y.h(itemView3, "itemView");
        return new C3579x(itemView3, this.f1792c);
    }
}
