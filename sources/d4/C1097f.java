...
public final class C1097f extends RecyclerView.Adapter {
    ...
    private final InterfaceC1488k f1672b;

    /* renamed from: c, reason: collision with root package name */
    private int f1673c;

    /* renamed from: d, reason: collision with root package name */
    private ArrayList f1674d;

    /* renamed from: e, reason: collision with root package name */
    private final Animation f1675e;
    ...
    public final void b(File file, C1505o download) {
        AbstractC3159y.i(file, "file");
        AbstractC3159y.i(download, "download");
        this.f1674d.add(new a(file, download));
        notifyItemInserted(this.f1674d.size());
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i8) {
        ...
        Object obj = this.f1674d.get(absoluteAdapterPosition);
        ...
        if (absoluteAdapterPosition > this.f1673c) {
            viewHolder.itemView.startAnimation(this.f1675e);
            this.f1673c = absoluteAdapterPosition;
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i8) {
        ...
        View itemView = LayoutInflater.from(this.f1671a).inflate(R.layout.floating_notification, viewGroup, false);
