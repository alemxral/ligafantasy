...
public final class Q extends RecyclerView.Adapter {
    ...
    public static final a f1606d = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private ArrayList f1607a;

    /* renamed from: b, reason: collision with root package name */
    private final W4.H f1608b;
    ...
    public final void d(X4.K review) {
        ...
        this.f1607a.set(i8, review);
        notifyItemChanged(i8);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        return this.f1607a.size() + (this.f1609c ? 1 : 0);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i8) {
        if (i8 == this.f1607a.size()) {
            return 1;
        }
        return 0;
    }
