...
public final class r extends RecyclerView.Adapter {
    ...
    public static final a f1774j = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private final Context f1775a;

    /* renamed from: b, reason: collision with root package name */
    private final InterfaceC1479b f1776b;

    /* renamed from: c, reason: collision with root package name */
    private final W4.E f1777c;

    /* renamed from: d, reason: collision with root package name */
    private final W4.G f1778d;

    /* renamed from: e, reason: collision with root package name */
    private final W4.t f1779e;

    /* renamed from: f, reason: collision with root package name */
    public ArrayList f1780f;

    /* renamed from: g, reason: collision with root package name */
    private ArrayList f1781g;
    ...
    public r(ArrayList apps, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, Context context, InterfaceC1479b applistener, W4.E e8, W4.G uptodownProtectListener, W4.t infoClickListener) {
        ...
        this.f1775a = context;
        this.f1776b = applistener;
        this.f1777c = e8;
        this.f1778d = uptodownProtectListener;
        this.f1779e = infoClickListener;
        this.f1783i = -1;
    ...
    public final ArrayList b() {
        ArrayList arrayList = this.f1780f;
        if (arrayList != null) {
            return arrayList;
        }
    ...
    public final void h(ArrayList arrayList) {
        this.f1781g = arrayList;
        this.f1782h = false;
        notifyItemChanged(this.f1783i);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i8) {
        ...
        if (viewHolder instanceof C3544f) {
            ...
            ((P0) viewHolder).d(this.f1781g, this.f1775a);
        } else {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i8) {
        ...
        if (i8 != 0) {
            if (i8 != 1) {
                if (i8 != 3) {
                    if (i8 != 4) {
                        if (i8 != 5) {
                            if (i8 == 6) {
                                ...
                                String string = this.f1775a.getString(R.string.disabled_apps);
                                AbstractC3159y.h(string, "context.getString(R.string.disabled_apps)");
                                return new C3563o0(inflate, string, this.f1779e);
                            }
                        ...
                        String string2 = this.f1775a.getString(R.string.menu_item_title_system_services);
                    ...
                    String string3 = this.f1775a.getString(R.string.system_apps_title);
                ...
                return new P0(inflate4, this.f1778d);
            }
            ...
            return new L0(inflate5, this.f1777c, this.f1775a);
        }
        ...
        return new C3544f(inflate6, this.f1776b, this.f1775a);
    }
}
