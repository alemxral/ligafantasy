...
public final class M extends RecyclerView.Adapter {
    ...
    public static final a f1568o = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private final Context f1569a;

    /* renamed from: b, reason: collision with root package name */
    private final W4.E f1570b;

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC1479b f1571c;

    /* renamed from: d, reason: collision with root package name */
    private final W4.F f1572d;

    /* renamed from: e, reason: collision with root package name */
    private final W4.G f1573e;

    /* renamed from: f, reason: collision with root package name */
    private final W4.L f1574f;

    /* renamed from: g, reason: collision with root package name */
    private final W4.t f1575g;

    /* renamed from: h, reason: collision with root package name */
    public ArrayList f1576h;

    /* renamed from: i, reason: collision with root package name */
    private ArrayList f1577i;
    ...
    public M(ArrayList updates, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, Context context, W4.E updatelistener, InterfaceC1479b applistener, W4.F headerlistener, W4.G uptodownProtectListener, W4.L warningTrackingDisabledListener, W4.t infoClickListener) {
        ...
        this.f1569a = context;
        this.f1570b = updatelistener;
        this.f1571c = applistener;
        this.f1572d = headerlistener;
        this.f1573e = uptodownProtectListener;
        this.f1574f = warningTrackingDisabledListener;
        this.f1575g = infoClickListener;
        this.f1578j = new b();
        this.f1579k = -1;
        this.f1580l = -1;
        this.f1581m = -1;
    ...
    private final void a(ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
        ...
        int i8 = 0;
        this.f1579k = 0;
        File g8 = new C3329q().g(this.f1569a);
        if (g8.exists() && new C3329q().k(this.f1569a, g8) < 262144000) {
            b().add("warning_not_space");
            i8 = 1;
            this.f1580l = 1;
        }
        if (arrayList != null) {
            this.f1578j.d(arrayList.size());
            this.f1578j.c(3);
        }
        b().add(this.f1578j);
        this.f1581m = i8 + 1;
        if (!SettingsPreferences.f29309b.k0(this.f1569a)) {
    ...
    public final ArrayList b() {
        ArrayList arrayList = this.f1576h;
        if (arrayList != null) {
            return arrayList;
        }
    ...
    public final void l(ArrayList arrayList) {
        this.f1577i = arrayList;
        notifyItemChanged(this.f1579k);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i8) {
        ...
        if (viewHolder instanceof P0) {
            ((P0) viewHolder).d(this.f1577i, this.f1569a);
            return;
        }
        ...
        if (viewHolder instanceof Y0) {
            ...
            ((G0) viewHolder).c(this.f1578j.a(), this.f1578j.b());
        } else {
            if (viewHolder instanceof a1) {
                ((a1) viewHolder).c(!SettingsPreferences.f29309b.k0(this.f1569a));
                return;
            }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i8) {
        ...
        if (i8 != 0) {
            if (i8 != 1) {
                switch (i8) {
                    case 4:
                        ...
                        return new P0(inflate, this.f1573e);
                    case 5:
                    ...
                    case 6:
                        ...
                        return new G0(inflate3, this.f1572d, this.f1569a);
                    case 7:
                        ...
                        return new a1(inflate4, this.f1569a, this.f1574f);
                    case 8:
                        ...
                        String string = this.f1569a.getString(R.string.updates_recent);
                    ...
                    case 9:
                        ...
                        String string2 = this.f1569a.getString(R.string.update_ignored);
                    ...
                    case 10:
                        ...
                        String string3 = this.f1569a.getString(R.string.disabled_apps);
                        AbstractC3159y.h(string3, "context.getString(R.string.disabled_apps)");
                        return new C3563o0(inflate7, string3, this.f1575g);
                    default:
            ...
            return new C3544f(inflate8, this.f1571c, this.f1569a);
        }
        ...
        return new L0(inflate9, this.f1570b, this.f1569a);
    }
}
