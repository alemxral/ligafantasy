...
public final class C1893g extends Fragment implements a.b {
    ...
    public RecyclerView f14820b;

    /* renamed from: c, reason: collision with root package name */
    public C1891e f14821c;

    /* renamed from: d, reason: collision with root package name */
    public J7.c f14822d;

    /* renamed from: e, reason: collision with root package name */
    public Typeface f14823e;

    /* renamed from: f, reason: collision with root package name */
    public Typeface f14824f;
    ...
    public final void h() {
        ...
        C1891e c1891e = this.f14821c;
        if (c1891e == null) {
            AbstractC3159y.y("viewModel");
            c1891e = null;
        }
        RecyclerView recyclerView = this.f14820b;
        ...
        if (adapter != null) {
            List<R7.d> gbcList = ((R7.a) adapter).f8861a;
            c1891e.getClass();
            AbstractC3159y.i(gbcList, "gbcList");
            for (R7.d dVar : gbcList) {
                if (AbstractC3159y.d(dVar.f8900b, Boolean.TRUE)) {
                    C1895i.f14826a.d(dVar.f8899a.f1047a, GBCConsentValue.GRANTED);
                } else {
                    C1895i.f14826a.d(dVar.f8899a.f1047a, GBCConsentValue.DENIED);
                }
            }
            SharedStorage sharedStorage = c1891e.f14813a;
            N7.a aVar = N7.a.GBC_CONSENT_STRING;
            sharedStorage.d(aVar, C1895i.f14826a.a(sharedStorage.k(aVar), C1895i.f14828c));
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (getActivity() != null) {
            ...
            this.f14821c = (C1891e) new ViewModelProvider(viewModelStore, new C1892f()).get(C1891e.class);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View inflate = inflater.inflate(I1.c.f3862m, viewGroup, false);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x00f2, code lost:
        ...
        if (r8.f2358b == com.inmobi.cmp.core.model.portalconfig.GBCConsentValue.GRANTED) goto L61;
     */
    @Override // androidx.fragment.app.Fragment
    /*
