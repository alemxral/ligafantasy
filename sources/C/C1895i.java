...
public final class C1895i {
    ...
    public static final C1895i f14826a = new C1895i();

    /* renamed from: c, reason: collision with root package name */
    public static Vector f14828c = new Vector(null, 1, null);
    ...
    public static final class a extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final /* synthetic */ Vector f14829a;
        ...
        public Object invoke(Object obj, Object obj2) {
            ...
            if (!this.f14829a.contains(intValue)) {
                if (booleanValue) {
                    this.f14829a.set(intValue);
                } else {
                    this.f14829a.unset(intValue);
                }
            }
            return I.f6474a;
        }
