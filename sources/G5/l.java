...
public final class l extends Presenter {
    ...
    public Presenter.ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        this.f31264b = ContextCompat.getColor(parent.getContext(), R.color.main_blue);
        this.f31263a = ContextCompat.getColor(parent.getContext(), R.color.main_blue_pressed);
