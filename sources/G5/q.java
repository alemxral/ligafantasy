...
public final class q extends Presenter {
    ...
    public Presenter.ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        this.f31277b = ContextCompat.getColor(parent.getContext(), R.color.main_blue);
        this.f31276a = ContextCompat.getColor(parent.getContext(), R.color.main_blue_pressed);
