...
public final class n extends Presenter {
    ...
    private int f31271a = -1;

    /* renamed from: b, reason: collision with root package name */
    private int f31272b = -1;
    ...
    public Presenter.ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        this.f31272b = ContextCompat.getColor(parent.getContext(), R.color.tv_default_background);
        this.f31271a = ContextCompat.getColor(parent.getContext(), R.color.tv_selected_background);
