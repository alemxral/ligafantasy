...
public final class m extends Presenter {
    ...
    private int f31265a = -1;

    /* renamed from: b, reason: collision with root package name */
    private int f31266b = -1;

    /* renamed from: c, reason: collision with root package name */
    private int f31267c = -1;
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
        ...
        if (item instanceof C1496f) {
            ...
            if (j8 != null) {
                ...
                imageCardView.setMainImage(this.f31269e);
            }
    ...
    public Presenter.ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        this.f31266b = ContextCompat.getColor(parent.getContext(), R.color.white);
        this.f31265a = ContextCompat.getColor(parent.getContext(), R.color.main_blue_pressed);
        this.f31267c = ContextCompat.getColor(parent.getContext(), R.color.black);
        this.f31268d = ContextCompat.getColor(parent.getContext(), R.color.white);
        this.f31269e = ContextCompat.getDrawable(parent.getContext(), R.drawable.vector_uptodown_logo_bag_disabled);
